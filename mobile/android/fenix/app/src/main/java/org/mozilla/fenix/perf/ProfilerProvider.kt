...
/**
 * Content Provider to expose method to return a profile URL through adb. The returned value
 * is a URL of an uploaded profile.
 *
 * Note: For security, the access is restricted via the DUMP  permission.
 */
