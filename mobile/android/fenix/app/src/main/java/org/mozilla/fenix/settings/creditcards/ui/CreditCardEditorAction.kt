...
sealed interface CreditCardEditorAction : Action {
    ...
    /**
     * An action that is dispatched when the environment has been rehydrated from a configuration change.
     *
     * @property environment The [CreditCardEditorEnvironment] associated with the action.
     */
    data class EnvironmentRehydrated(val environment: CreditCardEditorEnvironment) :
