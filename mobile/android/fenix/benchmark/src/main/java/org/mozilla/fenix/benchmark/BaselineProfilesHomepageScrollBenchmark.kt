...
class BaselineProfilesHomepageScrollBenchmark {
    @get:Rule
    val benchmarkRule = MacrobenchmarkRule()

    @Test
    fun homepageScrollNone() = homepageScrollBenchmark(CompilationMode.None())

    @Test
    fun homepageScroll() =
        homepageScrollBenchmark(
            CompilationMode.Partial(baselineProfileMode = BaselineProfileMode.Require),
        )

    private fun homepageScrollBenchmark(compilationMode: CompilationMode) =
