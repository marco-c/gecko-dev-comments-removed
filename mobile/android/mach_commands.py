...
class MachCommands(MachCommandBase):
    ...
    @SubCommand('android', 'test-ccov',
        ...
        See https://firefox-source-docs.mozilla.org/mobile/android/fennec/testcoverage.html""")  
    @CommandArgument('args', nargs=argparse.REMAINDER)
    ...
    def _process_jacoco_reports(self):
        ...
        with TemporaryDirectory() as xml_dir:
            ...
            report_xml_template = self.topobjdir + '/gradle/build/mobile/android/%s/reports/jacoco/jacocoTestReport/jacocoTestReport.xml'  
    ...
    @SubCommand('android', 'archive-coverage-artifacts',
        ...
        coverage reports. See https://firefox-source-docs.mozilla.org/mobile/android/fennec/testcoverage.html""")  
    @CommandArgument('args', nargs=argparse.REMAINDER)
