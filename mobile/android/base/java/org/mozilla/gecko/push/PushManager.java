...
public class PushManager {
    public static final long TIME_BETWEEN_AUTOPUSH_UAID_REGISTRATION_IN_MILLIS = 7 * 24 * 60 * 60 * 1000L; 
    ...
    public void startup(long now) {
        try {
            ...
            gcmClient.getToken(AppConstants.MOZ_ANDROID_GCM_SENDERIDS, false); 
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                try {
                    advanceRegistration(profileName, now); 
