...
public class GeckoApplication extends Application
    ...
    private void onDestroy() {
     ...
     boolean initPushService() {
        ...
        try {
            ...
            return (Boolean) onCreate.invoke(null, getApplicationContext()); 
        } catch (Exception e) {
    ...
    public static void createBrowserShortcut(final String title, final String url) {
     ...
     static void createShortcutWithIcon(final String aTitle, final String aURI,
                                                       final Bitmap aIcon) {
    ...
    public static void createAppShortcut(final String aTitle, final String aURI,
     ...
     static void showSetImageResult(final boolean success, final int message,
                                           final String path) {
        ThreadUtils.postToUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    private static void downloadImageForSetImage(final String aSrc) {
        ...
        try {
            ...
            if (image != null) {
                ...
                showSetImageResult( true,
                                   R.string.set_image_chooser_title, path);
            } else {
                showSetImageResult( false, R.string.set_image_fail, null);
            }
