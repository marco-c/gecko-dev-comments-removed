...
import java.util.concurrent.Future;
 ...
 class TopSitesCard extends RecyclerView.ViewHolder
    ...
    private final HomePager.OnUrlOpenInBackgroundListener onUrlOpenInBackgroundListener;
     ...
     TopSitesCard(FrameLayout card, final HomePager.OnUrlOpenListener onUrlOpenListener, final HomePager.OnUrlOpenInBackgroundListener onUrlOpenInBackgroundListener) {
        super(card);
