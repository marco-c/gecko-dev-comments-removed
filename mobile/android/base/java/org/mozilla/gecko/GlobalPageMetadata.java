...
import java.util.Map;
 ...
 class GlobalPageMetadata implements BundleEventListener {
    ...
    @VisibleForTesting
     void doAddOrQueue(BrowserDB db, ContentProviderClient contentProviderClient, String uri, boolean hasImage, @NonNull String metadataJSON) {
