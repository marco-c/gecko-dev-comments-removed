...
import java.util.concurrent.Future;
 ...
 class TopSitesCard extends RecyclerView.ViewHolder
    ...
    private final HomePager.OnUrlOpenInBackgroundListener onUrlOpenInBackgroundListener;
     ...
     TopSitesCard(final FrameLayout card, final HomePager.OnUrlOpenListener onUrlOpenListener, final HomePager.OnUrlOpenInBackgroundListener onUrlOpenInBackgroundListener) {
        super(card);
    ...
    private static class UpdateCardTitleAsyncTask extends URIUtils.GetFormattedDomainAsyncTask {
        private static final int VIEW_TAG_ID = R.id.title; 
