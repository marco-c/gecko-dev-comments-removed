  ...
  observe: function(aSubject, aTopic, aData) {
    switch (aTopic) {
      ...
      case "content-document-global-created": {
        ...
        win.addEventListener("contextmenu", this); 
        break;
      }
    }
  },
...
PromptDelegate.prototype = {
  ...
  _showPrompt: function(aMsg) {
    ...
    if (!this._changeModalState( true)) {
      return;
    }
    try {
  ...
  promptPassword: function(aTitle, aText, aPassword, aCheckMsg, aCheckState) {
    return this._promptUsernameAndPassword(aTitle, aText,  undefined,
  ...
  _getAuthMsg: function(aChannel, aLevel, aAuthInfo) {
    ...
    return this._addText( null, this._getAuthText(aChannel, aAuthInfo), {
      type: "auth",
