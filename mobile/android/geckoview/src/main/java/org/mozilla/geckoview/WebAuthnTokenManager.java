...
import com.google.android.gms.tasks.Task;
 ...
 class WebAuthnTokenManager {
    ...
    private static final Algorithm[] SUPPORTED_ALGORITHMS = {
        ...
        EC2Algorithm.ED256,       EC2Algorithm.ED512,
    ...
    @WrapForJNI(dispatchTo = "gecko")
     static native void webAuthnMakeCredentialFinish(final byte[] clientDataJson,
                                                                  final byte[] keyHandle,
                                                                  final byte[] attestationObject);
    @WrapForJNI(dispatchTo = "gecko")
     static native void webAuthnMakeCredentialReturnError(String errorCode);
    ...
    @WrapForJNI(dispatchTo = "gecko")
     static native void webAuthnGetAssertionFinish(final byte[] clientDataJson,
                                                                final byte[] keyHandle,
                                                                final byte[] authData,
                                                                final byte[] signature,
                                                                final byte[] userHandle);
    @WrapForJNI(dispatchTo = "gecko")
     static native void webAuthnGetAssertionReturnError(String errorCode);
}
