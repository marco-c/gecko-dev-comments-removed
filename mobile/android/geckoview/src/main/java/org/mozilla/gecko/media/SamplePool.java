...
final class SamplePool {
    ...
    private final Impl mOutputs;
     ...
     SampleBuffer getInputBuffer(final int id) {
        return mInputs.getBuffer(id);
    }

     SampleBuffer getOutputBuffer(final int id) {
