...
import org.mozilla.gecko.util.ThreadUtils;
 ...
 final class GeckoInputConnection extends BaseInputConnection
  ...
  private KeyEvent translateKey(final int keyCode, final @NonNull KeyEvent event) {
   ...
   static boolean isMediaKeyEvent(final KeyEvent event) {
   ...
   void performDefaultKeyAction(final KeyEvent event) {
