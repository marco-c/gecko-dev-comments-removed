...
public final class GeckoProcessManager extends IProcessManager.Stub {
    ...
    private static GeckoResult<Integer> start(final String type, final String[] args,
        ...
        int pid = INSTANCE.start(type, args, prefsFd, prefMapFd, ipcFd, crashFd, crashAnnotationFd,  false);
    ...
    private int start(final String type, final String[] args,
        ...
        return start(type, args, prefsFd, prefMapFd, ipcFd, crashFd, crashAnnotationFd, retry,  null);
    }
    ...
    private int start(final String type, final String[] args,
        ...
        if (!started) {
            ...
            connection.unbind();
            return start(type, args, prefsFd, prefMapFd, ipcFd, crashFd, crashAnnotationFd,  true, exception);
        }
