...
public final class RuntimeTelemetry {
  ...
  public static class Histogram extends Metric<long[]> {
    ...
    public final boolean isCategorical;
     ...
     Histogram(final boolean isCategorical, final String name, final long[] value) {
      super(name, value);
  ...
  public interface Delegate {
   ...
   static final class Proxy extends JNIObject {
    ...
    @WrapForJNI(calledFrom = "gecko")
     void dispatchStringScalar(final String name, final String value) {
      if (mDelegate == null) {
        return;
      }
    ...
    @WrapForJNI(calledFrom = "gecko")
     void dispatchBooleanScalar(final String name, final boolean value) {
      if (mDelegate == null) {
        return;
      }
    ...
    @WrapForJNI(calledFrom = "gecko")
     void dispatchLongScalar(final String name, final long value) {
      if (mDelegate == null) {
        return;
      }
