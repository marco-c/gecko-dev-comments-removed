...
public class SessionAccessibility {
     ...
     final class NodeProvider extends AccessibilityNodeProvider {
        ...
        public AccessibilityNodeInfo createAccessibilityNodeInfo(int virtualDescendantId) {
            ...
            case View.NO_ID:
                ...
                info.setClassName("android.webkit.WebView"); 
    ...
    private int getAutoFillRootId(final int id) {
     ...
     AccessibilityNodeInfo getAutoFillNode(final int id) {
     ...
     boolean performAutoFill(final int id, final String value) {
        if (mAutoFillRoots == null) {
            return false;
        }
    ...
    private void fireWindowChangedEvent(final int id) {
     ...
     void addAutoFill(final GeckoBundle message, final EventCallback callback) {
     ...
     void onAutoFillFocus(final GeckoBundle message) {
