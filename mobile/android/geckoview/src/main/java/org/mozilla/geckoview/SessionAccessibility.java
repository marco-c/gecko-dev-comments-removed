...
public class SessionAccessibility {
            ...
            switch (action) {
                ...
                case AccessibilityNodeInfo.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY:
                    ...
                    if (granularity <= BRAILLE_CLICK_BASE_INDEX) {
                        ...
                        final boolean next = action == AccessibilityNodeInfo.ACTION_NEXT_AT_MOVEMENT_GRANULARITY;
                ...
                case AccessibilityNodeInfo.ACTION_SET_SELECTION:
                    ...
                    final int selectionStart = arguments.getInt(AccessibilityNodeInfo.ACTION_ARGUMENT_SELECTION_START_INT);
                    final int selectionEnd = arguments.getInt(AccessibilityNodeInfo.ACTION_ARGUMENT_SELECTION_END_INT);
    ...
    private boolean mViewFocusRequested = false;
     ...
     static void setForceEnabled(final boolean forceEnabled) {
    ...
    public boolean onMotionEvent(final @NonNull MotionEvent event) {
     ...
     void sendEvent(final int eventType, final int sourceId, final int className, final GeckoBundle eventData) {
        ThreadUtils.assertOnUiThread();
        if (mView == null) {
            return;
        }
