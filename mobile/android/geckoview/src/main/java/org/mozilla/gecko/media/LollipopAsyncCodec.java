...
@TargetApi(Build.VERSION_CODES.LOLLIPOP)
 final class LollipopAsyncCodec implements AsyncCodec {
      ...
      public void handleMessage(final Message msg) {
        switch (msg.what) {
          case MSG_INPUT_BUFFER_AVAILABLE:
            mTarget.onInputBufferAvailable(LollipopAsyncCodec.this, msg.arg1); 
            break;
          ...
          case MSG_OUTPUT_FORMAT_CHANGE:
            mTarget.onOutputFormatChanged(
                LollipopAsyncCodec.this, (MediaFormat) msg.obj); 
            break;
          case MSG_ERROR:
            mTarget.onError(LollipopAsyncCodec.this, msg.arg1); 
            break;
          default:
