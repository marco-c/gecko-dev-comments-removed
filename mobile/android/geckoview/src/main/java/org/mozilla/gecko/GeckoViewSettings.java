...
public final class GeckoViewSettings implements Parcelable {
    ...
    public static final Key<String> DEBUGGER_SOCKET_DIR =
     ...
     static final Key<String> DATA_DIR =
        new Key<String>("dataDir",  true,  null);
    ...
    public GeckoViewSettings() {
     ...
     GeckoViewSettings(final GeckoSession session) {
        mSession = session;
     ...
     GeckoViewSettings(final GeckoViewSettings settings,
