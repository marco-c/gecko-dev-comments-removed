...
public class WebExtension {
    ...
    public final boolean allowContentMessaging;
     ...
     final @NonNull Map<String, MessageDelegateInfo> messageDelegates;
    ...
    public void setMessageDelegate(final @Nullable MessageDelegate messageDelegate,
     ...
     static class MessageDelegateInfo {
    ...
    public static class Port {
     ...
     static final WebExtension.PortDelegate NULL_PORT_DELEGATE = new WebExtension.PortDelegate() {
        @Override
