...
public class Autofill {
    ...
    public static final class Session {
        ...
        public @NonNull Rect getDefaultDimensions() {
         ...
         void setFocus(final int id, final int rootId) {
            mFocusedId = id;
         ...
         int getFocusedRootId() {
            return mFocusedRootId;
        }

         @Nullable Node getNode(final int id) {
        ...
        public @NonNull Node getRoot() {
         ...
         String getUuid(final int id) {
            return mNodes.get(id).getUuid();
        }

         int getIdFromUuid(final String uuid) {
         ...
         int mapUuidtoId(final String uuid) {
    ...
    public static final class Node {
        ...
        public int getId() {
         ...
         @NonNull Node setId(final int id) {
            mId = id;
            return this;
        }

         @NonNull Node setUuid(final String uuid) {
            mUuid = uuid;
            return this;
        }
         ...
         @NonNull Node setRootId(final int rootId) {
            mRootId = rootId;
            return this;
        }
         ...
         @NonNull Node setParentId(final int parentId) {
            mParentId = parentId;
            return this;
        }

         @NonNull Session getAutofillSession() {
            return mAutofillSession;
        }

         @NonNull Node setAutofillSession(
        ...
        public @NonNull Rect getDimensions() {
         ...
         @NonNull Node setDimensions(final Rect rect) {
            mDimens = rect;
            return this;
        }
        ...
        public @NonNull Collection<Node> getChildren() {
         ...
         @NonNull Node addChild(@NonNull final Node child) {
            mChildren.add(child);
            return this;
        }
        ...
        public @Nullable String getAttribute(@NonNull final String key) {
         ...
         @NonNull Node setAttributes(
                final Map<String, String> attributes) {
            mAttributes = attributes;
            return this;
        }

         @NonNull Node setAttribute(
        ...
        public boolean getEnabled() {
         ...
         @NonNull Node setEnabled(final boolean enabled) {
            mEnabled = enabled;
            return this;
        }
        ...
        public boolean getFocusable() {
         ...
         @NonNull Node setFocusable(final boolean focusable) {
        ...
        public @AutofillHint int getHint() {
         ...
         @NonNull Node setHint(final @AutofillHint int hint) {
            mHint = hint;
            return this;
        }
        ...
        public @NonNull String getTag() {
         ...
         @NonNull Node setTag(final String tag) {
            mTag = tag;
            return this;
        }
        ...
        public @NonNull String getDomain() {
         ...
         @NonNull Node setDomain(final String domain) {
            mDomain = domain;
            return this;
        }
        ...
        public @NonNull String getValue() {
         ...
         @NonNull Node setValue(final String value) {
            mValue = value;
            return this;
        }

         @Nullable EventCallback getCallback() {
            return mCallback;
        }

         @NonNull Node setCallback(final EventCallback callback) {
            mCallback = callback;
            return this;
        }

         Node(@NonNull final Session session) {
            mAutofillSession = session;
            mId = View.NO_ID;
        ...
        public void fillViewStructure(
         ...
         static class Builder {
            private Node mNode;
             ...
             Builder(@NonNull final Session session) {
    ...
    public interface Delegate {
     ...
     static final class Support implements BundleEventListener {
