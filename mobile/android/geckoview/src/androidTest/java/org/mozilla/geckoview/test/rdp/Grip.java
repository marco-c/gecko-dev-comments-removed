...
public class Grip extends Actor {
    ...
    private static final class LongString {
     ...
     static Object unpack(final @NonNull RDPConnection connection,
    ...
    private final ReplyParser<JSONObject> GRIP_PARSER = new ReplyParser<JSONObject>() {
     ...
     Grip(final @NonNull RDPConnection connection, final @NonNull JSONObject grip) {
    ...
    protected void release() {
     ...
     List<Object> unpackAsArray(final @NonNull Cache cache) {
     ...
     Map<String, Object> unpackAsObject(final @NonNull Cache cache) {
        final JSONObject reply = sendPacket("{\"type\":\"prototypeAndProperties\"}",
                                            GRIP_PARSER).get();
