...
public class GeckoBundleTest {
    ...
    public void intShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "int",  "double");
        testInvalidCoercions(reference, "intArray",  "doubleArray");
    }
    ...
    public void doubleShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "double",  "int");
        testInvalidCoercions(reference, "doubleArray",  "intArray");
    }
