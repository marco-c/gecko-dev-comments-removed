...
public class GeckoBundleTest {
    ...
    public void intShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "int",  "double", "long");
    ...
    public void doubleShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "double",  "int", "long");
    ...
    public void longShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "long",  "int", "double");
    ...
    public void nullStringShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "stringArrayOfNull",  "objectArrayOfNull");
    }
    ...
    public void nullBundleShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "objectArrayOfNull",  "stringArrayOfNull");
    }
    ...
    public void emptyArrayShouldNotCoerceToOtherTypes() {
        testInvalidCoercions(reference, "emptyBooleanArray",  "intArray",
                             "doubleArray", "longArray", "stringArray", "objectArray");
        testInvalidCoercions(reference, "emptyIntArray",  "booleanArray",
                             "doubleArray", "longArray", "stringArray", "objectArray");
        testInvalidCoercions(reference, "emptyDoubleArray",  "booleanArray",
                             "intArray", "longArray", "stringArray", "objectArray");
        testInvalidCoercions(reference, "emptyLongArray",  "booleanArray",
                             "intArray", "doubleArray", "stringArray", "objectArray");
        testInvalidCoercions(reference, "emptyStringArray",  "booleanArray",
                             "intArray", "doubleArray", "longArray", "objectArray");
        testInvalidCoercions(reference, "emptyObjectArray",  "booleanArray",
