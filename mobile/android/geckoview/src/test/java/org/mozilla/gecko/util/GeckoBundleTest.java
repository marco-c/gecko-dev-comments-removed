...
public class GeckoBundleTest {
  ...
  public void intShouldNotCoerceToOtherTypes() {
    ...
    testInvalidCoercions(reference, "intArray",  "doubleArray", "longArray");
  }
  ...
  public void doubleShouldNotCoerceToOtherTypes() {
    ...
    testInvalidCoercions(reference, "doubleArray",  "intArray", "longArray");
  }
  ...
  public void longShouldNotCoerceToOtherTypes() {
    ...
    testInvalidCoercions(reference, "longArray",  "intArray", "doubleArray");
  }
