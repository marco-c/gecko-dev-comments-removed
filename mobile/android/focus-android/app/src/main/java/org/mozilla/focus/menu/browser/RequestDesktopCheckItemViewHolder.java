...
import mozilla.components.support.utils.ThreadUtils;
 ...
 class RequestDesktopCheckItemViewHolder extends BrowserMenuViewHolder implements
        CheckBox.OnCheckedChangeListener {
     static final int LAYOUT_ID = R.layout.request_desktop_check_menu_item;

    private final BrowserFragment fragment;
    private CheckBox checkbox;

     RequestDesktopCheckItemViewHolder(View itemView, final BrowserFragment fragment) {
        super(itemView);
