...
public class Session {
    ...
    private boolean requestDesktopSite;
     ...
     Session(Source source, String url) {
     ...
     Session(String url, @NonNull CustomTabConfig customTabConfig) {
    ...
    public NonNullLiveData<Boolean> getSecure() {
     ...
     void setSecurityVerifier(String verifier) {
        this.securityVerifier.setValue(verifier);
    }

     void setSecurityOrigin(String origin) {
    ...
    public NonNullLiveData<Boolean> getLoading() {
     ...
     void setTrackersBlocked(int trackersBlocked) {
