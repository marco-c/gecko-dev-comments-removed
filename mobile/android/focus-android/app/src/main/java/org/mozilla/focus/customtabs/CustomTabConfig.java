...
public class CustomTabConfig {
    ...
    public static boolean isCustomTabIntent(final @NonNull SafeIntent intent) {
     ...
     static @Nullable Bitmap getCloseButtonIcon(final @NonNull Context context, final @NonNull SafeIntent intent) {
     ...
     static @Nullable ActionButtonConfig getActionButtonConfig(final @NonNull Context context, final @NonNull SafeIntent intent) {
