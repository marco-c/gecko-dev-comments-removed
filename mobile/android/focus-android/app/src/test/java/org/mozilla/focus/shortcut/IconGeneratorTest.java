...
public class IconGeneratorTest {
    ...
    public void testRepresentativeCharacter() {
        ...
        assertEquals("Ԛ", IconGenerator.getRepresentativeCharacter("http://ԛәлп.com/")); 

        
        assertEquals("X", IconGenerator.getRepresentativeCharacter("http://xn--tzend-fra.de")); 
        assertEquals("X", IconGenerator.getRepresentativeCharacter("http://xn--V8jxj3d1dzdz08w.com")); 
