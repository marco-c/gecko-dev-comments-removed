...
public class FragmentedMp4Extractor implements Extractor {
  ...
  public static final int FLAG_WORKAROUND_IGNORE_TFDT_BOX = 1 << 1; 
  



  public static final int FLAG_ENABLE_EMSG_TRACK = 1 << 2; 
  



  private static final int FLAG_SIDELOADED = 1 << 3; 
  
  public static final int FLAG_WORKAROUND_IGNORE_EDIT_LISTS = 1 << 4; 
  ...
  private static TrackBundle parseTfhd(
    ...
    int defaultSampleDuration = ((atomFlags & 0x08 ) != 0)
        ? tfhd.readUnsignedIntToInt() : defaultSampleValues.duration;
    int defaultSampleSize = ((atomFlags & 0x10 ) != 0)
        ? tfhd.readUnsignedIntToInt() : defaultSampleValues.size;
    int defaultSampleFlags = ((atomFlags & 0x20 ) != 0)
  ...
  private static void parseSenc(ParsableByteArray senc, int offset, TrackFragment out)
    ...
    boolean subsampleEncryption = (flags & 0x02 ) != 0;
  ...
  private boolean readSample(ExtractorInput input) throws IOException, InterruptedException {
    if (parserState == STATE_READING_SAMPLE_START) {
      ...
      if (MimeTypes.AUDIO_AC4.equals(currentTrackBundle.track.format.sampleMimeType)) {
        ...
        sampleBytesWritten =
            currentTrackBundle.outputSampleEncryptionData(sampleSize,  0);
      }
  ...
  private static final class TrackBundle {
    ...
    public int outputSampleEncryptionData(int sampleSize, int clearHeaderSize) {
      ...
      if (clearHeaderSize != 0) {
        ...
        scratch.readBytes(subsampleEncryptionData.data,  0, subsampleDataLength);
