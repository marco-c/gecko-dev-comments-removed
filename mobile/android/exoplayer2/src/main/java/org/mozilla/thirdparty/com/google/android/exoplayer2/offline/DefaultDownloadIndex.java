...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
  ...
  @VisibleForTesting  static final int TABLE_VERSION = 2;
  ...
  public void setDownloadingStatesToQueued() throws DatabaseIOException {
    ...
    try {
      ...
      SQLiteDatabase writableDatabase = databaseProvider.getWritableDatabase();
      writableDatabase.update(tableName, values, WHERE_STATE_IS_DOWNLOADING,  null);
  ...
  public void setStatesToRemoving() throws DatabaseIOException {
    ...
    try {
      ...
      SQLiteDatabase writableDatabase = databaseProvider.getWritableDatabase();
      writableDatabase.update(tableName, values,  null,  null);
    } catch (SQLException e) {
      throw new DatabaseIOException(e);
    }
  }
  ...
  public void setStopReason(int stopReason) throws DatabaseIOException {
    ...
    try {
      ...
      SQLiteDatabase writableDatabase = databaseProvider.getWritableDatabase();
      writableDatabase.update(tableName, values, WHERE_STATE_IS_TERMINAL,  null);
    } catch (SQLException e) {
      throw new DatabaseIOException(e);
    }
  }
  ...
  private static Download getDownloadForCurrentRow(Cursor cursor) {
    ...
    return new Download(
        ...
        state,
         ...
         cursor.getLong(COLUMN_INDEX_CONTENT_LENGTH),
