...
public final class DownloadHelper {
  ...
  public DownloadHelper(
    ...
    trackSelector.init( () -> {}, new DummyBandwidthMeter());
  ...
  public Object getManifest() {
    ...
    return mediaPreparer.timeline.getWindowCount() > 0
        ? mediaPreparer.timeline.getWindow( 0, window).manifest
        : null;
  }
  ...
  public DownloadRequest getDownloadRequest(String id, @Nullable byte[] data) {
    if (mediaSource == null) {
      return new DownloadRequest(
          id, downloadType, uri,  Collections.emptyList(), cacheKey, data);
    }
    assertPreparedWithMedia();
        ...
        case MESSAGE_CHECK_FOR_FAILURE:
          try {
            ...
            mediaSourceHandler.sendEmptyMessageDelayed(
                MESSAGE_CHECK_FOR_FAILURE,  100);
          } catch (IOException e) {
            downloadHelperHandler
                .obtainMessage(DOWNLOAD_HELPER_CALLBACK_MESSAGE_FAILED,  e)
                .sendToTarget();
          }
          return true;
