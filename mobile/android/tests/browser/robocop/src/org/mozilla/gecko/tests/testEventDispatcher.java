...
public class testEventDispatcher extends JavascriptBridgeTest implements BundleEventListener {
    ...
    private static final long WAIT_FOR_BUNDLE_EVENT_TIMEOUT_MILLIS = 20000; 
    ...
    private void testScope(final String scope) {
        ...
        testThreadEvents(scope, GECKO_EVENT, GECKO_RESPONSE_EVENT,  true);
        ...
        testThreadEvents(scope, UI_EVENT, UI_RESPONSE_EVENT,  true);
        ...
        testThreadEvents(scope, BACKGROUND_EVENT, BACKGROUND_RESPONSE_EVENT,  true);
        ...
        final int count = testThreadEvents(
                scope, JS_EVENT, JS_RESPONSE_EVENT,  false);
