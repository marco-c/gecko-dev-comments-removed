...
import java.util.concurrent.ConcurrentHashMap;
 ...
 class BookmarksSessionHelper extends SessionHelper implements BookmarksInsertionManager.BookmarkInserter {
    ...
    @Override
     void updateBookkeeping(Record record) throws NoGuidForIdException, NullCursorException, ParentNotFoundException {
    ...
    private class BookmarkWipeRunnable extends WipeRunnable {
         BookmarkWipeRunnable(RepositorySessionWipeDelegate delegate) {
            super(delegate);
        }
