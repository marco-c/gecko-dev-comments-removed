...
public class AndroidFxAccount {
  ...
  static final String BUNDLE_KEY_STATE_LABEL = "stateLabel";
   static final String BUNDLE_KEY_STATE = "state";
  ...
  private void setAuthoritiesToSyncAutomaticallyMap(Map<String, Boolean> authoritiesToSyncAutomaticallyMap) {
   ...
   Map<String, Boolean> getAuthoritiesToSyncAutomaticallyMap() {
  ...
  private class ProfileResultReceiver extends ResultReceiver {
     ProfileResultReceiver(Handler handler) {
      super(handler);
    }
  ...
  private static final Semaphore sLock = new Semaphore(1, true );
