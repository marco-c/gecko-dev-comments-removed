...
public class BatchingDownloaderController {
    ...
    @CheckResult
     static boolean setInitialResumeContextAndCommit(RepositoryStateProvider stateProvider, String offset, long since, String order) {
        if (isResumeContextSet(stateProvider)) {
    ...
    @CheckResult
     static boolean updateResumeContextAndCommit(RepositoryStateProvider stateProvider, String offset) {
        if (!isResumeContextSet(stateProvider)) {
    ...
    @CheckResult
     static boolean resetResumeContextAndCommit(RepositoryStateProvider stateProvider) {
        return stateProvider
     ...
     static boolean isResumeContextSet(RepositoryStateProvider stateProvider) {
        final String offset = stateProvider.getString(RepositoryStateProvider.KEY_OFFSET);
        final Long offsetSince = stateProvider.getLong(RepositoryStateProvider.KEY_OFFSET_SINCE);
        final String offsetOrder = stateProvider.getString(RepositoryStateProvider.KEY_OFFSET_ORDER);
