...
BEGIN_TEST(testBufferAllocPolicy_vector) {
  ...
  CHECK(testVector( true,  true));
  CHECK(testVector( true,  false));
  CHECK(testVector( false,  false));
  return true;
}
...
BEGIN_TEST(testBufferAllocPolicy_hashSet) {
  ...
  CHECK(testSet( true,  true));
  CHECK(testSet( true,  false));
  CHECK(testSet( false,  false));
  return true;
}
