...
END_TEST(testFrontendErrors_error)
 ...
 bool cls_testFrontendErrors_error::warningReporterCalled = false;
...
END_TEST(testFrontendErrors_warning)
 ...
 const char* cls_testFrontendErrors_warning::filename =
    "testFrontendErrors_warning.js";
 bool cls_testFrontendErrors_warning::warningReporterCalled = false;
 bool cls_testFrontendErrors_warning::errorNumberMatches = false;
 bool cls_testFrontendErrors_warning::filenameMatches = false;
...
END_TEST(testFrontendErrors_oom)
 ...
 bool cls_testFrontendErrors_oom::warningReporterCalled = false;
...
END_TEST(testFrontendErrors_overRecursed)
 ...
 bool cls_testFrontendErrors_overRecursed::warningReporterCalled =
    false;
