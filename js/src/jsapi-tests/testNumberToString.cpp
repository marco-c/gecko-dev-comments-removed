...
static const struct NumberToStringTest {
  ...
  size_t expectedLength;
    ...
    {5e-324, STR("5e-324")},                                
    {9.5367431640625e-7, STR("9.5367431640625e-7")},        
    {0.0000019073486328125, STR("0.0000019073486328125")},  
    {0.000003814697265625, STR("0.000003814697265625")},    
    {0.0000057220458984375, STR("0.0000057220458984375")},  
    {0.000244140625, STR("0.000244140625")},                
    {0.125, STR("0.125")},
    {0.25, STR("0.25")},
    {0.5, STR("0.5")},
    {1, STR("1")},
