...
template <typename... Args>
using ArgsMoveOps_t =
    std::integer_sequence<MoveOp::Type, TypeToMoveOp<Args>()...>;
...
bool CheckArgsEqual(std::integer_sequence<Int, Val...>, Args... args) {
  return ((ConvertToInt<Args>(args) == IntTypeOf_t<Args>(Val)) && ...);
}
...
struct DefineCheckArgs<Res (*)(Args...)> {
  ...
  static Res CheckArgsBitOfPositions0(Args... args) {
    AutoUnsafeCallWithABI unsafe;
  ...
  static Res CheckArgsBitOfPositions1(Args... args) {
    AutoUnsafeCallWithABI unsafe;
  ...
  static Res CheckArgsBitOfPositions2(Args... args) {
    AutoUnsafeCallWithABI unsafe;
  ...
  static Res CheckArgsBitOfPositions3(Args... args) {
    AutoUnsafeCallWithABI unsafe;
  ...
  static Res CheckArgsFillBits(Args... args) {
    AutoUnsafeCallWithABI unsafe;
    using FillBits = ArgsFillBits_t<Args...>;
    bool res = CheckArgsEqual<Args...>(FillBits(), std::forward<Args>(args)...);
    instance_->check_result(res);
    return Res();
  }
 ...
 private:
  ...
  static DefineCheckArgs* instance_;
};
...
#  error "Unknown architecture!"
 ...
 private:
  ...
  bool check_result_wrapped(bool res) {
