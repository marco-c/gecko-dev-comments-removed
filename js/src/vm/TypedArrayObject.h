...
class DataViewObject : public NativeObject
{
  private:
    ...
    static bool constructSameCompartment(JSContext* cx, JSObject* bufobj, const CallArgs& args);
    static bool constructWrapped(JSContext* cx, JSObject* bufobj, const CallArgs& args);
