...
class MutableWrappedPtrOperations<SavedFrame::Lookup, Wrapper>
 ...
 bool SavedFrame::finishSavedFrameInit(JSContext* cx,
                                                   HandleObject ctor,
                                                   HandleObject proto) {
...
uint32_t SavedFrame::wasmBytecodeOffset() {
 ...
 bool SavedFrame::construct(JSContext* cx, unsigned argc,
                                        Value* vp) {
...
namespace js {
 ...
 bool SavedFrame::sourceProperty(JSContext* cx, unsigned argc,
                                             Value* vp) {
 ...
 bool SavedFrame::sourceIdProperty(JSContext* cx, unsigned argc,
                                             Value* vp) {
 ...
 bool SavedFrame::lineProperty(JSContext* cx, unsigned argc,
                                           Value* vp) {
 ...
 bool SavedFrame::columnProperty(JSContext* cx, unsigned argc,
                                             Value* vp) {
 ...
 bool SavedFrame::asyncCauseProperty(JSContext* cx, unsigned argc,
                                                 Value* vp) {
 ...
 bool SavedFrame::asyncParentProperty(JSContext* cx, unsigned argc,
                                                  Value* vp) {
 ...
 bool SavedFrame::parentProperty(JSContext* cx, unsigned argc,
                                             Value* vp) {
 ...
 bool SavedFrame::toStringMethod(JSContext* cx, unsigned argc,
                                             Value* vp) {
