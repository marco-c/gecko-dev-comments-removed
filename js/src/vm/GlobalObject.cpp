...
TypedObjectModuleObject& js::GlobalObject::getTypedObjectModule() const {
 ...
 bool GlobalObject::skipDeselectedConstructor(JSContext* cx,
                                                          JSProtoKey key) {
  switch (key) {
 ...
 bool GlobalObject::maybeResolveGlobalThis(
...
const Class GlobalObject::OffThreadPlaceholderObject::class_ = {
 ...
 GlobalObject::OffThreadPlaceholderObject*
...
inline int32_t GlobalObject::OffThreadPlaceholderObject::getSlotIndex() const {
 ...
 bool GlobalObject::resolveOffThreadConstructor(
 ...
 JSObject* GlobalObject::createOffThreadObject(
...
JSObject* GlobalObject::getPrototypeForOffThreadPlaceholder(JSObject* obj) {
 ...
 bool GlobalObject::initBuiltinConstructor(
    JSContext* cx, Handle<GlobalObject*> global, JSProtoKey key,
    HandleObject ctor, HandleObject proto) {
  MOZ_ASSERT(!global->empty());  
  MOZ_ASSERT(key != JSProto_Null);
  MOZ_ASSERT(ctor);
  MOZ_ASSERT(proto);
...
GlobalObject* GlobalObject::createInternal(JSContext* cx, const Class* clasp) {
 ...
 GlobalObject* GlobalObject::new_(
...
GlobalScope& GlobalObject::emptyGlobalScope() const {
 ...
 bool GlobalObject::getOrCreateEval(JSContext* cx,
                                                Handle<GlobalObject*> global,
...
bool GlobalObject::valueIsEval(const Value& val) {
 ...
 bool GlobalObject::initStandardClasses(
    JSContext* cx, Handle<GlobalObject*> global) {
...
static bool InitBareBuiltinCtor(JSContext* cx, Handle<GlobalObject*> global,
 ...
 bool GlobalObject::initSelfHostingBuiltins(
    JSContext* cx, Handle<GlobalObject*> global,
 ...
 bool GlobalObject::isRuntimeCodeGenEnabled(
 ...
 JSFunction* GlobalObject::createConstructor(
...
static NativeObject* CreateBlankProto(JSContext* cx, const Class* clasp,
 ...
 NativeObject* GlobalObject::createBlankPrototype(
 ...
 NativeObject* GlobalObject::createBlankPrototypeInheriting(
...
bool GlobalObject::hasRegExpStatics() const {
 ...
 RegExpStatics* GlobalObject::getRegExpStatics(
    JSContext* cx, Handle<GlobalObject*> global) {
  MOZ_ASSERT(cx);
...
RegExpStatics* GlobalObject::getAlreadyCreatedRegExpStatics() const {
 ...
 NativeObject* GlobalObject::getIntrinsicsHolder(
    JSContext* cx, Handle<GlobalObject*> global) {
 ...
 bool GlobalObject::getSelfHostedFunction(
    JSContext* cx, Handle<GlobalObject*> global,
 ...
 bool GlobalObject::ensureModulePrototypesCreated(
    JSContext* cx, Handle<GlobalObject*> global) {
