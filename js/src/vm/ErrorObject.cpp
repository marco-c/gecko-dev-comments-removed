...
using namespace js;
 ...
 Shape* js::ErrorObject::assignInitialShape(
 ...
 ErrorObject* js::ErrorObject::create(
...
static MOZ_ALWAYS_INLINE bool IsObject(HandleValue v) { return v.isObject(); }
 ...
 bool js::ErrorObject::getStack(JSContext* cx, unsigned argc,
                                            Value* vp) {
 ...
 bool js::ErrorObject::getStack_impl(JSContext* cx,
                                                 const CallArgs& args) {
 ...
 bool js::ErrorObject::setStack(JSContext* cx, unsigned argc,
                                            Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
 ...
 bool js::ErrorObject::setStack_impl(JSContext* cx,
                                                 const CallArgs& args) {
  RootedObject thisObj(cx, &args.thisv().toObject());
