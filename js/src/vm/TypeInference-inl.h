...
inline StackTypeSet* TypeScript::bytecodeTypes(const AutoSweepTypeScript& sweep,
 ...
 inline void TypeScript::MonitorBytecodeType(
    JSContext* cx, JSScript* script, jsbytecode* pc, const js::Value& rval) {
  TypeMonitorResult(cx, script, pc, rval);
}

 inline void TypeScript::MonitorBytecodeType(JSContext* cx,
                                                         JSScript* script,
                                                         jsbytecode* pc,
                                                         TypeSet::Type type) {
 ...
 inline void TypeScript::MonitorThisType(JSContext* cx,
                                                     JSScript* script,
                                                     TypeSet::Type type) {
 ...
 inline void TypeScript::MonitorArgType(JSContext* cx,
                                                    JSScript* script,
                                                    unsigned arg,
                                                    TypeSet::Type type) {
