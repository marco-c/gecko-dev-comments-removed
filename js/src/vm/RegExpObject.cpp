...
bool VectorMatchPairs::allocOrExpandArray(size_t pairCount) {
 ...
 RegExpShared* RegExpObject::getShared(
 ...
 bool RegExpObject::isOriginalFlagGetter(JSNative native,
                                                     RegExpFlag* mask) {
...
RegExpObject* RegExpObject::create(JSContext* cx, HandleAtom source,
 ...
 RegExpShared* RegExpObject::createShared(
    JSContext* cx, Handle<RegExpObject*> regexp) {
...
#ifdef DEBUG
 bool RegExpShared::dumpBytecode(JSContext* cx,
...
#undef BRANCH
 ...
 bool RegExpObject::dumpBytecode(JSContext* cx,
...
void RegExpShared::finalize(FreeOp* fop) {
 ...
 bool RegExpShared::compile(JSContext* cx,
                                        MutableHandleRegExpShared re,
                                        HandleLinearString input,
 ...
 bool RegExpShared::compile(
  ...
  irregexp::RegExpCode code = irregexp::CompilePattern(
      cx, allocScope.alloc(), re, &data, input, false ,
 ...
 RegExpRunStatus RegExpShared::execute(
