...
const ClassOps WasmModuleObject::classOps_ = {nullptr, 
                                              nullptr, 
                                              nullptr, 
                                              nullptr, 
                                              nullptr, 
...
static JSString* UTF8CharsToString(JSContext* cx, const char* chars) {
 ...
 bool WasmModuleObject::imports(JSContext* cx, unsigned argc,
                                            Value* vp) {
 ...
 bool WasmModuleObject::exports(JSContext* cx, unsigned argc,
                                            Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
 ...
 bool WasmModuleObject::customSections(JSContext* cx, unsigned argc,
                                                   Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
static bool ReportCompileWarnings(JSContext* cx,
 ...
 bool WasmModuleObject::construct(JSContext* cx, unsigned argc,
                                              Value* vp) {
...
const ClassOps WasmInstanceObject::classOps_ = {nullptr, 
                                                nullptr, 
                                                nullptr, 
                                                nullptr, 
                                                nullptr, 
...
static bool Instantiate(JSContext* cx, const Module& module,
 ...
 bool WasmInstanceObject::construct(JSContext* cx, unsigned argc,
                                                Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
const ClassOps WasmMemoryObject::classOps_ = {nullptr, 
                                              nullptr, 
                                              nullptr, 
                                              nullptr, 
                                              nullptr, 
...
const Class WasmMemoryObject::class_ = {
 ...
 bool WasmMemoryObject::construct(JSContext* cx, unsigned argc,
                                              Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
static bool IsMemory(HandleValue v) {
 ...
 bool WasmMemoryObject::bufferGetterImpl(JSContext* cx,
                                                     const CallArgs& args) {
 ...
 bool WasmMemoryObject::bufferGetter(JSContext* cx, unsigned argc,
                                                 Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
const JSPropertySpec WasmMemoryObject::properties[] = {
 ...
 bool WasmMemoryObject::growImpl(JSContext* cx,
                                             const CallArgs& args) {
 ...
 bool WasmMemoryObject::grow(JSContext* cx, unsigned argc,
                                         Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
bool WasmMemoryObject::addMovingGrowObserver(JSContext* cx,
 ...
 uint32_t WasmMemoryObject::growShared(
 ...
 uint32_t WasmMemoryObject::grow(HandleWasmMemoryObject memory,
...
const ClassOps WasmTableObject::classOps_ = {nullptr, 
                                             nullptr, 
                                             nullptr, 
                                             nullptr, 
                                             nullptr, 
...
bool WasmTableObject::isNewborn() const {
 ...
 WasmTableObject* WasmTableObject::create(JSContext* cx,
                                                      const Limits& limits,
                                                      TableKind tableKind) {
  ...
  TableDesc td(tableKind, limits, true);
 ...
 bool WasmTableObject::construct(JSContext* cx, unsigned argc,
                                             Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
static bool IsTable(HandleValue v) {
 ...
 bool WasmTableObject::lengthGetterImpl(JSContext* cx,
                                                    const CallArgs& args) {
  args.rval().setNumber(
 ...
 bool WasmTableObject::lengthGetter(JSContext* cx, unsigned argc,
                                                Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
static bool ToTableIndex(JSContext* cx, HandleValue v, const Table& table,
 ...
 bool WasmTableObject::getImpl(JSContext* cx,
                                           const CallArgs& args) {
 ...
 bool WasmTableObject::get(JSContext* cx, unsigned argc,
                                       Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
                              ...
                              uint32_t index, uint32_t limit)
{
 ...
 bool WasmTableObject::setImpl(JSContext* cx,
                                           const CallArgs& args) {
  RootedWasmTableObject tableObj(
      cx, &args.thisv().toObject().as<WasmTableObject>());
 ...
 bool WasmTableObject::set(JSContext* cx, unsigned argc,
                                       Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
  return CallNonGenericMethod<IsTable, setImpl>(cx, args);
}

 bool WasmTableObject::growImpl(JSContext* cx,
                                            const CallArgs& args) {
  RootedWasmTableObject table(cx,
  ...
  MOZ_ASSERT(delta <= MaxTableLength); 
 ...
 bool WasmTableObject::grow(JSContext* cx, unsigned argc,
                                        Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
const ClassOps WasmGlobalObject::classOps_ = {nullptr, 
                                              nullptr, 
                                              nullptr, 
                                              nullptr, 
                                              nullptr, 
...
const Class WasmGlobalObject::class_ = {
 ...
 WasmGlobalObject* WasmGlobalObject::create(JSContext* cx,
                                                        HandleVal hval,
                                                        bool isMutable) {
  RootedObject proto(
 ...
 bool WasmGlobalObject::construct(JSContext* cx, unsigned argc,
                                              Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
...
static bool IsGlobal(HandleValue v) {
 ...
 bool WasmGlobalObject::valueGetterImpl(JSContext* cx,
                                                    const CallArgs& args) {
 ...
 bool WasmGlobalObject::valueGetter(JSContext* cx, unsigned argc,
                                                Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
  return CallNonGenericMethod<IsGlobal, valueGetterImpl>(cx, args);
}

 bool WasmGlobalObject::valueSetterImpl(JSContext* cx,
                                                    const CallArgs& args) {
 ...
 bool WasmGlobalObject::valueSetter(JSContext* cx, unsigned argc,
                                                Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
