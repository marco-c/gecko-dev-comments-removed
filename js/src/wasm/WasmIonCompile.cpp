...
#  endif
 ...
 public:
  ...
  [[nodiscard]] bool refCast(MDefinition* ref, uint32_t castTypeIndex) {
    MDefinition* success =
        isGcObjectSubtypeOf(ref, castTypeIndex, true);
    if (!success) {
      return false;
    }
  ...
  [[nodiscard]] MDefinition* refTest(MDefinition* ref, uint32_t castTypeIndex) {
    return isGcObjectSubtypeOf(ref, castTypeIndex, false);
  }
  ...
  [[nodiscard]] bool brOnCastCommon(bool onSuccess, uint32_t labelRelativeDepth,
    ...
    MDefinition* success =
        isGcObjectSubtypeOf(ref, castTypeIndex, false);
    if (!success) {
      return false;
    }
      ...
      case uint16_t(Op::GcPrefix): {
        ...
        switch (op.b1) {
          ...
          case uint32_t(GcOp::BrOnCast):
            CHECK(EmitBrOnCastCommon(f, true));
          case uint32_t(GcOp::BrOnCastFail):
            CHECK(EmitBrOnCastCommon(f, false));
