...
EmitExpr(FunctionCompiler& f)
{
    ...
    switch (op) {
      ...
      case Op::CallIndirect:
        return EmitCallIndirect(f,  false);
      case Op::OldCallIndirect:
        return EmitCallIndirect(f,  true);
      ...
      case Op::F32Div:
        return EmitDiv(f, ValType::F32, MIRType::Float32,  false);
      case Op::F32Min:
      case Op::F32Max:
      ...
      case Op::F64Div:
        return EmitDiv(f, ValType::F64, MIRType::Double,  false);
      case Op::F64Mod:
        return EmitRem(f, ValType::F64, MIRType::Double,  false);
      case Op::F64Min:
      case Op::F64Max:
