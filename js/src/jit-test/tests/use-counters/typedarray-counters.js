...
TYPED_ARRAY_FROM.forEach((x) => {
    test_function_for_use_counter_integration(x, "SubclassingTypedArrayTypeII",   false)
})
SUBCLASS_FROM.forEach((x) => {
    test_function_for_use_counter_integration(x, "SubclassingTypedArrayTypeII",   true)
})
...
test_function_for_use_counter_integration(int8_test, "SubclassingTypedArrayTypeIII",  false);
test_function_for_use_counter_integration(myint8_test, "SubclassingTypedArrayTypeIII",  true);
