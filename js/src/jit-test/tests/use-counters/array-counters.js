...
test_function_for_use_counter_integration(array_from, "SubclassingArrayTypeII",  false);
test_function_for_use_counter_integration(array_from_subclassing_type_ii, "SubclassingArrayTypeII",  true);
...
test_function_for_use_counter_integration(array_of, "SubclassingArrayTypeII",  false);
test_function_for_use_counter_integration(array_of_subclassing_type_ii, "SubclassingArrayTypeII",  true);
...
test_function_for_use_counter_integration(array_fromAsync, "SubclassingArrayTypeII",  false);
test_function_for_use_counter_integration(array_fromAsync_subclassing_type_ii, "SubclassingArrayTypeII",  true);
...
test_function_for_use_counter_integration(array_concat, "SubclassingArrayTypeIII",  false);
test_function_for_use_counter_integration(array_concat_subclassing_type_iii, "SubclassingArrayTypeIII",  true);

function array_map() {
    var arr = new MyArray([1, 2, 3]);
    arr.map(x => x + 1);
}
test_function_for_use_counter_integration(array_map, "SubclassingArrayTypeIII",  false);
