...
assertErrorMessage(() => new Module(new Uint8Array()),  TypeError, /wasm validation error/);
assertErrorMessage(() => new Module(new ArrayBuffer()),  TypeError, /wasm validation error/);
