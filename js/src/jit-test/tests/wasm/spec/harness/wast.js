...
function add_hex_char(buf, c) {
  return Curry._1(Printf.bprintf(buf, [
                  Block.__(12, [
                      92,
                      Block.__(4, [
                          6,
...
function break_bytes(s) {
  var ss = Curry._2(Lib.$$String[0], s, 16);
  var f = function (param) {
    return Block.__(0, [string_with(add_hex_char, param)]);
  };
...
function decls(kind, ts) {
  var head = kind;
  var f = function (param) {
    return Block.__(0, [Types.string_of_value_type(param)]);
  };
  var xs = ts;
  if (xs) {
    return [
...
function limits(nat, param) {
  var xs = list_of_opt(param[1]);
  return $$String.concat(" ", [
              Curry._1(nat, param[0]),
              List.map(nat, xs)
            ]);
}
...
function global_type(param) {
  ...
  if (param[1] !== 0) {
    return Block.__(1, [
              "mut",
              [
                Block.__(0, [Types.string_of_value_type(t)]),
                0
              ]
            ]);
  }
  else {
    return Block.__(0, [Types.string_of_value_type(t)]);
  }
}
...
function $$var(x) {
  return Curry._1(I32.to_string_u, x[1]);
}

function constop(v) {
  return Types.string_of_value_type(Values.type_of(v[1])) + ".const";
}
...
function instr(e) {
  ...
  if (typeof match === "number") {
    ...
    switch (match.tag | 0) {
      ...
      case 3 : 
          match$1 = [
            "br " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 4 : 
          match$1 = [
            "br_if " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 5 : 
      ...
      case 6 : 
          match$1 = [
            "call " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 7 : 
          match$1 = [
            "call_indirect " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 8 : 
          match$1 = [
            "get_local " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 9 : 
          match$1 = [
            "set_local " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 10 : 
          match$1 = [
            "tee_local " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 11 : 
          match$1 = [
            "get_global " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 12 : 
          match$1 = [
            "set_global " + Curry._1(I32.to_string_u, match[0][1]),
            0
          ];
          break;
      case 13 : 
      ...
      case 15 : 
          var lit = match[0];
          match$1 = [
            constop(lit) + (" " + Values.string_of_value(lit[1])),
            0
          ];
          break;
      case 16 : 
...
function func_with_name(name, f) {
  ...
  return Block.__(1, [
            ...
            Pervasives.$at([
                  Block.__(1, [
                      "type " + Curry._1(I32.to_string_u, match[0][1]),
                      0
                    ]),
                  0
                ], Pervasives.$at(decls("local", match[1]), List.map(instr, match[2])))
          ]);
}
...
function start(x) {
  return Block.__(1, [
            "start " + Curry._1(I32.to_string_u, x[1]),
            0
          ]);
}
...
function table(off, i, tab) {
  ...
  return Block.__(1, [
            ...
            [
              Block.__(0, [Types.string_of_elem_type(match$1[1])]),
              0
            ]
          ]);
}
...
function memory(off, i, mem) {
  var match = mem[1];
  return Block.__(1, [
            "memory $" + (Curry._1(I32.to_string_u, Curry._1(I32.of_int_u, off + i | 0)) + (" " + limits(I32.to_string_u, match[0][0]))),
            0
          ]);
}
...
function segment(head, dat, seg) {
  ...
  return Block.__(1, [
            head,
            [
              Block.__(0, [Curry._1(I32.to_string_u, match[0][1])]),
              [
                Block.__(1, [
                    "offset",
                    List.map(instr, match[1][1])
                  ]),
                Curry._1(dat, match[2])
              ]
            ]
          ]);
}
...
function elems(seg) {
  return segment("elem", function (param) {
              return List.map(function (param) {
                          return Block.__(0, [Curry._1(I32.to_string_u, param[1])]);
                        }, param);
            }, seg);
}
...
function import_kind(i, k) {
  ...
  switch (match.tag | 0) {
    ...
    case 1 : 
        return table(0, i, Source.$at$at([match[0]], k[0]));
    case 2 : 
        return memory(0, i, Source.$at$at([match[0]], k[0]));
    case 3 : 
        return Block.__(1, [
...
function $$import(i, im) {
  ...
  return Block.__(1, [
            "import",
            [
              Block.__(0, [string_with(add_char, match[0])]),
              [
                Block.__(0, [string_with(add_char, match[1])]),
                [
                  import_kind(i, match[2]),
                  0
                ]
              ]
            ]
            ...
            [
              ...
              [
                Block.__(1, [
                    export_kind(match[1]),
                    [
                      Block.__(0, [Curry._1(I32.to_string_u, match[2][1])]),
                      0
                    ]
                  ]),
                0
...
function module_with_var_opt(x_opt, m) {
  var func_imports = List.filter(is_func_import)(m[1][8]);
  var table_imports = List.filter(is_table_import)(m[1][8]);
  var memory_imports = List.filter(is_memory_import)(m[1][8]);
  var global_imports = List.filter(is_global_import)(m[1][8]);
  ...
  var xs = list_of_opt(m[1][5]);
  return Block.__(1, [
            "module" + var_opt(x_opt),
            Pervasives.$at(List.mapi(typedef, m[1][0]), Pervasives.$at(List.mapi($$import, table_imports), Pervasives.$at(List.mapi($$import, memory_imports), Pervasives.$at(List.mapi($$import, global_imports), Pervasives.$at(List.mapi($$import, func_imports), Pervasives.$at(List.mapi(f, m[1][2]), Pervasives.$at(List.mapi(f$1, m[1][3]), Pervasives.$at(List.mapi(f$2, m[1][1]), Pervasives.$at(List.mapi(f$3, m[1][4]), Pervasives.$at(List.map($$export, m[1][9]), Pervasives.$at(List.map(start, xs), Pervasives.$at(List.map(elems, m[1][6]), List.map(data, m[1][7])))))))))))))
          ]);
}

function module_(param) {
  return module_with_var_opt(0, param);
}
                    ...
                    switch (match$1.tag | 0) {
                      case 0 : 
                          return Block.__(1, [
                                    "assert_malformed",
                                    [
                                      definition(983167089, 0, match$1[0]),
                                      [
                                        Block.__(0, [string_with(add_char, match$1[1])]),
                                        0
                                      ]
                                    ]
                                  ]);
...
function import_type(m, im) {
  ...
  switch (match$1.tag | 0) {
    case 0 : 
        return Block.__(0, [Curry._2(Lib.List32[1], m[1][0], match$1[0][1])]);
    case 1 : 
        return Block.__(1, [match$1[0]]);
    case 2 : 
        return Block.__(2, [match$1[0]]);
    case 3 : 
        return Block.__(3, [match$1[0]]);
...
function export_type(m, ex) {
  ...
  while(true) {
    ...
    if (param) {
      var ims = param[1];
      var im = param[0];
      if (Caml_obj.caml_equal(export_kind_of_import_kind(im[1][2][1]), ekind[1])) {
        if (i) {
          _param = ims;
          _i = i - 1 | 0;
          continue ;
      ...
      switch (match$1) {
        case 0 : 
            return Block.__(0, [Curry._2(Lib.List32[1], m[1][0], Curry._2(Lib.List32[1], m[1][4], i)[1][0][1])]);
        case 1 : 
            return Block.__(1, [Curry._2(Lib.List32[1], m[1][2], i)[1][0]]);
        case 2 : 
            return Block.__(2, [Curry._2(Lib.List32[1], m[1][3], i)[1][0]]);
        case 3 : 
            return Block.__(3, [Curry._2(Lib.List32[1], m[1][1], i)[1][0]]);
...
function blit(src, srcoff, dst, dstoff, len) {
  if (len < 0 || srcoff < 0 || srcoff > (src[1] - len | 0) || dstoff < 0 || dstoff > (dst.length - len | 0)) {
    throw [
          Caml_builtin_exceptions.invalid_argument,
          "Buffer.blit"
        ];
...
function resize(b, more) {
  var len = b[2];
  var new_len = len;
  while((b[1] + more | 0) > new_len) {
    new_len = (new_len << 1);
  };
  if (new_len > Sys.max_string_length) {
    if ((b[1] + more | 0) <= Sys.max_string_length) {
...
function caml_int32_bits_of_float(x) {
  var float32 = new Float32Array([x]);
    ...
    if (i >= len) {
      ...
      if (c >= 69) {
        if (c >= 88) {
          ...
          f[5] = 1;
          f[7] = 1;
          f[10] = String.fromCharCode(lowercase(c));
          _i = i + 1 | 0;
          continue ;
        ...
        if (switcher > 25 || switcher < 0) {
          ...
          switch (switcher) {
            ...
            case 13 : 
                ...
                while((function(j){
                    return function () {
                      var w = fmt.charCodeAt(j) - 48 | 0;
                      return +(w >= 0 && w <= 9);
                    }
                    }(j))()) {
                  f[9] = (Caml_int32.imul(f[9], 10) + fmt.charCodeAt(j) | 0) - 48 | 0;
                  j = j + 1 | 0;
                };
                _i = j;
                continue ;
      ...
      switch (exit) {
        case 1 : 
            ...
            while((function(j$1){
                return function () {
                  var w = fmt.charCodeAt(j$1) - 48 | 0;
                  return +(w >= 0 && w <= 9);
                }
                }(j$1))()) {
              f[6] = (Caml_int32.imul(f[6], 10) + fmt.charCodeAt(j$1) | 0) - 48 | 0;
              j$1 = j$1 + 1 | 0;
            };
            _i = j$1;
            continue ;
...
function finish_formatting(param, rawbuffer) {
  var justify = param[0];
  var signstyle = param[1];
  var filter = param[2];
  var alternate = param[3];
  var base = param[4];
  var signedconv = param[5];
  var width = param[6];
  var uppercase = param[7];
  var sign = param[8];
...
function caml_format_int(fmt, i) {
  if (fmt === "%d") {
    ...
    var i$1 = i;
    var i$2 = i$1 < 0 ? (
        f$1[5] ? (f$1[8] = -1, -i$1) : (i$1 >>> 0)
      ) : i$1;
    var s = i$2.toString(int_of_base(f$1[4]));
    if (f$1[9] >= 0) {
      f$1[2] = " ";
      var n = f$1[9] - s.length | 0;
      if (n > 0) {
...
function caml_int64_format(fmt, x) {
  var f = parse_format(fmt);
  var x$1 = f[5] && Caml_int64.lt(x, [
        0,
        0
      ]) ? (f[8] = -1, Caml_int64.neg(x)) : x;
  var s = "";
  var match = f[4];
  switch (match) {
    case 0 : 
...
function caml_format_float(fmt, x) {
  var f = parse_format(fmt);
  var prec = f[9] < 0 ? 6 : f[9];
  var x$1 = x < 0 ? (f[8] = -1, -x) : x;
  var s = "";
  if (isNaN(x$1)) {
    s = "nan";
    f[2] = " ";
...
function add(param, param$1) {
  var other_low_ = param$1[1];
  var this_low_ = param[1];
  var lo = this_low_ + other_low_ & 4294967295;
  var overflow = neg_signed(this_low_) && (neg_signed(other_low_) || !neg_signed(lo)) || neg_signed(other_low_) && !neg_signed(lo) ? 1 : 0;
  var hi = param[0] + param$1[0] + overflow & 4294967295;
  return [
          hi,
          (lo >>> 0)
        ];
...
function swap(param) {
  var hi = Caml_int32.caml_int32_bswap(param[1]);
  var lo = Caml_int32.caml_int32_bswap(param[0]);
  return [
          hi,
          (lo >>> 0)
        ];
...
function compare(self, other) {
  var v = Caml_obj.caml_nativeint_compare(self[0], other[0]);
  if (v) {
    return v;
  }
  else {
    return Caml_obj.caml_nativeint_compare(self[1], other[1]);
  }
}
    ...
    if (match$1 !== 0) {
      if (match !== 0) {
        ...
        if (pad <= 0) {
          ...
          return aux(x[0]) + (Caml_utils.repeat(pad, "0") + lo);
        }
      }
      else {
        return aux(x[1]);
...
function erase_rel(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case 0 : 
          return Block.__(0, [erase_rel(param[0])]);
      case 1 : 
          return Block.__(1, [erase_rel(param[0])]);
      case 2 : 
          return Block.__(2, [erase_rel(param[0])]);
      case 3 : 
          return Block.__(3, [erase_rel(param[0])]);
      case 4 : 
          return Block.__(4, [erase_rel(param[0])]);
      case 5 : 
          return Block.__(5, [erase_rel(param[0])]);
      case 6 : 
          return Block.__(6, [erase_rel(param[0])]);
      case 7 : 
          return Block.__(7, [erase_rel(param[0])]);
      case 8 : 
          return Block.__(8, [
                    param[0],
                    erase_rel(param[1])
      ...
      case 10 : 
          return Block.__(10, [erase_rel(param[0])]);
      case 11 : 
          return Block.__(11, [erase_rel(param[0])]);
      case 12 : 
          return Block.__(12, [erase_rel(param[0])]);
      case 13 : 
          return Block.__(13, [erase_rel(param[0])]);
      case 14 : 
          return Block.__(14, [erase_rel(param[0])]);
...
function concat_fmtty(fmtty1, fmtty2) {
  if (typeof fmtty1 === "number") {
    ...
    switch (fmtty1.tag | 0) {
      case 0 : 
          return Block.__(0, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 1 : 
          return Block.__(1, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 2 : 
          return Block.__(2, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 3 : 
          return Block.__(3, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 4 : 
          return Block.__(4, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 5 : 
          return Block.__(5, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 6 : 
          return Block.__(6, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 7 : 
          return Block.__(7, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 8 : 
          return Block.__(8, [
                    fmtty1[0],
      ...
      case 10 : 
          return Block.__(10, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 11 : 
          return Block.__(11, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 12 : 
          return Block.__(12, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 13 : 
          return Block.__(13, [concat_fmtty(fmtty1[0], fmtty2)]);
      case 14 : 
          return Block.__(14, [concat_fmtty(fmtty1[0], fmtty2)]);
...
function concat_fmt(fmt1, fmt2) {
  if (typeof fmt1 === "number") {
    ...
    switch (fmt1.tag | 0) {
      case 0 : 
          return Block.__(0, [concat_fmt(fmt1[0], fmt2)]);
      case 1 : 
          return Block.__(1, [concat_fmt(fmt1[0], fmt2)]);
      case 2 : 
          return Block.__(2, [
                    fmt1[0],
      ...
      case 9 : 
          return Block.__(9, [concat_fmt(fmt1[0], fmt2)]);
      case 10 : 
          return Block.__(10, [concat_fmt(fmt1[0], fmt2)]);
      case 11 : 
          return Block.__(11, [
                    fmt1[0],
                    concat_fmt(fmt1[1], fmt2)
      ...
      case 15 : 
          return Block.__(15, [concat_fmt(fmt1[0], fmt2)]);
      case 16 : 
          return Block.__(16, [concat_fmt(fmt1[0], fmt2)]);
      case 17 : 
          return Block.__(17, [
                    fmt1[0],
                    concat_fmt(fmt1[1], fmt2)
      ...
      case 19 : 
          return Block.__(19, [concat_fmt(fmt1[0], fmt2)]);
      case 20 : 
          return Block.__(20, [
                    fmt1[0],
                    fmt1[1],
      ...
      case 22 : 
          return Block.__(22, [concat_fmt(fmt1[0], fmt2)]);
      case 23 : 
          return Block.__(23, [
                    fmt1[0],
                    concat_fmt(fmt1[1], fmt2)
...
function rev_char_set(char_set) {
  var char_set$prime = Bytes.make(32, 0);
  for(var i = 0; i <= 31; ++i){
...
function param_format_of_ignored_format(ign, fmt) {
  if (typeof ign === "number") {
    switch (ign) {
      case 0 : 
          return [Block.__(0, [fmt])];
      case 1 : 
          return [Block.__(1, [fmt])];
      case 2 : 
          return [Block.__(9, [fmt])];
      case 3 : 
          return [Block.__(19, [fmt])];
      case 4 : 
          return [Block.__(22, [fmt])];
...
function bprint_char_set(buf, char_set) {
  ...
  print_start(is_in_char_set(char_set, 0) ? (buffer_add_char(buf, 94), rev_char_set(char_set)) : char_set);
    ...
    if (typeof fmt$1 === "number") {
      ...
      switch (fmt$1.tag | 0) {
        case 0 : 
            ...
            continue ;
            case 5 : 
            bprint_altint_fmt(buf, ign_flag, fmt$1[0], fmt$1[1], fmt$1[2], 108);
            _ign_flag = 0;
            _fmt = fmt$1[3];
            continue ;
            case 6 : 
            bprint_altint_fmt(buf, ign_flag, fmt$1[0], fmt$1[1], fmt$1[2], 110);
            _ign_flag = 0;
            _fmt = fmt$1[3];
            continue ;
            case 7 : 
            bprint_altint_fmt(buf, ign_flag, fmt$1[0], fmt$1[1], fmt$1[2], 76);
            _ign_flag = 0;
            _fmt = fmt$1[3];
            continue ;
            case 8 : 
...
function symm(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case 0 : 
          return Block.__(0, [symm(param[0])]);
      case 1 : 
          return Block.__(1, [symm(param[0])]);
      case 2 : 
          return Block.__(2, [symm(param[0])]);
      case 3 : 
          return Block.__(3, [symm(param[0])]);
      case 4 : 
          return Block.__(4, [symm(param[0])]);
      case 5 : 
          return Block.__(5, [symm(param[0])]);
      case 6 : 
          return Block.__(6, [symm(param[0])]);
      case 7 : 
          return Block.__(7, [symm(param[0])]);
      case 8 : 
          return Block.__(8, [
                    param[0],
                    symm(param[1])
      ...
      case 10 : 
          return Block.__(10, [symm(param[0])]);
      case 11 : 
          return Block.__(11, [symm(param[0])]);
      case 12 : 
          return Block.__(12, [symm(param[0])]);
      case 13 : 
          return Block.__(13, [symm(param[0])]);
      case 14 : 
          return Block.__(14, [symm(param[0])]);
    ...
    switch (ty1.tag | 0) {
      case 0 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 0 : 
                  return Block.__(0, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 1 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 1 : 
                  return Block.__(1, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 2 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 2 : 
                  return Block.__(2, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 3 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 3 : 
                  return Block.__(3, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 4 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 4 : 
                  return Block.__(4, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 5 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 5 : 
                  return Block.__(5, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 6 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 6 : 
                  return Block.__(6, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 7 : 
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 7 : 
                  return Block.__(7, [trans(ty1[0], ty2[0])]);
              case 8 : 
                  exit = 6;
                  break;
              case 9 : 
      ...
      case 10 : 
          if (typeof ty2 === "number") {
            ...
            return Block.__(10, [trans(ty1[0], ty2[0])]);
          }
          else {
            throw [
                  Caml_builtin_exceptions.assert_failure,
          ...
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              case 10 : 
                  ...
                  break;
              case 11 : 
                  return Block.__(11, [trans(ty1[0], ty2[0])]);
              default:
                throw [
                      Caml_builtin_exceptions.assert_failure,
                      [
          ...
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              ...
              case 11 : 
                  ...
                  break;
              case 12 : 
                  return Block.__(12, [trans(ty1[0], ty2[0])]);
              default:
                throw [
                      Caml_builtin_exceptions.assert_failure,
                      [
          ...
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              ...
              case 12 : 
                  ...
                  break;
              case 13 : 
                  return Block.__(13, [trans(ty1[0], ty2[0])]);
              default:
                throw [
                      Caml_builtin_exceptions.assert_failure,
                      [
          ...
          if (typeof ty2 === "number") {
            ...
            switch (ty2.tag | 0) {
              ...
              case 13 : 
                  ...
                  break;
              case 14 : 
                  return Block.__(14, [trans(ty1[0], ty2[0])]);
              default:
                throw [
                      Caml_builtin_exceptions.assert_failure,
                      [
  ...
  while(true) {
    ...
    if (typeof fmtty === "number") {
      ...
      switch (fmtty.tag | 0) {
        case 2 : 
        case 3 : 
            return fmtty_of_padding_fmtty(fmtty[0], Block.__(1, [fmtty_of_fmt(fmtty[1])]));
        case 4 : 
            var ty_rest = fmtty_of_fmt(fmtty[3]);
            var prec_ty = fmtty_of_precision_fmtty(fmtty[2], Block.__(2, [ty_rest]));
            return fmtty_of_padding_fmtty(fmtty[1], prec_ty);
        case 5 : 
            var ty_rest$1 = fmtty_of_fmt(fmtty[3]);
            var prec_ty$1 = fmtty_of_precision_fmtty(fmtty[2], Block.__(3, [ty_rest$1]));
            return fmtty_of_padding_fmtty(fmtty[1], prec_ty$1);
        case 6 : 
            var ty_rest$2 = fmtty_of_fmt(fmtty[3]);
            var prec_ty$2 = fmtty_of_precision_fmtty(fmtty[2], Block.__(4, [ty_rest$2]));
            return fmtty_of_padding_fmtty(fmtty[1], prec_ty$2);
        case 7 : 
            var ty_rest$3 = fmtty_of_fmt(fmtty[3]);
            var prec_ty$3 = fmtty_of_precision_fmtty(fmtty[2], Block.__(5, [ty_rest$3]));
            return fmtty_of_padding_fmtty(fmtty[1], prec_ty$3);
        case 8 : 
            var ty_rest$4 = fmtty_of_fmt(fmtty[3]);
            var prec_ty$4 = fmtty_of_precision_fmtty(fmtty[2], Block.__(6, [ty_rest$4]));
            return fmtty_of_padding_fmtty(fmtty[1], prec_ty$4);
        case 9 : 
            return Block.__(7, [fmtty_of_fmt(fmtty[0])]);
        case 10 : 
            _fmtty = fmtty[0];
            continue ;
            case 13 : 
        ...
        case 15 : 
            return Block.__(10, [fmtty_of_fmt(fmtty[0])]);
        case 16 : 
            return Block.__(11, [fmtty_of_fmt(fmtty[0])]);
        case 11 : 
        case 12 : 
        case 17 : 
            _fmtty = fmtty[1];
        ...
        case 19 : 
            return Block.__(13, [fmtty_of_fmt(fmtty[0])]);
        case 20 : 
            return Block.__(1, [fmtty_of_fmt(fmtty[2])]);
        case 21 : 
            return Block.__(2, [fmtty_of_fmt(fmtty[1])]);
        case 0 : 
        case 1 : 
        case 22 : 
            return Block.__(0, [fmtty_of_fmt(fmtty[0])]);
        case 23 : 
            var ign = fmtty[0];
            var fmt = fmtty[1];
            if (typeof ign === "number") {
              switch (ign) {
                case 3 : 
                    return Block.__(14, [fmtty_of_fmt(fmt)]);
                case 0 : 
                case 1 : 
                case 2 : 
                case 4 : 
...
function fmtty_of_custom(arity, fmtty) {
  if (arity) {
    return Block.__(12, [fmtty_of_custom(arity[0], fmtty)]);
  }
  else {
    return fmtty;
  }
    ...
    switch (fmt.tag | 0) {
      ...
      case 13 : 
          if (typeof fmtty === "number") {
            ...
            if (Caml_obj.caml_notequal([fmt[1]], [sub_fmtty$prime])) {
              throw Type_mismatch;
            }
      ...
      case 14 : 
          if (typeof fmtty === "number") {
            ...
            if (Caml_obj.caml_notequal([CamlinternalFormatBasics.erase_rel(fmt[1])], [CamlinternalFormatBasics.erase_rel(sub_fmtty1)])) {
              throw Type_mismatch;
            }
      ...
      case 23 : 
          ...
          if (typeof ign === "number") {
            ...
            switch (ign.tag | 0) {
              case 7 : 
                  return type_ignored_param_one(Block.__(7, [
                                ign[0],
                                ign[1]
                              ]), fmt$1, fmtty$1);
              case 8 : 
    ...
    switch (sub_fmtty.tag | 0) {
      ...
      case 8 : 
          if (typeof fmtty === "number") {
            ...
            if (Caml_obj.caml_notequal([sub_fmtty[0]], [sub2_fmtty$prime])) {
              throw Type_mismatch;
            }
      ...
      case 9 : 
          if (typeof fmtty === "number") {
            ...
            if (Caml_obj.caml_notequal([CamlinternalFormatBasics.erase_rel(sub_fmtty[0])], [CamlinternalFormatBasics.erase_rel(sub1_fmtty$prime)])) {
              throw Type_mismatch;
            }
            if (Caml_obj.caml_notequal([CamlinternalFormatBasics.erase_rel(sub_fmtty[1])], [CamlinternalFormatBasics.erase_rel(sub2_fmtty$prime$1)])) {
              throw Type_mismatch;
            }
            var sub_fmtty$prime = trans(symm(sub1_fmtty$prime), sub2_fmtty$prime$1);
            var match$9 = fmtty_rel_det(sub_fmtty$prime);
            Curry._1(match$9[1], 0);
            Curry._1(match$9[3], 0);
...
function fix_padding(padty, width, str) {
  ...
  if (width$1 <= len) {
    ...
    var res = Bytes.make(width$1, padty$1 === 2 ? 48 : 32);
    switch (padty$1) {
      case 0 : 
      ...
      case 2 : 
          ...
          else if (len > 1 && Caml_string.get(str, 0) === 48 && (Caml_string.get(str, 1) === 120 || Caml_string.get(str, 1) === 88)) {
    ...
    if (c >= 43) {
      switch (c - 43 | 0) {
        ...
        case 4 : 
            return str;
        case 5 : 
            if ((prec$1 + 2 | 0) > len && len > 1 && (Caml_string.get(str, 1) === 120 || Caml_string.get(str, 1) === 88)) {
...
function convert_int32(iconv, n) {
  return Caml_format.caml_int32_format(format_of_aconv(iconv, 108), n);
}

function convert_nativeint(iconv, n) {
  return Caml_format.caml_nativeint_format(format_of_aconv(iconv, 110), n);
}

function convert_int64(iconv, n) {
  return Caml_format.caml_int64_format(format_of_aconv(iconv, 76), n);
}
    ...
    if (typeof fmt === "number") {
      ...
      switch (fmt.tag | 0) {
              ...
              if (typeof prec === "number") {
                if (prec !== 0) {
                  ...
                  return function (p, x) {
                    ...
                    return make_printf(k$1, o$1, Block.__(4, [
                                  acc$1,
                                  str
                                ]), fmt$1);
                  }
        ...
        case 9 : 
            ...
            return function (b) {
              return make_printf(k, o, Block.__(4, [
                            acc,
                            b ? "true" : "false"
                          ]), rest$2);
            }
        ...
        case 15 : 
            ...
            return function (f, x) {
              return make_printf(k, o, Block.__(6, [
                            acc,
                            function (o) {
        ...
        case 17 : 
            ...
            if (match.tag) {
              ...
              return function k$prime(koc, kacc) {
                return make_printf(k, koc, Block.__(1, [
                              acc,
                              Block.__(1, [kacc])
                            ]), rest$7);
              }
...
function make_invalid_arg(k, o, acc, fmt) {
  return make_printf(k, o, Block.__(8, [
                acc,
...
function failwith_message(param) {
  ...
  return make_printf(k, 0, 0, param[0]);
}
...
function fmt_ebb_of_string(legacy_behavior, str) {
  var legacy_behavior$1 = legacy_behavior ? legacy_behavior[0] : 1;
  ...
  var parse_positive = function (_str_ind, end_ind, _acc) {
    while(true) {
      ...
      if (c > 57 || c < 48) {
        ...
        var new_acc = Caml_int32.imul(acc, 10) + (c - 48 | 0) | 0;
  ...
  var parse_after_precision = function (pct_ind, str_ind, end_ind, minus, plus, sharp, space, ign, pad, prec) {
    ...
    if (typeof pad === "number") {
      ...
      if (exit === 1) {
        if (minus !== 0) {
          if (typeof prec === "number") {
            return parse_conv(Block.__(1, [0]));
          }
          else {
            return parse_conv(Block.__(0, [
                          0,
                          prec[0]
                        ]));
          }
          ...
          return parse_conv(Block.__(1, [1]));
        }
        else {
          return parse_conv(Block.__(0, [
                        1,
  ...
  var parse_after_padding = function (pct_ind, str_ind, end_ind, minus, plus, sharp, space, ign, pad) {
    ...
    if (symb !== 46) {
      return parse_conversion(pct_ind, str_ind + 1 | 0, end_ind, plus, sharp, space, ign, pad, 0, pad, symb);
    }
    else {
      ...
      var parse_literal = function (minus, str_ind) {
        ...
        return parse_after_precision(pct_ind$1, match[0], end_ind$1, minus, plus$1, sharp$1, space$1, ign$1, pad$1, [match[1]]);
      };
      ...
      if (symb$1 >= 48) {
        ...
        switch (symb$1 - 42 | 0) {
          case 0 : 
              return parse_after_precision(pct_ind$1, str_ind$1 + 1 | 0, end_ind$1, minus$1, plus$1, sharp$1, space$1, ign$1, pad$1, 1);
          case 1 : 
          case 3 : 
              exit$1 = 2;
              break;
      ...
      if (exit === 1) {
        if (legacy_behavior$1) {
          return parse_after_precision(pct_ind$1, str_ind$1, end_ind$1, minus$1, plus$1, sharp$1, space$1, ign$1, pad$1, [0]);
        }
        else {
  ...
  var parse_format = function (pct_ind, end_ind) {
    ...
    var match = Caml_string.get(str, str_ind);
    if (match !== 95) {
      return parse_flags(pct_ind$1, str_ind, end_ind$1, 0);
    }
    else {
      return parse_flags(pct_ind$1, str_ind + 1 | 0, end_ind$1, 1);
    }
  };
  ...
  var parse_conversion = function (pct_ind, str_ind, end_ind, plus, sharp, space, ign, pad, prec, padprec, symb) {
    ...
    if (symb >= 124) {
      ...
      switch (symb) {
        case 33 : 
            ...
            fmt_result = [Block.__(10, [match[0]])];
            break;
        case 40 : 
            ...
            if (ign_used[0] = 1, ign) {
              pad_used = 1;
              var ignored_000 = opt_of_pad(95, pad);
              var ignored = Block.__(8, [
                  ignored_000,
                  sub_fmtty
                ]);
              fmt_result = [Block.__(23, [
                    ignored,
                    fmt_rest
                  ])];
            }
        ...
        case 67 : 
            ...
            fmt_result = (ign_used[0] = 1, ign) ? [Block.__(23, [
                    1,
                    fmt_rest$1
                  ])] : [Block.__(1, [fmt_rest$1])];
            break;
        case 78 : 
            var match$4 = parse_literal(str_ind, str_ind, end_ind);
            var fmt_rest$2 = match$4[0];
            if (ign_used[0] = 1, ign) {
              var ignored$1 = Block.__(10, [2]);
              fmt_result = [Block.__(23, [
                    ignored$1,
                    fmt_rest$2
                  ])];
        ...
        case 83 : 
            ...
            if (ign_used[0] = 1, ign) {
              pad_used = 1;
              var ignored$2 = Block.__(1, [opt_of_pad(95, padprec)]);
              fmt_result = [Block.__(23, [
                    ignored$2,
                    fmt_rest$3
                  ])];
        ...
        case 91 : 
            ...
            if (ign_used[0] = 1, ign) {
              pad_used = 1;
              var ignored_000$1 = opt_of_pad(95, pad);
              var ignored$3 = Block.__(9, [
                  ignored_000$1,
                  char_set
                ]);
              fmt_result = [Block.__(23, [
        ...
        case 97 : 
            ...
            fmt_result = [Block.__(15, [match$9[0]])];
            break;
        case 66 : 
        case 98 : 
            exit$1 = 3;
        ...
        case 115 : 
            ...
            if (ign_used[0] = 1, ign) {
              pad_used = 1;
              var ignored$4 = Block.__(0, [opt_of_pad(95, padprec)]);
              fmt_result = [Block.__(23, [
                    ignored$4,
                    fmt_rest$7
                  ])];
        ...
        case 116 : 
            ...
            fmt_result = [Block.__(16, [match$15[0]])];
            break;
        case 88 : 
        case 100 : 
        case 105 : 
        ...
        case 123 : 
            ...
            if (ign_used[0] = 1, ign) {
              pad_used = 1;
              var ignored_000$2 = opt_of_pad(95, pad);
              var ignored$5 = Block.__(7, [
                  ignored_000$2,
                  sub_fmtty$1
                ]);
              fmt_result = [Block.__(23, [
    ...
    switch (exit$2) {
      case 7 : 
          ...
          if (ign_used[0] = 1, ign) {
            pad_used = 1;
            var ignored_001 = opt_of_pad(95, pad);
            var ignored$6 = Block.__(2, [
                iconv,
                ignored_001
              ]);
            fmt_result = [Block.__(23, [
            ...
            if (exit$3 === 9) {
              pad$3 = typeof pad === "number" ? 0 : (
                  pad.tag ? (
                      pad[0] >= 2 ? (
                          legacy_behavior$1 ? Block.__(1, [1]) : incompatible_flag(pct_ind, str_ind, 48, "precision")
                        ) : pad
                    ) : (
                      pad[0] >= 2 ? (
                          legacy_behavior$1 ? Block.__(0, [
                                1,
                                pad[1]
            ...
            var match$19 = make_padprec_fmt_ebb(pad$3, (prec_used[0] = 1, prec), fmt_rest$9);
            fmt_result = [Block.__(4, [
                  iconv,
                  match$19[0],
                  match$19[1],
                  match$19[2]
      ...
      case 8 : 
          if (str_ind === end_ind || !is_int_base(Caml_string.get(str, str_ind))) {
            ...
            if (ign_used[0] = 1, ign) {
              var ignored$7 = Block.__(10, [counter]);
              fmt_result = [Block.__(23, [
                    ignored$7,
                    fmt_rest$10
                  ])];
    ...
    switch (exit$1) {
      case 2 : 
          ...
          if (ign_used[0] = 1, ign) {
            pad_used = 1;
            var ignored_000$3 = opt_of_pad(95, pad);
            var ignored_001$1 = get_prec_opt(0);
            var ignored$8 = Block.__(6, [
                ignored_000$3,
                ignored_001$1
              ]);
            fmt_result = [Block.__(23, [
            ...
            pad_used = 1;
            var match$22 = make_padprec_fmt_ebb(pad, (prec_used[0] = 1, prec), fmt_rest$11);
            fmt_result = [Block.__(8, [
                  fconv,
                  match$22[0],
                  match$22[1],
                  match$22[2]
      ...
      case 6 : 
          if (symb >= 108) {
            if (symb >= 111) {
              ...
              switch (symb - 108 | 0) {
                case 0 : 
                    ...
                    if (ign_used[0] = 1, ign) {
                      pad_used = 1;
                      var ignored_001$2 = opt_of_pad(95, pad);
                      var ignored$9 = Block.__(3, [
                          iconv$1,
                          ignored_001$2
                        ]);
                      fmt_result = [Block.__(23, [
                      ...
                      pad_used = 1;
                      var match$26 = make_padprec_fmt_ebb(pad, (prec_used[0] = 1, prec), fmt_rest$13);
                      fmt_result = [Block.__(5, [
                            iconv$1,
                            match$26[0],
                            match$26[1],
                            match$26[2]
                ...
                case 2 : 
                    ...
                    if (ign_used[0] = 1, ign) {
                      pad_used = 1;
                      var ignored_001$3 = opt_of_pad(95, pad);
                      var ignored$10 = Block.__(4, [
                          iconv$2,
                          ignored_001$3
                        ]);
                      fmt_result = [Block.__(23, [
                      ...
                      pad_used = 1;
                      var match$28 = make_padprec_fmt_ebb(pad, (prec_used[0] = 1, prec), fmt_rest$14);
                      fmt_result = [Block.__(6, [
                            iconv$2,
                            match$28[0],
                            match$28[1],
                            match$28[2]
            ...
            if (ign_used[0] = 1, ign) {
              pad_used = 1;
              var ignored_001$4 = opt_of_pad(95, pad);
              var ignored$11 = Block.__(5, [
                  iconv$3,
                  ignored_001$4
                ]);
              fmt_result = [Block.__(23, [
              ...
              pad_used = 1;
              var match$30 = make_padprec_fmt_ebb(pad, (prec_used[0] = 1, prec), fmt_rest$15);
              fmt_result = [Block.__(7, [
                    iconv$3,
                    match$30[0],
                    match$30[1],
                    match$30[2]
    ...
    if (!legacy_behavior$1) {
      ...
      if (!pad_used && Caml_obj.caml_notequal([pad], [0])) {
        incompatible_flag(pct_ind, str_ind, symb, "`padding'");
      }
      if (!prec_used[0] && Caml_obj.caml_notequal([prec], [0])) {
  ...
  var parse_flags = function (pct_ind, str_ind, end_ind, ign) {
    ...
    while(true) {
      ...
      if (exit === 1) {
        ...
        var padty = zero$1 !== 0 ? (
            minus$1 !== 0 ? (
                legacy_behavior$1 ? 0 : incompatible_flag(pct_ind$1, str_ind$2, 45, "0")
              ) : 2
          ) : (
            minus$1 !== 0 ? 0 : 1
          );
        ...
        if (match$1 >= 48) {
          if (match$1 >= 58) {
            ...
            return parse_after_padding(pct_ind$1, match$2[0], end_ind$1, minus$1, plus$1, sharp$1, space$1, ign$1, Block.__(0, [
                          padty,
                          match$2[1]
                        ]));
          }
          ...
          return parse_after_padding(pct_ind$1, str_ind$2 + 1 | 0, end_ind$1, minus$1, plus$1, sharp$1, space$1, ign$1, Block.__(1, [padty]));
        }
        if (exit$1 === 1) {
          switch (padty) {
            case 0 : 
                ...
                return parse_after_padding(pct_ind$1, str_ind$2, end_ind$1, minus$1, plus$1, sharp$1, space$1, ign$1, 0);
            case 1 : 
                return parse_after_padding(pct_ind$1, str_ind$2, end_ind$1, minus$1, plus$1, sharp$1, space$1, ign$1, 0);
            case 2 : 
                return parse_after_padding(pct_ind$1, str_ind$2, end_ind$1, minus$1, plus$1, sharp$1, space$1, ign$1, Block.__(0, [
                              1,
                              0
                            ]));
  ...
  var parse_tag = function (is_open_tag, str_ind, end_ind) {
    try {
      ...
      if (match !== 60) {
        ...
        var formatting = is_open_tag ? Block.__(0, [sub_format]) : (check_open_box(sub_fmt), Block.__(1, [sub_format]));
        return [Block.__(18, [
                    formatting,
                    match$1[0]
                  ])];
      ...
      if (exn === Caml_builtin_exceptions.not_found) {
        ...
        var formatting$1 = is_open_tag ? Block.__(0, [sub_format$1]) : Block.__(1, [sub_format$1]);
        return [Block.__(18, [
                    formatting$1,
                    match$3[0]
                  ])];
...
function caml_ml_output(oc, str, offset, len) {
  ...
  if (( (typeof process !== "undefined") && process.stdout && process.stdout.write ) && oc === stdout) {
    ...
    if (id < 0) {
      ...
      oc[0] = oc[0] + str$1.slice(0, id + 1 | 0);
      caml_ml_flush(oc);
      oc[0] = oc[0] + str$1.slice(id + 1 | 0);
      return 0;
    }
  }
}
        ...
        switch (cmd) {
            ...
            case Automata.TOKEN_READ:
                if (typeof arg !== 'number') {
                    env[env_curr_char] = tables[tbl_transl_block][arg.tag | 0 ];
                    env[env_lval] = arg[0];
                }
                else {
...
function eos(s) {
  return +(s[2][0] === s[1].length);
}

function check(n, s) {
  if ((s[2][0] + n | 0) > s[1].length) {
    throw EOS;
  }
  else {
    return 0;
...
function read(s) {
  return Caml_string.get(s[1], s[2][0]);
}
...
function guard(f, s) {
  try {
    ...
    if (exn === EOS) {
      return error(s, s[1].length, "unexpected end of binary or function");
    }
    else {
      throw exn;
    }
...
function expect(b, s, msg) {
  return $$require(+(guard(get$1, s) === b), s, s[2][0] - 1 | 0, msg);
}
...
function vuN(n, s) {
  $$require(+(n > 0), s, s[2][0], "integer representation too long");
  var b = guard(get, s);
  $$require(+(n >= 7 || (b & 127) < (1 << n)), s, s[2][0] - 1 | 0, "integer too large");
...
function vsN(n, s) {
  ...
  var b = guard(get, s);
  var mask = (-1 << n) & 127;
  $$require(+(n >= 7 || (b & mask) === 0 || (b & mask) === mask), s, s[2][0] - 1 | 0, "integer too large");
  var x = Caml_int64.of_int32(b & 127);
  if (b & 128) {
...
function sized(f, s) {
  ...
  $$require(+(s[2][0] === (start + size | 0)), s, start, "section size mismatch");
  return x;
}
...
function value_type(s) {
  ...
  if (switcher > 3 || switcher < 0) {
    return error(s, s[2][0] - 1 | 0, "invalid value type");
  }
  else {
    switch (switcher) {
      case 0 : 
...
function elem_type(s) {
  var match = vsN(7, s)[1] | 0;
  if (match !== -16) {
    return error(s, s[2][0] - 1 | 0, "invalid element type");
  }
  else {
    return 0;
  }
...
function func_type(s) {
  var match = vsN(7, s)[1] | 0;
  if (match !== -32) {
    return error(s, s[2][0] - 1 | 0, "invalid function type");
  }
  else {
...
function mutability(s) {
  ...
  if (match !== 0) {
    if (match !== 1) {
      return error(s, s[2][0] - 1 | 0, "invalid mutability");
    }
    else {
      return 1;
    }
...
function memop(s) {
  ...
  $$require(Curry._2(I32.le_u, align, 32), s, s[2][0] - 1 | 0, "invalid memop flags");
...
function id(s) {
  var bo = peek(s);
  return Curry._2(Lib.Option[1], function (param) {
              if (param > 11 || param < 0) {
                return error(s, s[2][0], "invalid section id");
              }
              else {
                switch (param) {
                  case 0 : 
...
function type_section(s) {
  return section(836501035, function (param) {
...
function import_kind(s) {
  var match = guard(get, s);
  if (match > 3 || match < 0) {
    return error(s, s[2][0] - 1 | 0, "invalid import kind");
  }
  else {
    switch (match) {
      case 0 : 
          return Block.__(0, [at($$var, s)]);
      case 1 : 
          return Block.__(1, [table_type(s)]);
      case 2 : 
          return Block.__(2, [memory_type(s)]);
      case 3 : 
          return Block.__(3, [global_type(s)]);
...
function import_section(s) {
  return section(696517344, function (param) {
...
function func_section(s) {
  return section(205556449, function (param) {
              return vec(function (param) {
                          return at($$var, param);
                        }, param);
            }, 0, s);
...
function table_section(s) {
  return section(1031864215, function (param) {
              return vec(function (param) {
...
function memory_section(s) {
  return section(-840203068, function (param) {
              return vec(function (param) {
...
function global_section(s) {
  return section(-872313182, function (param) {
              return vec(function (param) {
...
function export_kind(s) {
  var match = guard(get, s);
  if (match > 3 || match < 0) {
    return error(s, s[2][0] - 1 | 0, "invalid export kind");
  }
  else {
    switch (match) {
      case 0 : 
...
function export_section(s) {
  return section(-440679759, function (param) {
              return vec(function (param) {
...
function start_section(s) {
  return section(395720131, function (param) {
              return [at($$var, param)];
            }, 0, s);
}
...
function local(s) {
  var n = len32(s);
  var t = value_type(s);
  return Curry._2(Lib.List[0], n, t);
}
...
function code(_, s) {
  ...
  expect(11, s, "END opcode expected");
  return [
          Source.$at$at(-1, Source.no_region),
          locals,
          body
        ];
}
...
function code_section(s) {
  return section(1021133848, function (param) {
              return vec(function (param) {
...
function elem_section(s) {
  return section(440380662, function (param) {
              return vec(function (param) {
...
function data_section(s) {
  return section(66447547, function (param) {
              return vec(function (param) {
...
function custom(size, s) {
  var start = s[2][0];
  string(s);
  var partial_arg = size - (s[2][0] - start | 0) | 0;
...
function custom_section(s) {
  return section_with_size(-808010220, custom, 0, s);
}
...
function module_(s) {
  ...
  iterate(custom_section, s);
  $$require(+(s[2][0] === s[1].length), s, s[1].length, "junk after last section");
  $$require(+(List.length(func_types) === List.length(func_bodies)), s, s[1].length, "function and code section have inconsistent lengths");
...
function encode(m) {
  ...
  var len = function (i) {
    if (i !== i) {
      Curry._2(Code[2], Source.no_region, "cannot encode length with more than 32 bit");
    }
    return vu32(i);
  };
  var bool = function (b) {
  ...
  var string = function (bs) {
    len(bs.length);
    return Buffer.add_string(s[0], bs);
  };
  ...
  var stack_type = function (param) {
    if (param) {
      if (param[1]) {
        return Curry._2(Code[2], Source.no_region, "cannot encode stack type with arity > 1 (yet)");
      }
      else {
  ...
  var limits = function (vu, param) {
    ...
    bool(+(max !== 0));
    Curry._1(vu, param[0]);
    return Curry._2(Lib.Option[2], vu, max);
  };
  ...
  var section = function (id, f, x, needed) {
    if (needed) {
      ...
      var p = Buffer.length(s[0]);
      Curry._1(f, x);
      return patch_gap32(g, Buffer.length(s[0]) - p | 0);
    }
    else {
      return 0;
    }
  ...
  var start_section = function (xo) {
    return section(8, function (param) {
                return Curry._2(Lib.Option[2], $$var, param);
              }, xo, +(xo !== 0));
  };
  ...
  var code = function (f) {
    ...
    var g = gap32(0);
    var p = Buffer.length(s[0]);
    vec(local, compress(match[1]));
    List.iter(instr, match[2]);
    u8(11);
    return patch_gap32(g, Buffer.length(s[0]) - p | 0);
  };
  ...
  var module_ = function (m) {
    ...
    u32(13);
    type_section(m[1][0]);
    import_section(m[1][8]);
    func_section(m[1][4]);
    table_section(m[1][2]);
    memory_section(m[1][3]);
    global_section(m[1][1]);
    export_section(m[1][9]);
    start_section(m[1][5]);
    elem_section(m[1][6]);
    code_section(m[1][4]);
    var data = m[1][7];
...
var include = Float.Make([
      2143289344,
      -4194304,
      Caml_float.caml_int32_bits_of_float,
      Caml_float.caml_int32_float_of_bits,
...
var include = Float.Make([
      ...
      Caml_int64.bits_of_float,
      Caml_int64.float_of_bits,
...
function Make(Rep) {
  ...
  var is_nan = function (x) {
    var xf = Curry._1(Rep[3], x);
    return +(xf !== xf);
  };
  var canonicalize_nan = function (x) {
    return Curry._2(Rep[7], x, Rep[0]);
  };
  ...
  var determine_unary_nan = function (x) {
    return canonicalize_nan(is_nan(x) ? x : Rep[0]);
  };
  ...
  var abs = function (x) {
    return Curry._2(Rep[6], x, Rep[10]);
  };
  var neg = function (x) {
    return Curry._2(Rep[8], x, Rep[9]);
  };
  var copysign = function (x, y) {
    return Curry._2(Rep[7], abs(x), Curry._2(Rep[6], y, Rep[9]));
  };
  var eq = function (x, y) {
  ...
  var of_signless_string = function (x, len) {
    if (x !== "nan" && len > 6 && $$String.sub(x, 0, 6) === "nan:0x") {
      var s = Curry._1(Rep[4], $$String.sub(x, 4, len - 4 | 0));
      if (Caml_obj.caml_equal(s, Rep[11])) {
        throw [
              Caml_builtin_exceptions.failure,
              "nan payload must not be zero"
            ];
      }
      else if (Caml_obj.caml_notequal(Curry._2(Rep[6], s, bare_nan), Rep[11])) {
        throw [
              Caml_builtin_exceptions.failure,
              "nan payload must not overlap with exponent bits"
            ];
      }
      else if (Caml_obj.caml_lessthan(s, Rep[11])) {
        throw [
              Caml_builtin_exceptions.failure,
        ...
        return Curry._2(Rep[7], s, bare_nan);
      }
    }
    else {
  ...
  var to_string = function (x) {
    var a = abs(x);
    return (
            Caml_obj.caml_lessthan(x, Rep[11]) ? "-" : ""
          ) + (
            is_nan(a) ? "nan:0x" + Curry._1(Rep[13], a) : Pervasives.string_of_float(Curry._1(to_float, a))
          );
  };
  return [
          pos_nan,
...
function pp_output_string(state, s) {
  return Curry._3(state[16], s, 0, s.length);
}

function break_new_line(state, offset, width) {
  Curry._1(state[18], 0);
  state[10] = 1;
  var indent = (state[5] - width | 0) + offset | 0;
  var real_indent = Pervasives.min(state[7], indent);
  state[9] = real_indent;
  state[8] = state[5] - state[9] | 0;
  return Curry._1(state[19], state[9]);
}

function break_same_line(state, width) {
  state[8] = state[8] - width | 0;
  return Curry._1(state[19], width);
}
...
function format_pp_token(state, size, param) {
  if (typeof param === "number") {
    switch (param) {
      case 0 : 
          ...
          if (match) {
            ...
            tabs[0] = add_tab(state[5] - state[8] | 0, tabs[0]);
            return 0;
          }
          else {
            return 0;
      ...
      case 4 : 
          if (state[9] !== (state[5] - state[8] | 0)) {
            var state$1 = state;
            var match$4 = take_queue(state$1[26]);
            var size$1 = match$4[0];
            state$1[11] = state$1[11] - match$4[2] | 0;
            state$1[8] = state$1[8] + size$1 | 0;
            return 0;
          }
          else {
            return 0;
      ...
      case 5 : 
          var match$5 = state[4];
          if (match$5) {
            var marker = Curry._1(state[23], match$5[0]);
    ...
    switch (param.tag | 0) {
      ...
      case 1 : 
          ...
          if (match$6) {
            ...
            switch (match$7[0]) {
              ...
              case 4 : 
                  if (state[10] || !(size > state[8] || state[9] > ((state[5] - width | 0) + off | 0))) {
                    return break_same_line(state, n);
                  }
                  else {
                    return break_new_line(state, off, width);
          ...
          break;
      case 2 : 
          var insertion_point = state[5] - state[8] | 0;
          var match$8 = state[2];
          if (match$8) {
            ...
            if (offset >= 0) {
              ...
              return break_new_line(state, tab + param[1] | 0, state[5]);
            }
          }
          else {
            return 0;
      ...
      case 3 : 
          var ty = param[1];
          var insertion_point$1 = state[5] - state[8] | 0;
          if (insertion_point$1 > state[7]) {
            pp_force_break_line(state);
          }
          var offset$1 = state[8] - param[0] | 0;
          var bl_type = ty !== 1 ? (
              size > state[8] ? ty : 5
            ) : 1;
          state[1] = [
      ...
      case 5 : 
          ...
          var marker$1 = Curry._1(state[22], tag_name);
...
function advance_left(state) {
  try {
    ...
    while(true) {
      ...
      var size = match[0];
      if (size < 0 && (state$1[12] - state$1[11] | 0) < state$1[8]) {
        return 0;
      }
      else {
        take_queue(state$1[26]);
        format_pp_token(state$1, size < 0 ? 1000000010 : size, match[1]);
        state$1[11] = match[2] + state$1[11] | 0;
        continue ;
...
function pp_set_max_indent(state, n) {
  ...
  if (n$1 >= 1) {
    ...
    state$1[6] = n$2;
    state$1[7] = state$1[5] - state$1[6] | 0;
...
function pp_set_margin(state, n) {
  if (n >= 1) {
    var n$1 = pp_limit(n);
    state[5] = n$1;
    var new_max_indent = state[7] <= state[5] ? state[7] : Pervasives.max(Pervasives.max(state[5] - state[6] | 0, state[5] / 2 | 0), 1);
...
function display_blanks(state, _n) {
  while(true) {
    ...
    if (n > 0) {
      if (n <= 80) {
        return Curry._3(state[16], blank_line, 0, n);
      }
      else {
        Curry._3(state[16], blank_line, 0, 80);
        _n = n - 80 | 0;
        continue ;
...
function ksprintf(k, param) {
  ...
  return CamlinternalFormat.make_printf(k$prime, 0, 0, param[0]);
}
...
function asprintf(param) {
  ...
  return CamlinternalFormat.make_printf(k$prime, ppf, 0, param[0]);
}
...
function bprintf(b, param) {
  ...
  return CamlinternalFormat.make_printf(k, formatter_of_buffer(b), 0, param[0]);
}
...
function Make(Rep) {
  var cmp_u = function (x, op, y) {
    return Curry._2(op, Curry._2(Rep[6], x, Rep[4]), Curry._2(Rep[6], y, Rep[4]));
  };
  var divrem_u = function (n, d) {
    if (Caml_obj.caml_equal(d, Rep[0])) {
      throw Numeric_error.IntegerDivideByZero;
    }
    else {
      var t = Curry._2(Rep[16], d, Rep[21] - 1 | 0);
      var n$prime = Curry._2(Rep[11], n, Curry._1(Rep[12], t));
      var q = Curry._2(Rep[15], Curry._2(Rep[9], Curry._2(Rep[17], n$prime, 1), d), 1);
      var r = Curry._2(Rep[7], n, Curry._2(Rep[8], q, d));
  ...
  var zero = Rep[0];
  var one = Rep[1];
  var ten = Curry._1(Rep[18], 10);
  var add = Rep[6];
  var sub = Rep[7];
  var mul = Rep[8];
  var div_s = function (x, y) {
    if (Caml_obj.caml_equal(y, Rep[0])) {
      throw Numeric_error.IntegerDivideByZero;
    }
    else if (Caml_obj.caml_equal(x, Rep[4]) && Caml_obj.caml_equal(y, Rep[2])) {
      throw Numeric_error.IntegerOverflow;
    }
    else {
      return Curry._2(Rep[9], x, y);
    }
  };
  ...
  var shift = function (f, x, y) {
    return Curry._2(f, x, Curry._1(Rep[19], Curry._2(Rep[11], y, Curry._1(Rep[18], Rep[21] - 1 | 0))));
  };
  var shl = function (x, y) {
    return shift(Rep[15], x, y);
  };
  var shr_s = function (x, y) {
    return shift(Rep[16], x, y);
  };
  var shr_u = function (x, y) {
    return shift(Rep[17], x, y);
  };
  var clamp_rotate_count = function (n) {
    return Curry._1(Rep[19], Curry._2(Rep[11], n, Curry._1(Rep[18], Rep[21] - 1 | 0)));
  };
  var rotl = function (x, y) {
    var n = clamp_rotate_count(y);
    return Curry._2(or_, Curry._2(Rep[15], x, n), Curry._2(Rep[17], x, Rep[21] - n | 0));
  };
  var rotr = function (x, y) {
    var n = clamp_rotate_count(y);
    return Curry._2(or_, Curry._2(Rep[17], x, n), Curry._2(Rep[15], x, Rep[21] - n | 0));
  };
  var clz = function (x) {
    var loop = function (_acc, _n) {
      while(true) {
        var n = _n;
        var acc = _acc;
        if (Caml_obj.caml_equal(n, Rep[0])) {
          return Rep[21];
        }
        else if (Caml_obj.caml_equal(Curry._2(and_, n, Curry._2(Rep[15], Rep[1], Rep[21] - 1 | 0)), Rep[0])) {
          _n = Curry._2(Rep[15], n, 1);
          _acc = 1 + acc | 0;
          continue ;
    ...
    return Curry._1(Rep[18], loop(0, x));
  };
  var ctz = function (x) {
    var loop = function (_acc, _n) {
      while(true) {
        ...
        else if (Caml_obj.caml_equal(Curry._2(and_, n, Rep[1]), Rep[1])) {
          return acc;
        }
        else {
          _n = Curry._2(Rep[17], n, 1);
          _acc = 1 + acc | 0;
          continue ;
  ...
  var popcnt = function (x) {
    var loop = function (_acc, _i, _n) {
      while(true) {
        ...
        if (Caml_obj.caml_equal(n, Rep[0])) {
          ...
          var acc$prime = Caml_obj.caml_equal(Curry._2(and_, n, Rep[1]), Rep[1]) ? acc + 1 | 0 : acc;
          _n = Curry._2(Rep[17], n, 1);
          _i = i - 1 | 0;
          _acc = acc$prime;
          continue ;
    ...
    return Curry._1(Rep[18], loop(0, Rep[21], x));
  };
  var eqz = function (x) {
    return Caml_obj.caml_equal(x, Rep[0]);
  };
  ...
  var of_int_u = function (i) {
    return Curry._2(and_, Curry._1(Rep[18], i), Curry._2(or_, shl(Curry._1(Rep[18], Pervasives.max_int), one), one));
  };
  var to_string_s = Rep[20];
  var to_string_u = function (i) {
    if (Caml_obj.caml_greaterequal(i, Rep[0])) {
  ...
  var of_string = function (s) {
    ...
    var parse_int = function (i) {
      $$require(+((len - i | 0) > 0));
      if ((i + 2 | 0) <= len && Caml_string.get(s, i) === 48 && Caml_string.get(s, i + 1 | 0) === 120) {
        var _i = i + 2 | 0;
        var _num = Rep[0];
        while(true) {
          var num = _num;
          ...
          if (i$1 === len) {
            ...
            var digit = Curry._1(Rep[18], hex_digit(Caml_string.get(s, i$1)));
            $$require(le_u(num, shr_u(Rep[2], Curry._1(Rep[18], 4))));
            _num = Curry._2(Rep[13], Curry._2(Rep[15], num, 4), digit);
            _i = i$1 + 1 | 0;
            continue ;
        ...
        while(true) {
          ...
          if (i$2 === len) {
            ...
            var digit$1 = Curry._1(Rep[18], dec_digit(Caml_string.get(s, i$2)));
            $$require(lt_u(num$1, max_upper) || Caml_obj.caml_equal(num$1, max_upper) && le_u(digit$1, max_lower));
            _num$1 = Curry._2(Rep[6], Curry._2(Rep[8], num$1, ten), digit$1);
            _i$1 = i$2 + 1 | 0;
            continue ;
    ...
    if (switcher > 2 || switcher < 0) {
      ...
      switch (switcher) {
        ...
        case 2 : 
            var n = parse_int(1);
            $$require(Caml_obj.caml_greaterequal(Curry._2(Rep[7], n, Rep[1]), Rep[2]));
            return Curry._1(Rep[5], n);
  ...
  var of_string_s = function (s) {
    var n = of_string(s);
    $$require(+(Caml_string.get(s, 0) === 45) || Caml_obj.caml_greaterequal(n, Rep[0]));
    return n;
  };
...
var opt = Lib.Option[0];

var __ocaml_lex_tables = [
  "\0\0o\xffp\xffq\xffr\xff\x01\0U\0\x07\0\x1b\0\x05\0o\0o\0t\0\x06\0j\0\x0e\0k\0y\0\x10\0y\0s\0\xb4\0\x01\x01z\0\xbe\0\xc5\0\x04\x01\x1a\x01\xfe\xff\x02\0s\xff\x13\0<\x01R\x01x\x01\"\0\x8f\x01\xd5\x01\x0e\x01\xee\x01/\x02>\x02U\x02\x96\x02\xa0\x02O\0D\0\xac\x02\xc2\x02\xe7\x02\0\x03&\x03L\x03z\0|\0~\0\x86\0|\0y\0\xfb\xff\x85\0\0\0\x0f\0\x87\0r\x03\x98\x03\xb1\0\xe8\xff\r\0\x10\0\xee\0\xad\0\xb6\0\xbb\0\xc2\0\x82\xff\xb4\0x\xff\0\0\x9c\x02\xb8\0\xbb\0\xf1\0\xca\0\xbf\0\xc2\0\xe3\0\xf2\0\xef\0\xe4\0\xf8\0\xeb\0\xf3\0*\x01\n\x01\xe6\0\xe8\0\xf5\0\xf7\0\xf7\0\xf5\xff\xd7\xff\xd6\xff\0\0\x01\0\x16\x01\x14\x01j\x01\x1c\0\x1a\0\x1b\x01\b\x01\xdb\xff\x19\x01\xb3\xff\xb4\xff'\x01\xb1\xff\xb2\xff3\x01\x1a\x01\x1e\x01\x1e\x01,\x01\xae\x01\x1f\0&\0\xda\xff\xcc\xffA\x01\xc3\xffV\x01\xc1\xff\xc2\xff3\x01A\x019\x01>\x01\xd5\xfff\x01h\x01\xcd\xff\xc6\xffa\x01\xcb\xffX\x01p\x01c\x01\xc9\xff\xca\xffc\x01w\x01t\x01\x84\x01r\x01\xc7\xff\xc8\xffu\x01\x85\x01y\x01|\x01{\x01\x89\x01{\x01\0\0\x90\x01*\0,\0\t\x02\t\x02\f\x02\xa1\xff\x9f\xff\xda\x01\x0e\x02\x0e\x02\x11\x02\xa0\xff\x9e\xff\x18\x02~\x03\xd6\x01\xe6\x01\xdf\x01\xdb\x01\xd6\x01\xe8\x01\xe4\x01\xe7\x01\xe6\x01\xf4\x01\xe6\x01,\x02\xf6\x01'\x026\x02\x96\xff\xf8\x01\b\x02\n\x02\x15\x02\x1b\x02\b\x02M\x02O\x02&\x02]\x02_\x02\xa5\xff)\x02`\x02b\x02\xa4\xff&\x02*\x02)\x02\x86\xff.\x02\xf2\xff\xf8\xff\xf9\xff\xfa\xff\xd1\x03F\x04\xf7\xff9\x04\xa4\x047\x02r\x02u\x02z\x02\xb7\x03D\x02H\x029\x02F\x02K\x02>\x02E\x02Q\x02M\x02M\x02\xbd\x03\x97\x02T\x02x\x02F\x02t\x02^\x02R\x02g\x02\x8a\x02x\t\x03\xfb\x02\xd3\xff\xbe\xff\0\x03\x02\x03\0\x03\xd0\xff\xfe\x02\x06\x03\x12\x03\xcf\xff\xfe\x02\t\x03\f\x03\xbc\xff\xba\xff\xb9\xff\f\x03\x05\x03\xbb\xff\x17\x03\x1f\x03/\x03f\x031\x03b\x03e\x03\xa3\xff\xac\xff\xa7\xff\xa8\xff1\x03-\x03(\x038\x03,\x03/\x03.\x03<\x038\x03\x8a\x03Q\x03\x88\x03\x8b\x03\x99\xff\x90\x03\x1f\x04Z\x03N\x03X\x03S\x03V\x03U\x03Q\x03a\x03\x98\x03l\x03\xad\x03\xb2\x03\xa2\xff}\x03y\x03t\x03\x84\x03}\n\x04\x0e\x04\x14\x04\x7f\xff\x13\x04\r\x04(\x04\x1f\x04\x1b\x04\x14\x04-\x04$\x04+\x041\x04~\xff*\x04.\x04*\x04.\x04?\x04?\x047\x04_\x04}\xff|\x04|\x04\x80\x04\x85\x04\x95\x04\x87\x04\x95\x04\x8f\x04{\xff\x9d\x04\x8f\x04z\xff\x99\x04\xa1\x04\x8e\x04\x91\x04\x91\x04\x9d\x04\x98\x04\x9a\x04y\n\x05\xfd\x04\t\x05\n\x05\x02\x05\xe7\xff\x12\x05\x06\x05\x04\x05\x11\x05\x14\x05\n\x05\xe0\xff\x12\x05\x93\xff\f\x05\x14\x05\x8b\xff\b\x05\x1a\x05\x10\x05\x1e\x05\x19\x05\x1c\x05\f\x05\xe5\xff\x1a\x05\x16\x05\x14\x05\"\x05&\x05\x1c\x05\xe1\xff\x1a\x05(\x05*\x05 \x05\xde\xff\x1b\x05\x1a\x05\x91\xff&\x05 \x05\x1d\x05\x84\xff \x05'\x05(\x056\x05-\x05)\x054\x050\x05(\x056\x059\x05)\x05\xe3\xff,\x05:\x052\x05-\x05C\x056\x05@\x059\x058\x056\x050\x05\x95\xff;\x05<\x058\x05N\x05G\x05C\x05A\x05N\x05Q\x05H\x05\xe2\xffF\x05T\x05V\x05L\x05\xdf\xffB\x05[\x05N\x05W\x05P\x05O\x05M\x05G\x05\x94\xff_\x05a\x05W\x05\x8d\xffP\x05_\x05S\x05b\x05T\x05\x8c\x05\x9a\x05\xa4\x05\xae\x05\xb8\x05\xcf\x05\x82\x05~\x05\x80\x05w\xff\x83\x05\x95\x05\x8a\x05\x90\xff\x15\x06\xee\x05t\xffu\xff\x02\x06\xfb\xff\xfc\xff\xfd\xff\xce\x05\x01\0\xff\xff\xfe\xff",
  "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x90\0\x02\0\x02\0\xff\xff\0\0\xff\xff\xff\xff\x04\0\xff\xff\x02\0\xff\xff\xff\xff\x02\0\xff\xff\x02\0\x04\0\xff\xff\x04\0\x04\0\xff\xff\xff\xff\xff\xff\x03\0\x03\0\xff\xff\x03\0\x03\0\x03\0\xff\xff\x04\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x04\0\xff\xff\xff\xff\xff\xff\x04\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\t\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\"\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff#\0I\0\t\0\b\0\b\0\xff\xff\xff\xff\xff\xff\t\0T\0\t\0'\0'\0\xff\xff'\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff~\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xffx\0\xff\xff&\0&\0\xff\xff&\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x89\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x04\0\x04\0\xff\xff\xff\xff",
  "\x01\0\0\0\0\0\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\x01\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\0\0\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\0\0\xff\xff\0\0\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\0\0\0\0\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\0\0\0\0\xff\xff\0\0\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\0\0\0\0\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\0\0\0\0\0\0\x01\x01\0\x01\0\0\xff\xff\0\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\0\0\0\0\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\0\0\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\0\0\0\0\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\0\0\0\0\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\0\0\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\0\0\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xff\xff\xff\xff\0\0\xff\xff\xa9\x02\0\0\0\0\xad\x02\0\0\0\0\0\0\xff\xff\xff\xff\0\0\0\0",
    ...
    if (__ocaml_lex_state$1 > 144 || __ocaml_lex_state$1 < 0) {
      ...
      switch (__ocaml_lex_state$1) {
        ...
        case 1 : 
            return 3;
        case 2 : 
            var s = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[5]);
            return Block.__(0, [s]);
        case 3 : 
            var s$1 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[5]);
            return Block.__(1, [s$1]);
        case 4 : 
            var s$2 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[5]);
            return Block.__(2, [s$2]);
        case 5 : 
            var s$3 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[5]);
            return Block.__(3, [text(s$3)]);
        case 6 : 
        ...
        case 9 : 
            var t = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(5, [value_type(t)]);
        case 10 : 
            var t$1 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(10, [numop(t$1, function (s) {
                            var n = Curry._1(I32.of_string, s[1]);
                            return [
                                    Operators.i32_const(Source.$at$at(n, s[0])),
                                    Block.__(0, [n])
                                  ];
                          }, function (s) {
                            var n = Curry._1(I64.of_string, s[1]);
                            return [
                                    Operators.i64_const(Source.$at$at(n, s[0])),
                                    Block.__(1, [n])
                                  ];
                          }, function (s) {
                            var n = Curry._1(F32.of_string, s[1]);
                            return [
                                    Operators.f32_const(Source.$at$at(n, s[0])),
                                    Block.__(2, [n])
                                  ];
                          }, function (s) {
                            var n = Curry._1(F64.of_string, s[1]);
                            return [
                                    Operators.f64_const(Source.$at$at(n, s[0])),
                                    Block.__(3, [n])
                                  ];
                          })]);
        case 11 : 
        ...
        case 33 : 
            return 23;
        case 34 : 
            var t$2 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(6, [(function(t$2){
                      return function (a, o) {
        ...
        case 35 : 
            var t$3 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(7, [(function(t$3){
                      return function (a, o) {
                        var partial_arg = Curry._2(opt, a, 2);
                        var partial_arg$1 = Curry._2(opt, a, 3);
                        var partial_arg$2 = Curry._2(opt, a, 2);
        ...
        case 36 : 
            var t$4 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            var sz = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4] + 8 | 0, lexbuf$1[5] - 2 | 0);
            var s$4 = Lexing.sub_lexeme_char(lexbuf$1, lexbuf$1[5] - 1 | 0);
            if (t$4 === "i32" && sz === "32") {
              error(lexbuf$1, "unknown operator");
            }
            return Block.__(6, [(function(t$4,sz,s$4){
                      return function (a, o) {
        ...
        case 37 : 
            var t$5 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            var sz$1 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4] + 9 | 0, lexbuf$1[5]);
            if (t$5 === "i32" && sz$1 === "32") {
              error(lexbuf$1, "unknown operator");
            }
            return Block.__(7, [(function(t$5,sz$1){
                      return function (a, o) {
        ...
        case 38 : 
            var s$5 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4] + 7 | 0, lexbuf$1[5]);
            return Block.__(8, [s$5]);
        case 39 : 
            var s$6 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4] + 6 | 0, lexbuf$1[5]);
            return Block.__(9, [s$6]);
        case 40 : 
            var t$6 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [intop(t$6, Operators.i32_clz, Operators.i64_clz)]);
        case 41 : 
            var t$7 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [intop(t$7, Operators.i32_ctz, Operators.i64_ctz)]);
        case 42 : 
            var t$8 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [intop(t$8, Operators.i32_popcnt, Operators.i64_popcnt)]);
        case 43 : 
            var t$9 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [floatop(t$9, Operators.f32_neg, Operators.f64_neg)]);
        case 44 : 
            var t$10 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [floatop(t$10, Operators.f32_abs, Operators.f64_abs)]);
        case 45 : 
            var t$11 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [floatop(t$11, Operators.f32_sqrt, Operators.f64_sqrt)]);
        case 46 : 
            var t$12 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [floatop(t$12, Operators.f32_ceil, Operators.f64_ceil)]);
        case 47 : 
            var t$13 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [floatop(t$13, Operators.f32_floor, Operators.f64_floor)]);
        case 48 : 
            var t$14 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [floatop(t$14, Operators.f32_trunc, Operators.f64_trunc)]);
        case 49 : 
            var t$15 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(11, [floatop(t$15, Operators.f32_nearest, Operators.f64_nearest)]);
        case 50 : 
            var t$16 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$16, Operators.i32_add, Operators.i64_add)]);
        case 51 : 
            var t$17 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$17, Operators.i32_sub, Operators.i64_sub)]);
        case 52 : 
            var t$18 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$18, Operators.i32_mul, Operators.i64_mul)]);
        case 53 : 
            var t$19 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$19, Operators.i32_div_s, Operators.i64_div_s)]);
        case 54 : 
            var t$20 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$20, Operators.i32_div_u, Operators.i64_div_u)]);
        case 55 : 
            var t$21 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$21, Operators.i32_rem_s, Operators.i64_rem_s)]);
        case 56 : 
            var t$22 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$22, Operators.i32_rem_u, Operators.i64_rem_u)]);
        case 57 : 
            var t$23 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$23, Operators.i32_and, Operators.i64_and)]);
        case 58 : 
            var t$24 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$24, Operators.i32_or, Operators.i64_or)]);
        case 59 : 
            var t$25 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$25, Operators.i32_xor, Operators.i64_xor)]);
        case 60 : 
            var t$26 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$26, Operators.i32_shl, Operators.i64_shl)]);
        case 61 : 
            var t$27 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$27, Operators.i32_shr_s, Operators.i64_shr_s)]);
        case 62 : 
            var t$28 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$28, Operators.i32_shr_u, Operators.i64_shr_u)]);
        case 63 : 
            var t$29 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$29, Operators.i32_rotl, Operators.i64_rotl)]);
        case 64 : 
            var t$30 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [intop(t$30, Operators.i32_rotr, Operators.i64_rotr)]);
        case 65 : 
            var t$31 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [floatop(t$31, Operators.f32_add, Operators.f64_add)]);
        case 66 : 
            var t$32 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [floatop(t$32, Operators.f32_sub, Operators.f64_sub)]);
        case 67 : 
            var t$33 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [floatop(t$33, Operators.f32_mul, Operators.f64_mul)]);
        case 68 : 
            var t$34 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [floatop(t$34, Operators.f32_div, Operators.f64_div)]);
        case 69 : 
            var t$35 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [floatop(t$35, Operators.f32_min, Operators.f64_min)]);
        case 70 : 
            var t$36 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [floatop(t$36, Operators.f32_max, Operators.f64_max)]);
        case 71 : 
            var t$37 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(12, [floatop(t$37, Operators.f32_copysign, Operators.f64_copysign)]);
        case 72 : 
            var t$38 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(15, [intop(t$38, Operators.i32_eqz, Operators.i64_eqz)]);
        case 73 : 
            var t$39 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$39, Operators.i32_eq, Operators.i64_eq)]);
        case 74 : 
            var t$40 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$40, Operators.i32_ne, Operators.i64_ne)]);
        case 75 : 
            var t$41 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$41, Operators.i32_lt_s, Operators.i64_lt_s)]);
        case 76 : 
            var t$42 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$42, Operators.i32_lt_u, Operators.i64_lt_u)]);
        case 77 : 
            var t$43 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$43, Operators.i32_le_s, Operators.i64_le_s)]);
        case 78 : 
            var t$44 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$44, Operators.i32_le_u, Operators.i64_le_u)]);
        case 79 : 
            var t$45 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$45, Operators.i32_gt_s, Operators.i64_gt_s)]);
        case 80 : 
            var t$46 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$46, Operators.i32_gt_u, Operators.i64_gt_u)]);
        case 81 : 
            var t$47 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$47, Operators.i32_ge_s, Operators.i64_ge_s)]);
        case 82 : 
            var t$48 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [intop(t$48, Operators.i32_ge_u, Operators.i64_ge_u)]);
        case 83 : 
            var t$49 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [floatop(t$49, Operators.f32_eq, Operators.f64_eq)]);
        case 84 : 
            var t$50 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [floatop(t$50, Operators.f32_ne, Operators.f64_ne)]);
        case 85 : 
            var t$51 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [floatop(t$51, Operators.f32_lt, Operators.f64_lt)]);
        case 86 : 
            var t$52 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [floatop(t$52, Operators.f32_le, Operators.f64_le)]);
        case 87 : 
            var t$53 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [floatop(t$53, Operators.f32_gt, Operators.f64_gt)]);
        case 88 : 
            var t$54 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(13, [floatop(t$54, Operators.f32_ge, Operators.f64_ge)]);
        case 89 : 
            return Block.__(14, [Operators.i32_wrap_i64]);
        case 90 : 
            return Block.__(14, [Operators.i64_extend_s_i32]);
        case 91 : 
            return Block.__(14, [Operators.i64_extend_u_i32]);
        case 92 : 
            return Block.__(14, [Operators.f32_demote_f64]);
        case 93 : 
            return Block.__(14, [Operators.f64_promote_f32]);
        case 94 : 
            var t$55 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [intop(t$55, Operators.i32_trunc_s_f32, Operators.i64_trunc_s_f32)]);
        case 95 : 
            var t$56 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [intop(t$56, Operators.i32_trunc_u_f32, Operators.i64_trunc_u_f32)]);
        case 96 : 
            var t$57 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [intop(t$57, Operators.i32_trunc_s_f64, Operators.i64_trunc_s_f64)]);
        case 97 : 
            var t$58 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [intop(t$58, Operators.i32_trunc_u_f64, Operators.i64_trunc_u_f64)]);
        case 98 : 
            var t$59 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [floatop(t$59, Operators.f32_convert_s_i32, Operators.f64_convert_s_i32)]);
        case 99 : 
            var t$60 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [floatop(t$60, Operators.f32_convert_u_i32, Operators.f64_convert_u_i32)]);
        case 100 : 
            var t$61 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [floatop(t$61, Operators.f32_convert_s_i64, Operators.f64_convert_s_i64)]);
        case 101 : 
            var t$62 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[4] + 3 | 0);
            return Block.__(14, [floatop(t$62, Operators.f32_convert_u_i64, Operators.f64_convert_u_i64)]);
        case 102 : 
            return Block.__(14, [Operators.f32_reinterpret_i32]);
        case 103 : 
            return Block.__(14, [Operators.f64_reinterpret_i64]);
        case 104 : 
            return Block.__(14, [Operators.i32_reinterpret_f32]);
        case 105 : 
            return Block.__(14, [Operators.i64_reinterpret_f64]);
        case 106 : 
            return 25;
        case 107 : 
            return 26;
        ...
        case 136 : 
            return 55;
        case 137 : 
            var s$7 = Lexing.sub_lexeme(lexbuf$1, lexbuf$1[4], lexbuf$1[5]);
            return Block.__(4, [s$7]);
        case 140 : 
...
function from_function(f) {
  ...
  return [
          function (param) {
            ...
            var n = read > 0 ? read : (lexbuf[8] = 1, 0);
            if ((lexbuf[2] + n | 0) > lexbuf[1].length) {
              if (((lexbuf[2] - lexbuf[4] | 0) + n | 0) <= lexbuf[1].length) {
                Bytes.blit(lexbuf[1], lexbuf[4], lexbuf[1], 0, lexbuf[2] - lexbuf[4] | 0);
              }
              else {
                var newlen = Pervasives.min((lexbuf[1].length << 1), Sys.max_string_length);
                if (((lexbuf[2] - lexbuf[4] | 0) + n | 0) > newlen) {
                  throw [
                        Caml_builtin_exceptions.failure,
                ...
                Bytes.blit(lexbuf[1], lexbuf[4], newbuf, 0, lexbuf[2] - lexbuf[4] | 0);
                lexbuf[1] = newbuf;
              }
              var s = lexbuf[4];
...
function sub_lexeme_char(lexbuf, i) {
  return Caml_bytes.get(lexbuf[1], i);
}
...
function lexeme_char(lexbuf, i) {
  return Caml_bytes.get(lexbuf[1], lexbuf[4] + i | 0);
}
...
function create(kind, layout, n) {
  ...
  return Curry._3(Bigarray.Array1[0], kind, layout, n[1] | 0);
}
...
function Make(funarg) {
  ...
  var find = function (x, _param) {
    while(true) {
      var param = _param;
      if (param) {
        var c = Curry._2(funarg[0], x, param[1]);
        if (c) {
  ...
  var merge = function (f, s1, s2) {
    ...
    if (s1) {
      ...
      if (s1[4] >= height(s2)) {
        ...
        return concat_or_join(merge(f, s1[0], match[0]), v1, Curry._3(f, v1, [s1[2]], match[1]), merge(f, s1[3], match[2]));
      }
      else {
        exit = 1;
      }
    ...
    if (exit === 1) {
      if (s2) {
        ...
        return concat_or_join(merge(f, match$1[0], s2[0]), v2, Curry._3(f, v2, match$1[1], [s2[2]]), merge(f, match$1[2], s2[3]));
      }
      else {
        throw [
              Caml_builtin_exceptions.assert_failure,
  ...
  var compare = function (cmp, m1, m2) {
    var _e1 = cons_enum(m1, 0);
    var _e2 = cons_enum(m2, 0);
    while(true) {
      var e2 = _e2;
      var e1 = _e1;
      if (e1) {
        if (e2) {
          var c = Curry._2(funarg[0], e1[0], e2[0]);
          if (c !== 0) {
            return c;
          }
          else {
  ...
  var equal = function (cmp, m1, m2) {
    ...
    while(true) {
      ...
      if (e1) {
        if (e2) {
          if (Curry._2(funarg[0], e1[0], e2[0])) {
            return 0;
          }
...
function i32_const(n) {
  return Block.__(15, [Source.$at$at(Block.__(0, [n[1]]), n[0])]);
}

function i64_const(n) {
  return Block.__(15, [Source.$at$at(Block.__(1, [n[1]]), n[0])]);
}

function f32_const(n) {
  return Block.__(15, [Source.$at$at(Block.__(2, [n[1]]), n[0])]);
}

function f64_const(n) {
  return Block.__(15, [Source.$at$at(Block.__(3, [n[1]]), n[0])]);
}
...
function tee_local(x) {
  return Block.__(10, [x]);
}

function get_global(x) {
  return Block.__(11, [x]);
}

function set_global(x) {
  return Block.__(12, [x]);
}
...
var i32_clz = Block.__(18, [Block.__(0, [0])]);

var i32_ctz = Block.__(18, [Block.__(0, [1])]);

var i32_popcnt = Block.__(18, [Block.__(0, [2])]);

var i64_clz = Block.__(18, [Block.__(1, [0])]);

var i64_ctz = Block.__(18, [Block.__(1, [1])]);

var i64_popcnt = Block.__(18, [Block.__(1, [2])]);

var f32_neg = Block.__(18, [Block.__(2, [0])]);

var f32_abs = Block.__(18, [Block.__(2, [1])]);

var f32_sqrt = Block.__(18, [Block.__(2, [6])]);

var f32_ceil = Block.__(18, [Block.__(2, [2])]);

var f32_floor = Block.__(18, [Block.__(2, [3])]);

var f32_trunc = Block.__(18, [Block.__(2, [4])]);

var f32_nearest = Block.__(18, [Block.__(2, [5])]);

var f64_neg = Block.__(18, [Block.__(3, [0])]);

var f64_abs = Block.__(18, [Block.__(3, [1])]);

var f64_sqrt = Block.__(18, [Block.__(3, [6])]);

var f64_ceil = Block.__(18, [Block.__(3, [2])]);

var f64_floor = Block.__(18, [Block.__(3, [3])]);

var f64_trunc = Block.__(18, [Block.__(3, [4])]);

var f64_nearest = Block.__(18, [Block.__(3, [5])]);

var i32_add = Block.__(19, [Block.__(0, [0])]);

var i32_sub = Block.__(19, [Block.__(0, [1])]);

var i32_mul = Block.__(19, [Block.__(0, [2])]);

var i32_div_s = Block.__(19, [Block.__(0, [3])]);

var i32_div_u = Block.__(19, [Block.__(0, [4])]);

var i32_rem_s = Block.__(19, [Block.__(0, [5])]);

var i32_rem_u = Block.__(19, [Block.__(0, [6])]);

var i32_and = Block.__(19, [Block.__(0, [7])]);

var i32_or = Block.__(19, [Block.__(0, [8])]);

var i32_xor = Block.__(19, [Block.__(0, [9])]);

var i32_shl = Block.__(19, [Block.__(0, [10])]);

var i32_shr_s = Block.__(19, [Block.__(0, [11])]);

var i32_shr_u = Block.__(19, [Block.__(0, [12])]);

var i32_rotl = Block.__(19, [Block.__(0, [13])]);

var i32_rotr = Block.__(19, [Block.__(0, [14])]);

var i64_add = Block.__(19, [Block.__(1, [0])]);

var i64_sub = Block.__(19, [Block.__(1, [1])]);

var i64_mul = Block.__(19, [Block.__(1, [2])]);

var i64_div_s = Block.__(19, [Block.__(1, [3])]);

var i64_div_u = Block.__(19, [Block.__(1, [4])]);

var i64_rem_s = Block.__(19, [Block.__(1, [5])]);

var i64_rem_u = Block.__(19, [Block.__(1, [6])]);

var i64_and = Block.__(19, [Block.__(1, [7])]);

var i64_or = Block.__(19, [Block.__(1, [8])]);

var i64_xor = Block.__(19, [Block.__(1, [9])]);

var i64_shl = Block.__(19, [Block.__(1, [10])]);

var i64_shr_s = Block.__(19, [Block.__(1, [11])]);

var i64_shr_u = Block.__(19, [Block.__(1, [12])]);

var i64_rotl = Block.__(19, [Block.__(1, [13])]);

var i64_rotr = Block.__(19, [Block.__(1, [14])]);

var f32_add = Block.__(19, [Block.__(2, [0])]);

var f32_sub = Block.__(19, [Block.__(2, [1])]);

var f32_mul = Block.__(19, [Block.__(2, [2])]);

var f32_div = Block.__(19, [Block.__(2, [3])]);

var f32_min = Block.__(19, [Block.__(2, [4])]);

var f32_max = Block.__(19, [Block.__(2, [5])]);

var f32_copysign = Block.__(19, [Block.__(2, [6])]);

var f64_add = Block.__(19, [Block.__(3, [0])]);

var f64_sub = Block.__(19, [Block.__(3, [1])]);

var f64_mul = Block.__(19, [Block.__(3, [2])]);

var f64_div = Block.__(19, [Block.__(3, [3])]);

var f64_min = Block.__(19, [Block.__(3, [4])]);

var f64_max = Block.__(19, [Block.__(3, [5])]);

var f64_copysign = Block.__(19, [Block.__(3, [6])]);

var i32_eqz = Block.__(16, [Block.__(0, [0])]);

var i64_eqz = Block.__(16, [Block.__(1, [0])]);

var i32_eq = Block.__(17, [Block.__(0, [0])]);

var i32_ne = Block.__(17, [Block.__(0, [1])]);

var i32_lt_s = Block.__(17, [Block.__(0, [2])]);

var i32_lt_u = Block.__(17, [Block.__(0, [3])]);

var i32_le_s = Block.__(17, [Block.__(0, [6])]);

var i32_le_u = Block.__(17, [Block.__(0, [7])]);

var i32_gt_s = Block.__(17, [Block.__(0, [4])]);

var i32_gt_u = Block.__(17, [Block.__(0, [5])]);

var i32_ge_s = Block.__(17, [Block.__(0, [8])]);

var i32_ge_u = Block.__(17, [Block.__(0, [9])]);

var i64_eq = Block.__(17, [Block.__(1, [0])]);

var i64_ne = Block.__(17, [Block.__(1, [1])]);

var i64_lt_s = Block.__(17, [Block.__(1, [2])]);

var i64_lt_u = Block.__(17, [Block.__(1, [3])]);

var i64_le_s = Block.__(17, [Block.__(1, [6])]);

var i64_le_u = Block.__(17, [Block.__(1, [7])]);

var i64_gt_s = Block.__(17, [Block.__(1, [4])]);

var i64_gt_u = Block.__(17, [Block.__(1, [5])]);

var i64_ge_s = Block.__(17, [Block.__(1, [8])]);

var i64_ge_u = Block.__(17, [Block.__(1, [9])]);

var f32_eq = Block.__(17, [Block.__(2, [0])]);

var f32_ne = Block.__(17, [Block.__(2, [1])]);

var f32_lt = Block.__(17, [Block.__(2, [2])]);

var f32_le = Block.__(17, [Block.__(2, [4])]);

var f32_gt = Block.__(17, [Block.__(2, [3])]);

var f32_ge = Block.__(17, [Block.__(2, [5])]);

var f64_eq = Block.__(17, [Block.__(3, [0])]);

var f64_ne = Block.__(17, [Block.__(3, [1])]);

var f64_lt = Block.__(17, [Block.__(3, [2])]);

var f64_le = Block.__(17, [Block.__(3, [4])]);

var f64_gt = Block.__(17, [Block.__(3, [3])]);

var f64_ge = Block.__(17, [Block.__(3, [5])]);

var i32_wrap_i64 = Block.__(20, [Block.__(0, [2])]);

var i32_trunc_s_f32 = Block.__(20, [Block.__(0, [3])]);

var i32_trunc_u_f32 = Block.__(20, [Block.__(0, [4])]);

var i32_trunc_s_f64 = Block.__(20, [Block.__(0, [5])]);

var i32_trunc_u_f64 = Block.__(20, [Block.__(0, [6])]);

var i64_extend_s_i32 = Block.__(20, [Block.__(1, [0])]);

var i64_extend_u_i32 = Block.__(20, [Block.__(1, [1])]);

var i64_trunc_s_f32 = Block.__(20, [Block.__(1, [3])]);

var i64_trunc_u_f32 = Block.__(20, [Block.__(1, [4])]);

var i64_trunc_s_f64 = Block.__(20, [Block.__(1, [5])]);

var i64_trunc_u_f64 = Block.__(20, [Block.__(1, [6])]);

var f32_convert_s_i32 = Block.__(20, [Block.__(2, [0])]);

var f32_convert_u_i32 = Block.__(20, [Block.__(2, [1])]);

var f32_convert_s_i64 = Block.__(20, [Block.__(2, [2])]);

var f32_convert_u_i64 = Block.__(20, [Block.__(2, [3])]);

var f32_demote_f64 = Block.__(20, [Block.__(2, [5])]);

var f64_convert_s_i32 = Block.__(20, [Block.__(3, [0])]);

var f64_convert_u_i32 = Block.__(20, [Block.__(3, [1])]);

var f64_convert_s_i64 = Block.__(20, [Block.__(3, [2])]);

var f64_convert_u_i64 = Block.__(20, [Block.__(3, [3])]);

var f64_promote_f32 = Block.__(20, [Block.__(3, [4])]);

var i32_reinterpret_f32 = Block.__(20, [Block.__(0, [7])]);

var i64_reinterpret_f64 = Block.__(20, [Block.__(1, [7])]);

var f32_reinterpret_i32 = Block.__(20, [Block.__(2, [6])]);

var f64_reinterpret_i64 = Block.__(20, [Block.__(3, [6])]);

var current_memory = 5;
...
function parse$prime(name, lexbuf, start) {
  ...
  try {
    ...
    if (exn[0] === Script.Syntax) {
      var region = exn[1];
      var region$prime = Caml_obj.caml_notequal(region, Source.no_region) ? region : [
          Lexer.convert_pos(lexbuf[10]),
          Lexer.convert_pos(lexbuf[11])
        ];
      throw [
            Script.Syntax,
            region$prime,
...
function string_to_script(s) {
  return string_to(1, s);
}

function string_to_module(s) {
  return string_to(0, s);
}
...
function positions_to_region(position1, position2) {
  return [
          position_to_pos(position1),
          position_to_pos(position2)
        ];
}
...
function type_(c, x) {
  try {
    return Curry._2(VarMap[21], x[1], c[0][0]);
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      throw [
...
function lookup(category, space, x) {
  try {
    return Curry._2(VarMap[21], x[1], space[0]);
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      throw [
...
function func(c, x) {
  return lookup("function", c[3], x);
}

function local(c, x) {
  return lookup("local", c[4], x);
}

function global(c, x) {
  return lookup("global", c[5], x);
}

function table(c, x) {
  return lookup("table", c[1], x);
}

function memory(c, x) {
  return lookup("memory", c[2], x);
}

function label(c, x) {
  try {
    return Curry._2(VarMap[21], x[1], c[6]);
  }
  catch (exn){
    if (exn === Caml_builtin_exceptions.not_found) {
      throw [
...
function bind(category, space, x) {
  if (Curry._2(VarMap[2], x[1], space[0])) {
    throw [
          Script.Syntax,
          x[0],
          "duplicate " + (category + (" " + x[1]))
        ];
  }
  space[0] = Curry._3(VarMap[3], x[1], space[1], space[0]);
  space[1] = space[1] + 1 | 0;
  if (space[1]) {
    return 0;
  }
...
function bind_func(c, x) {
  return bind("function", c[3], x);
}

function bind_local(c, x) {
  return bind("local", c[4], x);
}

function bind_global(c, x) {
  return bind("global", c[5], x);
}

function bind_table(c, x) {
  return bind("table", c[1], x);
}

function bind_memory(c, x) {
  return bind("memory", c[2], x);
}

function anon(category, space, n) {
  space[1] = space[1] + n | 0;
  if (Curry._2(I32.lt_u, space[1], n)) {
    throw [
          Script.Syntax,
          Source.no_region,
          "too many " + (category + " bindings")
...
function anon_func(c) {
  return anon("function", c[3], 1);
}

function anon_locals(c, ts) {
  return anon("local", c[4], Curry._1(Lib.List32[0], ts));
}

function anon_global(c) {
  return anon("global", c[5], 1);
}

function anon_table(c) {
  return anon("table", c[1], 1);
}

function anon_memory(c) {
  return anon("memory", c[2], 1);
}

function anon_label(c) {
  var newrecord = c.slice();
  newrecord[6] = Curry._2(VarMap[22], function (param) {
        return 1 + param | 0;
      }, c[6]);
  return newrecord;
}
...
function explicit_sig(c, var_sem, ty, at) {
  ...
  if (x[1] < Curry._1(Lib.List32[0], c[0][1]) && Caml_obj.caml_notequal(ty, empty_type) && Caml_obj.caml_notequal(ty, Curry._2(Lib.List32[1], c[0][1], x[1]))) {
    throw [
          Script.Syntax,
          at,
          "signature mismatch"
...
function inline_type(c, ty, at) {
  var match = Curry._2(Lib.List[6], ty, c[0][1]);
  if (match) {
    return Source.$at$at(match[0], at);
  }
  else {
    var i = Curry._1(Lib.List32[0], c[0][1]);
    anon_type(c, ty);
...
var yyact = [
  ...
  function (__caml_parser_env) {
    ...
    return function (c, xs) {
      ...
      newrecord[6] = Curry._3(VarMap[3], x[1], 0, Curry._2(VarMap[22], function (param) {
                return 1 + param | 0;
              }, c$1[6]));
      return newrecord;
    };
  ...
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      return function () {
        return [
                Source.$at$at([_5], at$1),
                0,
                Curry._3(_4, 1, c[1][1], c)
              ];
      };
    };
  },
  ...
  function (__caml_parser_env) {
    ...
    return function (c) {
      Curry._3(_3, c, anon_func, bind_func);
      return Block.__(0, [Curry._2(_4, c, type_)]);
    };
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    ...
    return function (c) {
      Curry._3(_3, c, anon_func, bind_func);
      return Block.__(0, [inline_type(c, _4, at4)]);
    };
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
  ...
  function (__caml_parser_env) {
    ...
    return function (c) {
      return Source.$at$at([
                  _3,
                  _4,
                  Source.$at$at(Curry._1(_5, c), at5)
                ], at$1);
    };
  },
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      return Source.$at$at([
                  _4[0],
                  _4[1],
                  Source.$at$at(Block.__(0, [Curry._2(_5, c, type_)]), at$1)
                ], at$1);
    };
  },
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      return Source.$at$at([
                  _4[0],
                  _4[1],
                  Source.$at$at(Block.__(0, [inline_type(c, _5, at5)]), at$1)
                ], at$1);
    };
  },
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      return Source.$at$at([
                  _4[0],
                  _4[1],
                  Source.$at$at(Block.__(1, [_5]), at$1)
                ], at$1);
    };
  },
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      return Source.$at$at([
                  _4[0],
                  _4[1],
                  Source.$at$at(Block.__(2, [_5]), at$1)
                ], at$1);
    };
  },
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      return Source.$at$at([
                  _4[0],
                  _4[1],
                  Source.$at$at(Block.__(3, [_5]), at$1)
                ], at$1);
    };
  },
  function (__caml_parser_env) {
  ...
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      var x = _3;
      var ty = _4;
      if (Curry._2(VarMap[2], x[1], c$1[0][0])) {
        throw [
              Script.Syntax,
              x[0],
              "duplicate type " + x[1]
      ...
      c$1[0][0] = Curry._3(VarMap[3], x[1], Curry._1(Lib.List32[0], c$1[0][1]), c$1[0][0]);
      c$1[0][1] = Pervasives.$at(c$1[0][1], [
            ty,
            0
          ]);
      return 0;
  ...
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      newrecord[9] = Pervasives.$at(match[1], m[9]);
      return newrecord;
    };
  },
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      newrecord[6] = Pervasives.$at(match[1], m[6]);
      newrecord[9] = Pervasives.$at(match[2], m[9]);
      return newrecord;
    };
  },
  function (__caml_parser_env) {
    ...
    return function (c) {
      ...
      newrecord[7] = Pervasives.$at(match[1], m[7]);
      newrecord[9] = Pervasives.$at(match[2], m[9]);
      return newrecord;
    };
  },
  ...
  function (__caml_parser_env) {
    ...
    return [
            _3,
            Source.$at$at(Block.__(0, [Source.$at$at(Curry._1(_4, empty_context(0)), at(0))]), at(0))
          ];
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 3);
  ...
  function (__caml_parser_env) {
    ...
    var _4 = Parsing.peek_val(__caml_parser_env, 2);
    var _5 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(0, [
                  _3,
                  _4,
                  _5
                ]), at(0));
  ...
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    var _4 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(1, [
                  _3,
                  _4
                ]), at(0));
  },
  ...
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    var _4 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(2, [
                  _3[1],
                  _4
                ]), at(0));
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    var _4 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(3, [
                  _3[1],
                  _4
                ]), at(0));
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    var _4 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(4, [
                  _3[1],
                  _4
                ]), at(0));
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    var _4 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(5, [
                  _3,
                  _4
                ]), at(0));
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(6, [_3]), at(0));
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    var _4 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(7, [
                  _3,
                  _4
                ]), at(0));
  },
  function (__caml_parser_env) {
    var _3 = Parsing.peek_val(__caml_parser_env, 2);
    var _4 = Parsing.peek_val(__caml_parser_env, 1);
    return Source.$at$at(Block.__(8, [
                  _3,
                  _4
                ]), at(0));
  },
  function (__caml_parser_env) {
    var _1 = Parsing.peek_val(__caml_parser_env, 0);
    return Source.$at$at(Block.__(2, [_1]), at(0));
  },
  function (__caml_parser_env) {
    var _1 = Parsing.peek_val(__caml_parser_env, 0);
    return Source.$at$at(Block.__(3, [_1]), at(0));
  },
  function (__caml_parser_env) {
    var _1 = Parsing.peek_val(__caml_parser_env, 0);
    return Source.$at$at(Block.__(0, [
  ...
  function (__caml_parser_env) {
    var _1 = Parsing.peek_val(__caml_parser_env, 0);
    return Source.$at$at(Block.__(4, [_1]), at(0));
  },
  function () {
    return 0;
  },
    ...
    while(true) {
      ...
      switch (match) {
        ...
        case 2 : 
            ...
            continue ;
            case 5 : 
            Curry._1(tables[13], "syntax error");
            _arg = 0;
            _cmd = 5;
            continue ;
...
function symbol_start_pos() {
  ...
  while(true) {
    ...
    if (i <= 0) {
      ...
      var st = env[2][(env[10] - i | 0) + 1 | 0];
      var en = env[3][(env[10] - i | 0) + 1 | 0];
...
function rhs_start_pos(n) {
  return env[2][env[10] - (env[11] - n | 0) | 0];
}

function rhs_end_pos(n) {
  return env[3][env[10] - (env[11] - n | 0) | 0];
}
...
function pp(off, width, param) {
  if (param.tag) {
    ...
    return [
            len,
            $caret$plus("(", $caret$plus(s, $plus$caret($plus$caret(Block.__(1, [List.map(function (r) {
...
function string_of_pos(pos) {
  if (pos[1] === -1) {
    ...
    return Pervasives.string_of_int(pos[1]) + ("." + Pervasives.string_of_int(pos[2] + 1 | 0));
  }
}

function string_of_region(r) {
  return r[0][0] + (":" + (string_of_pos(r[0]) + (
              Caml_obj.caml_equal(r[1], r[0]) ? "" : "-" + string_of_pos(r[1])
            )));
}
...
function string_of_limits(param) {
  var max = param[1];
  return Curry._1(I32.to_string_u, param[0]) + (
...
function default_value(param) {
  switch (param) {
    case 0 : 
        return Block.__(0, [I32.zero]);
    case 1 : 
        return Block.__(1, [I64.zero]);
    case 2 : 
        return Block.__(2, [F32.zero]);
    case 3 : 
        return Block.__(3, [F64.zero]);
    
  }
}

function value_of_bool(b) {
  return Block.__(0, [b ? 1 : 0]);
}
