...
testConversion('f32', 'convert_i64_s', 'i64', "0x7fffffff", 2147483648.0); 
testConversion('f32', 'convert_i64_s', 'i64', "0x80000000", 2147483648.0);
testConversion('f32', 'convert_i64_s', 'i64', "0x80000001", 2147483648.0); 
...
testConversion('i32', 'trunc_f32_s', 'f32', p(2, 31) - 128, p(2, 31) - 128); 
testConversion('i32', 'trunc_f32_s', 'f32', -p(2, 31), -p(2,31)); 
...
testConversion('i32', 'trunc_f64_s', 'f64', p(2,31) - 0.001, p(2,31) - 1); 
testConversion('i32', 'trunc_f64_s', 'f64', -p(2,31) - 0.999, -p(2,31)); 
...
testConversion('i32', 'trunc_f32_u', 'f32', p(2,32) - 256, (p(2,32) - 256)|0); 
testConversion('i32', 'trunc_f32_u', 'f32', -0.99, 0); 
...
testConversion('i32', 'trunc_f64_u', 'f64', p(2,32) - 0.001, (p(2,32) - 1)|0); 
testConversion('i32', 'trunc_f64_u', 'f64', -0.99999, 0); 
