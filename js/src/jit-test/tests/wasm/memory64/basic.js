...
const MaxTable64Elems = 0xFFFF_FFFF; 
const MaxUint32 = 0xFFFF_FFFF;
const MaxTableElems = 10000000; 
...
function testRead(ins, mem, LOC, prefix) {
    ...
    assertEq(ins.exports[NM + "@0"](BigInt(len - SZ)), Zero(SZ)); 
  ...
  try {
    ...
    for (const delta of indexes) {
      if (idxType1 === "i64") {
        ...
        assertErrorMessage(() => f1.grow(delta, null), Error, /grow/); 
