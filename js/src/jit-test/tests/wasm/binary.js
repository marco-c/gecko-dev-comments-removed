...
runStackTraceTest([{nameLen: 100, name: 'test'}], 'wasm-function[0]'); 
runStackTraceTest([{name: 'test', locals: [{nameLen: 40, name: 'var1'}]}], 'wasm-function[0]'); 
runStackTraceTest([{name: ''}], 'wasm-function[0]'); 
