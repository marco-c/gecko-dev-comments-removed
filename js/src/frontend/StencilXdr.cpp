...
template <XDRMode mode>
 XDRResult StencilXDR::codeBigInt(XDRState<mode>* xdr,
                                              LifoAlloc& alloc,
...
template <XDRMode mode>
 XDRResult StencilXDR::codeObjLiteral(XDRState<mode>* xdr,
                                                  LifoAlloc& alloc,
...
template <typename ScopeT>
 void AssertScopeSpecificDataIsEncodable() {
...
template  XDRResult StencilXDR::codeSharedData(
...
template <XDRMode mode>
 XDRResult StencilXDR::codeParserAtom(XDRState<mode>* xdr,
                                                  LifoAlloc& alloc,
                                                  ParserAtom** atomp) {
...
template <XDRMode mode>
 XDRResult StencilXDR::codeParserAtomSpan(
...
template <XDRMode mode>
 XDRResult StencilXDR::codeModuleRequest(
...
template <XDRMode mode>
 XDRResult StencilXDR::codeModuleRequestVector(
...
template <XDRMode mode>
 XDRResult StencilXDR::codeModuleEntry(
...
template <XDRMode mode>
 XDRResult StencilXDR::codeModuleEntryVector(
...
template <XDRMode mode>
 XDRResult StencilXDR::codeCompilationStencil(
...
template  XDRResult StencilXDR::codeCompilationStencil(
