...
impl CPPExporter {
    ...
    fn get_field_type_name(canonical_list_parsers: &HashMap<NodeName, ListParserData>, typedef: Option<&str>, spec: &Spec, type_: &Type, make_optional: bool) -> Cow<'static, str> {
