...
new TestCase( "VAR1 = 10; VAR2 = '255', VAR1 *= VAR2",
              2550,      
              eval("VAR1 = 10; VAR2 = '255', VAR1 *= VAR2") );

new TestCase( "VAR1 = '255'; VAR2 = 10, VAR1 *= VAR2",
              2550,      
              eval("VAR1 = '255'; VAR2 = 10, VAR1 *= VAR2") );

new TestCase( "VAR1 = 10; VAR2 = '0XFF', VAR1 *= VAR2",
              2550,      
...
new TestCase( "VAR1 = true; VAR2 = false; VAR1 *= VAR2",   
              0,     
              eval("VAR1 = true; VAR2 = false; VAR1 *= VAR2") );

new TestCase( "VAR1 = true; VAR2 = true; VAR1 *= VAR2",   
              1,     
              eval("VAR1 = true; VAR2 = true; VAR1 *= VAR2") );


new TestCase( "VAR1 = new Boolean(true); VAR2 = 10; VAR1 *= VAR2;VAR1",   
              10,     
              eval("VAR1 = new Boolean(true); VAR2 = 10; VAR1 *= VAR2; VAR1") );

new TestCase( "VAR1 = new Number(11); VAR2 = 10; VAR1 *= VAR2; VAR1",   
              110,     
              eval("VAR1 = new Number(11); VAR2 = 10; VAR1 *= VAR2; VAR1") );

new TestCase( "VAR1 = new Number(11); VAR2 = new Number(10); VAR1 *= VAR2",   
              110,     
              eval("VAR1 = new Number(11); VAR2 = new Number(10); VAR1 *= VAR2") );

new TestCase( "VAR1 = new String('15'); VAR2 = new String('0xF'); VAR1 *= VAR2",   
              225,     
