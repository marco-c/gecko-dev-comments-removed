...
for ( CHARCODE=0; CHARCODE <256; CHARCODE++ ) {
  new TestCase( "(String.fromCharCode("+CHARCODE+")).charCodeAt(0)",
		CHARCODE,
...
new TestCase( "(String.fromCharCode(65535)).charCodeAt(0)", 65535,     (String.fromCharCode(65535)).charCodeAt(0) );
