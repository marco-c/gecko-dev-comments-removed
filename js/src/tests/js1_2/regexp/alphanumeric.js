...
new TestCase ( "'" + alphanumeric + "'.match(new RegExp('\\w+'))",
	       String([alphanumeric]), String(alphanumeric.match(new RegExp('\\w+'))));


new TestCase ( "'" + non_alphanumeric + "'.match(new RegExp('\\W+'))",
...
new TestCase ( "'" + s + "'.match(new RegExp('\\w+'))",
