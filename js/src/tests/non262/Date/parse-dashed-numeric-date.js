...
inTimeZone("GMT-0100", () => {
  ...
  const accepted = {
    ...
    "275760-09-12 23:00:00": new Date(275760, Month.September, 12, 23),
    "275760-09-12 (comment) 23:00:00": new Date(275760, Month.September, 12, 23),
    "275760-09-12 23:00:00.555": new Date(275760, Month.September, 12, 23, 0, 0, 555),
    "275760-09-12 23:00:00 GMT-0200": new Date(275760, Month.September, 12, 22),
  ...
  for (const [test, dateObject] of Object.entries(accepted)) {
    assertEq(new Date(test).getTime(), dateObject.getTime(),
