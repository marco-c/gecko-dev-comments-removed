...
assert.sameValue(typedArray[1], 9223372036854775810n, 
...
assert.sameValue(typedArray[4], 18446744073709551614n, 
...
assert.sameValue(typedArray[6], 18446744073709551614n, 
