...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M08", day: 16, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months5).toPlainDateTime(),
    2022, 1, "M01", 16, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2019, monthCode: "M10", day: 1, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months5).toPlainDateTime(),
    2020, 3, "M03", 1, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year on day 1 of month");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M10", day: 31, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months5).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M11", day: 30, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1months2).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M01", day: 16, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months5n).toPlainDateTime(),
    2020, 8, "M08", 16, 12, 34, 0, 0, 0, 0, "subtract 5mo with result in the previous year");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2019, monthCode: "M02", day: 1, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months5n).toPlainDateTime(),
    2018, 9, "M09", 1, 12, 34, 0, 0, 0, 0, "subtract 5mo with result in the previous year on day 1 of month");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M03", day: 31, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months5n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M02", day: 17, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1months2n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M12", day: 25, hour: 12, minute: 34, timeZone: "UTC" }).subtract(weeks1).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2019, monthCode: "M10", day: 28, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months2weeks3).toPlainDateTime(),
    2020, 1, "M01", 18, 12, 34, 0, 0, 0, 0, "add 2mo 3w with result in the next year");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2019, monthCode: "M10", day: 31, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months2weeks3).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M01", day: 8, hour: 12, minute: 34, timeZone: "UTC" }).subtract(weeks1n).toPlainDateTime(),
    2021, 1, "M01", 1, 12, 34, 0, 0, 0, 0, "subtract 1w with result on the first day of the year");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M01", day: 7, hour: 12, minute: 34, timeZone: "UTC" }).subtract(weeks1n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M07", day: 3, hour: 12, minute: 34, timeZone: "UTC" }).subtract(weeks1n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M09", day: 8, hour: 12, minute: 34, timeZone: "UTC" }).subtract(weeks6n).toPlainDateTime(),
    2021, 7, "M07", 28, 12, 34, 0, 0, 0, 0, "subtract 6w crossing months of 30 and 31 days");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M08", day: 8, hour: 12, minute: 34, timeZone: "UTC" }).subtract(weeks6n).toPlainDateTime(),
    2021, 6, "M06", 27, 12, 34, 0, 0, 0, 0, "subtract 6w crossing months of 31 and 31 days");

TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2022, monthCode: "M01", day: 5, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1weeks2n).toPlainDateTime(),
    2020, 12, "M12", 22, 12, 34, 0, 0, 0, 0, "subtract 1y 2w with result in the previous year");

TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2019, monthCode: "M03", day: 2, hour: 12, minute: 34, timeZone: "UTC" }).subtract(months2weeks3n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M07", day: 26, hour: 12, minute: 34, timeZone: "UTC" }).subtract(days10).toPlainDateTime(),
    2021, 8, "M08", 5, 12, 34, 0, 0, 0, 0, "add 10 days with result in the next month");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M12", day: 26, hour: 12, minute: 34, timeZone: "UTC" }).subtract(days10).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M02", day: 27, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1months2days4).toPlainDateTime(),
    2022, 5, "M05", 1, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 30-day month");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M07", day: 30, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1months2days4).toPlainDateTime(),
    2022, 10, "M10", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 30-day month");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M01", day: 28, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1months2days4).toPlainDateTime(),
    2022, 4, "M04", 1, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in a month following a 31-day month");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M06", day: 30, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1months2days4).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M07", day: 6, hour: 12, minute: 34, timeZone: "UTC" }).subtract(days10n).toPlainDateTime(),
    2021, 6, "M06", 26, 12, 34, 0, 0, 0, 0, "subtract 10 days with result in the previous month");
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M01", day: 4, hour: 12, minute: 34, timeZone: "UTC" }).subtract(days10n).toPlainDateTime(),
    2020, 12, "M12", 25, 12, 34, 0, 0, 0, 0, "subtract 10 days with result in the previous year");

TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M01", day: 15, hour: 12, minute: 34, timeZone: "UTC" }).subtract(weeks2days3n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
    Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M07", day: 4, hour: 12, minute: 34, timeZone: "UTC" }).subtract(years1months2days4n).toPlainDateTime(),
