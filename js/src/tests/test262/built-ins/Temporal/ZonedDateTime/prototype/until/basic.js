...
const date = Temporal.ZonedDateTime.from({year: 1969, monthCode: "M07", day: 24, hour: 12, minute: 34, timeZone: "UTC" });
const date2 = Temporal.ZonedDateTime.from({year: 1969, monthCode: "M10", day: 5, hour: 12, minute: 34, timeZone: "UTC" });
TemporalHelpers.assertDuration(date2.until(date, { largestUnit: "days" }), 0, 0, 0,  -73, 0, 0, 0, 0, 0, 0, "same year");

const earlier = date;
const later = Temporal.ZonedDateTime.from({year: 1996, monthCode: "M03", day: 3, hour: 12, minute: 34, timeZone: "UTC" });
...
const date20010618 = Temporal.ZonedDateTime.from({year: 2001, monthCode: "M06", day: 18, hour: 12, minute: 34, timeZone: "UTC" });
...
const date20010601 = Temporal.ZonedDateTime.from({year: 2001, monthCode: "M06", day: 1, hour: 12, minute: 34, timeZone: "UTC" });
...
const date20001007 = Temporal.ZonedDateTime.from({year: 2000, monthCode: "M10", day: 7, hour: 12, minute: 34, timeZone: "UTC" });
