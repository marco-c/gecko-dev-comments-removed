...
const zdt2 = new Temporal.ZonedDateTime(946722600_000_000_000n , springFallZone);



{
  const zdt1 = new Temporal.ZonedDateTime(949442400_000_000_000n , springFallZone);
...
{
  const zdt1 = new Temporal.ZonedDateTime(949395600_000_000_000n , springFallZone);
  const result = zdt1.since(zdt2, { largestUnit: "years" });
...
{
  const end = new Temporal.ZonedDateTime(957258000_000_000_000n , springFallZone);
  const start = new Temporal.ZonedDateTime(954671400_000_000_000n , springFallZone);
