...
const zdt1 = new Temporal.ZonedDateTime(946722600_000_000_000n , springFallZone);



{
  const zdt2 = new Temporal.ZonedDateTime(949442400_000_000_000n , springFallZone);
...
{
  const zdt2 = new Temporal.ZonedDateTime(949395600_000_000_000n , springFallZone);
  const result = zdt1.until(zdt2, { largestUnit: "years" });
...
{
  const zdt2 = new Temporal.ZonedDateTime(954669600_000_000_000n , springFallZone);
  const result = zdt1.until(zdt2, { largestUnit: "years" });
...
{
  const start = new Temporal.ZonedDateTime(1325102400_000_000_000n , dateLineZone);
  const end = new Temporal.ZonedDateTime(1325257200_000_000_000n , dateLineZone);
