...
TemporalHelpers.assertDuration(laterSinceYear,
   4, 0, 0, 0, 0, 0, 0, 0, 0, 0, "rounds to an increment of years");
...
TemporalHelpers.assertDuration(laterSinceMixed,
   2,  5, 0, 0, 0, 0, 0, 0, 0, 0, "rounds to an increment of months mixed with years");
...
TemporalHelpers.assertDuration(laterSinceMonth,
  0,  30, 0, 0, 0, 0, 0, 0, 0, 0, "rounds to an increment of pure months");
