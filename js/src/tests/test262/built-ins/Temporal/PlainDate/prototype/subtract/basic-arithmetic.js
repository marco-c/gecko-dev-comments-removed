...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M08", day: 16 }).subtract(months5),
    2022, 1, "M01", 16, "add 5mo with result in the next year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M10", day: 1 }).subtract(months5),
    2020, 3, "M03", 1, "add 5mo with result in the next year on day 1 of month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M10", day: 31 }).subtract(months5),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M11", day: 30 }).subtract(years1months2),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 16 }).subtract(months5n),
    2020, 8, "M08", 16, "subtract 5mo with result in the previous year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M02", day: 1 }).subtract(months5n),
    2018, 9, "M09", 1, "subtract 5mo with result in the previous year on day 1 of month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M03", day: 31 }).subtract(months5n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M02", day: 17 }).subtract(years1months2n),
    2019, 12, "M12", 17, "subtract 1y 2mo with result in the previous year");

TemporalHelpers.assertPlainDate(
  date20001201.subtract(months6),
  2001, 6, "M06", 1, "subtract 6mo");
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M12", day: 25 }).subtract(weeks1),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M10", day: 28 }).subtract(months2weeks3),
    2020, 1, "M01", 18, "add 2mo 3w with result in the next year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M10", day: 31 }).subtract(months2weeks3),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 8 }).subtract(weeks1n),
    2021, 1, "M01", 1, "subtract 1w with result on the first day of the year");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 7 }).subtract(weeks1n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 3 }).subtract(weeks1n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M09", day: 8 }).subtract(weeks6n),
    2021, 7, "M07", 28, "subtract 6w crossing months of 30 and 31 days");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M08", day: 8 }).subtract(weeks6n),
    2021, 6, "M06", 27, "subtract 6w crossing months of 31 and 31 days");

TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2022, monthCode: "M01", day: 5 }).subtract(years1weeks2n),
    2020, 12, "M12", 22, "subtract 1y 2w with result in the previous year");

TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2019, monthCode: "M03", day: 2 }).subtract(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 26 }).subtract(days10),
    2021, 8, "M08", 5, "add 10 days with result in the next month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M12", day: 26 }).subtract(days10),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M02", day: 27 }).subtract(years1months2days4),
    2022, 5, "M05", 1, "add 1y 2mo 4d with result in a month following a 30-day month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 30 }).subtract(years1months2days4),
    2022, 10, "M10", 4, "add 1y 2mo 4d with result in a month following a 30-day month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 28 }).subtract(years1months2days4),
    2022, 4, "M04", 1, "add 1y 2mo 4d with result in a month following a 31-day month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M06", day: 30 }).subtract(years1months2days4),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 6 }).subtract(days10n),
    2021, 6, "M06", 26, "subtract 10 days with result in the previous month");
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 4 }).subtract(days10n),
    2020, 12, "M12", 25, "subtract 10 days with result in the previous year");

TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M01", day: 15 }).subtract(weeks2days3n),
...
TemporalHelpers.assertPlainDate(
    Temporal.PlainDate.from({ year: 2021, monthCode: "M07", day: 4 }).subtract(years1months2days4n),
