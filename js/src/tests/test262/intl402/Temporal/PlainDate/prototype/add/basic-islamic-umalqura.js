...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1441, monthCode: "M12", day: 29, calendar }, options).add(months2weeks3),
  1442, 3, "M03", 20, "add 2 months 3 weeks from end of year to next year",
  "ah", 1442
);

TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1441, monthCode: "M10", day: 1, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1440, monthCode: "M12", day: 29, calendar }, options).add(days10),
...
TemporalHelpers.assertPlainDate(
  Temporal.PlainDate.from({ year: 1439, monthCode: "M06", day: 1, calendar }, options).add(days10n),
