...
const common1231 = Temporal.PlainDate.from({ year: 108, monthCode: "M12", day: 31, calendar }, options);
const leap0131 = Temporal.PlainDate.from({ year: 105, monthCode: "M01", day: 31, calendar }, options);
const leap1231 = Temporal.PlainDate.from({ year: 105, monthCode: "M12", day: 31, calendar }, options);
...
TemporalHelpers.assertPlainDate(
  ...
  108, 1, "M01", 31, "common-year Jan does not reject 31",
  "roc", 108);
...
TemporalHelpers.assertPlainDate(
  ...
  105, 1, "M01", 31, "leap-year Jan does not reject 31",
  "roc", 105);
