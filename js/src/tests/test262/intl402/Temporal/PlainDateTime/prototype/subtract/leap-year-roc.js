...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M09", day: 30, hour: 12, minute: 34, calendar }, options).subtract(months5),
  111, 2, "M02", 28, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year constrained to Feb 28",
  "roc", 111);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 108, monthCode: "M09", day: 30, hour: 12, minute: 34, calendar }, options).subtract(months5),
  109, 2, "M02", 29, 12, 34, 0, 0, 0, 0, "add 5mo with result in the next year constrained to Feb 29",
  "roc", 109);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M12", day: 31, hour: 12, minute: 34, calendar }, options).subtract(years1months2),
  112, 2, "M02", 28, 12, 34, 0, 0, 0, 0, "add 1y 2mo with result in the next year constrained to Feb 28",
  "roc", 112);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 111, monthCode: "M12", day: 31, hour: 12, minute: 34, calendar }, options).subtract(years1months2),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "roc", 108);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options).subtract(months11n),
  109, 2, "M02", 29, 12, 34, 0, 0, 0, 0, "add 11mo with result in the next year constrained to Feb 29",
  "roc", 109);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 111, monthCode: "M04", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2n),
  110, 2, "M02", 28, 12, 34, 0, 0, 0, 0, "add 1y 2mo with result in the previous year constrained to Feb 28",
  "roc", 110);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M04", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M02", day: 27, hour: 12, minute: 34, calendar }, options).subtract(weeks1),
  110, 3, "M03", 6, 12, 34, 0, 0, 0, 0, "add 1w in Feb with result in March",
  "roc", 110);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 109, monthCode: "M02", day: 27, hour: 12, minute: 34, calendar }, options).subtract(weeks1),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "roc", 109);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 109, monthCode: "M01", day: 27, hour: 12, minute: 34, calendar }, options).subtract(weeks6),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "roc", 110);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 108, monthCode: "M02", day: 28, hour: 12, minute: 34, calendar }, options).subtract(years1weeks2),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M04", day: 2, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
  110, 2, "M02", 19, 12, 34, 0, 0, 0, 0, "subtract 6w with result in Feb",
  "roc", 110);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 109, monthCode: "M04", day: 2, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
  109, 2, "M02", 20, 12, 34, 0, 0, 0, 0, "subtract 6w with result in leap-year Feb",
  "roc", 109);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 109, monthCode: "M03", day: 9, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "roc", 108);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 112, monthCode: "M03", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1weeks2n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "roc", 108);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 108, monthCode: "M03", day: 1, hour: 12, minute: 34, calendar }, options).subtract(months2weeks3n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 109, monthCode: "M02", day: 26, hour: 12, minute: 34, calendar }, options).subtract(days10),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "roc", 111);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 112, monthCode: "M02", day: 26, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  113, 4, "M04", 30, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result in leap-year April",
  "roc", 113);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M12", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  112, 3, "M03", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into common-year March",
  "roc", 112);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 111, monthCode: "M12", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  113, 3, "M03", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into leap-year March",
  "roc", 113);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 111, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  113, 3, "M03", 4, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into leap-year March",
  "roc", 113);
...
TemporalHelpers.assertPlainDateTime(
  ...
  "roc", 110);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 109, monthCode: "M03", day: 10, hour: 12, minute: 34, calendar }, options).subtract(days10n),
  109, 2, "M02", 29, 12, 34, 0, 0, 0, 0, "subtract 10d with result on leap day",
  "roc", 109);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M03", day: 10, hour: 12, minute: 34, calendar }, options).subtract(days10n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 112, monthCode: "M03", day: 24, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  111, 1, "M01", 20, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in common-year January",
  "roc", 111);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M03", day: 24, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  109, 1, "M01", 20, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in leap-year January",
  "roc", 109);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 112, monthCode: "M05", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  111, 2, "M02", 25, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into common-year February",
  "roc", 111);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 110, monthCode: "M05", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
