...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1362, monthCode: "M10", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2),
  1363, 12, "M12", 29, 12, 34, 0, 0, 0, 0, "add 1y 2mo with result in the next year constrained to Esfand 29",
  "ap", 1363);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1361, monthCode: "M10", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ap", 1361);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1363, monthCode: "M11", day: 30, hour: 12, minute: 34, calendar }, options).subtract(months11n),
  1362, 12, "M12", 30, 12, 34, 0, 0, 0, 0, "subtract 11mo with result in the previous year constrained to Esfand 30",
  "ap", 1362);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1364, monthCode: "M02", day: 31, hour: 12, minute: 34, calendar }, options).subtract(years1months2n),
  1362, 12, "M12", 30, 12, 34, 0, 0, 0, 0, "add 1y 2mo with result in the previous year constrained to Esfand 30",
  "ap", 1362);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1365, monthCode: "M02", day: 31, hour: 12, minute: 34, calendar }, options).subtract(years1months2n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1363, monthCode: "M12", day: 28, hour: 12, minute: 34, calendar }, options).subtract(weeks1),
  1364, 1, "M01", 6, 12, 34, 0, 0, 0, 0, "add 1w in Esfand with result in Farvardin",
  "ap", 1364);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1362, monthCode: "M12", day: 28, hour: 12, minute: 34, calendar }, options).subtract(weeks1),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ap", 1363);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1362, monthCode: "M11", day: 27, hour: 12, minute: 34, calendar }, options).subtract(weeks6),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ap", 1364);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1361, monthCode: "M12", day: 28, hour: 12, minute: 34, calendar }, options).subtract(years1weeks2),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1364, monthCode: "M02", day: 2, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
  1363, 12, "M12", 20, 12, 34, 0, 0, 0, 0, "subtract 6w with result in Esfand",
  "ap", 1363);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1363, monthCode: "M02", day: 2, hour: 12, minute: 34, calendar }, options).subtract(weeks6n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ap", 1361);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1363, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).subtract(years1weeks2n),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ap", 1362);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1362, monthCode: "M01", day: 1, hour: 12, minute: 34, calendar }, options).subtract(months2weeks3n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1362, monthCode: "M12", day: 25, hour: 12, minute: 34, calendar }, options).subtract(days10),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ap", 1365);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1362, monthCode: "M12", day: 26, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  1364, 2, "M02", 30, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d crossing leap-year Esfand",
  "ap", 1364);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1362, monthCode: "M12", day: 30, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
  1364, 3, "M03", 3, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into common-year Khordad",
  "ap", 1364);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1361, monthCode: "M10", day: 27, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4),
...
TemporalHelpers.assertPlainDateTime(
  ...
  "ap", 1363);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1363, monthCode: "M01", day: 10, hour: 12, minute: 34, calendar }, options).subtract(days10n),
  1362, 12, "M12", 30, 12, 34, 0, 0, 0, 0, "subtract 10d with result on leap day",
  "ap", 1362);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1364, monthCode: "M01", day: 10, hour: 12, minute: 34, calendar }, options).subtract(days10n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1365, monthCode: "M01", day: 24, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  1363, 11, "M11", 20, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in common-year Bahman",
  "ap", 1363);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1364, monthCode: "M01", day: 24, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  1362, 11, "M11", 20, 12, 34, 0, 0, 0, 0, "subtract 1y 2mo 4d with result in leap-year Bahman",
  "ap", 1362);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1365, monthCode: "M03", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
  1363, 12, "M12", 26, 12, 34, 0, 0, 0, 0, "add 1y 2mo 4d with result rolling over into common-year Esfand",
  "ap", 1363);
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 1364, monthCode: "M03", day: 1, hour: 12, minute: 34, calendar }, options).subtract(years1months2days4n),
