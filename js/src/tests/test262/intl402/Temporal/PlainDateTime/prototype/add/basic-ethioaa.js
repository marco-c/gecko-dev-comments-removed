...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 7506, monthCode: "M12", day: 29, hour: 12, minute: 34, calendar }, options).add(months2weeks3),
  7507, 2, "M02", 20, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year", "aa", 7507
);

TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 7506, monthCode: "M06", day: 1, hour: 12, minute: 34, calendar }, options).add(months2weeks3n),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 7506, monthCode: "M13", day: 5, hour: 12, minute: 34, calendar }, options).add(days10),
