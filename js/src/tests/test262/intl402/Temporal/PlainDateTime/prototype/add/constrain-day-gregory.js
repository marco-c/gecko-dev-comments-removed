...
const common1231 = Temporal.PlainDateTime.from({ year: 2019, monthCode: "M12", day: 31, hour: 12, minute: 34, calendar }, options);
const leap0131 = Temporal.PlainDateTime.from({ year: 2016, monthCode: "M01", day: 31, hour: 12, minute: 34, calendar }, options);
const leap1231 = Temporal.PlainDateTime.from({ year: 2016, monthCode: "M12", day: 31, hour: 12, minute: 34, calendar }, options);
