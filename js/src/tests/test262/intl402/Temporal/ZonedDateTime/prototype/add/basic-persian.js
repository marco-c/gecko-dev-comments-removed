...
TemporalHelpers.assertPlainDateTime(
  date13751201.add(years3months6days17).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date13781201.add(months6).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date13780101.add(weeks40).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date13780101.add(days280).toPlainDateTime(),
