...
const instance = Temporal.ZonedDateTime.from({ year: 2566, monthCode: "M12", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar: "buddhist" }, options);
...
TemporalHelpers.assertPlainDateTime(
  instance.with({ era: "be", eraYear: 2560 }, options).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  instance.with({ year: 2559 }, options).toPlainDateTime(),
