...
TemporalHelpers.assertPlainDateTime(
  date578201.subtract(months2weeks3).toPlainDateTime(),
  5782, 3, "M03", 22, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks, ending in same year",
  "am", 5782
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 5782, monthCode: "M12", day: 29, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).subtract(months2weeks3).toPlainDateTime(),
  5783, 3, "M03", 20, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year",
  "am", 5783
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 5782, monthCode: "M10", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).subtract(months2weeks3n).toPlainDateTime(),
  5782, 8, "M07", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks, ending in same year",
  "am", 5782
);

TemporalHelpers.assertPlainDateTime(
  date578201.subtract(months2weeks3n).toPlainDateTime(),
  5781, 10, "M10", 9, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from beginning of year to previous year",
  "am", 5781
);

TemporalHelpers.assertPlainDateTime(
  date576001.subtract(weeks40).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date578201.subtract(days10).toPlainDateTime(),
  5782, 1, "M01", 11, 12, 34, 0, 0, 0, 0, "add 10 days, ending in same month",
  "am", 5782
);

TemporalHelpers.assertPlainDateTime(
  date57800129.subtract(days10).toPlainDateTime(),
  5780, 2, "M02", 9, 12, 34, 0, 0, 0, 0, "add 10 days, ending in following month",
  "am", 5780
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 5782, monthCode: "M12", day: 29, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).subtract(days10).toPlainDateTime(),
  5783, 1, "M01", 10, 12, 34, 0, 0, 0, 0, "add 10 days, ending in following year",
  "am", 5783
);

TemporalHelpers.assertPlainDateTime(
  date57800129.subtract(days10n).toPlainDateTime(),
  5780, 1, "M01", 19, 12, 34, 0, 0, 0, 0, "subtract 10 days, ending in same month",
  "am", 5780
);

TemporalHelpers.assertPlainDateTime(
  date578006.subtract(days10n).toPlainDateTime(),
  5780, 5, "M05", 21, 12, 34, 0, 0, 0, 0, "subtract 10 days, ending in previous month",
  "am", 5780
);

TemporalHelpers.assertPlainDateTime(
  date578201.subtract(days10n).toPlainDateTime(),
  5781, 12, "M12", 20, 12, 34, 0, 0, 0, 0, "subtract 10 days, ending in previous year",
  "am", 5781
);

TemporalHelpers.assertPlainDateTime(
  date576001.subtract(days280).toPlainDateTime(),
