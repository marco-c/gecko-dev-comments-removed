...
const common1231 = Temporal.ZonedDateTime.from({ year: 2562, monthCode: "M12", day: 31, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
...
const leap1231 = Temporal.ZonedDateTime.from({ year: 2559, monthCode: "M12", day: 31, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
...
TemporalHelpers.assertPlainDateTime(
  common0131.add(months1).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common0131.add(months2, options).toPlainDateTime(),
  2562, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "common-year Mar does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common0131.add(months3).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common0131.add(months4, options).toPlainDateTime(),
  2562, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "common-year May does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common0131.add(months5).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common0131.add(months6, options).toPlainDateTime(),
  2562, 7, "M07", 31, 12, 34, 0, 0, 0, 0, "common-year Jul does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common0131.add(months7, options).toPlainDateTime(),
  2562, 8, "M08", 31, 12, 34, 0, 0, 0, 0, "common-year Aug does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common0131.add(months8).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common0131.add(months9, options).toPlainDateTime(),
  2562, 10, "M10", 31, 12, 34, 0, 0, 0, 0, "common-year Oct does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common0131.add(months10).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common0131.add(months11, options).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap0131.add(months1).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap0131.add(months2, options).toPlainDateTime(),
  2559, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "leap-year Mar does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap0131.add(months3).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap0131.add(months4, options).toPlainDateTime(),
  2559, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "leap-year May does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap0131.add(months5).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap0131.add(months6, options).toPlainDateTime(),
  2559, 7, "M07", 31, 12, 34, 0, 0, 0, 0, "leap-year Jul does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap0131.add(months7, options).toPlainDateTime(),
  2559, 8, "M08", 31, 12, 34, 0, 0, 0, 0, "leap-year Aug does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap0131.add(months8).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap0131.add(months9, options).toPlainDateTime(),
  2559, 10, "M10", 31, 12, 34, 0, 0, 0, 0, "leap-year Oct does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap0131.add(months10).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap0131.add(months11, options).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  common1231.add(months1n).toPlainDateTime(),
  2562, 11, "M11", 30, 12, 34, 0, 0, 0, 0, "common-year Nov constrains to 30",
  "be", 2562);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  common1231.add(months2n, options).toPlainDateTime(),
  2562, 10, "M10", 31, 12, 34, 0, 0, 0, 0, "common-year Oct does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common1231.add(months3n).toPlainDateTime(),
  2562, 9, "M09", 30, 12, 34, 0, 0, 0, 0, "common-year Sep constrains to 30",
  "be", 2562);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  common1231.add(months4n, options).toPlainDateTime(),
  2562, 8, "M08", 31, 12, 34, 0, 0, 0, 0, "common-year Aug does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common1231.add(months5n, options).toPlainDateTime(),
  2562, 7, "M07", 31, 12, 34, 0, 0, 0, 0, "common-year Jul does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common1231.add(months6n).toPlainDateTime(),
  2562, 6, "M06", 30, 12, 34, 0, 0, 0, 0, "common-year Jun constrains to 30",
  "be", 2562);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  common1231.add(months7n, options).toPlainDateTime(),
  2562, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "common-year May does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common1231.add(months8n).toPlainDateTime(),
  2562, 4, "M04", 30, 12, 34, 0, 0, 0, 0, "common-year Apr constrains to 30",
  "be", 2562);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  common1231.add(months9n, options).toPlainDateTime(),
  2562, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "common-year Mar does not reject 31",
  "be", 2562);

TemporalHelpers.assertPlainDateTime(
  common1231.add(months10n).toPlainDateTime(),
  2562, 2, "M02", 28, 12, 34, 0, 0, 0, 0, "common-year Feb constrains to 28",
  "be", 2562);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  common1231.add(months11n, options).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  leap1231.add(months1n).toPlainDateTime(),
  2559, 11, "M11", 30, 12, 34, 0, 0, 0, 0, "leap-year Nov constrains to 30",
  "be", 2559);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  leap1231.add(months2n, options).toPlainDateTime(),
  2559, 10, "M10", 31, 12, 34, 0, 0, 0, 0, "leap-year Oct does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap1231.add(months3n).toPlainDateTime(),
  2559, 9, "M09", 30, 12, 34, 0, 0, 0, 0, "leap-year Sep constrains to 30",
  "be", 2559);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  leap1231.add(months4n, options).toPlainDateTime(),
  2559, 8, "M08", 31, 12, 34, 0, 0, 0, 0, "leap-year Aug does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap1231.add(months5n, options).toPlainDateTime(),
  2559, 7, "M07", 31, 12, 34, 0, 0, 0, 0, "leap-year Jul does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap1231.add(months6n).toPlainDateTime(),
  2559, 6, "M06", 30, 12, 34, 0, 0, 0, 0, "leap-year Jun constrains to 30",
  "be", 2559);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  leap1231.add(months7n, options).toPlainDateTime(),
  2559, 5, "M05", 31, 12, 34, 0, 0, 0, 0, "leap-year May does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap1231.add(months8n).toPlainDateTime(),
  2559, 4, "M04", 30, 12, 34, 0, 0, 0, 0, "leap-year Apr constrains to 30",
  "be", 2559);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  leap1231.add(months9n, options).toPlainDateTime(),
  2559, 3, "M03", 31, 12, 34, 0, 0, 0, 0, "leap-year Mar does not reject 31",
  "be", 2559);

TemporalHelpers.assertPlainDateTime(
  leap1231.add(months10n).toPlainDateTime(),
  2559, 2, "M02", 29, 12, 34, 0, 0, 0, 0, "leap-year Feb constrains to 29",
  "be", 2559);
assert.throws(RangeError, function () {
...
TemporalHelpers.assertPlainDateTime(
  leap1231.add(months11n, options).toPlainDateTime(),
