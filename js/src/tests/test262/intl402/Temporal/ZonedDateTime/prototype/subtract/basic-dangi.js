...
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 2021, monthCode: "M06", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).subtract(months2weeks3n).toPlainDateTime(),
  2021, 3, "M03", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from non-leap day/month, ending in same year"
);

TemporalHelpers.assertPlainDateTime(
  date202101.subtract(months2weeks3n).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date202101.subtract(days10).toPlainDateTime(),
  2021, 1, "M01", 11, 12, 34, 0, 0, 0, 0, "add 10 days, ending in same month"
);

TemporalHelpers.assertPlainDateTime(
  date20210129.subtract(days10).toPlainDateTime(),
