...
const londonNext = new Temporal.ZonedDateTime(-39488400000000000n , "Europe/London")
...
const anchoragePrev = new Temporal.ZonedDateTime(-84290400000000000n , "America/Anchorage")
  .getTimeZoneTransition("previous");
assert.notSameValue(
...
const anchorageNext = new Temporal.ZonedDateTime(-94658400000000000n , "America/Anchorage")
  .getTimeZoneTransition("next");
assert.notSameValue(
