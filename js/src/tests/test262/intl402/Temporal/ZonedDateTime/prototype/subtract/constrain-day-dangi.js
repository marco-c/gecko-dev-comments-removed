...
const longLeapMonth = Temporal.ZonedDateTime.from({ year: 1979, monthCode: "M06L", day: 30, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
const longLeapMonth2 = Temporal.ZonedDateTime.from({ year: 2012, monthCode: "M03L", day: 30, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
...
TemporalHelpers.assertPlainDateTime(
  longLeapMonth.subtract(years8).toPlainDateTime(),
