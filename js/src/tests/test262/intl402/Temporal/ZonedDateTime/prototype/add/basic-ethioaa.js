...
TemporalHelpers.assertPlainDateTime(
  date750601.add(months2weeks3).toPlainDateTime(),
  7506, 3, "M03", 22, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from non-leap day/month, ending in same year", "aa", 7506
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 7506, monthCode: "M12", day: 29, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3).toPlainDateTime(),
  7507, 2, "M02", 20, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year", "aa", 7507
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 7506, monthCode: "M06", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3n).toPlainDateTime(),
  7506, 3, "M03", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from non-leap day/month, ending in same year", "aa", 7506
);

TemporalHelpers.assertPlainDateTime(
  date750601.add(months2weeks3n).toPlainDateTime(),
  7505, 11, "M11", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from beginning of year to previous year", "aa", 7505
);

TemporalHelpers.assertPlainDateTime(
  date749201.add(weeks40).toPlainDateTime(),
