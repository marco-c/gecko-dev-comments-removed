...
const date144501 = Temporal.ZonedDateTime.from({ year: 1445, monthCode: "M01", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options);
TemporalHelpers.assertPlainDateTime(
  date144501.add(new Temporal.Duration(0, 8)).toPlainDateTime(),
  1445, 9, "M09", 1, 12, 34, 0, 0, 0, 0, "Adding 8 months to Muharram 1445 lands in Ramadan",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  date144501.add(new Temporal.Duration(0, 11)).toPlainDateTime(),
  1445, 12, "M12", 1, 12, 34, 0, 0, 0, 0, "Adding 11 months to Muharram 1445 lands in Dhu al-Hijjah",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  date144501.add(new Temporal.Duration(0, 12)).toPlainDateTime(),
  1446, 1, "M01", 1, 12, 34, 0, 0, 0, 0, "Adding 12 months to Muharram 1445 lands in Muharram 1446",
  "ah", 1446
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1445, monthCode: "M06", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }).add(new Temporal.Duration(0, 13)).toPlainDateTime(),
  1446, 7, "M07", 15, 12, 34, 0, 0, 0, 0, "Adding 13 months to Jumada II 1445 lands in Rajab 1446",
  "ah", 1446
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1445, monthCode: "M03", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(new Temporal.Duration(0, 6)).toPlainDateTime(),
  1445, 9, "M09", 15, 12, 34, 0, 0, 0, 0, "Adding 6 months to Rabi I 1445 lands in Ramadan",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1444, monthCode: "M10", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }).add(new Temporal.Duration(0, 5)).toPlainDateTime(),
  1445, 3, "M03", 1, 12, 34, 0, 0, 0, 0, "Adding 5 months to Shawwal 1444 crosses to 1445",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1400, monthCode: "M01", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }).add(new Temporal.Duration(0, 100)).toPlainDateTime(),
  1408, 5, "M05", 1, 12, 34, 0, 0, 0, 0, "Adding a large number of months",
  "ah", 1408
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1445, monthCode: "M09", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(new Temporal.Duration(0, -8)).toPlainDateTime(),
  1445, 1, "M01", 1, 12, 34, 0, 0, 0, 0, "Subtracting 8 months from Ramadan 1445 lands in Muharram",
  "ah", 1445
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1445, monthCode: "M06", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(new Temporal.Duration(0, -12)).toPlainDateTime(),
  1444, 6, "M06", 1, 12, 34, 0, 0, 0, 0, "Subtracting 12 months from Jumada II 1445 lands in Jumada II 1444",
  "ah", 1444
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1445, monthCode: "M02", day: 15, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(new Temporal.Duration(0, -5)).toPlainDateTime(),
  1444, 9, "M09", 15, 12, 34, 0, 0, 0, 0, "Subtracting 5 months from Safar 1445 crosses to Ramadan 1444",
  "ah", 1444
);

TemporalHelpers.assertPlainDateTime(
  date142012.add(months6).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date144101.add(months2weeks3).toPlainDateTime(),
  1441, 3, "M03", 22, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks, ending in same year",
  "ah", 1441
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1441, monthCode: "M12", day: 29, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3).toPlainDateTime(),
  1442, 3, "M03", 21, 12, 34, 0, 0, 0, 0, "add 2 months 3 weeks from end of year to next year",
  "ah", 1442
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1441, monthCode: "M10", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(months2weeks3n).toPlainDateTime(),
  1441, 7, "M07", 10, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks, ending in same year",
  "ah", 1441
);

TemporalHelpers.assertPlainDateTime(
  date144101.add(months2weeks3n).toPlainDateTime(),
  1440, 10, "M10", 9, 12, 34, 0, 0, 0, 0, "subtract 2 months 3 weeks from beginning of year to previous year",
  "ah", 1440
);

TemporalHelpers.assertPlainDateTime(
  date142001.add(weeks40).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date144101.add(days10).toPlainDateTime(),
  1441, 1, "M01", 11, 12, 34, 0, 0, 0, 0, "add 10 days, ending in same month",
  "ah", 1441
);

TemporalHelpers.assertPlainDateTime(
  date14390129.add(days10).toPlainDateTime(),
  1439, 2, "M02", 9, 12, 34, 0, 0, 0, 0, "add 10 days, ending in following month",
  "ah", 1439
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1440, monthCode: "M12", day: 29, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(days10).toPlainDateTime(),
  1441, 1, "M01", 10, 12, 34, 0, 0, 0, 0, "add 10 days, ending in following year",
  "ah", 1441
);

TemporalHelpers.assertPlainDateTime(
  date14390129.add(days10n).toPlainDateTime(),
  1439, 1, "M01", 19, 12, 34, 0, 0, 0, 0, "subtract 10 days, ending in same month",
  "ah", 1439
);

TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 1439, monthCode: "M06", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).add(days10n).toPlainDateTime(),
  1439, 5, "M05", 21, 12, 34, 0, 0, 0, 0, "subtract 10 days, ending in previous month",
  "ah", 1439
);

TemporalHelpers.assertPlainDateTime(
  date144101.add(days10n).toPlainDateTime(),
  1440, 12, "M12", 20, 12, 34, 0, 0, 0, 0, "subtract 10 days, ending in previous year",
  "ah", 1440
);

TemporalHelpers.assertPlainDateTime(
  date142001.add(days280).toPlainDateTime(),
