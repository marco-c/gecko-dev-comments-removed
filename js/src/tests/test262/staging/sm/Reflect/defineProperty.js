...
assert.sameValue(Reflect.defineProperty(obj, "prop", {writable: false}), true);  


obj = Object.freeze({prop: 0});
assert.sameValue(Reflect.defineProperty(obj, "prop", {value: -0}), false);
assert.sameValue(Reflect.defineProperty(obj, "prop", {value: +0}), true);  
...
assert.sameValue(Reflect.defineProperty(obj, "prop", {get: g}), true);  
