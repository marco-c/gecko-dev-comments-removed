...
class ReadableStreamController : public StreamController
{
  public:
    ...
    void setUnderlyingSource(Value underlyingSource) {
...
class ReadableStreamDefaultController : public ReadableStreamController
{
  ...
  public:
    ...
    void setStrategySize(Value size) { setFixedSlot(Slot_StrategySize, size); }
...
class ReadableByteStreamController : public ReadableStreamController
{
  public:
    ...
    void setAutoAllocateChunkSize(Value size) {
...
template <>
inline bool
JSObject::is<StreamController>() const
{
