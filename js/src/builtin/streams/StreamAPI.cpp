...
JS_PUBLIC_API JSObject* JS::NewReadableDefaultStreamObject(
    JSContext* cx, JS::Handle<JSObject*> underlyingSource ,
    JS::Handle<JSFunction*> size ,
...
JS_PUBLIC_API JSObject* JS::NewReadableExternalSourceStreamObject(
    ...
    void* nsISupportsObject_alreadyAddreffed ,
...
void JS::InitAbortSignalHandling(const JSClass* clasp, JSContext* cx) {
  cx->runtime()->initAbortSignalHandling(clasp);
}
