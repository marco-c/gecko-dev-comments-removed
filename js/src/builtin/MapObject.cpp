...
static const ClassOps MapIteratorObjectClassOps = {nullptr, 
                                                   nullptr, 
                                                   nullptr, 
                                                   nullptr, 
                                                   nullptr, 
...
inline MapObject::IteratorKind MapIteratorObject::kind() const {
 ...
 bool GlobalObject::initMapIteratorProto(
...
const ClassOps MapObject::classOps_ = {nullptr,  
                                       nullptr,  
                                       nullptr,  
                                       nullptr,  
                                       nullptr,  
...
static const ClassOps SetIteratorObjectClassOps = {nullptr, 
                                                   nullptr, 
                                                   nullptr, 
                                                   nullptr, 
                                                   nullptr, 
...
inline SetObject::IteratorKind SetIteratorObject::kind() const {
 ...
 bool GlobalObject::initSetIteratorProto(
    JSContext* cx, Handle<GlobalObject*> global) {
  Rooted<JSObject*> base(
      cx, GlobalObject::getOrCreateIteratorPrototype(cx, global));
  if (!base) {
...
const ClassOps SetObject::classOps_ = {nullptr,  
                                       nullptr,  
                                       nullptr,  
                                       nullptr,  
                                       nullptr,  
