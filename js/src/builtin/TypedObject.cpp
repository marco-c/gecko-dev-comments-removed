...
uint32_t ScalarTypeDescr::alignment(Type t) {
 ...
 const char* ScalarTypeDescr::typeName(Type type) {
  switch (type) {
...
uint32_t ReferenceTypeDescr::alignment(Type t) {
 ...
 const char* ReferenceTypeDescr::typeName(Type type) {
  switch (type) {
#define NUMERIC_TYPE_TO_STRING(constant_, type_, name_) \
  case constant_:                                       \
    return #name_;
...
CheckedInt32 StructMetaTypeDescr::Layout::close(int32_t* alignment) {
 ...
 JSObject* StructMetaTypeDescr::create(JSContext* cx,
...
static JSObject* DefineMetaTypeDescr(JSContext* cx, const char* name,
 ...
 bool GlobalObject::initTypedObjectModule(
...
bool TypedObject::isAttached() const {
 ...
 bool TypedObject::GetBuffer(JSContext* cx, unsigned argc,
                                         Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
 ...
 bool TypedObject::GetByteOffset(JSContext* cx, unsigned argc,
                                             Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
  args.rval().setInt32(
 ...
 OutlineTypedObject* OutlineTypedObject::createUnattached(
...
void OutlineTypedObject::attach(JSContext* cx, TypedObject& typedObj,
 ...
 TypedObject* TypedObject::createZeroed(JSContext* cx,
                                                  HandleTypeDescr descr,
                                                  gc::InitialHeap heap) {
 ...
 void OutlineTypedObject::obj_trace(JSTracer* trc,
                                                JSObject* object) {
...
bool TypeDescr::hasProperty(const JSAtomState& names, jsid id) {
 ...
 bool TypedObject::obj_lookupProperty(
...
void OutlineTypedObject::notifyBufferDetached(void* newData) {
 ...
 InlineTypedObject* InlineTypedObject::create(
    JSContext* cx, HandleTypeDescr descr, gc::InitialHeap heap) {
 ...
 void InlineTypedObject::obj_trace(JSTracer* trc,
                                               JSObject* object) {
...
DEFINE_TYPEDOBJ_CLASS(InlineOpaqueTypedObject, InlineTypedObject::obj_trace,
 ...
 bool TypedObject::construct(JSContext* cx, unsigned int argc,
                                       Value* vp) {
  CallArgs args = CallArgsFromVp(argc, vp);
