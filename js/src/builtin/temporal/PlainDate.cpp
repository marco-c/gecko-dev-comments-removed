...
bool js::temporal::AddISODate(JSContext* cx, const ISODate& date,
...
static ISODate AddISODate(const ISODate& date,
...
DateDuration js::temporal::DifferenceISODate(const ISODate& start,
                                             const ISODate& end,
