...
#else
        return RegI64(Register64(needI32().reg, r.reg)); 
#endif
    }
...
#define CHECK_NEXT(E) if (!(E)) goto done; continue
        ...
        switch (expr) {
          ...
          case Expr::CallIndirect:
            CHECK_NEXT(emitCallIndirect(exprOffset,  false));
          case Expr::OldCallIndirect:
            CHECK_NEXT(emitCallIndirect(exprOffset,  true));
