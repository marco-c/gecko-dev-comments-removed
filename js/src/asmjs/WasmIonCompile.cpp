    ...
    bool passArg(MDefinition* argDef, ValType type, CallCompileState* call)
    {
        ...
        switch (arg.kind()) {
          ...
          case ABIArg::GPR_PAIR: {
            auto mirLow = MWrapInt64ToInt32::NewAsmJS(alloc(), argDef,  true);
            curBlock_->add(mirLow);
            auto mirHigh = MWrapInt64ToInt32::NewAsmJS(alloc(), argDef,  false);
...
EmitExpr(FunctionCompiler& f)
{
    ...
    switch (expr) {
      ...
      case Expr::CallIndirect:
        return EmitCallIndirect(f, exprOffset,  false);
      case Expr::OldCallIndirect:
        return EmitCallIndirect(f, exprOffset,  true);
