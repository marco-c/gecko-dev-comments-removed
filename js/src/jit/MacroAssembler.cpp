...
void MacroAssembler::emitMegamorphicCacheLookup(
  ...
  addPtr(Imm32(HashAtomOrSymbolPropertyKey(id)), scratch2);
...
void MacroAssembler::emitMegamorphicCacheLookupExists(
    ...
    Register scratch3, Register scratch4, Register output, Label* fail,
  ...
  loadAtomOrSymbolAndHash(id, scratch4, scratch3, &cacheMiss);
  ...
  branchPtr(Assembler::NotEqual,
            Address(scratch2, MegamorphicCache::Entry::offsetOfKey()), scratch4,
            &cacheMiss);
  ...
  branch32(Assembler::Equal, scratch3,
           Imm32(MegamorphicCache::Entry::NumHopsForMissingProperty), cacheHit);

  if (hasOwn) {
    branch32(Assembler::NotEqual, scratch3, Imm32(0), cacheHit);
  } else {
    branch32(Assembler::Equal, scratch3,
             Imm32(MegamorphicCache::Entry::NumHopsForMissingOwnProperty),
             &cacheMiss);
