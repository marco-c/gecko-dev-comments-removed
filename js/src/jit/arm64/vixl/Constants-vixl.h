...
enum SVCSimulatorCodes {
  ...
  kMarkStackPointer = 0x11,  
  kCheckStackPointer = 0x12  
};
...
enum SystemRegister {
  ...
  RNDR = SystemRegisterEncoder<3, 3, 2, 4, 0>::value,    
  RNDRRS = SystemRegisterEncoder<3, 3, 2, 4, 1>::value   
};
...
enum NEON3SameOp {
  ...
  NEON3SameFHMMask = 0xBFE0FC00,                
  NEON_FMLAL   = NEON3SameFixed | 0x0000E800,   
  NEON_FMLAL2  = NEON3SameFixed | 0x2000C800,   
  NEON_FMLSL   = NEON3SameFixed | 0x0080E800,   
  NEON_FMLSL2  = NEON3SameFixed | 0x2080C800    
};
