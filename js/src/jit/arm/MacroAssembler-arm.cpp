...
void MacroAssembler::wasmTruncateDoubleToUInt32(FloatRegister input,
                                                ...
                                                bool isSaturating,
                                                Label* oolEntry) {
  wasmTruncateToInt32(input, output, MIRType::Double,  true,
...
void MacroAssembler::wasmTruncateDoubleToInt32(FloatRegister input,
                                               ...
                                               bool isSaturating,
                                               Label* oolEntry) {
  wasmTruncateToInt32(input, output, MIRType::Double,  false,
                      isSaturating, oolEntry);
}
...
void MacroAssembler::wasmTruncateFloat32ToUInt32(FloatRegister input,
                                                 ...
                                                 bool isSaturating,
                                                 Label* oolEntry) {
  wasmTruncateToInt32(input, output, MIRType::Float32,  true,
                      isSaturating, oolEntry);
}
...
void MacroAssembler::wasmTruncateFloat32ToInt32(FloatRegister input,
                                                ...
                                                bool isSaturating,
                                                Label* oolEntry) {
  wasmTruncateToInt32(input, output, MIRType::Float32,  false,
                      isSaturating, oolEntry);
}
...
void MacroAssemblerARM::wasmLoadImpl(const wasm::MemoryAccessDesc& access,
  ...
  if (out64 != Register64::Invalid()) {
    if (type == Scalar::Int64) {
      ...
      load = ma_dataTransferN(IsLoad, 32,  false, memoryBase, ptr,
                              out64.low);
...
void MacroAssemblerARM::wasmUnalignedLoadImpl(
  ...
  switch (access.type()) {
    ...
    case Scalar::Float64: {
      ...
      emitUnalignedLoad(&access, false, 4, ptr, tmp, tmp3,
                        4);
    ...
    case Scalar::Int64: {
      ...
      emitUnalignedLoad(&access, false, 4, ptr, tmp,
                        out64.high, 4);
      emitUnalignedLoad(nullptr, false, 4, ptr, tmp,
                        out64.low);
      break;
    }
    case Scalar::Int16:
...
void MacroAssemblerARM::emitUnalignedLoad(const wasm::MemoryAccessDesc* access,
  ...
  while (i >= 0) {
    ma_dataTransferN(IsLoad, 8, false, ptr, Imm32(offset + i), tmp,
                     scratch);
