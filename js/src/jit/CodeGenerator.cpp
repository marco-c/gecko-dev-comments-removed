...
void CodeGenerator::visitBindFunction(LBindFunction* lir) {
  ...
  masm.createGCObject(temp1, temp2, templateObject, gc::DefaultHeap,
                      &allocFailed);
  masm.jump(&allocOk);
...
void CodeGenerator::visitWasmGcObjectIsSubtypeOfAbstract(
  ...
  masm.branchWasmGcObjectIsRefType(
      ...
      true, superSuperTypeVector, scratch1, scratch2);
  masm.bind(&onFail);
...
void CodeGenerator::visitWasmGcObjectIsSubtypeOfAbstractAndBranch(
  ...
  masm.branchWasmGcObjectIsRefType(
      ...
      true, Register::Invalid(), scratch1, Register::Invalid());
  masm.jump(onFail);
}
