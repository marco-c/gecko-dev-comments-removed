...
#endif
#ifdef MOZ_VTUNE
    VTuneMarkStub(code, "RegExpMatcherStub");
#endif
...
#endif
#ifdef MOZ_VTUNE
    VTuneMarkStub(code, "RegExpSearcherStub");
#endif
...
#endif
#ifdef MOZ_VTUNE
    VTuneMarkStub(code, "RegExpTesterStub");
#endif
...
#endif
#ifdef MOZ_VTUNE
    VTuneMarkStub(code, "StringConcatStub");
#endif
...
#endif
#ifdef MOZ_VTUNE
    VTuneMarkStub(code, "LazyLinkStub");
#endif
    return code;
}
                              ...
                              bool enter)
{
    ...
    if (vmEventEnabled || vmSpecificEventEnabled) {
        ...
        if (vmSpecificEventEnabled) {
            ...
            if (enter)
                masm.tracelogStartId(loggerReg, event.payload()->textId(),  true);
            else
                masm.tracelogStopId(loggerReg, event.payload()->textId(),  true);
        }
...
CodeGenerator::link(JSContext* cx, CompilerConstraintList* constraints)
{
    ...
    if (IsVTuneProfilingActive())
        VTuneMarkScript(code, script, "ion");
#endif
