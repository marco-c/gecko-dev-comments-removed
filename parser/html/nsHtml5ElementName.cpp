...
static int32_t const ELEMENT_HASHES_DATA[] = {
    1899272519, 1748225318, 2001349720, 876609538,  1797585096, 1971461414,
    2007781534, 59768833,   1730965751, 1755148615, 1857653029, 1935549734,
    1988763672, 2005324101, 2060065124, 52490899,   62390273,   1682547543,
    1738539010, 1749813541, 1763839627, 1806806678, 1881288348, 1907435316,
    1966223078, 1982935782, 1999397992, 2001392798, 2006329158, 2008851557,
    2085266636, 51961587,   57206291,   60352339,   67108865,   943718402,
    1699324759, 1733076167, 1747306711, 1749673195, 1751386406, 1757137429,
    1783388497, 1803929861, 1853642948, 1870268949, 1884120164, 1904412884,
    1919418370, 1941221172, 1967795910, 1973420034, 1983633431, 1998585858,
    ...
    1679960596, 1686491348, 1715310660, 1732381397, 1736200310, 1747048757,
    1747838298, 1749395095, 1749723735, 1749932347, 1753362711, 1756600614,
    1757157700, 1782357526, 1786534215, 1803876550, 1805647874, 1818230786,
    1854228698, 1868312196, 1874053333, 1881613047, 1898223949, 1902641154,
    1906087319, 1907959605, 1932928296, 1939219752, 1965115924, 1967760215,
    1968053806, 1971938532, 1982173479, 1983533124, 1986527234, 1990037800,
    ...
    1730150402, 1732069431, 1733054663, 1733890180, 1737099991, 1740181637,
    1747176599, 1747814436, 1748100148, 1748359220, 1749656156, 1749715159,
    1749801286, 1749905526, 1751288021, 1752979652, 1755076808, 1756474198,
    1756625221, 1757146773, 1757268168, 1766992520, 1783210839, 1783388498,
    1790207270, 1798686984, 1803929812, 1805502724, 1806805526, 1807599880,
    1818755074, 1854228692, 1854245076, 1864368130, 1870135298, 1873281026,
    1874102998, 1881498736, 1881669634, 1889085973, 1898753862, 1900845386,
    1903302038, 1905563974, 1906135367, 1907661127, 1914900309, 1925844629,
    1934172497, 1938817026, 1941178676, 1963982850, 1965334268, 1967128578,
    1967788867, 1967795958, 1968836118, 1971465813};
...
void nsHtml5ElementName::initializeStatics() {
  ...
  ELT_TBODY = new nsHtml5ElementName(
      ...
      nsHtml5TreeBuilder::TBODY_OR_THEAD_OR_TFOOT | SPECIAL | FOSTER_PARENTING |
          OPTIONAL_END_TAG);
  ELEMENT_NAMES = new nsHtml5ElementName*[208];
  ...
  ELEMENT_NAMES[151] = ELT_DISCARD;
  ELEMENT_NAMES[152] = ELT_FEBLEND;
  ELEMENT_NAMES[153] = ELT_HEAD;
  ELEMENT_NAMES[154] = ELT_NOEMBED;
  ELEMENT_NAMES[155] = ELT_THEAD;
  ELEMENT_NAMES[156] = ELT_ARTICLE;
  ELEMENT_NAMES[157] = ELT_BASE;
  ELEMENT_NAMES[158] = ELT_CODE;
  ELEMENT_NAMES[159] = ELT_CITE;
  ELEMENT_NAMES[160] = ELT_FETURBULENCE;
  ELEMENT_NAMES[161] = ELT_FEIMAGE;
  ELEMENT_NAMES[162] = ELT_FETILE;
  ELEMENT_NAMES[163] = ELT_FIGURE;
  ELEMENT_NAMES[164] = ELT_IMAGE;
  ELEMENT_NAMES[165] = ELT_LINE;
  ELEMENT_NAMES[166] = ELT_POLYLINE;
  ELEMENT_NAMES[167] = ELT_SOURCE;
  ELEMENT_NAMES[168] = ELT_STYLE;
  ELEMENT_NAMES[169] = ELT_TITLE;
  ELEMENT_NAMES[170] = ELT_TEMPLATE;
  ELEMENT_NAMES[171] = ELT_GLYPHREF;
  ELEMENT_NAMES[172] = ELT_FEFUNCG;
  ELEMENT_NAMES[173] = ELT_FESPECULARLIGHTING;
  ELEMENT_NAMES[174] = ELT_STRONG;
  ELEMENT_NAMES[175] = ELT_CLIPPATH;
  ELEMENT_NAMES[176] = ELT_MATH;
  ELEMENT_NAMES[177] = ELT_PATH;
  ELEMENT_NAMES[178] = ELT_SEARCH;
  ELEMENT_NAMES[179] = ELT_TEXTPATH;
  ELEMENT_NAMES[180] = ELT_MI;
  ELEMENT_NAMES[181] = ELT_MARK;
  ELEMENT_NAMES[182] = ELT_MASK;
  ELEMENT_NAMES[183] = ELT_DL;
  ELEMENT_NAMES[184] = ELT_OL;
  ELEMENT_NAMES[185] = ELT_UL;
  ELEMENT_NAMES[186] = ELT_SYMBOL;
  ELEMENT_NAMES[187] = ELT_ANIMATETRANSFORM;
  ELEMENT_NAMES[188] = ELT_EM;
  ELEMENT_NAMES[189] = ELT_PARAM;
  ELEMENT_NAMES[190] = ELT_BUTTON;
  ELEMENT_NAMES[191] = ELT_FIGCAPTION;
  ELEMENT_NAMES[192] = ELT_KEYGEN;
  ELEMENT_NAMES[193] = ELT_OPTION;
  ELEMENT_NAMES[194] = ELT_PATTERN;
  ELEMENT_NAMES[195] = ELT_SECTION;
  ELEMENT_NAMES[196] = ELT_AUDIO;
  ELEMENT_NAMES[197] = ELT_VIDEO;
  ELEMENT_NAMES[198] = ELT_FEDISPLACEMENTMAP;
  ELEMENT_NAMES[199] = ELT_RP;
  ELEMENT_NAMES[200] = ELT_SAMP;
  ELEMENT_NAMES[201] = ELT_BR;
  ELEMENT_NAMES[202] = ELT_ANIMATECOLOR;
  ELEMENT_NAMES[203] = ELT_HR;
  ELEMENT_NAMES[204] = ELT_FECOMPONENTTRANSFER;
  ELEMENT_NAMES[205] = ELT_FOOTER;
  ELEMENT_NAMES[206] = ELT_HEADER;
  ELEMENT_NAMES[207] = ELT_METER;
}
