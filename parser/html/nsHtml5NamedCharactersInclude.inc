...
NAMED_CHARACTER_REFERENCE(
    27,
     'c' _ 'k' _ 's' _ 'l' _ 'a' _ 's' _ 'h' _ ';', 8, 0, 0x2216 _ 0)
...
NAMED_CHARACTER_REFERENCE(31,
                           'c' _ 'a' _ 'u' _ 's' _ 'e' _ ';', 6, 0,
                          0x2235 _ 0)
NAMED_CHARACTER_REFERENCE(
    32,
     'r' _ 'n' _ 'o' _ 'u' _ 'l' _ 'l' _ 'i' _ 's' _ ';', 9, 0,
    0x212c _ 0)
...
NAMED_CHARACTER_REFERENCE(50,
                           'o' _ 'n' _ 'i' _ 'n' _ 't' _ ';', 6, 0,
                          0x2230 _ 0)
NAMED_CHARACTER_REFERENCE(51,  'o' _ 't' _ ';', 3, 0, 0x010a _ 0)
NAMED_CHARACTER_REFERENCE(52,
                           'd' _ 'i' _ 'l' _ 'l' _ 'a' _ ';', 6, 0,
                          0x00b8 _ 0)
NAMED_CHARACTER_REFERENCE(
    53,
     'n' _ 't' _ 'e' _ 'r' _ 'D' _ 'o' _ 't' _ ';', 8, 0, 0x00b7 _ 0)
NAMED_CHARACTER_REFERENCE(54,  'r' _ ';', 2, 0, 0x212d _ 0)
NAMED_CHARACTER_REFERENCE(55,  'i' _ ';', 2, 0, 0x03a7 _ 0)
NAMED_CHARACTER_REFERENCE(
    56,
     'r' _ 'c' _ 'l' _ 'e' _ 'D' _ 'o' _ 't' _ ';', 8, 0, 0x2299 _ 0)
NAMED_CHARACTER_REFERENCE(
    57,
     'r' _ 'c' _ 'l' _ 'e' _ 'M' _ 'i' _ 'n' _ 'u' _ 's' _ ';', 10, 0,
    0x2296 _ 0)
NAMED_CHARACTER_REFERENCE(
    58,
     'r' _ 'c' _ 'l' _ 'e' _ 'P' _ 'l' _ 'u' _ 's' _ ';', 9, 0,
    0x2295 _ 0)
NAMED_CHARACTER_REFERENCE(
    59,
     'r' _ 'c' _ 'l' _ 'e' _ 'T' _ 'i' _ 'm' _ 'e' _ 's' _ ';', 10, 0,
    0x2297 _ 0)
NAMED_CHARACTER_REFERENCE(
    60,
...
NAMED_CHARACTER_REFERENCE(
    65,
     'n' _ 'g' _ 'r' _ 'u' _ 'e' _ 'n' _ 't' _ ';', 8, 0, 0x2261 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    69,
     'p' _ 'r' _ 'o' _ 'd' _ 'u' _ 'c' _ 't' _ ';', 8, 0, 0x2210 _ 0)
NAMED_CHARACTER_REFERENCE(
    70,
...
NAMED_CHARACTER_REFERENCE(
    100,
     'u' _ 'b' _ 'l' _ 'e' _ 'D' _ 'o' _ 't' _ ';', 8, 0, 0x00a8 _ 0)
NAMED_CHARACTER_REFERENCE(
    101,
...
NAMED_CHARACTER_REFERENCE(
    113,
     'w' _ 'n' _ 'A' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 8, 0, 0x2193 _ 0)
NAMED_CHARACTER_REFERENCE(
    114,
...
NAMED_CHARACTER_REFERENCE(
    116,
     'w' _ 'n' _ 'B' _ 'r' _ 'e' _ 'v' _ 'e' _ ';', 8, 0, 0x0311 _ 0)
NAMED_CHARACTER_REFERENCE(
    117,
...
NAMED_CHARACTER_REFERENCE(
    126,
     'w' _ 'n' _ 'a' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 8, 0, 0x21d3 _ 0)
...
NAMED_CHARACTER_REFERENCE(146,
                           'g' _ 'o' _ 'n' _ ';', 4, 0, 0x0118 _ 0)
NAMED_CHARACTER_REFERENCE(147,  'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd3c)
NAMED_CHARACTER_REFERENCE(148,
                           's' _ 'i' _ 'l' _ 'o' _ 'n' _ ';', 6, 0,
                          0x0395 _ 0)
NAMED_CHARACTER_REFERENCE(149,
                           'u' _ 'a' _ 'l' _ ';', 4, 0, 0x2a75 _ 0)
NAMED_CHARACTER_REFERENCE(
    150,
     'u' _ 'a' _ 'l' _ 'T' _ 'i' _ 'l' _ 'd' _ 'e' _ ';', 9, 0,
    0x2242 _ 0)
NAMED_CHARACTER_REFERENCE(
    151,
     'u' _ 'i' _ 'l' _ 'i' _ 'b' _ 'r' _ 'i' _ 'u' _ 'm' _ ';', 10, 0,
    0x21cc _ 0)
...
NAMED_CHARACTER_REFERENCE(
    165,
     'u' _ 'r' _ 'i' _ 'e' _ 'r' _ 't' _ 'r' _ 'f' _ ';', 9, 0,
    0x2131 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    184,
     'e' _ 'a' _ 't' _ 'e' _ 'r' _ 'L' _ 'e' _ 's' _ 's' _ ';', 10, 0,
    0x2277 _ 0)
NAMED_CHARACTER_REFERENCE(
    185,
...
NAMED_CHARACTER_REFERENCE(
    251,
     'p' _ 'l' _ 'a' _ 'c' _ 'e' _ 't' _ 'r' _ 'f' _ ';', 9, 0,
    0x2112 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    257,
     'f' _ 't' _ 'A' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 8, 0, 0x2190 _ 0)
NAMED_CHARACTER_REFERENCE(
    258,
...
NAMED_CHARACTER_REFERENCE(
    260,
     'f' _ 't' _ 'C' _ 'e' _ 'i' _ 'l' _ 'i' _ 'n' _ 'g' _ ';', 10, 0,
    0x2308 _ 0)
NAMED_CHARACTER_REFERENCE(
    261,
...
NAMED_CHARACTER_REFERENCE(
    265,
     'f' _ 't' _ 'F' _ 'l' _ 'o' _ 'o' _ 'r' _ ';', 8, 0, 0x230a _ 0)
NAMED_CHARACTER_REFERENCE(
    266,
...
NAMED_CHARACTER_REFERENCE(
    278,
     'f' _ 't' _ 'V' _ 'e' _ 'c' _ 't' _ 'o' _ 'r' _ ';', 9, 0,
    0x21bc _ 0)
NAMED_CHARACTER_REFERENCE(
    279,
...
NAMED_CHARACTER_REFERENCE(
    280,
     'f' _ 't' _ 'a' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 8, 0, 0x21d0 _ 0)
NAMED_CHARACTER_REFERENCE(
    281,
...
NAMED_CHARACTER_REFERENCE(
    284,
     's' _ 's' _ 'G' _ 'r' _ 'e' _ 'a' _ 't' _ 'e' _ 'r' _ ';', 10, 0,
    0x2276 _ 0)
NAMED_CHARACTER_REFERENCE(285,
                           's' _ 's' _ 'L' _ 'e' _ 's' _ 's' _ ';', 7,
                          0, 0x2aa1 _ 0)
NAMED_CHARACTER_REFERENCE(
    286,
...
NAMED_CHARACTER_REFERENCE(
    307,
     'd' _ 'i' _ 'u' _ 'm' _ 'S' _ 'p' _ 'a' _ 'c' _ 'e' _ ';', 10, 0,
    0x205f _ 0)
NAMED_CHARACTER_REFERENCE(
    308,
     'l' _ 'l' _ 'i' _ 'n' _ 't' _ 'r' _ 'f' _ ';', 8, 0, 0x2133 _ 0)
NAMED_CHARACTER_REFERENCE(309,  'r' _ ';', 2, 0, 0xd835 _ 0xdd10)
NAMED_CHARACTER_REFERENCE(
    310,
     'n' _ 'u' _ 's' _ 'P' _ 'l' _ 'u' _ 's' _ ';', 8, 0, 0x2213 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    332,
     't' _ 'C' _ 'u' _ 'p' _ 'C' _ 'a' _ 'p' _ ';', 8, 0, 0x226d _ 0)
NAMED_CHARACTER_REFERENCE(
    333,
...
NAMED_CHARACTER_REFERENCE(
    334,
     't' _ 'E' _ 'l' _ 'e' _ 'm' _ 'e' _ 'n' _ 't' _ ';', 9, 0,
    0x2209 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    337,
     't' _ 'E' _ 'x' _ 'i' _ 's' _ 't' _ 's' _ ';', 8, 0, 0x2204 _ 0)
NAMED_CHARACTER_REFERENCE(
    338,
     't' _ 'G' _ 'r' _ 'e' _ 'a' _ 't' _ 'e' _ 'r' _ ';', 9, 0,
    0x226f _ 0)
NAMED_CHARACTER_REFERENCE(
    339,
...
NAMED_CHARACTER_REFERENCE(
    353,
     't' _ 'L' _ 'e' _ 's' _ 's' _ 'L' _ 'e' _ 's' _ 's' _ ';', 10, 0,
    0x226a _ 0x0338)
NAMED_CHARACTER_REFERENCE(
    354,
...
NAMED_CHARACTER_REFERENCE(
    358,
     't' _ 'P' _ 'r' _ 'e' _ 'c' _ 'e' _ 'd' _ 'e' _ 's' _ ';', 10, 0,
    0x2280 _ 0)
NAMED_CHARACTER_REFERENCE(
    359,
...
NAMED_CHARACTER_REFERENCE(
    369,
     't' _ 'S' _ 'u' _ 'b' _ 's' _ 'e' _ 't' _ ';', 8, 0,
    0x2282 _ 0x20d2)
NAMED_CHARACTER_REFERENCE(
    370,
...
NAMED_CHARACTER_REFERENCE(
    371,
     't' _ 'S' _ 'u' _ 'c' _ 'c' _ 'e' _ 'e' _ 'd' _ 's' _ ';', 10, 0,
    0x2281 _ 0)
NAMED_CHARACTER_REFERENCE(
    372,
...
NAMED_CHARACTER_REFERENCE(
    375,
     't' _ 'S' _ 'u' _ 'p' _ 'e' _ 'r' _ 's' _ 'e' _ 't' _ ';', 10, 0,
    0x2283 _ 0x20d2)
NAMED_CHARACTER_REFERENCE(
    376,
...
NAMED_CHARACTER_REFERENCE(411,
                           'e' _ 'r' _ 'B' _ 'a' _ 'r' _ ';', 6, 0,
                          0x203e _ 0)
NAMED_CHARACTER_REFERENCE(
    412,
     'e' _ 'r' _ 'B' _ 'r' _ 'a' _ 'c' _ 'e' _ ';', 8, 0, 0x23de _ 0)
NAMED_CHARACTER_REFERENCE(
    413,
     'e' _ 'r' _ 'B' _ 'r' _ 'a' _ 'c' _ 'k' _ 'e' _ 't' _ ';', 10, 0,
    0x23b4 _ 0)
NAMED_CHARACTER_REFERENCE(
    414,
...
NAMED_CHARACTER_REFERENCE(
    420,
     'u' _ 's' _ 'M' _ 'i' _ 'n' _ 'u' _ 's' _ ';', 8, 0, 0x00b1 _ 0)
NAMED_CHARACTER_REFERENCE(
    421,
...
NAMED_CHARACTER_REFERENCE(428,
                           'i' _ 'm' _ 'e' _ ';', 4, 0, 0x2033 _ 0)
NAMED_CHARACTER_REFERENCE(429,
                           'o' _ 'd' _ 'u' _ 'c' _ 't' _ ';', 6, 0,
                          0x220f _ 0)
NAMED_CHARACTER_REFERENCE(
    430,
     'o' _ 'p' _ 'o' _ 'r' _ 't' _ 'i' _ 'o' _ 'n' _ ';', 9, 0,
    0x2237 _ 0)
NAMED_CHARACTER_REFERENCE(
    431,
...
NAMED_CHARACTER_REFERENCE(
    456,
     'g' _ 'h' _ 't' _ 'A' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 9, 0,
    0x2192 _ 0)
NAMED_CHARACTER_REFERENCE(
    457,
...
NAMED_CHARACTER_REFERENCE(
    464,
     'g' _ 'h' _ 't' _ 'F' _ 'l' _ 'o' _ 'o' _ 'r' _ ';', 9, 0,
    0x230b _ 0)
NAMED_CHARACTER_REFERENCE(465,
                           'g' _ 'h' _ 't' _ 'T' _ 'e' _ 'e' _ ';', 7,
                          0, 0x22a2 _ 0)
NAMED_CHARACTER_REFERENCE(
    466,
...
NAMED_CHARACTER_REFERENCE(
    475,
     'g' _ 'h' _ 't' _ 'V' _ 'e' _ 'c' _ 't' _ 'o' _ 'r' _ ';', 10, 0,
    0x21c0 _ 0)
NAMED_CHARACTER_REFERENCE(
    476,
...
NAMED_CHARACTER_REFERENCE(498,
                           'g' _ 'm' _ 'a' _ ';', 4, 0, 0x03a3 _ 0)
NAMED_CHARACTER_REFERENCE(
    499,
     'a' _ 'l' _ 'l' _ 'C' _ 'i' _ 'r' _ 'c' _ 'l' _ 'e' _ ';', 10, 0,
    0x2218 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    508,
     'u' _ 'a' _ 'r' _ 'e' _ 'U' _ 'n' _ 'i' _ 'o' _ 'n' _ ';', 10, 0,
    0x2294 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    513,
     'b' _ 's' _ 'e' _ 't' _ 'E' _ 'q' _ 'u' _ 'a' _ 'l' _ ';', 10, 0,
    0x2286 _ 0)
NAMED_CHARACTER_REFERENCE(514,
                           'c' _ 'c' _ 'e' _ 'e' _ 'd' _ 's' _ ';', 7,
                          0, 0x227b _ 0)
NAMED_CHARACTER_REFERENCE(
    515,
...
NAMED_CHARACTER_REFERENCE(525,
                           'O' _ 'R' _ 'N' _ ';', 4, 0, 0x00de _ 0)
NAMED_CHARACTER_REFERENCE(526,
                           'A' _ 'D' _ 'E' _ ';', 4, 0, 0x2122 _ 0)
NAMED_CHARACTER_REFERENCE(527,
                           'H' _ 'c' _ 'y' _ ';', 4, 0, 0x040b _ 0)
...
NAMED_CHARACTER_REFERENCE(
    535,
     'e' _ 'r' _ 'e' _ 'f' _ 'o' _ 'r' _ 'e' _ ';', 8, 0, 0x2234 _ 0)
NAMED_CHARACTER_REFERENCE(536,
                           'e' _ 't' _ 'a' _ ';', 4, 0, 0x0398 _ 0)
NAMED_CHARACTER_REFERENCE(
    537,
     'i' _ 'c' _ 'k' _ 'S' _ 'p' _ 'a' _ 'c' _ 'e' _ ';', 9, 0,
    0x205f _ 0x200a)
NAMED_CHARACTER_REFERENCE(
    538,
     'i' _ 'n' _ 'S' _ 'p' _ 'a' _ 'c' _ 'e' _ ';', 8, 0, 0x2009 _ 0)
NAMED_CHARACTER_REFERENCE(539,
                           'l' _ 'd' _ 'e' _ ';', 4, 0, 0x223c _ 0)
NAMED_CHARACTER_REFERENCE(
    540,
     'l' _ 'd' _ 'e' _ 'E' _ 'q' _ 'u' _ 'a' _ 'l' _ ';', 9, 0,
    0x2243 _ 0)
NAMED_CHARACTER_REFERENCE(
    541,
...
NAMED_CHARACTER_REFERENCE(558,
                           'r' _ 'a' _ 'v' _ 'e', 4, 0, 0x00d9 _ 0)
NAMED_CHARACTER_REFERENCE(559,
                           'r' _ 'a' _ 'v' _ 'e' _ ';', 5, 0,
                          0x00d9 _ 0)
NAMED_CHARACTER_REFERENCE(560,
                           'a' _ 'c' _ 'r' _ ';', 4, 0, 0x016a _ 0)
NAMED_CHARACTER_REFERENCE(561,
                           'd' _ 'e' _ 'r' _ 'B' _ 'a' _ 'r' _ ';', 7,
                          0, 0x005f _ 0)
NAMED_CHARACTER_REFERENCE(
    562,
     'd' _ 'e' _ 'r' _ 'B' _ 'r' _ 'a' _ 'c' _ 'e' _ ';', 9, 0,
    0x23df _ 0)
NAMED_CHARACTER_REFERENCE(
    563,
...
NAMED_CHARACTER_REFERENCE(565,
                           'i' _ 'o' _ 'n' _ ';', 4, 0, 0x22c3 _ 0)
NAMED_CHARACTER_REFERENCE(
    566,
     'i' _ 'o' _ 'n' _ 'P' _ 'l' _ 'u' _ 's' _ ';', 8, 0, 0x228e _ 0)
NAMED_CHARACTER_REFERENCE(567,
                           'g' _ 'o' _ 'n' _ ';', 4, 0, 0x0172 _ 0)
NAMED_CHARACTER_REFERENCE(568,  'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd4c)
NAMED_CHARACTER_REFERENCE(569,
                           'A' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 6, 0,
                          0x2191 _ 0)
NAMED_CHARACTER_REFERENCE(
    570,
     'A' _ 'r' _ 'r' _ 'o' _ 'w' _ 'B' _ 'a' _ 'r' _ ';', 9, 0,
    0x2912 _ 0)
NAMED_CHARACTER_REFERENCE(
    571,
...
NAMED_CHARACTER_REFERENCE(
    572,
     'D' _ 'o' _ 'w' _ 'n' _ 'A' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 10, 0,
    0x2195 _ 0)
NAMED_CHARACTER_REFERENCE(
    573,
...
NAMED_CHARACTER_REFERENCE(574,
                           'T' _ 'e' _ 'e' _ ';', 4, 0, 0x22a5 _ 0)
NAMED_CHARACTER_REFERENCE(
    575,
     'T' _ 'e' _ 'e' _ 'A' _ 'r' _ 'r' _ 'o' _ 'w' _ ';', 9, 0,
    0x21a5 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    595,
     'r' _ 't' _ 'i' _ 'c' _ 'a' _ 'l' _ 'B' _ 'a' _ 'r' _ ';', 10, 0,
    0x2223 _ 0)
NAMED_CHARACTER_REFERENCE(
    596,
...
NAMED_CHARACTER_REFERENCE(604,
                           'i' _ 'r' _ 'c' _ ';', 4, 0, 0x0174 _ 0)
NAMED_CHARACTER_REFERENCE(605,
                           'd' _ 'g' _ 'e' _ ';', 4, 0, 0x22c0 _ 0)
...
NAMED_CHARACTER_REFERENCE(695,
                           'y' _ 'm' _ 'p' _ ';', 4, 0, 0x2248 _ 0)
NAMED_CHARACTER_REFERENCE(696,
                           'y' _ 'm' _ 'p' _ 'e' _ 'q' _ ';', 6, 0,
                          0x224d _ 0)
NAMED_CHARACTER_REFERENCE(697,
                           'i' _ 'l' _ 'd' _ 'e', 4, 0, 0x00e3 _ 0)
...
NAMED_CHARACTER_REFERENCE(701,
                           'c' _ 'o' _ 'n' _ 'i' _ 'n' _ 't' _ ';', 7,
                          0, 0x2233 _ 0)
NAMED_CHARACTER_REFERENCE(702,
                           'i' _ 'n' _ 't' _ ';', 4, 0, 0x2a11 _ 0)
NAMED_CHARACTER_REFERENCE(703,  'o' _ 't' _ ';', 3, 0, 0x2aed _ 0)
NAMED_CHARACTER_REFERENCE(704,
                           'c' _ 'k' _ 'c' _ 'o' _ 'n' _ 'g' _ ';', 7,
                          0, 0x224c _ 0)
NAMED_CHARACTER_REFERENCE(
    705,
     'c' _ 'k' _ 'e' _ 'p' _ 's' _ 'i' _ 'l' _ 'o' _ 'n' _ ';', 10, 0,
    0x03f6 _ 0)
NAMED_CHARACTER_REFERENCE(
    706,
     'c' _ 'k' _ 'p' _ 'r' _ 'i' _ 'm' _ 'e' _ ';', 8, 0, 0x2035 _ 0)
NAMED_CHARACTER_REFERENCE(707,
                           'c' _ 'k' _ 's' _ 'i' _ 'm' _ ';', 6, 0,
                          0x223d _ 0)
NAMED_CHARACTER_REFERENCE(
    708,
     'c' _ 'k' _ 's' _ 'i' _ 'm' _ 'e' _ 'q' _ ';', 8, 0, 0x22cd _ 0)
...
NAMED_CHARACTER_REFERENCE(719,
                           'm' _ 'p' _ 't' _ 'y' _ 'v' _ ';', 6, 0,
                          0x29b0 _ 0)
NAMED_CHARACTER_REFERENCE(720,
                           'p' _ 's' _ 'i' _ ';', 4, 0, 0x03f6 _ 0)
...
NAMED_CHARACTER_REFERENCE(727,
                           'g' _ 'c' _ 'i' _ 'r' _ 'c' _ ';', 6, 0,
                          0x25ef _ 0)
NAMED_CHARACTER_REFERENCE(728,
                           'g' _ 'c' _ 'u' _ 'p' _ ';', 5, 0,
                          0x22c3 _ 0)
NAMED_CHARACTER_REFERENCE(729,
                           'g' _ 'o' _ 'd' _ 'o' _ 't' _ ';', 6, 0,
                          0x2a00 _ 0)
NAMED_CHARACTER_REFERENCE(730,
                           'g' _ 'o' _ 'p' _ 'l' _ 'u' _ 's' _ ';', 7,
                          0, 0x2a01 _ 0)
NAMED_CHARACTER_REFERENCE(
    731,
     'g' _ 'o' _ 't' _ 'i' _ 'm' _ 'e' _ 's' _ ';', 8, 0, 0x2a02 _ 0)
NAMED_CHARACTER_REFERENCE(732,
                           'g' _ 's' _ 'q' _ 'c' _ 'u' _ 'p' _ ';', 7,
                          0, 0x2a06 _ 0)
NAMED_CHARACTER_REFERENCE(733,
                           'g' _ 's' _ 't' _ 'a' _ 'r' _ ';', 6, 0,
                          0x2605 _ 0)
NAMED_CHARACTER_REFERENCE(
    734,
...
NAMED_CHARACTER_REFERENCE(
    741,
     'a' _ 'c' _ 'k' _ 's' _ 'q' _ 'u' _ 'a' _ 'r' _ 'e' _ ';', 10, 0,
    0x25aa _ 0)
NAMED_CHARACTER_REFERENCE(
    742,
...
NAMED_CHARACTER_REFERENCE(816,
                           'm' _ 'p' _ 'E' _ ';', 4, 0, 0x2aae _ 0)
NAMED_CHARACTER_REFERENCE(817,
                           'm' _ 'p' _ 'e' _ ';', 4, 0, 0x224f _ 0)
...
NAMED_CHARACTER_REFERENCE(845,
                           'e' _ 'c' _ 'k' _ ';', 4, 0, 0x2713 _ 0)
NAMED_CHARACTER_REFERENCE(
    846,
     'e' _ 'c' _ 'k' _ 'm' _ 'a' _ 'r' _ 'k' _ ';', 8, 0, 0x2713 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    872,
     'm' _ 'p' _ 'l' _ 'e' _ 'm' _ 'e' _ 'n' _ 't' _ ';', 9, 0,
    0x2201 _ 0)
NAMED_CHARACTER_REFERENCE(
    873,
     'm' _ 'p' _ 'l' _ 'e' _ 'x' _ 'e' _ 's' _ ';', 8, 0, 0x2102 _ 0)
NAMED_CHARACTER_REFERENCE(874,  'n' _ 'g' _ ';', 3, 0, 0x2245 _ 0)
NAMED_CHARACTER_REFERENCE(875,
                           'n' _ 'g' _ 'd' _ 'o' _ 't' _ ';', 6, 0,
                          0x2a6d _ 0)
...
NAMED_CHARACTER_REFERENCE(882,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21b5 _ 0)
NAMED_CHARACTER_REFERENCE(883,
                           'o' _ 's' _ 's' _ ';', 4, 0, 0x2717 _ 0)
...
NAMED_CHARACTER_REFERENCE(901,
                           'p' _ 'o' _ 'r' _ ';', 4, 0, 0x2a45 _ 0)
NAMED_CHARACTER_REFERENCE(902,  'p' _ 's' _ ';', 3, 0, 0x222a _ 0xfe00)
NAMED_CHARACTER_REFERENCE(903,
                           'r' _ 'a' _ 'r' _ 'r' _ ';', 5, 0,
                          0x21b7 _ 0)
NAMED_CHARACTER_REFERENCE(904,
                           'r' _ 'a' _ 'r' _ 'r' _ 'm' _ ';', 6, 0,
                          0x293c _ 0)
NAMED_CHARACTER_REFERENCE(
    905,
     'r' _ 'l' _ 'y' _ 'e' _ 'q' _ 'p' _ 'r' _ 'e' _ 'c' _ ';', 10, 0,
    0x22de _ 0)
NAMED_CHARACTER_REFERENCE(
    906,
     'r' _ 'l' _ 'y' _ 'e' _ 'q' _ 's' _ 'u' _ 'c' _ 'c' _ ';', 10, 0,
    0x22df _ 0)
NAMED_CHARACTER_REFERENCE(907,
                           'r' _ 'l' _ 'y' _ 'v' _ 'e' _ 'e' _ ';', 7,
                          0, 0x22ce _ 0)
NAMED_CHARACTER_REFERENCE(
    908,
     'r' _ 'l' _ 'y' _ 'w' _ 'e' _ 'd' _ 'g' _ 'e' _ ';', 9, 0,
    0x22cf _ 0)
NAMED_CHARACTER_REFERENCE(909,
                           'r' _ 'r' _ 'e' _ 'n', 4, 0, 0x00a4 _ 0)
...
NAMED_CHARACTER_REFERENCE(924,
                           's' _ 'h' _ 'v' _ ';', 4, 0, 0x22a3 _ 0)
NAMED_CHARACTER_REFERENCE(925,
                           'k' _ 'a' _ 'r' _ 'o' _ 'w' _ ';', 6, 0,
                          0x290f _ 0)
NAMED_CHARACTER_REFERENCE(926,
                           'l' _ 'a' _ 'c' _ ';', 4, 0, 0x02dd _ 0)
...
NAMED_CHARACTER_REFERENCE(930,
                           'a' _ 'g' _ 'g' _ 'e' _ 'r' _ ';', 6, 0,
                          0x2021 _ 0)
NAMED_CHARACTER_REFERENCE(931,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21ca _ 0)
NAMED_CHARACTER_REFERENCE(932,
                           'o' _ 't' _ 's' _ 'e' _ 'q' _ ';', 6, 0,
                          0x2a77 _ 0)
...
NAMED_CHARACTER_REFERENCE(939,
                           'a' _ 'r' _ 'l' _ ';', 4, 0, 0x21c3 _ 0)
NAMED_CHARACTER_REFERENCE(940,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21c2 _ 0)
...
NAMED_CHARACTER_REFERENCE(959,
                           't' _ 'e' _ 'q' _ ';', 4, 0, 0x2250 _ 0)
NAMED_CHARACTER_REFERENCE(960,
                           't' _ 'e' _ 'q' _ 'd' _ 'o' _ 't' _ ';', 7,
                          0, 0x2251 _ 0)
NAMED_CHARACTER_REFERENCE(961,
                           't' _ 'm' _ 'i' _ 'n' _ 'u' _ 's' _ ';', 7,
                          0, 0x2238 _ 0)
NAMED_CHARACTER_REFERENCE(962,
                           't' _ 'p' _ 'l' _ 'u' _ 's' _ ';', 6, 0,
                          0x2214 _ 0)
NAMED_CHARACTER_REFERENCE(
    963,
     't' _ 's' _ 'q' _ 'u' _ 'a' _ 'r' _ 'e' _ ';', 8, 0, 0x22a1 _ 0)
NAMED_CHARACTER_REFERENCE(
    964,
...
NAMED_CHARACTER_REFERENCE(1009,
                           'a' _ 'c' _ 'r' _ ';', 4, 0, 0x0113 _ 0)
NAMED_CHARACTER_REFERENCE(1010,
                           'p' _ 't' _ 'y' _ ';', 4, 0, 0x2205 _ 0)
NAMED_CHARACTER_REFERENCE(1011,
                           'p' _ 't' _ 'y' _ 's' _ 'e' _ 't' _ ';', 7,
                          0, 0x2205 _ 0)
...
NAMED_CHARACTER_REFERENCE(1048,
                           'i' _ 's' _ 't' _ ';', 4, 0, 0x2203 _ 0)
NAMED_CHARACTER_REFERENCE(
    1049,
     'p' _ 'e' _ 'c' _ 't' _ 'a' _ 't' _ 'i' _ 'o' _ 'n' _ ';', 10, 0,
    0x2130 _ 0)
NAMED_CHARACTER_REFERENCE(
    1050,
     'p' _ 'o' _ 'n' _ 'e' _ 'n' _ 't' _ 'i' _ 'a' _ 'l' _ 'e' _ ';',
...
NAMED_CHARACTER_REFERENCE(1087,
                           'a' _ 's' _ 'l' _ ';', 4, 0, 0x2044 _ 0)
NAMED_CHARACTER_REFERENCE(1088,
                           'o' _ 'w' _ 'n' _ ';', 4, 0, 0x2322 _ 0)
NAMED_CHARACTER_REFERENCE(1089,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdcbb)
...
NAMED_CHARACTER_REFERENCE(1126,
                           'e' _ 'q' _ 'q' _ ';', 4, 0, 0x2269 _ 0)
NAMED_CHARACTER_REFERENCE(1127,
                           's' _ 'i' _ 'm' _ ';', 4, 0, 0x22e7 _ 0)
NAMED_CHARACTER_REFERENCE(1128,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd58)
NAMED_CHARACTER_REFERENCE(1129,
                           'a' _ 'v' _ 'e' _ ';', 4, 0, 0x0060 _ 0)
...
NAMED_CHARACTER_REFERENCE(1132,
                           'i' _ 'm' _ 'e' _ ';', 4, 0, 0x2a8e _ 0)
NAMED_CHARACTER_REFERENCE(1133,
                           'i' _ 'm' _ 'l' _ ';', 4, 0, 0x2a90 _ 0)
...
NAMED_CHARACTER_REFERENCE(1137,
                           'c' _ 'i' _ 'r' _ ';', 4, 0, 0x2a7a _ 0)
NAMED_CHARACTER_REFERENCE(1138,
                           'd' _ 'o' _ 't' _ ';', 4, 0, 0x22d7 _ 0)
NAMED_CHARACTER_REFERENCE(1139,
                           'l' _ 'P' _ 'a' _ 'r' _ ';', 5, 0,
                          0x2995 _ 0)
NAMED_CHARACTER_REFERENCE(1140,
                           'q' _ 'u' _ 'e' _ 's' _ 't' _ ';', 6, 0,
                          0x2a7c _ 0)
NAMED_CHARACTER_REFERENCE(
    1141,
     'r' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';', 8, 0, 0x2a86 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    1144,
     'r' _ 'e' _ 'q' _ 'l' _ 'e' _ 's' _ 's' _ ';', 8, 0, 0x22db _ 0)
NAMED_CHARACTER_REFERENCE(
    1145,
     'r' _ 'e' _ 'q' _ 'q' _ 'l' _ 'e' _ 's' _ 's' _ ';', 9, 0,
    0x2a8c _ 0)
NAMED_CHARACTER_REFERENCE(1146,
                           'r' _ 'l' _ 'e' _ 's' _ 's' _ ';', 6, 0,
                          0x2277 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    1148,
     'e' _ 'r' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';', 8, 0,
    0x2269 _ 0xfe00)
NAMED_CHARACTER_REFERENCE(1149,
                           'n' _ 'E' _ ';', 3, 0, 0x2269 _ 0xfe00)
...
NAMED_CHARACTER_REFERENCE(1165,
                           's' _ 'e' _ 'a' _ 'r' _ 'o' _ 'w' _ ';', 7,
                          0, 0x2925 _ 0)
NAMED_CHARACTER_REFERENCE(1166,
                           's' _ 'w' _ 'a' _ 'r' _ 'o' _ 'w' _ ';', 7,
                          0, 0x2926 _ 0)
NAMED_CHARACTER_REFERENCE(1167,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21ff _ 0)
...
NAMED_CHARACTER_REFERENCE(1282,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x290c _ 0)
NAMED_CHARACTER_REFERENCE(1283,
                           'b' _ 'r' _ 'k' _ ';', 4, 0, 0x2772 _ 0)
...
NAMED_CHARACTER_REFERENCE(1286,
                           'r' _ 'k' _ 'e' _ ';', 4, 0, 0x298b _ 0)
NAMED_CHARACTER_REFERENCE(1287,
                           'r' _ 'k' _ 's' _ 'l' _ 'd' _ ';', 6, 0,
                          0x298f _ 0)
NAMED_CHARACTER_REFERENCE(1288,
                           'r' _ 'k' _ 's' _ 'l' _ 'u' _ ';', 6, 0,
                          0x298d _ 0)
...
NAMED_CHARACTER_REFERENCE(1319,
                           's' _ 'd' _ 'o' _ 't' _ 'o' _ 'r' _ ';', 7,
                          0, 0x2a83 _ 0)
NAMED_CHARACTER_REFERENCE(1320,
                           's' _ 'g' _ ';', 3, 0, 0x22da _ 0xfe00)
NAMED_CHARACTER_REFERENCE(1321,
                           's' _ 'g' _ 'e' _ 's' _ ';', 5, 0,
                          0x2a93 _ 0)
NAMED_CHARACTER_REFERENCE(
    1322,
     's' _ 's' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';', 9, 0,
    0x2a85 _ 0)
NAMED_CHARACTER_REFERENCE(1323,
                           's' _ 's' _ 'd' _ 'o' _ 't' _ ';', 6, 0,
                          0x22d6 _ 0)
NAMED_CHARACTER_REFERENCE(
    1324,
     's' _ 's' _ 'e' _ 'q' _ 'g' _ 't' _ 'r' _ ';', 8, 0, 0x22da _ 0)
NAMED_CHARACTER_REFERENCE(
    1325,
     's' _ 's' _ 'e' _ 'q' _ 'q' _ 'g' _ 't' _ 'r' _ ';', 9, 0,
    0x2a8b _ 0)
NAMED_CHARACTER_REFERENCE(1326,
                           's' _ 's' _ 'g' _ 't' _ 'r' _ ';', 6, 0,
                          0x2276 _ 0)
NAMED_CHARACTER_REFERENCE(1327,
                           's' _ 's' _ 's' _ 'i' _ 'm' _ ';', 6, 0,
                          0x2272 _ 0)
...
NAMED_CHARACTER_REFERENCE(
    1345,
     'o' _ 'u' _ 's' _ 't' _ 'a' _ 'c' _ 'h' _ 'e' _ ';', 9, 0,
    0x23b0 _ 0)
...
NAMED_CHARACTER_REFERENCE(1351,
                           'e' _ 'q' _ 'q' _ ';', 4, 0, 0x2268 _ 0)
NAMED_CHARACTER_REFERENCE(1352,
                           's' _ 'i' _ 'm' _ ';', 4, 0, 0x22e6 _ 0)
NAMED_CHARACTER_REFERENCE(1353,
                           'a' _ 'n' _ 'g' _ ';', 4, 0, 0x27ec _ 0)
NAMED_CHARACTER_REFERENCE(1354,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21fd _ 0)
NAMED_CHARACTER_REFERENCE(1355,
                           'b' _ 'r' _ 'k' _ ';', 4, 0, 0x27e6 _ 0)
NAMED_CHARACTER_REFERENCE(
    1356,
...
NAMED_CHARACTER_REFERENCE(
    1358,
     'n' _ 'g' _ 'm' _ 'a' _ 'p' _ 's' _ 't' _ 'o' _ ';', 9, 0,
    0x27fc _ 0)
NAMED_CHARACTER_REFERENCE(
    1359,
...
NAMED_CHARACTER_REFERENCE(1392,
                           'c' _ 'i' _ 'r' _ ';', 4, 0, 0x2a79 _ 0)
NAMED_CHARACTER_REFERENCE(1393,
                           'd' _ 'o' _ 't' _ ';', 4, 0, 0x22d6 _ 0)
...
NAMED_CHARACTER_REFERENCE(1400,
                           'r' _ 'i' _ 'e' _ ';', 4, 0, 0x22b4 _ 0)
NAMED_CHARACTER_REFERENCE(1401,
                           'r' _ 'i' _ 'f' _ ';', 4, 0, 0x25c2 _ 0)
NAMED_CHARACTER_REFERENCE(1402,
                           'r' _ 'd' _ 's' _ 'h' _ 'a' _ 'r' _ ';', 7,
                          0, 0x294a _ 0)
NAMED_CHARACTER_REFERENCE(1403,
                           'r' _ 'u' _ 'h' _ 'a' _ 'r' _ ';', 6, 0,
                          0x2966 _ 0)
NAMED_CHARACTER_REFERENCE(
    1404,
     'e' _ 'r' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';', 8, 0,
...
NAMED_CHARACTER_REFERENCE(1405,
                           'n' _ 'E' _ ';', 3, 0, 0x2268 _ 0xfe00)
NAMED_CHARACTER_REFERENCE(1406,
                           'D' _ 'o' _ 't' _ ';', 4, 0, 0x223a _ 0)
...
NAMED_CHARACTER_REFERENCE(
    1414,
     'p' _ 's' _ 't' _ 'o' _ 'd' _ 'o' _ 'w' _ 'n' _ ';', 9, 0,
    0x21a7 _ 0)
NAMED_CHARACTER_REFERENCE(
    1415,
     'p' _ 's' _ 't' _ 'o' _ 'l' _ 'e' _ 'f' _ 't' _ ';', 9, 0,
    0x21a4 _ 0)
NAMED_CHARACTER_REFERENCE(1416,
                           'p' _ 's' _ 't' _ 'o' _ 'u' _ 'p' _ ';', 7,
                          0, 0x21a5 _ 0)
...
NAMED_CHARACTER_REFERENCE(1475,
                           'o' _ 'n' _ 'g' _ ';', 4, 0, 0x2247 _ 0)
NAMED_CHARACTER_REFERENCE(1476,
                           'o' _ 'n' _ 'g' _ 'd' _ 'o' _ 't' _ ';', 7,
                          0, 0x2a6d _ 0x0338)
...
NAMED_CHARACTER_REFERENCE(
    1496,
     'e' _ 'q' _ 's' _ 'l' _ 'a' _ 'n' _ 't' _ ';', 8, 0,
    0x2a7e _ 0x0338)
NAMED_CHARACTER_REFERENCE(1497,
                           'e' _ 's' _ ';', 3, 0, 0x2a7e _ 0x0338)
NAMED_CHARACTER_REFERENCE(1498,
                           's' _ 'i' _ 'm' _ ';', 4, 0, 0x2275 _ 0)
...
NAMED_CHARACTER_REFERENCE(1501,
                           'A' _ 'r' _ 'r' _ ';', 4, 0, 0x21ce _ 0)
NAMED_CHARACTER_REFERENCE(1502,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21ae _ 0)
NAMED_CHARACTER_REFERENCE(1503,
                           'p' _ 'a' _ 'r' _ ';', 4, 0, 0x2af2 _ 0)
...
NAMED_CHARACTER_REFERENCE(1546,
                           'r' _ 'e' _ ';', 3, 0, 0x2aaf _ 0x0338)
NAMED_CHARACTER_REFERENCE(1547,
                           'r' _ 'e' _ 'c' _ ';', 4, 0, 0x2280 _ 0)
NAMED_CHARACTER_REFERENCE(1548,
                           'r' _ 'e' _ 'c' _ 'e' _ 'q' _ ';', 6, 0,
                          0x2aaf _ 0x0338)
NAMED_CHARACTER_REFERENCE(1549,
                           'A' _ 'r' _ 'r' _ ';', 4, 0, 0x21cf _ 0)
NAMED_CHARACTER_REFERENCE(1550,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x219b _ 0)
...
NAMED_CHARACTER_REFERENCE(1558,
                           'c' _ 'e' _ ';', 3, 0, 0x2ab0 _ 0x0338)
NAMED_CHARACTER_REFERENCE(1559,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdcc3)
NAMED_CHARACTER_REFERENCE(
    1560,
     'h' _ 'o' _ 'r' _ 't' _ 'm' _ 'i' _ 'd' _ ';', 8, 0, 0x2224 _ 0)
NAMED_CHARACTER_REFERENCE(
    1561,
...
NAMED_CHARACTER_REFERENCE(1571,
                           'u' _ 'b' _ 'e' _ ';', 4, 0, 0x2288 _ 0)
NAMED_CHARACTER_REFERENCE(1572,
                           'u' _ 'b' _ 's' _ 'e' _ 't' _ ';', 6, 0,
                          0x2282 _ 0x20d2)
NAMED_CHARACTER_REFERENCE(
    1573,
     'u' _ 'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';', 8, 0, 0x2288 _ 0)
NAMED_CHARACTER_REFERENCE(
    1574,
     'u' _ 'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';', 9, 0,
    0x2ac5 _ 0x0338)
NAMED_CHARACTER_REFERENCE(1575,
                           'u' _ 'c' _ 'c' _ ';', 4, 0, 0x2281 _ 0)
NAMED_CHARACTER_REFERENCE(1576,
                           'u' _ 'c' _ 'c' _ 'e' _ 'q' _ ';', 6, 0,
                          0x2ab0 _ 0x0338)
...
NAMED_CHARACTER_REFERENCE(1579,
                           'u' _ 'p' _ 'e' _ ';', 4, 0, 0x2289 _ 0)
NAMED_CHARACTER_REFERENCE(1580,
                           'u' _ 'p' _ 's' _ 'e' _ 't' _ ';', 6, 0,
                          0x2283 _ 0x20d2)
NAMED_CHARACTER_REFERENCE(
    1581,
     'u' _ 'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';', 8, 0, 0x2289 _ 0)
NAMED_CHARACTER_REFERENCE(
    1582,
     'u' _ 'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';', 9, 0,
    0x2ac6 _ 0x0338)
NAMED_CHARACTER_REFERENCE(1583,  'g' _ 'l' _ ';', 3, 0, 0x2279 _ 0)
NAMED_CHARACTER_REFERENCE(1584,
                           'i' _ 'l' _ 'd' _ 'e', 4, 0, 0x00f1 _ 0)
...
NAMED_CHARACTER_REFERENCE(1627,
                           'l' _ 'i' _ 'g' _ ';', 4, 0, 0x0153 _ 0)
NAMED_CHARACTER_REFERENCE(1628,
                           'c' _ 'i' _ 'r' _ ';', 4, 0, 0x29bf _ 0)
...
NAMED_CHARACTER_REFERENCE(1700,
                           'u' _ 's' _ 'a' _ 'c' _ 'i' _ 'r' _ ';', 7,
                          0, 0x2a23 _ 0)
NAMED_CHARACTER_REFERENCE(1701,
                           'u' _ 's' _ 'b' _ ';', 4, 0, 0x229e _ 0)
NAMED_CHARACTER_REFERENCE(1702,
                           'u' _ 's' _ 'c' _ 'i' _ 'r' _ ';', 6, 0,
                          0x2a22 _ 0)
...
NAMED_CHARACTER_REFERENCE(1746,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd62)
NAMED_CHARACTER_REFERENCE(1747,
                           'r' _ 'i' _ 'm' _ 'e' _ ';', 5, 0,
                          0x2057 _ 0)
NAMED_CHARACTER_REFERENCE(1748,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdcc6)
NAMED_CHARACTER_REFERENCE(
    1749,
     'a' _ 't' _ 'e' _ 'r' _ 'n' _ 'i' _ 'o' _ 'n' _ 's' _ ';', 10, 0,
    0x210d _ 0)
NAMED_CHARACTER_REFERENCE(1750,
                           'a' _ 't' _ 'i' _ 'n' _ 't' _ ';', 6, 0,
                          0x2a16 _ 0)
NAMED_CHARACTER_REFERENCE(1751,
                           'e' _ 's' _ 't' _ ';', 4, 0, 0x003f _ 0)
NAMED_CHARACTER_REFERENCE(1752,
                           'e' _ 's' _ 't' _ 'e' _ 'q' _ ';', 6, 0,
                          0x225f _ 0)
...
NAMED_CHARACTER_REFERENCE(1781,
                           'r' _ 'r' _ 'w' _ ';', 4, 0, 0x219d _ 0)
NAMED_CHARACTER_REFERENCE(1782,
                           't' _ 'a' _ 'i' _ 'l' _ ';', 5, 0,
                          0x291a _ 0)
NAMED_CHARACTER_REFERENCE(1783,
                           't' _ 'i' _ 'o' _ ';', 4, 0, 0x2236 _ 0)
NAMED_CHARACTER_REFERENCE(
    1784,
     't' _ 'i' _ 'o' _ 'n' _ 'a' _ 'l' _ 's' _ ';', 8, 0, 0x211a _ 0)
NAMED_CHARACTER_REFERENCE(1785,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x290d _ 0)
NAMED_CHARACTER_REFERENCE(1786,
                           'b' _ 'r' _ 'k' _ ';', 4, 0, 0x2773 _ 0)
...
NAMED_CHARACTER_REFERENCE(1798,
                           'l' _ 'd' _ 'h' _ 'a' _ 'r' _ ';', 6, 0,
                          0x2969 _ 0)
NAMED_CHARACTER_REFERENCE(1799,
                           'q' _ 'u' _ 'o' _ ';', 4, 0, 0x201d _ 0)
...
NAMED_CHARACTER_REFERENCE(1803,
                           'a' _ 'l' _ 'i' _ 'n' _ 'e' _ ';', 6, 0,
                          0x211b _ 0)
NAMED_CHARACTER_REFERENCE(1804,
                           'a' _ 'l' _ 'p' _ 'a' _ 'r' _ 't' _ ';', 7,
                          0, 0x211c _ 0)
NAMED_CHARACTER_REFERENCE(1805,
                           'a' _ 'l' _ 's' _ ';', 4, 0, 0x211d _ 0)
...
NAMED_CHARACTER_REFERENCE(1812,
                           'a' _ 'r' _ 'd' _ ';', 4, 0, 0x21c1 _ 0)
NAMED_CHARACTER_REFERENCE(1813,
                           'a' _ 'r' _ 'u' _ ';', 4, 0, 0x21c0 _ 0)
...
NAMED_CHARACTER_REFERENCE(1828,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21c4 _ 0)
NAMED_CHARACTER_REFERENCE(1829,
                           'h' _ 'a' _ 'r' _ ';', 4, 0, 0x21cc _ 0)
...
NAMED_CHARACTER_REFERENCE(1833,
                           'm' _ 'i' _ 'd' _ ';', 4, 0, 0x2aee _ 0)
NAMED_CHARACTER_REFERENCE(1834,
                           'a' _ 'n' _ 'g' _ ';', 4, 0, 0x27ed _ 0)
NAMED_CHARACTER_REFERENCE(1835,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x21fe _ 0)
NAMED_CHARACTER_REFERENCE(1836,
                           'b' _ 'r' _ 'k' _ ';', 4, 0, 0x27e7 _ 0)
NAMED_CHARACTER_REFERENCE(1837,
                           'p' _ 'a' _ 'r' _ ';', 4, 0, 0x2986 _ 0)
NAMED_CHARACTER_REFERENCE(1838,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd63)
...
NAMED_CHARACTER_REFERENCE(1854,
                           'r' _ 'i' _ 'e' _ ';', 4, 0, 0x22b5 _ 0)
NAMED_CHARACTER_REFERENCE(1855,
                           'r' _ 'i' _ 'f' _ ';', 4, 0, 0x25b8 _ 0)
NAMED_CHARACTER_REFERENCE(1856,
                           'r' _ 'i' _ 'l' _ 't' _ 'r' _ 'i' _ ';', 7,
                          0, 0x29ce _ 0)
NAMED_CHARACTER_REFERENCE(1857,
                           'l' _ 'u' _ 'h' _ 'a' _ 'r' _ ';', 6, 0,
                          0x2968 _ 0)
...
NAMED_CHARACTER_REFERENCE(1945,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x2192 _ 0)
NAMED_CHARACTER_REFERENCE(1946,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdcc8)
...
NAMED_CHARACTER_REFERENCE(
    1953,
     'r' _ 'a' _ 'i' _ 'g' _ 'h' _ 't' _ 'p' _ 'h' _ 'i' _ ';', 10, 0,
    0x03d5 _ 0)
NAMED_CHARACTER_REFERENCE(1954,
                           'r' _ 'n' _ 's' _ ';', 4, 0, 0x00af _ 0)
...
NAMED_CHARACTER_REFERENCE(1959,
                           'b' _ 'e' _ 'd' _ 'o' _ 't' _ ';', 6, 0,
                          0x2ac3 _ 0)
NAMED_CHARACTER_REFERENCE(1960,
                           'b' _ 'm' _ 'u' _ 'l' _ 't' _ ';', 6, 0,
                          0x2ac1 _ 0)
NAMED_CHARACTER_REFERENCE(1961,
                           'b' _ 'n' _ 'E' _ ';', 4, 0, 0x2acb _ 0)
NAMED_CHARACTER_REFERENCE(1962,
                           'b' _ 'n' _ 'e' _ ';', 4, 0, 0x228a _ 0)
NAMED_CHARACTER_REFERENCE(1963,
                           'b' _ 'p' _ 'l' _ 'u' _ 's' _ ';', 6, 0,
                          0x2abf _ 0)
NAMED_CHARACTER_REFERENCE(1964,
                           'b' _ 'r' _ 'a' _ 'r' _ 'r' _ ';', 6, 0,
                          0x2979 _ 0)
NAMED_CHARACTER_REFERENCE(1965,
                           'b' _ 's' _ 'e' _ 't' _ ';', 5, 0,
                          0x2282 _ 0)
NAMED_CHARACTER_REFERENCE(1966,
                           'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';', 7,
                          0, 0x2286 _ 0)
NAMED_CHARACTER_REFERENCE(
    1967,
     'b' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';', 8, 0, 0x2ac5 _ 0)
NAMED_CHARACTER_REFERENCE(
    1968,
     'b' _ 's' _ 'e' _ 't' _ 'n' _ 'e' _ 'q' _ ';', 8, 0, 0x228a _ 0)
NAMED_CHARACTER_REFERENCE(
    1969,
     'b' _ 's' _ 'e' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';', 9, 0,
    0x2acb _ 0)
...
NAMED_CHARACTER_REFERENCE(
    1974,
     'c' _ 'c' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';', 9, 0,
    0x2ab8 _ 0)
NAMED_CHARACTER_REFERENCE(
    1975,
     'c' _ 'c' _ 'c' _ 'u' _ 'r' _ 'l' _ 'y' _ 'e' _ 'q' _ ';', 10, 0,
    0x227d _ 0)
...
NAMED_CHARACTER_REFERENCE(
    1977,
     'c' _ 'c' _ 'n' _ 'a' _ 'p' _ 'p' _ 'r' _ 'o' _ 'x' _ ';', 10, 0,
    0x2aba _ 0)
NAMED_CHARACTER_REFERENCE(1978,
                           'c' _ 'c' _ 'n' _ 'e' _ 'q' _ 'q' _ ';', 7,
                          0, 0x2ab6 _ 0)
NAMED_CHARACTER_REFERENCE(1979,
                           'c' _ 'c' _ 'n' _ 's' _ 'i' _ 'm' _ ';', 7,
                          0, 0x22e9 _ 0)
NAMED_CHARACTER_REFERENCE(1980,
                           'c' _ 'c' _ 's' _ 'i' _ 'm' _ ';', 6, 0,
                          0x227f _ 0)
...
NAMED_CHARACTER_REFERENCE(1992,
                           'p' _ 'd' _ 's' _ 'u' _ 'b' _ ';', 6, 0,
                          0x2ad8 _ 0)
NAMED_CHARACTER_REFERENCE(1993,  'p' _ 'e' _ ';', 3, 0, 0x2287 _ 0)
NAMED_CHARACTER_REFERENCE(1994,
                           'p' _ 'e' _ 'd' _ 'o' _ 't' _ ';', 6, 0,
                          0x2ac4 _ 0)
NAMED_CHARACTER_REFERENCE(1995,
                           'p' _ 'h' _ 's' _ 'o' _ 'l' _ ';', 6, 0,
                          0x27c9 _ 0)
NAMED_CHARACTER_REFERENCE(1996,
                           'p' _ 'h' _ 's' _ 'u' _ 'b' _ ';', 6, 0,
                          0x2ad7 _ 0)
NAMED_CHARACTER_REFERENCE(1997,
                           'p' _ 'l' _ 'a' _ 'r' _ 'r' _ ';', 6, 0,
                          0x297b _ 0)
NAMED_CHARACTER_REFERENCE(1998,
                           'p' _ 'm' _ 'u' _ 'l' _ 't' _ ';', 6, 0,
                          0x2ac2 _ 0)
NAMED_CHARACTER_REFERENCE(1999,
                           'p' _ 'n' _ 'E' _ ';', 4, 0, 0x2acc _ 0)
NAMED_CHARACTER_REFERENCE(2000,
                           'p' _ 'n' _ 'e' _ ';', 4, 0, 0x228b _ 0)
NAMED_CHARACTER_REFERENCE(2001,
                           'p' _ 'p' _ 'l' _ 'u' _ 's' _ ';', 6, 0,
                          0x2ac0 _ 0)
NAMED_CHARACTER_REFERENCE(2002,
                           'p' _ 's' _ 'e' _ 't' _ ';', 5, 0,
                          0x2283 _ 0)
NAMED_CHARACTER_REFERENCE(2003,
                           'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ ';', 7,
                          0, 0x2287 _ 0)
NAMED_CHARACTER_REFERENCE(
    2004,
     'p' _ 's' _ 'e' _ 't' _ 'e' _ 'q' _ 'q' _ ';', 8, 0, 0x2ac6 _ 0)
NAMED_CHARACTER_REFERENCE(
    2005,
     'p' _ 's' _ 'e' _ 't' _ 'n' _ 'e' _ 'q' _ ';', 8, 0, 0x228b _ 0)
NAMED_CHARACTER_REFERENCE(
    2006,
     'p' _ 's' _ 'e' _ 't' _ 'n' _ 'e' _ 'q' _ 'q' _ ';', 9, 0,
    0x2acc _ 0)
...
NAMED_CHARACTER_REFERENCE(2028,
                           'e' _ 't' _ 'a' _ ';', 4, 0, 0x03b8 _ 0)
NAMED_CHARACTER_REFERENCE(2029,
                           'e' _ 't' _ 'a' _ 's' _ 'y' _ 'm' _ ';', 7,
                          0, 0x03d1 _ 0)
...
NAMED_CHARACTER_REFERENCE(2049,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd65)
NAMED_CHARACTER_REFERENCE(2050,
                           'p' _ 'f' _ 'o' _ 'r' _ 'k' _ ';', 6, 0,
                          0x2ada _ 0)
...
NAMED_CHARACTER_REFERENCE(
    2058,
     'i' _ 'a' _ 'n' _ 'g' _ 'l' _ 'e' _ 'q' _ ';', 8, 0, 0x225c _ 0)
NAMED_CHARACTER_REFERENCE(
    2059,
...
NAMED_CHARACTER_REFERENCE(2098,
                           't' _ 'r' _ 'i' _ ';', 4, 0, 0x25f8 _ 0)
NAMED_CHARACTER_REFERENCE(2099,
                           'a' _ 'c' _ 'r' _ ';', 4, 0, 0x016b _ 0)
...
NAMED_CHARACTER_REFERENCE(2102,
                           'g' _ 'o' _ 'n' _ ';', 4, 0, 0x0173 _ 0)
NAMED_CHARACTER_REFERENCE(2103,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd66)
...
NAMED_CHARACTER_REFERENCE(2160,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd67)
NAMED_CHARACTER_REFERENCE(2161,
                           'r' _ 'o' _ 'p' _ ';', 4, 0, 0x221d _ 0)
NAMED_CHARACTER_REFERENCE(2162,
                           't' _ 'r' _ 'i' _ ';', 4, 0, 0x22b3 _ 0)
NAMED_CHARACTER_REFERENCE(2163,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdccb)
...
NAMED_CHARACTER_REFERENCE(2192,
                           'd' _ 'o' _ 't' _ ';', 4, 0, 0x2a00 _ 0)
NAMED_CHARACTER_REFERENCE(2193,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd69)
...
NAMED_CHARACTER_REFERENCE(2196,
                           'A' _ 'r' _ 'r' _ ';', 4, 0, 0x27f9 _ 0)
NAMED_CHARACTER_REFERENCE(2197,
                           'a' _ 'r' _ 'r' _ ';', 4, 0, 0x27f6 _ 0)
NAMED_CHARACTER_REFERENCE(2198,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdccd)
...
NAMED_CHARACTER_REFERENCE(2213,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd6a)
NAMED_CHARACTER_REFERENCE(2214,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdcce)
...
NAMED_CHARACTER_REFERENCE(2226,
                           'g' _ 'r' _ 'a' _ 'r' _ 'r' _ ';', 6, 0,
                          0x21dd _ 0)
NAMED_CHARACTER_REFERENCE(2227,
                           'p' _ 'f' _ ';', 3, 0, 0xd835 _ 0xdd6b)
NAMED_CHARACTER_REFERENCE(2228,
                           'c' _ 'r' _ ';', 3, 0, 0xd835 _ 0xdccf)
