...
static int32_t const ATTRIBUTE_HASHES_DATA[] = {
    1872034503, 1748971848, 1972656710, 1681174213, 1786740932, 1917857531,
    2006459190, 1680165421, 1723336432, 1754907227, 1820262641, 1905902311,
    1932959284, 1990107683, 2026893641, 71827457,   1680282148, 1689324870,
    1747295467, 1754606246, 1757053236, 1804069019, 1854302364, 1889633006,
    1910487243, 1922677495, 1941435445, 1983157559, 2001634458, 2010716309,
    ...
    1902640276, 1908316832, 1915757815, 1922413307, 1924517489, 1934970504,
    1965512429, 1972922984, 1984430082, 2000096287, 2001826027, 2008401563,
    2019887833, 2060474743, 2082471938, 53006051,   60345635,   885522434,
    ...
    1884267068, 1894552650, 1905541832, 1906421049, 1910328970, 1910572893,
    1916286197, 1921977416, 1922607670, 1923088386, 1924629705, 1933369607,
    1939976792, 1941550652, 1966442279, 1972904518, 1975062341, 1983398182,
    1988784439, 1991625270, 2000752725, 2001710298, 2004846654, 2007021895,
    2009079867, 2016810187, 2024647008, 2034765641, 2065694722, 2081423362,
    ...
    1905672729, 1906408598, 1907660596, 1909438149, 1910441770, 1910507338,
    1915295948, 1916247343, 1917295176, 1921061206, 1922400908, 1922566877,
    1922665179, 1922679610, 1924443742, 1924583073, 1924773438, 1933123337,
    1934917290, 1937336473, 1941286708, 1941440197, 1943317364, 1966384692,
    1972151670, 1972744954, 1972908839, 1972996699, 1982254612, 1983290011,
    1983432389, 1987422362, 1989522022, 1991220282, 1993343287, 2000160071,
    2001527900, 2001669449, 2001732764, 2001898809, 2005342360, 2006824246,
    2007064819, 2009041198, 2009231684, 2016711994, 2017010843, 2023342821,
    2024794274, 2026975253, 2060302634, 2065170434, 2066743298, 2075005220,
    ...
    1910527802, 1915025672, 1915341049, 1916210285, 1916278099, 1916337499,
    ...
    2024616088, 2024763702, 2026741958};
...
void nsHtml5AttributeName::initializeStatics() {
  ...
  ATTR_REFY = new nsHtml5AttributeName(
      ...
      ALL_NO_PREFIX);
  ATTRIBUTE_NAMES = new nsHtml5AttributeName*[495];
  ATTRIBUTE_NAMES[0] = ATTR_ONCLICK;
  ATTRIBUTE_NAMES[1] = ATTR_DATETIME;
  ATTRIBUTE_NAMES[2] = ATTR_ONDRAG;
  ATTRIBUTE_NAMES[3] = ATTR_CLEAR;
  ATTRIBUTE_NAMES[4] = ATTR_LANG;
  ATTRIBUTE_NAMES[5] = ATTR_FLOOD_COLOR;
  ATTRIBUTE_NAMES[6] = ATTR_ONSTOP;
  ...
  ATTRIBUTE_NAMES[13] = ATTR_PRESERVEASPECTRATIO;
  ...
  ATTRIBUTE_NAMES[24] = ATTR_XMLNS_XLINK;
  ATTRIBUTE_NAMES[25] = ATTR_ONFOCUS;
  ATTRIBUTE_NAMES[26] = ATTR_SCOPE;
  ATTRIBUTE_NAMES[27] = ATTR_COLSPAN;
  ATTRIBUTE_NAMES[28] = ATTR_FONTWEIGHT;
  ATTRIBUTE_NAMES[29] = ATTR_WIDTH;
  ...
  ATTRIBUTE_NAMES[49] = ATTR_TRANSFORM_ORIGIN;
  ATTRIBUTE_NAMES[50] = ATTR_BGCOLOR;
  ATTRIBUTE_NAMES[51] = ATTR_ONMOUSEOVER;
  ATTRIBUTE_NAMES[52] = ATTR_STROKE_DASHOFFSET;
  ATTRIBUTE_NAMES[53] = ATTR_GLYPHREF;
  ATTRIBUTE_NAMES[54] = ATTR_ATTRIBUTENAME;
  ATTRIBUTE_NAMES[55] = ATTR_OVERFLOW;
  ATTRIBUTE_NAMES[56] = ATTR_IS;
  ATTRIBUTE_NAMES[57] = ATTR_CONTENTEDITABLE;
  ATTRIBUTE_NAMES[58] = ATTR_FILTERUNITS;
  ATTRIBUTE_NAMES[59] = ATTR_STITCHTILES;
  ATTRIBUTE_NAMES[60] = ATTR_INPUTMODE;
  ...
  ATTRIBUTE_NAMES[100] = ATTR_XLINK_HREF;
  ATTRIBUTE_NAMES[101] = ATTR_XLINK_ACTUATE;
  ATTRIBUTE_NAMES[102] = ATTR_COLOR;
  ATTRIBUTE_NAMES[103] = ATTR_NOMODULE;
  ATTRIBUTE_NAMES[104] = ATTR_ONCOPY;
  ATTRIBUTE_NAMES[105] = ATTR_TO;
  ATTRIBUTE_NAMES[106] = ATTR_SCROLLING;
  ATTRIBUTE_NAMES[107] = ATTR_DISPLAY;
  ATTRIBUTE_NAMES[108] = ATTR_PROPERTY;
  ATTRIBUTE_NAMES[109] = ATTR_STOP_OPACITY;
  ATTRIBUTE_NAMES[110] = ATTR_CHAROFF;
  ATTRIBUTE_NAMES[111] = ATTR_ONDROP;
  ATTRIBUTE_NAMES[112] = ATTR_START;
  ATTRIBUTE_NAMES[113] = ATTR_CURSOR;
  ATTRIBUTE_NAMES[114] = ATTR_MAXSIZE;
  ATTRIBUTE_NAMES[115] = ATTR_SRCSET;
  ATTRIBUTE_NAMES[116] = ATTR_DEPTH;
  ATTRIBUTE_NAMES[117] = ATTR_FONTFAMILY;
  ATTRIBUTE_NAMES[118] = ATTR_LETTER_SPACING;
  ATTRIBUTE_NAMES[119] = ATTR_PATTERN;
  ATTRIBUTE_NAMES[120] = ATTR_TEXT_ANCHOR;
  ATTRIBUTE_NAMES[121] = ATTR_COLUMNALIGN;
  ATTRIBUTE_NAMES[122] = ATTR_REQUIREDFEATURES;
  ...
  ATTRIBUTE_NAMES[201] = ATTR_VLINK;
  ATTRIBUTE_NAMES[202] = ATTR_XLINK_ROLE;
  ATTRIBUTE_NAMES[203] = ATTR_XLINK_TYPE;
  ATTRIBUTE_NAMES[204] = ATTR_AUTOCOMPLETE;
  ATTRIBUTE_NAMES[205] = ATTR_COLOR_RENDERING;
  ATTRIBUTE_NAMES[206] = ATTR_ENCODING;
  ATTRIBUTE_NAMES[207] = ATTR_LQUOTE;
  ATTRIBUTE_NAMES[208] = ATTR_ONMOUSEWHEEL;
  ATTRIBUTE_NAMES[209] = ATTR_ONCONTEXTMENU;
  ATTRIBUTE_NAMES[210] = ATTR_ONMOUSEMOVE;
  ATTRIBUTE_NAMES[211] = ATTR_ONFOCUSOUT;
  ATTRIBUTE_NAMES[212] = ATTR_STROKE_LINECAP;
  ...
  ATTRIBUTE_NAMES[217] = ATTR_KEYPOINTS;
  ATTRIBUTE_NAMES[218] = ATTR_STEP;
  ATTRIBUTE_NAMES[219] = ATTR_SLOPE;
  ATTRIBUTE_NAMES[220] = ATTR_WRAP;
  ATTRIBUTE_NAMES[221] = ATTR_CHAR;
  ATTRIBUTE_NAMES[222] = ATTR_NOWRAP;
  ATTRIBUTE_NAMES[223] = ATTR_ONDRAGOVER;
  ATTRIBUTE_NAMES[224] = ATTR_ONERROR;
  ATTRIBUTE_NAMES[225] = ATTR_ONDRAGLEAVE;
  ATTRIBUTE_NAMES[226] = ATTR_AXIS;
  ATTRIBUTE_NAMES[227] = ATTR_CROSSORIGIN;
  ATTRIBUTE_NAMES[228] = ATTR_CLOSE;
  ATTRIBUTE_NAMES[229] = ATTR_KEYSPLINES;
  ATTRIBUTE_NAMES[230] = ATTR_OFFSET;
  ATTRIBUTE_NAMES[231] = ATTR_ROWSPACING;
  ATTRIBUTE_NAMES[232] = ATTR_VERSION;
  ATTRIBUTE_NAMES[233] = ATTR_CONTENT;
  ATTRIBUTE_NAMES[234] = ATTR_FONT_STRETCH;
  ATTRIBUTE_NAMES[235] = ATTR_FONTSTYLE;
  ATTRIBUTE_NAMES[236] = ATTR_FONT_VARIANT;
  ATTRIBUTE_NAMES[237] = ATTR_FONT_SIZE;
  ATTRIBUTE_NAMES[238] = ATTR_MULTIPLE;
  ATTRIBUTE_NAMES[239] = ATTR_POSTER;
  ATTRIBUTE_NAMES[240] = ATTR_PATTERNCONTENTUNITS;
  ATTRIBUTE_NAMES[241] = ATTR_TEXT_RENDERING;
  ATTRIBUTE_NAMES[242] = ATTR_TEXT;
  ATTRIBUTE_NAMES[243] = ATTR_COLUMNSPAN;
  ATTRIBUTE_NAMES[244] = ATTR_COLUMNWIDTH;
  ATTRIBUTE_NAMES[245] = ATTR_ONCUT;
  ATTRIBUTE_NAMES[246] = ATTR_REQUIREDEXTENSIONS;
  ...
  ATTRIBUTE_NAMES[403] = ATTR_TRANSFORM;
  ATTRIBUTE_NAMES[404] = ATTR_WHEN;
  ATTRIBUTE_NAMES[405] = ATTR_XLINK_TITLE;
  ATTRIBUTE_NAMES[406] = ATTR_XLINK_ARCROLE;
  ATTRIBUTE_NAMES[407] = ATTR_XMLNS;
  ATTRIBUTE_NAMES[408] = ATTR_XLINK_SHOW;
  ATTRIBUTE_NAMES[409] = ATTR_AUTOPLAY;
  ATTRIBUTE_NAMES[410] = ATTR_AUTOFOCUS;
  ATTRIBUTE_NAMES[411] = ATTR_COLOR_PROFILE;
  ATTRIBUTE_NAMES[412] = ATTR_COLOR_INTERPOLATION;
  ATTRIBUTE_NAMES[413] = ATTR_COLOR_INTERPOLATION_FILTERS;
  ATTRIBUTE_NAMES[414] = ATTR_EXPONENT;
  ATTRIBUTE_NAMES[415] = ATTR_FLOOD_OPACITY;
  ATTRIBUTE_NAMES[416] = ATTR_NUMOCTAVES;
  ATTRIBUTE_NAMES[417] = ATTR_ONLOAD;
  ATTRIBUTE_NAMES[418] = ATTR_ONMOUSEENTER;
  ATTRIBUTE_NAMES[419] = ATTR_ONFOCUSIN;
  ATTRIBUTE_NAMES[420] = ATTR_ONZOOM;
  ATTRIBUTE_NAMES[421] = ATTR_ONMOUSELEAVE;
  ATTRIBUTE_NAMES[422] = ATTR_ONMOUSEUP;
  ATTRIBUTE_NAMES[423] = ATTR_ONMOUSEOUT;
  ATTRIBUTE_NAMES[424] = ATTR_ONMOUSEDOWN;
  ATTRIBUTE_NAMES[425] = ATTR_RQUOTE;
  ...
  ATTRIBUTE_NAMES[435] = ATTR_HTTP_EQUIV;
  ATTRIBUTE_NAMES[436] = ATTR_LOOP;
  ATTRIBUTE_NAMES[437] = ATTR_SCOPED;
  ATTRIBUTE_NAMES[438] = ATTR_SHAPE_RENDERING;
  ATTRIBUTE_NAMES[439] = ATTR_SHAPE;
  ATTRIBUTE_NAMES[440] = ATTR_STOP_COLOR;
  ATTRIBUTE_NAMES[441] = ATTR_TEMPLATE;
  ATTRIBUTE_NAMES[442] = ATTR_ABBR;
  ATTRIBUTE_NAMES[443] = ATTR_ATTRIBUTETYPE;
  ATTRIBUTE_NAMES[444] = ATTR_COORDS;
  ATTRIBUTE_NAMES[445] = ATTR_CHARSET;
  ATTRIBUTE_NAMES[446] = ATTR_NOHREF;
  ATTRIBUTE_NAMES[447] = ATTR_ONDRAGENTER;
  ATTRIBUTE_NAMES[448] = ATTR_ONDRAGEND;
  ATTRIBUTE_NAMES[449] = ATTR_ONDRAGDROP;
  ATTRIBUTE_NAMES[450] = ATTR_OPERATOR;
  ATTRIBUTE_NAMES[451] = ATTR_ONDRAGSTART;
  ATTRIBUTE_NAMES[452] = ATTR_STARTOFFSET;
  ATTRIBUTE_NAMES[453] = ATTR_AS;
  ATTRIBUTE_NAMES[454] = ATTR_BIAS;
  ATTRIBUTE_NAMES[455] = ATTR_CLASSID;
  ATTRIBUTE_NAMES[456] = ATTR_COLS;
  ATTRIBUTE_NAMES[457] = ATTR_CLOSURE;
  ATTRIBUTE_NAMES[458] = ATTR_CLASS;
  ATTRIBUTE_NAMES[459] = ATTR_KEYSYSTEM;
  ATTRIBUTE_NAMES[460] = ATTR_LOWSRC;
  ATTRIBUTE_NAMES[461] = ATTR_MINSIZE;
  ATTRIBUTE_NAMES[462] = ATTR_PRESERVEALPHA;
  ATTRIBUTE_NAMES[463] = ATTR_ROWSPAN;
  ATTRIBUTE_NAMES[464] = ATTR_ROWS;
  ATTRIBUTE_NAMES[465] = ATTR_SUBSCRIPTSHIFT;
  ATTRIBUTE_NAMES[466] = ATTR_ALTTEXT;
  ATTRIBUTE_NAMES[467] = ATTR_CONTROLS;
  ATTRIBUTE_NAMES[468] = ATTR_CONTEXTMENU;
  ATTRIBUTE_NAMES[469] = ATTR_ENCTYPE;
  ATTRIBUTE_NAMES[470] = ATTR_FILTER;
  ATTRIBUTE_NAMES[471] = ATTR_FONT_WEIGHT;
  ATTRIBUTE_NAMES[472] = ATTR_FONT_STYLE;
  ATTRIBUTE_NAMES[473] = ATTR_FONT_FAMILY;
  ATTRIBUTE_NAMES[474] = ATTR_FONT_SIZE_ADJUST;
  ATTRIBUTE_NAMES[475] = ATTR_FONTSIZE;
  ATTRIBUTE_NAMES[476] = ATTR_KEYTIMES;
  ATTRIBUTE_NAMES[477] = ATTR_LIST;
  ATTRIBUTE_NAMES[478] = ATTR_RT;
  ATTRIBUTE_NAMES[479] = ATTR_ONSTART;
  ATTRIBUTE_NAMES[480] = ATTR_PATTERNTRANSFORM;
  ATTRIBUTE_NAMES[481] = ATTR_PATTERNUNITS;
  ATTRIBUTE_NAMES[482] = ATTR_RESTART;
  ATTRIBUTE_NAMES[483] = ATTR_SYSTEMLANGUAGE;
  ATTRIBUTE_NAMES[484] = ATTR_TEXT_DECORATION;
  ATTRIBUTE_NAMES[485] = ATTR_TEXTLENGTH;
  ATTRIBUTE_NAMES[486] = ATTR_WRITING_MODE;
  ATTRIBUTE_NAMES[487] = ATTR_ACCUMULATE;
  ATTRIBUTE_NAMES[488] = ATTR_COLUMNLINES;
  ATTRIBUTE_NAMES[489] = ATTR_COLUMNSPACING;
  ATTRIBUTE_NAMES[490] = ATTR_GROUPALIGN;
  ATTRIBUTE_NAMES[491] = ATTR_ONSUBMIT;
  ATTRIBUTE_NAMES[492] = ATTR_REQUIRED;
  ATTRIBUTE_NAMES[493] = ATTR_RESULT;
  ATTRIBUTE_NAMES[494] = ATTR_VALUES;
}
