...
static int32_t const ATTRIBUTE_HASHES_DATA[] = {
    1864698185, 1748306996, 1965349396, 1681174213, 1780975314, 1915394254,
    2001814704, 1680165421, 1721347639, 1754798923, 1814558026, 1902640276,
    1924462384, 1983461061, 2018908874, 71827457,   1680282148, 1689324870,
    1740096054, 1753297133, 1756737685, 1790814502, 1823841492, 1881750231,
    1908316832, 1922413292, 1934917372, 1972909592, 1999273799, 2008084807,
    ...
    1889633006, 1905902311, 1910487243, 1917327080, 1922671417, 1932870919,
    1941409583, 1972196486, 1982640164, 1990062797, 2001578182, 2005925890,
    2010452700, 2026741958, 2082471938, 53006051,   60345635,   885522434,
    ...
    1874261045, 1884267068, 1894552650, 1905541832, 1906421049, 1910328970,
    1910572893, 1916278099, 1921894426, 1922567078, 1922699851, 1924585254,
    1933145837, 1937777860, 1941454586, 1966439670, 1972863609, 1974849131,
    1983347764, 1988132214, 1991392548, 2000162011, 2001669450, 2004199576,
    2007019632, 2009071951, 2016787611, 2024616088, 2060302634, 2081423362,
    ...
    1898428101, 1903659239, 1905672729, 1906408598, 1907660596, 1909438149,
    1910441770, 1910507338, 1915295948, 1916210285, 1916337499, 1917953597,
    1922319046, 1922470745, 1922665052, 1922679386, 1924206934, 1924570799,
    1924738716, 1932986153, 1933508940, 1935597338, 1941253366, 1941438085,
    1942026440, 1965561677, 1966454567, 1972744939, 1972904522, 1972962123,
    1980235778, 1983266615, 1983416119, 1987410233, 1988788535, 1991021879,
    1991643278, 2000125224, 2001210183, 2001634459, 2001710299, 2001898808,
    2004957380, 2006516551, 2007064812, 2008408414, 2009141482, 2015950026,
    2016910397, 2023146024, 2024763702, 2026975253, 2065170434, 2075005220,
    ...
    1891937366, 1898415413, 1900544002, 1903612236, 1903759600, 1905628916,
    1905754853, 1906408542, 1906419001, 1906423097, 1907701479, 1908462185,
    1909819252, 1910441627, 1910441773, 1910503637, 1910527802, 1915025672,
    1915341049, 1915757815, 1916247343, 1916286197, 1917295176, 1917857531,
    1921061206, 1921977416, 1922400908, 1922413307, 1922566877, 1922607670,
    1922665179, 1922677495, 1922679610, 1923088386, 1924443742, 1924517489,
    1924583073, 1924629705, 1924773438, 1932959284, 1933123337, 1933369607,
    1934917290, 1934970504, 1937336473, 1939976792, 1941286708, 1941435445,
    1941440197, 1941550652, 1943317364, 1965512429, 1966384692, 1966442279,
    1972151670, 1972656710, 1972744954, 1972904518, 1972908839, 1972922984,
    1972996699, 1975062341, 1982254612, 1983157559, 1983290011, 1983398182,
    ...
    2024794274, 2026893641, 2034765641, 2060474743, 2065694722, 2073034754};
...
void nsHtml5AttributeName::initializeStatics() {
  ...
  ATTRIBUTE_NAMES[2] = ATTR_ABBR;
  ATTRIBUTE_NAMES[3] = ATTR_CLEAR;
  ATTRIBUTE_NAMES[4] = ATTR_ALIGNMENT_BASELINE;
  ATTRIBUTE_NAMES[5] = ATTR_AUTOCAPITALIZE;
  ATTRIBUTE_NAMES[6] = ATTR_FONT_SIZE_ADJUST;
  ...
  ATTRIBUTE_NAMES[11] = ATTR_ICON;
  ATTRIBUTE_NAMES[12] = ATTR_STROKE_DASHARRAY;
  ATTRIBUTE_NAMES[13] = ATTR_CLASS;
  ATTRIBUTE_NAMES[14] = ATTR_GROUPALIGN;
  ...
  ATTRIBUTE_NAMES[24] = ATTR_TRANSFORM_ORIGIN;
  ATTRIBUTE_NAMES[25] = ATTR_ONMOUSEENTER;
  ATTRIBUTE_NAMES[26] = ATTR_GLYPH_ORIENTATION_HORIZONTAL;
  ATTRIBUTE_NAMES[27] = ATTR_OPERATOR;
  ATTRIBUTE_NAMES[28] = ATTR_ALTTEXT;
  ATTRIBUTE_NAMES[29] = ATTR_RESTART;
  ...
  ATTRIBUTE_NAMES[49] = ATTR_ONINPUT;
  ATTRIBUTE_NAMES[50] = ATTR_XMLNS_XLINK;
  ATTRIBUTE_NAMES[51] = ATTR_EXPONENT;
  ATTRIBUTE_NAMES[52] = ATTR_ONMOUSEUP;
  ATTRIBUTE_NAMES[53] = ATTR_COMPACT;
  ATTRIBUTE_NAMES[54] = ATTR_SHAPE_RENDERING;
  ATTRIBUTE_NAMES[55] = ATTR_NOHREF;
  ATTRIBUTE_NAMES[56] = ATTR_BIAS;
  ATTRIBUTE_NAMES[57] = ATTR_PRESERVEALPHA;
  ATTRIBUTE_NAMES[58] = ATTR_FILTER;
  ATTRIBUTE_NAMES[59] = ATTR_RT;
  ATTRIBUTE_NAMES[60] = ATTR_WRITING_MODE;
  ATTRIBUTE_NAMES[61] = ATTR_VALUES;
  ...
  ATTRIBUTE_NAMES[99] = ATTR_ONUNLOAD;
  ATTRIBUTE_NAMES[100] = ATTR_POINTSATY;
  ATTRIBUTE_NAMES[101] = ATTR_XLINK_HREF;
  ATTRIBUTE_NAMES[102] = ATTR_XLINK_ACTUATE;
  ATTRIBUTE_NAMES[103] = ATTR_COLOR_INTERPOLATION;
  ATTRIBUTE_NAMES[104] = ATTR_NUMOCTAVES;
  ATTRIBUTE_NAMES[105] = ATTR_ONZOOM;
  ATTRIBUTE_NAMES[106] = ATTR_ONMOUSEDOWN;
  ATTRIBUTE_NAMES[107] = ATTR_STROKE;
  ATTRIBUTE_NAMES[108] = ATTR_CLIPPATHUNITS;
  ATTRIBUTE_NAMES[109] = ATTR_LOOP;
  ATTRIBUTE_NAMES[110] = ATTR_STOP_COLOR;
  ATTRIBUTE_NAMES[111] = ATTR_COORDS;
  ATTRIBUTE_NAMES[112] = ATTR_ONDRAGEND;
  ATTRIBUTE_NAMES[113] = ATTR_STARTOFFSET;
  ATTRIBUTE_NAMES[114] = ATTR_COLS;
  ATTRIBUTE_NAMES[115] = ATTR_LOWSRC;
  ATTRIBUTE_NAMES[116] = ATTR_ROWS;
  ATTRIBUTE_NAMES[117] = ATTR_CONTEXTMENU;
  ATTRIBUTE_NAMES[118] = ATTR_FONT_STYLE;
  ATTRIBUTE_NAMES[119] = ATTR_KEYTIMES;
  ATTRIBUTE_NAMES[120] = ATTR_PATTERNTRANSFORM;
  ATTRIBUTE_NAMES[121] = ATTR_TEXT_DECORATION;
  ATTRIBUTE_NAMES[122] = ATTR_COLUMNLINES;
  ATTRIBUTE_NAMES[123] = ATTR_REQUIRED;
  ...
  ATTRIBUTE_NAMES[199] = ATTR_KERNING;
  ATTRIBUTE_NAMES[200] = ATTR_ONINVALID;
  ATTRIBUTE_NAMES[201] = ATTR_POINTS;
  ATTRIBUTE_NAMES[202] = ATTR_SPAN;
  ATTRIBUTE_NAMES[203] = ATTR_VLINK;
  ATTRIBUTE_NAMES[204] = ATTR_XLINK_ROLE;
  ATTRIBUTE_NAMES[205] = ATTR_XLINK_TYPE;
  ATTRIBUTE_NAMES[206] = ATTR_AUTOCOMPLETE;
  ATTRIBUTE_NAMES[207] = ATTR_COLOR_PROFILE;
  ATTRIBUTE_NAMES[208] = ATTR_COLOR_INTERPOLATION_FILTERS;
  ATTRIBUTE_NAMES[209] = ATTR_FLOOD_OPACITY;
  ATTRIBUTE_NAMES[210] = ATTR_ONLOAD;
  ATTRIBUTE_NAMES[211] = ATTR_ONFOCUSIN;
  ATTRIBUTE_NAMES[212] = ATTR_ONMOUSELEAVE;
  ATTRIBUTE_NAMES[213] = ATTR_ONMOUSEOUT;
  ATTRIBUTE_NAMES[214] = ATTR_RQUOTE;
  ATTRIBUTE_NAMES[215] = ATTR_STROKE_LINEJOIN;
  ATTRIBUTE_NAMES[216] = ATTR_STROKE_WIDTH;
  ATTRIBUTE_NAMES[217] = ATTR_CLIP_RULE;
  ATTRIBUTE_NAMES[218] = ATTR_DISPLAYSTYLE;
  ATTRIBUTE_NAMES[219] = ATTR_HTTP_EQUIV;
  ATTRIBUTE_NAMES[220] = ATTR_SCOPED;
  ATTRIBUTE_NAMES[221] = ATTR_SHAPE;
  ATTRIBUTE_NAMES[222] = ATTR_TEMPLATE;
  ATTRIBUTE_NAMES[223] = ATTR_ATTRIBUTETYPE;
  ATTRIBUTE_NAMES[224] = ATTR_CHARSET;
  ATTRIBUTE_NAMES[225] = ATTR_ONDRAGENTER;
  ATTRIBUTE_NAMES[226] = ATTR_ONDRAGDROP;
  ATTRIBUTE_NAMES[227] = ATTR_ONDRAGSTART;
  ATTRIBUTE_NAMES[228] = ATTR_AS;
  ATTRIBUTE_NAMES[229] = ATTR_CLASSID;
  ATTRIBUTE_NAMES[230] = ATTR_CLOSURE;
  ATTRIBUTE_NAMES[231] = ATTR_KEYSYSTEM;
  ATTRIBUTE_NAMES[232] = ATTR_MINSIZE;
  ATTRIBUTE_NAMES[233] = ATTR_ROWSPAN;
  ATTRIBUTE_NAMES[234] = ATTR_SUBSCRIPTSHIFT;
  ATTRIBUTE_NAMES[235] = ATTR_CONTROLS;
  ATTRIBUTE_NAMES[236] = ATTR_ENCTYPE;
  ATTRIBUTE_NAMES[237] = ATTR_FONT_WEIGHT;
  ATTRIBUTE_NAMES[238] = ATTR_FONT_FAMILY;
  ATTRIBUTE_NAMES[239] = ATTR_FONTSIZE;
  ATTRIBUTE_NAMES[240] = ATTR_LIST;
  ATTRIBUTE_NAMES[241] = ATTR_ONSTART;
  ATTRIBUTE_NAMES[242] = ATTR_PATTERNUNITS;
  ATTRIBUTE_NAMES[243] = ATTR_SYSTEMLANGUAGE;
  ATTRIBUTE_NAMES[244] = ATTR_TEXTLENGTH;
  ATTRIBUTE_NAMES[245] = ATTR_ACCUMULATE;
  ATTRIBUTE_NAMES[246] = ATTR_COLUMNSPACING;
  ATTRIBUTE_NAMES[247] = ATTR_ONSUBMIT;
  ATTRIBUTE_NAMES[248] = ATTR_RESULT;
  ATTRIBUTE_NAMES[249] = ATTR_VALUE;
  ...
  ATTRIBUTE_NAMES[399] = ATTR_KERNELMATRIX;
  ATTRIBUTE_NAMES[400] = ATTR_KERNELUNITLENGTH;
  ATTRIBUTE_NAMES[401] = ATTR_OPEN;
  ATTRIBUTE_NAMES[402] = ATTR_ONEND;
  ATTRIBUTE_NAMES[403] = ATTR_POINTER_EVENTS;
  ATTRIBUTE_NAMES[404] = ATTR_POINTSATX;
  ATTRIBUTE_NAMES[405] = ATTR_POINTSATZ;
  ATTRIBUTE_NAMES[406] = ATTR_STANDBY;
  ATTRIBUTE_NAMES[407] = ATTR_TRANSFORM;
  ATTRIBUTE_NAMES[408] = ATTR_WHEN;
  ATTRIBUTE_NAMES[409] = ATTR_XLINK_TITLE;
  ATTRIBUTE_NAMES[410] = ATTR_XLINK_ARCROLE;
  ATTRIBUTE_NAMES[411] = ATTR_XMLNS;
  ATTRIBUTE_NAMES[412] = ATTR_XLINK_SHOW;
  ATTRIBUTE_NAMES[413] = ATTR_AUTOPLAY;
  ATTRIBUTE_NAMES[414] = ATTR_AUTOFOCUS;
  ATTRIBUTE_NAMES[415] = ATTR_BGCOLOR;
  ATTRIBUTE_NAMES[416] = ATTR_COLOR_RENDERING;
  ATTRIBUTE_NAMES[417] = ATTR_COLOR;
  ATTRIBUTE_NAMES[418] = ATTR_ENCODING;
  ATTRIBUTE_NAMES[419] = ATTR_FLOOD_COLOR;
  ATTRIBUTE_NAMES[420] = ATTR_LQUOTE;
  ATTRIBUTE_NAMES[421] = ATTR_NOMODULE;
  ATTRIBUTE_NAMES[422] = ATTR_ONMOUSEWHEEL;
  ATTRIBUTE_NAMES[423] = ATTR_ONMOUSEOVER;
  ATTRIBUTE_NAMES[424] = ATTR_ONCONTEXTMENU;
  ATTRIBUTE_NAMES[425] = ATTR_ONCOPY;
  ATTRIBUTE_NAMES[426] = ATTR_ONMOUSEMOVE;
  ATTRIBUTE_NAMES[427] = ATTR_ONFOCUS;
  ATTRIBUTE_NAMES[428] = ATTR_ONFOCUSOUT;
  ATTRIBUTE_NAMES[429] = ATTR_TO;
  ATTRIBUTE_NAMES[430] = ATTR_STROKE_LINECAP;
  ATTRIBUTE_NAMES[431] = ATTR_STROKE_DASHOFFSET;
  ATTRIBUTE_NAMES[432] = ATTR_STROKE_MITERLIMIT;
  ATTRIBUTE_NAMES[433] = ATTR_SCROLLING;
  ATTRIBUTE_NAMES[434] = ATTR_STROKE_OPACITY;
  ATTRIBUTE_NAMES[435] = ATTR_CLIP;
  ATTRIBUTE_NAMES[436] = ATTR_CLIP_PATH;
  ATTRIBUTE_NAMES[437] = ATTR_DISPLAY;
  ATTRIBUTE_NAMES[438] = ATTR_GLYPH_ORIENTATION_VERTICAL;
  ATTRIBUTE_NAMES[439] = ATTR_GLYPHREF;
  ATTRIBUTE_NAMES[440] = ATTR_KEYPOINTS;
  ATTRIBUTE_NAMES[441] = ATTR_PROPERTY;
  ATTRIBUTE_NAMES[442] = ATTR_STEP;
  ATTRIBUTE_NAMES[443] = ATTR_SCOPE;
  ATTRIBUTE_NAMES[444] = ATTR_SLOPE;
  ATTRIBUTE_NAMES[445] = ATTR_STOP_OPACITY;
  ATTRIBUTE_NAMES[446] = ATTR_WRAP;
  ATTRIBUTE_NAMES[447] = ATTR_ATTRIBUTENAME;
  ATTRIBUTE_NAMES[448] = ATTR_CHAR;
  ATTRIBUTE_NAMES[449] = ATTR_CHAROFF;
  ATTRIBUTE_NAMES[450] = ATTR_NOWRAP;
  ATTRIBUTE_NAMES[451] = ATTR_ONDRAG;
  ATTRIBUTE_NAMES[452] = ATTR_ONDRAGOVER;
  ATTRIBUTE_NAMES[453] = ATTR_ONDROP;
  ATTRIBUTE_NAMES[454] = ATTR_ONERROR;
  ATTRIBUTE_NAMES[455] = ATTR_OVERFLOW;
  ATTRIBUTE_NAMES[456] = ATTR_ONDRAGLEAVE;
  ATTRIBUTE_NAMES[457] = ATTR_START;
  ATTRIBUTE_NAMES[458] = ATTR_AXIS;
  ATTRIBUTE_NAMES[459] = ATTR_COLSPAN;
  ATTRIBUTE_NAMES[460] = ATTR_CROSSORIGIN;
  ATTRIBUTE_NAMES[461] = ATTR_CURSOR;
  ATTRIBUTE_NAMES[462] = ATTR_CLOSE;
  ATTRIBUTE_NAMES[463] = ATTR_IS;
  ATTRIBUTE_NAMES[464] = ATTR_KEYSPLINES;
  ATTRIBUTE_NAMES[465] = ATTR_MAXSIZE;
  ATTRIBUTE_NAMES[466] = ATTR_OFFSET;
  ATTRIBUTE_NAMES[467] = ATTR_PRESERVEASPECTRATIO;
  ATTRIBUTE_NAMES[468] = ATTR_ROWSPACING;
  ATTRIBUTE_NAMES[469] = ATTR_SRCSET;
  ATTRIBUTE_NAMES[470] = ATTR_VERSION;
  ATTRIBUTE_NAMES[471] = ATTR_CONTENTEDITABLE;
  ATTRIBUTE_NAMES[472] = ATTR_CONTENT;
  ATTRIBUTE_NAMES[473] = ATTR_DEPTH;
  ATTRIBUTE_NAMES[474] = ATTR_FONT_STRETCH;
  ATTRIBUTE_NAMES[475] = ATTR_FONTWEIGHT;
  ATTRIBUTE_NAMES[476] = ATTR_FONTSTYLE;
  ATTRIBUTE_NAMES[477] = ATTR_FONTFAMILY;
  ATTRIBUTE_NAMES[478] = ATTR_FONT_VARIANT;
  ATTRIBUTE_NAMES[479] = ATTR_FILTERUNITS;
  ATTRIBUTE_NAMES[480] = ATTR_FONT_SIZE;
  ATTRIBUTE_NAMES[481] = ATTR_LETTER_SPACING;
  ATTRIBUTE_NAMES[482] = ATTR_MULTIPLE;
  ATTRIBUTE_NAMES[483] = ATTR_ONSTOP;
  ATTRIBUTE_NAMES[484] = ATTR_POSTER;
  ATTRIBUTE_NAMES[485] = ATTR_PATTERN;
  ATTRIBUTE_NAMES[486] = ATTR_PATTERNCONTENTUNITS;
  ATTRIBUTE_NAMES[487] = ATTR_STITCHTILES;
  ATTRIBUTE_NAMES[488] = ATTR_TEXT_RENDERING;
  ATTRIBUTE_NAMES[489] = ATTR_TEXT_ANCHOR;
  ATTRIBUTE_NAMES[490] = ATTR_TEXT;
  ATTRIBUTE_NAMES[491] = ATTR_WIDTH;
  ATTRIBUTE_NAMES[492] = ATTR_COLUMNSPAN;
  ATTRIBUTE_NAMES[493] = ATTR_COLUMNALIGN;
  ATTRIBUTE_NAMES[494] = ATTR_COLUMNWIDTH;
  ATTRIBUTE_NAMES[495] = ATTR_INPUTMODE;
  ATTRIBUTE_NAMES[496] = ATTR_ONCUT;
  ATTRIBUTE_NAMES[497] = ATTR_REQUIREDFEATURES;
  ATTRIBUTE_NAMES[498] = ATTR_REQUIREDEXTENSIONS;
  ATTRIBUTE_NAMES[499] = ATTR_VALUETYPE;
