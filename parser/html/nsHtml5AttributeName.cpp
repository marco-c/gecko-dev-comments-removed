...
void nsHtml5AttributeName::initializeStatics() {
  ...
  ATTR_DATA_ID = new nsHtml5AttributeName(ALL_NO_NS, nsGkAtoms::data_id,
                                          nsGkAtoms::data_id,
                                          nsGkAtoms::data_id, ALL_NO_PREFIX);
  ATTR_DATA_PRIORITY = new nsHtml5AttributeName(
      ALL_NO_NS, nsGkAtoms::data_priority, nsGkAtoms::data_priority,
      nsGkAtoms::data_priority, ALL_NO_PREFIX);
  ATTR_CLASS =
  ...
  ATTRIBUTE_NAMES[12] = ATTR_RQUOTE;
  ATTRIBUTE_NAMES[13] = ATTR_CLOSURE;
  ...
  ATTRIBUTE_NAMES[25] = ATTR_ONLOAD;
  ATTRIBUTE_NAMES[26] = ATTR_DISPLAYSTYLE;
  ATTRIBUTE_NAMES[27] = ATTR_ONDRAGDROP;
  ATTRIBUTE_NAMES[28] = ATTR_VERSION;
  ATTRIBUTE_NAMES[29] = ATTR_PATTERNCONTENTUNITS;
  ATTRIBUTE_NAMES[30] = ATTR_FX;
  ...
  ATTRIBUTE_NAMES[51] = ATTR_COLOR_INTERPOLATION_FILTERS;
  ATTRIBUTE_NAMES[52] = ATTR_ONMOUSELEAVE;
  ATTRIBUTE_NAMES[53] = ATTR_STROKE_WIDTH;
  ATTRIBUTE_NAMES[54] = ATTR_SCOPED;
  ATTRIBUTE_NAMES[55] = ATTR_CHARSET;
  ATTRIBUTE_NAMES[56] = ATTR_AS;
  ...
  ATTRIBUTE_NAMES[77] = ATTR_SHADOWROOTCUSTOMELEMENTREGISTRY;
  ...
  ATTRIBUTE_NAMES[103] = ATTR_COLOR_PROFILE;
  ATTRIBUTE_NAMES[104] = ATTR_FLOOD_OPACITY;
  ATTRIBUTE_NAMES[105] = ATTR_ONFOCUSIN;
  ATTRIBUTE_NAMES[106] = ATTR_ONMOUSEOUT;
  ATTRIBUTE_NAMES[107] = ATTR_STROKE_LINEJOIN;
  ATTRIBUTE_NAMES[108] = ATTR_CLIP_RULE;
  ATTRIBUTE_NAMES[109] = ATTR_HTTP_EQUIV;
  ATTRIBUTE_NAMES[110] = ATTR_SHAPE;
  ATTRIBUTE_NAMES[111] = ATTR_ATTRIBUTETYPE;
  ATTRIBUTE_NAMES[112] = ATTR_ONDRAGENTER;
  ATTRIBUTE_NAMES[113] = ATTR_ONDRAGSTART;
  ATTRIBUTE_NAMES[114] = ATTR_CLASSID;
  ...
  ATTRIBUTE_NAMES[124] = ATTR_VIEWTARGET;
  ...
  ATTRIBUTE_NAMES[149] = ATTR_FENCE;
  ...
  ATTRIBUTE_NAMES[154] = ATTR_SHADOWROOTCLONABLE;
  ...
  ATTRIBUTE_NAMES[207] = ATTR_AUTOCAPITALIZE;
  ATTRIBUTE_NAMES[208] = ATTR_COLOR_INTERPOLATION;
  ATTRIBUTE_NAMES[209] = ATTR_EXPONENT;
  ATTRIBUTE_NAMES[210] = ATTR_NUMOCTAVES;
  ATTRIBUTE_NAMES[211] = ATTR_ONMOUSEENTER;
  ATTRIBUTE_NAMES[212] = ATTR_ONZOOM;
  ATTRIBUTE_NAMES[213] = ATTR_ONMOUSEUP;
  ATTRIBUTE_NAMES[214] = ATTR_ONMOUSEDOWN;
  ATTRIBUTE_NAMES[215] = ATTR_STROKE_DASHARRAY;
  ATTRIBUTE_NAMES[216] = ATTR_STROKE;
  ATTRIBUTE_NAMES[217] = ATTR_COMPACT;
  ATTRIBUTE_NAMES[218] = ATTR_CLIPPATHUNITS;
  ATTRIBUTE_NAMES[219] = ATTR_GLYPH_ORIENTATION_HORIZONTAL;
  ATTRIBUTE_NAMES[220] = ATTR_LOOP;
  ATTRIBUTE_NAMES[221] = ATTR_SHAPE_RENDERING;
  ATTRIBUTE_NAMES[222] = ATTR_STOP_COLOR;
  ATTRIBUTE_NAMES[223] = ATTR_ABBR;
  ATTRIBUTE_NAMES[224] = ATTR_COORDS;
  ATTRIBUTE_NAMES[225] = ATTR_NOHREF;
  ATTRIBUTE_NAMES[226] = ATTR_ONDRAGEND;
  ATTRIBUTE_NAMES[227] = ATTR_OPERATOR;
  ATTRIBUTE_NAMES[228] = ATTR_STARTOFFSET;
  ATTRIBUTE_NAMES[229] = ATTR_BIAS;
  ATTRIBUTE_NAMES[230] = ATTR_COLS;
  ...
  ATTRIBUTE_NAMES[300] = ATTR_FETCHPRIORITY;
  ...
  ATTRIBUTE_NAMES[308] = ATTR_SHADOWROOTMODE;
  ATTRIBUTE_NAMES[309] = ATTR_SHADOWROOTREFERENCETARGET;
  ATTRIBUTE_NAMES[310] = ATTR_SHADOWROOTSERIALIZABLE;
  ATTRIBUTE_NAMES[311] = ATTR_SHADOWROOTSLOTASSIGNMENT;
  ...
  ATTRIBUTE_NAMES[414] = ATTR_AUTOCORRECT;
  ATTRIBUTE_NAMES[415] = ATTR_AUTOFOCUS;
  ATTRIBUTE_NAMES[416] = ATTR_BGCOLOR;
  ATTRIBUTE_NAMES[417] = ATTR_COLOR_RENDERING;
  ATTRIBUTE_NAMES[418] = ATTR_COLOR;
  ATTRIBUTE_NAMES[419] = ATTR_ENCODING;
  ATTRIBUTE_NAMES[420] = ATTR_FLOOD_COLOR;
  ATTRIBUTE_NAMES[421] = ATTR_LQUOTE;
  ATTRIBUTE_NAMES[422] = ATTR_NOMODULE;
  ATTRIBUTE_NAMES[423] = ATTR_ONMOUSEWHEEL;
  ATTRIBUTE_NAMES[424] = ATTR_ONMOUSEOVER;
  ATTRIBUTE_NAMES[425] = ATTR_ONCONTEXTMENU;
  ATTRIBUTE_NAMES[426] = ATTR_ONCOPY;
  ATTRIBUTE_NAMES[427] = ATTR_ONMOUSEMOVE;
  ATTRIBUTE_NAMES[428] = ATTR_ONFOCUS;
  ATTRIBUTE_NAMES[429] = ATTR_ONFOCUSOUT;
  ATTRIBUTE_NAMES[430] = ATTR_TO;
  ATTRIBUTE_NAMES[431] = ATTR_STROKE_LINECAP;
  ATTRIBUTE_NAMES[432] = ATTR_STROKE_DASHOFFSET;
  ATTRIBUTE_NAMES[433] = ATTR_STROKE_MITERLIMIT;
  ATTRIBUTE_NAMES[434] = ATTR_SCROLLING;
  ATTRIBUTE_NAMES[435] = ATTR_STROKE_OPACITY;
  ATTRIBUTE_NAMES[436] = ATTR_CLIP;
  ATTRIBUTE_NAMES[437] = ATTR_CLIP_PATH;
  ATTRIBUTE_NAMES[438] = ATTR_DISPLAY;
  ATTRIBUTE_NAMES[439] = ATTR_GLYPH_ORIENTATION_VERTICAL;
  ATTRIBUTE_NAMES[440] = ATTR_GLYPHREF;
  ATTRIBUTE_NAMES[441] = ATTR_KEYPOINTS;
  ATTRIBUTE_NAMES[442] = ATTR_PROPERTY;
  ATTRIBUTE_NAMES[443] = ATTR_STEP;
  ATTRIBUTE_NAMES[444] = ATTR_SCOPE;
  ATTRIBUTE_NAMES[445] = ATTR_SLOPE;
  ATTRIBUTE_NAMES[446] = ATTR_STOP_OPACITY;
  ATTRIBUTE_NAMES[447] = ATTR_WRAP;
  ATTRIBUTE_NAMES[448] = ATTR_ATTRIBUTENAME;
  ATTRIBUTE_NAMES[449] = ATTR_CHAR;
  ATTRIBUTE_NAMES[450] = ATTR_CHAROFF;
  ATTRIBUTE_NAMES[451] = ATTR_NOWRAP;
  ATTRIBUTE_NAMES[452] = ATTR_ONDRAG;
  ATTRIBUTE_NAMES[453] = ATTR_ONDRAGOVER;
  ATTRIBUTE_NAMES[454] = ATTR_ONDROP;
  ATTRIBUTE_NAMES[455] = ATTR_ONERROR;
  ATTRIBUTE_NAMES[456] = ATTR_OVERFLOW;
  ATTRIBUTE_NAMES[457] = ATTR_ONDRAGLEAVE;
  ATTRIBUTE_NAMES[458] = ATTR_START;
  ATTRIBUTE_NAMES[459] = ATTR_AXIS;
  ATTRIBUTE_NAMES[460] = ATTR_COLSPAN;
  ATTRIBUTE_NAMES[461] = ATTR_CROSSORIGIN;
  ATTRIBUTE_NAMES[462] = ATTR_CURSOR;
  ATTRIBUTE_NAMES[463] = ATTR_CLOSE;
  ...
  ATTRIBUTE_NAMES[500] = ATTR_ELEVATION;
  ATTRIBUTE_NAMES[501] = ATTR_VIEWBOX;
  ATTRIBUTE_NAMES[502] = ATTR_DX;
  ATTRIBUTE_NAMES[503] = ATTR_RX;
}
