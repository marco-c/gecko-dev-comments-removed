...
static int32_t const ATTRIBUTE_HASHES_DATA[] = {
    1867462756, 1748971848, 1966454567, 1681174213, 1785053243, 1916337499,
    2004957380, 1680165421, 1723336432, 1754899031, 1816104145, 1905628916,
    1924738716, 1988788535, 2024763702, 71827457,   1680282148, 1689324870,
    1747295467, 1754579720, 1756889417, 1803561214, 1848600826, 1884295780,
    1910441627, 1922665052, 1941253366, 1980235778, 2001210183, 2009141482,
    ...
    1898415413, 1906423097, 1915025672, 1922319046, 1924206934, 1933508940,
    1942026440, 1972904522, 1983416119, 1991643278, 2001710299, 2007064812,
    2016910397, 2060474743, 2082471938, 53006051,   60345635,   885522434,
    ...
    1916210285, 1917953597, 1922470745, 1922679386, 1924570799, 1932986153,
    1935597338, 1941438085, 1965561677, 1972744939, 1972962123, 1983266615,
    1987410233, 1991021879, 2000125224, 2001634459, 2001898808, 2006516551,
    2008408414, 2015950026, 2023146024, 2026975253, 2065694722, 2081423362,
    ...
    1910527802, 1915341049, 1916278099, 1917327080, 1921894426, 1922413292,
    1922567078, 1922671417, 1922699851, 1924462384, 1924585254, 1932870919,
    1933145837, 1934917372, 1937777860, 1941409583, 1941454586, 1965349396,
    1966439670, 1972196486, 1972863609, 1972909592, 1974849131, 1982640164,
    1983347764, 1983461061, 1988132214, 1990062797, 1991392548, 1999273799,
    2000162011, 2001578182, 2001669450, 2001814704, 2004199576, 2005925890,
    2007019632, 2008084807, 2009071951, 2010452700, 2016787611, 2018908874,
    2024616088, 2026741958, 2060302634, 2065170434, 2066743298, 2075005220,
    ...
    1910487243, 1910507338, 1910572893, 1915295948, 1915757815, 1916247343,
...
void nsHtml5AttributeName::initializeStatics() {
  ...
  ATTR_REFY = new nsHtml5AttributeName(
      ...
      ALL_NO_PREFIX);
  ATTRIBUTE_NAMES = new nsHtml5AttributeName*[498];
  ATTRIBUTE_NAMES[0] = ATTR_FILL;
  ATTRIBUTE_NAMES[1] = ATTR_DATETIME;
  ATTRIBUTE_NAMES[2] = ATTR_CHARSET;
  ATTRIBUTE_NAMES[3] = ATTR_CLEAR;
  ATTRIBUTE_NAMES[4] = ATTR_IMAGESRCSET;
  ATTRIBUTE_NAMES[5] = ATTR_COLOR_INTERPOLATION_FILTERS;
  ATTRIBUTE_NAMES[6] = ATTR_LIST;
  ...
  ATTRIBUTE_NAMES[12] = ATTR_STROKE_WIDTH;
  ATTRIBUTE_NAMES[13] = ATTR_MINSIZE;
  ATTRIBUTE_NAMES[14] = ATTR_RESULT;
  ...
  ATTRIBUTE_NAMES[25] = ATTR_ONMOUSELEAVE;
  ATTRIBUTE_NAMES[26] = ATTR_SCOPED;
  ATTRIBUTE_NAMES[27] = ATTR_AS;
  ATTRIBUTE_NAMES[28] = ATTR_ENCTYPE;
  ATTRIBUTE_NAMES[29] = ATTR_TEXTLENGTH;
  ...
  ATTRIBUTE_NAMES[51] = ATTR_ONLOAD;
  ATTRIBUTE_NAMES[52] = ATTR_RQUOTE;
  ATTRIBUTE_NAMES[53] = ATTR_DISPLAYSTYLE;
  ATTRIBUTE_NAMES[54] = ATTR_TEMPLATE;
  ATTRIBUTE_NAMES[55] = ATTR_ONDRAGDROP;
  ATTRIBUTE_NAMES[56] = ATTR_CLOSURE;
  ATTRIBUTE_NAMES[57] = ATTR_SUBSCRIPTSHIFT;
  ATTRIBUTE_NAMES[58] = ATTR_FONT_FAMILY;
  ATTRIBUTE_NAMES[59] = ATTR_PATTERNUNITS;
  ATTRIBUTE_NAMES[60] = ATTR_COLUMNSPACING;
  ...
  ATTRIBUTE_NAMES[102] = ATTR_COLOR_PROFILE;
  ATTRIBUTE_NAMES[103] = ATTR_FLOOD_OPACITY;
  ATTRIBUTE_NAMES[104] = ATTR_ONFOCUSIN;
  ATTRIBUTE_NAMES[105] = ATTR_ONMOUSEOUT;
  ATTRIBUTE_NAMES[106] = ATTR_STROKE_LINEJOIN;
  ATTRIBUTE_NAMES[107] = ATTR_CLIP_RULE;
  ATTRIBUTE_NAMES[108] = ATTR_HTTP_EQUIV;
  ATTRIBUTE_NAMES[109] = ATTR_SHAPE;
  ATTRIBUTE_NAMES[110] = ATTR_ATTRIBUTETYPE;
  ATTRIBUTE_NAMES[111] = ATTR_ONDRAGENTER;
  ATTRIBUTE_NAMES[112] = ATTR_ONDRAGSTART;
  ATTRIBUTE_NAMES[113] = ATTR_CLASSID;
  ATTRIBUTE_NAMES[114] = ATTR_KEYSYSTEM;
  ATTRIBUTE_NAMES[115] = ATTR_ROWSPAN;
  ATTRIBUTE_NAMES[116] = ATTR_CONTROLS;
  ATTRIBUTE_NAMES[117] = ATTR_FONT_WEIGHT;
  ATTRIBUTE_NAMES[118] = ATTR_FONTSIZE;
  ATTRIBUTE_NAMES[119] = ATTR_ONSTART;
  ATTRIBUTE_NAMES[120] = ATTR_SYSTEMLANGUAGE;
  ATTRIBUTE_NAMES[121] = ATTR_ACCUMULATE;
  ATTRIBUTE_NAMES[122] = ATTR_ONSUBMIT;
  ATTRIBUTE_NAMES[123] = ATTR_VALUE;
  ...
  ATTRIBUTE_NAMES[206] = ATTR_COLOR_INTERPOLATION;
  ATTRIBUTE_NAMES[207] = ATTR_EXPONENT;
  ATTRIBUTE_NAMES[208] = ATTR_NUMOCTAVES;
  ATTRIBUTE_NAMES[209] = ATTR_ONMOUSEENTER;
  ATTRIBUTE_NAMES[210] = ATTR_ONZOOM;
  ATTRIBUTE_NAMES[211] = ATTR_ONMOUSEUP;
  ATTRIBUTE_NAMES[212] = ATTR_ONMOUSEDOWN;
  ATTRIBUTE_NAMES[213] = ATTR_STROKE_DASHARRAY;
  ATTRIBUTE_NAMES[214] = ATTR_STROKE;
  ATTRIBUTE_NAMES[215] = ATTR_COMPACT;
  ATTRIBUTE_NAMES[216] = ATTR_CLIPPATHUNITS;
  ATTRIBUTE_NAMES[217] = ATTR_GLYPH_ORIENTATION_HORIZONTAL;
  ATTRIBUTE_NAMES[218] = ATTR_LOOP;
  ATTRIBUTE_NAMES[219] = ATTR_SHAPE_RENDERING;
  ATTRIBUTE_NAMES[220] = ATTR_STOP_COLOR;
  ATTRIBUTE_NAMES[221] = ATTR_ABBR;
  ATTRIBUTE_NAMES[222] = ATTR_COORDS;
  ATTRIBUTE_NAMES[223] = ATTR_NOHREF;
  ATTRIBUTE_NAMES[224] = ATTR_ONDRAGEND;
  ATTRIBUTE_NAMES[225] = ATTR_OPERATOR;
  ATTRIBUTE_NAMES[226] = ATTR_STARTOFFSET;
  ATTRIBUTE_NAMES[227] = ATTR_BIAS;
  ATTRIBUTE_NAMES[228] = ATTR_COLS;
  ATTRIBUTE_NAMES[229] = ATTR_CLASS;
  ATTRIBUTE_NAMES[230] = ATTR_LOWSRC;
  ATTRIBUTE_NAMES[231] = ATTR_PRESERVEALPHA;
  ATTRIBUTE_NAMES[232] = ATTR_ROWS;
  ATTRIBUTE_NAMES[233] = ATTR_ALTTEXT;
  ATTRIBUTE_NAMES[234] = ATTR_CONTEXTMENU;
  ATTRIBUTE_NAMES[235] = ATTR_FILTER;
  ATTRIBUTE_NAMES[236] = ATTR_FONT_STYLE;
  ATTRIBUTE_NAMES[237] = ATTR_FONT_SIZE_ADJUST;
  ATTRIBUTE_NAMES[238] = ATTR_KEYTIMES;
  ATTRIBUTE_NAMES[239] = ATTR_RT;
  ATTRIBUTE_NAMES[240] = ATTR_PATTERNTRANSFORM;
  ATTRIBUTE_NAMES[241] = ATTR_RESTART;
  ATTRIBUTE_NAMES[242] = ATTR_TEXT_DECORATION;
  ATTRIBUTE_NAMES[243] = ATTR_WRITING_MODE;
  ATTRIBUTE_NAMES[244] = ATTR_COLUMNLINES;
  ATTRIBUTE_NAMES[245] = ATTR_GROUPALIGN;
  ATTRIBUTE_NAMES[246] = ATTR_REQUIRED;
  ATTRIBUTE_NAMES[247] = ATTR_VALUES;
  ...
  ATTRIBUTE_NAMES[412] = ATTR_BGCOLOR;
  ATTRIBUTE_NAMES[413] = ATTR_COLOR_RENDERING;
  ATTRIBUTE_NAMES[414] = ATTR_COLOR;
  ATTRIBUTE_NAMES[415] = ATTR_ENCODING;
  ATTRIBUTE_NAMES[416] = ATTR_FLOOD_COLOR;
  ATTRIBUTE_NAMES[417] = ATTR_LQUOTE;
  ATTRIBUTE_NAMES[418] = ATTR_NOMODULE;
  ATTRIBUTE_NAMES[419] = ATTR_ONMOUSEWHEEL;
  ATTRIBUTE_NAMES[420] = ATTR_ONMOUSEOVER;
  ATTRIBUTE_NAMES[421] = ATTR_ONCONTEXTMENU;
  ATTRIBUTE_NAMES[422] = ATTR_ONCOPY;
  ATTRIBUTE_NAMES[423] = ATTR_ONMOUSEMOVE;
  ATTRIBUTE_NAMES[424] = ATTR_ONFOCUS;
  ATTRIBUTE_NAMES[425] = ATTR_ONFOCUSOUT;
  ATTRIBUTE_NAMES[426] = ATTR_TO;
  ATTRIBUTE_NAMES[427] = ATTR_STROKE_LINECAP;
  ATTRIBUTE_NAMES[428] = ATTR_STROKE_DASHOFFSET;
  ATTRIBUTE_NAMES[429] = ATTR_STROKE_MITERLIMIT;
  ATTRIBUTE_NAMES[430] = ATTR_SCROLLING;
  ATTRIBUTE_NAMES[431] = ATTR_STROKE_OPACITY;
  ATTRIBUTE_NAMES[432] = ATTR_CLIP;
  ATTRIBUTE_NAMES[433] = ATTR_CLIP_PATH;
  ATTRIBUTE_NAMES[434] = ATTR_DISPLAY;
  ATTRIBUTE_NAMES[435] = ATTR_GLYPH_ORIENTATION_VERTICAL;
  ATTRIBUTE_NAMES[436] = ATTR_GLYPHREF;
  ATTRIBUTE_NAMES[437] = ATTR_KEYPOINTS;
  ATTRIBUTE_NAMES[438] = ATTR_PROPERTY;
  ATTRIBUTE_NAMES[439] = ATTR_STEP;
  ATTRIBUTE_NAMES[440] = ATTR_SCOPE;
  ATTRIBUTE_NAMES[441] = ATTR_SLOPE;
  ATTRIBUTE_NAMES[442] = ATTR_STOP_OPACITY;
  ATTRIBUTE_NAMES[443] = ATTR_WRAP;
  ATTRIBUTE_NAMES[444] = ATTR_ATTRIBUTENAME;
  ATTRIBUTE_NAMES[445] = ATTR_CHAR;
  ATTRIBUTE_NAMES[446] = ATTR_CHAROFF;
  ATTRIBUTE_NAMES[447] = ATTR_NOWRAP;
  ATTRIBUTE_NAMES[448] = ATTR_ONDRAG;
  ATTRIBUTE_NAMES[449] = ATTR_ONDRAGOVER;
  ATTRIBUTE_NAMES[450] = ATTR_ONDROP;
  ATTRIBUTE_NAMES[451] = ATTR_ONERROR;
  ATTRIBUTE_NAMES[452] = ATTR_OVERFLOW;
  ATTRIBUTE_NAMES[453] = ATTR_ONDRAGLEAVE;
  ATTRIBUTE_NAMES[454] = ATTR_START;
  ATTRIBUTE_NAMES[455] = ATTR_AXIS;
  ATTRIBUTE_NAMES[456] = ATTR_COLSPAN;
  ATTRIBUTE_NAMES[457] = ATTR_CROSSORIGIN;
  ATTRIBUTE_NAMES[458] = ATTR_CURSOR;
  ATTRIBUTE_NAMES[459] = ATTR_CLOSE;
  ATTRIBUTE_NAMES[460] = ATTR_IS;
  ATTRIBUTE_NAMES[461] = ATTR_KEYSPLINES;
  ATTRIBUTE_NAMES[462] = ATTR_MAXSIZE;
  ATTRIBUTE_NAMES[463] = ATTR_OFFSET;
  ATTRIBUTE_NAMES[464] = ATTR_PRESERVEASPECTRATIO;
  ATTRIBUTE_NAMES[465] = ATTR_ROWSPACING;
  ATTRIBUTE_NAMES[466] = ATTR_SRCSET;
  ATTRIBUTE_NAMES[467] = ATTR_VERSION;
  ATTRIBUTE_NAMES[468] = ATTR_CONTENTEDITABLE;
  ATTRIBUTE_NAMES[469] = ATTR_CONTENT;
  ATTRIBUTE_NAMES[470] = ATTR_DEPTH;
  ATTRIBUTE_NAMES[471] = ATTR_FONT_STRETCH;
  ATTRIBUTE_NAMES[472] = ATTR_FONTWEIGHT;
  ATTRIBUTE_NAMES[473] = ATTR_FONTSTYLE;
  ATTRIBUTE_NAMES[474] = ATTR_FONTFAMILY;
  ATTRIBUTE_NAMES[475] = ATTR_FONT_VARIANT;
  ATTRIBUTE_NAMES[476] = ATTR_FILTERUNITS;
  ATTRIBUTE_NAMES[477] = ATTR_FONT_SIZE;
  ATTRIBUTE_NAMES[478] = ATTR_LETTER_SPACING;
  ATTRIBUTE_NAMES[479] = ATTR_MULTIPLE;
  ATTRIBUTE_NAMES[480] = ATTR_ONSTOP;
  ATTRIBUTE_NAMES[481] = ATTR_POSTER;
  ATTRIBUTE_NAMES[482] = ATTR_PATTERN;
  ATTRIBUTE_NAMES[483] = ATTR_PATTERNCONTENTUNITS;
  ATTRIBUTE_NAMES[484] = ATTR_STITCHTILES;
  ATTRIBUTE_NAMES[485] = ATTR_TEXT_RENDERING;
  ATTRIBUTE_NAMES[486] = ATTR_TEXT_ANCHOR;
  ATTRIBUTE_NAMES[487] = ATTR_TEXT;
  ATTRIBUTE_NAMES[488] = ATTR_WIDTH;
  ATTRIBUTE_NAMES[489] = ATTR_COLUMNSPAN;
  ATTRIBUTE_NAMES[490] = ATTR_COLUMNALIGN;
  ATTRIBUTE_NAMES[491] = ATTR_COLUMNWIDTH;
  ATTRIBUTE_NAMES[492] = ATTR_INPUTMODE;
  ATTRIBUTE_NAMES[493] = ATTR_ONCUT;
  ATTRIBUTE_NAMES[494] = ATTR_REQUIREDFEATURES;
  ATTRIBUTE_NAMES[495] = ATTR_REQUIREDEXTENSIONS;
  ATTRIBUTE_NAMES[496] = ATTR_VALUETYPE;
  ATTRIBUTE_NAMES[497] = ATTR_ELEVATION;
}
