...
static int32_t const ATTRIBUTE_HASHES_DATA[] = {
    1867620412, 1748971848, 1972151670, 1681174213, 1785174319, 1917295176,
    2005342360, 1680165421, 1723336432, 1754907227, 1816144023, 1905672729,
    1924773438, 1989522022, 2024794274, 71827457,   1680282148, 1689324870,
    1747295467, 1754606246, 1757053236, 1804036350, 1853862084, 1884343396,
    1910441770, 1922665179, 1941286708, 1982254612, 2001527900, 2009231684,
    2073034754, 57205395,   911736834,  1680181996, 1680368221, 1685882101,
    1704526375, 1736416327, 1747906667, 1752985897, 1754792749, 1756471625,
    1776114564, 1788254870, 1805715716, 1823580230, 1854497003, 1874698443,
    1898428101, 1907660596, 1915295948, 1922400908, 1924443742, 1934917290,
    1943317364, 1972908839, 1983432389, 1993343287, 2001732764, 2007064819,
    2017010843, 2060474743, 2082471938, 53006051,   60345635,   885522434,
    ...
    1756804936, 1767875272, 1782518297, 1786821704, 1791070327, 1804235064,
    1814656326, 1820928104, 1824377064, 1854464212, 1865910347, 1873590471,
    1884142379, 1891186903, 1903659239, 1906408598, 1909438149, 1910507338,
    1916247343, 1921061206, 1922566877, 1922679610, 1924583073, 1933123337,
    1937336473, 1941440197, 1966384692, 1972744954, 1972996699, 1983290011,
    1987422362, 1991220282, 2000160071, 2001669449, 2001898809, 2006824246,
    2009041198, 2016711994, 2023342821, 2034765641, 2065694722, 2081423362,
    ...
    1785051290, 1786740932, 1787193500, 1790814502, 1801312388, 1804069019,
    1804978712, 1814558026, 1814986837, 1820262641, 1822002839, 1823841492,
    1825677514, 1854302364, 1854474395, 1864698185, 1867448617, 1872034503,
    1874261045, 1881750231, 1884267068, 1889633006, 1894552650, 1902640276,
    1905541832, 1905902311, 1906421049, 1908316832, 1910328970, 1910487243,
    1910572893, 1915757815, 1916286197, 1917857531, 1921977416, 1922413307,
    1922607670, 1922677495, 1923088386, 1924517489, 1924629705, 1932959284,
    1933369607, 1934970504, 1939976792, 1941435445, 1941550652, 1965512429,
    1966442279, 1972656710, 1972904518, 1972922984, 1975062341, 1983157559,
    1983398182, 1984430082, 1988784439, 1990107683, 1991625270, 2000096287,
    2000752725, 2001634458, 2001710298, 2001826027, 2004846654, 2006459190,
    2007021895, 2008401563, 2009079867, 2010716309, 2016810187, 2019887833,
    2024647008, 2026893641, 2060302634, 2065170434, 2066743298, 2075005220,
    ...
    1781007934, 1784574102, 1785053243, 1786622296, 1786775671, 1786851500,
    1787365531, 1788842244, 1791068279, 1797886599, 1803561214, 1804054854,
    1804081401, 1804405895, 1805715690, 1814517574, 1814560070, 1814656840,
    1816104145, 1816178925, 1820727381, 1821958888, 1823574314, 1823829083,
    1824159037, 1825437894, 1848600826, 1854285018, 1854366938, 1854466380,
    1854497001, 1854497008, 1865910331, 1866496199, 1867462756, 1871251689,
    1872343590, 1873656984, 1874270021, 1874788501, 1884079398, 1884246821,
    1884295780, 1889569526, 1890996553, 1891937366, 1898415413, 1900544002,
    1903612236, 1903759600, 1905628916, 1905754853, 1906408542, 1906419001,
    1906423097, 1907701479, 1908462185, 1909819252, 1910441627, 1910441773,
    1910503637, 1910527802, 1915025672, 1915341049, 1916210285, 1916278099,
    ...
    2023146024, 2024616088, 2024763702, 2026741958, 2026975253};
...
void nsHtml5AttributeName::initializeStatics() {
  ...
  ATTR_REFY = new nsHtml5AttributeName(
      ...
      ALL_NO_PREFIX);
  ATTRIBUTE_NAMES = new nsHtml5AttributeName*[497];
  ATTRIBUTE_NAMES[0] = ATTR_FILL_OPACITY;
  ATTRIBUTE_NAMES[1] = ATTR_DATETIME;
  ATTRIBUTE_NAMES[2] = ATTR_NOWRAP;
  ATTRIBUTE_NAMES[3] = ATTR_CLEAR;
  ATTRIBUTE_NAMES[4] = ATTR_IMAGE_RENDERING;
  ATTRIBUTE_NAMES[5] = ATTR_ENCODING;
  ATTRIBUTE_NAMES[6] = ATTR_MULTIPLE;
  ATTRIBUTE_NAMES[7] = ATTR_ARIA_DISABLED;
  ATTRIBUTE_NAMES[8] = ATTR_SPECULAREXPONENT;
  ATTRIBUTE_NAMES[9] = ATTR_ONBEFORECUT;
  ATTRIBUTE_NAMES[10] = ATTR_DIVISOR;
  ATTRIBUTE_NAMES[11] = ATTR_ONINVALID;
  ATTRIBUTE_NAMES[12] = ATTR_STROKE_OPACITY;
  ATTRIBUTE_NAMES[13] = ATTR_OFFSET;
  ATTRIBUTE_NAMES[14] = ATTR_REQUIREDEXTENSIONS;
  ...
  ATTRIBUTE_NAMES[21] = ATTR_MATHBACKGROUND;
  ATTRIBUTE_NAMES[22] = ATTR_LINK;
  ATTRIBUTE_NAMES[23] = ATTR_FORM;
  ATTRIBUTE_NAMES[24] = ATTR_XLINK_ROLE;
  ATTRIBUTE_NAMES[25] = ATTR_ONMOUSEMOVE;
  ATTRIBUTE_NAMES[26] = ATTR_STEP;
  ATTRIBUTE_NAMES[27] = ATTR_AXIS;
  ATTRIBUTE_NAMES[28] = ATTR_FONT_STRETCH;
  ATTRIBUTE_NAMES[29] = ATTR_TEXT;
  ...
  ATTRIBUTE_NAMES[43] = ATTR_ORIGIN;
  ATTRIBUTE_NAMES[44] = ATTR_PATH;
  ATTRIBUTE_NAMES[45] = ATTR_RADIUS;
  ATTRIBUTE_NAMES[46] = ATTR_MARKERUNITS;
  ATTRIBUTE_NAMES[47] = ATTR_TABLEVALUES;
  ATTRIBUTE_NAMES[48] = ATTR_ALINK;
  ATTRIBUTE_NAMES[49] = ATTR_SPAN;
  ATTRIBUTE_NAMES[50] = ATTR_AUTOCOMPLETE;
  ATTRIBUTE_NAMES[51] = ATTR_ONMOUSEWHEEL;
  ATTRIBUTE_NAMES[52] = ATTR_STROKE_LINECAP;
  ATTRIBUTE_NAMES[53] = ATTR_GLYPH_ORIENTATION_VERTICAL;
  ATTRIBUTE_NAMES[54] = ATTR_WRAP;
  ATTRIBUTE_NAMES[55] = ATTR_ONERROR;
  ATTRIBUTE_NAMES[56] = ATTR_CLOSE;
  ATTRIBUTE_NAMES[57] = ATTR_VERSION;
  ATTRIBUTE_NAMES[58] = ATTR_FONT_VARIANT;
  ATTRIBUTE_NAMES[59] = ATTR_PATTERNCONTENTUNITS;
  ATTRIBUTE_NAMES[60] = ATTR_COLUMNWIDTH;
  ...
  ATTRIBUTE_NAMES[87] = ATTR_LONGDESC;
  ATTRIBUTE_NAMES[88] = ATTR_TARGETY;
  ATTRIBUTE_NAMES[89] = ATTR_MATHSIZE;
  ATTRIBUTE_NAMES[90] = ATTR_ACTIVE;
  ATTRIBUTE_NAMES[91] = ATTR_MANIFEST;
  ATTRIBUTE_NAMES[92] = ATTR_TABINDEX;
  ATTRIBUTE_NAMES[93] = ATTR_MASK;
  ATTRIBUTE_NAMES[94] = ATTR_CELLPADDING;
  ATTRIBUTE_NAMES[95] = ATTR_REPLACE;
  ATTRIBUTE_NAMES[96] = ATTR_FRAMEBORDER;
  ATTRIBUTE_NAMES[97] = ATTR_SUMMARY;
  ATTRIBUTE_NAMES[98] = ATTR_KERNING;
  ATTRIBUTE_NAMES[99] = ATTR_POINTS;
  ATTRIBUTE_NAMES[100] = ATTR_VLINK;
  ATTRIBUTE_NAMES[101] = ATTR_XLINK_TYPE;
  ATTRIBUTE_NAMES[102] = ATTR_COLOR_RENDERING;
  ATTRIBUTE_NAMES[103] = ATTR_LQUOTE;
  ATTRIBUTE_NAMES[104] = ATTR_ONCONTEXTMENU;
  ATTRIBUTE_NAMES[105] = ATTR_ONFOCUSOUT;
  ATTRIBUTE_NAMES[106] = ATTR_STROKE_MITERLIMIT;
  ATTRIBUTE_NAMES[107] = ATTR_CLIP_PATH;
  ATTRIBUTE_NAMES[108] = ATTR_KEYPOINTS;
  ATTRIBUTE_NAMES[109] = ATTR_SLOPE;
  ATTRIBUTE_NAMES[110] = ATTR_CHAR;
  ATTRIBUTE_NAMES[111] = ATTR_ONDRAGOVER;
  ATTRIBUTE_NAMES[112] = ATTR_ONDRAGLEAVE;
  ATTRIBUTE_NAMES[113] = ATTR_CROSSORIGIN;
  ATTRIBUTE_NAMES[114] = ATTR_KEYSPLINES;
  ATTRIBUTE_NAMES[115] = ATTR_ROWSPACING;
  ATTRIBUTE_NAMES[116] = ATTR_CONTENT;
  ATTRIBUTE_NAMES[117] = ATTR_FONTSTYLE;
  ATTRIBUTE_NAMES[118] = ATTR_FONT_SIZE;
  ATTRIBUTE_NAMES[119] = ATTR_POSTER;
  ATTRIBUTE_NAMES[120] = ATTR_TEXT_RENDERING;
  ATTRIBUTE_NAMES[121] = ATTR_COLUMNSPAN;
  ATTRIBUTE_NAMES[122] = ATTR_ONCUT;
  ...
  ATTRIBUTE_NAMES[174] = ATTR_IMAGESIZES;
  ATTRIBUTE_NAMES[175] = ATTR_LANG;
  ATTRIBUTE_NAMES[176] = ATTR_MARGINHEIGHT;
  ATTRIBUTE_NAMES[177] = ATTR_TARGET;
  ATTRIBUTE_NAMES[178] = ATTR_HIGH;
  ATTRIBUTE_NAMES[179] = ATTR_MATHVARIANT;
  ATTRIBUTE_NAMES[180] = ATTR_ONCHANGE;
  ATTRIBUTE_NAMES[181] = ATTR_ACTIONTYPE;
  ATTRIBUTE_NAMES[182] = ATTR_BEGIN;
  ATTRIBUTE_NAMES[183] = ATTR_LIMITINGCONEANGLE;
  ATTRIBUTE_NAMES[184] = ATTR_OPTIMUM;
  ATTRIBUTE_NAMES[185] = ATTR_SCRIPTSIZEMULTIPLIER;
  ATTRIBUTE_NAMES[186] = ATTR_VISIBILITY;
  ATTRIBUTE_NAMES[187] = ATTR_MARKERHEIGHT;
  ATTRIBUTE_NAMES[188] = ATTR_MARKERWIDTH;
  ATTRIBUTE_NAMES[189] = ATTR_AMPLITUDE;
  ATTRIBUTE_NAMES[190] = ATTR_FILL_RULE;
  ATTRIBUTE_NAMES[191] = ATTR_ONCLICK;
  ATTRIBUTE_NAMES[192] = ATTR_SCALE;
  ATTRIBUTE_NAMES[193] = ATTR_AZIMUTH;
  ATTRIBUTE_NAMES[194] = ATTR_FRAMESPACING;
  ATTRIBUTE_NAMES[195] = ATTR_PRIMITIVEUNITS;
  ATTRIBUTE_NAMES[196] = ATTR_ZOOMANDPAN;
  ATTRIBUTE_NAMES[197] = ATTR_ICON;
  ATTRIBUTE_NAMES[198] = ATTR_ONUNLOAD;
  ATTRIBUTE_NAMES[199] = ATTR_ONINPUT;
  ATTRIBUTE_NAMES[200] = ATTR_POINTSATY;
  ATTRIBUTE_NAMES[201] = ATTR_TRANSFORM_ORIGIN;
  ATTRIBUTE_NAMES[202] = ATTR_XLINK_HREF;
  ATTRIBUTE_NAMES[203] = ATTR_XMLNS_XLINK;
  ATTRIBUTE_NAMES[204] = ATTR_XLINK_ACTUATE;
  ATTRIBUTE_NAMES[205] = ATTR_BGCOLOR;
  ATTRIBUTE_NAMES[206] = ATTR_COLOR;
  ATTRIBUTE_NAMES[207] = ATTR_FLOOD_COLOR;
  ATTRIBUTE_NAMES[208] = ATTR_NOMODULE;
  ATTRIBUTE_NAMES[209] = ATTR_ONMOUSEOVER;
  ATTRIBUTE_NAMES[210] = ATTR_ONCOPY;
  ATTRIBUTE_NAMES[211] = ATTR_ONFOCUS;
  ATTRIBUTE_NAMES[212] = ATTR_TO;
  ATTRIBUTE_NAMES[213] = ATTR_STROKE_DASHOFFSET;
  ATTRIBUTE_NAMES[214] = ATTR_SCROLLING;
  ATTRIBUTE_NAMES[215] = ATTR_CLIP;
  ATTRIBUTE_NAMES[216] = ATTR_DISPLAY;
  ATTRIBUTE_NAMES[217] = ATTR_GLYPHREF;
  ATTRIBUTE_NAMES[218] = ATTR_PROPERTY;
  ATTRIBUTE_NAMES[219] = ATTR_SCOPE;
  ATTRIBUTE_NAMES[220] = ATTR_STOP_OPACITY;
  ATTRIBUTE_NAMES[221] = ATTR_ATTRIBUTENAME;
  ATTRIBUTE_NAMES[222] = ATTR_CHAROFF;
  ATTRIBUTE_NAMES[223] = ATTR_ONDRAG;
  ATTRIBUTE_NAMES[224] = ATTR_ONDROP;
  ATTRIBUTE_NAMES[225] = ATTR_OVERFLOW;
  ATTRIBUTE_NAMES[226] = ATTR_START;
  ATTRIBUTE_NAMES[227] = ATTR_COLSPAN;
  ATTRIBUTE_NAMES[228] = ATTR_CURSOR;
  ATTRIBUTE_NAMES[229] = ATTR_IS;
  ATTRIBUTE_NAMES[230] = ATTR_MAXSIZE;
  ATTRIBUTE_NAMES[231] = ATTR_PRESERVEASPECTRATIO;
  ATTRIBUTE_NAMES[232] = ATTR_SRCSET;
  ATTRIBUTE_NAMES[233] = ATTR_CONTENTEDITABLE;
  ATTRIBUTE_NAMES[234] = ATTR_DEPTH;
  ATTRIBUTE_NAMES[235] = ATTR_FONTWEIGHT;
  ATTRIBUTE_NAMES[236] = ATTR_FONTFAMILY;
  ATTRIBUTE_NAMES[237] = ATTR_FILTERUNITS;
  ATTRIBUTE_NAMES[238] = ATTR_LETTER_SPACING;
  ATTRIBUTE_NAMES[239] = ATTR_ONSTOP;
  ATTRIBUTE_NAMES[240] = ATTR_PATTERN;
  ATTRIBUTE_NAMES[241] = ATTR_STITCHTILES;
  ATTRIBUTE_NAMES[242] = ATTR_TEXT_ANCHOR;
  ATTRIBUTE_NAMES[243] = ATTR_WIDTH;
  ATTRIBUTE_NAMES[244] = ATTR_COLUMNALIGN;
  ATTRIBUTE_NAMES[245] = ATTR_INPUTMODE;
  ATTRIBUTE_NAMES[246] = ATTR_REQUIREDFEATURES;
  ATTRIBUTE_NAMES[247] = ATTR_VALUETYPE;
  ...
  ATTRIBUTE_NAMES[350] = ATTR_IMAGESRCSET;
  ATTRIBUTE_NAMES[351] = ATTR_LANGUAGE;
  ATTRIBUTE_NAMES[352] = ATTR_LARGEOP;
  ATTRIBUTE_NAMES[353] = ATTR_LENGTHADJUST;
  ATTRIBUTE_NAMES[354] = ATTR_MARGINWIDTH;
  ATTRIBUTE_NAMES[355] = ATTR_PING;
  ATTRIBUTE_NAMES[356] = ATTR_TARGETX;
  ATTRIBUTE_NAMES[357] = ATTR_ARCHIVE;
  ATTRIBUTE_NAMES[358] = ATTR_LIGHTING_COLOR;
  ATTRIBUTE_NAMES[359] = ATTR_METHOD;
  ATTRIBUTE_NAMES[360] = ATTR_MATHCOLOR;
  ATTRIBUTE_NAMES[361] = ATTR_NOSHADE;
  ATTRIBUTE_NAMES[362] = ATTR_PATHLENGTH;
  ATTRIBUTE_NAMES[363] = ATTR_ALTIMG;
  ATTRIBUTE_NAMES[364] = ATTR_ACTION;
  ATTRIBUTE_NAMES[365] = ATTR_ADDITIVE;
  ATTRIBUTE_NAMES[366] = ATTR_DOMINANT_BASELINE;
  ATTRIBUTE_NAMES[367] = ATTR_DEFINITIONURL;
  ATTRIBUTE_NAMES[368] = ATTR_MEDIA;
  ATTRIBUTE_NAMES[369] = ATTR_ONFINISH;
  ATTRIBUTE_NAMES[370] = ATTR_RADIOGROUP;
  ATTRIBUTE_NAMES[371] = ATTR_SCRIPTLEVEL;
  ATTRIBUTE_NAMES[372] = ATTR_SCRIPTMINSIZE;
  ATTRIBUTE_NAMES[373] = ATTR_VALIGN;
  ATTRIBUTE_NAMES[374] = ATTR_BACKGROUND;
  ATTRIBUTE_NAMES[375] = ATTR_MARKER_MID;
  ATTRIBUTE_NAMES[376] = ATTR_MARKER_END;
  ATTRIBUTE_NAMES[377] = ATTR_MARKER_START;
  ATTRIBUTE_NAMES[378] = ATTR_MASKUNITS;
  ATTRIBUTE_NAMES[379] = ATTR_MASKCONTENTUNITS;
  ATTRIBUTE_NAMES[380] = ATTR_CELLSPACING;
  ATTRIBUTE_NAMES[381] = ATTR_DECLARE;
  ATTRIBUTE_NAMES[382] = ATTR_FILL;
  ATTRIBUTE_NAMES[383] = ATTR_MAXLENGTH;
  ATTRIBUTE_NAMES[384] = ATTR_ONBLUR;
  ATTRIBUTE_NAMES[385] = ATTR_ROWLINES;
  ATTRIBUTE_NAMES[386] = ATTR_STYLE;
  ATTRIBUTE_NAMES[387] = ATTR_TITLE;
  ATTRIBUTE_NAMES[388] = ATTR_FORMAT;
  ATTRIBUTE_NAMES[389] = ATTR_FRAME;
  ATTRIBUTE_NAMES[390] = ATTR_FROM;
  ATTRIBUTE_NAMES[391] = ATTR_PROMPT;
  ATTRIBUTE_NAMES[392] = ATTR_SYMMETRIC;
  ATTRIBUTE_NAMES[393] = ATTR_USEMAP;
  ATTRIBUTE_NAMES[394] = ATTR_ASYNC;
  ATTRIBUTE_NAMES[395] = ATTR_IN;
  ATTRIBUTE_NAMES[396] = ATTR_KERNELMATRIX;
  ATTRIBUTE_NAMES[397] = ATTR_KERNELUNITLENGTH;
  ATTRIBUTE_NAMES[398] = ATTR_OPEN;
  ATTRIBUTE_NAMES[399] = ATTR_ONEND;
  ATTRIBUTE_NAMES[400] = ATTR_POINTER_EVENTS;
  ATTRIBUTE_NAMES[401] = ATTR_POINTSATX;
  ATTRIBUTE_NAMES[402] = ATTR_POINTSATZ;
  ATTRIBUTE_NAMES[403] = ATTR_STANDBY;
  ATTRIBUTE_NAMES[404] = ATTR_TRANSFORM;
  ATTRIBUTE_NAMES[405] = ATTR_WHEN;
  ATTRIBUTE_NAMES[406] = ATTR_XLINK_TITLE;
  ATTRIBUTE_NAMES[407] = ATTR_XLINK_ARCROLE;
  ATTRIBUTE_NAMES[408] = ATTR_XMLNS;
  ATTRIBUTE_NAMES[409] = ATTR_XLINK_SHOW;
  ATTRIBUTE_NAMES[410] = ATTR_AUTOPLAY;
  ATTRIBUTE_NAMES[411] = ATTR_AUTOFOCUS;
  ATTRIBUTE_NAMES[412] = ATTR_COLOR_PROFILE;
  ATTRIBUTE_NAMES[413] = ATTR_COLOR_INTERPOLATION;
  ATTRIBUTE_NAMES[414] = ATTR_COLOR_INTERPOLATION_FILTERS;
  ATTRIBUTE_NAMES[415] = ATTR_EXPONENT;
  ATTRIBUTE_NAMES[416] = ATTR_FLOOD_OPACITY;
  ATTRIBUTE_NAMES[417] = ATTR_NUMOCTAVES;
  ATTRIBUTE_NAMES[418] = ATTR_ONLOAD;
  ATTRIBUTE_NAMES[419] = ATTR_ONMOUSEENTER;
  ATTRIBUTE_NAMES[420] = ATTR_ONFOCUSIN;
  ATTRIBUTE_NAMES[421] = ATTR_ONZOOM;
  ATTRIBUTE_NAMES[422] = ATTR_ONMOUSELEAVE;
  ATTRIBUTE_NAMES[423] = ATTR_ONMOUSEUP;
  ATTRIBUTE_NAMES[424] = ATTR_ONMOUSEOUT;
  ATTRIBUTE_NAMES[425] = ATTR_ONMOUSEDOWN;
  ATTRIBUTE_NAMES[426] = ATTR_RQUOTE;
  ATTRIBUTE_NAMES[427] = ATTR_STROKE_DASHARRAY;
  ATTRIBUTE_NAMES[428] = ATTR_STROKE_LINEJOIN;
  ATTRIBUTE_NAMES[429] = ATTR_STROKE;
  ATTRIBUTE_NAMES[430] = ATTR_STROKE_WIDTH;
  ATTRIBUTE_NAMES[431] = ATTR_COMPACT;
  ATTRIBUTE_NAMES[432] = ATTR_CLIP_RULE;
  ATTRIBUTE_NAMES[433] = ATTR_CLIPPATHUNITS;
  ATTRIBUTE_NAMES[434] = ATTR_DISPLAYSTYLE;
  ATTRIBUTE_NAMES[435] = ATTR_GLYPH_ORIENTATION_HORIZONTAL;
  ATTRIBUTE_NAMES[436] = ATTR_HTTP_EQUIV;
  ATTRIBUTE_NAMES[437] = ATTR_LOOP;
  ATTRIBUTE_NAMES[438] = ATTR_SCOPED;
  ATTRIBUTE_NAMES[439] = ATTR_SHAPE_RENDERING;
  ATTRIBUTE_NAMES[440] = ATTR_SHAPE;
  ATTRIBUTE_NAMES[441] = ATTR_STOP_COLOR;
  ATTRIBUTE_NAMES[442] = ATTR_TEMPLATE;
  ATTRIBUTE_NAMES[443] = ATTR_ABBR;
  ATTRIBUTE_NAMES[444] = ATTR_ATTRIBUTETYPE;
  ATTRIBUTE_NAMES[445] = ATTR_COORDS;
  ATTRIBUTE_NAMES[446] = ATTR_CHARSET;
  ATTRIBUTE_NAMES[447] = ATTR_NOHREF;
  ATTRIBUTE_NAMES[448] = ATTR_ONDRAGENTER;
  ATTRIBUTE_NAMES[449] = ATTR_ONDRAGEND;
  ATTRIBUTE_NAMES[450] = ATTR_ONDRAGDROP;
  ATTRIBUTE_NAMES[451] = ATTR_OPERATOR;
  ATTRIBUTE_NAMES[452] = ATTR_ONDRAGSTART;
  ATTRIBUTE_NAMES[453] = ATTR_STARTOFFSET;
  ATTRIBUTE_NAMES[454] = ATTR_AS;
  ATTRIBUTE_NAMES[455] = ATTR_BIAS;
  ATTRIBUTE_NAMES[456] = ATTR_CLASSID;
  ATTRIBUTE_NAMES[457] = ATTR_COLS;
  ATTRIBUTE_NAMES[458] = ATTR_CLOSURE;
  ATTRIBUTE_NAMES[459] = ATTR_CLASS;
  ATTRIBUTE_NAMES[460] = ATTR_KEYSYSTEM;
  ATTRIBUTE_NAMES[461] = ATTR_LOWSRC;
  ATTRIBUTE_NAMES[462] = ATTR_MINSIZE;
  ATTRIBUTE_NAMES[463] = ATTR_PRESERVEALPHA;
  ATTRIBUTE_NAMES[464] = ATTR_ROWSPAN;
  ATTRIBUTE_NAMES[465] = ATTR_ROWS;
  ATTRIBUTE_NAMES[466] = ATTR_SUBSCRIPTSHIFT;
  ATTRIBUTE_NAMES[467] = ATTR_ALTTEXT;
  ATTRIBUTE_NAMES[468] = ATTR_CONTROLS;
  ATTRIBUTE_NAMES[469] = ATTR_CONTEXTMENU;
  ATTRIBUTE_NAMES[470] = ATTR_ENCTYPE;
  ATTRIBUTE_NAMES[471] = ATTR_FILTER;
  ATTRIBUTE_NAMES[472] = ATTR_FONT_WEIGHT;
  ATTRIBUTE_NAMES[473] = ATTR_FONT_STYLE;
  ATTRIBUTE_NAMES[474] = ATTR_FONT_FAMILY;
  ATTRIBUTE_NAMES[475] = ATTR_FONT_SIZE_ADJUST;
  ATTRIBUTE_NAMES[476] = ATTR_FONTSIZE;
  ATTRIBUTE_NAMES[477] = ATTR_KEYTIMES;
  ATTRIBUTE_NAMES[478] = ATTR_LIST;
  ATTRIBUTE_NAMES[479] = ATTR_RT;
  ATTRIBUTE_NAMES[480] = ATTR_ONSTART;
  ATTRIBUTE_NAMES[481] = ATTR_PATTERNTRANSFORM;
  ATTRIBUTE_NAMES[482] = ATTR_PATTERNUNITS;
  ATTRIBUTE_NAMES[483] = ATTR_RESTART;
  ATTRIBUTE_NAMES[484] = ATTR_SYSTEMLANGUAGE;
  ATTRIBUTE_NAMES[485] = ATTR_TEXT_DECORATION;
  ATTRIBUTE_NAMES[486] = ATTR_TEXTLENGTH;
  ATTRIBUTE_NAMES[487] = ATTR_WRITING_MODE;
  ATTRIBUTE_NAMES[488] = ATTR_ACCUMULATE;
  ATTRIBUTE_NAMES[489] = ATTR_COLUMNLINES;
  ATTRIBUTE_NAMES[490] = ATTR_COLUMNSPACING;
  ATTRIBUTE_NAMES[491] = ATTR_GROUPALIGN;
  ATTRIBUTE_NAMES[492] = ATTR_ONSUBMIT;
  ATTRIBUTE_NAMES[493] = ATTR_REQUIRED;
  ATTRIBUTE_NAMES[494] = ATTR_RESULT;
  ATTRIBUTE_NAMES[495] = ATTR_VALUES;
  ATTRIBUTE_NAMES[496] = ATTR_VALUE;
}
