...
static int32_t const ATTRIBUTE_HASHES_DATA[] = {
    1872343590, 1749027145, 1972744954, 1681174213, 1786775671, 1921061206,
    2006824246, 1680165421, 1723336432, 1754927689, 1820727381, 1906408542,
    1933123337, 1991220282, 2026893641, 71827457,   1680282148, 1689324870,
    1747299630, 1754612424, 1757421892, 1804081401, 1854366938, 1890996553,
    1910507338, 1922679610, 1941440197, 1983290011, 2001669449, 2016711994,
    2073034754, 57205395,   911736834,  1680181996, 1680368221, 1685882101,
    1704526375, 1739561208, 1747939528, 1753049109, 1754794646, 1756704824,
    1780879045, 1791068279, 1814560070, 1824159037, 1865910331, 1884079398,
    1903612236, 1909438149, 1916247343, 1922566877, 1924583073, 1937336473,
    1966384692, 1972996699, 1987422362, 2000160071, 2001898809, 2009041198,
    ...
    1687620127, 1692408896, 1721189160, 1733874289, 1740119884, 1747792072,
    1748552744, 1751507685, 1754434872, 1754647074, 1754860061, 1756219733,
    1756836998, 1771569964, 1784574102, 1787365531, 1803561214, 1805715690,
    1816104145, 1823574314, 1848600826, 1854497001, 1867462756, 1874270021,
    1884295780, 1898415413, 1905628916, 1906423097, 1910441770, 1915295948,
    1917295176, 1922400908, 1922665179, 1924443742, 1924773438, 1934917290,
    1941286708, 1943317364, 1972151670, 1972908839, 1982254612, 1983432389,
    ...
    1721347639, 1731048742, 1734182982, 1739927860, 1742183484, 1747446838,
    1747839118, 1748306996, 1748869205, 1749399124, 1751755561, 1753550036,
    1754579720, 1754644293, 1754698327, 1754835516, 1754899031, 1756147974,
    1756360955, 1756762256, 1756889417, 1767725700, 1773606972, 1781007934,
    1786622296, 1786851500, 1788842244, 1797886599, 1804054854, 1804405895,
    1814517574, 1814656840, 1816178925, 1821958888, 1823829083, 1825437894,
    1854285018, 1854466380, 1854497008, 1866496199, 1871251689, 1873656984,
    1874788501, 1884246821, 1889569526, 1891937366, 1900544002, 1903759600,
    1905754853, 1906419001, 1907701479, 1910328970, 1910487243, 1910572893,
    1915757815, 1916286197, 1917857531, 1921977416, 1922413307, 1922607670,
    ...
    1972656710, 1972904518, 1972922984, 1975062341, 1983157559, 1983398182,
    ...
    1734404167, 1739583824, 1740096054, 1740130375, 1747295467, 1747309881,
    1747479606, 1747800157, 1747906667, 1748021284, 1748503880, 1748566068,
    1748971848, 1749350104, 1749856356, 1751679545, 1752985897, 1753297133,
    1754214628, 1754546894, 1754606246, 1754643237, 1754645079, 1754647353,
    1754792749, 1754798923, 1754858317, 1754872618, 1754907227, 1754958648,
    1756190926, 1756302628, 1756471625, 1756737685, 1756804936, 1756874572,
    1757053236, 1765800271, 1767875272, 1772032615, 1776114564, 1780975314,
    1782518297, 1785174319, 1786740932, 1786821704, 1787193500, 1788254870,
    ...
    1889633006, 1891186903, 1894552650, 1898428101, 1902640276, 1903659239,
    ...
    1915025672, 1915341049, 1916210285, 1916278099, 1916337499, 1917327080,
...
void nsHtml5AttributeName::initializeStatics() {
  ...
  ATTRIBUTE_NAMES[0] = ATTR_ONBLUR;
  ATTRIBUTE_NAMES[1] = ATTR_DIRECTION;
  ATTRIBUTE_NAMES[2] = ATTR_ONDRAGOVER;
  ATTRIBUTE_NAMES[3] = ATTR_CLEAR;
  ATTRIBUTE_NAMES[4] = ATTR_LARGEOP;
  ATTRIBUTE_NAMES[5] = ATTR_LQUOTE;
  ATTRIBUTE_NAMES[6] = ATTR_POSTER;
  ATTRIBUTE_NAMES[7] = ATTR_ARIA_DISABLED;
  ATTRIBUTE_NAMES[8] = ATTR_SPECULAREXPONENT;
  ATTRIBUTE_NAMES[9] = ATTR_ONKEYDOWN;
  ATTRIBUTE_NAMES[10] = ATTR_MEDIA;
  ATTRIBUTE_NAMES[11] = ATTR_POINTER_EVENTS;
  ...
  ATTRIBUTE_NAMES[18] = ATTR_ACCEPT_CHARSET;
  ATTRIBUTE_NAMES[19] = ATTR_ONSELECT;
  ATTRIBUTE_NAMES[20] = ATTR_TYPE;
  ATTRIBUTE_NAMES[21] = ATTR_MATHCOLOR;
  ATTRIBUTE_NAMES[22] = ATTR_MARKER_END;
  ATTRIBUTE_NAMES[23] = ATTR_SYMMETRIC;
  ATTRIBUTE_NAMES[24] = ATTR_XLINK_TYPE;
  ...
  ATTRIBUTE_NAMES[37] = ATTR_READONLY;
  ATTRIBUTE_NAMES[38] = ATTR_BASELINE;
  ATTRIBUTE_NAMES[39] = ATTR_LABEL;
  ATTRIBUTE_NAMES[40] = ATTR_ORIENT;
  ATTRIBUTE_NAMES[41] = ATTR_SELECTED;
  ATTRIBUTE_NAMES[42] = ATTR_ALIGN;
  ATTRIBUTE_NAMES[43] = ATTR_TARGETX;
  ATTRIBUTE_NAMES[44] = ATTR_ACTION;
  ATTRIBUTE_NAMES[45] = ATTR_SCRIPTMINSIZE;
  ATTRIBUTE_NAMES[46] = ATTR_CELLSPACING;
  ATTRIBUTE_NAMES[47] = ATTR_FORMAT;
  ATTRIBUTE_NAMES[48] = ATTR_KERNELMATRIX;
  ATTRIBUTE_NAMES[49] = ATTR_VLINK;
  ATTRIBUTE_NAMES[50] = ATTR_COLOR_RENDERING;
  ...
  ATTRIBUTE_NAMES[76] = ATTR_STDDEVIATION;
  ATTRIBUTE_NAMES[77] = ATTR_BEVELLED;
  ATTRIBUTE_NAMES[78] = ATTR_CODEBASE;
  ATTRIBUTE_NAMES[79] = ATTR_INDEX;
  ATTRIBUTE_NAMES[80] = ATTR_NORESIZE;
  ATTRIBUTE_NAMES[81] = ATTR_ONREADYSTATECHANGE;
  ATTRIBUTE_NAMES[82] = ATTR_ONBEFOREPASTE;
  ATTRIBUTE_NAMES[83] = ATTR_RULES;
  ATTRIBUTE_NAMES[84] = ATTR_SCHEME;
  ATTRIBUTE_NAMES[85] = ATTR_ONAFTERPRINT;
  ATTRIBUTE_NAMES[86] = ATTR_HEIGHT;
  ATTRIBUTE_NAMES[87] = ATTR_MARGINWIDTH;
  ATTRIBUTE_NAMES[88] = ATTR_LIGHTING_COLOR;
  ATTRIBUTE_NAMES[89] = ATTR_PATHLENGTH;
  ATTRIBUTE_NAMES[90] = ATTR_DOMINANT_BASELINE;
  ATTRIBUTE_NAMES[91] = ATTR_RADIOGROUP;
  ATTRIBUTE_NAMES[92] = ATTR_BACKGROUND;
  ATTRIBUTE_NAMES[93] = ATTR_MASKUNITS;
  ATTRIBUTE_NAMES[94] = ATTR_FILL;
  ATTRIBUTE_NAMES[95] = ATTR_STYLE;
  ATTRIBUTE_NAMES[96] = ATTR_FROM;
  ATTRIBUTE_NAMES[97] = ATTR_ASYNC;
  ATTRIBUTE_NAMES[98] = ATTR_OPEN;
  ATTRIBUTE_NAMES[99] = ATTR_POINTSATZ;
  ATTRIBUTE_NAMES[100] = ATTR_XLINK_ROLE;
  ATTRIBUTE_NAMES[101] = ATTR_AUTOCOMPLETE;
  ATTRIBUTE_NAMES[102] = ATTR_ENCODING;
  ...
  ATTRIBUTE_NAMES[153] = ATTR_SEED;
  ATTRIBUTE_NAMES[154] = ATTR_WORD_SPACING;
  ATTRIBUTE_NAMES[155] = ATTR_ACCENT;
  ATTRIBUTE_NAMES[156] = ATTR_BASELINE_SHIFT;
  ATTRIBUTE_NAMES[157] = ATTR_CODE;
  ATTRIBUTE_NAMES[158] = ATTR_DEFER;
  ATTRIBUTE_NAMES[159] = ATTR_EDGE;
  ATTRIBUTE_NAMES[160] = ATTR_INTEGRITY;
  ATTRIBUTE_NAMES[161] = ATTR_MODE;
  ATTRIBUTE_NAMES[162] = ATTR_ONREPEAT;
  ATTRIBUTE_NAMES[163] = ATTR_OTHER;
  ATTRIBUTE_NAMES[164] = ATTR_ONBEGIN;
  ATTRIBUTE_NAMES[165] = ATTR_ONBEFORECOPY;
  ATTRIBUTE_NAMES[166] = ATTR_ONKEYUP;
  ATTRIBUTE_NAMES[167] = ATTR_REPEAT;
  ATTRIBUTE_NAMES[168] = ATTR_REPEATCOUNT;
  ATTRIBUTE_NAMES[169] = ATTR_SUPERSCRIPTSHIFT;
  ATTRIBUTE_NAMES[170] = ATTR_SELECTION;
  ATTRIBUTE_NAMES[171] = ATTR_HREF;
  ATTRIBUTE_NAMES[172] = ATTR_SURFACESCALE;
  ATTRIBUTE_NAMES[173] = ATTR_ALIGNMENTSCOPE;
  ATTRIBUTE_NAMES[174] = ATTR_LANGUAGE;
  ATTRIBUTE_NAMES[175] = ATTR_LENGTHADJUST;
  ATTRIBUTE_NAMES[176] = ATTR_PING;
  ATTRIBUTE_NAMES[177] = ATTR_ARCHIVE;
  ATTRIBUTE_NAMES[178] = ATTR_METHOD;
  ATTRIBUTE_NAMES[179] = ATTR_NOSHADE;
  ATTRIBUTE_NAMES[180] = ATTR_ALTIMG;
  ATTRIBUTE_NAMES[181] = ATTR_ADDITIVE;
  ATTRIBUTE_NAMES[182] = ATTR_DEFINITIONURL;
  ATTRIBUTE_NAMES[183] = ATTR_ONFINISH;
  ATTRIBUTE_NAMES[184] = ATTR_SCRIPTLEVEL;
  ATTRIBUTE_NAMES[185] = ATTR_VALIGN;
  ATTRIBUTE_NAMES[186] = ATTR_MARKER_MID;
  ATTRIBUTE_NAMES[187] = ATTR_MARKER_START;
  ATTRIBUTE_NAMES[188] = ATTR_MASKCONTENTUNITS;
  ATTRIBUTE_NAMES[189] = ATTR_DECLARE;
  ATTRIBUTE_NAMES[190] = ATTR_MAXLENGTH;
  ATTRIBUTE_NAMES[191] = ATTR_ROWLINES;
  ATTRIBUTE_NAMES[192] = ATTR_TITLE;
  ATTRIBUTE_NAMES[193] = ATTR_FRAME;
  ATTRIBUTE_NAMES[194] = ATTR_PROMPT;
  ATTRIBUTE_NAMES[195] = ATTR_USEMAP;
  ATTRIBUTE_NAMES[196] = ATTR_IN;
  ATTRIBUTE_NAMES[197] = ATTR_KERNELUNITLENGTH;
  ATTRIBUTE_NAMES[198] = ATTR_ONEND;
  ATTRIBUTE_NAMES[199] = ATTR_POINTSATX;
  ATTRIBUTE_NAMES[200] = ATTR_STANDBY;
  ATTRIBUTE_NAMES[201] = ATTR_XLINK_HREF;
  ATTRIBUTE_NAMES[202] = ATTR_XMLNS_XLINK;
  ATTRIBUTE_NAMES[203] = ATTR_XLINK_ACTUATE;
  ATTRIBUTE_NAMES[204] = ATTR_BGCOLOR;
  ATTRIBUTE_NAMES[205] = ATTR_COLOR;
  ATTRIBUTE_NAMES[206] = ATTR_FLOOD_COLOR;
  ATTRIBUTE_NAMES[207] = ATTR_NOMODULE;
  ...
  ATTRIBUTE_NAMES[307] = ATTR_RENDERING_INTENT;
  ATTRIBUTE_NAMES[308] = ATTR_SRCDOC;
  ATTRIBUTE_NAMES[309] = ATTR_SANDBOX;
  ATTRIBUTE_NAMES[310] = ATTR_ACCENTUNDER;
  ATTRIBUTE_NAMES[311] = ATTR_ACCESSKEY;
  ATTRIBUTE_NAMES[312] = ATTR_ACCEPT;
  ATTRIBUTE_NAMES[313] = ATTR_BASEFREQUENCY;
  ATTRIBUTE_NAMES[314] = ATTR_BASEPROFILE;
  ATTRIBUTE_NAMES[315] = ATTR_BASE;
  ATTRIBUTE_NAMES[316] = ATTR_CODETYPE;
  ATTRIBUTE_NAMES[317] = ATTR_CITE;
  ATTRIBUTE_NAMES[318] = ATTR_DATETIME;
  ATTRIBUTE_NAMES[319] = ATTR_EDGEMODE;
  ATTRIBUTE_NAMES[320] = ATTR_FACE;
  ATTRIBUTE_NAMES[321] = ATTR_INTERCEPT;
  ATTRIBUTE_NAMES[322] = ATTR_LINEBREAK;
  ATTRIBUTE_NAMES[323] = ATTR_LINETHICKNESS;
  ATTRIBUTE_NAMES[324] = ATTR_NAME;
  ATTRIBUTE_NAMES[325] = ATTR_ONBEFOREUNLOAD;
  ATTRIBUTE_NAMES[326] = ATTR_OBJECT;
  ATTRIBUTE_NAMES[327] = ATTR_ORDER;
  ATTRIBUTE_NAMES[328] = ATTR_ONRESET;
  ATTRIBUTE_NAMES[329] = ATTR_ONMESSAGE;
  ATTRIBUTE_NAMES[330] = ATTR_ONBEFOREPRINT;
  ATTRIBUTE_NAMES[331] = ATTR_ORIENTATION;
  ATTRIBUTE_NAMES[332] = ATTR_ONSELECTSTART;
  ATTRIBUTE_NAMES[333] = ATTR_ONKEYPRESS;
  ATTRIBUTE_NAMES[334] = ATTR_ONBEFORECUT;
  ATTRIBUTE_NAMES[335] = ATTR_ONRESIZE;
  ATTRIBUTE_NAMES[336] = ATTR_REFERRERPOLICY;
  ATTRIBUTE_NAMES[337] = ATTR_ROLE;
  ATTRIBUTE_NAMES[338] = ATTR_REPEATDUR;
  ATTRIBUTE_NAMES[339] = ATTR_SIZES;
  ATTRIBUTE_NAMES[340] = ATTR_STRETCHY;
  ATTRIBUTE_NAMES[341] = ATTR_SPREADMETHOD;
  ATTRIBUTE_NAMES[342] = ATTR_SIZE;
  ATTRIBUTE_NAMES[343] = ATTR_DIFFUSECONSTANT;
  ATTRIBUTE_NAMES[344] = ATTR_HREFLANG;
  ATTRIBUTE_NAMES[345] = ATTR_PROFILE;
  ATTRIBUTE_NAMES[346] = ATTR_XREF;
  ATTRIBUTE_NAMES[347] = ATTR_ALIGNMENT_BASELINE;
  ATTRIBUTE_NAMES[348] = ATTR_DRAGGABLE;
  ATTRIBUTE_NAMES[349] = ATTR_IMAGE_RENDERING;
  ATTRIBUTE_NAMES[350] = ATTR_LANG;
  ATTRIBUTE_NAMES[351] = ATTR_LONGDESC;
  ATTRIBUTE_NAMES[352] = ATTR_MARGINHEIGHT;
  ATTRIBUTE_NAMES[353] = ATTR_ORIGIN;
  ATTRIBUTE_NAMES[354] = ATTR_TARGET;
  ATTRIBUTE_NAMES[355] = ATTR_TARGETY;
  ATTRIBUTE_NAMES[356] = ATTR_HIGH;
  ATTRIBUTE_NAMES[357] = ATTR_MATHBACKGROUND;
  ATTRIBUTE_NAMES[358] = ATTR_MATHVARIANT;
  ATTRIBUTE_NAMES[359] = ATTR_MATHSIZE;
  ATTRIBUTE_NAMES[360] = ATTR_ONCHANGE;
  ATTRIBUTE_NAMES[361] = ATTR_PATH;
  ATTRIBUTE_NAMES[362] = ATTR_ACTIONTYPE;
  ATTRIBUTE_NAMES[363] = ATTR_ACTIVE;
  ATTRIBUTE_NAMES[364] = ATTR_BEGIN;
  ATTRIBUTE_NAMES[365] = ATTR_DIVISOR;
  ATTRIBUTE_NAMES[366] = ATTR_LIMITINGCONEANGLE;
  ATTRIBUTE_NAMES[367] = ATTR_MANIFEST;
  ATTRIBUTE_NAMES[368] = ATTR_OPTIMUM;
  ATTRIBUTE_NAMES[369] = ATTR_RADIUS;
  ATTRIBUTE_NAMES[370] = ATTR_SCRIPTSIZEMULTIPLIER;
  ATTRIBUTE_NAMES[371] = ATTR_TABINDEX;
  ATTRIBUTE_NAMES[372] = ATTR_VISIBILITY;
  ATTRIBUTE_NAMES[373] = ATTR_LINK;
  ATTRIBUTE_NAMES[374] = ATTR_MARKERHEIGHT;
  ATTRIBUTE_NAMES[375] = ATTR_MASK;
  ATTRIBUTE_NAMES[376] = ATTR_MARKERWIDTH;
  ATTRIBUTE_NAMES[377] = ATTR_MARKERUNITS;
  ATTRIBUTE_NAMES[378] = ATTR_AMPLITUDE;
  ATTRIBUTE_NAMES[379] = ATTR_CELLPADDING;
  ATTRIBUTE_NAMES[380] = ATTR_FILL_RULE;
  ATTRIBUTE_NAMES[381] = ATTR_FILL_OPACITY;
  ATTRIBUTE_NAMES[382] = ATTR_ONCLICK;
  ATTRIBUTE_NAMES[383] = ATTR_REPLACE;
  ATTRIBUTE_NAMES[384] = ATTR_SCALE;
  ATTRIBUTE_NAMES[385] = ATTR_TABLEVALUES;
  ATTRIBUTE_NAMES[386] = ATTR_AZIMUTH;
  ATTRIBUTE_NAMES[387] = ATTR_FRAMEBORDER;
  ATTRIBUTE_NAMES[388] = ATTR_FRAMESPACING;
  ATTRIBUTE_NAMES[389] = ATTR_FORM;
  ATTRIBUTE_NAMES[390] = ATTR_PRIMITIVEUNITS;
  ATTRIBUTE_NAMES[391] = ATTR_SUMMARY;
  ATTRIBUTE_NAMES[392] = ATTR_ZOOMANDPAN;
  ATTRIBUTE_NAMES[393] = ATTR_ALINK;
  ATTRIBUTE_NAMES[394] = ATTR_ICON;
  ATTRIBUTE_NAMES[395] = ATTR_KERNING;
  ATTRIBUTE_NAMES[396] = ATTR_ONUNLOAD;
  ATTRIBUTE_NAMES[397] = ATTR_ONINVALID;
  ATTRIBUTE_NAMES[398] = ATTR_ONINPUT;
  ATTRIBUTE_NAMES[399] = ATTR_POINTS;
  ATTRIBUTE_NAMES[400] = ATTR_POINTSATY;
  ATTRIBUTE_NAMES[401] = ATTR_SPAN;
  ATTRIBUTE_NAMES[402] = ATTR_TRANSFORM;
  ATTRIBUTE_NAMES[403] = ATTR_WHEN;
  ATTRIBUTE_NAMES[404] = ATTR_XLINK_TITLE;
  ATTRIBUTE_NAMES[405] = ATTR_XLINK_ARCROLE;
  ATTRIBUTE_NAMES[406] = ATTR_XMLNS;
  ATTRIBUTE_NAMES[407] = ATTR_XLINK_SHOW;
  ATTRIBUTE_NAMES[408] = ATTR_AUTOPLAY;
  ATTRIBUTE_NAMES[409] = ATTR_AUTOFOCUS;
  ATTRIBUTE_NAMES[410] = ATTR_COLOR_PROFILE;
  ATTRIBUTE_NAMES[411] = ATTR_COLOR_INTERPOLATION;
  ATTRIBUTE_NAMES[412] = ATTR_COLOR_INTERPOLATION_FILTERS;
  ATTRIBUTE_NAMES[413] = ATTR_EXPONENT;
  ATTRIBUTE_NAMES[414] = ATTR_FLOOD_OPACITY;
  ATTRIBUTE_NAMES[415] = ATTR_NUMOCTAVES;
