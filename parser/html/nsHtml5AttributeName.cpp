...
static int32_t const ATTRIBUTE_HASHES_DATA[] = {
    1872034503, 1748971848, 1972744939, 1681174213, 1786740932, 1917953597,
    2006516551, 1680165421, 1723336432, 1754907227, 1820262641, 1905902311,
    1932986153, 1991021879, 2026893641, 71827457,   1680282148, 1689324870,
    1747295467, 1754606246, 1757053236, 1804069019, 1854302364, 1889633006,
    1910503637, 1922679386, 1941438085, 1983266615, 2001634459, 2015950026,
    ...
    1965561677, 1972962123, 1987410233, 2000125224, 2001898808, 2008408414,
    2023146024, 2060474743, 2082471938, 53006051,   60345635,   885522434,
    ...
    1941253366, 1942026440, 1966454567, 1972904522, 1980235778, 1983416119,
    1988788535, 1991643278, 2001210183, 2001710299, 2004957380, 2007064812,
    2009141482, 2016910397, 2024763702, 2034765641, 2065694722, 2081423362,
    ...
    1972196486, 1972863609, 1972909592, 1974849131, 1982640164, 1983347764,
    1983461061, 1988132214, 1990062797, 1991392548, 1999273799, 2000162011,
    2001578182, 2001669450, 2001814704, 2004199576, 2005925890, 2007019632,
    2008084807, 2009071951, 2010452700, 2016787611, 2018908874, 2024616088,
    ...
    1990107683, 1991220282, 1991625270, 1993343287, 2000096287, 2000160071,
    2000752725, 2001527900, 2001634458, 2001669449, 2001710298, 2001732764,
    2001826027, 2001898809, 2004846654, 2005342360, 2006459190, 2006824246,
    2007021895, 2007064819, 2008401563, 2009041198, 2009079867, 2009231684,
    2010716309, 2016711994, 2016810187, 2017010843, 2019887833, 2023342821,
    2024647008, 2024794274};
...
void nsHtml5AttributeName::initializeStatics() {
  ...
  ATTR_REFY = new nsHtml5AttributeName(
      ...
      ALL_NO_PREFIX);
  ATTRIBUTE_NAMES = new nsHtml5AttributeName*[494];
  ...
  ATTRIBUTE_NAMES[6] = ATTR_ONSTART;
  ...
  ATTRIBUTE_NAMES[13] = ATTR_ROWSPAN;
  ...
  ATTRIBUTE_NAMES[27] = ATTR_CLASSID;
  ATTRIBUTE_NAMES[28] = ATTR_FONT_WEIGHT;
  ATTRIBUTE_NAMES[29] = ATTR_ACCUMULATE;
  ...
  ATTRIBUTE_NAMES[56] = ATTR_KEYSYSTEM;
  ATTRIBUTE_NAMES[57] = ATTR_CONTROLS;
  ATTRIBUTE_NAMES[58] = ATTR_FONTSIZE;
  ATTRIBUTE_NAMES[59] = ATTR_SYSTEMLANGUAGE;
  ATTRIBUTE_NAMES[60] = ATTR_ONSUBMIT;
  ...
  ATTRIBUTE_NAMES[112] = ATTR_AS;
  ATTRIBUTE_NAMES[113] = ATTR_CLOSURE;
  ATTRIBUTE_NAMES[114] = ATTR_MINSIZE;
  ATTRIBUTE_NAMES[115] = ATTR_SUBSCRIPTSHIFT;
  ATTRIBUTE_NAMES[116] = ATTR_ENCTYPE;
  ATTRIBUTE_NAMES[117] = ATTR_FONT_FAMILY;
  ATTRIBUTE_NAMES[118] = ATTR_LIST;
  ATTRIBUTE_NAMES[119] = ATTR_PATTERNUNITS;
  ATTRIBUTE_NAMES[120] = ATTR_TEXTLENGTH;
  ATTRIBUTE_NAMES[121] = ATTR_COLUMNSPACING;
  ATTRIBUTE_NAMES[122] = ATTR_RESULT;
  ...
  ATTRIBUTE_NAMES[226] = ATTR_BIAS;
  ATTRIBUTE_NAMES[227] = ATTR_COLS;
  ATTRIBUTE_NAMES[228] = ATTR_CLASS;
  ATTRIBUTE_NAMES[229] = ATTR_LOWSRC;
  ATTRIBUTE_NAMES[230] = ATTR_PRESERVEALPHA;
  ATTRIBUTE_NAMES[231] = ATTR_ROWS;
  ATTRIBUTE_NAMES[232] = ATTR_ALTTEXT;
  ATTRIBUTE_NAMES[233] = ATTR_CONTEXTMENU;
  ATTRIBUTE_NAMES[234] = ATTR_FILTER;
  ATTRIBUTE_NAMES[235] = ATTR_FONT_STYLE;
  ATTRIBUTE_NAMES[236] = ATTR_FONT_SIZE_ADJUST;
  ATTRIBUTE_NAMES[237] = ATTR_KEYTIMES;
  ATTRIBUTE_NAMES[238] = ATTR_RT;
  ATTRIBUTE_NAMES[239] = ATTR_PATTERNTRANSFORM;
  ATTRIBUTE_NAMES[240] = ATTR_RESTART;
  ATTRIBUTE_NAMES[241] = ATTR_TEXT_DECORATION;
  ATTRIBUTE_NAMES[242] = ATTR_WRITING_MODE;
  ATTRIBUTE_NAMES[243] = ATTR_COLUMNLINES;
  ATTRIBUTE_NAMES[244] = ATTR_GROUPALIGN;
  ATTRIBUTE_NAMES[245] = ATTR_REQUIRED;
  ...
  ATTRIBUTE_NAMES[453] = ATTR_AXIS;
  ATTRIBUTE_NAMES[454] = ATTR_COLSPAN;
  ATTRIBUTE_NAMES[455] = ATTR_CROSSORIGIN;
  ATTRIBUTE_NAMES[456] = ATTR_CURSOR;
  ATTRIBUTE_NAMES[457] = ATTR_CLOSE;
  ATTRIBUTE_NAMES[458] = ATTR_IS;
  ATTRIBUTE_NAMES[459] = ATTR_KEYSPLINES;
  ATTRIBUTE_NAMES[460] = ATTR_MAXSIZE;
  ATTRIBUTE_NAMES[461] = ATTR_OFFSET;
  ATTRIBUTE_NAMES[462] = ATTR_PRESERVEASPECTRATIO;
  ATTRIBUTE_NAMES[463] = ATTR_ROWSPACING;
  ATTRIBUTE_NAMES[464] = ATTR_SRCSET;
  ATTRIBUTE_NAMES[465] = ATTR_VERSION;
  ATTRIBUTE_NAMES[466] = ATTR_CONTENTEDITABLE;
  ATTRIBUTE_NAMES[467] = ATTR_CONTENT;
  ATTRIBUTE_NAMES[468] = ATTR_DEPTH;
  ATTRIBUTE_NAMES[469] = ATTR_FONT_STRETCH;
  ATTRIBUTE_NAMES[470] = ATTR_FONTWEIGHT;
  ATTRIBUTE_NAMES[471] = ATTR_FONTSTYLE;
  ATTRIBUTE_NAMES[472] = ATTR_FONTFAMILY;
  ATTRIBUTE_NAMES[473] = ATTR_FONT_VARIANT;
  ATTRIBUTE_NAMES[474] = ATTR_FILTERUNITS;
  ATTRIBUTE_NAMES[475] = ATTR_FONT_SIZE;
  ATTRIBUTE_NAMES[476] = ATTR_LETTER_SPACING;
  ATTRIBUTE_NAMES[477] = ATTR_MULTIPLE;
  ATTRIBUTE_NAMES[478] = ATTR_ONSTOP;
  ATTRIBUTE_NAMES[479] = ATTR_POSTER;
  ATTRIBUTE_NAMES[480] = ATTR_PATTERN;
  ATTRIBUTE_NAMES[481] = ATTR_PATTERNCONTENTUNITS;
  ATTRIBUTE_NAMES[482] = ATTR_STITCHTILES;
  ATTRIBUTE_NAMES[483] = ATTR_TEXT_RENDERING;
  ATTRIBUTE_NAMES[484] = ATTR_TEXT_ANCHOR;
  ATTRIBUTE_NAMES[485] = ATTR_TEXT;
  ATTRIBUTE_NAMES[486] = ATTR_WIDTH;
  ATTRIBUTE_NAMES[487] = ATTR_COLUMNSPAN;
  ATTRIBUTE_NAMES[488] = ATTR_COLUMNALIGN;
  ATTRIBUTE_NAMES[489] = ATTR_COLUMNWIDTH;
  ATTRIBUTE_NAMES[490] = ATTR_INPUTMODE;
  ATTRIBUTE_NAMES[491] = ATTR_ONCUT;
  ATTRIBUTE_NAMES[492] = ATTR_REQUIREDFEATURES;
  ATTRIBUTE_NAMES[493] = ATTR_REQUIREDEXTENSIONS;
}
