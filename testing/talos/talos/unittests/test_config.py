...
class Test_get_test(object):
    ...
    def test_doesnt_override_specific_keys_unless_they_are_null(self):
        ...
        test_instance = mock_test(tpmozafterpaint=None, firstpaint=None, userready=None, fnbpaint=None)
        test_dict = get_test({}, self.global_overrides, [], test_instance)
    ...
    def test_add_counters(self):
        test_instance = mock_test(linux_counters=None, mac_counters=[], win_counters=['counter_a'],
                                  w7_counters=['counter_a', 'counter_b'], xperf_counters=['counter_a', 'counter_extra'])
...
class Test_get_browser_config(object):
    ...
    optional = list({'bcontroller_config': '${talos}/bcontroller.json',
                'branch_name': '',
...
class Test_get_config(object):
    ...
    def setup_class(cls):
        ...
        --activeTests sessionrestore_no_auto_restore
        -e /some/random/path
        '''.split()
        cls.argv_sessionrestore_many_windows = '''
        --activeTests sessionrestore_many_windows
        -e /some/random/path
        '''.split()
        ...
        cls.argv_basic_compositor_video = '--activeTests basic_compositor_video -e /some/random/path'.split()
        ...
        cls.argv_perf_reftest_singletons = '--activeTests perf_reftest_singletons -e /some/random/path'.split()
        cls.argv_quantum_pageload_google = '--activeTests quantum_pageload_google -e /some/random/path'.split()
        cls.argv_quantum_pageload_youtube = '--activeTests quantum_pageload_youtube -e /some/random/path'.split()
        cls.argv_quantum_pageload_amazon = '--activeTests quantum_pageload_amazon -e /some/random/path'.split()
        cls.argv_quantum_pageload_facebook = '--activeTests quantum_pageload_facebook -e /some/random/path'.split()
        ...
        cls.argv_tp6_facebook_heavy = '--activeTests tp6_facebook_heavy -e /some/random/path'.split()
    ...
    def test_sessionrestore_has_expected_attributes(self):
        ...
        assert test_config['gecko_profile_entries'] == 10000000
        assert test_config['shutdown'] is False
        assert test_config['reinstall'] == ['sessionstore.jsonlz4', 'sessionstore.js', 'sessionCheckpoints.json']
    ...
    def test_tpaint_has_expected_attributes(self):
        ...
        assert test_config['preferences'] == {'security.data_uri.block_toplevel_data_uri_navigations': False}
    ...
    def test_perf_reftest_singletons_has_expected_attributes(self):
        ...
        assert test_config['tpmanifest'] != '${talos}/tests/perf-reftest-singletons/perf_reftest_singletons.manifest'
        assert test_config['tpcycles'] == 1
    ...
    def test_quantum_pageload_google_has_expected_attributes(self):
        ...
        assert test_config['tpmanifest'] != '${talos}/tests/quantum_pageload/quantum_pageload_google.manifest'
    ...
    def test_quantum_pageload_youtube_has_expected_attributes(self):
        ...
        assert test_config['lower_is_better'] is True
        assert test_config['fnbpaint'] is True
        assert test_config['tpmanifest'] != '${talos}/tests/quantum_pageload/quantum_pageload_youtube.manifest'
    ...
    def test_quantum_pageload_amazon_has_expected_attributes(self):
        ...
        assert test_config['lower_is_better'] is True
        assert test_config['fnbpaint'] is True
        assert test_config['tpmanifest'] != '${talos}/tests/quantum_pageload/quantum_pageload_amazon.manifest'
    ...
    def test_quantum_pageload_facebook_has_expected_attributes(self):
        ...
        assert test_config['lower_is_better'] is True
        assert test_config['fnbpaint'] is True
        assert test_config['tpmanifest'] != '${talos}/tests/quantum_pageload/quantum_pageload_facebook.manifest'
