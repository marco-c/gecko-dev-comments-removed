...
class TestElements(MarionetteTestCase):
    ...
    def test_should_throw_invalidselectorexception_when_css_is_pass_null(self):
        test_html = self.marionette.absolute_url("formPage.html")
        self.marionette.navigate(test_html)
        body = self.marionette.find_element(By.TAG_NAME, "body")
        self.assertRaises(InvalidSelectorException, body.find_element, By.CSS_SELECTOR, None)
