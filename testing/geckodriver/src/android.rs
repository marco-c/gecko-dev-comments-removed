...
mod test {
    ...
    fn android_handler_storage_as_app() {
        let package = "com.android.calendar";

        let mut test_root = PathBuf::from("/data/data");
        test_root.push(&package);
        test_root.push("test_root");

        run_handler_storage_test(&package, AndroidStorageInput::App, test_root);
    }

    #[test]
    fn android_handler_storage_as_auto() {
        let package = "com.android.calendar";
        let test_root = PathBuf::from("/data/local/tmp/test_root");

        run_handler_storage_test(package, AndroidStorageInput::Auto, test_root);
    }
    ...
    fn android_handler_storage_as_internal() {
        ...
        run_handler_storage_test(package, AndroidStorageInput::Internal, test_root);
    }

    #[test]
    fn android_handler_storage_as_sdcard() {
        let package = "com.android.calendar";
        let test_root = PathBuf::from("/mnt/sdcard/test_root");

        run_handler_storage_test(package, AndroidStorageInput::Sdcard, test_root);
    }
}
