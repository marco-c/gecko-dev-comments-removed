...
params(
  ...
  { indexCount: 5, firstIndex: 1 }, 
  { indexCount: 1, firstIndex: 5 }, 
  { indexCount: 0, firstIndex: 6 }, 
  { indexCount: 0, firstIndex: 7 }, 
  { indexCount: 7, firstIndex: 0 }, 
  { indexCount: 6, firstIndex: 1 }, 
  { indexCount: 1, firstIndex: 6 }, 
  { indexCount: 6, firstIndex: 10000 }, 
  { indexCount: 10000, firstIndex: 0 }, 
  { indexCount: 0xffffffff, firstIndex: 0xffffffff }, 
  { indexCount: 0xffffffff, firstIndex: 2 }, 
  { indexCount: 2, firstIndex: 0xffffffff } 
  ]).
  combine('instanceCount', [1, 10000]) 
).
fn((t) => {
...
params(
  ...
  u.
  combineWithParams([
  { indexCount: 3, firstIndex: 1 }, 
  { indexCount: 0, firstIndex: 1 }, 
  { indexCount: 3, firstIndex: 0 }, 
  { indexCount: 0, firstIndex: 0 } 
  ]).
  combine('instanceCount', [1, 10000]) 
).
fn((t) => {
