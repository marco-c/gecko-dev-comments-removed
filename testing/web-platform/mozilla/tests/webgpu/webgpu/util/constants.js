...
export const kValue = {
  ...
  f32: {
    positive: {
      ...
      first_f64_not_castable: hexToF32(kBit.f32.positive.max) / 2 + 2 ** 127, 
    ...
    negative: {
      ...
      less_than_one: hexToF32(kBit.f32.negative.less_than_one), 
      pi: {
  ...
  f16: {
    positive: {
      ...
      first_f64_not_castable: hexToF16(kBit.f16.positive.max) / 2 + 2 ** 16, 
      last_f64_castable: hexToF64(
