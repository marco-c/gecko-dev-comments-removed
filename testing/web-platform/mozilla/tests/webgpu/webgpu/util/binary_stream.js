...
export default class BinaryStream {
  ...
  writeU16(value) {
    this.view.setUint16(this.alignedOffset(2), value, true);
  }

  
  readU16() {
    return this.view.getUint16(this.alignedOffset(2), true);
  }

  
  writeU32(value) {
    this.view.setUint32(this.alignedOffset(4), value, true);
  }

  
  readU32() {
    return this.view.getUint32(this.alignedOffset(4), true);
  }
  ...
  writeI16(value) {
    this.view.setInt16(this.alignedOffset(2), value, true);
  }

  
  readI16() {
    return this.view.getInt16(this.alignedOffset(2), true);
  }
  ...
  readI32() {
    return this.view.getInt32(this.alignedOffset(4), true);
  }
  ...
  writeF32(value) {
    this.view.setFloat32(this.alignedOffset(4), value, true);
  }

  
  readF32() {
    return this.view.getFloat32(this.alignedOffset(4), true);
  }

  
  writeF64(value) {
    this.view.setFloat64(this.alignedOffset(8), value, true);
  }

  
  readF64() {
    return this.view.getFloat64(this.alignedOffset(8), true);
  }
