...
def compare_expected(changes, subtest, ancestor_manifest, new_manifest):
    if not (
        ancestor_manifest and ancestor_manifest.has_key("expected")  
    ) and (
        ...
        ancestor_manifest
        and ancestor_manifest.has_key("expected")  
        and not (new_manifest and new_manifest.has_key("expected"))  
    ):
        ...
        and ancestor_manifest.has_key("expected")  
        and new_manifest
        and new_manifest.has_key("expected")  
    ):
