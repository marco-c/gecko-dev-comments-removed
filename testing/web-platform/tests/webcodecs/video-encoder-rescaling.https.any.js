...
const scaleTests = [
  { from: { w: 64, h: 64 }, to: { w: 128, h: 128 } }, 
  { from: { w: 128, h: 128 }, to: { w: 128, h: 128 } }, 
  { from: { w: 128, h: 128 }, to: { w: 64, h: 64 } }, 
  { from: { w: 32, h: 32 }, to: { w: 96, h: 96 } }, 
  { from: { w: 192, h: 192 }, to: { w: 64, h: 64 } }, 
  { from: { w: 64, h: 32 }, to: { w: 128, h: 64 } }, 
  { from: { w: 128, h: 256 }, to: { w: 64, h: 128 } }, 
  { from: { w: 64, h: 64 }, to: { w: 128, h: 192 } }, 
  { from: { w: 128, h: 192 }, to: { w: 64, h: 64 } }, 
]
...
const pixelFormatChannelParameters = [
  { 
    ...
    channelPlaneWidths: [4, 0, 0], 
    channelWidths: [1, 1, 1],
    channelStrides: [4, 4, 4], 
    channelSteps: [4, 4, 4],
    channelHeights: [1, 1, 1],  
  ...
  { 
    ...
    channelStrides: [1, 0.5, 0.5], 
    channelSteps: [1, 1, 1],
    channelHeights: [1, 0.5, 0.5],  
    channelFourColors: fourColors.map((col) => rgb2yuv(col)), 
    format: 'I420'
  }
]
