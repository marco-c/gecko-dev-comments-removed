...
promise_test(() => {
  ...
  return fetchAndEatBody(initialURL, {})                      
    .then(() => fetchAndEatBody(initialURL, {}))              
    .then(() => fetchAndEatBody(initialURL, mustRevalidate))  
...
promise_test(() => {
  ...
  return fetchAndEatBody(redirectURL, {})                      
    .then(() => fetchAndEatBody(redirectURL, {}))              
    .then(() => fetchAndEatBody(redirectURL, mustRevalidate))  
    .then(accumulateEntries)
    .then(checkDeliveryType);
