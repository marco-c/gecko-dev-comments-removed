      ...
      case 'bgra8unorm':
        {
          ...
          data.set(new Uint8Array([0x00, 0x00, 0x7f, 0xff]), 0); 

          data.set(new Uint8Array([0x00, 0x7f, 0x00, 0xff]), 4); 

          data.set(new Uint8Array([0x7f, 0x00, 0x00, 0xff]), 256 + 0); 

          data.set(new Uint8Array([0x00, 0x7f, 0x7f, 0xff]), 256 + 4); 
        }
        break;
