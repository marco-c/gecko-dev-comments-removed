...
subsetTest(promise_test, async test => {
  ...
  let bidderReportURL1 = createBidderReportURL(uuid,  1);
  let bidderReportURL2 = createBidderReportURL(uuid,  2);
  let bidderDebugReportURL =
      createBidderReportURL(uuid,  'forDebuggingOnly');
  let sellerReportURL1 = createSellerReportURL(uuid,  1);
  let sellerReportURL2 = createSellerReportURL(uuid,  2);
