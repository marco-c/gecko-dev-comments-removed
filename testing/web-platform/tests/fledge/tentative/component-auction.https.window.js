...
subsetTest(promise_test, async test => {
  ...
  let componentSellerReportURL = createSellerReportURL(uuid, "component");
  let topLevelSellerReportURL = createSellerReportURL(uuid, "top");
...
subsetTest(promise_test, async test => {
  ...
  let bidder1ReportURL = createBidderReportURL(uuid, 1);
  let bidder2ReportURL = createBidderReportURL(uuid, 2);
  let componentSeller1ReportURL = createSellerReportURL(uuid, "component1");
  let componentSeller2ReportURL = createSellerReportURL(uuid, "component2");
  let topLevelSellerReportURL = createSellerReportURL(uuid, "top");
...
subsetTest(promise_test, async test => {
  ...
  let renderURL2 = createRenderURL(uuid, ';');
...
subsetTest(promise_test, async test => {
  ...
  let bidderReportURL1 = createBidderReportURL(uuid, 1);
  let bidderReportURL2 = createBidderReportURL(uuid, 2);
  let seller1ReportURL = createSellerReportURL(uuid, 1);
  let seller2ReportURL = createSellerReportURL(uuid, 2);
...
subsetTest(promise_test, async test => {
  ...
  let auctionConfig = createComponentAuctionConfig(uuid,auctionConfigOverride,
  deprecatedRenderURLReplacements);
