...
integrity("Empty string integrity", url, "",  undefined,
           true);
integrity("SHA-256 integrity", url, topSha256,  undefined,
           true);
integrity("SHA-384 integrity", url, topSha384,  undefined,
           true);
integrity("SHA-512 integrity", url, topSha512,  undefined,
           true);
integrity("Invalid integrity", url, invalidSha256,
           undefined,   false);
integrity("Multiple integrities: valid stronger than invalid", url,
          invalidSha256 + " " + topSha384,  undefined,
           true);
integrity("Multiple integrities: invalid stronger than valid",
          url, invalidSha512 + " " + topSha384,  undefined,
           false);
integrity("Multiple integrities: invalid as strong as valid", url,
          invalidSha512 + " " + topSha512,  undefined,
           true);
integrity("Multiple integrities: both are valid", url,
          topSha384 + " " + topSha512,  undefined,
           true);
integrity("Multiple integrities: both are invalid", url,
          invalidSha256 + " " + invalidSha512,  undefined,
           false);
integrity("CORS empty integrity", corsUrl, "",  undefined,
           true);
