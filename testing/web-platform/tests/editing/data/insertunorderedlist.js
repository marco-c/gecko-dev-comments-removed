...
["<ol><li>[foo]<ol><li>bar</ol><li>baz</ol>",
    [["insertunorderedlist",""]],
    "<ul><li>[foo]<ol><li>bar</li></ol></li></ul><ol><li>baz</li></ol>",
    [true],
    {"insertunorderedlist":[false,false,"",false,false,""]}],
...
["<ol><li>foo<li>[bar]<ol><li>baz</ol><li>quz</ol>",
    [["insertunorderedlist",""]],
    "<ol><li>foo</li></ol><ul><li>[bar]<ol><li>baz</li></ol></li></ul><ol><li>quz</li></ol>",
    [true],
    {"insertunorderedlist":[false,false,"",false,false,""]}],
...
["<ol><li>[foo<ol><li>bar]</ol><li>baz</ol>",
    [["insertunorderedlist",""]],
    "<ul><li>[foo<ul><li>bar]</li></ul></li></ul><ol><li>baz</li></ol>",
    [true],
    {"insertunorderedlist":[false,false,"",false,false,""]}],
...
["<ol><li>[foo]<ol><li>bar</ol>baz</ol>",
    [["insertunorderedlist",""]],
    "<ul><li>[foo]<ol><li>bar</li></ol>baz</li></ul>",
    [true],
    {"insertunorderedlist":[false,false,"",false,false,""]}],
["<ol><li>foo<ol><li>[bar]</ol>baz</ol>",
    [["insertunorderedlist",""]],
...
["<ol><li>[foo<ol><li>bar]</ol>baz</ol>",
    [["insertunorderedlist",""]],
    "<ul><li>[foo<ul><li>bar]</li></ul>baz</li></ul>",
    [true],
    {"insertunorderedlist":[false,false,"",false,false,""]}],
...
["<div>[foo</div>bar]<div>baz</div>",
    [["insertunorderedlist",""]],
    ["<div><ul><li>[foo</li><li>bar]</li></ul></div><div>baz</div>",
...
["<div>[abc</div><div><br></div><div>def]</div>",
    [["insertunorderedlist",""]],
    ["<div><ul><li>[abc</li><li><br></li><li>def]</li></ul></div>",
     "<ul><li>[abc</li><li><br></li><li>def]</li></ul>"],
    [true],
    {}],
["<div>{<br></div><div>abc</div><div>def]</div>",
    [["insertunorderedlist",""]],
    ["<div><ul><li>{<br></li><li>abc</li><li>def]</li></ul></div>",
     "<ul><li>{<br></li><li>abc</li><li>def]</li></ul>"],
    [true],
    {}],


["<div>[abc</div><div>def</div><div>}<br></div>",
    [["insertunorderedlist",""]],
    ["<div><ul><li>[abc</li><li>def]</li></ul></div><div><br></div>",
     "<ul><li>[abc</li><li>def]</li></ul><div><br></div>"],
    [true],
    {}],
["<div>[abc</div><div>def</div><div>]ghi</div>",
    [["insertunorderedlist",""]],
    ["<div><ul><li>[abc</li><li>def]</li></ul></div><div>ghi</div>",
...
['{ <span contenteditable="false">A</span> ; <span contenteditable="false">B</span> ; <span contenteditable="false">C</span> }',
    [["insertunorderedlist",""]],
    ['<ul><li> <span contenteditable="false">A</span> ; <span contenteditable="false">B</span> ; <span contenteditable="false">C</span> </li></ul>',
