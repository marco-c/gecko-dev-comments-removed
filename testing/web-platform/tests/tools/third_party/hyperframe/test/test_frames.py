...
class TestSettingsFrame(object):
    serialized = (
        b'\x00\x00\x2A\x04\x01\x00\x00\x00\x00' +  
        b'\x00\x01\x00\x00\x10\x00' +              
        b'\x00\x02\x00\x00\x00\x00' +              
        b'\x00\x03\x00\x00\x00\x64' +              
        b'\x00\x04\x00\x00\xFF\xFF' +              
        b'\x00\x05\x00\x00\x40\x00' +              
        b'\x00\x06\x00\x00\xFF\xFF' +              
...
class TestGoAwayFrame(object):
    ...
    def test_goaway_serializes_properly(self):
        ...
        s = f.serialize()
        assert s == (
            b'\x00\x00\x0D\x07\x00\x00\x00\x00\x00' +  
            b'\x00\x00\x00\x40' +                      
            b'\x00\x00\x00\x20' +                      
            b'hello'                                   
        )
...
class TestWindowUpdateFrame(object):
    ...
    def test_short_windowupdate_frame_errors(self):
        s = b'\x00\x00\x04\x08\x00\x00\x00\x00\x00\x00\x00\x02'  
...
class TestAltSvcFrame(object):
    payload_with_origin = (
        ...
        b'\x00\x0B'  
        b'example.com'  
        b'h2="alt.example.com:8000", h2=":443"'  
    )
    ...
    payload_with_origin_and_stream = (
        ...
        b'\x00\x0B'  
        b'example.com'  
        b'Alt-Svc: h2=":443"; ma=2592000; persist=1'  
    )
