...
promise_test(async t => {
    ...
    await promise_rejects(t, 'SecurityError', file.moveTo(dir, kCurrentDirectory));
...
promise_test(async t => {
    ...
    await promise_rejects(t, 'SecurityError', file.moveTo(first_subdir, kParentDirectory));
