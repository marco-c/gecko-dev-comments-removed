...
directory_test(async (t, root_dir) => {
  ...
  await do_message_port_test(t, root_dir, dedicated_worker);
...
directory_test(async (t, root_dir) => {
  ...
  await do_message_port_test(t, root_dir, registration.installing);
...
if (self.SharedWorker !== undefined) {
  directory_test(async (t, root_dir) => {
    ...
    await do_message_port_test(t, root_dir, shared_worker.port);
