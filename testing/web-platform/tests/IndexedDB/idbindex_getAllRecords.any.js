...
index_get_all_records_test(
     'large-values',
     undefined, 'Get all records with large value');
...
index_get_all_records_test(
     ...
     {
      query:
          IDBKeyRange.bound('G', 'M',  false,  true)
    },
...
index_get_all_records_test(
     ...
     {
      query:
          IDBKeyRange.bound('G', 'M',  true,  false)
    },
...
index_get_all_records_test(
     'out-of-line',  {count: 0}, 'Zero count');
...
index_get_all_records_test(
     'out-of-line',
     {direction: 'prev', query: IDBKeyRange.bound('B', 'X')},
    'Direction and query');
...
get_all_with_invalid_keys_test(
    'getAllRecords',  'out-of-line',  'test_idx',
     true, 'Get all records with invalid query keys');
