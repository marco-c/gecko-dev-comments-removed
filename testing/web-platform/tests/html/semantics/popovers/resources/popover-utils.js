...
function assertIsFunctionalPopover(popover) {
  ...
  popover.showPopover();
  assertPopoverVisibility(popover, true, true, 'After showPopover(), a popover should be visible');
  ...
  popover.hidePopover();
  assertPopoverVisibility(popover, true, false, 'After hidePopover(), a popover should be hidden');
  ...
  assertPopoverVisibility(popover, true, true, 'After togglePopover() on hidden popover, it should be visible');
  popover.togglePopover();
  assertPopoverVisibility(popover, true, false, 'After togglePopover() on visible popover, it should be hidden');
  popover.togglePopover(true);
  assertPopoverVisibility(popover, true, true, 'After togglePopover(true) on hidden popover, it should be visible');
  popover.togglePopover(true);
  assertPopoverVisibility(popover, true, true, 'After togglePopover(true) on visible popover, it should be visible');
  popover.togglePopover(false);
  assertPopoverVisibility(popover, true, false, 'After togglePopover(false) on visible popover, it should be hidden');
  popover.togglePopover(false);
  assertPopoverVisibility(popover, true, false, 'After togglePopover(false) on hidden popover, it should be hidden');
