...
const tests = [
    ...
    },
    {
        ...
        weight: {
            dataType: 'float32',
            dimensions: [ 2, 3 * hiddenSize, inputSize]
        },
        recurrentWeight: {
            dataType: 'float32',
            dimensions: [ 2, 3 * hiddenSize, hiddenSize]
        },
        steps: steps,
        hiddenSize: hiddenSize,
        options: {
            ...
            initialHiddenState: {
                dataType: 'float32',
                dimensions: [ 2, batchSize, hiddenSize]
            },
            restAfter: true,
            returnSequence: true,
            direction: 'both',
        ...
        outputs: [
            ...
            {
                dataType: 'float32',
                dimensions: [steps,  2, batchSize, hiddenSize]
            }
        ]
    },
    {
