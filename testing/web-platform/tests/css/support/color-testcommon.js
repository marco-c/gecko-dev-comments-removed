...
function fuzzy_test_computed_color(specified, computed, epsilon) {
  ...
  test_computed_value("color", specified, computed, undefined , {comparisonFunction: set_up_fuzzy_color_test(epsilon)});
}
...
function fuzzy_test_computed_color_property(property, specified, computed, epsilon) {
  ...
  test_computed_value(property, specified, computed, undefined , {comparisonFunction: set_up_fuzzy_color_test(epsilon)});
}
