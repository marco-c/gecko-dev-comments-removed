    ...
    if (self.refs):
      ...
      def adjustReferences(source):
        ...
        for refName in source.refs:
          ...
          newRefs[refName] = (refType, refPath, refNode, refSource) 
        source.refs = newRefs
      adjustReferences(self)

    if (self.scripts):   
      for src in self.scripts:
        if (src.endswith('/resources/testharness.js')):   
