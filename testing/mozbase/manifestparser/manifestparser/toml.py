...
def sort_paths_keyfn(k):
    sort_paths_keyfn.rx = getattr(sort_paths_keyfn, "rx", None)  
...
class Carry:
    ...
    def __init__(self):
        self.os_rx: Optional[re.Pattern] = None
        self.opt_rx: Optional[re.Pattern] = None
        self.not_opt_rx: Optional[re.Pattern] = None
        self.debug_rx: Optional[re.Pattern] = None
        self.not_debug_rx: Optional[re.Pattern] = None
        self.asan_rx: Optional[re.Pattern] = None
        self.tsan_rx: Optional[re.Pattern] = None
        self.ccov_rx: Optional[re.Pattern] = None
...
def add_skip_if(
    ...
    filename: str,
    condition: str,
    bug_reference: OptionalStr = None,
    ...
    first: OptionalStr = None
    first_comment: str = ""
    skip_if: Optional[Array] = None
