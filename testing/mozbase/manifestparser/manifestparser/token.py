...
class Token:
    ...
    def __init__(self, **kwargs):
        ...
        self._depends: Optional[Token] = kwargs.get("depends", None)  
    ...
    def depends(self) -> Optional[Token]:  
...
OptTokenType = Optional[TokenType]  
OptStr = Optional[str]  
TokenizedOps = List[Tuple[OptTokenType, OptStr, Token]]  
