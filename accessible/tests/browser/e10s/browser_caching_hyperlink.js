...
addAccessibleTask(
  ...
  function(browser, accDoc) {
    ...
    testLinkIndexAtOffset(p, 0, 0); 
    testLinkIndexAtOffset(p, 1, 1); 
    testLinkIndexAtOffset(p, 2, -1); 
    testLinkIndexAtOffset(p, 3, -1); 
    testLinkIndexAtOffset(p, 5, -1); 
    testLinkIndexAtOffset(p, 7, -1); 
    testLinkIndexAtOffset(p, 8, 2); 
    testLinkIndexAtOffset(p, 9, 2); 
