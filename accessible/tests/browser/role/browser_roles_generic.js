...
addAccessibleTask(
  ...
  async function testARIARoleMap(browser, accDoc) {
    ...
    testRole(getAcc("aria_log"), ROLE_TEXT); 
    testRole(getAcc("aria_log_mixed"), ROLE_TEXT); 
    ...
    testRole(getAcc("aria_presentation"), ROLE_TEXT); 
    testRole(getAcc("aria_presentation_mixed"), ROLE_TEXT); 
    ...
    testRole(getAcc("aria_timer"), ROLE_TEXT); 
    testRole(getAcc("aria_timer_mixed"), ROLE_TEXT); 
