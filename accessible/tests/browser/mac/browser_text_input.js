...
function waitForTextEventDuo(eventName, expectedId) {
  return Promise.all([
...
async function synthKeyAndTestSelectionChanged(
  ...
  let valueChangedEvents = waitForTextEventDuo(
  ...
  is(rangeString, expectedSelectionString, "selection has correct length");
}
...
async function synthKeyAndTestValueChanged(
  ...
  let valueChangedEvents = waitForTextEventDuo("AXValueChanged", "input");
