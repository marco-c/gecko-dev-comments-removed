...
const COMPARE_TESTS = [
  { region: "US" },
  ["123 Main St.", "123 Main St.", SAME], 
  ["123 Main St. Apt 4, Floor 2", "123 Main St. Apt 4, Floor 2", SAME],
  ["123 Main St. Apt 4A, Floor 2", "123 main St. Apt 4a, Floor 2", SAME],
  ["123 Main St. Apt 4, Floor 2", "123 Main St. Suite 4, 2nd fl", SAME], 
  ["Main St.", "Main St.", SAME], 
  ["Main St.", "main st.", SAME], 

  ["123 Main St.", "Main St.", A_CONTAINS_B], 
  ["123 Main Lane St.", "123 Main St.", A_CONTAINS_B], 
  ["123 Main St. Apt 4", "Main St.", A_CONTAINS_B], 
  ["123 Main St. Apt 4, Floor 2", "123 Main St., Floor 2", A_CONTAINS_B],
  ["123 Main St. Floor 2", "Main St.", A_CONTAINS_B], 
  ["123 Main St. Apt 4, Floor 2", "123 Main St. Apt 4", A_CONTAINS_B],
  ["123 North-South Road", "123 North South Road", SIMILAR], 

  ["123 Main St. Apt 4, Floor 2", "1234 Main St. Apt 4, Floor 2", DIFFERENT], 
  ["123 Main St. Apt 4, Floor 2", "123 Mainn St. Apt 4, Floor 2", DIFFERENT], 
  [
    "123 Lane Main St. Apt 4, Floor 2",
    "123 Main Lane St. Apt 4, Floor 2",
    DIFFERENT,
  ], 
  ["123 Main St. Apt 4, Floor 2", "123 Main St. Apt 41, Floor 2", DIFFERENT], 
  ["123 Main St. Apt 4, Floor 2", "123 Main St. Apt 4, Floor 22", DIFFERENT], 
