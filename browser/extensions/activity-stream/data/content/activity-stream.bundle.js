  ...
  render() {
    ...
    if (!shouldShowEmptyState) {
      for (let i = 0; i < maxCards; i++) {
        ...
        cards.push(link ? __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0_content_src_components_Card_Card__["a" ], { key: i,
          index: i,
          className: className,
          dispatch: dispatch,
          link: link,
          ...
          isWebExtension: this.props.isWebExtension }) : __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0_content_src_components_Card_Card__["b" ], { key: i, className: className }));
      }
    }
