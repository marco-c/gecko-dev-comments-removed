...
describe("Highlights Feed", () => {
  ...
  describe("#fetchHighlights", () => {
    ...
    it("should chronologically order highlight data types", async () => {
      links = [
        {url: "https://site0.com", type: "bookmark", bookmarkGuid: "1234", date_added: Date.now() - 80}, 
        {url: "https://site1.com", type: "history", bookmarkGuid: "1234", date_added: Date.now() - 60}, 
        {url: "https://site2.com", type: "history", date_added: Date.now() - 160}, 
        {url: "https://site3.com", type: "history", date_added: Date.now() - 60}, 
        {url: "https://site4.com", type: "pocket", date_added: Date.now()}, 
    ...
    it("should sort bookmarks, pocket, and downloads chronologically", async () => {
      ...
      assert.equal(highlights[3].url, links[2].url); 
    });
