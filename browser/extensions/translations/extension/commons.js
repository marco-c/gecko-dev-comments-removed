...
var Scope =  (function () {
    ...
    Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
        var mergedBreadcrumb = __assign({ timestamp: (0,time.yW)() }, breadcrumb);
        this._breadcrumbs =
...
var Session =  (function () {
    ...
    Session.prototype.update = function (context) {
        ...
        if (context.sid) {
            ...
            this.sid = context.sid.length === 32 ? context.sid : (0,misc.DM)();
        }
        if (context.did) {
...
var Hub =  (function () {
    ...
    Hub.prototype.addBreadcrumb = function (breadcrumb, hint) {
        ...
        if (maxBreadcrumbs <= 0)
            return;
        var timestamp = (0,time.yW)();
        var mergedBreadcrumb = __assign({ timestamp: timestamp }, breadcrumb);
        var finalBreadcrumb = beforeBreadcrumb
            ? (0,misc.Cf)(function () { return beforeBreadcrumb(mergedBreadcrumb, hint); })
            : mergedBreadcrumb;
...
var BaseClient =  (function () {
    ...
    BaseClient.prototype._prepareEvent = function (event, scope, hint) {
        ...
        var prepared = __assign(__assign({}, event), { event_id: event.event_id || (hint && hint.event_id ? hint.event_id : (0,misc.DM)()), timestamp: event.timestamp || (0,time.yW)() });
...
function eventFromUnknownInput(exception, syntheticException, options) {
    ...
    (0,misc.Db)(event, "" + exception, undefined);
    (0,misc.EG)(event, {
        synthetic: true,
    });
    return event;
...
var BaseTransport =  (function () {
    ...
    BaseTransport.prototype._handleRateLimit = function (headers) {
        ...
        if (rlHeader) {
            ...
            this._rateLimits.all = new Date(now + (0,misc.JY)(now, raHeader));
            return true;
        }
        return false;
    };
            ...
            withScope(function (scope) {
                scope.addEventProcessor(function (event) {
                    ...
                    if (options.mechanism) {
                        (0,misc.Db)(processedEvent, undefined, undefined);
                        (0,misc.EG)(processedEvent, options.mechanism);
                    }
...
var Breadcrumbs =  (function () {
    ...
    Breadcrumbs.prototype._historyBreadcrumb = function (handlerData) {
        ...
        var parsedLoc = (0,misc.en)(global.location.href);
        var parsedFrom = (0,misc.en)(from);
        var parsedTo = (0,misc.en)(to);
...
var BrowserClient =  (function (_super) {
    ...
    BrowserClient.prototype.showReportDialog = function (options) {
        ...
        var document = (0,misc.Rf)().document;
        if (!document) {
            return;
        }
        if (!this._isEnabled()) {
...
var InboundFilters =  (function () {
    ...
    InboundFilters.prototype._getPossibleEventMessages = function (event) {
        ...
        if (event.exception) {
            try {
                ...
                logger.error("Cannot extract message for event " + (0,misc.jH)(event));
                return [];
            }
        }
        return [];
    ...
    InboundFilters.prototype._getEventFilterUrl = function (event) {
        try {
            ...
            logger.error("Cannot extract url for event " + (0,misc.jH)(event));
            return null;
        }
    };
...
var GlobalHandlers =  (function () {
    ...
    GlobalHandlers.prototype._enhanceEventWithInitialFrame = function (event, url, line, column) {
        ...
        var filename = isString(url) && url.length > 0 ? url : (0,misc.l4)();
...
var useragent_global = (0,misc.Rf)();
...
function getGlobalObject() {
    return ((0,_node__WEBPACK_IMPORTED_MODULE_0__ .KV)()
...
var DEFAULT_REQUEST_KEYS = ( null && (['cookies', 'data', 'headers', 'method', 'query_string', 'url']));
...
function getBrowserPerformance() {
    var performance = (0,_misc__WEBPACK_IMPORTED_MODULE_0__ .Rf)().performance;
...
function getNodePerformance() {
    try {
        var perfHooks = (0,_node__WEBPACK_IMPORTED_MODULE_1__ .l$)(module, 'perf_hooks');
...
var platformPerformance = (0,_node__WEBPACK_IMPORTED_MODULE_1__ .KV)() ? getNodePerformance() : getBrowserPerformance();
...
var timestampWithMs = ( null && (timestampInSeconds));
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "ArraySet": () => ( ArraySet),
  "ArraySetTypeInfo": () => ( ArraySetTypeInfo),
  "ArrayTypeInfo": () => ( ArrayTypeInfo),
  "BaseModel": () => ( BaseModel),
  "BooleanTypeInfo": () => ( BooleanTypeInfo),
  "BuiltInAction": () => ( BuiltInAction),
  "Draft": () => ( Draft),
  "ExtendedModel": () => ( ExtendedModel),
  "Frozen": () => ( Frozen),
  "FrozenCheckMode": () => ( FrozenCheckMode),
  "FrozenTypeInfo": () => ( FrozenTypeInfo),
  "HookAction": () => ( HookAction),
  "InternalPatchRecorder": () => ( InternalPatchRecorder),
  "LiteralTypeInfo": () => ( LiteralTypeInfo),
  "MobxKeystoneError": () => ( MobxKeystoneError),
  "Model": () => ( Model),
  "ModelAutoTypeCheckingMode": () => ( ModelAutoTypeCheckingMode),
  "ModelTypeInfo": () => ( ModelTypeInfo),
  "NumberTypeInfo": () => ( NumberTypeInfo),
  "ObjectMap": () => ( ObjectMap),
  "ObjectMapTypeInfo": () => ( ObjectMapTypeInfo),
  "ObjectTypeInfo": () => ( ObjectTypeInfo),
  "OrTypeInfo": () => ( OrTypeInfo),
  "RecordTypeInfo": () => ( RecordTypeInfo),
  "Ref": () => ( Ref),
  "RefTypeInfo": () => ( RefTypeInfo),
  "RefinementTypeInfo": () => ( RefinementTypeInfo),
  "SandboxManager": () => ( SandboxManager),
  "StringTypeInfo": () => ( StringTypeInfo),
  "TupleTypeInfo": () => ( TupleTypeInfo),
  "TypeCheckError": () => ( TypeCheckError),
  "TypeInfo": () => ( TypeInfo),
  "UncheckedTypeInfo": () => ( UncheckedTypeInfo),
  ...
  "actionCallToReduxAction": () => ( actionCallToReduxAction),
  "actionTrackingMiddleware": () => ( actionTrackingMiddleware),
  "addActionMiddleware": () => ( addActionMiddleware),
  "addActionToFnModel": () => ( addActionToFnModel),
  "addHiddenProp": () => ( addHiddenProp),
  "addLateInitializationFunction": () => ( addLateInitializationFunction),
  "applyAction": () => ( applyAction),
  "applyDelete": () => ( applyDelete),
  "applyMethodCall": () => ( applyMethodCall),
  "applyPatches": () => ( applyPatches),
  "applySerializedActionAndSyncNewModelIds": () => ( applySerializedActionAndSyncNewModelIds),
  "applySerializedActionAndTrackNewModelIds": () => ( applySerializedActionAndTrackNewModelIds),
  "applySet": () => ( applySet),
  ...
  "assertFnModelKeyNotInUse": () => ( assertFnModelKeyNotInUse),
  "assertIsFunction": () => ( assertIsFunction),
  "assertIsMap": () => ( assertIsMap),
  "assertIsModel": () => ( assertIsModel),
  "assertIsModelClass": () => ( assertIsModelClass),
  "assertIsObject": () => ( assertIsObject),
  "assertIsObservableArray": () => ( assertIsObservableArray),
  "assertIsObservableObject": () => ( assertIsObservableObject),
  "assertIsPlainObject": () => ( assertIsPlainObject),
  "assertIsPrimitive": () => ( assertIsPrimitive),
  "assertIsSet": () => ( assertIsSet),
  "assertIsString": () => ( assertIsString),
  "assertIsTreeNode": () => ( assertIsTreeNode),
  "assertTweakedObject": () => ( assertTweakedObject),
  "baseModelPropNames": () => ( baseModelPropNames),
  "canWrite": () => ( canWrite),
  "cannotSerialize": () => ( cannotSerialize),
  "checkModelDecoratorArgs": () => ( checkModelDecoratorArgs),
  "clone": () => ( clone),
  "computedWalkTreeAggregate": () => ( computedWalkTreeAggregate),
  "connectReduxDevTools": () => ( connectReduxDevTools),
  "createContext": () => ( createContext),
  "customRef": () => ( customRef),
  "debugFreeze": () => ( debugFreeze),
  "decorateWrapMethodOrField": () => ( decorateWrapMethodOrField),
  "decoratedModel": () => ( decoratedModel),
  "deepEquals": () => ( deepEquals),
  "deleteFromArray": () => ( deleteFromArray),
  "deserializeActionCall": () => ( deserializeActionCall),
  "deserializeActionCallArgument": () => ( deserializeActionCallArgument),
  "detach": () => ( detach),
  "draft": () => ( draft),
  "extendFnModelActions": () => ( extendFnModelActions),
  "extendFnModelSetterActions": () => ( extendFnModelSetterActions),
  "extendFnModelViews": () => ( extendFnModelViews),
  "failure": () => ( failure),
  "fastGetParent": () => ( fastGetParent),
  "fastGetParentIncludingDataObjects": () => ( fastGetParentIncludingDataObjects),
  "fastGetParentPath": () => ( fastGetParentPath),
  "fastGetParentPathIncludingDataObjects": () => ( fastGetParentPathIncludingDataObjects),
  "fastGetRoot": () => ( fastGetRoot),
  "fastGetRootPath": () => ( fastGetRootPath),
  "fastGetRootStore": () => ( fastGetRootStore),
  "fastIsModelDataObject": () => ( fastIsModelDataObject),
  "fastIsRootStore": () => ( fastIsRootStore),
  ...
  "frozen": () => ( frozen),
  "frozenKey": () => ( frozenKey),
  "getActionMiddlewares": () => ( getActionMiddlewares),
  "getActionProtection": () => ( getActionProtection),
  "getChildrenObjects": () => ( getChildrenObjects),
  "getCurrentActionContext": () => ( getCurrentActionContext),
  "getFnModelAction": () => ( getFnModelAction),
  "getGlobalConfig": () => ( getGlobalConfig),
  "getMobxVersion": () => ( getMobxVersion),
  "getModelDataType": () => ( getModelDataType),
  "getModelRefId": () => ( getModelRefId),
  "getNodeSandboxManager": () => ( getNodeSandboxManager),
  "getParent": () => ( getParent),
  "getParentPath": () => ( getParentPath),
  "getParentToChildPath": () => ( getParentToChildPath),
  "getRefsResolvingTo": () => ( getRefsResolvingTo),
  "getRoot": () => ( getRoot),
  ...
  "inDevMode": () => ( inDevMode),
  "instanceCreationDataTypeSymbol": () => ( instanceCreationDataTypeSymbol),
  "instanceDataTypeSymbol": () => ( instanceDataTypeSymbol),
  "internalApplyDelete": () => ( internalApplyDelete),
  "internalApplyMethodCall": () => ( internalApplyMethodCall),
  "internalApplyPatches": () => ( internalApplyPatches),
  "internalCustomRef": () => ( internalCustomRef),
  "internalPatchRecorder": () => ( internalPatchRecorder),
  "isArray": () => ( isArray),
  "isBuiltInAction": () => ( isBuiltInAction),
  "isChildOfParent": () => ( isChildOfParent),
  "isFrozenSnapshot": () => ( isFrozenSnapshot),
  "isHookAction": () => ( isHookAction),
  "isMap": () => ( isMap),
  "isModel": () => ( isModel),
  "isModelAction": () => ( isModelAction),
  "isModelAutoTypeCheckingEnabled": () => ( isModelAutoTypeCheckingEnabled),
  "isModelClass": () => ( isModelClass),
  "isModelDataObject": () => ( isModelDataObject),
  "isModelFlow": () => ( isModelFlow),
  "isModelSnapshot": () => ( isModelSnapshot),
  "isObject": () => ( isObject),
  "isParentOfChild": () => ( isParentOfChild),
  "isPlainObject": () => ( isPlainObject),
  "isPrimitive": () => ( isPrimitive),
  "isRefOfType": () => ( isRefOfType),
  "isReservedModelKey": () => ( isReservedModelKey),
  "isRoot": () => ( isRoot),
  "isRootStore": () => ( isRootStore),
  "isSandboxedNode": () => ( isSandboxedNode),
  "isSet": () => ( isSet),
  "isTreeNode": () => ( isTreeNode),
  "isTweakedObject": () => ( isTweakedObject),
  "jsonPatchToPatch": () => ( jsonPatchToPatch),
  "jsonPointerToPath": () => ( jsonPointerToPath),
  "lateVal": () => ( lateVal),
  "lazy": () => ( lazy),
  "logWarning": () => ( logWarning),
  "makePropReadonly": () => ( makePropReadonly),
  ...
  "modelInitializedSymbol": () => ( modelInitializedSymbol),
  "modelSnapshotInWithMetadata": () => ( modelSnapshotInWithMetadata),
  "modelSnapshotOutWithMetadata": () => ( modelSnapshotOutWithMetadata),
  "modelTypeKey": () => ( modelTypeKey),
  "noDefaultValue": () => ( noDefaultValue),
  "objectMap": () => ( objectMap),
  "onActionMiddleware": () => ( onActionMiddleware),
  "onChildAttachedTo": () => ( onChildAttachedTo),
  "onGlobalPatches": () => ( onGlobalPatches),
  "onPatches": () => ( onPatches),
  "onSnapshot": () => ( onSnapshot),
  "patchRecorder": () => ( patchRecorder),
  "patchToJsonPatch": () => ( patchToJsonPatch),
  "pathToJsonPointer": () => ( pathToJsonPointer),
  "prop": () => ( prop),
  "propTransform": () => ( propTransform),
  "prop_dateString": () => ( prop_dateString),
  "prop_dateTimestamp": () => ( prop_dateTimestamp),
  "prop_mapArray": () => ( prop_mapArray),
  "prop_mapObject": () => ( prop_mapObject),
  "prop_setArray": () => ( prop_setArray),
  "propsCreationDataTypeSymbol": () => ( propsCreationDataTypeSymbol),
  "propsDataTypeSymbol": () => ( propsDataTypeSymbol),
  "readonlyMiddleware": () => ( readonlyMiddleware),
  "reduxActionType": () => ( reduxActionType),
  "registerActionCallArgumentSerializer": () => ( registerActionCallArgumentSerializer),
  "registerRootStore": () => ( registerRootStore),
  "resolvePath": () => ( resolvePath),
  "resolvePathCheckingIds": () => ( resolvePathCheckingIds),
  "rootRef": () => ( rootRef),
  "runLateInitializationFunctions": () => ( runLateInitializationFunctions),
  "runUnprotected": () => ( runUnprotected),
  "runWithoutSnapshotOrPatches": () => ( runWithoutSnapshotOrPatches),
  "runningWithoutSnapshotOrPatches": () => ( runningWithoutSnapshotOrPatches),
  "sandbox": () => ( sandbox),
  "serializeActionCall": () => ( serializeActionCall),
  "serializeActionCallArgument": () => ( serializeActionCallArgument),
  "setCurrentActionContext": () => ( setCurrentActionContext),
  "setGlobalConfig": () => ( setGlobalConfig),
  "setToArray": () => ( setToArray),
  "simplifyActionContext": () => ( simplifyActionContext),
  "skipIdChecking": () => ( skipIdChecking),
  "stringAsDate": () => ( stringAsDate),
  "tProp": () => ( tProp),
  "tProp_dateString": () => ( tProp_dateString),
  "tProp_dateTimestamp": () => ( tProp_dateTimestamp),
  "tProp_mapArray": () => ( tProp_mapArray),
  "tProp_mapObject": () => ( tProp_mapObject),
  "tProp_setArray": () => ( tProp_setArray),
  "tag": () => ( tag),
  "timestampAsDate": () => ( timestampAsDate),
  "toTreeNode": () => ( toTreeNode),
  "transaction": () => ( transaction),
  "transactionMiddleware": () => ( transactionMiddleware),
  "tryUntweak": () => ( tryUntweak),
  "tweak": () => ( tweak),
  "tweakedObjects": () => ( tweakedObjects),
  "typeCheck": () => ( typeCheck),
  "types": () => ( types),
  "undoMiddleware": () => ( undoMiddleware),
  "unregisterRootStore": () => ( unregisterRootStore),
  "walkTree": () => ( walkTree),
  "withoutUndo": () => ( withoutUndo)
});
...
var MobxKeystoneError = function (_Error) {
...
var decoratorsSymbol = Symbol("decorators");
...
function toBase64(input) {
  ...
  for ( 
  var block = 0, charCode, idx = 0, map = chars; 
...
var localId = 0;
var localBaseId = shortenUuid( esm_browser_v4());
...
var noDefaultValue = Symbol("noDefaultValue");
...
var MemoTransformCache = function () {
...
var memoTransformCache = new MemoTransformCache();
var valueNotMemoized = Symbol("valueNotMemoized");
...
var updateDeepObjectChildren = (0,mobx_esm.action)(function (node) {
  var obj = objectChildren.get(node);
...
var addObjectChild = (0,mobx_esm.action)(function (node, child) {
  var obj = objectChildren.get(node);
...
var removeObjectChild = (0,mobx_esm.action)(function (node, child) {
  var obj = objectChildren.get(node);
...
var unsetInternalSnapshot = (0,mobx_esm.action)("unsetInternalSnapshot", function (value) {
...
var setInternalSnapshot = (0,mobx_esm.action)("setInternalSnapshot", function (value, standard) {
  var oldSn = getInternalSnapshot(value); 
...
var modelDataTypeCheckerSymbol = Symbol("modelDataTypeChecker");
var modelUnwrappedClassSymbol = Symbol("modelUnwrappedClass");
...
var modelPropertiesSymbol = Symbol("modelProperties");
...
var emptyPath = [];
var typeCheckersWithCachedResultsOfObject = new WeakMap();
...
var lateTypeCheckerSymbol = Symbol("lateTypeCheker");
...
var RefinementTypeInfo = function (_TypeInfo) {
...
var LiteralTypeInfo = function (_TypeInfo) {
...
var typesUndefined = typesLiteral(undefined);
...
var typesNull = typesLiteral(null);
...
var typesBoolean = new TypeChecker(function (value, path) {
...
var BooleanTypeInfo = function (_TypeInfo2) {
...
var typesNumber = new TypeChecker(function (value, path) {
...
var NumberTypeInfo = function (_TypeInfo3) {
...
var typesString = new TypeChecker(function (value, path) {
...
var StringTypeInfo = function (_TypeInfo4) {
...
var typesInteger = typesRefinement(typesNumber, function (n) {
...
var typesNonEmptyString = typesRefinement(typesString, function (s) {
  return s !== "";
}, "nonEmpty");
...
var cachedModelTypeChecker = new WeakMap();
...
var ModelTypeInfo = function (_TypeInfo) {
...
var hookActionValues = new Set( Object.values(HookAction));
...
var onAttachedDisposers = new WeakMap();





var attachToRootStore = (0,mobx_esm.action)("attachToRootStore", function (rootStore, child) {
...
var detachFromRootStore = (0,mobx_esm.action)("detachFromRootStore", function (child) {
...
var rootStores = new WeakSet();
var rootStoreAtoms = new WeakMap();
...
var registerRootStore = (0,mobx_esm.action)("registerRootStore", function (node) {
...
var unregisterRootStore = (0,mobx_esm.action)("unregisterRootStore", function (node) {
  if (!isRootStore(node)) {
...
var setParent = (0,mobx_esm.action)("setParent", function (value, parentPath, indexChangeAllowed, isDataObject) {
  if (isPrimitive(value)) {
    return;
  }
  ...
  if (value instanceof BaseModel) {
    ...
    var newRootStore = isRootStore(newRoot) ? newRoot : undefined; 
...
var InternalPatchRecorder = function () {
...
var patchListeners = new WeakMap();
...
var builtInActionValues = new Set( Object.values(BuiltInAction));
...
fromSnapshot = (0,mobx_esm.action)("fromSnapshot", fromSnapshot);
...
var wrappedInternalApplyPatches = lazy(function () {
  return wrapInAction({
    ...
    case "splice":
      {
        ...
        if (addedCount === removedCount) {
          ...
          var interimLen = oldLen - removedCount; 
...
var undefinedInsideArrayErrorMsg = "undefined is not supported inside arrays since it is not serializable in JSON, consider using null instead"; 
...
var tweak = (0,mobx_esm.action)("tweak", internalTweak);
...
var modelInitializersSymbol = Symbol("modelInitializers");
...
var internalNewModel = (0,mobx_esm.action)("newModel", function (origModelObj, initialData, options) {
  ...
  var obsData = tweakPlainObject(initialData, {
    parent: modelObj,
    path: "$"
  }, modelObj[modelTypeKey], false, true); 
...
var propsDataTypeSymbol = Symbol();




var propsCreationDataTypeSymbol = Symbol();




var instanceDataTypeSymbol = Symbol();




var instanceCreationDataTypeSymbol = Symbol();





var modelInitializedSymbol = Symbol("modelInitialized");
...
var baseModelPropNames = new Set([modelTypeKey, modelIdKey, "onInit", "$", "getRefId", "onAttachedToRootStore", "fromSnapshot", "typeCheck"]);
...
var modelFlowSymbol = Symbol("modelFlow");
...
var fnModelActionRegistry = new Map();
...
var wrappedInternalApplySnapshot = lazy(function () {
  return wrapInAction({
...
var wrappedInternalApplyDelete = lazy(function () {
  return wrapInAction({
...
var wrappedInternalApplyMethodCall = lazy(function () {
  return wrapInAction({
...
var wrappedInternalApplySet = lazy(function () {
  return wrapInAction({
...
var cannotSerialize = Symbol("cannotSerialize");
...
function rootPathToTargetPathIds(rootPath) {
  ...
  for (var i = 0; i < rootPath.path.length; i++) {
    var targetObj = rootPath.pathObjects[i + 1]; 
...
var plainObjectSerializer = {
  ...
  serialize: function serialize(value, _serialize) {
    if (!isPlainObject(value) && !(0,mobx_esm.isObservableObject)(value)) return cannotSerialize; 
...
function typesObjectHelper(objFn, frozen, typeInfoGen) {
  ...
  return lateTypeChecker(function () {
    ...
    var thisTc = new TypeChecker(function (obj, path) {
      if (!isObject(obj) || frozen && !(obj instanceof Frozen)) return new TypeCheckError(path, getTypeName(thisTc), obj); 
...
var ObjectTypeInfo = function (_TypeInfo) {
...
var FrozenTypeInfo = function (_TypeInfo2) {
...
var unchecked = new TypeChecker(null, function () {
  return "any";
}, function (t) {
...
var UncheckedTypeInfo = function (_TypeInfo) {
...
function decoratedModel(name, clazz, decorators) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(decorators); _i < _Object$entries.length; _i++) {
    ...
    var prototypeValueDesc = Object.getOwnPropertyDescriptor(clazz.prototype, k); 
...
var simpleDataContextSymbol = Symbol("simpleDataContext");
...
var ArrayTypeInfo = function (_TypeInfo) {
...
var UndoStore = function (_Model) {
  ...
  undoEvents: tProp( typesArray( typesUnchecked()), function () {
    return [];
  }),
  redoEvents: tProp( typesArray( typesUnchecked()), function () {
    return [];
  })
}));
...
UndoStore = __decorate([model("mobx-keystone/UndoStore")], UndoStore);
...
__decorate([mobx_esm.action], ContextClass.prototype, "unset", null); 
...
var _fnArray = fnModel("mobx-keystone/fnArray").actions({
...
var _fnObject = fnModel("mobx-keystone/fnObject").actions({
...
var observableMapBackedByObservableObject = (0,mobx_esm.action)(function (obj) {
  if (inDevMode()) {
...
var observableMapBackedByObservableArray = (0,mobx_esm.action)(function (array) {
  if (inDevMode()) {
...
var asMapTag = tag(function (objOrArray) {
...
var observableSetBackedByObservableArray = (0,mobx_esm.action)(function (array) {
  if (inDevMode()) {
    if (!(0,mobx_esm.isObservableArray)(array)) {
      throw failure("assertion failed: expected an observable array");
    }
...
var asSetTag = tag(function (array) {
...
var InternalImmutableDate = function (_Date) {
...
var stringAsDate = propTransform({
...
var timestampAsDate = propTransform({
  propToData: function propToData(prop) {
...
var objectBackRefs = new WeakMap();
...
function internalCustomRef(modelTypeId, resolverGen, getId, onResolvedValueChange) {
  ...
  var CustomRef = (_temp = function (_Ref) {
...
var customRef = (0,mobx_esm.action)("customRef", function (modelTypeId, options) {
  var _options$getId;
...
var computedIdTrees = new WeakMap();
...
var rootRef = (0,mobx_esm.action)("rootRef", function (modelTypeId, options) {
  var _options$getId;

  var getId = (_options$getId = options == null ? void 0 : options.getId) != null ? _options$getId : getModelRefId;
  var onResolvedValueChange = options == null ? void 0 : options.onResolvedValueChange; 
...
var toJSOptions = getMobxVersion() >= 6 ? undefined : {
...
var sandboxManagerContext = createContext();
...
var ArraySet = function (_Model) {
  ...
  items: tProp( typesArray( typesUnchecked()), function () {
    return [];
  })
}));
...
ArraySet = __decorate([model("mobx-keystone/ArraySet")], ArraySet);
...
var ArraySetTypeInfo = function (_TypeInfo) {
...
function typesOr() {
  ...
  return lateTypeChecker(function () {
    var checkers = orTypes.map(resolveTypeChecker); 
...
var OrTypeInfo = function (_TypeInfo) {
...
var RecordTypeInfo = function (_TypeInfo) {
...
var ObjectMap = function (_Model) {
  ...
  items: tProp( typesRecord( typesUnchecked()), function () {
    return {};
  })
}));
...
ObjectMap = __decorate([model("mobx-keystone/ObjectMap")], ObjectMap);
...
var ObjectMapTypeInfo = function (_TypeInfo) {
...
var typeName = "Ref";
var refDataTypeChecker = typesObject(function () {
  return {
    id: typesString
  };
});
var refTypeChecker = new TypeChecker(function (value, path) {
...
var RefTypeInfo = function (_TypeInfo) {
...
var TupleTypeInfo = function (_TypeInfo) {
...
var mobxDecoratorsSymbol = Symbol("mobx-decorators");
var mobxAppliedDecoratorsSymbol = Symbol("mobx-applied-decorators");
...
computed.struct = assign(function (target, property) {
...
function propagateChangeConfirmed(observable) {
  ...
  observable.lowestObserverState_ = IDerivationState_.STALE_;
  observable.observers_.forEach(function (d) {
    if (d.dependenciesState_ === IDerivationState_.POSSIBLY_STALE_) d.dependenciesState_ = IDerivationState_.STALE_;else if (d.dependenciesState_ === IDerivationState_.UP_TO_DATE_ 
...
var action = createActionFactory(false, ACTION);
var autoAction = createActionFactory(true, AUTOACTION);
...
var CACHED_ANNOTATIONS = Symbol("mobx-cached-annotations");
...
function getInferredAnnotation(desc, defaultAnnotation, autoBind) {
  ...
  if (isFunction(desc.value)) return isGenerator(desc.value) ? flow : isAction(desc.value) ? false : autoBind ? autoAction.bound : autoAction; 
...
function makeProperty(adm, owner, key, descriptor, annotation, forceCopy, 
autoBind) {
...
var ObservableObjectAdministration = function () {
  ...
  _proto.addComputedProp_ = function addComputedProp_(propertyOwner, 
  propName, options) {
    var target = this.target_;
