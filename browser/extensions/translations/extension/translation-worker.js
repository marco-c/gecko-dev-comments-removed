...
exports.modelRegistry = {
    ruen: {
        vocab: {
            ...
            expectedSha256Hash: "d52b077fd1a2633f8a833b5f50ec0a1d1775d1d82edf5f92fcae9be50cbee1a5",
        },
        lex: {
            name: "lex.50.50.ruen.s2t.bin",
            size: 4020736,
            estimatedCompressedSize: 2131338,
            expectedSha256Hash: "f34d96729e9c7ccd060109d9add03705b4f012ea5783ba3ad9c24ba57fe1813d",
        },
        model: {
            name: "model.ruen.intgemm.alphas.bin",
            size: 17140836,
            estimatedCompressedSize: 13170690,
            expectedSha256Hash: "5dd27f1c7c0872f1d544aa285828b5bcf71bfd923d07d1e493e354fb1d743655",
        },
    },
    csen: {
        vocab: {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.loadEmscriptenGlueCode = void 0;
...
function loadEmscriptenGlueCode(Module) {
    ...
    var MEMFS = {
        ...
        expandFileStorage: function (node, newCapacity) {
            ...
            newCapacity = Math.max(newCapacity, (prevCapacity * (prevCapacity < CAPACITY_DOUBLING_MAX ? 2 : 1.125)) >>>
                0);
            if (prevCapacity != 0)
    ...
    var _main_thread_futex = (Module["_main_thread_futex"] = 1563104);
...
exports.loadEmscriptenGlueCode = loadEmscriptenGlueCode;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getBergamotModelsForLanguagePair = exports.LanguagePairUnsupportedError = void 0;
const setupPersistRemoteFileWithProgressDuringDownload_1 = __webpack_require__( 5333);
const mb = bytes => Math.round((bytes / 1024 / 1024) * 10) / 10;
class LanguagePairUnsupportedError extends Error {
    constructor() {
        super(...arguments);
        this.name = "LanguagePairUnsupportedError";
    }
}
exports.LanguagePairUnsupportedError = LanguagePairUnsupportedError;
const getBergamotModelsForLanguagePair = (languagePair, bergamotModelsBaseUrl, modelRegistry, cache, log, onModelDownloadProgress) => __awaiter(void 0, void 0, void 0, function* () {
    if (!modelRegistry[languagePair]) {
        throw new LanguagePairUnsupportedError(`Language pair '${languagePair}' not supported`);
    }
    const downloadStart = Date.now();
    const modelRegistryEntry = modelRegistry[languagePair];
    const modelFiles = Object.keys(modelRegistryEntry).map((type) => {
        const { name, size, estimatedCompressedSize, expectedSha256Hash, } = modelRegistryEntry[type];
    ...
    const persistRemoteFileWithProgressDuringDownload = setupPersistRemoteFileWithProgressDuringDownload_1.setupPersistRemoteFileWithProgressDuringDownload(languagePair, persistFiles, cache, log, filesToTransferByType, bytesTransferredByType, broadcastDownloadProgressUpdate);
    const downloadedFiles = yield Promise.all(modelFiles.map(persistRemoteFileWithProgressDuringDownload));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const bergamot_translator_worker_1 = __webpack_require__( 31);
const getBergamotModelsForLanguagePair_1 = __webpack_require__( 3519);
const config_1 = __webpack_require__( 7843);
const modelRegistry_1 = __webpack_require__( 2050);
const setupPersistRemoteFileWithProgressDuringDownload_1 = __webpack_require__( 5333);
...
const init = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const remoteWasmBinary = {
        type: "wasm-binary",
        url: `${config_1.config.wasmBinariesBaseUrl}/${name}`,
        name,
        size: 6732404,
        estimatedCompressedSize: 1827872,
        expectedSha256Hash: "396d5e4df660f6746af00de961bfe257f7163e0f3aff413146072f93126e1c77",
    };
    const persistFiles = true;
    const wasmBinaryCache = yield caches.open("bergamot-wasm-binaries");
    const filesToTransferByType = { "wasm-binary": undefined };
    const bytesTransferredByType = { "wasm-binary": 0 };
    const persistRemoteFileWithProgressDuringDownload = setupPersistRemoteFileWithProgressDuringDownload_1.setupPersistRemoteFileWithProgressDuringDownload("bergamot-translator", persistFiles, wasmBinaryCache, log, filesToTransferByType, bytesTransferredByType, () => {
        console.log("WASM binary download progress update", {
            filesToTransferByType,
            bytesTransferredByType,
        });
    });
    const downloadedWasmBinary = yield persistRemoteFileWithProgressDuringDownload(remoteWasmBinary);
    const initialModule = {
        wasmBinary: downloadedWasmBinary.arrayBuffer,
    };
    const { addOnPreMain, Module } = bergamot_translator_worker_1.loadEmscriptenGlueCode(initialModule);
    addOnPreMain(function () {
        ...
        const downloadModel = (from, to, bergamotModelsBaseUrl, onModelDownloadProgress) => __awaiter(this, void 0, void 0, function* () {
            ...
            const downloadedFiles = yield getBergamotModelsForLanguagePair_1.getBergamotModelsForLanguagePair(languagePair, bergamotModelsBaseUrl, modelRegistry_1.modelRegistry, cache, log, onModelDownloadProgress);
        ...
        const loadModel = (from, to, bergamotModelsBaseUrl, onModelDownloadProgress) => __awaiter(this, void 0, void 0, function* () {
            ...
            const downloadedFilesByType = yield downloadModel(from, to, bergamotModelsBaseUrl, onModelDownloadProgress);
            const loadModelStart = performance.now();
            
            const constructAlignedMemoryFromBuffer = (buffer, alignmentSize) => {
                const byteArray = new Int8Array(buffer);
                
                const alignedMemory = new Module.AlignedMemory(byteArray.byteLength, alignmentSize);
...
`;
            ...
            model = new Module.TranslationModel(modelConfig, alignedModelMemory, alignedShortlistMemory, alignedVocabsMemoryList);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setupPersistRemoteFileWithProgressDuringDownload = exports.FileDownloadError = void 0;
const instrumentResponseWithProgressCallback_1 = __webpack_require__( 1136);
const persistResponse_1 = __webpack_require__( 1836);
const digestSha256_1 = __webpack_require__( 9493);
const throttle_1 = __webpack_require__( 2297);
...
const setupPersistRemoteFileWithProgressDuringDownload = (contextName, persistFiles, cache, log, filesToTransferByType, bytesTransferredByType, broadcastDownloadProgressUpdate) => {
    const throttledBroadcastDownloadProgressUpdate = throttle_1.throttle(broadcastDownloadProgressUpdate, 100);
    return ({ type, url, name, expectedSha256Hash }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (sha256Hash !== expectedSha256Hash) {
            console.warn(`File download integrity check failed for ${contextName}'s ${type} file`, {
                sha256Hash,
                expectedSha256Hash,
            });
            throw new FileDownloadError(`File download integrity check failed for ${contextName}'s ${type} file`);
        }
        return { type, name, arrayBuffer, downloaded, sha256Hash };
    });
};
exports.setupPersistRemoteFileWithProgressDuringDownload = setupPersistRemoteFileWithProgressDuringDownload;
...
exports.throttle = throttle;
 	...
 	var __webpack_exports__ = __webpack_require__(5716);
