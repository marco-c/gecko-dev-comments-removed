...
const PR_IRWXU = 0o700;  
const PR_IRUSR = 0o400;  
const PR_IWUSR = 0o200;  
const PR_IXUSR = 0o100;  
const PR_IRWXG = 0o070;  
const PR_IRGRP = 0o040;  
const PR_IWGRP = 0o020;  
const PR_IXGRP = 0o010;  
const PR_IRWXO = 0o007;  
const PR_IROTH = 0o004;  
const PR_IWOTH = 0o002;  
const PR_IXOTH = 0o001;  
...
class AudioConfig extends PP_Resource {
  constructor(instance, frameCount) {
    ...
    this.bufferSize = frameCount * 2  * 2 ;
  }
}
