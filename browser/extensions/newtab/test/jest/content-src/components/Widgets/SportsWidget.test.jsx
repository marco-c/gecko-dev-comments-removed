...
// A loaded watch-live payload whose non-empty your_region marks the user's
// region as supported, so the "Watch live" entry point renders.
const supportedWatchLive = {
  loaded: true,
  data: {
    your_region: [
      {
