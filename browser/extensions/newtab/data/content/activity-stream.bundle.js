...
class DiscoveryStreamAdminUI extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", null, external_React_default().createElement("button", {
      ...
      className: "large-data-container"
    }, this.renderBlocksData()), external_React_default().createElement("h3", null, "Weather Data"), this.renderWeatherData());
  }
}
...
function CardSections({
  ...
  if (interestPickerEnabled && personalizationEnabled && interestPicker?.sections) {
    ...
    sectionsToRender.splice(Math.min(sectionsToRender.length - 1, index), 0, external_React_default().createElement(InterestPicker, {
...
function SectionsMgmtPanel({
  ...
  const [followedSectionsState, setFollowedSectionsState] = (0,external_React_namespaceObject.useState)(followedSectionsPref); 
  const [blockedSectionsState, setBlockedSectionsState] = (0,external_React_namespaceObject.useState)(blockedSectionsPref); 
...
class ContentSection extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, !wallpapersV2Enabled && wallpapersEnabled && external_React_default().createElement("div", {
      className: "wallpapers-section"
    }, external_React_default().createElement(WallpapersSection, {
      setPref: setPref,
      activeWallpaper: activeWallpaper
    })), wallpapersV2Enabled && external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("div", {
      className: "wallpapers-section"
...
class _Weather extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    if (Weather.searchActive) {
      ...
      }, WEATHER_SUGGESTION.current_conditions.temperature[this.props.Prefs.values["weather.temperatureUnits"]], "\xB0", this.props.Prefs.values["weather.temperatureUnits"])), external_React_default().createElement("div", {
      ...
      }, external_React_default().createElement("span", null, WEATHER_SUGGESTION.forecast.high[this.props.Prefs.values["weather.temperatureUnits"]], "\xB0", this.props.Prefs.values["weather.temperatureUnits"]), external_React_default().createElement("span", null, "\u2022"), external_React_default().createElement("span", null, WEATHER_SUGGESTION.forecast.low[this.props.Prefs.values["weather.temperatureUnits"]], "\xB0", this.props.Prefs.values["weather.temperatureUnits"])), external_React_default().createElement("span", {
...
function WallpaperFeatureHighlight({
  ...
  let header = external_React_default().createElement("span", {
    className: "highlightHeader",
    "data-l10n-id": "newtab-wallpaper-feature-highlight-header"
  });
  let content = external_React_default().createElement("span", {
  ...
  if (highlightHeaderText) {
    header = external_React_default().createElement("span", {
      className: "highlightHeader"
    }, highlightHeaderText);
  }
  if (highlightContentText) {
    content = external_React_default().createElement("span", {
      className: "highlightContent"
    }, highlightContentText);
  }
  if (highlightCtaText) {
    button = external_React_default().createElement("button", {
      onClick: onToggleClick
    }, highlightCtaText);
  }
  return external_React_default().createElement("div", {
