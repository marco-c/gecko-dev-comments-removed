...
function Lists({
  ...
  }, external_React_default().createElement("fieldset", null, lists[selected]?.tasks.length >= 1 ? lists[selected].tasks.map(task => external_React_default().createElement(ListItem, {
