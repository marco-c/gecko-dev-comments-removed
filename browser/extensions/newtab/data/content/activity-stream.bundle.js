...
class _CardGrid extends (external_React_default()).PureComponent {
  ...
  renderCards() {
    ...
    for (let index = 0; index < items; index++) {
      ...
      cards.push(topicsLoading || this.props.placeholder || !rec || rec.placeholder || rec.flight_id && !spocsStartupCacheEnabled && this.props.App.isForStartupCache.DiscoveryStream ? external_React_default().createElement(PlaceholderDSCard, {
        key: `dscard-${index}`
...
function CardSection({
  ...
  return external_React_default().createElement("section", {
    ...
    className: "section-subtitle"
  }, subtitle)), showWeather && external_React_default().createElement(Weather_Weather, {
    isInSection: true
...
class BaseContent extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, shouldDisplayWeather && external_React_default().createElement(ErrorBoundary, null, external_React_default().createElement(Weather_Weather, null))), external_React_default().createElement("div", {
