...
class DiscoveryStreamAdminUI extends (external_React_default()).PureComponent {
  ...
  renderPersonalizationData() {
    ...
    }, "Inferred Interests:", external_React_default().createElement("pre", null, JSON.stringify(inferredInterests, null, 2)), this.renderInferredPersonalizationOverrides(), "Coarse Inferred Interests With Differential Privacy:", external_React_default().createElement("pre", null, JSON.stringify(coarsePrivateInferredInterests, null, 2)));
  }
  renderInferredPersonalizationOverrides() {
    ...
    return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("h3", null, "Inferred Personalization Overrides"), external_React_default().createElement("table", {
      ...
      className: "min"
    }, "Last refreshed"), external_React_default().createElement("td", {
      colSpan: "2"
    }, external_React_default().createElement("div", {
      className: "inferred-overrides-refresh"
    }, external_React_default().createElement("span", null, relativeTime(lastUpdated) || "(no data)"), external_React_default().createElement("moz-button", {
      type: "default",
      disabled: overridesEnabled ? null : true,
      onClick: this.refreshInferredPersonalizationAndDebug
    }, "Refresh"), external_React_default().createElement("moz-button", {
      type: "default",
