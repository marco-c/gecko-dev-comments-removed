...
class DiscoveryStreamAdminUI extends (external_React_default()).PureComponent {
  ...
  renderPersonalizationData() {
    ...
    return external_React_default().createElement("div", null, " ", "Inferred Intrests:", external_React_default().createElement("pre", null, JSON.stringify(inferredInterests, null, 2)), " Coarse Inferred Interests:", external_React_default().createElement("pre", null, JSON.stringify(coarseInferredInterests, null, 2)), " Coarse Inferred Interests With Differential Privacy:", external_React_default().createElement("pre", null, JSON.stringify(coarsePrivateInferredInterests, null, 2)));
  }
  renderFeedData(url) {
    const {
      feeds
  ...
  renderSpocs() {
    ...
    return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("table", null, external_React_default().createElement("tbody", null, external_React_default().createElement(Row, null, external_React_default().createElement("td", {
      ...
      className: "min"
    }, "spocs_endpoint"), external_React_default().createElement("td", null, unifiedAdsSpocsEnabled ? unifiedAdsEndpoint : spocs.spocs_endpoint)), external_React_default().createElement(Row, null, external_React_default().createElement("td", {
      className: "min"
  ...
  render() {
    ...
    return external_React_default().createElement("div", null, external_React_default().createElement("button", {
    ...
    }, "Refresh Inferred Personalization"), external_React_default().createElement("br", null), external_React_default().createElement("button", {
      className: "button",
    ...
    }, "Show Placeholder Cards"), " ", external_React_default().createElement("select", {
      className: "button",
      ...
      className: "large-data-container"
    }, this.renderBlocksData()), external_React_default().createElement("h3", null, "Weather Data"), this.renderWeatherData(), external_React_default().createElement("h3", null, "Personalization Data"), this.renderPersonalizationData());
  }
}
...
class CollapseToggle extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    })), renderAdmin ? external_React_default().createElement(DiscoveryStreamAdminInner, _extends({}, props, {
      collapsed: this.state.collapsed
    })) : null);
  }
}
const _DiscoveryStreamAdmin = props => external_React_default().createElement(SimpleHashRouter, null, external_React_default().createElement(CollapseToggle, props));
...
function SponsoredContentHighlight({
  ...
  return external_React_default().createElement("div", {
    ...
    dispatch: dispatch,
    message: external_React_default().createElement("span", null, "Sponsored content supports our mission to build a better web.", " ", external_React_default().createElement(SafeAnchor, {
      dispatch: dispatch,
      url: "https://support.mozilla.org/kb/pocket-sponsored-stories-new-tabs"
    }, "Find out how")),
...
class DSContextFooter extends (external_React_default()).PureComponent {
  render() {
    ...
    if (sponsorLabel || dsMessageLabel && context_type !== "pocket") {
      return external_React_default().createElement("div", {
        className: "story-footer"
      }, sponsorLabel, sponsorLabel && spocMessageVariant === "variant-b" && external_React_default().createElement(SponsoredContentHighlight, {
        dispatch: dispatch,
...
const DefaultMeta = ({
  ...
  return external_React_default().createElement("div", {
    ...
    className: "info-wrap"
  }, ctaButtonVariant !== "variant-b" && format !== "rectangle" && !refinedCardsLayout && external_React_default().createElement(DSSource, {
    source: source,
    ...
    className: "excerpt clamp"
  }, excerpt)), !isListCard && format !== "rectangle" && !mayHaveSectionsCards && mayHaveThumbsUpDown && !refinedCardsLayout && external_React_default().createElement(DSThumbsUpDownButtons, {
...
class _DSCard extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("article", {
      ...
      url: this.props.url,
      title: this.props.title
    }, this.props.showTopics && !this.props.mayHaveSectionsCards && this.props.topic && !isListCard && !refinedCardsLayout && external_React_default().createElement("span", {
      className: "ds-card-topic",
      "data-l10n-id": `newtab-topic-label-${this.props.topic}`
    }), external_React_default().createElement("div", {
      className: "img-wrapper"
    }, external_React_default().createElement(DSImage, {
      extraClassNames: "img",
...
class DSDismiss extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", {
      className: className
    }, this.props.children, external_React_default().createElement("button", {
...
function ListFeed({
  ...
  return listLength > 0 && external_React_default().createElement("div", {
    className: `list-feed ${fullList ? "full-height" : ""} ${listLength > 2 ? "span-2" : "span-1"}`
  }, external_React_default().createElement("div", {
    className: "list-feed-inner-wrapper"
  }, isFakespot ? external_React_default().createElement("div", {
    ...
    value: ""
  }, categoryTitle || "Holiday Gift Guide"), categories.map(category => external_React_default().createElement("option", {
    key: category,
    value: category
  }, category))), external_React_default().createElement("div", {
    className: "context-menu-wrapper"
  }, external_React_default().createElement(ContextMenuButton, null, external_React_default().createElement(LinkMenu, {
    dispatch: dispatch,
  ...
  }, listFeedTitle)) : external_React_default().createElement("h1", {
  ...
  }, external_React_default().createElement("p", null, footerCopy), external_React_default().createElement(SafeAnchor, {
...
function RecentSavesContainer({
  ...
  if (!visible) {
    return external_React_default().createElement(CardGrid_IntersectionObserver, {
      windowObj: windowObj,
  ...
  return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement(DSSubHeader, null, external_React_default().createElement("span", {
...
class _CardGrid extends (external_React_default()).PureComponent {
  ...
  renderCards() {
    ...
    return external_React_default().createElement((external_React_default()).Fragment, null, !isOnboardingExperienceDismissed && onboardingExperience && external_React_default().createElement(OnboardingExperience, {
      dispatch: this.props.dispatch
    }), essentialReadsCards?.length > 0 && external_React_default().createElement("div", {
      className: gridClassName
    }, essentialReadsCards), showRecentSaves && external_React_default().createElement(RecentSavesContainer, {
      gridClassName: gridClassName,
      dispatch: this.props.dispatch
    }), editorsPicksCards?.length > 0 && external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement(DSSubHeader, null, external_React_default().createElement("span", {
      className: "section-title"
    }, external_React_default().createElement(FluentOrText, {
      message: "Editor\u2019s Picks"
    }))), external_React_default().createElement("div", {
      className: gridClassName
    }, editorsPicksCards)), cards?.length > 0 && external_React_default().createElement((external_React_default()).Fragment, null, moreRecsHeader && external_React_default().createElement(DSSubHeader, null, external_React_default().createElement("span", {
      className: "section-title"
    }, external_React_default().createElement(FluentOrText, {
...
class DSSignup extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }), external_React_default().createElement("span", null, title, " ", external_React_default().createElement(SafeAnchor, {
      className: "ds-chevron-link",
      dispatch: dispatch,
      onLinkClick: this.onLinkClick,
      url: url
    }, excerpt)), external_React_default().createElement(ImpressionStats_ImpressionStats, {
      flightId: flight_id,
      rows: [{
        id,
        pos: 0,
...
class DSTextPromo extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement(DSDismiss, {
      ...
      className: "text"
    }, external_React_default().createElement("h3", null, `${title}\u2003`, external_React_default().createElement(SafeAnchor, {
      className: "ds-chevron-link",
      dispatch: this.props.dispatch,
      onLinkClick: this.onLinkClick,
      url: url
    }, cta)), external_React_default().createElement("p", {
      className: "subtitle"
    }, context)), external_React_default().createElement(ImpressionStats_ImpressionStats, {
      flightId: flight_id,
      rows: [{
        id,
        pos: 0,
...
class _PocketLoggedInCta extends (external_React_default()).PureComponent {
  render() {
    ...
    }, pocketCta.ctaButton ? pocketCta.ctaButton : external_React_default().createElement("span", {
      "data-l10n-id": "newtab-pocket-cta-button"
    })), external_React_default().createElement("a", {
      href: pocketCta.ctaUrl ? pocketCta.ctaUrl : "https://getpocket.com/"
    }, external_React_default().createElement("span", {
      className: "cta-text"
    }, pocketCta.ctaText ? pocketCta.ctaText : external_React_default().createElement("span", {
...
function CardSection({
  ...
  return external_React_default().createElement("section", {
    ...
    return index === 0 && shouldShowTrendingSearch && sectionKey === "top_stories_section" ? [card, external_React_default().createElement(TrendingSearches, {
      key: "trending"
    })] : [card];
  })));
}
function CardSections({
  ...
  if ((billboardEnabled || leaderboardEnabled) && spocs?.data?.newtab_spocs?.items) {
    ...
    if (spocToRender && !spocs.blocked.includes(spocToRender.url)) {
      ...
      if (promoCardEnabled) {
        sectionsToRender.splice(Math.min(sectionsToRender.length + 1, row), 0, external_React_default().createElement(PromoCard, null));
      }
    }
  }
...
function EditableText({
  ...
  return isEditing ? external_React_default().createElement("input", {
    className: `edit-${type}`,
    ref: inputRef,
    type: "text",
    value: tempValue,
...
class _DiscoveryStreamBase extends (external_React_default()).PureComponent {
  ...
  renderComponent(component) {
    switch (component.type) {
      ...
      case "TextPromo":
        return external_React_default().createElement(DSTextPromo, {
          dispatch: this.props.dispatch,
          type: component.type,
          data: component.data
        });
      case "Signup":
        return external_React_default().createElement(DSSignup, {
          dispatch: this.props.dispatch,
          type: component.type,
          data: component.data
        });
  ...
  render() {
    ...
    return external_React_default().createElement((external_React_default()).Fragment, null, this.props.DiscoveryStream.isPrivacyInfoModalVisible && external_React_default().createElement(DSPrivacyModal, {
      dispatch: this.props.dispatch
    }), (reportAdsEnabled && spocsEnabled || sectionsEnabled) && external_React_default().createElement(ReportContent, {
      spocs: DiscoveryStream.spocs
...
class ContentSection extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", {
    ...
    })), !mayHaveWidgets && mayHaveTrendingSearch && external_React_default().createElement("div", {
      id: "trending-search-section",
      className: "section"
    }, external_React_default().createElement("moz-toggle", {
      id: "trending-search-toggle",
      ...
      exitEventFired: exitEventFired
    }), mayHaveRecentSaves && external_React_default().createElement("div", {
      className: "check-wrapper",
      role: "presentation"
    }, external_React_default().createElement("input", {
...
class _Base extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement(BaseContent, Base_extends({}, this.props, {
      adminContent: this.state
    })), isDevtoolsEnabled ? external_React_default().createElement(DiscoveryStreamAdmin, {
