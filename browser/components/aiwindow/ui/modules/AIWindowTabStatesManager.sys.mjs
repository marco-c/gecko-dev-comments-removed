  ...
  #getTabsListener() {
    return {
      ...
      onLocationChange: async (
        ...
        // Open sidebar when navigating to non-AI pages (if not already open and user hasn't closed it)
        // Close sidebar when navigating to AI window (if currently open)
