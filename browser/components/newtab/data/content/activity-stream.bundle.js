...
class DiscoveryStreamAdmin extends (external_React_default()).PureComponent {
  ...
  renderSpocs() {
    ...
    return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("table", null, external_React_default().createElement("tbody", null, external_React_default().createElement(Row, null, external_React_default().createElement("td", {
      className: "min"
    }, "spocs_endpoint"), external_React_default().createElement("td", null, spocs.spocs_endpoint)), external_React_default().createElement(Row, null, external_React_default().createElement("td", {
      className: "min"
  ...
  render() {
    ...
    return external_React_default().createElement("div", null, external_React_default().createElement("button", {
    ...
    }, "Sync Remote Settings"), external_React_default().createElement("table", null, external_React_default().createElement("tbody", null, prefToggles.map(pref => external_React_default().createElement(Row, {
      key: pref
    }, external_React_default().createElement("td", null, external_React_default().createElement(TogglePrefCheckbox, {
      checked: config[pref],
      pref: pref,
      onChange: this.setConfigValue
    })))))), external_React_default().createElement("h3", null, "Endpoint variant"), external_React_default().createElement("p", null, "You can also change this manually by changing this pref:", " ", external_React_default().createElement("code", null, "browser.newtabpage.activity-stream.discoverystream.config")), external_React_default().createElement("table", {
      style: config.enabled && !config.hardcoded_layout ? null : {
        opacity: 0.5
      }
    }, external_React_default().createElement("tbody", null, Object.keys(LAYOUT_VARIANTS).map(id => external_React_default().createElement(Row, {
      key: id
    }, external_React_default().createElement("td", {
      className: "min"
      ...
      className: "min"
    }, id), external_React_default().createElement("td", null, LAYOUT_VARIANTS[id]))))), external_React_default().createElement("h3", null, "Caching info"), external_React_default().createElement("table", {
      ...
      className: "min"
    }, "Data last fetched"), external_React_default().createElement("td", null, relativeTime(lastUpdated) || "(no data)")))), external_React_default().createElement("h3", null, "Layout"), layout.map((row, rowIndex) => external_React_default().createElement("div", {
      key: `row-${rowIndex}`
...
class ASRouterAdminInner extends (external_React_default()).PureComponent {
  ...
  renderMessageItem(msg) {
    ...
    return external_React_default().createElement("tr", {
      ...
      className: "message-id"
    }, external_React_default().createElement("span", null, msg.id, " ", external_React_default().createElement("br", null))), external_React_default().createElement("td", null, external_React_default().createElement(ToggleMessageJSON, {
      msgId: `${msg.id}`,
    ...
    isBlocked ? null : isModified ? external_React_default().createElement("button", {
      className: "button restore" 
      ,
      onClick: e => this.resetJSON(msg)
    }, "Reset") : external_React_default().createElement("button", {
      className: "button show",
      onClick: this.handleOverride(msg.id)
    }, "Show"), isBlocked ? null : external_React_default().createElement("button", {
  ...
  renderPBMessageItem(msg) {
    ...
    return external_React_default().createElement("tr", {
      ...
      className: `button ${isBlocked ? "" : " primary"}`,
      onClick: isBlocked ? this.handleUnblock(msg) : this.handleBlock(msg)
    }, isBlocked ? "Unblock" : "Block"), external_React_default().createElement("button", {
      className: "ASRouterButton slim button",
      onClick: e => this.resetPBJSON(msg)
    }, "Reset JSON")), external_React_default().createElement("td", {
      className: `message-summary`
  ...
  renderMessages() {
    ...
    }, "Collapse/Expand All"), external_React_default().createElement("p", {
      className: "helpLink"
    }, external_React_default().createElement("span", {
  ...
  renderPBMessages() {
    ...
    return external_React_default().createElement("table", null, external_React_default().createElement("tbody", null, messagesToShow.map(msg => this.renderPBMessageItem(msg))));
  }
  ...
  renderMessageFilter() {
    ...
    return external_React_default().createElement("p", null, external_React_default().createElement("button", {
      className: "unblock-all ASRouterButton test-only",
      onClick: this.unblockAll
    }, "Unblock All Snippets"), "Show messages from ", external_React_default().createElement("select", {
      value: this.state.messageFilter,
      onChange: this.onChangeMessageFilter
    }, external_React_default().createElement("option", {
      value: "all"
    }, "all providers"), this.state.providers.map(provider => external_React_default().createElement("option", {
      key: provider.id,
      value: provider.id
    }, provider.id))), this.state.messageFilter !== "all" && !this.state.messageFilter.includes("_local_testing") ? external_React_default().createElement("button", {
  ...
  renderMessageGroupsFilter() {
    ...
    return external_React_default().createElement("p", null, "Show messages from ", external_React_default().createElement("select", {
      value: this.state.messageGroupsFilter,
      onChange: this.onChangeMessageGroupsFilter
    }, external_React_default().createElement("option", {
      value: "all"
    }, "all groups"), this.state.groups.map(group => external_React_default().createElement("option", {
      key: group.id,
      value: group.id
    }, group.id))));
  }
  ...
  renderTableHead() {
    return external_React_default().createElement("thead", null, external_React_default().createElement("tr", {
      className: "message-item"
    }, external_React_default().createElement("td", {
      className: "min"
    }), external_React_default().createElement("td", {
      className: "min"
    }, "Provider ID"), external_React_default().createElement("td", null, "Source"), external_React_default().createElement("td", {
      className: "min"
    }, "Cohort"), external_React_default().createElement("td", {
      className: "min"
    }, "Last Updated")));
  }
  ...
  renderProviders() {
    ...
    const userPrefInfo = this.state.userPrefs;
    return external_React_default().createElement("table", null, this.renderTableHead(), external_React_default().createElement("tbody", null, providersConfig.map((provider, i) => {
      ...
      if (provider.type === "remote") {
        label = external_React_default().createElement("span", null, "endpoint (", external_React_default().createElement("a", {
        ...
        label = external_React_default().createElement("span", null, "remote settings (", external_React_default().createElement("a", {
          className: "providerUrl",
          target: "_blank",
      ...
      return external_React_default().createElement("tr", {
        className: "message-item",
        key: i
      }, external_React_default().createElement("td", null, isTestProvider ? external_React_default().createElement("input", {
        type: "checkbox",
        disabled: true,
        readOnly: true,
        checked: true
      ...
      })), external_React_default().createElement("td", null, provider.id), external_React_default().createElement("td", null, external_React_default().createElement("span", {
        className: `sourceLabel${isUserEnabled && isSystemEnabled ? "" : " isDisabled"}`
      }, label)), external_React_default().createElement("td", null, provider.cohort), external_React_default().createElement("td", {
        style: {
          whiteSpace: "nowrap"
        }
  ...
  renderTargetingParameters() {
    ...
    return external_React_default().createElement("table", null, external_React_default().createElement("tbody", null, external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("h2", null, "Evaluate JEXL expression"))), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("p", null, external_React_default().createElement("textarea", {
      ref: "expressionInput",
      rows: "10",
      cols: "60",
      placeholder: "Evaluate JEXL expressions and mock parameters by changing their values below"
    })), external_React_default().createElement("p", null, "Status:", " ", external_React_default().createElement("span", {
      ref: "evaluationStatus"
    }, success ? "✅" : "❌", ", Result: ", result))), external_React_default().createElement("td", null, external_React_default().createElement("button", {
      className: "ASRouterButton secondary",
      onClick: this.handleExpressionEval
    }, "Evaluate"))), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("h2", null, "Modify targeting parameters"))), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("button", {
      className: "ASRouterButton secondary",
      ...
      const inputComp = (value && value.length) > 30 ? external_React_default().createElement("textarea", {
        name: param,
        className: className,
        value: value,
        rows: "10",
      ...
      return external_React_default().createElement("tr", {
        key: i
      }, external_React_default().createElement("td", null, param), external_React_default().createElement("td", null, inputComp));
    })));
  }
  ...
  renderDiscoveryStream() {
    ...
    return external_React_default().createElement("div", null, external_React_default().createElement("table", null, external_React_default().createElement("tbody", null, external_React_default().createElement("tr", {
      className: "message-item"
    }, external_React_default().createElement("td", {
      className: "min"
    }, "Enabled"), external_React_default().createElement("td", null, config.enabled ? "yes" : "no")), external_React_default().createElement("tr", {
      className: "message-item"
    }, external_React_default().createElement("td", {
      className: "min"
    }, "Endpoint"), external_React_default().createElement("td", null, config.endpoint || "(empty)")))));
  }

  renderAttributionParamers() {
    return external_React_default().createElement("div", null, external_React_default().createElement("h2", null, " Attribution Parameters "), external_React_default().createElement("p", null, " ", "This forces the browser to set some attribution parameters, useful for testing the Return To AMO feature. Clicking on 'Force Attribution', with the default values in each field, will demo the Return To AMO flow with the addon called 'uBlock Origin'. If you wish to try different attribution parameters, enter them in the text boxes. If you wish to try a different addon with the Return To AMO flow, make sure the 'content' text box has a string that is 'rta:base64(addonID)', the base64 string of the addonID prefixed with 'rta:'. The addon must currently be a recommended addon on AMO. Then click 'Force Attribution'. Clicking on 'Force Attribution' with blank text boxes reset attribution data."), external_React_default().createElement("table", null, external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " Source ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "source",
      placeholder: "addons.mozilla.org",
      value: this.state.attributionParameters.source,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " Medium ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "medium",
      placeholder: "referral",
      value: this.state.attributionParameters.medium,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " Campaign ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "campaign",
      placeholder: "non-fx-button",
      value: this.state.attributionParameters.campaign,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " Content ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "content",
      placeholder: `rta:${btoa("uBlock0@raymondhill.net")}`,
      value: this.state.attributionParameters.content,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " Experiment ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "experiment",
      placeholder: "ua-onboarding",
      value: this.state.attributionParameters.experiment,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " Variation ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "variation",
      placeholder: "chrome",
      value: this.state.attributionParameters.variation,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " User Agent ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "ua",
      placeholder: "Google Chrome 123",
      value: this.state.attributionParameters.ua,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, external_React_default().createElement("b", null, " Download Token ")), external_React_default().createElement("td", null, " ", external_React_default().createElement("input", {
      type: "text",
      name: "dltoken",
      placeholder: "00000000-0000-0000-0000-000000000000",
      value: this.state.attributionParameters.dltoken,
      onChange: this.onChangeAttributionParameters
    }), " ")), external_React_default().createElement("tr", null, external_React_default().createElement("td", null, " ", external_React_default().createElement("button", {
  ...
  renderErrorMessage({
    ...
    const providerId = external_React_default().createElement("td", {
    ...
    return errors.map(({
      error,
      timestamp
    }, cellKey) => external_React_default().createElement("tr", {
      key: cellKey
    }, cellKey === errors.length - 1 ? providerId : null, external_React_default().createElement("td", null, error.message), external_React_default().createElement("td", null, relativeTime(timestamp)))).reverse();
  }
  ...
  renderErrors() {
    ...
    if (providersWithErrors && providersWithErrors.length) {
      ...
      }, external_React_default().createElement("thead", null, external_React_default().createElement("tr", null, external_React_default().createElement("th", null, "Provider ID"), external_React_default().createElement("th", null, "Message"), external_React_default().createElement("th", null, "Timestamp"))), external_React_default().createElement("tbody", null, providersWithErrors.map(this.renderErrorMessage)));
    }
  ...
  renderPBTab() {
    ...
    return external_React_default().createElement("div", null, external_React_default().createElement("p", {
      ...
      className: "icon icon-small-spacer icon-info"
    }), " ", external_React_default().createElement("span", null, "To view an available message, select its radio button and click \"Open a Private Browsing Window\".", external_React_default().createElement("br", null), "To modify a message, make changes to the JSON first, then select the radio button. (To make new changes, click \"Reset Message State\", make your changes, and reselect the radio button.)", external_React_default().createElement("br", null), "Click \"Reset Message State\" to clear all message impressions and view messages in a clean state.", external_React_default().createElement("br", null), "Note that ContentSearch functions do not work in debug mode.")), external_React_default().createElement("div", null, external_React_default().createElement("button", {
      className: "ASRouterButton primary button",
      onClick: this.handleOpenPB
    }, "Open a Private Browsing Window"), external_React_default().createElement("button", {
      className: "ASRouterButton primary button",
      style: {
        marginInlineStart: 12
      },
      onClick: this.resetPBMessageState
    }, "Reset Message State"), external_React_default().createElement("br", null), external_React_default().createElement("input", {
      type: "radio",
      id: `clear radio`,
      name: "PB_message_radio",
    ...
    }), external_React_default().createElement("h2", null, "Messages"), external_React_default().createElement("button", {
      className: "ASRouterButton slim button" 
      ,
      onClick: e => this.toggleAllMessages(messagesToShow)
  ...
  getSection() {
    ...
    switch (section) {
      case "private":
        return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("h2", null, "Private Browsing Messages"), this.renderPBTab());
      ...
      case "groups":
        return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("h2", null, "Message Groups"), external_React_default().createElement("button", {
          className: "button",
          onClick: this.resetGroups
        }, "Reset group impressions"), external_React_default().createElement("table", null, external_React_default().createElement("thead", null, external_React_default().createElement("tr", {
          className: "message-item"
        }, external_React_default().createElement("td", null, "Enabled"), external_React_default().createElement("td", null, "Impressions count"), external_React_default().createElement("td", null, "Custom frequency"), external_React_default().createElement("td", null, "User preferences"))), external_React_default().createElement("tbody", null, this.state.groups && this.state.groups.map(({
          id,
          enabled,
          frequency,
          userPreferences = []
        }, index) => external_React_default().createElement(Row, {
          key: id
        }, external_React_default().createElement("td", null, external_React_default().createElement(TogglePrefCheckbox, {
          checked: enabled,
          pref: id,
          disabled: true
        })), external_React_default().createElement("td", null, this._getGroupImpressionsCount(id, frequency)), external_React_default().createElement("td", null, JSON.stringify(frequency, null, 2)), external_React_default().createElement("td", null, userPreferences.join(", ")))))), this.renderMessageGroupsFilter(), this.renderMessagesByGroup());

      case "ds":
        return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("h2", null, "Discovery Stream"), external_React_default().createElement(DiscoveryStreamAdmin, {
          state: {
      ...
      case "errors":
        return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("h2", null, "ASRouter Errors"), this.renderErrors());

      default:
        return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("h2", null, "Message Providers", " ", external_React_default().createElement("button", {
          title: "Restore all provider settings that ship with Firefox",
          className: "button",
          onClick: this.resetPref
        }, "Restore default prefs")), this.state.providers ? this.renderProviders() : null, external_React_default().createElement("h2", null, "Messages"), this.renderMessageFilter(), this.renderMessages());
    }
  }
  ...
  render() {
    ...
    }, "Private Browsing")), external_React_default().createElement("li", null, external_React_default().createElement("a", {
    ...
    }, "Message Groups")), external_React_default().createElement("li", null, external_React_default().createElement("a", {
      href: "#devtools-ds"
    }, "Discovery Stream")), external_React_default().createElement("li", null, external_React_default().createElement("a", {
      href: "#devtools-errors"
    }, "Errors")))), external_React_default().createElement("main", {
      className: "main-panel"
    }, external_React_default().createElement("h1", null, "AS Router Admin"), external_React_default().createElement("p", {
      className: "helpLink"
    }, external_React_default().createElement("span", {
      className: "icon icon-small-spacer icon-info"
...
const _ASRouterAdmin = props => external_React_default().createElement(SimpleHashRouter, null, external_React_default().createElement(CollapseToggle, props));
...
var omittedCloseTags = {
 ...
 const vendor_omittedCloseTags = (omittedCloseTags);
;
...
var voidElementTags = {
 ...
 const vendor_voidElementTags = (voidElementTags);
;
...
const ConditionalWrapper = ({
 ...
 const ConditionalWrapper_ConditionalWrapper = (ConditionalWrapper);
;
...
const ALLOWED_TAGS = {
  b: external_React_default().createElement("b", null),
  i: external_React_default().createElement("i", null),
  u: external_React_default().createElement("u", null),
  strong: external_React_default().createElement("strong", null),
  em: external_React_default().createElement("em", null),
  br: external_React_default().createElement("br", null)
};
...
class SimpleSnippet extends (external_React_default()).PureComponent {
  ...
  renderTitle() {
    ...
    return title ? external_React_default().createElement("h3", {
  ...
  renderText() {
    ...
    return external_React_default().createElement(RichText, {
  ...
  renderSectionHeader() {
    ...
    if (props.content.section_title_icon && props.content.section_title_text) {
      ...
      }, external_React_default().createElement(ConditionalWrapper_ConditionalWrapper, {
  ...
  render() {
    ...
    return external_React_default().createElement("div", {
    ...
    }, external_React_default().createElement(SnippetBase, SimpleSnippet_extends({}, props, {
      className: className,
      textStyle: this.props.textStyle
    }), sectionHeader, external_React_default().createElement(ConditionalWrapper_ConditionalWrapper, {
      ...
      alt: props.content.icon_alt_text || ICON_ALT_TEXT
    }), external_React_default().createElement("div", null, this.renderTitle(), " ", external_React_default().createElement("p", {
      className: "body"
    }, this.renderText()), this.props.extraContent), external_React_default().createElement("div", null, this.renderButton()))));
  }
...
class EOYSnippetBase extends (external_React_default()).PureComponent {
  ...
  renderDonations() {
    ...
    return external_React_default().createElement("form", {
      ...
      ref: "form"
    }, donationURLParams.map(([key, value], idx) => external_React_default().createElement("input", {
      type: "hidden",
      name: key,
      value: value,
      key: idx
    ...
    }, this.props.content.monthly_checkbox_label_text)), external_React_default().createElement("input", {
      type: "hidden",
      name: "frequency",
      value: "single"
    }), external_React_default().createElement("input", {
  ...
  render() {
    ...
    const customElement = external_React_default().createElement("em", {
      style: {
        backgroundColor: this.props.content.highlight_color
      }
    });
    return external_React_default().createElement(SimpleSnippet, EOYSnippet_extends({}, this.props, {
...
const EOYSnippet = props => {
  ...
  return external_React_default().createElement(EOYSnippetBase, EOYSnippet_extends({}, props, {
...
class SubmitFormSnippet extends (external_React_default()).PureComponent {
  ...
  renderHiddenFormInputs() {
    ...
    return Object.keys(hidden_inputs).map((key, idx) => external_React_default().createElement("input", {
      key: idx,
      type: "hidden",
      name: key,
  ...
  renderDisclaimer() {
    ...
    }, external_React_default().createElement(RichText, {
  ...
  renderSignupSubmitted() {
    ...
    return external_React_default().createElement(SnippetBase, this.props, external_React_default().createElement("div", {
      className: "submissionStatus"
    }, successTitle ? external_React_default().createElement("h2", {
      className: "submitStatusTitle"
    }, successTitle) : null, external_React_default().createElement("p", null, external_React_default().createElement(RichText, SubmitFormSnippet_extends({}, bodyText, {
      localization_id: isSuccess ? "success_text" : "error_text"
    })), isSuccess ? null : external_React_default().createElement(Button, {
  ...
  renderForm() {
    return external_React_default().createElement("form", {
      ...
      onSubmit: this.handleSubmit,
      ref: "form"
    }, this.renderHiddenFormInputs(), external_React_default().createElement("div", null, this.renderInput(), external_React_default().createElement("button", {
      type: "submit",
  ...
  renderSignupView() {
    ...
    return external_React_default().createElement(SnippetBase, SubmitFormSnippet_extends({}, this.props, {
      className: containerClass,
      footerDismiss: true
    }), this.renderScene2Icon(), external_React_default().createElement("div", {
      className: "message"
    }, external_React_default().createElement("p", null, content.scene2_title && external_React_default().createElement("h3", {
      className: "scene2Title"
    }, content.scene2_title), " ", content.scene2_text && external_React_default().createElement(RichText, {
  ...
  renderSignupViewAlt() {
    ...
    return external_React_default().createElement(SnippetBase, SubmitFormSnippet_extends({}, this.props, {
      ...
      ,
      footerDismiss: false
    }), this.renderSectionHeader(), this.renderScene2Icon(), external_React_default().createElement("div", {
      className: "message"
    }, external_React_default().createElement("p", null, content.scene2_text && external_React_default().createElement(RichText, {
      scene2_text: content.scene2_text,
      localization_id: "scene2_text"
    })), this.renderForm()));
  }
  ...
  render() {
    ...
    return external_React_default().createElement(SimpleSnippet, SubmitFormSnippet_extends({}, this.props, {
      content: content,
...
const FXASignupSnippet = props => {
  ...
  return external_React_default().createElement(SubmitFormSnippet, FXASignupSnippet_extends({}, props, {
    content: extendedContent,
...
const NewsletterSnippet = props => {
  ...
  return external_React_default().createElement(SubmitFormSnippet, NewsletterSnippet_extends({}, props, {
    content: extendedContent,
...
const SendToDeviceSnippet = props => {
  ...
  return external_React_default().createElement(SubmitFormSnippet, SendToDeviceSnippet_extends({}, propsWithDefaults, {
    form_method: "POST",
...
const SendToDeviceScene2Snippet = props => {
  return external_React_default().createElement(SendToDeviceSnippet, SendToDeviceSnippet_extends({
    expandedAlt: true
  }, props));
};
;
...
class SimpleBelowSearchSnippet extends (external_React_default()).PureComponent {
  ...
  renderText() {
    ...
    return props.content.text ? external_React_default().createElement(RichText, {
      text: props.content.text,
      customElements: this.props.customElements,
      localization_id: "text",
      links: props.content.links,
  ...
  renderTitle() {
    ...
    }, title, external_React_default().createElement("br", null)) : null;
  }
  ...
  render() {
    ...
    return external_React_default().createElement("div", {
      ...
      className: "snippet-hover-wrapper"
    }, external_React_default().createElement(SnippetBase, SimpleBelowSearchSnippet_extends({}, props, {
      className: className,
      textStyle: this.props.textStyle
    }), external_React_default().createElement("img", {
    ...
    }, this.renderTitle(), external_React_default().createElement("p", {
      className: "body"
    }, this.renderText()), this.props.extraContent), external_React_default().createElement("div", {
...
class ASRouterUISurface extends (external_React_default()).PureComponent {
  ...
  renderSnippets() {
    ...
    return external_React_default().createElement(ImpressionsWrapper, {
  ...
  renderPreviewBanner() {
    ...
    return external_React_default().createElement("div", {
      ...
      className: "icon icon-small-spacer icon-info"
    }), external_React_default().createElement("span", null, "Preview Purposes Only"));
  }
  ...
  render() {
    ...
    external_ReactDOM_default().createPortal( external_React_default().createElement((external_React_default()).Fragment, null, this.renderPreviewBanner(), this.renderSnippets()), this.footerPortal);
  }
...
const ImpressionStats_VISIBILITY_CHANGE_EVENT = "visibilitychange"; 
...
const DefaultMeta = ({
  ...
  className: "info-wrap"
}, external_React_default().createElement(DSSource, {
  source: source,
...
}, excerpt)), !newSponsoredLabel && external_React_default().createElement(DSContextFooter, {
...
class _DSCard extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", {
      ...
      saveToPocketCard: saveToPocketCard
    }), external_React_default().createElement(ImpressionStats, {
      flightId: this.props.flightId,
      rows: [{
        id: this.props.id,
        pos: this.props.pos,
    ...
    })), saveToPocketCard && external_React_default().createElement("div", {
      className: "card-stp-button-hover-background"
    }, external_React_default().createElement("div", {
      className: "card-stp-button-position-wrapper"
    }, !this.props.flightId && stpButton(), external_React_default().createElement(DSLinkMenu, {
      id: this.props.id,
      ...
      isRecentSave: isRecentSave
    }))), !saveToPocketCard && external_React_default().createElement(DSLinkMenu, {
      id: this.props.id,
      index: this.props.pos,
      dispatch: this.props.dispatch,
      url: this.props.url,
...
const PlaceholderDSCard = props => external_React_default().createElement(DSCard, {
  placeholder: true
});
;
...
function _TopicsWidget(props) {
  ...
  }, "More Topics"), external_React_default().createElement(ImpressionStats, {
    dispatch: dispatch,
    rows: [{
      id,
      pos: position
...
class _CardGrid extends (external_React_default()).PureComponent {
  renderCards() {
    ...
    for (let index = 0; index < items; index++) {
      ...
      cards.push(!rec || rec.placeholder ? external_React_default().createElement(PlaceholderDSCard, {
        key: `dscard-${index}`
    ...
    return external_React_default().createElement((external_React_default()).Fragment, null, ((_essentialReadsCards = essentialReadsCards) === null || _essentialReadsCards === void 0 ? void 0 : _essentialReadsCards.length) > 0 && external_React_default().createElement("div", {
      className: gridClassName
    }, essentialReadsCards), showRecentSaves && external_React_default().createElement(RecentSavesContainer, {
      gridClassName: gridClassName,
      dispatch: this.props.dispatch
    }), ((_editorsPicksCards = editorsPicksCards) === null || _editorsPicksCards === void 0 ? void 0 : _editorsPicksCards.length) > 0 && external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement(DSSubHeader, null, external_React_default().createElement("span", {
      className: "section-title"
    }, external_React_default().createElement(FluentOrText, {
      message: "Editor\u2019s Picks"
    }))), external_React_default().createElement("div", {
      className: gridClassName
    }, editorsPicksCards)), (cards === null || cards === void 0 ? void 0 : cards.length) > 0 && external_React_default().createElement((external_React_default()).Fragment, null, moreRecsHeader && external_React_default().createElement(DSSubHeader, null, external_React_default().createElement("span", {
      className: "section-title"
    }, external_React_default().createElement(FluentOrText, {
...
class _CollapsibleSection extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, learnMore && external_React_default().createElement("span", {
...
class DSSignup extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", {
      ...
      url: url
    }, excerpt)), external_React_default().createElement(ImpressionStats, {
      flightId: flight_id,
      rows: [{
        id,
        pos: 0,
...
class DSTextPromo extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement(DSDismiss, {
      ...
      className: "subtitle"
    }, context)), external_React_default().createElement(ImpressionStats, {
      flightId: flight_id,
      rows: [{
        id,
        pos: 0,
...
class TopSiteLink extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("li", TopSite_extends({
    ...
    })))), children, link.type === SPOC_TYPE ? external_React_default().createElement(ImpressionStats, {
      ...
      dispatch: this.props.dispatch,
      source: TOP_SITES_SOURCE
    }) : null, link.sponsored_position ? external_React_default().createElement(TopSiteImpressionWrapper, {
      tile: {
...
class _TopSites extends (external_React_default()).PureComponent {
  ...
  _getVisibleTopSites() {
    ...
    let sitesPerRow = Reducers.TOP_SITES_MAX_SITES_PER_ROW; 
  ...
  renderComponent(component, embedWidth) {
    ...
    switch (component.type) {
      ...
      case "TopSites":
        ...
        return external_React_default().createElement(TopSites, {
...
class _Search extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", {
      ...
      className: "search-inner-wrapper"
    }, external_React_default().createElement("button", Search_extends({
      className: "search-handoff-button"
    }, this.getHandoffInputL10nAttributes(), {
      ref: this.onSearchHandoffButtonMount,
      onClick: this.onSearchHandoffClick,
      tabIndex: "-1"
    }), external_React_default().createElement("div", Search_extends({
      className: "fake-textbox"
    }, this.getHandoffTextL10nAttributes())), external_React_default().createElement("input", {
      type: "search",
...
class _Base extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    })), isDevtoolsEnabled ? external_React_default().createElement(ASRouterAdmin, {
...
class BaseContent extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, external_React_default().createElement(ErrorBoundary, null, external_React_default().createElement(Search, Base_extends({
      showLogo: noSectionsEnabled || prefs["logowordmark.alwaysVisible"],
      handoffEnabled: searchHandoffEnabled
    }, props.Search)))), external_React_default().createElement(ASRouterUISurface, {
    ...
    })) : external_React_default().createElement(Sections, null)), external_React_default().createElement(ConfirmDialog, null))));
  }
