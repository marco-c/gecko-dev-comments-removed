...
class DiscoveryStreamAdminUI extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, "Sync Remote Settings"), external_React_default().createElement("br", null), external_React_default().createElement("button", {
      className: "button",
      onClick: this.showPlaceholder
    }, "Show Placeholder Cards"), external_React_default().createElement("table", null, external_React_default().createElement("tbody", null, prefToggles.map(pref => external_React_default().createElement(Row, {
      key: pref
...
class _DSCard extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, this.props.topic), external_React_default().createElement("div", {
...
class _CardGrid extends (external_React_default()).PureComponent {
  renderCards() {
    ...
    for (let index = 0; index < items; index++) {
      ...
      cards.push(!rec || rec.placeholder || rec.flight_id && !spocsStartupCacheEnabled && this.props.App.isForStartupCache ? external_React_default().createElement(PlaceholderDSCard, {
        key: `dscard-${index}`
