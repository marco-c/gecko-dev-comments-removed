...
const MESSAGE_TYPE_LIST = ["BLOCK_MESSAGE_BY_ID", "USER_ACTION", "IMPRESSION", "TRIGGER", "NEWTAB_MESSAGE_REQUEST", 
"PBNEWTAB_MESSAGE_REQUEST", "DOORHANGER_TELEMETRY", "TOOLBAR_BADGE_TELEMETRY", "TOOLBAR_PANEL_TELEMETRY", "MOMENTS_PAGE_TELEMETRY", "INFOBAR_TELEMETRY", "SPOTLIGHT_TELEMETRY", "TOAST_NOTIFICATION_TELEMETRY", "AS_ROUTER_TELEMETRY_USER_EVENT", 
...
class TopSiteLink extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    })))), children, link.type === SPOC_TYPE ? external_React_default().createElement(ImpressionStats_ImpressionStats, {
  ...
  renderComponent(component, embedWidth) {
    ...
    switch (component.type) {
      ...
      case "TopSites":
        ...
        return external_React_default().createElement(DiscoveryStreamComponents_TopSites_TopSites_TopSites, {
...
class BaseContent extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    })) : external_React_default().createElement(Sections_Sections, null)), external_React_default().createElement(ConfirmDialog, null))));
  }
