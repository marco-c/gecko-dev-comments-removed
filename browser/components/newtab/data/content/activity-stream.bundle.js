...
const DefaultMeta = ({
  ...
  className: "info-wrap"
}, ctaButtonVariant !== "variant-b" && external_React_default().createElement(DSSource, {
  source: source,
...
class _WallpaperCategories extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", null, external_React_default().createElement("h2", {
      "data-l10n-id": "newtab-wallpaper-title"
    }, "Wallpapers"), external_React_default().createElement("button", {
      className: "wallpapers-reset",
      onClick: this.handleReset,
      "data-l10n-id": "newtab-wallpaper-reset"
      ...
      }), external_React_default().createElement("label", null, category));
    })), external_React_default().createElement(external_ReactTransitionGroup_namespaceObject.CSSTransition, {
      in: !!activeCategory,
      timeout: 300,
    ...
    }, "back arrow"), external_React_default().createElement("h2", null, activeCategory), external_React_default().createElement("fieldset", null, filteredWallpapers.map(({
      title,
      theme,
      fluent_id
    }) => {
...
class ContentSection extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, wallpapersEnabled && external_React_default().createElement("div", {
...
function LocationSearch({
  ...
  }, (suggestedLocations || []).map(location => external_React_default().createElement("option", {
    value: location.key,
    key: location.key
...
class _Weather extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    if (Weather.searchActive) {
      ...
      }, WEATHER_SUGGESTION.current_conditions.summary)) : null)), external_React_default().createElement("div", {
...
class BaseContent extends (external_React_default()).PureComponent {
  ...
  renderWallpaperAttribution() {
    ...
    if (activeWallpaper && wallpaperList && name.url) {
      return external_React_default().createElement("p", {
        ...
        href: name.url
      }, name.string), external_React_default().createElement("a", {
  ...
  render() {
    ...
    })) : external_React_default().createElement(Sections_Sections, null)), external_React_default().createElement(ConfirmDialog, null), wallpapersEnabled && this.renderWallpaperAttribution()), external_React_default().createElement("aside", null, weatherEnabled && external_React_default().createElement(ErrorBoundary, null, external_React_default().createElement(Weather_Weather, null)))));
  }
}
