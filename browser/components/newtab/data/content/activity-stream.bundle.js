...
class DiscoveryStreamAdminUI extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    return external_React_default().createElement("div", null, external_React_default().createElement("button", {
      ...
      className: "large-data-container"
    }, this.renderImpressionsData()), external_React_default().createElement("h3", null, "Weather Data"), this.renderWeatherData());
  }
}
...
class _DSCard extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }, saveToPocketCard && !isListCard && external_React_default().createElement((external_React_default()).Fragment, null, !this.props.flightId && stpButton()), !isFakespot && external_React_default().createElement(DSLinkMenu, {
      id: this.props.id,
