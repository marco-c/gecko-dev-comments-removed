...
function RecentSavesContainer({
  ...
  return external_React_default().createElement(GridContainer, {
    className: className,
...
class _CardGrid extends (external_React_default()).PureComponent {
  ...
  renderCards() {
    ...
    return external_React_default().createElement((external_React_default()).Fragment, null, ((_essentialReadsCards = essentialReadsCards) === null || _essentialReadsCards === void 0 ? void 0 : _essentialReadsCards.length) > 0 && external_React_default().createElement(GridContainer, {
      className: className
    }, essentialReadsCards), recentSavesEnabled && external_React_default().createElement(RecentSavesContainer, {
      className: className,
      dispatch: this.props.dispatch
    }), ((_editorsPicksCards = editorsPicksCards) === null || _editorsPicksCards === void 0 ? void 0 : _editorsPicksCards.length) > 0 && external_React_default().createElement(GridContainer, {
      className: className,
...
class ContentSection extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    })), this.props.mayHaveSponsoredTopSites && external_React_default().createElement("div", {
    ...
    })))))), this.props.pocketRegion && external_React_default().createElement("div", {
      id: "pocket-section",
      className: "section"
    }, external_React_default().createElement("label", {
      className: "switch"
    ...
    }), this.props.mayHaveSponsoredStories && external_React_default().createElement("div", {
    ...
    })), recentSavesExperiment && external_React_default().createElement("div", {
      className: "check-wrapper",
      role: "presentation"
    }, external_React_default().createElement("input", {
