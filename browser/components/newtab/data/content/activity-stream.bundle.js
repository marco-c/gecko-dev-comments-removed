...
const ImpressionsSection = ({
  ...
  }, external_React_default().createElement(ImpressionsItem, {
...
const ImpressionsItem = ({
  ...
  return external_React_default().createElement("div", {
  ...
  }, label), description ? external_React_default().createElement("p", {
    className: "impressions-description"
  }, description) : null, external_React_default().createElement("div", {
    ...
    onClick: handleSave
  }, "Save"), external_React_default().createElement("button", {
...
class ASRouterAdminInner extends (external_React_default()).PureComponent {
  ...
  getSection() {
    ...
    switch (section) {
      ...
      case "impressions":
        return external_React_default().createElement((external_React_default()).Fragment, null, external_React_default().createElement("h2", null, "Impressions"), external_React_default().createElement(ImpressionsSection, {
  ...
  render() {
    ...
    }, "Impressions")), external_React_default().createElement("li", null, external_React_default().createElement("a", {
      href: "#devtools-ds"
