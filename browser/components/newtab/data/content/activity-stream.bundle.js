...
const DSMessageLabel = props => {
  ...
  if (!context && (context_type || display_engagement_labels && engagement)) {
    ...
    }, engagement && !context_type ? external_React_default().createElement("div", {
      className: "story-view-count"
    }, engagement) : external_React_default().createElement(StatusMessage, {
      icon: icon,
      fluentID: fluentID
    })));
  }
...
}, excerpt), cta_variant === "link" && cta && external_React_default().createElement("div", {
  role: "link",
  className: "cta-link icon icon-arrow",
  tabIndex: "0"
}, cta)), !newSponsoredLabel && external_React_default().createElement(DSContextFooter, {
...
const CTAButtonMeta = ({
  ...
  className: "source clamp"
}, context && external_React_default().createElement(FluentOrText, {
  message: {
...
}), !context && (sponsor ? sponsor : source)), external_React_default().createElement("header", {
  title: title,
  className: "title clamp"
}, title), excerpt && external_React_default().createElement("p", {
  className: "excerpt clamp"
}, excerpt)), context && cta && external_React_default().createElement("button", {
  className: "button cta-button"
}, cta), !context && external_React_default().createElement(DSContextFooter, {
  context_type: context_type,
  context: context,
  sponsor: sponsor,
  sponsored_by_override: sponsored_by_override,
...
class _DSCard extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    }), this.props.is_video && external_React_default().createElement("div", {
      className: "playhead"
    }, external_React_default().createElement("span", null, "Video Content"))), isButtonCTA ? external_React_default().createElement(CTAButtonMeta, {
...
const LastCardMessage = props => external_React_default().createElement(DSCard, {
  lastCard: true
});
;
...
class _CardGrid extends (external_React_default()).PureComponent {
  ...
  render() {
    ...
    })) : this.renderCards(), this.showLoadMore && external_React_default().createElement("button", {
