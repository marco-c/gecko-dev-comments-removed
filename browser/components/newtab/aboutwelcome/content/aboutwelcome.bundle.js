...
const ProtonScreenActionButtons = props => {
  ...
  })), content.checkbox ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
class ProtonScreen extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  renderContentTiles() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, content.tiles && content.tiles.type === "colorway" && content.tiles.colorways ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_MRColorways__WEBPACK_IMPORTED_MODULE_2__.Colorways, {
      content: content,
      activeTheme: this.props.activeTheme,
  ...
  renderSecondarySection(content) {
    ...
    }, content.image_alt_text ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
    ...
    }, content.dismiss_button ? this.renderDismissButton() : null, content.logo ? this.renderLogo(content.logo) : null, isRtamo ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      handleAction: this.props.handleAction
    })), hideStepsIndicator ? null : react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
