...
__webpack_require__.r(__webpack_exports__);
 ...
 var _LegalParagraph__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(18);
...
const ProtonScreenActionButtons = props => {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: `${((_content$primary_butt2 = content.primary_button) === null || _content$primary_butt2 === void 0 ? void 0 : _content$primary_butt2.style) ?? "primary"}${(_content$primary_butt3 = content.primary_button) !== null && _content$primary_butt3 !== void 0 && _content$primary_butt3.has_arrow_icon ? " arrow-icon" : ""}` 
...
class ProtonScreen extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  renderTitle({
    ...
    }, this.renderLogo(title_logo), react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_MSLocalized__WEBPACK_IMPORTED_MODULE_1__.Localized, {
      text: title
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
      ...
      handleAction: this.props.handleAction
    }) : null, content.legal_paragraph ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_LegalParagraph__WEBPACK_IMPORTED_MODULE_15__.LegalParagraph, {
      content: content,
      handleAction: this.props.handleAction
...
const LegalParagraph = props => {
  ...
  return (
    ...
    }, legal_paragraph.text.string_id ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, legal_paragraph === null || legal_paragraph === void 0 ? void 0 : legal_paragraph.link_keys.map(link => react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
