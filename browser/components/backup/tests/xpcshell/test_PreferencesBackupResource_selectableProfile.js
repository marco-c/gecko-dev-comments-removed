...
add_task(async function test_recover_regular_profile_no_storeID_in_prefs() {
  ...
  sandbox.stub(SelectableProfileService, "currentProfile").value(null);
...
add_task(async function test_recover_into_selectable_profile_writes_storeID() {
  ...
  sandbox.stub(SelectableProfileService, "currentProfile").value({ id: 1 });
  sandbox
    .stub(SelectableProfileService, "addSelectableProfilePrefs")
