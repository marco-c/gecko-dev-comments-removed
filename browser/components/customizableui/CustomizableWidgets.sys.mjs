  ...
  CustomizableWidgets.push({
    ...
    onBuild(aDocument) {
      ...
      const enableDisableButton = () => {
        node.disabled =
          !aDocument.ownerGlobal.gSync.sendTabToolbarButtonShouldBeEnabled(
            aDocument.ownerGlobal.gBrowser.currentURI
          );
      };
      ...
      aDocument.ownerGlobal.addEventListener("TabSelect", enableDisableButton);
      ...
      aDocument.ownerGlobal.gBrowser.addTabsProgressListener(locationListener);
      ...
      const widgetListener = {
        onWidgetInstanceRemoved: (aWidgetId, aDoc) => {
          ...
          aDocument.ownerGlobal.removeEventListener(
            "TabSelect",
            enableDisableButton
          );
          aDocument.ownerGlobal.gBrowser.removeTabsProgressListener(
            locationListener
          );
        },
      };
      ...
      popup.addEventListener("popupshowing", () =>
        aDocument.ownerGlobal.gSync.populateSendTabToolbarButton(popup)
      );
