...
add_task(async function sortingCheck() {
  ...
  const container = win.document.getElementById("handlersView");
  const firstItem = container.querySelector("richlistitem");
  ...
  Assert.equal(actionColumn.getAttribute("sortDirection"),
    ...
    let siteItems = container.getElementsByTagName("richlistitem");
