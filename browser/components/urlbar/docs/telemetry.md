...
- `autofill_adaptive`
  ...
  document][adaptive history autofill document].
- `history_autofill_fallback_origin`
  ...
  navigation.
- `autofill_origin`
  An autofilled [origin] from the user's history. Typically "origin" means a
  ...
  history autofill document][adaptive history autofill document].
- `autofill_other`
  Counts how many times some other type of autofill result that does not have
...
- `autofill_url`
  ...
  [adaptive history autofill document].
- `bookmark`
  A bookmarked URL.
- `bookmark_adaptive`
...
: Firefox 141
  ...
  : The "actions" key was added to the engagement event. \[Bug [1893067]\]

  Firefox 125

  : The "impression" engagement event has been removed. \[Bug [1878983]\]

## Custom pings for Contextual Services

Contextual Services currently has two features involving the address bar, top
sites and Firefox Suggest. Top sites telemetry is sent in the ["top-sites" ping],
...
: Firefox 122.0
  ...
  : PingCentre-sent custom pings removed. \[Bug [1868580]\]

  Firefox 116.0

  : The "top-sites" ping is implemented. \[Bug [1836283]\]
...
["top-sites" ping]: https://mozilla.github.io/glean/book/user/pings/custom.html
[1836283]: https://bugzilla.mozilla.org/show_bug.cgi?id=1836283
[1868580]: https://bugzilla.mozilla.org/show_bug.cgi?id=1868580
[1878983]: https://bugzilla.mozilla.org/show_bug.cgi?id=1878983
[1893067]: https://bugzilla.mozilla.org/show_bug.cgi?id=1893067
[1919180]: https://bugzilla.mozilla.org/show_bug.cgi?id=1919180
[1971534]: https://bugzilla.mozilla.org/show_bug.cgi?id=1971534
[abandonment]: https://dictionary.telemetry.mozilla.org/apps/firefox_desktop/metrics/urlbar_abandonment
...
[engagement]: https://dictionary.telemetry.mozilla.org/apps/firefox_desktop/metrics/urlbar_engagement
[origin]: https://html.spec.whatwg.org/multipage/origin.html#origin
[the search telemetry]: /browser/search/telemetry.html
