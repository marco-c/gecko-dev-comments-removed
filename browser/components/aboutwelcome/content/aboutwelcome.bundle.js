...
class ProtonScreen extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
      ...
      handleAction: this.props.handleAction,
      position: "top"
    }) : null, includeNoodles ? this.renderNoodles() : null, content.dismiss_button ? this.renderDismissButton() : null, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      style: {
        justifyContent: content.split_content_justify_content ? content.split_content_justify_content : null
      }
    }, (content.title || content.subtitle) && react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
