...
__webpack_require__.r(__webpack_exports__);
 ...
 var _lib_addUtmParams_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(23);
...
class ProtonScreen extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
    ...
    }, content.logo && !content.fullscreen ? this.renderPicture(content.logo) : null, isRtamo && !content.fullscreen ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      alt: "",
      role: "presentation"
    })) : null, content.title || content.subtitle ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
