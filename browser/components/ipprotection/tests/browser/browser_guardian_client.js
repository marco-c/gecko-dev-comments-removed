...
add_task(async function test_enroll() {
  ...
  const testcases = [
    ...
    {
      name: "Failed enrollment - fxa requires login",
      responseURL: "/oauth/success?error=login_needed",
      expects: {
        ok: false,
        error: "login_needed",
      },
    ...
    {
      name: "Failed enrollment - Guardian rejects enrollment",
      responseURL: "/api/v1/fpn/error?error=access_denied",
      expects: {
        ok: false,
        error: "access_denied",
      },
    ...
    {
      name: "Failed enrollment - missing code",
      responseURL: "/oauth/success",
      expects: {
        ok: false,
        error: "missing_code",
      },
