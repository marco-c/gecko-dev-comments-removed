...
add_task(async function test_tabGroupContextMenuMoveTabsToNewGroup() {
  ...
  await withTabMenu(
    ...
    async (moveTabToNewSplitViewItem, unsplitTabItem) => {
      Assert.ok(
        ...
        "moveTabToNewSplitViewItem is visible"
      );
      Assert.ok(
        moveTabToNewSplitViewItem.disabled,
        "moveTabToNewSplitViewItem is disabled"
      );
  ...
  await withTabMenu(
    ...
    async (moveTabToNewSplitViewItem, unsplitTabItem) => {
      ...
      Assert.ok(
        !moveTabToNewSplitViewItem.disabled,
        "moveTabToNewSplitViewItem is not disabled"
      );
      Assert.ok(unsplitTabItem.hidden, "unsplitTabItem is hidden");
  ...
  contextMenuHidden = BrowserTestUtils.waitForPopupEvent(
    tabContextMenu,
    "hidden"
  );
  tabContextMenu.hidePopup();
