...
async function scrolling_works(useVerticalTabs) {
...
add_task(function test_vertical_scroll() {
  return scrolling_works(true);
});

add_task(function test_horizontal_scroll() {
  return scrolling_works(false);
});
