                    ...
                    if (childNtype == nsIDOMNode::ELEMENT_NODE) {
                        ...
                        if (childNname.Equals(NS_LITERAL_STRING("title"))) {
                            if (isAtom) {
                                ...
                                } else if (titleType.EqualsLiteral("html") || 
                                           (titleType.EqualsLiteral("text/html") && 
                                            !titleMode.EqualsLiteral("xml")) ||
                                           titleMode.EqualsLiteral("escaped")) 
                                {
                                ...
                                }else if (titleType.EqualsLiteral("xhtml") || 
                                          titleType.EqualsLiteral("application/xhtml") || 
                                          titleMode.EqualsLiteral("xml")) 
                                {
                                    rv = FindTextInChildNodes(childNode, titleStr);
                                } else {
