...
function test_url_for_process_types(url, chromeResult, webContentResult, privilegedAboutContentResult, privilegedMozillaContentResult, extensionProcessResult) {
  ...
  is(E10SUtils.canLoadURIInRemoteType(url,  false, PRIVILEGEDABOUT_CONTENT_PROCESS),
     privilegedAboutContentResult, "Check URL in privileged about content process.");
  is(E10SUtils.canLoadURIInRemoteType(url,  false, PRIVILEGEDMOZILLA_CONTENT_PROCESS),
     privilegedMozillaContentResult, "Check URL in privileged mozilla content process.");
  is(E10SUtils.canLoadURIInRemoteType(url,  false, EXTENSION_PROCESS),
  ...
  is(E10SUtils.canLoadURIInRemoteType(url + "#foo",  false, PRIVILEGEDABOUT_CONTENT_PROCESS),
     privilegedAboutContentResult, "Check URL with ref in privileged about content process.");
  is(E10SUtils.canLoadURIInRemoteType(url + "#foo",  false, PRIVILEGEDMOZILLA_CONTENT_PROCESS),
     privilegedMozillaContentResult, "Check URL with ref in privileged mozilla content process.");
  is(E10SUtils.canLoadURIInRemoteType(url + "#foo",  false, EXTENSION_PROCESS),
  ...
  is(E10SUtils.canLoadURIInRemoteType(url + "?foo#bar",  false, PRIVILEGEDABOUT_CONTENT_PROCESS),
     privilegedAboutContentResult, "Check URL with query and ref in privileged about content process.");
  is(E10SUtils.canLoadURIInRemoteType(url + "?foo#bar",  false, PRIVILEGEDMOZILLA_CONTENT_PROCESS),
     privilegedMozillaContentResult, "Check URL with query and ref in privileged mozilla content process.");
  is(E10SUtils.canLoadURIInRemoteType(url + "?foo#bar",  false, EXTENSION_PROCESS),
