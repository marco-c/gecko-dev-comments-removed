...
export class CDPPage extends Page {
    ...
    constructor(client, target, ignoreHTTPSErrors, screenshotTaskQueue) {
        ...
        __classPrivateFieldGet(this, _CDPPage_target, "f")
            ._targetManager()
            .on("targetGone" , __classPrivateFieldGet(this, _CDPPage_onDetachedFromTarget, "f"));
        ...
        __classPrivateFieldGet(this, _CDPPage_target, "f")._isClosedPromise.then(() => {
            ...
            __classPrivateFieldGet(this, _CDPPage_target, "f")
                ._targetManager()
                .off("targetGone" , __classPrivateFieldGet(this, _CDPPage_onDetachedFromTarget, "f"));
            this.emit("close" );
    ...
    async screenshot(options = {}) {
        ...
        if (options.quality) {
            assert(screenshotType === "jpeg"  ||
                screenshotType === "webp" , 'options.quality is unsupported for the ' +
                screenshotType +
                ' screenshots');
