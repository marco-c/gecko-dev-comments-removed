...
class NetworkObserver {
  ...
  constructor() {
    ...
    this._eventListeners = [
      ...
      helper.addObserver(this._onResponse.bind(this, false ), "http-on-examine-response"),
      helper.addObserver(this._onResponse.bind(this, true ), "http-on-examine-cached-response"),
      helper.addObserver(this._onResponse.bind(this, true ), "http-on-examine-merged-response"),
    ];
  }
  ...
  resumeSuspendedRequest(browser, requestId, headers) {
    ...
    if (headers) {
      ...
      for (const header of headers) {
        httpChannel.setRequestHeader(header.name, header.value, false );
      }
    }
