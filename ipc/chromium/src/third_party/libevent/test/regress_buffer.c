...
test_evbuffer_search(void *ptr)
{
	...
	evbuffer_add_printf(tmp, "hello");  
	evbuffer_add_buffer(buf, tmp);
	evbuffer_add_printf(tmp, "foo");    
	evbuffer_add_buffer(buf, tmp);
	evbuffer_add_printf(tmp, "cat");    
	evbuffer_add_buffer(buf, tmp);
...
test_evbuffer_callbacks(void *ptr)
{
	...
	evbuffer_drain(buf, 10); 
	evbuffer_validate(buf);
	evbuffer_prepend(buf, "Hello", 5);
	evbuffer_cb_set_flags(buf, cb2, EVBUFFER_CB_ENABLED);
	evbuffer_add_reference(buf, "Goodbye", 7, NULL, NULL); 
...
test_evbuffer_add_reference(void *ptr)
{
	...
	evbuffer_drain(buf1, 7); 
	evbuffer_drain(buf1, len1-11-1); 
