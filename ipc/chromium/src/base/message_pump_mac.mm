...
MessagePumpCFRunLoopBase::MessagePumpCFRunLoopBase()
  ...
  pre_wait_observer_ =
      CFRunLoopObserverCreate(nullptr,  
...
MessagePumpNSRunLoop::MessagePumpNSRunLoop() : keep_running_(true) {
  ...
  quit_source_ = CFRunLoopSourceCreate(nullptr,  
                                       0,        
                                       &source_context);
