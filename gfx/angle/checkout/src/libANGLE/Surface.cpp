...
gl::Extents Surface::getAttachmentSize(const gl::ImageIndex & ) const
{
...
gl::InitState Surface::initState(const gl::ImageIndex & ) const
{
    return mInitState;
}

void Surface::setInitState(const gl::ImageIndex & , gl::InitState initState)
{
