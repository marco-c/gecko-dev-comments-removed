...
const Format &Renderbuffer::getAttachmentFormat(GLenum ,
                                                const ImageIndex & ) const
{
    return getFormat();
}
GLsizei Renderbuffer::getAttachmentSamples(const ImageIndex & ) const
{
    return getSamples();
}

InitState Renderbuffer::initState(const gl::ImageIndex & ) const
{
    if (isEGLImageTarget())
    {
...
void Renderbuffer::setInitState(const gl::ImageIndex & , InitState initState)
{
    if (isEGLImageTarget())
    {
