...
const ProcEntry g_procTable[] = {
    ...
    {"glBlendBarrier", P(gl::BlendBarrier)},
    {"glBlendBarrierContextANGLE", P(gl::BlendBarrierContextANGLE)},
    ...
    {"glBlendEquationSeparateiContextANGLE", P(gl::BlendEquationSeparateiContextANGLE)},
    ...
    {"glBlendEquationiContextANGLE", P(gl::BlendEquationiContextANGLE)},
    ...
    {"glBlendFuncSeparateiContextANGLE", P(gl::BlendFuncSeparateiContextANGLE)},
    ...
    {"glBlendFunciContextANGLE", P(gl::BlendFunciContextANGLE)},
    ...
    {"glColorMaskiContextANGLE", P(gl::ColorMaskiContextANGLE)},
    ...
    {"glDebugMessageCallbackContextANGLE", P(gl::DebugMessageCallbackContextANGLE)},
    ...
    {"glDebugMessageControlContextANGLE", P(gl::DebugMessageControlContextANGLE)},
    ...
    {"glDebugMessageInsertContextANGLE", P(gl::DebugMessageInsertContextANGLE)},
    ...
    {"glDisableiContextANGLE", P(gl::DisableiContextANGLE)},
    ...
    {"glDrawElementsBaseVertexContextANGLE", P(gl::DrawElementsBaseVertexContextANGLE)},
    ...
    {"glDrawElementsInstancedBaseVertexContextANGLE",
     P(gl::DrawElementsInstancedBaseVertexContextANGLE)},
    ...
    {"glDrawRangeElementsBaseVertexContextANGLE", P(gl::DrawRangeElementsBaseVertexContextANGLE)},
    ...
    {"glEnableiContextANGLE", P(gl::EnableiContextANGLE)},
    ...
    {"glFramebufferTextureContextANGLE", P(gl::FramebufferTextureContextANGLE)},
    ...
    {"glGetDebugMessageLogContextANGLE", P(gl::GetDebugMessageLogContextANGLE)},
    ...
    {"glGetGraphicsResetStatusContextANGLE", P(gl::GetGraphicsResetStatusContextANGLE)},
    ...
    {"glGetObjectPtrLabelContextANGLE", P(gl::GetObjectPtrLabelContextANGLE)},
    ...
    {"glGetSamplerParameterIivContextANGLE", P(gl::GetSamplerParameterIivContextANGLE)},
    ...
    {"glGetSamplerParameterIuivContextANGLE", P(gl::GetSamplerParameterIuivContextANGLE)},
    ...
    {"glGetTexParameterIivContextANGLE", P(gl::GetTexParameterIivContextANGLE)},
    ...
    {"glGetTexParameterIuivContextANGLE", P(gl::GetTexParameterIuivContextANGLE)},
    ...
    {"glGetnUniformfvContextANGLE", P(gl::GetnUniformfvContextANGLE)},
    ...
    {"glGetnUniformivContextANGLE", P(gl::GetnUniformivContextANGLE)},
    ...
    {"glGetnUniformuivContextANGLE", P(gl::GetnUniformuivContextANGLE)},
    ...
    {"glIsEnablediContextANGLE", P(gl::IsEnablediContextANGLE)},
    ...
    {"glObjectLabelContextANGLE", P(gl::ObjectLabelContextANGLE)},
    ...
    {"glObjectPtrLabelContextANGLE", P(gl::ObjectPtrLabelContextANGLE)},
    ...
    {"glPopDebugGroupContextANGLE", P(gl::PopDebugGroupContextANGLE)},
    ...
    {"glPrimitiveBoundingBox", P(gl::PrimitiveBoundingBox)},
    {"glPrimitiveBoundingBoxContextANGLE", P(gl::PrimitiveBoundingBoxContextANGLE)},
    ...
    {"glPushDebugGroupContextANGLE", P(gl::PushDebugGroupContextANGLE)},
    ...
    {"glReadnPixelsContextANGLE", P(gl::ReadnPixelsContextANGLE)},
    ...
    {"glSamplerParameterIivContextANGLE", P(gl::SamplerParameterIivContextANGLE)},
    ...
    {"glSamplerParameterIuivContextANGLE", P(gl::SamplerParameterIuivContextANGLE)},
    ...
    {"glTexBufferContextANGLE", P(gl::TexBufferContextANGLE)},
    {"glTexBufferEXT", P(gl::TexBufferEXT)},
    {"glTexBufferEXTContextANGLE", P(gl::TexBufferEXTContextANGLE)},
    ...
    {"glTexBufferRangeContextANGLE", P(gl::TexBufferRangeContextANGLE)},
    {"glTexBufferRangeEXT", P(gl::TexBufferRangeEXT)},
    {"glTexBufferRangeEXTContextANGLE", P(gl::TexBufferRangeEXTContextANGLE)},
    ...
    {"glTexParameterIivContextANGLE", P(gl::TexParameterIivContextANGLE)},
    ...
    {"glTexParameterIuivContextANGLE", P(gl::TexParameterIuivContextANGLE)},
