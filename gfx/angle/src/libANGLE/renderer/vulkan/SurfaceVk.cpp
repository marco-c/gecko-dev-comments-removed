...
egl::Error OffscreenSurfaceVk::bindTexImage(gl::Texture * , EGLint )
{
    return egl::NoError();
}

egl::Error OffscreenSurfaceVk::releaseTexImage(EGLint )
{
    return egl::NoError();
}
...
gl::Error WindowSurfaceVk::getAttachmentRenderTarget(const gl::Context * ,
                                                     GLenum ,
                                                     const gl::ImageIndex & ,
