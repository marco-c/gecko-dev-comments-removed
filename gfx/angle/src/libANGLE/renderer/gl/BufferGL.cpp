...
gl::Error BufferGL::setData(GLenum , const void *data, size_t size, GLenum usage)
{
...
gl::Error BufferGL::setSubData(GLenum , const void *data, size_t size, size_t offset)
{
    mStateManager->bindBuffer(DestBufferOperationTarget, mBufferID);
