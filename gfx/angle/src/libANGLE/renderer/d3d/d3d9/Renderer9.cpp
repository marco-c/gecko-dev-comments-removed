...
gl::Error Renderer9::setUniformBuffers(const gl::Data &,
...
gl::Error Renderer9::applyVertexBuffer(const gl::State &state, GLenum mode, GLint first, GLsizei count, GLsizei instances, SourceIndexData * )
{
...
gl::Error Renderer9::applyShadersImpl(const gl::Data &data, GLenum )
{
