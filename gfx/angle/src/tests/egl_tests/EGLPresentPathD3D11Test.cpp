...
class EGLPresentPathD3D11 : public testing::TestWithParam<PlatformParameters>
{
  protected:
    ...
    void checkPixelsUsingD3D(bool usingPresentPathFast)
    {
        ...
        GLColor expectedTopLeftPixel     = GLColor(0,   0, 255, 255);  
        GLColor expectedTopRightPixel    = GLColor(0, 255,   0, 255);  
        GLColor expectedBottomLeftPixel  = GLColor(255, 0,   0, 255);  
        GLColor expectedBottomRightPixel = GLColor(0, 255, 255, 255);  
