...
ANGLE_INSTANTIATE_TEST(ProgramBinariesAcrossPlatforms,
                       ...
                       PlatformsWithLinkResult(ES2_D3D11(),         ES2_D3D11(),            true         ), 
                       PlatformsWithLinkResult(ES3_D3D11(),         ES3_D3D11(),            true         ), 
                       PlatformsWithLinkResult(ES2_D3D11_FL11_0(),  ES2_D3D11_FL9_3(),      false        ), 
                       PlatformsWithLinkResult(ES2_D3D11(),         ES2_D3D11_WARP(),       false        ), 
                       PlatformsWithLinkResult(ES2_D3D11_FL9_3(),   ES2_D3D11_FL9_3_WARP(), false        ), 
                       PlatformsWithLinkResult(ES2_D3D11(),         ES2_D3D9(),             false        ), 
                       PlatformsWithLinkResult(ES2_D3D9(),          ES2_D3D11(),            false        ), 
                       PlatformsWithLinkResult(ES2_D3D11(),         ES3_D3D11(),            false        ), 
                       );
