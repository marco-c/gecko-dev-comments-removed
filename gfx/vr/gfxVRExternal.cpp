...
VRSystemManagerExternal::OpenShmem()
{
  ...
  mExternalShmem = (VRExternalShmem*)MapViewOfFile(mShmemFile, 
    FILE_MAP_ALL_ACCESS,  
    0,
    0,
    length.QuadPart);
...
VRSystemManagerExternal::CloseShmem()
{
 ...
 already_AddRefed<VRSystemManagerExternal>
VRSystemManagerExternal::Create(VRExternalShmem* aAPIShmem )
{
