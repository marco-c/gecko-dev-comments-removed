		       ...
		       size_t             vl)
{
    ...
    t0 = __riscv_vfsub_vv_f32m1 (sa, s, vl);  
    t1 = __riscv_vfmul_vv_f32m1 (sa, d, vl);  
    t2 = __riscv_vfmul_vv_f32m1 (sa, da, vl); 
		      ...
		      size_t             vl)
{
    ...
    t1 = __riscv_vfsub_vv_f32m1 (da, __riscv_vfdiv_vv_f32m1 (t0, s, vl),
				 vl);         
    t2 = __riscv_vfmul_vv_f32m1 (sa, da, vl); 
    t3 = __riscv_vfmul_vv_f32m1 (sa, t1, vl); 
    t4 = __riscv_vfmul_vv_f32m1 (s, da, vl);  
		      ...
		      size_t             vl)
{
    ...
    t1             = __riscv_vfmul_vv_f32m1 (sa, d, vl);  
    t2             = __riscv_vfsub_vv_f32m1 (sa, t0, vl); 
    t3             = __riscv_vfmul_vv_f32m1 (d, t2, vl);  
