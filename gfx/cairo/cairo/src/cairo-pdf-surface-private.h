...
typedef struct _pdf_page_mcid {
    int order;
    int page;
    cairo_pdf_resource_t xobject_res; 
    int mcid;
...
typedef struct _cairo_pdf_struct_tree_node {
    ...
    union {
	cairo_content_attrs_t content; 
	cairo_content_ref_attrs_t content_ref; 
    } attributes;
...
typedef struct _cairo_pdf_interchange {
    ...
    cairo_array_t recording_surface_stack; 
    cairo_pdf_resource_t current_recording_surface_res;
    cairo_hash_table_t *command_to_node_map; 
    cairo_bool_t ignore_current_surface;
    cairo_hash_table_t *content_tag_map; 
    ...
    cairo_array_t mcid_to_tree; 

    cairo_array_t page_commands; 
    cairo_pdf_command_list_t *current_commands; 
    ...
    int annot_page;
    cairo_array_t outline; 
    struct docinfo docinfo;
    cairo_array_t custom_metadata; 
