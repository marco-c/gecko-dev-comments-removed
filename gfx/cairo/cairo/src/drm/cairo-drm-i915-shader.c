...
#define DBLEND(X) ((BLENDFACT_##X) << S6_CBUF_DST_BLEND_FACT_SHIFT)
	...
	{0, SBLEND (ZERO),          DBLEND (ZERO), BOUNDED}, 
	{0, SBLEND (ONE),           DBLEND (ZERO), BOUNDED}, 

	{0, SBLEND (ONE),           DBLEND (INV_SRC_ALPHA), SIMPLE}, 
	{1, SBLEND (DST_ALPHA),     DBLEND (ZERO), XRENDER}, 
	{1, SBLEND (INV_DST_ALPHA), DBLEND (ZERO), XRENDER}, 
	{1, SBLEND (DST_ALPHA),     DBLEND (INV_SRC_ALPHA), SIMPLE}, 

	{0, SBLEND (ZERO),          DBLEND (ONE), SIMPLE}, 
	{1, SBLEND (INV_DST_ALPHA), DBLEND (ONE), SIMPLE}, 
	{0, SBLEND (ZERO),          DBLEND (SRC_ALPHA), XRENDER}, 
	{0, SBLEND (ZERO),          DBLEND (INV_SRC_ALPHA), SIMPLE}, 
	{1, SBLEND (INV_DST_ALPHA), DBLEND (SRC_ALPHA), XRENDER}, 

	{1, SBLEND (INV_DST_ALPHA), DBLEND (INV_SRC_ALPHA), SIMPLE}, 
	{0, SBLEND (ONE),           DBLEND (ONE), SIMPLE}, 
