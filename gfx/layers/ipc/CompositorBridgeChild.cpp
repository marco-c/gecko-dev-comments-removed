                                     ...
                                     nsIEventTarget* aTarget)
{
  PTextureChild* textureChild = AllocPTextureChild(
    aSharedData, aReadLock, aLayersBackend, aFlags, LayersId{0} , aSerial, aExternalImageId);
  ...
  return SendPTextureConstructor(
    textureChild, aSharedData, aReadLock, aLayersBackend, aFlags, LayersId{0} , aSerial, aExternalImageId);
}
