...
const NameTable::NameEntryId NAME_IDS[] = {
    NameTable::NameEntryId(1, 0, 0, 0),  
    NameTable::NameEntryId(1, 0, 0, 1),  
    NameTable::NameEntryId(1, 0, 0, 2),  
    NameTable::NameEntryId(1, 0, 0, 3),  
    NameTable::NameEntryId(1, 0, 0, 4),  
    NameTable::NameEntryId(1, 0, 0, 5),  
    NameTable::NameEntryId(1, 0, 0, 6),  
    NameTable::NameEntryId(1, 0, 0, 9),  
    NameTable::NameEntryId(1, 0, 0, 11),  
    NameTable::NameEntryId(1, 0, 0, 12),  
};
