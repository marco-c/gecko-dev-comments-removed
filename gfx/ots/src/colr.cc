                ...
                colrState& state, uint32_t depth)
{
  ...
  switch (format) {
    ...
    case 16: ok = ParsePaintScale(font, data, length, state, depth, false, false, false); break; 
    case 17: ok = ParsePaintScale(font, data, length, state, depth, true, false, false); break; 
    case 18: ok = ParsePaintScale(font, data, length, state, depth, false, true, false); break; 
    case 19: ok = ParsePaintScale(font, data, length, state, depth, true, true, false); break; 
    case 20: ok = ParsePaintScale(font, data, length, state, depth, false, false, true); break; 
    case 21: ok = ParsePaintScale(font, data, length, state, depth, true, false, true); break; 
    case 22: ok = ParsePaintScale(font, data, length, state, depth, false, true, true); break; 
    case 23: ok = ParsePaintScale(font, data, length, state, depth, true, true, true); break; 
    case 24: ok = ParsePaintRotate(font, data, length, state, depth, false, false); break; 
    case 25: ok = ParsePaintRotate(font, data, length, state, depth, true, false); break; 
    case 26: ok = ParsePaintRotate(font, data, length, state, depth, false, true); break; 
    case 27: ok = ParsePaintRotate(font, data, length, state, depth, true, true); break; 
    case 28: ok = ParsePaintSkew(font, data, length, state, depth, false, false); break; 
    case 29: ok = ParsePaintSkew(font, data, length, state, depth, true, false); break; 
    case 30: ok = ParsePaintSkew(font, data, length, state, depth, false, true); break; 
    case 31: ok = ParsePaintSkew(font, data, length, state, depth, true, true); break; 
