...
std::unique_ptr<SkAdvancedTypefaceMetrics> SkTypeface_Mac::onGetAdvancedMetrics() const {
    ...
    SkRect r;
    r.setLTRB(SkScalarFromCGFloat(SkCGRectGetMinX(bbox)),   
              SkScalarFromCGFloat(SkCGRectGetMaxY(bbox)),   
              SkScalarFromCGFloat(SkCGRectGetMaxX(bbox)),   
              SkScalarFromCGFloat(SkCGRectGetMinY(bbox)));  
