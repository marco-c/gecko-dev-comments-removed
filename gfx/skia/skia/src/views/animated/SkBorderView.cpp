...
void SkBorderView::setSkin(const char skin[])
{
 ...
 void SkBorderView::onInflate(const SkDOM& dom, const SkDOM::Node* node)
{
    this->INHERITED::onInflate(dom, node);
}

 void SkBorderView::onSizeChange()
{
 ...
 void SkBorderView::onDraw(SkCanvas* canvas)
{
    SkPaint                        paint;
 ...
 bool SkBorderView::onEvent(const SkEvent& evt)
{
