  ...
  for (uint32_t count=count_lo; count<=count_hi; count+=count_step)
    {
      ...
      fprintf(stdout,"%s, %u, %s, %s, %s, %8u, %8u, %8u, CPU, %s, %9.2f, %6.2f, GPU, %9u, %7.3f, %7.3f, %7.3f, %6.2f, %6.2f\n",
              ...
              verify ? (cpu_ns / 1000000.0)      : 0.0,             
              verify ? (1000.0 * count / cpu_ns) : 0.0,             
              
              loops,
              elapsed_ms_sum / loops,                               
              elapsed_ms_min,                                       
              elapsed_ms_max,                                       
              (double)(count * loops) / (1000.0 * elapsed_ms_sum),  
              (double) count          / (1000.0 * elapsed_ms_min)); 
