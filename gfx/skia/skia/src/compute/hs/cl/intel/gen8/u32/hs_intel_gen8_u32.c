...
struct hs_cl_target const HS_TARGET_NAME =
{
  .config = {
    .slab = {
  ...
  .program = {
    ...
    0, 
#include "hs_kernels.bin.len.xxd"
    ,
#include "hs_kernels.bin.xxd"
#else
    1, 
#include "hs_kernels.src.len.xxd"
    ,
#include "hs_kernels.src.xxd"
#endif
  }
};
