...
struct skc_config const config =
  {
    ...
    .subblock = {
      .words        = SKC_DEVICE_SUBBLOCK_WORDS,                         
      .bytes        = SKC_DEVICE_SUBBLOCK_WORDS * sizeof(skc_uint)       
    },

    .block = {
      .words        = SKC_DEVICE_BLOCK_WORDS,                            
      .bytes        = SKC_DEVICE_BLOCK_WORDS * sizeof(skc_uint),         
      .subblocks    = SKC_DEVICE_BLOCK_WORDS / SKC_DEVICE_SUBBLOCK_WORDS 
    },
    ...
    .tile = {
      .width        = SKC_TILE_WIDTH,                  
      .height       = SKC_TILE_HEIGHT,                 
      .ratio        = SKC_TILE_HEIGHT / SKC_TILE_WIDTH 
    },
    ...
    .paths_copy = {
      ...
      .block = {
        .subbuf     = SKC_DEVICE_BLOCK_WORDS * sizeof(skc_uint) * 1024,     
        .buffer     = SKC_DEVICE_BLOCK_WORDS * sizeof(skc_uint) * 1024 * 16 
      },

      .command = {
        .subbuf     = sizeof(skc_uint) * 1024,     
        .buffer     = sizeof(skc_uint) * 1024 * 16 
      },
    ...
    .raster_cohort = {
      ...
      .raster_ids = {
        .elem_count = 8192,
        .snap_count = (1<<SKC_TTRK_HI_BITS_COHORT) 
      },
...
static char const cl_build_options_debug[] =
  "-cl-std=CL1.2 -cl-kernel-arg-info -g"; 
