...
struct skc_raster_builder_impl
{
  ...
  struct skc_extent_phrwg_thr1s  path_ids;    
  struct skc_extent_phw1g_tdrNs  transforms;  
  struct skc_extent_phw1g_tdrNs  clips;       
  struct skc_extent_phw1g_tdrNs  fill_cmds;   
  struct skc_extent_phrwg_tdrNs  raster_ids;  
...
struct skc_raster_cohort
{
  ...
  struct skc_extent_phrwg_thr1s_snap  path_ids;    
  struct skc_extent_phw1g_tdrNs_snap  transforms;  
  struct skc_extent_phw1g_tdrNs_snap  clips;       
  struct skc_extent_phw1g_tdrNs_snap  fill_cmds;   
  struct skc_extent_phrwg_tdrNs_snap  raster_ids;  
