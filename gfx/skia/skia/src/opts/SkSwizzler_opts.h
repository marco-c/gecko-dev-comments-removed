...
static void premul_should_swapRB(uint32_t* dst, const void* vsrc, int count) {
 ...
 inline void RGBA_to_rgbA(uint32_t* dst, const void* src, int count) {
    premul_should_swapRB<false>(dst, src, count);
}

 inline void RGBA_to_bgrA(uint32_t* dst, const void* src, int count) {
    premul_should_swapRB<true>(dst, src, count);
}

 inline void RGBA_to_BGRA(uint32_t* dst, const void* vsrc, int count) {
    auto src = (const uint32_t*)vsrc;
    while (count >= 16) {
...
static void insert_alpha_should_swaprb(uint32_t dst[], const void* vsrc, int count) {
 ...
 inline void RGB_to_RGB1(uint32_t dst[], const void* src, int count) {
    insert_alpha_should_swaprb<false>(dst, src, count);
}

 inline void RGB_to_BGR1(uint32_t dst[], const void* src, int count) {
    insert_alpha_should_swaprb<true>(dst, src, count);
}

 inline void gray_to_RGB1(uint32_t dst[], const void* vsrc, int count) {
    const uint8_t* src = (const uint8_t*) vsrc;
    while (count >= 16) {
...
static void expand_grayA(uint32_t dst[], const void* vsrc, int count) {
 ...
 inline void grayA_to_RGBA(uint32_t dst[], const void* src, int count) {
...
static void inverted_cmyk_to(uint32_t* dst, const void* vsrc, int count) {
 ...
 inline void inverted_CMYK_to_RGB1(uint32_t dst[], const void* src, int count) {
    inverted_cmyk_to<kRGB1>(dst, src, count);
}

 inline void inverted_CMYK_to_BGR1(uint32_t dst[], const void* src, int count) {
...
static void insert_alpha_should_swaprb(uint32_t dst[], const void* vsrc, int count) {
 ...
 inline void grayA_to_RGBA(uint32_t dst[], const void* vsrc, int count) {
    const uint8_t* src = (const uint8_t*) vsrc;
    while (count >= 8) {
...
static void inverted_cmyk_to(uint32_t* dst, const void* vsrc, int count) {
 ...
 inline void gray_to_RGB1(uint32_t dst[], const void* src, int count) {
    gray_to_RGB1_portable(dst, src, count);
}
