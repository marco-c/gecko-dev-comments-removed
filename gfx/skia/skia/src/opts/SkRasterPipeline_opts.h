...
namespace SK_OPTS_NS {
    ...
    SI F   rcp_approx(F v)      { return 1.0f / v; }  
    ...
    SI F   rcp_approx(F v)   { return _mm256_rcp_ps  (v);    }  
    ...
    SI void load4(const uint16_t* ptr, U16* r, U16* g, U16* b, U16* a) {
        ...
        auto _02 = _mm_unpacklo_epi16(_01, _23),  
             _13 = _mm_unpackhi_epi16(_01, _23),  
             _46 = _mm_unpacklo_epi16(_45, _67),
             _57 = _mm_unpackhi_epi16(_45, _67);

        auto rg0123 = _mm_unpacklo_epi16(_02, _13),  
             ba0123 = _mm_unpackhi_epi16(_02, _13),  
    ...
    SI void store4(uint16_t* ptr, U16 r, U16 g, U16 b, U16 a) {
        auto rg0123 = _mm_unpacklo_epi16((__m128i)r, (__m128i)g),  
             rg4567 = _mm_unpackhi_epi16((__m128i)r, (__m128i)g),  
    ...
    SI void load4(const float* ptr, F* r, F* g, F* b, F* a) {
        ...
        F rg0145 = _mm256_unpacklo_ps(_04,_15),  
    ...
    SI void store4(float* ptr, F r, F g, F b, F a) {
        F rg0145 = _mm256_unpacklo_ps(r, g),  
          rg2367 = _mm256_unpackhi_ps(r, g),  
          ba0145 = _mm256_unpacklo_ps(b, a),  
          ba2367 = _mm256_unpackhi_ps(b, a);  

        F _04 = (F)_mm256_unpacklo_pd((__m256d)rg0145, (__m256d)ba0145),
          _15 = (F)_mm256_unpackhi_pd((__m256d)rg0145, (__m256d)ba0145),
          _26 = (F)_mm256_unpacklo_pd((__m256d)rg2367, (__m256d)ba2367),
          _37 = (F)_mm256_unpackhi_pd((__m256d)rg2367, (__m256d)ba2367);

        F _01 = _mm256_permute2f128_ps(_04, _15, 32),  
          _23 = _mm256_permute2f128_ps(_26, _37, 32),
          _45 = _mm256_permute2f128_ps(_04, _15, 49),  
...
#endif
    SI F   rcp_approx(F v)     { return _mm_rcp_ps  (v);    }  
    ...
    #endif
        return sk_unaligned_load<U16>(&p);  
    }
    SI U8 pack(U16 v) {
    ...
    SI void load2(const uint16_t* ptr, U16* r, U16* g) {
        __m128i _01 = _mm_loadu_si128(((const __m128i*)ptr) + 0); 
        auto rg01_23 = _mm_shufflelo_epi16(_01, 0xD8);            
        auto rg      = _mm_shufflehi_epi16(rg01_23, 0xD8);        

        auto R = _mm_shuffle_epi32(rg, 0x88);  
        auto G = _mm_shuffle_epi32(rg, 0xDD);  
    ...
    SI void load4(const uint16_t* ptr, U16* r, U16* g, U16* b, U16* a) {
        ...
        auto rg = _mm_unpacklo_epi16(_02, _13),  
             ba = _mm_unpackhi_epi16(_02, _13);  
    ...
    SI void load4(const uint16_t* ptr, U16* r, U16* g, U16* b, U16* a) {
        ...
        auto _02 = __lsx_vilvl_h(_23, _01),     
             _13 = __lsx_vilvh_h(_23, _01),     
             _46 = __lsx_vilvl_h(_67, _45),
             _57 = __lsx_vilvh_h(_67, _45);

        auto rg0123 = __lsx_vilvl_h(_13, _02),  
             ba0123 = __lsx_vilvh_h(_13, _02),  
    ...
    SI void store4(uint16_t* ptr, U16 r, U16 g, U16 b, U16 a) {
        auto rg0123 = __lsx_vilvl_h(g, r),      
             rg4567 = __lsx_vilvh_h(g, r),      
    ...
    SI void load4(const float* ptr, F* r, F* g, F* b, F* a) {
        ...
        F rg0145 = (F)__lasx_xvilvl_w((__m256i)_15, (__m256i)_04),  
    ...
    SI void store4(float* ptr, F r, F g, F b, F a) {
        F rg0145 = (F)__lasx_xvilvl_w((__m256i)g, (__m256i)r),         
          rg2367 = (F)__lasx_xvilvh_w((__m256i)g, (__m256i)r),         
          ba0145 = (F)__lasx_xvilvl_w((__m256i)a, (__m256i)b),         
          ba2367 = (F)__lasx_xvilvh_w((__m256i)a, (__m256i)b);         

        F _04 = (F)__lasx_xvilvl_d((__m256i)ba0145, (__m256i)rg0145),  
          _15 = (F)__lasx_xvilvh_d((__m256i)ba0145, (__m256i)rg0145),  
          _26 = (F)__lasx_xvilvl_d((__m256i)ba2367, (__m256i)rg2367),  
          _37 = (F)__lasx_xvilvh_d((__m256i)ba2367, (__m256i)rg2367);  
    ...
    SI void load2(const uint16_t* ptr, U16* r, U16* g) {
        __m128i _01 = __lsx_vld(ptr, 0);                  
        auto rg     = __lsx_vshuf4i_h(_01, 0xD8);         

        auto R = __lsx_vshuf4i_w(rg, 0x88);               
        auto G = __lsx_vshuf4i_w(rg, 0xDD);               
        *r = sk_unaligned_load<U16>(&R);
        *g = sk_unaligned_load<U16>(&G);
    }
    ...
    SI void load4(const uint16_t* ptr, U16* r, U16* g, U16* b, U16* a) {
        ...
        auto rg = __lsx_vilvl_h(_13, _02),   
             ba = __lsx_vilvh_h(_13, _02);   
...
SI F approx_pow2(F x) {
    ...
    F approx = nmad(f, 1.490129070f, x + 121.274057500f);
      ...
      approx *= 1.0f * (1<<23);
      approx  = min(max(approx, F0), F_(kInfinityBits));  
...
SI F clamp(F v, F limit) {
    F inclusive = sk_bit_cast<F>(sk_bit_cast<U32>(limit) - 1);  
...
SI U32 to_unorm(F v, int scale) {
    return to_unorm(v, (float) scale, 0.f, scale);
}
...
SI uint32_t select_lane(uint32_t data, int ) { return data; }
SI  int32_t select_lane( int32_t data, int ) { return data; }
#else
...
BLEND_MODE(plus_)    { return min(s + d, 1.0f); }  
...
BLEND_MODE(colorburn) {
    return if_then_else(d == da,    d +    s*inv(da),
           if_then_else(s ==  0,  d*inv(sa),
                                sa*(da - min(da, (da-d)*sa*rcp_fast(s))) + s*inv(da) + d*inv(sa)));
}
BLEND_MODE(colordodge) {
    return if_then_else(d ==  0,  s*inv(da),
...
BLEND_MODE(softlight) {
    ...
    F darkSrc = d*(sa + (s2 - sa)*(1.0f - m)),     
      darkDst = (m4*m4 + m4)*(m - 1.0f) + 7.0f*m,  
      liteDst = sqrt_(m) - m,
      liteSrc = d*sa + da*(s2 - sa) * if_then_else(two(two(d)) <= da, darkDst, liteDst); 
    return s*inv(da) + d*inv(sa) + if_then_else(s2 <= sa, darkSrc, liteSrc);      
}
#undef BLEND_MODE
...
HIGHP_STAGE(srcover_rgba_8888, const SkRasterPipelineContexts::MemoryCtx* ctx) {
    ...
    dst = to_unorm(r, 1, 0.f, 255)
        | to_unorm(g, 1, 0.f, 255) <<  8
        | to_unorm(b, 1, 0.f, 255) << 16
        | to_unorm(a, 1, 0.f, 255) << 24;
    store(ptr, dst);
}
...
HIGHP_STAGE(store_10101010_xr, const SkRasterPipelineContexts::MemoryCtx* ctx) {
    ...
    U16 R = pack(to_unorm(r, 510, 384, 1023)) << 6,
        G = pack(to_unorm(g, 510, 384, 1023)) << 6,
        B = pack(to_unorm(b, 510, 384, 1023)) << 6,
        A = pack(to_unorm(a, 510, 384, 1023)) << 6;
...
HIGHP_STAGE(store_1010102_xr, const SkRasterPipelineContexts::MemoryCtx* ctx) {
    ...
    U32 px = to_unorm(r, 510, 384, 1023)
           | to_unorm(g, 510, 384, 1023) << 10
           | to_unorm(b, 510, 384, 1023) << 10
           | to_unorm(a, 3) << 30;
    store(ptr, px);
}
...
HIGHP_STAGE(xy_to_unit_angle, NoCtx) {
    ...
    phi = if_then_else(phi != phi , 0.0f           , phi);  
    r = phi;
}
...
SI void apply_binary_immediate(SkRasterPipelineContexts::ConstantCtx* packed, std::byte* base) {
    auto ctx = SkRPCtxUtils::Unpack(packed);
    V* dst = (V*)(base + ctx.dst);         
    S scalar = sk_bit_cast<S>(ctx.value);  
    V src = scalar - V();                  
