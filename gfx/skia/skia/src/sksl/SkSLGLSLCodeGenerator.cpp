...
void GLSLCodeGenerator::writeModifiers(const Modifiers& modifiers,
    ...
    switch (modifiers.fLayout.fFormat) {
        case Layout::Format::kUnspecified:
            break;
        case Layout::Format::kRGBA32F:      
        case Layout::Format::kR32F:
            this->write("highp ");
            break;
        case Layout::Format::kRGBA16F:      
        case Layout::Format::kR16F:         
        case Layout::Format::kLUMINANCE16F: 
        case Layout::Format::kRG16F:
            this->write("mediump ");
            break;
        case Layout::Format::kRGBA8:        
        case Layout::Format::kR8:           
        case Layout::Format::kRGBA8I:       
