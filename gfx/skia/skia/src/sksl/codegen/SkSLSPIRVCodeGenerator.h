...
private:
    ...
    SkTHashMap<Instruction, SpvId, Instruction::Hash> fOpCache;  
    SkTHashMap<SpvId, Instruction> fSpvIdCache;                  
    SkTHashMap<SpvId, SpvId> fStoreCache;                        
    ...
    SkTHashMap<const Variable*, int> fTopLevelUniformMap; 
