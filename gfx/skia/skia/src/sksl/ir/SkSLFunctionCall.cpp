...
static std::unique_ptr<Expression> coalesce_vector(const IntrinsicArguments& arguments,
    ...
    return coalesce_n_way_vector(arguments[0], nullptr,
...
static std::unique_ptr<Expression> evaluate_intrinsic(const Context& context,
    ...
    return evaluate_n_way_intrinsic(context, arguments[0], nullptr, nullptr,
                                    returnType, eval);
}
...
static std::unique_ptr<Expression> evaluate_pairwise_intrinsic(const Context& context,
    ...
    return evaluate_n_way_intrinsic(context, arguments[0], arguments[1], nullptr,
                                    returnType, eval);
}
...
static std::unique_ptr<Expression> optimize_intrinsic_call(const Context& context,
    ...
    switch (intrinsic) {
        ...
        case k_cross_IntrinsicKind: {
            ...
            SkASSERT(arguments[0]->type().columns() == 3);  
        ...
        case k_determinant_IntrinsicKind: {
            ...
            switch (arguments[0]->type().slotCount()) {
                case 4:
                    determinant = SkInvert2x2Matrix(mat, nullptr);
                    break;
                case 9:
                    determinant = SkInvert3x3Matrix(mat, nullptr);
                    break;
                case 16:
                    determinant = SkInvert4x4Matrix(mat, nullptr);
                    break;
                default:
        ...
        case k_any_IntrinsicKind:
            return coalesce_vector<bool>(arguments, false, returnType,
                                         Intrinsics::coalesce_any,
                                         nullptr);
        case k_all_IntrinsicKind:
            return coalesce_vector<bool>(arguments, true, returnType,
