...
namespace skvm {
    ...
    public:
        ...
        void vpavgw   (Ymm dst, Ymm x, Operand y);  
        void vpmulhrsw(Ymm dst, Ymm x, Operand y);  
        ...
        void vpermps   (Ymm dst, Ymm ix, Operand src);        
        ...
        void vpmovzxwd(Ymm dst, Operand src);   
        void vpmovzxbd(Ymm dst, Operand src);   

        void vmovq(Operand dst, Xmm src);  
        void vmovd(Operand dst, Xmm src);  
        void vmovd(Xmm dst, Operand src);  

        void vpinsrd(Xmm dst, Xmm src, Operand y, int imm);  
        void vpinsrw(Xmm dst, Xmm src, Operand y, int imm);  
        void vpinsrb(Xmm dst, Xmm src, Operand y, int imm);  

        void vextracti128(Operand dst, Ymm src, int imm);    
        void vpextrd     (Operand dst, Xmm src, int imm);    
        void vpextrw     (Operand dst, Xmm src, int imm);    
        void vpextrb     (Operand dst, Xmm src, int imm);    
        ...
        void movzbq(GP64 dst, Operand x);  
        void movzwq(GP64 dst, Operand x);  
        ...
        void ldrd(X dst, X src, int imm12=0);  
        void ldrs(X dst, X src, int imm12=0);  
        void ldrh(X dst, X src, int imm12=0);  
        void ldrb(X dst, X src, int imm12=0);  

        void ldrq(V dst, Label*);  

        void ldrq(V dst, X src, int imm12=0);  
        void ldrd(V dst, X src, int imm12=0);  
        void ldrs(V dst, X src, int imm12=0);  
        void ldrh(V dst, X src, int imm12=0);  
        void ldrb(V dst, X src, int imm12=0);  

        void strs(X src, X dst, int imm12=0);  

        void strq(V src, X dst, int imm12=0);  
        void strd(V src, X dst, int imm12=0);  
        void strs(V src, X dst, int imm12=0);  
        void strh(V src, X dst, int imm12=0);  
        void strb(V src, X dst, int imm12=0);  

        void movs(X dst, V src, int lane);  
        void inss(V dst, X src, int lane);  

        void dup4s  (V dst, X src);  

        void ld1r4s (V dst, X src);  
        void ld1r8h (V dst, X src);  
        void ld1r16b(V dst, X src);  

        void ld24s(V dst, X src);  
        void ld44s(V dst, X src);  
        void st24s(V src, X dst);  
        void st44s(V src, X dst);  

        void ld24s(V dst, X src, int lane);  
        void ld44s(V dst, X src, int lane);  
    ...
    public:
        ...
        void store64 (Ptr ptr, I32 lo, I32 hi);              
        void store128(Ptr ptr, I32 x, I32 y, I32 z, I32 w);  
        ...
        I32 load64 (Ptr ptr, int lane);  
        I32 load128(Ptr ptr, int lane);  
        ...
        I32 extract(I32 x, int bits, I32 z);   
        ...
        F32 from_unorm(int bits, I32);   
        I32   to_unorm(int bits, F32);   
