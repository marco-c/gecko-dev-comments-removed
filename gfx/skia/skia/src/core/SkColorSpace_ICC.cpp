...
static bool load_matrix(SkMatrix44* toXYZ, const uint8_t* src, size_t len) {
    ...
    array[ 3] = scale * SkFixedToFloat(read_big_endian_i32(src + 36)); 
    ...
    array[ 7] = scale * SkFixedToFloat(read_big_endian_i32(src + 40)); 
    ...
    array[11] = scale * SkFixedToFloat(read_big_endian_i32(src + 44)); 
    array[12] = 0.0f;
    array[13] = 0.0f;
    array[14] = 0.0f;
    array[15] = 1.0f;
