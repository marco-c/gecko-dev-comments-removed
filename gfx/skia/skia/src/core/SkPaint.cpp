...
SkPaint::SkPaint()
    ...
    , fBitfields{(unsigned)false,                   
                 (unsigned)false,                   
                 (unsigned)SkPaint::kDefault_Cap,   
                 (unsigned)SkPaint::kDefault_Join,  
                 (unsigned)SkPaint::kFill_Style,    
                 (unsigned)kNone_SkFilterQuality,   
                 (unsigned)SkBlendMode::kSrcOver,   
                 0}                                 
{
