...
static constexpr float kFlatnessThreshold = 1/16.f; 
...
void GrCCFillGeometry::appendMonotonicConic(const Sk2f& p0, const Sk2f& p1, const Sk2f& p2,
    ...
    float h1 = std::abs(d[1] - d[0]); 
    float ht = h1*w, hs = 1 + w; 
