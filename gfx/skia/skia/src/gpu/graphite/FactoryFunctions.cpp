...
private:
    void addToKey(const KeyContext& keyContext,
        ...
        BlendModeBlock::BeginBlock(keyContext, builder,  nullptr, fBlendMode);
        builder->endBlock();
    }
...
private:
    ...
    void addToKey(const KeyContext& keyContext,
        ...
        if (desiredBlendCombination == fPorterDuffIndex) {
            PorterDuffBlendShaderBlock::BeginBlock(keyContext, builder,  nullptr,
                                                   {}); 
            ...
            RuntimeEffectBlock::BeginBlock(keyContext, builder,  nullptr,
...
private:
    ...
    void addToKey(const KeyContext& keyContext,
        ...
        ColorFilterShaderBlock::BeginBlock(keyContext, builder,  nullptr);
...
private:
    ...
    void addToKey(const KeyContext& keyContext,
        ...
        RuntimeEffectBlock::BeginBlock(keyContext, builder,  nullptr, { fEffect });
