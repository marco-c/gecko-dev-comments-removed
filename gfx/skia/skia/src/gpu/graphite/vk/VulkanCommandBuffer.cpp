...
bool VulkanCommandBuffer::onCopyTextureToBuffer(const Texture* texture,
    ...
    region.imageOffset = { srcRect.left(), srcRect.top(), 0 };
    region.imageExtent = { (uint32_t)srcRect.width(), (uint32_t)srcRect.height(), 1 };
