    ...
    if (fTriangleIsArc.fsIn()) {
        ...
        if (fShapeIsCircle) {
            ...
            this->emitArc(f, fEllipseCoords.fsIn(), fEllipseName.fsIn(),
                          true , ellipseCoordsMayBeNegative,
                          coverage.c_str());
        }
        if (fTweakAlphaForCoverage) {
...
void GLSLInstanceProcessor::BackendMultisample::onEmitCode(GrGLSLVertexBuilder*,
    ...
    if (fBatchInfo.fInnerShapeTypes) {
        ...
        innerOpts.fResolveMixedSamples = false; 
...
GLSLInstanceProcessor::BackendMultisample::acceptOrRejectWholeFragment(GrGLSLPPFragmentBuilder* f,
                                                                       bool inside,
                                                                       const EmitShapeOpts& opts) {
    if (inside != opts.fInvertCoverage) { 
...
const ShapeVertex kVertexData[] = {
    ...
    {+1.000000f, +0.414214f, ~0},   
    {+0.707106f, +0.707106f,  0},   
    {+0.414214f, +1.000000f, ~0},   
    { 0.000000f, +1.000000f,  0},   
    {-0.414214f, +1.000000f, ~0},   
    {-0.707106f, +0.707106f,  0},   
    {-1.000000f, +0.414214f, ~0},   
    {-1.000000f,  0.000000f,  0},   
    ...
    {+1.000000f, +0.000000f,  0},   
    {+1.000000f, +0.198913f, ~0},   
    {+0.923879f, +0.382683f,  0},   
    {+0.847760f, +0.566455f, ~0},   
    {+0.707106f, +0.707106f,  0},   
    {+0.566455f, +0.847760f, ~0},   
    {+0.382683f, +0.923879f,  0},   
    {+0.198913f, +1.000000f, ~0},   
    {+0.000000f, +1.000000f,  0},   
    {-0.198913f, +1.000000f, ~0},   
    {-0.382683f, +0.923879f,  0},   
    {-0.566455f, +0.847760f, ~0},   
...
IndexRange InstanceProcessor::GetIndexRangeForRect(AntialiasMode aa) {
    static constexpr IndexRange kRectRanges[kNumAntialiasModes] = {
        ...
        {kFramedRect_FirstIndex,  3 * kFramedRect_TriCount},  
        {kRect_FirstIndex,        3 * kRect_TriCount},        
        {kRect_FirstIndex,        3 * kRect_TriCount}         
    };
...
IndexRange InstanceProcessor::GetIndexRangeForOval(AntialiasMode aa, const SkRect& devBounds) {
    ...
    static constexpr IndexRange kOvalRanges[kNumAntialiasModes] = {
        {kOctagons_FirstIndex,          3 * kOctagons_TriCount},          
        {kDisjointOctagons_FirstIndex,  3 * kDisjointOctagons_TriCount},  
        {kOctagons_FirstIndex,          3 * kOctagons_TriCount},          
        {kOctagonsFanned_FirstIndex,    3 * kOctagonsFanned_TriCount}     
    };
...
IndexRange InstanceProcessor::GetIndexRangeForRRect(AntialiasMode aa) {
    static constexpr IndexRange kRRectRanges[kNumAntialiasModes] = {
        {kCorneredRect_FirstIndex,        3 * kCorneredRect_TriCount},        
        {kCorneredFramedRect_FirstIndex,  3 * kCorneredFramedRect_TriCount},  
        {kCorneredRect_FirstIndex,        3 * kCorneredRect_TriCount},        
        {kCorneredRectFanned_FirstIndex,  3 * kCorneredRectFanned_TriCount}   
    };
