...
enum GrDistanceFieldEffectFlags {
    kSimilarity_DistanceFieldEffectFlag   = 0x001, 
    kScaleOnly_DistanceFieldEffectFlag    = 0x002, 
    kPerspective_DistanceFieldEffectFlag  = 0x004, 
    kUseLCD_DistanceFieldEffectFlag       = 0x008, 
    kBGR_DistanceFieldEffectFlag          = 0x010, 
    kPortrait_DistanceFieldEffectFlag     = 0x020, 
    kGammaCorrect_DistanceFieldEffectFlag = 0x040, 
    kAliased_DistanceFieldEffectFlag      = 0x080, 
    kWideColor_DistanceFieldEffectFlag    = 0x100, 

    kInvalid_DistanceFieldEffectFlag      = 0x200,   
