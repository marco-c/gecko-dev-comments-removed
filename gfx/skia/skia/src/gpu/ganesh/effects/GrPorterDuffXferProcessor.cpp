...
constexpr BlendFormula::Properties BlendFormula::GetProperties(OutputType PrimaryOut,
    ...
    static_cast<Properties>(
        ...
        (!skgpu::BlendCoeffsUseDstColor(SrcCoeff, DstCoeff, false)
                    ? kUnaffectedByDst_Property
                    : 0) |
        (!skgpu::BlendCoeffsUseDstColor(SrcCoeff, DstCoeff, true)
...
static constexpr BlendFormula gBlendTable[2][2][(int)SkBlendMode::kLastCoeffMode + 1] = {
          ...
          MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kZero),
            MakeCoeffFormula(skgpu::BlendCoeff::kOne,  skgpu::BlendCoeff::kZero),
            MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kOne),
       MakeCoeffFormula(skgpu::BlendCoeff::kOne,  skgpu::BlendCoeff::kISA),
       MakeCoeffFormula(skgpu::BlendCoeff::kIDA,  skgpu::BlendCoeff::kOne),
         MakeCoeffFormula(skgpu::BlendCoeff::kDA,   skgpu::BlendCoeff::kZero),
         MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kSA),
        MakeCoeffFormula(skgpu::BlendCoeff::kIDA,  skgpu::BlendCoeff::kZero),
        MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kISA),
       MakeCoeffFormula(skgpu::BlendCoeff::kDA,   skgpu::BlendCoeff::kISA),
       MakeCoeffFormula(skgpu::BlendCoeff::kIDA,  skgpu::BlendCoeff::kSA),
            MakeCoeffFormula(skgpu::BlendCoeff::kIDA,  skgpu::BlendCoeff::kISA),
           MakeCoeffFormula(skgpu::BlendCoeff::kOne,  skgpu::BlendCoeff::kOne),
       MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kSC),
         MakeCoeffFormula(skgpu::BlendCoeff::kOne,  skgpu::BlendCoeff::kISC),
       ...
       MakeCoeffFormula(skgpu::BlendCoeff::kOne,  skgpu::BlendCoeff::kISA),
       MakeCoeffFormula(skgpu::BlendCoeff::kIDA,  skgpu::BlendCoeff::kOne),
         MakeCoverageDstCoeffZeroFormula(skgpu::BlendCoeff::kDA),
         MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISAModulate_OutputType),
        MakeCoverageDstCoeffZeroFormula(skgpu::BlendCoeff::kIDA),
        MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kISA),
       MakeCoeffFormula(skgpu::BlendCoeff::kDA,   skgpu::BlendCoeff::kISA),
       ...
       MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISCModulate_OutputType),
         MakeCoeffFormula(skgpu::BlendCoeff::kOne,  skgpu::BlendCoeff::kISC),
          ...
          MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kZero),
            MakeCoeffFormula(skgpu::BlendCoeff::kOne,  skgpu::BlendCoeff::kZero),
            MakeCoeffFormula(skgpu::BlendCoeff::kZero, skgpu::BlendCoeff::kOne),
       MakeCoeffFormula(skgpu::BlendCoeff::kOne,
...
static constexpr BlendFormula gLCDBlendTable[(int)SkBlendMode::kLastCoeffMode + 1] = {
          MakeCoverageSrcCoeffZeroFormula(BlendFormula::kCoverage_OutputType),
            MakeCoverageFormula(BlendFormula::kCoverage_OutputType,
                                         skgpu::BlendCoeff::kOne),
            MakeCoeffFormula(skgpu::BlendCoeff::kZero,
                                      skgpu::BlendCoeff::kOne),
       MakeCoverageFormula(BlendFormula::kSAModulate_OutputType,
                                         skgpu::BlendCoeff::kOne),
       MakeCoeffFormula(skgpu::BlendCoeff::kIDA,
                                      skgpu::BlendCoeff::kOne),
         MakeCoverageFormula(BlendFormula::kCoverage_OutputType,
        ...
        MakeCoverageFormula(BlendFormula::kCoverage_OutputType,
                                         skgpu::BlendCoeff::kIDA),
        MakeSAModulateFormula(skgpu::BlendCoeff::kZero,
...
PDLCDXferProcessor::PDLCDXferProcessor(const SkPMColor4f& blendConstant, float alpha)
    : INHERITED(kPDLCDXferProcessor_ClassID, false,
...
sk_sp<const GrXferProcessor> GrPorterDuffXPFactory::makeXferProcessor(
    ...
    if (isLCD &&
        SkBlendMode::kSrcOver == fBlendMode && color.isConstant() && 
