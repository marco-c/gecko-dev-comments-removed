...
static MAYBE_CONSTEXPR BlendFormula gBlendTable[2][2][(int)SkBlendMode::kLastCoeffMode + 1] = {
          ...
          MakeCoeffFormula(kZero_GrBlendCoeff, kZero_GrBlendCoeff),
            MakeCoeffFormula(kOne_GrBlendCoeff,  kZero_GrBlendCoeff),
            MakeCoeffFormula(kZero_GrBlendCoeff, kOne_GrBlendCoeff),
       MakeCoeffFormula(kOne_GrBlendCoeff,  kISA_GrBlendCoeff),
       MakeCoeffFormula(kIDA_GrBlendCoeff,  kOne_GrBlendCoeff),
         MakeCoeffFormula(kDA_GrBlendCoeff,   kZero_GrBlendCoeff),
         MakeCoeffFormula(kZero_GrBlendCoeff, kSA_GrBlendCoeff),
        MakeCoeffFormula(kIDA_GrBlendCoeff,  kZero_GrBlendCoeff),
        MakeCoeffFormula(kZero_GrBlendCoeff, kISA_GrBlendCoeff),
       MakeCoeffFormula(kDA_GrBlendCoeff,   kISA_GrBlendCoeff),
       MakeCoeffFormula(kIDA_GrBlendCoeff,  kSA_GrBlendCoeff),
            MakeCoeffFormula(kIDA_GrBlendCoeff,  kISA_GrBlendCoeff),
           MakeCoeffFormula(kOne_GrBlendCoeff,  kOne_GrBlendCoeff),
       MakeCoeffFormula(kZero_GrBlendCoeff, kSC_GrBlendCoeff),
         MakeCoeffFormula(kOne_GrBlendCoeff,  kISC_GrBlendCoeff),

                     },  {

          MakeCoverageSrcCoeffZeroFormula(BlendFormula::kCoverage_OutputType),
            MakeCoverageDstCoeffZeroFormula(kOne_GrBlendCoeff),
            MakeCoeffFormula(kZero_GrBlendCoeff, kOne_GrBlendCoeff),
       MakeCoeffFormula(kOne_GrBlendCoeff,  kISA_GrBlendCoeff),
       MakeCoeffFormula(kIDA_GrBlendCoeff,  kOne_GrBlendCoeff),
         MakeCoverageDstCoeffZeroFormula(kDA_GrBlendCoeff),
         MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISAModulate_OutputType),
        MakeCoverageDstCoeffZeroFormula(kIDA_GrBlendCoeff),
        MakeCoeffFormula(kZero_GrBlendCoeff, kISA_GrBlendCoeff),
       MakeCoeffFormula(kDA_GrBlendCoeff,   kISA_GrBlendCoeff),
       MakeCoverageFormula(BlendFormula::kISAModulate_OutputType, kIDA_GrBlendCoeff),
            MakeCoeffFormula(kIDA_GrBlendCoeff,  kISA_GrBlendCoeff),
           MakeCoeffFormula(kOne_GrBlendCoeff,  kOne_GrBlendCoeff),
       MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISCModulate_OutputType),
         MakeCoeffFormula(kOne_GrBlendCoeff,  kISC_GrBlendCoeff),
...
static MAYBE_CONSTEXPR BlendFormula gLCDBlendTable[(int)SkBlendMode::kLastCoeffMode + 1] = {
          MakeCoverageSrcCoeffZeroFormula(BlendFormula::kCoverage_OutputType),
            MakeCoverageFormula(BlendFormula::kCoverage_OutputType, kOne_GrBlendCoeff),
            MakeCoeffFormula(kZero_GrBlendCoeff, kOne_GrBlendCoeff),
       MakeCoverageFormula(BlendFormula::kSAModulate_OutputType, kOne_GrBlendCoeff),
       MakeCoeffFormula(kIDA_GrBlendCoeff, kOne_GrBlendCoeff),
         MakeCoverageFormula(BlendFormula::kCoverage_OutputType, kDA_GrBlendCoeff),
         MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISAModulate_OutputType),
        MakeCoverageFormula(BlendFormula::kCoverage_OutputType, kIDA_GrBlendCoeff),
        MakeSAModulateFormula(kZero_GrBlendCoeff, kISC_GrBlendCoeff),
       MakeCoverageFormula(BlendFormula::kSAModulate_OutputType, kDA_GrBlendCoeff),
       MakeCoverageFormula(BlendFormula::kISAModulate_OutputType, kIDA_GrBlendCoeff),
            MakeCoverageFormula(BlendFormula::kSAModulate_OutputType, kIDA_GrBlendCoeff),
           MakeCoeffFormula(kOne_GrBlendCoeff, kOne_GrBlendCoeff),
       MakeCoverageSrcCoeffZeroFormula(BlendFormula::kISCModulate_OutputType),
         MakeCoeffFormula(kOne_GrBlendCoeff, kISC_GrBlendCoeff),
};
...
sk_sp<const GrXferProcessor> GrPorterDuffXPFactory::makeXferProcessor(
    ...
    if ((blendFormula.hasSecondaryOutput() && !caps.shaderCaps()->dualSourceBlendingSupport()) ||
        (isLCD && (SkBlendMode::kSrcOver != fBlendMode ))) {
