...
static const BlendFormula gBlendTable[2][2][SkXfermode::kLastCoeffMode + 1] = {
          ...
          DST_CLEAR_FORMULA,
            COEFF_FORMULA(   kOne_GrBlendCoeff,    kZero_GrBlendCoeff),
            NO_DST_WRITE_FORMULA,
       COEFF_FORMULA(   kOne_GrBlendCoeff,    kISA_GrBlendCoeff),
       COEFF_FORMULA(   kIDA_GrBlendCoeff,    kOne_GrBlendCoeff),
         COEFF_FORMULA(   kDA_GrBlendCoeff,     kZero_GrBlendCoeff),
         COEFF_FORMULA(   kZero_GrBlendCoeff,   kSA_GrBlendCoeff),
        COEFF_FORMULA(   kIDA_GrBlendCoeff,    kZero_GrBlendCoeff),
        COEFF_FORMULA(   kZero_GrBlendCoeff,   kISA_GrBlendCoeff),
       COEFF_FORMULA(   kDA_GrBlendCoeff,     kISA_GrBlendCoeff),
       COEFF_FORMULA(   kIDA_GrBlendCoeff,    kSA_GrBlendCoeff),
            COEFF_FORMULA(   kIDA_GrBlendCoeff,    kISA_GrBlendCoeff),
           COEFF_FORMULA(   kOne_GrBlendCoeff,    kOne_GrBlendCoeff),
       COEFF_FORMULA(   kZero_GrBlendCoeff,   kSC_GrBlendCoeff),
         COEFF_FORMULA(   kOne_GrBlendCoeff,    kISC_GrBlendCoeff),

                     },  {

          COVERAGE_SRC_COEFF_ZERO_FORMULA(BlendFormula::kCoverage_OutputType),
            COVERAGE_DST_COEFF_ZERO_FORMULA(kOne_GrBlendCoeff),
            NO_DST_WRITE_FORMULA,
       COEFF_FORMULA(   kOne_GrBlendCoeff,    kISA_GrBlendCoeff),
       COEFF_FORMULA(   kIDA_GrBlendCoeff,    kOne_GrBlendCoeff),
         COVERAGE_DST_COEFF_ZERO_FORMULA(kDA_GrBlendCoeff),
         COVERAGE_SRC_COEFF_ZERO_FORMULA(BlendFormula::kISAModulate_OutputType),
        COVERAGE_DST_COEFF_ZERO_FORMULA(kIDA_GrBlendCoeff),
        COEFF_FORMULA(   kZero_GrBlendCoeff,   kISA_GrBlendCoeff),
       COEFF_FORMULA(   kDA_GrBlendCoeff,     kISA_GrBlendCoeff),
       COVERAGE_FORMULA(BlendFormula::kISAModulate_OutputType, kIDA_GrBlendCoeff),
            COEFF_FORMULA(   kIDA_GrBlendCoeff,    kISA_GrBlendCoeff),
           COEFF_FORMULA(   kOne_GrBlendCoeff,    kOne_GrBlendCoeff),
       COVERAGE_SRC_COEFF_ZERO_FORMULA(BlendFormula::kISCModulate_OutputType),
         COEFF_FORMULA(   kOne_GrBlendCoeff,    kISC_GrBlendCoeff),
...
static const BlendFormula gLCDBlendTable[SkXfermode::kLastCoeffMode + 1] = {
          COVERAGE_SRC_COEFF_ZERO_FORMULA(BlendFormula::kCoverage_OutputType),
            COVERAGE_FORMULA(BlendFormula::kCoverage_OutputType, kOne_GrBlendCoeff),
            NO_DST_WRITE_FORMULA,
       COVERAGE_FORMULA(BlendFormula::kSAModulate_OutputType, kOne_GrBlendCoeff),
       COEFF_FORMULA(   kIDA_GrBlendCoeff,    kOne_GrBlendCoeff),
         COVERAGE_FORMULA(BlendFormula::kCoverage_OutputType, kDA_GrBlendCoeff),
         COVERAGE_SRC_COEFF_ZERO_FORMULA(BlendFormula::kISAModulate_OutputType),
        COVERAGE_FORMULA(BlendFormula::kCoverage_OutputType, kIDA_GrBlendCoeff),
        COEFF_FORMULA_SA_MODULATE(   kZero_GrBlendCoeff,   kISC_GrBlendCoeff),
       COVERAGE_FORMULA(BlendFormula::kSAModulate_OutputType, kDA_GrBlendCoeff),
       COVERAGE_FORMULA(BlendFormula::kISAModulate_OutputType, kIDA_GrBlendCoeff),
            COVERAGE_FORMULA(BlendFormula::kSAModulate_OutputType, kIDA_GrBlendCoeff),
           COEFF_FORMULA(   kOne_GrBlendCoeff,    kOne_GrBlendCoeff),
       COVERAGE_SRC_COEFF_ZERO_FORMULA(BlendFormula::kISCModulate_OutputType),
         COEFF_FORMULA(   kOne_GrBlendCoeff,    kISC_GrBlendCoeff),
};
