...
#include "SkJumper_misc.h"
    ...
    SI F from_half(U16 h) {
        if ((int16_t)h < 0x0400) { h = 0; }   
        return bit_cast<F>(h << 13)           
             * bit_cast<F>(U32(0x77800000));  
    }
    SI U16 to_half(F f) {
        return bit_cast<U32>(f * bit_cast<F>(U32(0x07800000_i)))  
            >> 13;                                                
    }
    ...
    SI F from_half(U16 h) {
        ...
        return bit_cast<F>(w << 13)             
             * bit_cast<F>(U32(0x77800000_i));  
    #endif
    }
    SI U16 to_half(F f) {
    #if defined(__AVX2__)
    ...
    #else
        return pack(bit_cast<U32>(f * bit_cast<F>(U32(0x07800000_i)))  
                    >> 13);                                            
    #endif
    }
