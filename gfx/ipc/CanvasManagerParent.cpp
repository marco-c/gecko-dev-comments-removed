...
bool CanvasManagerParent::sReplayTexturesEnabled(true);
 ...
 void CanvasManagerParent::Shutdown() {
 ...
 void CanvasManagerParent::DisableRemoteCanvas() {
 ...
 void CanvasManagerParent::DisableRemoteCanvasInternal() {
 ...
 void CanvasManagerParent::AddReplayTexture(
 ...
 void CanvasManagerParent::RemoveReplayTexture(
    layers::CanvasTranslator* aOwner, int64_t aTextureId) {
  StaticMonitorAutoLock lock(sReplayTexturesMonitor);
 ...
 void CanvasManagerParent::RemoveReplayTextures(
