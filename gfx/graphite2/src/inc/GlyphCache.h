...
float GlyphCache::getBoundingMetric(unsigned short glyphid, uint8 metric) const
{
    ...
    switch (metric) {
        case 0: return (float)(glyph(glyphid)->theBBox().bl.x);                          
        case 1: return (float)(glyph(glyphid)->theBBox().bl.y);                          
        case 2: return (float)(glyph(glyphid)->theBBox().tr.x);                          
        case 3: return (float)(glyph(glyphid)->theBBox().tr.y);                          
        case 4: return (float)(_boxes[glyphid] ? _boxes[glyphid]->slant().bl.x : 0.f);    
        case 5: return (float)(_boxes[glyphid] ? _boxes[glyphid]->slant().bl.y : 0.f);    
        case 6: return (float)(_boxes[glyphid] ? _boxes[glyphid]->slant().tr.x : 0.f);    
        case 7: return (float)(_boxes[glyphid] ? _boxes[glyphid]->slant().tr.y : 0.f);    
        default: return 0.;
    }
}
