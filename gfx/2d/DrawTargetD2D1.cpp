...
void
DrawTargetD2D1::FinalizeDrawing(CompositionOp aOp, const Pattern &aPattern, const Rect* aAffectedRect )
{
  bool patternSupported = IsPatternSupportedByD2D(aPattern);
...
DrawTargetD2D1::GetImageForLayerContent(bool aShouldPreserveContent, const Rect* aBounds , Point* aOutOffset ) 
{
  PopAllClips();
