...
pub const CMYK_SIGNATURE: u32 = 0x434D594B; 
...
const ABSTRACT_PROFILE: u32 = 0x61627374; 
const NAMED_COLOR_PROFILE: u32 = 0x6e6d636c; 
...
pub const XYZ_TYPE: u32 = 0x58595a20; 
pub const CURVE_TYPE: u32 = 0x63757276; 
pub const PARAMETRIC_CURVE_TYPE: u32 = 0x70617261; 
pub const LUT16_TYPE: u32 = 0x6d667432; 
pub const LUT8_TYPE: u32 = 0x6d667431; 
pub const LUT_MAB_TYPE: u32 = 0x6d414220; 
pub const LUT_MBA_TYPE: u32 = 0x6d424120; 
pub const CHROMATIC_TYPE: u32 = 0x73663332; 
...
fn read_curveType(src: &mut MemSource, offset: u32, len: &mut u32) -> Option<Box<curveType>> {
    const COUNT_TO_LENGTH: [u32; 5] = [1, 3, 4, 5, 7]; 
    let type_0: u32 = read_u32(src, offset as usize);
    let count: u32;
...
fn read_tag_lutmABType(src: &mut MemSource, tag: &Tag) -> Option<Box<lutmABType>> {
    ...
    if matrix_offset != 0 {
        ...
        lut.e00 = read_s15Fixed16Number(src, (matrix_offset + (4 * 0) as u32) as usize); 
...
impl Profile {
    ...
    pub fn new_from_slice(mem: &[u8], curves_only: bool) -> Option<Box<Profile>> {
        ...
        if let Some(chad) = find_tag(&index, TAG_CHAD) {
            ...
            profile.chromaticAdaption = None; 
        }
