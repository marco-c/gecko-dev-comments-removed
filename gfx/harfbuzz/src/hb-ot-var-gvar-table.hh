...
struct glyph_variations_t
{
                                    ...
                                    const hb_hashmap_t<hb_codepoint_t, hb_bytes_t>& new_gid_var_data_map)
  {
    ...
    for (auto &_ : it)
    {
      ...
      if (!p->decompile_tuple_variations (all_contour_points->length, true ,
  ...
  bool serialize_glyph_var_data (hb_serialize_context_t *c,
                                 ...
                                 bool long_offset,
                                 unsigned num_glyphs,
                                 char* glyph_var_data_offsets ) const
  {
...
struct gvar_GVAR
{
  ...
  bool decompile_glyph_variations (hb_subset_context_t *c,
                                   glyph_variations_t<GidOffsetType>& glyph_vars ) const
  {
  ...
  struct accelerator_t
  {
    ...
    template <bool is_x>
#endif
    static bool decompile_deltas_add_to_points (const HBUINT8 *&p ,
