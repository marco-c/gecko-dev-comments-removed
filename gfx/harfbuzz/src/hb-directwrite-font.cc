				   ...
				   void *user_data HB_UNUSED)
{
  ...
  *y = font->em_scale_y (metrics.verticalOriginY); 
				  ...
				  void *user_data HB_UNUSED)
{
  ...
  extents->height = font->em_scale_y (metrics.verticalOriginY - metrics.advanceHeight + metrics.bottomSideBearing) - extents->y_bearing; 
