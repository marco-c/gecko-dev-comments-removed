					    ...
					    hb_font_t *font)
{
  ...
  OT::HBGlyphID16 component_list[ARRAY_LENGTH_CONST (ligature_list) * 1];
				   ...
				   hb_font_t *font HB_UNUSED)
{
  ...
  hb_codepoint_t g;
  if (!(hb_font_get_glyph (font, 0x0627u, 0, &g) && g == 199  &&
	hb_font_get_glyph (font, 0x0644u, 0, &g) && g == 225  &&
	hb_font_get_glyph (font, 0x0649u, 0, &g) && g == 236  &&
	hb_font_get_glyph (font, 0x064Au, 0, &g) && g == 237  &&
	hb_font_get_glyph (font, 0x0652u, 0, &g) && g == 250 ))
    return false;
