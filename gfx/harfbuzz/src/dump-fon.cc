...
typedef LEIntType<uint8_t,  1> LEUINT8;		
typedef LEIntType<int8_t,   1> LEINT8;		
typedef LEIntType<uint16_t, 2> LEUINT16;	
typedef LEIntType<int16_t,  2> LEINT16;		
typedef LEIntType<uint32_t, 4> LEUINT32;	
typedef LEIntType<int32_t,  4> LEINT32;		
typedef LEIntType<uint32_t, 3> LEUINT24;	
