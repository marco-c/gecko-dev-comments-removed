...
struct glyf
{
  ...
  struct Glyph
  {
	...
	return true;
      ...
      bool get_contour_points (contour_point_vector_t &points_ ,
			       hb_vector_t<unsigned int> &end_points_ ,
  ...
  struct accelerator_t
  {
    ...
    void init_phantom_points (hb_codepoint_t gid, hb_array_t<contour_point_t> &phantoms ) const
    {
    ...
    bool get_var_extents_and_phantoms (hb_font_t *font, hb_codepoint_t gid,
				       hb_glyph_extents_t *extents=nullptr ,
				       contour_point_vector_t *phantoms=nullptr ) const
    {
      contour_point_vector_t all_points;
