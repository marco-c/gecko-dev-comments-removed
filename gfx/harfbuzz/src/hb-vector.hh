...
struct hb_vector_t
{
  ...
  hb_array_t<const Type> sorted_sub_array (unsigned int start_offset, unsigned int *count = nullptr ) const
  { return as_sorted_array ().sorted_sub_array (start_offset, count);}
  hb_array_t<Type> sorted_sub_array (unsigned int start_offset, unsigned int count)
  { return as_sorted_array ().sorted_sub_array (start_offset, count);}
  hb_array_t<Type> sorted_sub_array (unsigned int start_offset, unsigned int *count = nullptr )
  { return as_sorted_array ().sorted_sub_array (start_offset, count);}
