...
public:
  ...
  const static uint32_t loadNormal = 0;                     
  const static uint32_t loadNormalReplace = 1;              
  const static uint32_t loadHistory = 2;                    
  const static uint32_t loadReloadNormal = 3;               
  ...
  const static uint32_t loadPushState = 17;                 
