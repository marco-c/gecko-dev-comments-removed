...
nsDOMNavigationTiming* nsDocShell::GetNavigationTiming() const {
 ...
 bool nsDocShell::ValidateOrigin(
...
nsDocShell::GetCanExecuteScripts(bool* aResult) {
 ...
 NS_IMETHODIMP nsDocShell::SetFrameType(
    FrameType aFrameType) {
  mFrameType = aFrameType;
  return NS_OK;
}

 NS_IMETHODIMP nsDocShell::GetFrameType(
    FrameType* aFrameType) {
  *aFrameType = mFrameType;
  return NS_OK;
}

 NS_IMETHODIMP nsDocShell::GetIsMozBrowser(
    bool* aIsMozBrowser) {
...
uint32_t nsDocShell::GetInheritedFrameType() {
 ...
 NS_IMETHODIMP nsDocShell::GetIsInMozBrowser(
