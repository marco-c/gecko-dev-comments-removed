...
class BASE_EXPORT File {
 public:
  ...
  enum Flags : uint32_t {
    ...
    FLAG_WRITE = 1 << 6,
    FLAG_APPEND = 1 << 7,
    FLAG_WIN_EXCLUSIVE_READ = 1 << 8,   
    FLAG_WIN_EXCLUSIVE_WRITE = 1 << 9,  
    FLAG_ASYNC = 1 << 10,
    FLAG_WIN_TEMPORARY = 1 << 11,  
    FLAG_WIN_HIDDEN = 1 << 12,     
    FLAG_DELETE_ON_CLOSE = 1 << 13,
    FLAG_WRITE_ATTRIBUTES = 1 << 14,  
                                      
    FLAG_WIN_SHARE_DELETE = 1 << 15,  
    FLAG_TERMINAL_DEVICE = 1 << 16,   
    FLAG_WIN_BACKUP_SEMANTICS = 1 << 17,  
    FLAG_WIN_EXECUTE = 1 << 18,           
    FLAG_WIN_SEQUENTIAL_SCAN = 1 << 19,   
