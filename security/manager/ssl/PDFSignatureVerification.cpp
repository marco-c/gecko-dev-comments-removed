...
void VerifyPKCS7Object(
    ...
    nsIX509CertDB::PDFSignatureAlgorithm signatureType,
     nsTArray<RefPtr<PDFVerificationResultImpl>>& pdfVerifResults) {
  if (signatureType !=
...
class VerifyPKCS7ObjectTask : public CryptoTask {
 ...
 private:
  ...
  nsTArray<RefPtr<PDFVerificationResultImpl>> mPdfVerifResults;  
