...
function checkDefaultSiteHPKPStatus() {
  ok(
    gSSService.isSecureURI(
      ...
      Services.io.newURI("https://a.pinning2.example.com"),
      0
    ),
  ...
  ok(
    !gSSService.isSecureURI(
      Ci.nsISiteSecurityService.HEADER_HPKP,
      Services.io.newURI("https://x.a.pinning2.example.com"),
      0
    ),
  ...
  ok(
    gSSService.isSecureURI(
      Ci.nsISiteSecurityService.HEADER_HPKP,
      Services.io.newURI("https://b.pinning2.example.com"),
      0
    ),
  ...
  ok(
    gSSService.isSecureURI(
      Ci.nsISiteSecurityService.HEADER_HPKP,
      Services.io.newURI("https://x.b.pinning2.example.com"),
      0
    ),
...
function checkStateRead(aSubject, aTopic, aData) {
  if (aData == SSS_STATE_FILE_NAME) {
    ...
    throw new Error(
      "Observed data should either be the Site Security " +
...
async function async_check_pins() {
  ...
  await checkOK(
    certFromFile("x.a.pinning2.example.com-badca"),
    "x.a.pinning2.example.com"
  );
  await checkOK(
    certFromFile("x.a.pinning2.example.com-pinningroot"),
    "x.a.pinning2.example.com"
  );

  await checkFail(
    certFromFile("b.pinning2.example.com-badca"),
    "b.pinning2.example.com"
  );
  await checkOK(
    certFromFile("b.pinning2.example.com-pinningroot"),
    "b.pinning2.example.com"
  );
  await checkFail(
    certFromFile("x.b.pinning2.example.com-badca"),
    "x.b.pinning2.example.com"
  );
  await checkOK(
    certFromFile("x.b.pinning2.example.com-pinningroot"),
    "x.b.pinning2.example.com"
  );
  ...
  throws(
    ...
    "Attempting to set an invalid pin should fail"
  );
  await checkFail(
    certFromFile("a.pinning2.example.com-badca"),
    "a.pinning2.example.com"
  ...
  ok(
    gSSService.isSecureURI(
      Ci.nsISiteSecurityService.HEADER_HPKP,
      Services.io.newURI("https://include-subdomains.pinning.example.com"),
      0
    ),
  ...
  await checkFail(
    certFromFile("a.preload.example.com-badca"),
    "a.preload.example.com"
  );
  await checkOK(
    certFromFile("a.preload.example.com-pinningroot"),
    "a.preload.example.com"
  );
