...
function run_test() {
  ...
  let lines = [
    ...
    "test.example.com:443:^privateBrowsingId=2\tOID.2.16.840.1.101.3.4.2.1\t" +
      cert1.sha256Fingerprint +
      "\t",
    "test.example.com:443:^privateBrowsingId=3\tOID.2.16.840.1.101.3.4.2.1\t" + 
      cert1.sha256Fingerprint +
      "\tM\t" +
    ...
    "example.com:443:\tOID.2.16.840.1.101.3.4.2.1\t" +
      ...
      "\t",
    "[::1]:443:\tOID.2.16.840.1.101.3.4.2.1\t" + 
      cert2.sha256Fingerprint +
      "\t",
    "old.example.com:443\tOID.2.16.840.1.101.3.4.2.1\t" + 
      cert1.sha256Fingerprint +
      "\t",
    ":443:\tOID.2.16.840.1.101.3.4.2.1\t" + 
      cert3.sha256Fingerprint +
      "\t",
    "example.com::\tOID.2.16.840.1.101.3.4.2.1\t" + 
      cert3.sha256Fingerprint +
      "\t",
    "example.com:443:\tOID.2.16.840.1.101.3.4.2.1\t" + 
      cert2.sha256Fingerprint +
      "\t",
    "example.com:443:\tOID.0.00.000.0.000.0.0.0.0\t" + 
      cert3.sha256Fingerprint +
      "\t",
    "example.com:443:\t.0.0.0.0\t" + 
      cert3.sha256Fingerprint +
      "\t",
    "example.com:443:\t\t" + 
      cert3.sha256Fingerprint +
  ...
  const BAD_OVERRIDES = [
    {
      ...
      port: 443,
      cert: cert1,
      attributes: { privateBrowsingId: 4 }, 
    },
    {
      host: "test.example.com",
      port: 443,
