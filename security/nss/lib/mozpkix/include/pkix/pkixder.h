...
Result BitStringWithNoUnusedBits(Reader& input,  Input& value);

inline Result Boolean(Reader& input,  bool& value) {
  Reader valueReader;
...
inline Result OptionalBoolean(Reader& input,  bool& value) {
  value = false;
...
inline Result GeneralizedTime(Reader& input,  Time& time) {
...
inline Result TimeChoice(Reader& input,  Time& time) {
...
inline Result Integer(Reader& input,  uint8_t& value) {
...
inline Result CertificateSerialNumber(Reader& input,  Input& value) {
