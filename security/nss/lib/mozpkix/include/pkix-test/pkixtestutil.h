...
ByteString CreateEncodedCertificate(
    ...
    const TestKeyPair& subjectKeyPair,
     const ByteString* extensions, const TestKeyPair& issuerKeyPair,
    const TestSignatureAlgorithm& signatureAlgorithm);
...
ByteString CreateEncodedBasicConstraints(
    bool isCA,
     const long* pathLenConstraint, Critical critical);
...
class OCSPResponseContext final {
 public:
  ...
  const ByteString* trailingResponseData; 
