...
#define MAX_ML_KEM_CIPHER_LENGTH KYBER768_CIPHERTEXT_BYTES
#define MAX_ML_KEM_PRIVATE_KEY_LENGTH KYBER768_PRIVATE_KEY_BYTES
#define MAX_ML_KEM_PUBLIC_KEY_LENGTH KYBER768_PUBLIC_KEY_BYTES
