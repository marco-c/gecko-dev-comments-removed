                    ...
                    mp_int *rx, mp_int *ry, const ECGroup *group)
{
    ...
    MP_CHECKOK(mp_copy(px, &x1));                              
    MP_CHECKOK(mp_set_int(&z1, 1));                            
    MP_CHECKOK(group->meth->field_sqr(&x1, &z2, group->meth)); 
    MP_CHECKOK(group->meth->field_sqr(&z2, &x2, group->meth));
    MP_CHECKOK(group->meth->field_add(&x2, &group->curveb, &x2, group->meth)); 
