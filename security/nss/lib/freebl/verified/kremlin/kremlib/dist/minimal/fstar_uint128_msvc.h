...
FStar_UInt128_add(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
    ...
    unsigned char carry =
        _addcarry_u64(0, a.low, b.low, &l);   
    _addcarry_u64(carry, a.high, b.high, &h); 
    return _mm_set_epi64x(h, l);
#else
...
FStar_UInt128_eq_mask(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
    ...
    __m128i s64 =
        _mm_shuffle_epi32(ret64, _MM_SHUFFLE(1, 0, 3, 2)); 
...
FStar_UInt128_gte_mask(FStar_UInt128_uint128 a, FStar_UInt128_uint128 b)
{
    ...
    __m128i ge0 = ge;
    __m128i eq0 = eq;
    __m128i ge1 = _mm_srli_si128(ge, 4); 
    __m128i t1 = _mm_and_si128(eq0, ge1);
    __m128i ret = _mm_or_si128(ge, t1);  
    __m128i eq1 = _mm_srli_si128(eq, 4); 
    __m128i ge2 =
        _mm_srli_si128(ge1, 4); 
    __m128i t2 =
        _mm_and_si128(eq0, _mm_and_si128(eq1, ge2)); 
    ret = _mm_or_si128(ret, t2);
    __m128i eq2 = _mm_srli_si128(eq1, 4); 
    __m128i ge3 =
        _mm_srli_si128(ge2, 4); 
    __m128i t3 = _mm_and_si128(
        eq0, _mm_and_si128(
                 eq1, _mm_and_si128(eq2, ge3))); 
