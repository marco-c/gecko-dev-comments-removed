...
TEST_F(Pkcs11AESKeyWrapPadTest, WrapUnwrapRandom_EvenBlock) {
  ...
  rv = PK11_Encrypt(kek.get(), CKM_NSS_AES_KEY_WRAP_PAD,  nullptr,
  ...
  rv = PK11_Decrypt(kek.get(), CKM_NSS_AES_KEY_WRAP_PAD,  nullptr,
...
TEST_F(Pkcs11AESKeyWrapPadTest, WrapUnwrapRandom_PaddingTooLong) {
  ...
  SECStatus rv =
      PK11_Encrypt(kek.get(), CKM_NSS_AES_KEY_WRAP,  
                    nullptr, wrapped_key.data(), &out_len,
