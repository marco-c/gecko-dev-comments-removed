    ...
    PKIX_PL_Object **obj4)
{
    ...
    PKIX_TEST_EXPECT_NO_ERROR(PKIX_PL_Object_RegisterType(1000,       
                                                          "thousand", 
                                                          NULL,       
                                                          NULL,       
    ...
    PKIX_TEST_EXPECT_NO_ERROR(PKIX_PL_Object_Alloc(1000, 
                                                   12,   
                                                   obj,
                                                   plContext));

    PKIX_TEST_EXPECT_NO_ERROR(PKIX_PL_Object_RegisterType(2000, 
                                                          "two thousand" ,
    ...
    PKIX_TEST_EXPECT_NO_ERROR(PKIX_PL_Object_Alloc(2000, 
                                                   1,    
                                                   obj2,
                                                   plContext));
