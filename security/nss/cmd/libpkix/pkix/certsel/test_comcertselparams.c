...
test_comcertselparams(int argc, char *argv[])
{
    ...
    PKIX_List *testPolicyInfos = NULL;  
    PKIX_List *cert2PolicyInfos = NULL; 
    ...
    PKIX_List *goodPolicies = NULL;  
    PKIX_List *equalPolicies = NULL; 
    PKIX_List *testPolicies = NULL;  
    PKIX_List *cert2Policies = NULL; 
