...
static const CK_ATTRIBUTE_TYPE known_attributes[] = {
    ...
    CKA_NAME_HASH_ALGORITHM, CKA_HASH_OF_CERTIFICATE,
    ...
    CKA_NSS_TRUST_DIGITAL_SIGNATURE, CKA_NSS_TRUST_NON_REPUDIATION,
    CKA_NSS_TRUST_KEY_ENCIPHERMENT, CKA_NSS_TRUST_DATA_ENCIPHERMENT,
    CKA_NSS_TRUST_KEY_AGREEMENT, CKA_NSS_TRUST_KEY_CERT_SIGN,
    CKA_NSS_TRUST_CRL_SIGN, CKA_NSS_TRUST_SERVER_AUTH,
    CKA_NSS_TRUST_CLIENT_AUTH, CKA_NSS_TRUST_CODE_SIGNING,
    CKA_NSS_TRUST_EMAIL_PROTECTION, CKA_NSS_TRUST_IPSEC_END_SYSTEM,
    CKA_NSS_TRUST_IPSEC_TUNNEL, CKA_NSS_TRUST_IPSEC_USER,
    CKA_NSS_TRUST_TIME_STAMPING, CKA_NSS_TRUST_STEP_UP_APPROVED,
    CKA_NSS_CERT_SHA1_HASH, CKA_NSS_CERT_MD5_HASH,
...
typedef struct Pkcs5v2PBEParameterStr {
    SECAlgorithmID keyParams; 
    SECAlgorithmID algParams; 
} Pkcs5v2PBEParameter;
...
oid2string(SECOidTag alg)
{
    ...
    const char *def = "Invalid oid tag"; 
