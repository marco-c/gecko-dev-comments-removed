...
aes_gcm(char *reqfn, int encrypt)
{
    ...
    unsigned int plaintextlen;
    unsigned char ciphertext[11 * 16]; 
    unsigned int ciphertextlen;
    unsigned char aad[11 * 16]; 
...
hmac_test(char *reqfn)
{
    ...
    HASH_HashType hash_alg = HASH_AlgNULL;       
