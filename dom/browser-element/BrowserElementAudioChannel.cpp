...
NS_IMPL_CYCLE_COLLECTION_INHERITED(BrowserElementAudioChannel,
 ...
 already_AddRefed<BrowserElementAudioChannel>
...
public:
  ...
  RespondSuccessHandler(nsPIDOMWindow* aOwner, nsPIDOMWindow* aFrameWindow,
                        DOMRequest* aRequest, AudioChannel aChannel)
    : mOwner(aOwner)
    , mFrameWindow(aFrameWindow)
                                          ...
                                          ErrorResult& aRv)
{
  ...
  RefPtr<DOMRequest> domRequest = new DOMRequest(GetOwner());
  RefPtr<RespondSuccessHandler> handler =
    new RespondSuccessHandler(GetOwner(), mFrameWindow,
                              domRequest, mAudioChannel);
