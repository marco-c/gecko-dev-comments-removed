                ...
                MediaData* aData, AudioSegment* aOutput, uint32_t aRate)
{
  ...
  aOutput->AppendFrames(buffer.forget(), channels, audio->mFrames, PRINCIPAL_HANDLE_NONE );
                        ...
                        VideoSegment* aOutput)
{
  ...
  aOutput->AppendFrame(image.forget(), duration, aIntrinsicSize, PRINCIPAL_HANDLE_NONE );
}
