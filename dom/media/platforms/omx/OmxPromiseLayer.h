...
public:
  ...
  typedef MozPromise<BufferData*, OmxBufferFailureHolder,  false> OmxBufferPromise;
  ...
  typedef MozPromise<OMX_COMMANDTYPE, OmxCommandFailureHolder,  true> OmxCommandPromise;

  typedef MozPromise<uint32_t, bool,  true> OmxPortConfigPromise;
