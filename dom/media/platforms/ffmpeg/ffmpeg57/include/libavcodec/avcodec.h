...
#define CODEC_CAP_DRAW_HORIZ_BAND \
  AV_CODEC_CAP_DRAW_HORIZ_BAND  ///< Decoder can use draw_horiz_band callback.
...
#define SLICE_FLAG_ALLOW_FIELD \
  0x0002  ///< allow draw_horiz_band() with field slices (MPEG2 field pics)
...
#define FF_BUG_AC_VLC \
  0  ///< Will be removed, libavcodec can now handle these non-compliant files
...
#define FF_DEBUG_VIS_QP \
  0x00002000  ///< only access through AVOptions from outside libavcodec
#define FF_DEBUG_VIS_MB_TYPE \
  0x00004000  ///< only access through AVOptions from outside libavcodec
#endif
...
attribute_deprecated struct AVResampleContext *av_resample_init(
    int out_rate, int in_rate, int filter_length, int log2_phase_count,
...
attribute_deprecated int av_resample(struct AVResampleContext *c, short *dst,
                                     short *src, int *consumed, int src_size,
...
attribute_deprecated void avcodec_set_dimensions(AVCodecContext *s, int width,
                                                 int height);
#endif
...
attribute_deprecated void av_log_missing_feature(void *avc, const char *feature,
                                                 int want_sample);
...
attribute_deprecated void av_log_ask_for_sample(void *avc, const char *msg, ...)
