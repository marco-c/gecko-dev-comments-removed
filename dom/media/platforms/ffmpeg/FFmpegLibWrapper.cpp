...
void FFmpegLibWrapper::UpdateLogLevel() {
 ...
 void FFmpegLibWrapper::RegisterCallbackLogLevel(
 ...
 int FFmpegLibWrapper::ToLibLogLevel(LogLevel aLevel) {
  switch (aLevel) {
 ...
 LogLevel FFmpegLibWrapper::FromLibLogLevel(int aLevel) {
  switch (aLevel) {
    case AV_LOG_QUIET:
 ...
 void FFmpegLibWrapper::Log(void* aPtr, int aLevel,
