 ...
 public:
  virtual HRESULT STDMETHODCALLTYPE KeyMessage(
      ...
      __RPC__in_ecount_full(messageSize) const BYTE* message,
       DWORD messageSize,
       __RPC__in LPCWSTR destinationURL) = 0;
