...
AudioConfig::ChannelLayout::SMPTEDefault(const ChannelLayout& aChannelLayout) {
 ...
 ChannelLayout AudioConfig::ChannelLayout::SMPTEDefault(
    ChannelMap aMap) {
...
bool AudioConfig::ChannelLayout::MappingTable(const ChannelLayout& aOther,
 ...
 const char* AudioConfig::FormatToString(
 ...
 uint32_t AudioConfig::SampleSize(
    AudioConfig::SampleFormat aFormat) {
  switch (aFormat) {
    case FORMAT_U8:
      return 1;
 ...
 uint32_t AudioConfig::FormatToBits(
    AudioConfig::SampleFormat aFormat) {
  switch (aFormat) {
    case FORMAT_U8:
      return 8;
