...
already_AddRefed<MediaByteBuffer> RemoteArrayOfByteBuffer::MediaByteBufferAt(
 ...
 void ipc::IPDLParamTraits<RemoteArrayOfByteBuffer>::Write(
 ...
 bool ipc::IPDLParamTraits<RemoteArrayOfByteBuffer>::Read(
...
already_AddRefed<MediaRawData> ArrayOfRemoteMediaRawData::ElementAt(
 ...
 void ipc::IPDLParamTraits<ArrayOfRemoteMediaRawData*>::Write(
    IPC::MessageWriter* aWriter, ipc::IProtocol* aActor,
 ...
 bool ipc::IPDLParamTraits<ArrayOfRemoteMediaRawData*>::Read(
    IPC::MessageReader* aReader, mozilla::ipc::IProtocol* aActor,
...
already_AddRefed<AudioData> ArrayOfRemoteAudioData::ElementAt(
 ...
 void ipc::IPDLParamTraits<ArrayOfRemoteAudioData*>::Write(
    IPC::MessageWriter* aWriter, ipc::IProtocol* aActor,
 ...
 bool ipc::IPDLParamTraits<ArrayOfRemoteAudioData*>::Read(
    IPC::MessageReader* aReader, mozilla::ipc::IProtocol* aActor,
