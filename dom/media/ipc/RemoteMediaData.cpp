...
already_AddRefed<MediaByteBuffer> RemoteArrayOfByteBuffer::MediaByteBufferAt(
 ...
 void IPC::ParamTraits<mozilla::RemoteArrayOfByteBuffer>::Write(
 ...
 bool IPC::ParamTraits<mozilla::RemoteArrayOfByteBuffer>::Read(
...
already_AddRefed<MediaRawData> ArrayOfRemoteMediaRawData::ElementAt(
 ...
 void IPC::ParamTraits<mozilla::ArrayOfRemoteMediaRawData*>::Write(
 ...
 bool IPC::ParamTraits<mozilla::ArrayOfRemoteMediaRawData*>::Read(
...
already_AddRefed<AudioData> ArrayOfRemoteAudioData::ElementAt(
 ...
 void IPC::ParamTraits<mozilla::ArrayOfRemoteAudioData*>::Write(
    IPC::MessageWriter* aWriter, mozilla::ArrayOfRemoteAudioData* aVar) {
  WriteParam(aWriter, std::move(aVar->mSamples));
  WriteParam(aWriter, std::move(aVar->mBuffers));
}

 bool IPC::ParamTraits<mozilla::ArrayOfRemoteAudioData*>::Read(
