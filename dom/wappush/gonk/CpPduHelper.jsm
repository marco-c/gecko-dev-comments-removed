...
const CP_VALUE_FIELDS = (function () {
  ...
  add("CDMA2000-1X-SIMPLE-IP",            0,  0xB9);  
  add("CDMA2000-1X-MOBILE-IP",            0,  0xBA);  
  ...
  add("OTA-HTTP-TO",                      0,  0xD0);  
  add("OTA-HTTP-TLS-TO",                  0,  0xD1);  
  add("OTA-HTTP-PO",                      0,  0xD2);  
  add("OTA-HTTP-TLS-PO",                  0,  0xD3);  
  add("AAA",                              0,  0xE0);  
  add("HA",                               0,  0xE1);  
