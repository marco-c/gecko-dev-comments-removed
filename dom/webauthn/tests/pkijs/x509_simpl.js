...
function(in_window)
{
            ...
            case 6:
                {
                    ...
                    value.id_block.tag_class = 1; 
                    value.id_block.tag_number = 22; 
            ...
            case 8: 
                {
                    ...
                    value.id_block.tag_class = 1; 
                    value.id_block.tag_number = 6; 

                    var value_ber = value.toBER(false);

                    this.Name = in_window.org.pkijs.fromBER(value_ber).result.value_block.toString(); 
                }
                break;
            default:
        }
    ...
    function(schema)
    {
        ...
        {
            asn1.result["keyIdentifier"].id_block.tag_class = 1; 
            asn1.result["keyIdentifier"].id_block.tag_number = 4; 
        ...
        {
            asn1.result["authorityCertSerialNumber"].id_block.tag_class = 1; 
            asn1.result["authorityCertSerialNumber"].id_block.tag_number = 2; 
    ...
    function()
    {
        ...
        else
        {
            if(arguments[0] instanceof Object)
            {
                this.certificatePolicies = arguments[0].certificatePolicies || new Array(); 
            }
        }
    ...
    function(schema)
    {
        ...
        if("requireExplicitPolicy" in asn1.result)
        {
            ...
            field1.id_block.tag_class = 1; 
            field1.id_block.tag_number = 2; 
        ...
        if("inhibitPolicyMapping" in asn1.result)
        {
            ...
            field2.id_block.tag_class = 1; 
            field2.id_block.tag_number = 2; 
    ...
    function()
    {
        ...
        if("requireExplicitPolicy" in this)
        {
            ...
            int1.id_block.tag_class = 3; 
            int1.id_block.tag_number = 0; 
    ...
    function(schema)
    {
        ...
        if("distributionPoint" in asn1.result)
        {
            ...
            {
                asn1.result["distributionPoint"].id_block.tag_class = 1; 
                asn1.result["distributionPoint"].id_block.tag_number = 16; 
    ...
    function()
    {
        ...
        else
        {
            if(arguments[0] instanceof Object)
            {
                this.distributionPoints = arguments[0].distributionPoints || new Array(); 
            }
        }
    ...
    function()
    {
        ...
        else
        {
            if(arguments[0] instanceof Object)
            {
                this.accessDescriptions = arguments[0].accessDescriptions || new Array(); 
            }
        }
    ...
    function(schema)
    {
        ...
        switch(this.extnID)
        {
            ...
            case "2.5.29.28": 
                ...
                break;
            case "2.5.29.29": 
                this.parsedValue = new in_window.org.pkijs.simpl.GENERAL_NAMES({ schema: asn1.result }); 
                break;
            case "2.5.29.30": 
            ...
            case "RSA-PSS":
                {
                    ...
                    _this.signatureAlgorithm = _this.signature; 
    ...
    function()
    {
        ...
        if(arguments[0] instanceof Object)
        {
            ...
            if("publicKeyInfo" in arguments[0])
                subjectPublicKeyInfo = arguments[0].publicKeyInfo; 
            ...
            return inner(current_certificate, 0).then(
                function(index)
                {
                    ...
                    if(current_certificate.issuer.isEqual(current_certificate.subject) === true)
                    {
                        ...
                        var found = (_this.trusted_certs.length === 0); 
    ...
    function()
    {
        ...
        initial_policy_set.push("2.5.29.32.0"); 

        var initial_explicit_policy = false;
        var initial_policy_mapping_inhibit = false;
        var initial_inhibit_policy = false;

        var initial_permitted_subtrees_set = new Array(); 
        var initial_excluded_subtrees_set = new Array();  
        var initial_required_name_forms = new Array();    
        ...
        sequence = sequence.then(
            function()
            {
                ...
                var all_policies = new Array(); 
                all_policies.push("2.5.29.32.0"); 

                var policies_and_certs = new Array(); 

                var any_policy_array = new Array(_this.certs.length - 1); 
                for(var ii = 0; ii < (_this.certs.length - 1) ; ii++)
                    any_policy_array[ii] = true;

                policies_and_certs.push(any_policy_array);

                var policy_mappings = new Array(_this.certs.length - 1); 
                var cert_policies = new Array(_this.certs.length - 1); 
                           ...
                           (policy_mapping_inhibit_indicator === false))
                        {
                            for(var m = 0; m < cert_policies[i].certificatePolicies.length; m++)
                            {
                                ...
                                if(domainPolicy_index !== (-1))
                                    (policies_and_certs[domainPolicy_index])[i] = true; 
        ...
        sequence = sequence.then(
            function(policy_result)
            {
                ...
                for(var i = (_this.certs.length - 2) ; i >= 0 ; i--, path_depth++)
                {
                    ...
                    var constr_groups = new Array(); 
                    constr_groups[0] = new Array(); 
                    constr_groups[1] = new Array(); 
                    constr_groups[2] = new Array(); 
                    constr_groups[3] = new Array(); 
                    constr_groups[4] = new Array(); 
                            ...
                            switch(p)
                            {
                                ...
                                case 0:
                                    ...
                                    else 
                                    {
                                        for(var k = 0; k < _this.certs[i].subject.types_and_values.length; k++)
                                        {
                                            if((_this.certs[i].subject.types_and_values[k].type === "1.2.840.113549.1.9.1") ||    
                                               (_this.certs[i].subject.types_and_values[k].type === "0.9.2342.19200300.100.1.3")) 
                                            {
                                                valueExists = true;
                        ...
                        switch(excluded_subtrees[j].base.NameType)
                        {
                            ...
                            case 1:
                                ...
                                else 
                                {
                                    ...
                                    {
                                        if((_this.subject.types_and_values[k].type === "1.2.840.113549.1.9.1") ||    
                                           (_this.subject.types_and_values[k].type === "0.9.2342.19200300.100.1.3")) 
                                        {
