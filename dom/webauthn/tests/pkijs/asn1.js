...
function(in_window)
{
    ...
    function()
    {
        ...
        if(arguments[0] instanceof Object)
        {
            ...
            if("value_hex" in arguments[0])
            {
                ...
                if(this.value_hex.byteLength >= 4) 
                    this.is_hex_only = true;
                else
        ...
        for(var j = 1; j < parser_array.length; j++)
        {
            switch(j)
            {
                case 1:
                    ...
                    break;
                case 2:
                    this.month = parseInt(parser_array[j], 10) - 1; 
                    break;
                case 3:
    ...
    function()
    {
        if(arguments[0] instanceof Object)
        {
            ...
            this.local = in_window.org.pkijs.getValue(arguments[0], "local", false); 
        }
    };
    ...
    {
        var incoming_offset = input_offset; 
    ...
    function(root, input_asn1_data, input_asn1_schema)
    {
        ...
        if(('is_hex_only' in input_asn1_schema.id_block) === false) 
            return {
                verified: false,
                result: { error: "Wrong ASN.1 schema" }
            };
        ...
        {
            if(('value_hex' in input_asn1_schema.id_block) === false) 
                return {
                    verified: false,
                    result: { error: "Wrong ASN.1 schema" }
                };
