...
add_task(function* () {
  ...
  info("-> " + tabStripContainer.tagName); 
  info("-> " + tabStripContainer.firstChild.tagName); 
  info("-> " + tabStripContainer.childNodes[0].label); 
  info("-> " + tabStripContainer.childNodes[1].label); 
