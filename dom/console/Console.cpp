...
NS_INTERFACE_MAP_END
 ...
 already_AddRefed<Console> Console::Create(
 ...
 already_AddRefed<Console> Console::CreateForWorklet(
...
#undef METHOD
 ...
 void Console::TimeLog(const GlobalObject& aGlobal,
                                   const nsAString& aLabel,
                                   const Sequence<JS::Value>& aData) {
 ...
 void Console::StringMethod(const GlobalObject& aGlobal,
                                        const nsAString& aLabel,
                                        const Sequence<JS::Value>& aData,
...
void Console::StringMethodInternal(JSContext* aCx, const nsAString& aLabel,
 ...
 void Console::ProfileMethod(const GlobalObject& aGlobal,
                                         MethodName aName,
                                         const nsAString& aAction,
                                         const Sequence<JS::Value>& aData) {
  RefPtr<Console> console = GetConsole(aGlobal);
...
void Console::ProfileMethodInternal(JSContext* aCx, MethodName aMethodName,
 ...
 void Console::Count(const GlobalObject& aGlobal,
                                 const nsAString& aLabel) {
  StringMethod(aGlobal, aLabel, Sequence<JS::Value>(), MethodCount,
               NS_LITERAL_STRING("count"));
}

 void Console::CountReset(const GlobalObject& aGlobal,
                                      const nsAString& aLabel) {
...
void ReifyStack(JSContext* aCx, nsIStackFrame* aStack,
 ...
 void Console::Method(const GlobalObject& aGlobal,
                                  MethodName aMethodName,
                                  const nsAString& aMethodString,
                                  const Sequence<JS::Value>& aData) {
  RefPtr<Console> console = GetConsole(aGlobal);
...
bool Console::IsShuttingDown() const {
 ...
 already_AddRefed<Console> Console::GetConsole(
