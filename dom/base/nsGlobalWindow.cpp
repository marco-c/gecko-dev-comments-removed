...
nsGlobalWindow::SetInnerWidth(int32_t aInnerWidth)
{
  ...
  ErrorResult rv;
  SetInnerWidthOuter(aInnerWidth, rv,  true);
...
nsGlobalWindow::SetInnerHeight(int32_t aInnerHeight)
{
  ...
  ErrorResult rv;
  SetInnerHeightOuter(aInnerHeight, rv,  true);
...
nsGlobalWindow::SetOuterWidth(int32_t aOuterWidth)
{
  ...
  ErrorResult rv;
  SetOuterWidthOuter(aOuterWidth, rv,  true);
...
nsGlobalWindow::SetOuterHeight(int32_t aOuterHeight)
{
  ...
  ErrorResult rv;
  SetOuterHeightOuter(aOuterHeight, rv,  true);
...
nsGlobalWindow::SetScreenX(int32_t aScreenX)
{
  ...
  ErrorResult rv;
  SetScreenXOuter(aScreenX, rv,  true);
...
nsGlobalWindow::SetScreenY(int32_t aScreenY)
{
  ...
  ErrorResult rv;
  SetScreenYOuter(aScreenY, rv,  true);
