...
void nsGlobalWindowInner::GetOwnPropertyNames(JSContext* aCx,
 ...
 bool nsGlobalWindowInner::IsPrivilegedChromeWindow(
 ...
 bool nsGlobalWindowInner::AllowChromeFrameAccess(JSContext* aCx,
                                                              JSObject* aObj) {
 ...
 bool nsGlobalWindowInner::DeviceSensorsEnabled(JSContext* aCx,
                                                            JSObject* aObj) {
...
int32_t nsGlobalWindowInner::SetInterval(
    ...
    const Sequence<JS::Value>& , ErrorResult& aError) {
