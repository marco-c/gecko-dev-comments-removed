...
bool nsGlobalWindowOuter::SetWidgetFullscreen(FullscreenReason aReason,
 ...
 void nsGlobalWindowOuter::FullscreenWillChange(
    bool aIsFullscreen) {
  if (aIsFullscreen) {
 ...
 void nsGlobalWindowOuter::FinishFullscreenChange(
    bool aIsFullscreen) {
...
nsresult nsGlobalWindowOuter::OpenDialog(const nsAString& aUrl,
 ...
 nsresult nsGlobalWindowOuter::OpenNoNavigate(
    const nsAString& aUrl, const nsAString& aName, const nsAString& aOptions,
    nsPIDOMWindowOuter** _retval) {
  return OpenInternal(aUrl, aName, aOptions,
                      false,             
