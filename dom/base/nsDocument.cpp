...
bool nsIDocument::IsWebAnimationsEnabled(JSContext* aCx, JSObject* ) {
  MOZ_ASSERT(NS_IsMainThread());
...
class nsCallExitFullscreen : public Runnable {
 ...
 void nsIDocument::AsyncExitFullscreen(nsIDocument* aDoc) {
  MOZ_RELEASE_ASSERT(NS_IsMainThread());
...
class ExitFullscreenScriptRunnable : public Runnable {
 ...
 void nsIDocument::ExitFullscreenInDocTree(
...
nsresult nsIDocument::RemoteFrameFullscreenReverted() {
 ...
 bool nsIDocument::IsUnprefixedFullscreenEnabled(
...
void nsIDocument::RequestFullscreen(UniquePtr<FullscreenRequest> aRequest) {
 ...
 bool nsIDocument::HandlePendingFullscreenRequests(
    nsIDocument* aDoc) {
  bool handled = false;
  PendingFullscreenChangeList::Iterator<FullscreenRequest> iter(
      aDoc, PendingFullscreenChangeList::eDocumentsWithSameRoot);
...
void nsIDocument::AddSizeOfExcludingThis(nsWindowSizes& aSizes,
 ...
 void nsIDocument::AddSizeOfNodeTree(nsINode& aNode,
