...
TextDirectiveUtil::RangeContentAsFoldCase(nsRange* aRange) {
 ...
 RangeBoundary TextDirectiveUtil::MoveRangeBoundaryOneWord(
 ...
 bool TextDirectiveUtil::IsAtWordBoundary(const nsAString& aText,
                                                      uint32_t aPosition) {
 ...
 RangeBoundary TextDirectiveUtil::GetBoundaryPointAtIndex(
...
TextDirectiveUtil::FindNextBlockBoundary(const RangeBoundary& aRangeBoundary,
 ...
 Result<Maybe<RangeBoundary>, ErrorResult>
TextDirectiveUtil::FindBlockBoundaryInRange(const nsRange& aRange,
 ...
 bool TextDirectiveUtil::NormalizedRangeBoundariesAreEqual(
