...
TEST_F(TestQuotaManager, OpenClientDirectory_InitializeOrigin) {
  ...
  ASSERT_NO_FATAL_FAILURE(
      PerformOnBackgroundThread(backgroundTest,  true));
  ASSERT_NO_FATAL_FAILURE(
  ...
  ASSERT_NO_FATAL_FAILURE(
      PerformOnBackgroundThread(backgroundTest,  false));
  ASSERT_NO_FATAL_FAILURE(
