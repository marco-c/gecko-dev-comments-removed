...
class ComputedTimingFunction {
 public:
  enum class Type : uint8_t {
    Ease = uint8_t(StyleTimingKeyword::Ease),            
    Linear = uint8_t(StyleTimingKeyword::Linear),        
    EaseIn = uint8_t(StyleTimingKeyword::EaseIn),        
    EaseOut = uint8_t(StyleTimingKeyword::EaseOut),      
    EaseInOut = uint8_t(StyleTimingKeyword::EaseInOut),  
    CubicBezier,                                         
    Step,  
  };
