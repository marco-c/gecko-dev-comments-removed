...
public:
  ...
  virtual void
  Send(JSContext* , const ArrayBuffer& aArrayBuffer,
       ErrorResult& aRv) override
  {
  ...
  virtual void
  Send(JSContext* , const ArrayBufferView& aArrayBufferView,
       ErrorResult& aRv) override
  {
  ...
  virtual void
  Send(JSContext* , Blob& aBlob, ErrorResult& aRv) override
  {
    BodyExtractor<nsIXHRSendable> body(&aBlob);
    aRv = SendInternal(&body);
  }

  virtual void Send(JSContext* , URLSearchParams& aURLSearchParams,
                    ErrorResult& aRv) override
  {
  ...
  virtual void
  Send(JSContext* , nsIDocument& aDoc, ErrorResult& aRv) override
  {
  ...
  virtual void
  Send(JSContext* , FormData& aFormData, ErrorResult& aRv) override
  {
