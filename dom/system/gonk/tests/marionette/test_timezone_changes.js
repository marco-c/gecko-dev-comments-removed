...
startTestBase(function() {
  return init()
    .then(() => testChangeNitzTimezone(36))  
    .then(() => testChangeOlsonTimezone('America/New_York',
      300, 1446357600000,   
      240, 1425798000000))  
    .then(() => testChangeNitzTimezone(-22)) 
    .then(() => testChangeNitzTimezone(51))  
    .then(() => testChangeOlsonTimezone('Australia/Adelaide',
      -570, 1428165000000,  
      -630, 1443889800000)) 
    .then(() => testChangeNitzTimezone(-38)) 
    .then(() => testChangeNitzTimezone(0))   
