...
es3fFboStateQueryTests.FboStateQueryTests.prototype.init = function() {
    var red =  (gl.getParameter(gl.RED_BITS));
    var green =  (gl.getParameter(gl.GREEN_BITS));
    var blue =  (gl.getParameter(gl.BLUE_BITS));
    var alpha =  (gl.getParameter(gl.ALPHA_BITS));
    es3fFboStateQueryTests.colorBits = [red, green, blue, alpha];
    es3fFboStateQueryTests.depthBits =  (gl.getParameter(gl.DEPTH_BITS));
    es3fFboStateQueryTests.stencilBits =  (gl.getParameter(gl.STENCIL_BITS));
