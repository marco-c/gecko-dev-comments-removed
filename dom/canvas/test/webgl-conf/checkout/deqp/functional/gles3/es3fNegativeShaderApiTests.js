...
goog.scope(function() {
    ...
    es3fNegativeShaderApiTests.init = function(gl) {
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('use_program', 'Invalid gl.useProgram() usage', gl,
            function() {
                ...
                bufferedLogToConsole('gl.INVALID_OPERATION is generated if transform feedback mode is active and not paused.');
                 var program1 = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(vertexShaderSource, fragmentShaderSource));
                 var program2 = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(vertexShaderSource, fragmentShaderSource));
                 var buf;
                 var tfID;
                 var tfVarying = ['gl_Position'];
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback(
            ...
            function() {
                 var programEmpty = gl.createProgram();
                 var shader = gl.createShader(gl.VERTEX_SHADER);
                 var program = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(vertexShaderSource, fragmentShaderSource));
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback(
            ...
            function() {
                 var program = gl.createProgram();
                var maxIndex =  (gl.getParameter(gl.MAX_VERTEX_ATTRIBS));
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('uniform_block_binding', 'Invalid gl.uniformBlockBinding() usage', gl,
            function() {
                 var program = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(uniformBlockVertSource, uniformTestFragSource));

                gl.useProgram(program.getProgram());

                 var maxUniformBufferBindings;
                 var numActiveUniforms = -1;
                 var numActiveBlocks = -1;
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('uniformf_incompatible_type', 'Invalid glUniform{1234}f() usage', gl,
            function() {
                 var program = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(uniformTestVertSource, uniformTestFragSource));

                gl.useProgram(program.getProgram());
                 var vec4_v = gl.getUniformLocation(program.getProgram(), 'vec4_v'); 
                 var ivec4_f = gl.getUniformLocation(program.getProgram(), 'ivec4_f'); 
                 var uvec4_f = gl.getUniformLocation(program.getProgram(), 'uvec4_f'); 
                 var sampler_f = gl.getUniformLocation(program.getProgram(), 'sampler_f'); 
                this.expectError(gl.NO_ERROR);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('uniformiv_incompatible_type', 'Invalid glUniform{1234}iv() usage', gl,
            function() {
                ...
                if (vec4_v == null || ivec4_f == null || uvec4_f == null || sampler_f == null)
                 ...
                 var data1 = new Int32Array(1);
                 var data2 = new Int32Array(2);
                 var data3 = new Int32Array(3);
                 var data4 = new Int32Array(4);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('uniformuiv_incompatible_type', 'Invalid glUniform{1234}uiv() usage', gl,
            function() {
                ...
                if (vec4_v == null || ivec4_f == null || uvec4_f == null || sampler_f == null)
                 ...
                 var data1 = new Uint32Array(1);
                 var data2 = new Uint32Array(2);
                 var data3 = new Uint32Array(3);
                 var data4 = new Uint32Array(4);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('uniform_matrixfv_incompatible_type', 'Invalid glUniformMatrix{234}fv() usage', gl,
            function() {
                ...
                gl.useProgram(program.getProgram());
                 var mat4_v = gl.getUniformLocation(program.getProgram(), 'mat4_v'); 
                 var sampler_f = gl.getUniformLocation(program.getProgram(), 'sampler_f'); 
                this.expectError(gl.NO_ERROR);
                ...
                if (mat4_v == null || sampler_f == null)
                 ...
                 var data4 = new Float32Array(4);
                 var data9 = new Float32Array(9);
                 var data16 = new Float32Array(16);
                 var data6 = new Float32Array(6);
                 var data8 = new Float32Array(8);
                 var data12 = new Float32Array(12);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('get_transform_feedback_varying', 'Invalid glGetTransformFeedbackVarying() usage', gl,
            function() {
                 var tfID;
                 var program = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(vertexShaderSource, fragmentShaderSource));
                 var programInvalid = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(vertexShaderSource, ''));
                 var tfVarying = ['gl_Position'];
                 var maxTransformFeedbackVaryings = 0;
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('transform_feedback_varyings', 'Invalid gl.transformFeedbackVaryings() usage', gl,
            function() {
                 ...
                 var program = new gluShaderProgram.ShaderProgram(gl, gluShaderProgram.makeVtxFragSources(vertexShaderSource, fragmentShaderSource));
                 var tfVarying = ['gl_Position'];
                 var maxTransformFeedbackSeparateAttribs = 0;
