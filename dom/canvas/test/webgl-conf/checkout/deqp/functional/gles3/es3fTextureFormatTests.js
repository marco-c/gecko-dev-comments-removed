...
es3fTextureFormatTests.Texture2DFormatCase.prototype.init = function() {
     var fmt = this.m_dataType ? gluTextureUtil.mapGLTransferFormat(this.m_format, this.m_dataType) : gluTextureUtil.mapGLInternalFormat(this.m_format);
     var spec = tcuTextureUtil.getTextureFormatInfo(fmt);
    ...
    this.m_texture = this.m_dataType ?
              gluTexture.texture2DFromFormat(gl, this.m_format, this.m_dataType, this.m_width, this.m_height) : 
              gluTexture.texture2DFromInternalFormat(gl, this.m_format, this.m_width, this.m_height); 
...
es3fTextureFormatTests.Texture2DFormatCase.prototype.iterate = function() {
    ...
    var viewport = new glsTextureTestUtil.RandomViewport(document.getElementById('canvas'), this.m_width, this.m_height);

     var renderedFrame = new tcuSurface.Surface(viewport.width, viewport.height);
     var referenceFrame = new tcuSurface.Surface(viewport.width, viewport.height);
    ...
    var renderParams = new glsTextureTestUtil.ReferenceParams(glsTextureTestUtil.textureType.TEXTURETYPE_2D);
     ...
     var spec = tcuTextureUtil.getTextureFormatInfo(this.m_texture.getRefTexture().getFormat());
     var wrapS = gl.CLAMP_TO_EDGE;
    ...
    glsTextureTestUtil.sampleTexture2D(new glsTextureTestUtil.SurfaceAccess(referenceFrame, undefined ),
...
es3fTextureFormatTests.TextureCubeFormatCase.prototype.init = function() {
    ...
    this.m_texture = this.m_dataType ?
              gluTexture.cubeFromFormat(gl, this.m_format, this.m_dataType, this.m_width) : 
              gluTexture.cubeFromInternalFormat(gl, this.m_format, this.m_width); 
...
es3fTextureFormatTests.TextureCubeFormatCase.prototype.testFace = function(face) {
    ...
    glsTextureTestUtil.sampleTextureCube(new glsTextureTestUtil.SurfaceAccess(referenceFrame, undefined ),
        this.m_texture.getRefTexture(), texCoord, renderParams);
...
es3fTextureFormatTests.Texture2DArrayFormatCase.prototype.init = function() {
    ...
    this.m_texture = this.m_dataType ?
              gluTexture.texture2DArrayFromFormat(gl, this.m_format, this.m_dataType, this.m_width, this.m_height, this.m_numLayers) : 
              gluTexture.texture2DArrayFromInternalFormat(gl, this.m_format, this.m_width, this.m_height, this.m_numLayers); 
...
es3fTextureFormatTests.Texture2DArrayFormatCase.prototype.testLayer = function(layerNdx) {
    ...
    glsTextureTestUtil.sampleTexture2DArray(new glsTextureTestUtil.SurfaceAccess(referenceFrame, undefined ),
...
es3fTextureFormatTests.Texture3DFormatCase.prototype.init = function() {
    ...
    this.m_texture = this.m_dataType ?
              gluTexture.texture3DFromFormat(gl, this.m_format, this.m_dataType, this.m_width, this.m_height, this.m_depth) : 
              gluTexture.texture3DFromInternalFormat(gl, this.m_format, this.m_width, this.m_height, this.m_depth); 
...
es3fTextureFormatTests.Texture3DFormatCase.prototype.testSlice = function(sliceNdx) {
    ...
    glsTextureTestUtil.sampleTexture3D(new glsTextureTestUtil.SurfaceAccess(referenceFrame, undefined ),
        this.m_texture.getRefTexture(), texCoord, renderParams);
