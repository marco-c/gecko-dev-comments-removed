...
goog.scope(function() {
    ...
    es3fTextureSpecificationTests.TextureSpecificationTests.prototype.init = function() {
        ...
        for (var formatNdx = 0; formatNdx < colorFormats.length; formatNdx++) {
            fmtName = colorFormats[formatNdx].name;
            format = colorFormats[formatNdx].internalFormat;
             var tex2DArrayWidth = 57;
             var tex2DArrayHeight = 44;
             var tex2DArrayLevels = 5;
             var tex3DWidth = 63;
             var tex3DHeight = 29;
             var tex3DDepth = 11;
        ...
        for (var formatNdx = 0; formatNdx < colorFormats.length; formatNdx++) {
            fmtName = colorFormats[formatNdx].name;
             var internalFormat = colorFormats[formatNdx].internalFormat;
            var tex2DWidth = 117;
            var tex2DHeight = 97;
        ...
        for (var ndx = 0; ndx < tex2DSizes.length; ndx++) {
            format = gl.RGBA8;
             var width = tex2DSizes[ndx].width;
             var height = tex2DSizes[ndx].height;
             var levels = tex2DSizes[ndx].levels;
        ...
        for (var ndx = 0; ndx < tex2DArraySizes.length; ndx++) {
            ...
            height = tex2DArraySizes[ndx].height;
             var layers = tex2DArraySizes[ndx].layers;
