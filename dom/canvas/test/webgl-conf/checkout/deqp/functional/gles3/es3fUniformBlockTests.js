...
goog.scope(function() {
    ...
    es3fUniformBlockTests.BlockBasicTypeCase = function(name, description, type, layoutFlags, numInstances) {
        glsUniformBlockCase.UniformBlockCase.call(this, name, description, glsUniformBlockCase.BufferMode.BUFFERMODE_PER_BLOCK);
         var block = this.m_interface.allocBlock('Block');
    ...
    es3fUniformBlockTests.BlockSingleStructCase.prototype.init = function() {
         var typeS = this.m_interface.allocStruct('S');
        typeS.addMember('a', glsUniformBlockCase.newVarTypeBasic(gluShaderUtil.DataType.INT_VEC3, glsUniformBlockCase.UniformFlags.PRECISION_HIGH), glsUniformBlockCase.UniformFlags.UNUSED_BOTH); 
    ...
    es3fUniformBlockTests.BlockSingleNestedStructCase.prototype.init = function() {
        ...
        typeS.addMember('c', glsUniformBlockCase.newVarTypeBasic(gluShaderUtil.DataType.FLOAT_VEC4, glsUniformBlockCase.UniformFlags.PRECISION_HIGH), glsUniformBlockCase.UniformFlags.UNUSED_BOTH);
         ...
         var typeT = this.m_interface.allocStruct('T');
    ...
    es3fUniformBlockTests.BlockMultiBasicTypesCase.prototype.init = function() {
         var blockA = this.m_interface.allocBlock('BlockA');
        ...
        blockA.setFlags(this.m_flagsA);
         ...
         var blockB = this.m_interface.allocBlock('BlockB');
    ...
    es3fUniformBlockTests.init = function() {
        ...
        bufferedLogToConsole('ubo.multi_nested_struct: Tests created');
          ...
          var allShaders = glsRandomUniformBlockCase.FeatureBits.FEATURE_VERTEX_BLOCKS | glsRandomUniformBlockCase.FeatureBits.FEATURE_FRAGMENT_BLOCKS | glsRandomUniformBlockCase.FeatureBits.FEATURE_SHARED_BLOCKS;
          var allLayouts = glsRandomUniformBlockCase.FeatureBits.FEATURE_STD140_LAYOUT;
          var allBasicTypes = glsRandomUniformBlockCase.FeatureBits.FEATURE_VECTORS | glsRandomUniformBlockCase.FeatureBits.FEATURE_MATRICES;
          var unused = glsRandomUniformBlockCase.FeatureBits.FEATURE_UNUSED_MEMBERS | glsRandomUniformBlockCase.FeatureBits.FEATURE_UNUSED_UNIFORMS;
          var matFlags = glsRandomUniformBlockCase.FeatureBits.FEATURE_MATRIX_LAYOUT;
          var allFeatures = (~glsRandomUniformBlockCase.FeatureBits.FEATURE_ARRAYS_OF_ARRAYS & 0xFFFF);
