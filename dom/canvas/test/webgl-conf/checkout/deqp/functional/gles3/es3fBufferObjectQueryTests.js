...
es3fBufferObjectQueryTests.BufferSizeCase.prototype.testBuffer = function() {
    ...
    var size =  (gl.getBufferParameter(this.m_bufferTarget, gl.BUFFER_SIZE));
    ...
    for (var i = 0; i < numIterations; ++i) {
        ...
        size =  (gl.getBufferParameter(this.m_bufferTarget, gl.BUFFER_SIZE));
...
es3fBufferObjectQueryTests.BufferUsageCase.prototype.testBuffer = function() {
    var usage =  (gl.getBufferParameter(this.m_bufferTarget, gl.BUFFER_USAGE));
    ...
    for (var ndx = 0; ndx < usages.length; ++ndx) {
        ...
        usage =  (gl.getBufferParameter(this.m_bufferTarget, gl.BUFFER_USAGE));
