...
goog.scope(function() {
    ...
    es3fNegativeTextureApiTests.init = function(gl) {
        ...
        function() {
            ...
            var numMaxTextureUnits = (gl.getParameter(gl.MAX_COMBINED_TEXTURE_IMAGE_UNITS));
        ...
        function() {
            ...
            bufferedLogToConsole('gl.INVALID_VALUE is generated if level is greater than log_2(gl.MAX_TEXTURE_SIZE) for a 2d texture target.');
             var uint8 = new Uint8Array(es3fNegativeTextureApiTests.etc2EacDataSize(16, 16));

             var log2MaxTextureSize = Math.floor(Math.log2((gl.getParameter(gl.MAX_TEXTURE_SIZE)))) + 1;
            ...
            bufferedLogToConsole('gl.INVALID_VALUE is generated if level is greater than log_2(gl.MAX_CUBE_MAP_TEXTURE_SIZE) for a cubemap target.');
             var log2MaxCubemapSize = Math.floor(Math.log2((gl.getParameter(gl.MAX_CUBE_MAP_TEXTURE_SIZE)))) + 1;
        ...
        function() {
            ...
            var maxTextureSize =  (gl.getParameter(gl.MAX_TEXTURE_SIZE)) + 1;
            var maxCubemapSize =  (gl.getParameter(gl.MAX_CUBE_MAP_TEXTURE_SIZE)) + 1;
        ...
        function() {
            ...
            bufferedLogToConsole('gl.INVALID_VALUE is generated if level is greater than log_2(gl.MAX_3D_TEXTURE_SIZE).');
             var log2Max3DTextureSize = Math.floor(Math.log2( (gl.getParameter(gl.MAX_3D_TEXTURE_SIZE)))) + 1;
        ...
        function() {
            ...
            var max3DTextureSize =  (gl.getParameter(gl.MAX_3D_TEXTURE_SIZE)) + 1;
            var maxTextureSize =  (gl.getParameter(gl.MAX_TEXTURE_SIZE)) + 1;
        ...
        function() {
            ...
            bufferedLogToConsole('gl.INVALID_OPERATION is generated if the texture object currently bound to target already has gl.TEXTURE_IMMUTABLE_FORMAT set to true.');
             var immutable;
            immutable = (gl.getTexParameter(gl.TEXTURE_2D, gl.TEXTURE_IMMUTABLE_FORMAT));
        ...
        function() {
            ...
            bufferedLogToConsole('gl.INVALID_OPERATION is generated if levels is greater than floor(log_2(max(width, height))) + 1');
             var log2MaxSize = Math.floor(Math.log2(Math.max(16, 4))) + 1 + 1;
        ...
        function() {
            ...
            bufferedLogToConsole('gl.INVALID_OPERATION is generated if the texture object currently bound to target already has gl.TEXTURE_IMMUTABLE_FORMAT set to true.');
             var immutable;
            immutable = (gl.getTexParameter(gl.TEXTURE_3D, gl.TEXTURE_IMMUTABLE_FORMAT));
            bufferedLogToConsole('// gl.TEXTURE_IMMUTABLE_FORMAT = ' + ((immutable != 0) ? 'true' : 'false'));
            gl.texStorage3D (gl.TEXTURE_3D, 1, gl.RGBA8, 4, 4, 4);
            this.expectError (gl.NO_ERROR);
            immutable = (gl.getTexParameter(gl.TEXTURE_3D, gl.TEXTURE_IMMUTABLE_FORMAT));
        ...
        function() {
            ...
            bufferedLogToConsole('gl.INVALID_OPERATION is generated if levels is greater than floor(log_2(max(width, height, depth))) + 1');
             var log2MaxSize = Math.floor(Math.log2(8)) + 1 + 1;
