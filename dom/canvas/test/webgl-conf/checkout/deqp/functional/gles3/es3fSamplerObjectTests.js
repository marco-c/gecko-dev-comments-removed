...
var glsSamplerObjectTest = modules.shared.glsSamplerObjectTest;
    ...
    es3fSamplerObjectTests.init = function() {
        var testGroup = tcuTestCase.runner.testCases;
         ...
         var simpleTexture2D = tcuTestCase.newTest('single_tex_2d', 'Simple 2D texture with sampler');
        ...
        testGroup.addChild(simpleTexture2D);
         ...
         var multiTexture2D = tcuTestCase.newTest('multi_tex_2d', 'Multiple texture units 2D texture with sampler');
        ...
        new glsSamplerObjectTest.TestSpec('diff_wrap_t', 'Different gl.TEXTURE_WRAP_T', gl.TEXTURE_3D,
         ...
         var simpleTexture3D = tcuTestCase.newTest('single_tex_3d', 'Simple 3D texture with sampler');
        ...
        testGroup.addChild(simpleTexture3D);
         ...
         var multiTexture3D = tcuTestCase.newTest('multi_tex_3d', 'Multiple texture units 3D texture with sampler');
        ...
        testGroup.addChild(multiTexture3D);
         ...
         var simpleTextureCube = tcuTestCase.newTest('single_cubemap', 'Simple cubemap texture with sampler');
        ...
        testGroup.addChild(simpleTextureCube);
         ...
         var multiTextureCube = tcuTestCase.newTest('multi_cubemap', 'Multiple texture units cubemap textures with sampler');
