...
var tcuImageCompare = framework.common.tcuImageCompare;
    ...
    es3fFragmentOutputTests.init = function(gl) {
        ...
        if (gl.getExtension('EXT_color_buffer_float')) {
             var floatGroup = tcuTestCase.newTest('basic.float', 'Floating-point output tests');
         ...
         var fixedGroup = tcuTestCase.newTest('basic.fixed', 'Fixed-point output tests');
        ...
        for (var fmtNdx = 0; fmtNdx < requiredFixedFormats.length; fmtNdx++) {
         ...
         var intGroup = tcuTestCase.newTest('basic.int', 'Integer output tests');
        ...
        for (var fmtNdx = 0; fmtNdx < requiredIntFormats.length; fmtNdx++) {
         ...
         var uintGroup = tcuTestCase.newTest('basic.uint', 'Usigned integer output tests');
        ...
        if (gl.getExtension('EXT_color_buffer_float')) {
             var arrayFloatGroup = tcuTestCase.newTest('array.float', 'Floating-point output tests');
         ...
         var arrayFixedGroup = tcuTestCase.newTest('array.fixed', 'Fixed-point output tests');
        ...
        for (var fmtNdx = 0; fmtNdx < requiredFixedFormats.length; fmtNdx++) {
         ...
         var arrayIntGroup = tcuTestCase.newTest('array.int', 'Integer output tests');
        ...
        for (var fmtNdx = 0; fmtNdx < requiredIntFormats.length; fmtNdx++) {
         ...
         var arrayUintGroup = tcuTestCase.newTest('array.uint', 'Usigned integer output tests');
