...
goog.scope(function() {
    ...
    es3fBufferCopyTests.BasicBufferCopyCase.prototype.iterate = function() {
         var verifier = new glsBufferTestUtil.BufferVerifier(this.m_verifyType);
    ...
    es3fBufferCopyTests.SingleBufferCopyCase.prototype.constructor = es3fBufferCopyTests.SingleBufferCopyCase;
     ...
     es3fBufferCopyTests.SingleBufferCopyCase.prototype.iterate = function() {
        ...
        var copyRanges = [{
                srcOffset: 57, dstOffset: 701, copySize: 101 
            },{
                srcOffset: 640, dstOffset: 101, copySize: 101 
            },{
                srcOffset: 0, dstOffset: 500, copySize: 500 
            },{
                srcOffset: 500, dstOffset: 0, copySize: 500 
        }];
