...
goog.scope(function() {
    ...
    var tcuTestCase = framework.common.tcuTestCase;
     ...
     var s_constInFloat = [0.5, -0.2];
     var s_constInVec2 = [[1.2, 0.5], [0.5, 1.0]];
     var s_constInVec3 = [[1.1, 0.1, 0.5], [-0.2, 0.5, 0.8]];
     var s_constInVec4 = [[1.4, 0.2, -0.5, 0.7], [0.2, -1.0, 0.5, 0.8]];
    ...
    es3fShaderMatrixTest.matrixCompMult = function (a, b) {
         var retVal = new tcuMatrix.Matrix(a.rows, a.cols);
    ...
    es3fShaderMatrixTest.transpose = function (mat) {
         var retVal = new tcuMatrix.Matrix(mat.cols, mat.rows);
    ...
    es3fShaderMatrixTest.inverseMat2 = function (mat) {
         var det = es3fShaderMatrixTest.determinant(mat);
         var retVal = new tcuMatrix.Mat2();
    ...
    es3fShaderMatrixTest.inverseMat3 = function (mat) {
        if (es3fShaderMatrixTest.determinant(mat) == 0.0) {
    	 ...
    	 var areaA = [mat.get(0, 0), mat.get(0, 1), mat.get(1, 0), mat.get(1,1)];
         var areaB = [mat.get(0, 2), mat.get(1, 2)];
         var areaC = [mat.get(2, 0), mat.get(2, 1)];
         var areaD = [mat.get(2,2)];

    	 var	invA = es3fShaderMatrixTest.inverse(tcuMatrix.matrixFromDataArray(2, 2, areaA));
    	 var	matB = tcuMatrix.matrixFromDataArray(2, 1, areaB);
    	 var	matC = tcuMatrix.matrixFromDataArray(1, 2, areaC);
    	 var	matD = tcuMatrix.matrixFromDataArray(1, 1, areaD);

         var tmp = tcuMatrix.subtract(matD, tcuMatrix.multiply(matC, tcuMatrix.multiply(invA, matB)));
    	 var schurComplement = 1.0 / tmp.get(0, 0);
    	 var	zeroMat = new tcuMatrix.Matrix(2, 2, 0);

    	 var	blockA = tcuMatrix.add(invA, tcuMatrix.multiply(tcuMatrix.multiply(invA, tcuMatrix.multiply(tcuMatrix.multiplyMatScal(matB, schurComplement), matC)), invA));
    	 var	blockB = tcuMatrix.multiplyMatScal(tcuMatrix.multiply(tcuMatrix.subtract(zeroMat, invA), matB), schurComplement);
    	 var	blockC = tcuMatrix.multiply(matC, tcuMatrix.multiplyMatScal(invA, - schurComplement));
    	 var blockD = schurComplement;
    ...
    es3fShaderMatrixTest.inverseMat4 = function (mat) {
        ...
        if (es3fShaderMatrixTest.determinant(mat) == 0.0) {
    	 ...
    	 var	invA = es3fShaderMatrixTest.inverse(tcuMatrix.matrixFromDataArray(2, 2, areaA));
    	 var	matB = tcuMatrix.matrixFromDataArray(2, 2, areaB);
    	 var	matC = tcuMatrix.matrixFromDataArray(2, 2, areaC);
    	 var	matD = tcuMatrix.matrixFromDataArray(2, 2, areaD);

    	 var	schurComplement = es3fShaderMatrixTest.inverse(tcuMatrix.subtract(matD, (tcuMatrix.multiply(matC, tcuMatrix.multiply(invA, matB)))));
    	 var	zeroMat = new tcuMatrix.Matrix(2, 2, 0);

    	 var	blockA = tcuMatrix.add(invA, tcuMatrix.multiply(tcuMatrix.multiply(tcuMatrix.multiply(tcuMatrix.multiply(invA, matB), schurComplement), matC), invA));
    	 var	blockB = tcuMatrix.multiply(tcuMatrix.multiply(tcuMatrix.subtract(zeroMat, invA), matB), schurComplement);
    	 var	blockC = tcuMatrix.multiply(tcuMatrix.multiply(tcuMatrix.subtract(zeroMat, schurComplement),matC), invA);
    	 var	blockD = schurComplement;
    ...
    es3fShaderMatrixTest.negate = function (mat) {
         var retVal = new tcuMatrix.Matrix(mat.rows, mat.cols);
    ...
    es3fShaderMatrixTest.outerProduct = function (a, b) {
         var retVal = new tcuMatrix.Matrix(b.length, a.length);
        ...
        switch(op){
        	...
        	case es3fShaderMatrixTest.MatrixOp.OP_COMP_MUL:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.matrixCompMult((in0_), (in1_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_OUTER_PRODUCT:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.outerProduct((in0_), (in1_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_TRANSPOSE:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.transpose((in0_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_INVERSE:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.inverse((in0_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_DETERMINANT:
                return function (evalCtx) {
                    ...
                    var det = es3fShaderMatrixTest.determinant((in0_));
        	...
        	case es3fShaderMatrixTest.MatrixOp.OP_UNARY_PLUS:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3((in0_)));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_NEGATION:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.negate((in0_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_PRE_INCREMENT:
                return function (evalCtx) {
                    ...
                    var val0 = es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.increment((in0_)));
                    var val1 = es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.increment((in0_)));
        	...
        	case es3fShaderMatrixTest.MatrixOp.OP_PRE_DECREMENT:
                return function (evalCtx) {
                    ...
                    var val0 = es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.decrement((in0_)));
                    var val1 = es3fShaderMatrixTest.reduceToVec3(es3fShaderMatrixTest.decrement((in0_)));
                    setColor(evalCtx, deMath.add(val0, val1));
                };
        	...
        	case es3fShaderMatrixTest.MatrixOp.OP_ADD_INTO:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(tcuMatrix.add((in0_), (in1_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_SUBTRACT_FROM:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(tcuMatrix.subtract((in0_), (in1_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_MULTIPLY_INTO:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(tcuMatrix.multiply((in0_), (in1_))));
                };
        	case es3fShaderMatrixTest.MatrixOp.OP_DIVIDE_INTO:
                return function (evalCtx) {
                    ...
                    setColor(evalCtx, es3fShaderMatrixTest.reduceToVec3(tcuMatrix.divide((in0_), (in1_))));
                };
        }
	};
    ...
    es3fShaderMatrixTest.ShaderMatrixCase.prototype.init = function () {
    	...
    	var op = this.m_isVertexCase ? vtx : frag;
         ...
         var isInDynMat0 = gluShaderUtil.isDataTypeMatrix(this.m_in0.dataType) && this.m_in0.inputType == es3fShaderMatrixTest.InputType.INPUTTYPE_DYNAMIC;
    	 var isInDynMat1 = gluShaderUtil.isDataTypeMatrix(this.m_in1.dataType) && this.m_in1.inputType == es3fShaderMatrixTest.InputType.INPUTTYPE_DYNAMIC;
    	 var inValues = [];
    	 var resultType;
    	 var resultPrec = this.m_in0.precision;
    	 var passVars = [];
    	 var numInputs = (es3fShaderMatrixTest.isOperationBinary(this.m_op)) ? (2) : (1);
        ...
        if (this.m_op == es3fShaderMatrixTest.MatrixOp.OP_MUL && gluShaderUtil.isDataTypeMatrix(this.m_in0.dataType) && gluShaderUtil.isDataTypeMatrix(this.m_in1.dataType)) {
    		...
    		resultType = this.m_in0.dataType;
    		 ...
    		 var matNdx = gluShaderUtil.isDataTypeMatrix(this.m_in0.dataType) ? 0 : 1;
    		 var matrixType = matNdx == 0 ? this.m_in0.dataType : this.m_in1.dataType;
    		 var otherType = matNdx == 0 ? this.m_in1.dataType : this.m_in0.dataType;
    	...
    	for (var inNdx = 0; inNdx < numInputs; inNdx++) {
    		 var ind = inNdx > 0 ? this.m_in1 : this.m_in0;
    		 var precName = gluShaderUtil.getPrecisionName(ind.precision);
    		 var typeName = gluShaderUtil.getDataTypeName(ind.dataType);
    		 var inValueNdx = inNdx > 0 ? 1 : 0;
    	...
    	for (var attribNdx = 0; attribNdx < 4; attribNdx++) {
    		...
    		this.m_userAttribTransforms[attribNdx].set(0, 3, 0.2);
