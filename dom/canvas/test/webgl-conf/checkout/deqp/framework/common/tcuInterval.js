 ...
 goog.scope(function() {
    ...
    tcuInterval.withIntervals = function(a, b) {
         var interval = new tcuInterval.Interval();
    ...
    tcuInterval.Interval.prototype.operatorOrBinary = function(other) {
         var temp = new tcuInterval.Interval();
    ...
    tcuInterval.Interval.prototype.operatorOrAssignBinary = function(other) {
         var temp = this.operatorOrBinary(other);
    ...
    tcuInterval.Interval.prototype.operatorAndAssignBinary = function(other) {
         var temp = this.operatorAndBinary(other);
        this.m_hasNaN = temp.m_hasNaN;
        this.m_lo = temp.m_lo;
        this.m_hi = temp.m_hi;
    };
    ...
    tcuInterval.Interval.prototype.abs = function(x) {
         ...
         var mono = tcuInterval.applyMonotone1p(Math.abs, x);
...
tcuInterval.applyMonotone3 = function(arg0, arg1, arg2, body) {
 ...
 tcuInterval.POSITIVE_INFINITY = new tcuInterval.Interval(Infinity);
 tcuInterval.NEGATIVE_INFINITY = new tcuInterval.Interval(-Infinity);
 tcuInterval.ZERO = new tcuInterval.Interval(0);
 tcuInterval.NAN = new tcuInterval.Interval(NaN);
});
