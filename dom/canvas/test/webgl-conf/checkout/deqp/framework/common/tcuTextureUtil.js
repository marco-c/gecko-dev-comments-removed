...
tcuTextureUtil.getTextureFormatBitDepth = function(format) {
     ...
     var chnBits = tcuTextureUtil.getChannelBitDepth(format.type); 
     var chnMask = [false, false, false, false]; 
     var chnSwz = [0, 1, 2, 3]; 
...
tcuTextureUtil.getTextureFormatMantissaBitDepth = function(format) {
     var chnBits = tcuTextureUtil.getChannelMantissaBitDepth(format.type);
     var chnMask = [false, false, false, false];
     var chnSwz = [0, 1, 2, 3];
