...
goog.scope(function() {
    ...
    var DE_ASSERT = function(x) {
     ...
     tcuBilinearImageCompare.NUM_SUBPIXEL_BITS = 8;
    ...
    tcuBilinearImageCompare.interpolateChannel = function(fx1, fy1, p00, p01, p10, p11) {
         var fx0 = (1 << tcuBilinearImageCompare.NUM_SUBPIXEL_BITS) - fx1;
         var fy0 = (1 << tcuBilinearImageCompare.NUM_SUBPIXEL_BITS) - fy1;
    ...
    tcuBilinearImageCompare.bilinearSampleUintRGBA8 = function(view, u, v) {
         var x0 = u >> tcuBilinearImageCompare.NUM_SUBPIXEL_BITS;
         var y0 = v >> tcuBilinearImageCompare.NUM_SUBPIXEL_BITS;
         var x1 = x0 + 1;
         var y1 = y0 + 1;
        ...
        DE_ASSERT(y1 < view.getHeight());
         ...
         var fx1 = u - (x0 << tcuBilinearImageCompare.NUM_SUBPIXEL_BITS);
         var fy1 = v - (y0 << tcuBilinearImageCompare.NUM_SUBPIXEL_BITS);

         var channelsP00 = view.readUintRGBA8(x0, y0);
         var channelsP10 = view.readUintRGBA8(x1, y0);
         var channelsP01 = view.readUintRGBA8(x0, y1);
         var channelsP11 = view.readUintRGBA8(x1, y1);
    ...
    tcuBilinearImageCompare.comparePixelRGBA8 = function(reference, result, threshold, x, y) {
         var resPix = result.readUintRGBA8(x, y);
    ...
    tcuBilinearImageCompare.bilinearCompare = function(reference, result, errorMask, threshold) {
        ...
        assertMsgOptions(errorMask.getWidth() == reference.getWidth() && errorMask.getHeight() == reference.getHeight() && errorMask.getDepth() == reference.getDepth(),
         ...
         var isEqual = reference.getFormat().isEqual(
            new tcuTexture.TextureFormat(
                tcuTexture.ChannelOrder.RGBA,
                tcuTexture.ChannelType.UNORM_INT8));
        if (isEqual) {
             var refView = new tcuTexture.RGBA8View(reference);
             var resView = new tcuTexture.RGBA8View(result);
