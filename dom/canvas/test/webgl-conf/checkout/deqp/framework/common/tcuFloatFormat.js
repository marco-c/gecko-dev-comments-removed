 ...
 goog.scope(function() {
    ...
    tcuFloatFormat.computeMaxValue = function(maxExp, fractionBits) {
     ...
     tcuFloatFormat.FloatFormat = function(minExp, maxExp, fractionBits, exactPrecision, hasSubnormal, hasInf, hasNaN) {
          ...
          this.m_hasSubnormal = hasSubnormal === undefined ? tcuFloatFormat.YesNoMaybe.MAYBE : hasSubnormal; 
          this.m_hasInf = hasInf === undefined ? tcuFloatFormat.YesNoMaybe.MAYBE : hasInf; 
          this.m_hasNaN = hasNaN === undefined ? tcuFloatFormat.YesNoMaybe.MAYBE : hasNaN; 
          this.m_exactPrecision = exactPrecision; 
          this.m_maxValue = tcuFloatFormat.computeMaxValue(maxExp, fractionBits);
     };
     ...
     tcuFloatFormat.FloatFormat.prototype.ulp = function(x, count) {
        var breakdown = deMath.deFractExp(Math.abs(x));
          ...
          var frac = breakdown.significand;
         ...
         exp = Math.max(exp, this.m_minExp);
          ...
          var oneULP = deMath.deLdExp(1.0, exp - this.m_fractionBits);
    ...
    tcuFloatFormat.nativeDouble = function() {
        return new tcuFloatFormat.FloatFormat(-1021 - 1, 
                                              1024 - 1, 
                                              53 - 1, 
                                              true, 
