...
deMath.toFloat32 = (function() {
 ...
 deMath.INV_LOG_2_FLOAT32 = deMath.toFloat32(1.44269504089); 
...
deMath.deAlign32 = function(val, align) {
    ...
    return ((val + align - 1) & ~(align - 1)) & 0xFFFFFFFF; 
};
...
deMath.dePop32 = function(a) {
     var mask0 = 0x55555555; 
     var mask1 = 0x33333333; 
     var mask2 = 0x0f0f0f0f; 
     var mask3 = 0x00ff00ff; 
     var mask4 = 0x0000ffff; 
     var t = a & 0xFFFFFFFF; 
    t = (t & mask0) + ((t >> 1) & mask0);
    t = (t & mask1) + ((t >> 2) & mask1);
    t = (t & mask2) + ((t >> 4) & mask2);
