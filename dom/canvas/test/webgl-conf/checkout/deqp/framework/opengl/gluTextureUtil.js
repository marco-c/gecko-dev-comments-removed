...
gluTextureUtil.getTransferFormat = function( texFormat) {
    var format = gl.NONE;
    var type = gl.NONE;
     var isInt = false;
...
gluTextureUtil.getGLFormat = function( format) {
    switch (format) {
...
gluTextureUtil.mapGLChannelType = function( dataType,  normalized) {
...
gluTextureUtil.mapGLInternalFormat = function( internalFormat) {
