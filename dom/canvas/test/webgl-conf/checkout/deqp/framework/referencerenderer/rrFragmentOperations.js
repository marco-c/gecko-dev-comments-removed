...
rrFragmentOperations.Fragment = function(coefficents, coords, depth) {
     ...
     this.pixelCoord = coords;
     this.isAlive = true;
     this.stencilPassed = true;
     this.depthPassed = true;
     this.sampleDepths = [depth];
     this.clampedBlendSrcColor = [];
     this.clampedBlendSrc1Color = [];
     this.clampedBlendDstColor = [];
     this.blendSrcFactorRGB = [];
     this.blendSrcFactorA = NaN;
     this.blendDstFactorRGB = [];
     this.blendDstFactorA = NaN;
     this.blendedRGB = [];
     this.blendedA = NaN;
     this.signedValue = []; 
     this.unsignedValue = []; 
