...
var rrGenericVector = framework.referencerenderer.rrGenericVector;
    ...
    rrVertexAttrib.VertexAttribType = {
        ...
        NONPURE_UINT_2_10_10_10_REV: 22, 
        NONPURE_INT_2_10_10_10_REV: 23, 
    ...
    rrVertexAttrib.VertexAttrib = function() {
         this.type = rrVertexAttrib.VertexAttribType.FLOAT;
         this.size = 0;
         this.stride = 0;
    ...
    rrVertexAttrib.getComponentSize = function(type) {
        switch (type) {
            ...
            case rrVertexAttrib.VertexAttribType.DOUBLE: return 8; 
            ...
            case rrVertexAttrib.VertexAttribType.NONPURE_UNORM_2_10_10_10_REV: return 1; 
            ...
            case rrVertexAttrib.VertexAttribType.NONPURE_SNORM_2_10_10_10_REV_CLAMP: return 1; 
            ...
            case rrVertexAttrib.VertexAttribType.NONPURE_SNORM_2_10_10_10_REV_SCALE: return 1; 
            ...
            case rrVertexAttrib.VertexAttribType.NONPURE_UINT_2_10_10_10_REV: return 1; 
            case rrVertexAttrib.VertexAttribType.NONPURE_INT_2_10_10_10_REV: return 1; 
            ...
            case rrVertexAttrib.VertexAttribType.NONPURE_UNORM_2_10_10_10_REV_BGRA: return 1; 
            case rrVertexAttrib.VertexAttribType.NONPURE_SNORM_2_10_10_10_REV_CLAMP_BGRA: return 1; 
            case rrVertexAttrib.VertexAttribType.NONPURE_SNORM_2_10_10_10_REV_SCALE_BGRA: return 1; 
            default:
    ...
    rrVertexAttrib.readVertexAttrib = function(vertexAttrib, instanceNdx, vertexNdx, genericType) {
        ...
        if (vertexAttrib.pointer) {
             var elementNdx = (vertexAttrib.instanceDivisor != 0) ? (instanceNdx / vertexAttrib.instanceDivisor) : vertexNdx;
             var compSize = rrVertexAttrib.getComponentSize(vertexAttrib.type);
             var stride = (vertexAttrib.stride != 0) ? (vertexAttrib.stride) : (vertexAttrib.size * compSize);
             var byteOffset = vertexAttrib.offset + (elementNdx * stride);
            ...
            dst = new arrayType( vertexAttrib.generic.data);
        }
    ...
    rrVertexAttrib.readHalf = function(dst, size, ptr) {
        ...
        var ptrclone = new Uint8Array(ptr.subarray(0, size * arraysize16)); 
...
integer_,
    ...
    rrVertexAttrib.readUint2101010Rev = function(dst, size, ptr) {
        ...
        var ptrclone = new Uint8Array(ptr.subarray(0, size * arraysize32)); 
    ...
    rrVertexAttrib.readUnormOrder = function(dst, size, ptr, order, readAsTypeArray) {
        ...
        var ptrclone = new Uint8Array(ptr.subarray(0, size * arrayelementsize)); 
    ...
    rrVertexAttrib.read = function(dst, type, size, ptr) {
        ...
        switch (type) {
            ...
            case rrVertexAttrib.VertexAttribType.NONPURE_UNORM_2_10_10_10_REV:
                ...
                break;
            case rrVertexAttrib.VertexAttribType.NONPURE_SNORM8_CLAMP: 
                rrVertexAttrib.readSnormClamp(dst, size, ptr, Int8Array);
                break;
            case rrVertexAttrib.VertexAttribType.NONPURE_SNORM16_CLAMP: 
                rrVertexAttrib.readSnormClamp(dst, size, ptr, Int16Array);
                break;
            case rrVertexAttrib.VertexAttribType.NONPURE_SNORM32_CLAMP: 
