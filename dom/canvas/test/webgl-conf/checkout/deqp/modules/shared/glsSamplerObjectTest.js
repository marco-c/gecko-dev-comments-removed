...
var deString = framework.delibs.debase.deString;
    ...
    var DE_ASSERT = function(expression) {
     ...
     glsSamplerObjectTest.VIEWPORT_WIDTH = 128;
     glsSamplerObjectTest.VIEWPORT_HEIGHT = 128;

     glsSamplerObjectTest.TEXTURE2D_WIDTH = 32;
     glsSamplerObjectTest.TEXTURE2D_HEIGHT = 32;

     glsSamplerObjectTest.TEXTURE3D_WIDTH = 32;
     glsSamplerObjectTest.TEXTURE3D_HEIGHT = 32;
     glsSamplerObjectTest.TEXTURE3D_DEPTH = 32;

     glsSamplerObjectTest.CUBEMAP_SIZE = 32;
    ...
    glsSamplerObjectTest.TestSpec = function(name, desc, target, state1, state2, state3) {
         ...
         this.desc = desc;
         this.target = target;
         this.textureState = state1;
         this.textureState2 = state3 !== undefined ? state2 : null; 
         this.samplerState = state3 !== undefined ? state3 : state2;
    };
    ...
    glsSamplerObjectTest.TextureSamplerTest = function(spec) {
        tcuTestCase.DeqpTest.call(this, spec.name, spec.desc);
         ...
         this.m_textureState = spec.textureState;
         this.m_samplerState = spec.samplerState;
    ...
    glsSamplerObjectTest.TextureSamplerTest.prototype.renderReferences = function(textureRef, samplerRef, x, y) {
         var texture = glsSamplerObjectTest.TextureSamplerTest.createTexture(this.m_target);
    ...
    glsSamplerObjectTest.TextureSamplerTest.createTexture2D = function() {
         var texture = null;
         var refTexture = new tcuTexture.Texture2D(
    ...
    glsSamplerObjectTest.TextureSamplerTest.createTexture3D = function() {
         var texture = null;
         var refTexture = new tcuTexture.Texture3D(
                                                                 new tcuTexture.TextureFormat(tcuTexture.ChannelOrder.RGBA,
                                                                                              tcuTexture.ChannelType.UNORM_INT8),
    ...
    glsSamplerObjectTest.TextureSamplerTest.createTextureCube = function() {
         var texture = null;
         var refTexture = new tcuTexture.TextureCube(
                                                                  new tcuTexture.TextureFormat(tcuTexture.ChannelOrder.RGBA,
                                                                                               tcuTexture.ChannelType.UNORM_INT8),
        ...
        for (var face in tcuTexture.CubeFace) {
             var target = gluTextureUtil.getGLCubeFace(tcuTexture.CubeFace[face]);
    ...
    glsSamplerObjectTest.TextureSamplerTest.prototype.init = function() {
         var vertexShaderTemplate = glsSamplerObjectTest.TextureSamplerTest.selectVertexShader(this.m_target);
         var fragmentShaderTemplate = glsSamplerObjectTest.TextureSamplerTest.selectFragmentShader(this.m_target);
    ...
    glsSamplerObjectTest.TextureSamplerTest.prototype.iterate = function() {
         ...
         var textureRef = new tcuSurface.Surface(glsSamplerObjectTest.VIEWPORT_WIDTH, glsSamplerObjectTest.VIEWPORT_HEIGHT);
         var samplerRef = new tcuSurface.Surface(glsSamplerObjectTest.VIEWPORT_WIDTH, glsSamplerObjectTest.VIEWPORT_HEIGHT);

         var textureResult = new tcuSurface.Surface(glsSamplerObjectTest.VIEWPORT_WIDTH, glsSamplerObjectTest.VIEWPORT_HEIGHT);
         var samplerResult = new tcuSurface.Surface(glsSamplerObjectTest.VIEWPORT_WIDTH, glsSamplerObjectTest.VIEWPORT_HEIGHT);

         var x = this.m_random.getInt(0, gl.drawingBufferWidth - glsSamplerObjectTest.VIEWPORT_WIDTH);
         var y = this.m_random.getInt(0, gl.drawingBufferHeight - glsSamplerObjectTest.VIEWPORT_HEIGHT);

        this.renderReferences(textureRef, samplerRef, x, y);
        this.renderResults(textureResult, samplerResult, x, y);

         var isOk = tcuImageCompare.pixelThresholdCompare('Sampler render result', 'Result from rendering with sampler', samplerRef, samplerResult, [0, 0, 0, 0]);
    ...
    glsSamplerObjectTest.MultiTextureSamplerTest = function(spec) {
        tcuTestCase.DeqpTest.call(this, spec.name, spec.desc);
         this.m_program = null;
         this.m_target = spec.target;
         this.m_textureState1 = spec.textureState;
         this.m_textureState2 = spec.textureState2;
         this.m_samplerState = spec.samplerState;
         this.m_random = new deRandom.Random(deString.deStringHash(spec.name));
    };
    ...
    glsSamplerObjectTest.MultiTextureSamplerTest.prototype.init = function() {
         var vertexShaderTemplate = glsSamplerObjectTest.MultiTextureSamplerTest.selectVertexShader(this.m_target);
         var fragmentShaderTemplate = glsSamplerObjectTest.MultiTextureSamplerTest.selectFragmentShader(this.m_target);
    ...
    glsSamplerObjectTest.MultiTextureSamplerTest.prototype.renderReferences = function(textureRef, samplerRef, x, y) {
         var texture1 = glsSamplerObjectTest.MultiTextureSamplerTest.createTexture(this.m_target, 0);
         var texture2 = glsSamplerObjectTest.MultiTextureSamplerTest.createTexture(this.m_target, 1);
    ...
    glsSamplerObjectTest.MultiTextureSamplerTest.prototype.render = function() {
        ...
        gl.useProgram(this.m_program.getProgram());
         ...
         var samplerLoc1 = gl.getUniformLocation(this.m_program.getProgram(), 'u_sampler1');
        DE_ASSERT(samplerLoc1 != -1);

         var samplerLoc2 = gl.getUniformLocation(this.m_program.getProgram(), 'u_sampler2');
        DE_ASSERT(samplerLoc2 != -1);

         var scaleLoc = gl.getUniformLocation(this.m_program.getProgram(), 'u_posScale');
