...
goog.scope(function() {
    ...
    glsFboUtil.Framebuffer.prototype.getImage = function(type, imgName) {
        switch (type) {
            case this.m_gl.TEXTURE: return this.textures.lookupDefault((imgName), null);
            case this.m_gl.RENDERBUFFER: return this.rbos.lookupDefault((imgName), null);
            default: break;
        }
