...
var gluShaderUtil = framework.opengl.gluShaderUtil;
    ...
    glsShaderLibrary.generateTestCases = function() {
     var parser = new glsShaderLibrary.Parser();
        try {
 ...
 var endchar = str.substr(0, 1);
        ...
        var advanceTokenWorker = function() {
            ...
            } else if (m_input.charAt(m_curPtr) === '"' && m_input.charAt(m_curPtr + 1) === '"') { 
        ...
        var parseValue = function(valueBlock) {
            ...
            if (m_curToken === Token.TOKEN_LEFT_BRACKET) { 
                ...
                for (;;) {
                    ...
                    if (m_curToken === Token.TOKEN_RIGHT_BRACKET) {
                        break;
                    } else if (m_curToken === Token.TOKEN_VERTICAL_BAR) { 
                        advanceToken();
                        continue;
                    } else {
        ...
        var parseShaderCase = function(shaderNodeList) {
            ...
            var valueBlockList = [];
             ...
             var version = '100';
             var expectResult = glsShaderLibraryCase.expectResult.EXPECT_PASS;
             var description;
             var bothSource = '';
             var vertexSource = '';
             var fragmentSource = '';
            ...
            for (;;) {
                ...
                if (m_curToken === Token.TOKEN_END) {
                 ...
                 var block = glsShaderLibraryCase.genValueBlock();
 ...
 var name = m_curTokenStr;
            ...
            advanceToken(Token.TOKEN_END); 
             ...
             var groupNode = tcuTestCase.newTest(name, description, null);
