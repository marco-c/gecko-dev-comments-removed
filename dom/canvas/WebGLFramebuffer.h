...
private:
    ...
    explicit WebGLFBAttachPoint(WebGLFBAttachPoint&) = default; 
...
protected:
    ...
    static const size_t kMaxColorAttachments = 8; 
    ...
    std::vector<const WebGLFBAttachPoint*> mColorDrawBuffers; 
    ...
    struct CompletenessInfo final {
        ...
        std::vector<const WebGLFBAttachPoint*> texAttachments; 
...
protected:
    ...
    Maybe<WebGLFBAttachPoint*> GetColorAttachPoint(GLenum attachment); 
