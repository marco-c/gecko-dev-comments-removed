...
nsSVGElement::IsAttributeMapped(const nsAtom* name) const {
 ...
 const Element::MappedAttributeEntry nsSVGElement::sGraphicsMap[] =
    {{nsGkAtoms::clip_path},
     {nsGkAtoms::clip_rule},
 ...
 const Element::MappedAttributeEntry nsSVGElement::sViewportsMap[] =
    {{nsGkAtoms::overflow}, {nsGkAtoms::clip}, {nullptr}};


 const Element::MappedAttributeEntry nsSVGElement::sMarkersMap[] = {
 ...
 const Element::MappedAttributeEntry nsSVGElement::sColorMap[] = {
    {nsGkAtoms::color}, {nullptr}};


 const Element::MappedAttributeEntry nsSVGElement::sFiltersMap[] = {
    {nsGkAtoms::colorInterpolationFilters}, {nullptr}};


 const Element::MappedAttributeEntry nsSVGElement::sFEFloodMap[] = {
 ...
 const Element::MappedAttributeEntry nsSVGElement::sMaskMap[] = {
...
SVGViewportElement* nsSVGElement::GetCtx() const {
 ...
 gfxMatrix nsSVGElement::PrependLocalTransformsTo(
