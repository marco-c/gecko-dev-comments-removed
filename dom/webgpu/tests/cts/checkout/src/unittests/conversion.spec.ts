...
g.test('float16BitsToFloat32').fn(t => {
  for (const [bits, number] of [
    ...cases,
    [0b1_00000_0000000000, -0], 
    [0b0_00000_1111111111, 0.00006104], 
...
g.test('float32ToFloat16Bits').fn(t => {
  for (const [bits, number] of [
    ...cases,
    [0b0_00000_0000000000, 0.00001], 
    [0b1_00000_0000000000, -0.00001], 
  ]) {
...
g.test('floatBitsToULPFromZero,16').fn(t => {
  ...
  test(0b0_00001_0000000000, 1); 
  test(0b1_00001_0000000000, -1); 
  test(0b0_00001_0000000001, 2); 
  test(0b1_00001_0000000001, -2); 
  test(0b0_01110_0000000000, 0b01101_0000000001); 
  test(0b1_01110_0000000000, -0b01101_0000000001); 
  test(0b0_01110_1111111110, 0b01101_1111111111); 
  test(0b1_01110_1111111110, -0b01101_1111111111); 
  test(0b0_01110_1111111111, 0b01110_0000000000); 
  test(0b1_01110_1111111111, -0b01110_0000000000); 
  test(0b0_01111_0000000000, 0b01110_0000000001); 
  test(0b1_01111_0000000000, -0b01110_0000000001); 
  test(0b0_01111_0000000001, 0b01110_0000000010); 
  test(0b1_01111_0000000001, -0b01110_0000000010); 
  test(0b0_10000_0000000000, 0b01111_0000000001); 
  test(0b1_10000_0000000000, -0b01111_0000000001); 
...
g.test('floatBitsToULPFromZero,32').fn(t => {
  ...
  test(0b0_00000001_00000000000000000000000, 1); 
  test(0b1_00000001_00000000000000000000000, -1); 
  test(0b0_00000001_00000000000000000000001, 2); 
  test(0b1_00000001_00000000000000000000001, -2); 
  test(0b0_01111110_00000000000000000000000, 0b01111101_00000000000000000000001); 
  test(0b1_01111110_00000000000000000000000, -0b01111101_00000000000000000000001); 
  test(0b0_01111110_11111111111111111111110, 0b01111101_11111111111111111111111); 
  test(0b1_01111110_11111111111111111111110, -0b01111101_11111111111111111111111); 
  test(0b0_01111110_11111111111111111111111, 0b01111110_00000000000000000000000); 
  test(0b1_01111110_11111111111111111111111, -0b01111110_00000000000000000000000); 
  test(0b0_01111111_00000000000000000000000, 0b01111110_00000000000000000000001); 
  test(0b1_01111111_00000000000000000000000, -0b01111110_00000000000000000000001); 
  test(0b0_01111111_00000000000000000000001, 0b01111110_00000000000000000000010); 
  test(0b1_01111111_00000000000000000000001, -0b01111110_00000000000000000000010); 
  test(0b0_11110000_00000000000000000000000, 0b11101111_00000000000000000000001); 
  test(0b1_11110000_00000000000000000000000, -0b11101111_00000000000000000000001); 
