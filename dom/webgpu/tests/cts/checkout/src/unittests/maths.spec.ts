...
g.test('nextAfterFlushToZero')
  .paramsSubcasesOnly<nextAfterCase>(
    ...
    { val: 0.001, dir: true, result: f32Bits(0x3a83126f) }, 
    { val: 0.001, dir: false, result: f32Bits(0x3a83126e) }, 
    { val: -0.001, dir: true, result: f32Bits(0xba83126e) }, 
    { val: -0.001, dir: false, result: f32Bits(0xba83126f) }, 
    { val: 2.82E-40, dir: true, result: f32Bits(kBit.f32.positive.min) }, 
    { val: 2.82E-40, dir: false, result: f32Bits(kBit.f32.negative.max) }, 
    { val: -2.82E-40, dir: true, result: f32Bits(kBit.f32.positive.min) }, 
    { val: -2.82E-40, dir: false, result: f32Bits(kBit.f32.negative.max) }, 
    ]
  )
...
g.test('nextAfterNoFlush')
  .paramsSubcasesOnly<nextAfterCase>(
    ...
    { val: -0.001, dir: true, result: f32Bits(0xba83126e) }, 
    { val: -0.001, dir: false, result: f32Bits(0xba83126f) }, 
    { val: 2.82E-40, dir: true, result: f32Bits(0x0003121a) }, 
    { val: 2.82E-40, dir: false, result: f32Bits(0x00031219) }, 
    { val: -2.82E-40, dir: true, result: f32Bits(0x80031219) }, 
    { val: -2.82E-40, dir: false, result: f32Bits(0x8003121a) }, 
  ]
  )
  .fn(t => {
    const val = t.params.val;
...
g.test('oneULPFlushToZero')
  .paramsSimple<OneULPCase>([
    ...
    { target: 0.001, expect: hexToF32(0x2f000000) }, 
    { target: -0.001, expect: hexToF32(0x2f000000) }, 
    { target: 1e40, expect: hexToF32(0x73800000) }, 
    { target: -1e40, expect: hexToF32(0x73800000) }, 
  ])
  .fn(t => {
...
g.test('oneULPNoFlush')
  .paramsSimple<OneULPCase>([
    ...
    { target: -2.82e-40, expect: hexToF32(0x00000001) }, 
