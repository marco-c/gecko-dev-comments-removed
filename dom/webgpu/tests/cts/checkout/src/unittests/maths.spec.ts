...
g.test('nextAfterF16NoFlush')
  .paramsSubcasesOnly<nextAfterCase>(
    ...
    [
      ...
      { val: -0.01, dir: 'positive', result: reinterpretU16AsF16(0xa11e) }, 
      { val: -0.01, dir: 'negative', result: reinterpretU16AsF16(0xa11f) }, 
      { val: 2.82E-40, dir: 'positive', result: kValue.f16.positive.subnormal.min }, 
      { val: 2.82E-40, dir: 'negative', result: 0 }, 
      { val: -2.82E-40, dir: 'positive', result: 0 }, 
      { val: -2.82E-40, dir: 'negative', result: kValue.f16.negative.subnormal.max }, 
    ]
  )
  .fn(t => {
    const val = t.params.val;
...
const kFrexpCases = {
  ...
  f64: [
    ...
    { input: kValue.f64.positive.subnormal.max, fract: reinterpretU64AsF64(0x3fef_ffff_ffff_fffen) , exp: -1022 },
    { input: kValue.f64.positive.subnormal.min, fract: 0.5, exp: -1073 },
    { input: kValue.f64.negative.subnormal.max, fract: -0.5, exp: -1073 },
    { input: kValue.f64.negative.subnormal.min, fract: reinterpretU64AsF64(0xbfef_ffff_ffff_fffen) , exp: -1022 },
  ] as frexpCase[],
} as const;
