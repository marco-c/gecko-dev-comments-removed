...
g.test('nextAfterF32FlushToZero')
  .paramsSubcasesOnly<nextAfterCase>(
    ...
    { val: 0.001, dir: 'positive', result: reinterpretU32AsF32(0x3a83126f) }, 
    { val: 0.001, dir: 'negative', result: reinterpretU32AsF32(0x3a83126e) }, 
    { val: -0.001, dir: 'positive', result: reinterpretU32AsF32(0xba83126e) }, 
    { val: -0.001, dir: 'negative', result: reinterpretU32AsF32(0xba83126f) }, 
    { val: 2.82E-40, dir: 'positive', result: kValue.f32.positive.min }, 
    { val: 2.82E-40, dir: 'negative', result: kValue.f32.negative.max }, 
    { val: -2.82E-40, dir: 'positive', result: kValue.f32.positive.min }, 
    { val: -2.82E-40, dir: 'negative', result: kValue.f32.negative.max }, 
    ]
  )
...
g.test('nextAfterF32NoFlush')
  .paramsSubcasesOnly<nextAfterCase>(
    ...
    { val: -0.001, dir: 'positive', result: reinterpretU32AsF32(0xba83126e) }, 
    { val: -0.001, dir: 'negative', result: reinterpretU32AsF32(0xba83126f) }, 
    { val: 2.82E-40, dir: 'positive', result: reinterpretU32AsF32(0x0003121a) }, 
    { val: 2.82E-40, dir: 'negative', result: reinterpretU32AsF32(0x00031219) }, 
    { val: -2.82E-40, dir: 'positive', result: reinterpretU32AsF32(0x80031219) }, 
    { val: -2.82E-40, dir: 'negative', result: reinterpretU32AsF32(0x8003121a) }, 
  ]
  )
  .fn(t => {
    const val = t.params.val;
...
g.test('nextAfterF16FlushToZero')
  .paramsSubcasesOnly<nextAfterCase>(
    ...
    [
      ...
      { val: 0.01, dir: 'positive', result: reinterpretU16AsF16(0x211f) }, 
      { val: 0.01, dir: 'negative', result: reinterpretU16AsF16(0x211e) }, 
      { val: -0.01, dir: 'positive', result: reinterpretU16AsF16(0xa11e) }, 
      { val: -0.01, dir: 'negative', result: reinterpretU16AsF16(0xa11f) }, 
      { val: 2.82E-40, dir: 'positive', result: kValue.f16.positive.min }, 
      { val: 2.82E-40, dir: 'negative', result: kValue.f16.negative.max }, 
      { val: -2.82E-40, dir: 'positive', result: kValue.f16.positive.min }, 
      { val: -2.82E-40, dir: 'negative', result: kValue.f16.negative.max }, 
    ]
  )
...
g.test('nextAfterF16NoFlush')
  .paramsSubcasesOnly<nextAfterCase>(
    ...
    [
      ...
      { val: -0.01, dir: 'positive', result: reinterpretU16AsF16(0xa11e) }, 
      { val: -0.01, dir: 'negative', result: reinterpretU16AsF16(0xa11f) }, 
      { val: 2.82E-40, dir: 'positive', result: kValue.f16.subnormal.positive.min }, 
      { val: 2.82E-40, dir: 'negative', result: 0 }, 
      { val: -2.82E-40, dir: 'positive', result: 0 }, 
      { val: -2.82E-40, dir: 'negative', result: kValue.f16.subnormal.negative.max }, 
    ]
  )
  .fn(t => {
    const val = t.params.val;
...
g.test('oneULPF32FlushToZero')
  .paramsSimple<OneULPCase>([
    ...
    { target: 0.001, expect: reinterpretU32AsF32(0x2f000000) }, 
    { target: -0.001, expect: reinterpretU32AsF32(0x2f000000) }, 
    { target: 1e40, expect: reinterpretU32AsF32(0x73800000) }, 
    { target: -1e40, expect: reinterpretU32AsF32(0x73800000) }, 
  ])
  .fn(t => {
    const target = t.params.target;
...
g.test('oneULPF32NoFlush')
  .paramsSimple<OneULPCase>([
    ...
    { target: -2.82e-40, expect: reinterpretU32AsF32(0x00000001) }, 
...
g.test('oneULPF16FlushToZero')
  .paramsSubcasesOnly<OneULPCase>([
    ...
    { target: 1.91e-6, expect: reinterpretU16AsF16(0x0400) }, 
    ...
    { target: 0.001, expect: reinterpretU16AsF16(0x0010) }, 
    { target: -0.001, expect: reinterpretU16AsF16(0x0010) }, 
    { target: 1e8, expect: reinterpretU16AsF16(0x5000) }, 
    { target: -1e8, expect: reinterpretU16AsF16(0x5000) }, 
  ])
  .fn(t => {
    const target = t.params.target;
...
g.test('oneULPF16NoFlush')
  .paramsSubcasesOnly<OneULPCase>([
    ...
    { target: 1.91e-6, expect: reinterpretU16AsF16(0x0001) }, 
...
const kFrexpCases = {
  ...
  f64: [
    { input: kValue.f64.positive.max, fract: reinterpretU64AsF64(0x3fef_ffff_ffff_ffffn) , exp: 1024 },
    { input: kValue.f64.positive.min, fract: 0.5, exp: -1021 },
    { input: kValue.f64.negative.max, fract: -0.5, exp: -1021 },
    { input: kValue.f64.negative.min, fract: reinterpretU64AsF64(0xbfef_ffff_ffff_ffffn) , exp: 1024 },
    { input: kValue.f64.subnormal.positive.max, fract: reinterpretU64AsF64(0x3fef_ffff_ffff_fffen) , exp: -1022 },
    { input: kValue.f64.subnormal.positive.min, fract: 0.5, exp: -1073 },
    { input: kValue.f64.subnormal.negative.max, fract: -0.5, exp: -1073 },
    { input: kValue.f64.subnormal.negative.min, fract: reinterpretU64AsF64(0xbfef_ffff_ffff_fffen) , exp: -1022 },
  ] as frexpCase[],
} as const;
