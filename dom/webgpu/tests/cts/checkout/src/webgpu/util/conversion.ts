...
export class ScalarType {
  ...
  readonly read: (buf: Uint8Array, offset: number) => ScalarValue; 
...
export class AbstractIntValue {
  ...
  readonly bitsLow: number; 
  readonly bitsHigh: number; 
  readonly type = Type.abstractInt; 
...
export class AbstractFloatValue {
  ...
  readonly bitsLow: number; 
  readonly bitsHigh: number; 
  readonly type = Type.abstractFloat; 
