  ...
  .params(u =>
    u 
      ...
      .combineWithParams([
        ...
        { vertexConstants: { w: 1 }, _success: false }, 
        { vertexConstants: { 1: 1, z: 1 }, _success: false }, 
        { vertexConstants: { 数: 1 }, _success: true }, 
        { vertexConstants: { séquençage: 0 }, _success: false }, 
  ...
  .params(u =>
    u 
      ...
      .combineWithParams([
        ...
        { fragmentConstants: { b: 1 }, _success: false }, 
        { fragmentConstants: { a: 1 }, _success: false }, 
        { fragmentConstants: { 1: 1, b: 1 }, _success: false }, 
        { fragmentConstants: { 数: 1 }, _success: true }, 
        { fragmentConstants: { séquençage: 0 }, _success: false }, 
  ...
  .params(u =>
    u 
      ...
      .combineWithParams([
        ...
        { fragmentConstants: { r: 1, g: 1 }, _success: false }, 
...
`
  ...
  .params(u =>
    u 
      .combine('isAsync', [true, false])
      .combineWithParams([
        { vertexConstants: { cf: 1 }, _success: true }, 
...
`
  ...
  .params(u =>
    u 
      .combine('isAsync', [true, false])
      .combineWithParams([
        { fragmentConstants: { cf: 1 }, _success: true }, 
