...
class F extends GPUTest {
  ...
  MakeIndirectBuffer(isIndexed: boolean, indirectOffset: number): GPUBuffer {
    ...
    if (isIndexed) {
      ...
      indirectBuffer[o] = 3; 
      indirectBuffer[o + 1] = 1; 
      indirectBuffer[o + 2] = 0; 
      indirectBuffer[o + 3] = 0; 
      indirectBuffer[o + 4] = 0; 

      
      indirectBuffer[o + 5] = 6; 
      indirectBuffer[o + 6] = 1; 
      indirectBuffer[o + 7] = 0; 
      indirectBuffer[o + 8] = 0; 
      indirectBuffer[o + 9] = 0; 

      if (o >= parametersSize) {
        
        indirectBuffer[o - 5] = 3; 
        indirectBuffer[o - 4] = 1; 
        indirectBuffer[o - 3] = 3; 
        indirectBuffer[o - 2] = 0; 
        indirectBuffer[o - 1] = 0; 
      }
      ...
      indirectBuffer[o + 4] = 6; 
      indirectBuffer[o + 5] = 1; 
      indirectBuffer[o + 6] = 0; 
      indirectBuffer[o + 7] = 0; 

      if (o >= parametersSize) {
        
        indirectBuffer[o - 4] = 3; 
        indirectBuffer[o - 3] = 1; 
        indirectBuffer[o - 2] = 3; 
        indirectBuffer[o - 1] = 0; 
      }
