  ...
  .params(u =>
    u
      ...
      .expandWithParams(function* (p) {
        yield { stageASize: 16, stageBSize: 16, layoutSize: 16 }; 
        yield { stageASize: 12, stageBSize: 12, layoutSize: 16 }; 
        yield { stageASize: 20, stageBSize: 20, layoutSize: 16 }; 
        yield { stageASize: 32, stageBSize: 32, layoutSize: 16 }; 
        yield { stageASize: 'max', stageBSize: 0, layoutSize: 'auto' }; 
        yield { stageASize: 'exceedLimits', stageBSize: 0, layoutSize: 'auto' }; 

        if (p.pipelineType === 'render') {
          yield { stageASize: 0, stageBSize: 'max', layoutSize: 'auto' }; 
          yield { stageASize: 'max', stageBSize: 'max', layoutSize: 'auto' }; 
          yield { stageASize: 0, stageBSize: 'exceedLimits', layoutSize: 'auto' }; 
        }
      })
  )
  .fn(t => {
