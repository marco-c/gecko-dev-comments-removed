      ...
      for (let y = 0; y < height; ++y) {
        for (let x = 0; x < width; ++x) {
          ...
          switch (format) {
            ...
            case 'rgba8unorm':
            case 'rgba8uint':
              initialTypedData[index * 4 + 0] = (baseValue * 1) % 256; 
              initialTypedData[index * 4 + 1] = (baseValue * 2) % 256; 
              initialTypedData[index * 4 + 2] = (baseValue * 3) % 256; 
              initialTypedData[index * 4 + 3] = 255;
              break;
            case 'rgba8sint':
              initialTypedData[index * 4 + 0] = ((baseValue * 1) % 256) - 128; 
              initialTypedData[index * 4 + 1] = ((baseValue * 2) % 256) - 128; 
              initialTypedData[index * 4 + 2] = ((baseValue * 3) % 256) - 128; 
            ...
            case 'r16float':
              ...
              break;
            case 'rgba16uint':
              initialTypedData[index * 4 + 0] = (baseValue * 1) % 65536; 
              initialTypedData[index * 4 + 1] = (baseValue * 2) % 65536; 
              initialTypedData[index * 4 + 2] = (baseValue * 3) % 65536; 
              initialTypedData[index * 4 + 3] = 65535;
              break;
            case 'rgba16sint':
              initialTypedData[index * 4 + 0] = ((baseValue * 1) % 65536) - 32768; 
              initialTypedData[index * 4 + 1] = ((baseValue * 2) % 65536) - 32768; 
              initialTypedData[index * 4 + 2] = ((baseValue * 3) % 65536) - 32768; 
              initialTypedData[index * 4 + 3] = 32767;
              break;
            case 'rgba16float':
              initialTypedData[index * 4 + 0] = baseValue * 1; 
              initialTypedData[index * 4 + 1] = baseValue * 2; 
              initialTypedData[index * 4 + 2] = baseValue * 3; 
            ...
            case 'rgba32uint':
              ...
              break;
            case 'rgba32sint':
              initialTypedData[index * 4 + 0] = (index & 1 ? 1 : -1) * baseValue * 1; 
              initialTypedData[index * 4 + 1] = (index & 1 ? 1 : -1) * baseValue * 2; 
              initialTypedData[index * 4 + 2] = (index & 1 ? 1 : -1) * baseValue * 3; 
              initialTypedData[index * 4 + 3] = baseValue;
              break;
            case 'rgba32float':
              initialTypedData[index * 4 + 0] = (baseValue * 1) / 10.0; 
              initialTypedData[index * 4 + 1] = (baseValue * 2) / 10.0; 
              initialTypedData[index * 4 + 2] = (baseValue * 3) / 10.0; 
              initialTypedData[index * 4 + 3] = 1.0;
              break;
          }
        }
