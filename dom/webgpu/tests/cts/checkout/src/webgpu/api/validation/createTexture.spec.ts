  ...
  .params(u =>
    u 
      ...
      .combineWithParams([
        ...
        { size: [32, 28] }, 
        { size: [31, 31] }, 
        { size: [32], dimension: '1d' as const }, 
        { size: [31], dimension: '1d' as const }, 
        { size: [32, 32, 32], dimension: '3d' as const }, 
        { size: [32, 31, 31], dimension: '3d' as const }, 
        { size: [31, 32, 31], dimension: '3d' as const }, 
        { size: [31, 31, 32], dimension: '3d' as const }, 
        { size: [31, 31, 31], dimension: '3d' as const }, 
        { size: [32, 8] }, 
        { size: [32, 32, 64] }, 
        { size: [32, 32, 64], dimension: '3d' as const }, 
      ])
      .unless(
