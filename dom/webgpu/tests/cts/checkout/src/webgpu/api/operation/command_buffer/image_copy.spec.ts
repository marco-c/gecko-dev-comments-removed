...
const kRowsPerImageAndBytesPerRowParams = {
  paddings: [
    { bytesPerRowPadding: 0, rowsPerImagePadding: 0 }, 
    { bytesPerRowPadding: 0, rowsPerImagePadding: 6 }, 
    { bytesPerRowPadding: 6, rowsPerImagePadding: 0 }, 
    { bytesPerRowPadding: 15, rowsPerImagePadding: 17 }, 
  ],
  ...
  copySizes: [
    ...
    { copyWidthInBlocks: 3, copyHeightInBlocks: 4, copyDepth: 5 }, 
    { copyWidthInBlocks: 5, copyHeightInBlocks: 4, copyDepth: 2 }, 

    { copyWidthInBlocks: 0, copyHeightInBlocks: 4, copyDepth: 5 }, 
    { copyWidthInBlocks: 3, copyHeightInBlocks: 0, copyDepth: 5 }, 
    { copyWidthInBlocks: 3, copyHeightInBlocks: 4, copyDepth: 0 }, 
    { copyWidthInBlocks: 256, copyHeightInBlocks: 3, copyDepth: 2 }, 
    { copyWidthInBlocks: 1, copyHeightInBlocks: 3, copyDepth: 5 }, 

    
    
    
    { copyWidthInBlocks: 32, copyHeightInBlocks: 1, copyDepth: 8 }, 
    
    
    { copyWidthInBlocks: 5, copyHeightInBlocks: 4, copyDepth: 1 }, 

    { copyWidthInBlocks: 7, copyHeightInBlocks: 1, copyDepth: 1 }, 
...
const kOffsetsAndSizesParams = {
  offsetsAndPaddings: [
    ...
    { offsetInBlocks: 1, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 2, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 15, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 16, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 242, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 243, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 768, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 769, dataPaddingInBytes: 0 }, 
    { offsetInBlocks: 0, dataPaddingInBytes: 1 }, 
    { offsetInBlocks: 1, dataPaddingInBytes: 8 }, 
  ],
  copyDepth: [1, 2, 6], 
};
...
`
  ...
  .params(u =>
    u
      ...
      .combine('copyWidth', [3, 1, 2, 127, 128, 255, 256] as const) 
...
for all formats. We pass origin and copyExtent as [number, number, number].`
  ...
  .params(u =>
    u
      ...
      .beginSubcases()
      .combine('originValueInBlocks', [0, 6, 7, 8]) 
      .combine('copySizeValueInBlocks', [0, 6, 7, 8]) 
