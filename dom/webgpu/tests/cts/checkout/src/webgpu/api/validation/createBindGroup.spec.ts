...
g.test('buffer_offset_and_size_for_bind_groups_match')
  ...
  .paramsSubcasesOnly([
    { offset: 0, size: 512, _success: true }, 
    { offset: 256, size: 256, _success: true }, 
    { bindBufferResource: true, _success: true }, 
    ...
    { offset: 256 * 5, size: 0, _success: false }, 
    { offset: 0, size: 256 * 5, _success: false }, 
    { offset: 1024, size: 1, _success: false }, 
  ])
  .fn(t => {
...
g.test('binding_resources,device_mismatch')
  ...
  .params(u =>
    u
      ...
      .beginSubcases()
      .combineWithParams([
        { resource0Mismatched: false, resource1Mismatched: false }, 
