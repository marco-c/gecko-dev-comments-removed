...
export const d = makeCaseCache('unary/af_assignment', {
  abstract: () => {
    const inputs = [
      ...
      1,
      -1,
      reinterpretU64AsF64(0x7000_0000_0000_0001n), 
      reinterpretU64AsF64(0x0000_0000_0000_0001n), 
      reinterpretU64AsF64(0x600a_aaaa_5555_5555n), 
      reinterpretU64AsF64(0x000a_aaaa_5555_5555n), 
      reinterpretU64AsF64(0x0010_0000_0000_0001n), 
      reinterpretU64AsF64(0x0010_0000_0000_0001n), 
      reinterpretU64AsF64(0xf555_5555_aaaa_aaaan), 
      reinterpretU64AsF64(0x5555_5555_aaaa_aaaan), 
      reinterpretU64AsF64(0xffef_ffff_ffff_ffffn), 
      reinterpretU64AsF64(0x7fef_ffff_ffff_ffffn), 
