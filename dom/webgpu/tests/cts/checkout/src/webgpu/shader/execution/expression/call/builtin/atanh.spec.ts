...
const f32_inputs = [
  ...biasedRange(kValue.f32.negative.less_than_one, -0.9, 20), 
  -1,
  ...biasedRange(kValue.f32.positive.less_than_one, 0.9, 20), 
  1,
  ...fullF32Range(),
];
const f16_inputs = [
  ...biasedRange(kValue.f16.negative.less_than_one, -0.9, 20), 
  -1,
  ...biasedRange(kValue.f16.positive.less_than_one, 0.9, 20), 
  1,
  ...fullF16Range(),
];
