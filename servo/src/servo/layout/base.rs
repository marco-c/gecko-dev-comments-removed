...
import style::style::{computed_style, di_block, di_inline};
import style::style::style_methods;
import util::tree;
    ...
    */
    ...
    fn do_layout() {
        ...
        assert fb == [geom::box(au(0), au(0), au(10), au(10)),   
                      geom::box(au(0), au(10), au(10), au(15)),  
                      geom::box(au(0), au(25), au(10), au(20)),  
                      geom::box(au(0), au(0), au(100), au(45))]; 
    }
}
