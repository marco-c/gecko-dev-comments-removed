...
const F_TERMINATED: u32 = 1 << 0; 
const F_VOIDED: u32 = 1 << 1; 
const F_SHARED: u32 = 1 << 2; 
const F_OWNED: u32 = 1 << 3; 
const F_FIXED: u32 = 1 << 4; 
const F_LITERAL: u32 = 1 << 5; 


const F_CLASS_FIXED: u32 = 1 << 16; 
