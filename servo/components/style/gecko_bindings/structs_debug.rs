...
pub mod root {
    ...
    pub const PR_FAILURE: root::_bindgen_ty_115 = _bindgen_ty_115::PR_FAILURE;
    pub const PR_SUCCESS: root::_bindgen_ty_115 = _bindgen_ty_115::PR_SUCCESS;
    #[repr(i32)]
    #[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
    pub enum _bindgen_ty_115 { PR_FAILURE = -1, PR_SUCCESS = 0, }
    pub use self::super::root::_bindgen_ty_115 as PRStatus;
