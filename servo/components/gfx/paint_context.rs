...
impl<'a> PaintContext<'a> {
    ...
    fn create_rounded_rect_path(&self,
        ...
        path_builder.move_to(Point2D(bounds.origin.x + radii.top_left, bounds.origin.y));   
        path_builder.line_to(Point2D(bounds.max_x() - radii.top_right, bounds.origin.y));   
        path_builder.arc(Point2D(bounds.max_x() - radii.top_right,
                         ...
                         f32::consts::PI_2,
                         false);                                                            
        path_builder.line_to(Point2D(bounds.max_x(), bounds.max_y() - radii.bottom_right)); 
        path_builder.arc(Point2D(bounds.max_x() - radii.bottom_right,
                         ...
                         false);                                                            
        path_builder.line_to(Point2D(bounds.origin.x + radii.bottom_left, bounds.max_y())); 
        path_builder.arc(Point2D(bounds.origin.x + radii.bottom_left,
                         ...
                         f32::consts::PI,
                         false);                                                            
        path_builder.line_to(Point2D(bounds.origin.x, bounds.origin.y + radii.top_left));   
    ...
    pub fn get_or_create_temporary_draw_target(&mut self,
        ...
        let mut size = Size2D(size.width, size.height); 
