...
impl<'a> PaintContext<'a> {
    ...
    fn create_rounded_rect_path(&self,
        ...
        path_builder.move_to(Point2D::new(bounds.origin.x + radii.top_left, bounds.origin.y));   
        path_builder.line_to(Point2D::new(bounds.max_x() - radii.top_right, bounds.origin.y));   
        ...
        path_builder.arc(Point2D::new(bounds.max_x() - radii.bottom_right,
                         ...
                         false);                                                                 
        path_builder.line_to(Point2D::new(bounds.origin.x + radii.bottom_left, bounds.max_y())); 
        path_builder.arc(Point2D::new(bounds.origin.x + radii.bottom_left,
                         ...
                         f32::consts::PI,
                         false);                                                                 
        path_builder.line_to(Point2D::new(bounds.origin.x, bounds.origin.y + radii.top_left));   
...
impl DrawTargetExtensions for DrawTarget {
    fn create_rectangular_border_path<T>(&self, outer_rect: &T, inner_rect: &T)
        ...
        path_builder.line_to(Point2D::new(outer_rect.max_x(), inner_rect.origin.y));     
        path_builder.line_to(Point2D::new(inner_rect.max_x(), inner_rect.origin.y));     
        path_builder.line_to(Point2D::new(inner_rect.max_x(), inner_rect.max_y()));      
        path_builder.line_to(Point2D::new(inner_rect.origin.x, inner_rect.max_y()));     
