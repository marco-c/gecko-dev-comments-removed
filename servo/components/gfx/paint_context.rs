...
impl<'a> PaintContext<'a> {
    ...
    fn create_rounded_rect_path(&self,
        ...
        path_builder.move_to(Point2D::new(bounds.origin.x + radii.top_left.width, bounds.origin.y));   
        path_builder.line_to(Point2D::new(bounds.max_x() - radii.top_right.width, bounds.origin.y));   
        PaintContext::draw_corner(path_builder,                                                        
                                  BorderCorner::TopRight,
                                  &origin_TR,
                                  &radii.top_right,
        ...
        PaintContext::draw_corner(path_builder,                                                        
                                  ...
                                  &zero_elbow,
                                  false);
        path_builder.line_to(Point2D::new(bounds.max_x(), bounds.max_y() - radii.bottom_right.width)); 
        PaintContext::draw_corner(path_builder,                                                        
                                  BorderCorner::BottomRight,
                                  &origin_BR,
                                  &radii.bottom_right,
        ...
        path_builder.line_to(Point2D::new(bounds.origin.x,
                                          bounds.origin.y + radii.top_left.height));                    
        PaintContext::draw_corner(path_builder,                                                         
                                  BorderCorner::TopLeft,
                                  &origin_TL,
                                  &radii.top_left,
