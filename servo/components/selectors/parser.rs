...
pub enum Component<Impl: SelectorImpl> {
    ...
    AttrIncludesNeverMatch(AttrSelector<Impl>, Impl::AttrValue),  
    AttrPrefixNeverMatch(AttrSelector<Impl>, Impl::AttrValue),  
    AttrSubstringNeverMatch(AttrSelector<Impl>, Impl::AttrValue),  
    AttrSuffixNeverMatch(AttrSelector<Impl>, Impl::AttrValue),  
...
fn parse_attribute_selector<P, Impl>(parser: &P, input: &mut CssParser)
    ...
    where P: Parser<Impl=Impl>, Impl: SelectorImpl
{
    let attr = match parse_qualified_name(parser, input,  true)? {
        None => return Err(()),
    ...
    where P: Parser<Impl=Impl>, Impl: SelectorImpl
{
    ...
    parse_compound_selector(parser, input, &mut v,  true)?;
