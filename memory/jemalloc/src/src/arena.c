...
static size_t	small_maxrun; 
static bool	*small_run_tab; 
static size_t	*run_quantize_floor_tab; 
static size_t	*run_quantize_ceil_tab; 
unsigned	nlclasses; 
unsigned	nhclasses; 
static szind_t	runs_avail_bias; 
static szind_t	runs_avail_nclasses; 
