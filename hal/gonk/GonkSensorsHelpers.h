...
Convert(int32_t aIn, SensorsStatus& aOut)
{
  static const uint8_t sStatus[] = {
    [0] = SENSORS_STATUS_NO_CONTACT, 
    [1] = SENSORS_STATUS_UNRELIABLE, 
    [2] = SENSORS_STATUS_ACCURACY_LOW, 
    [3] = SENSORS_STATUS_ACCURACY_MEDIUM, 
    [4] = SENSORS_STATUS_ACCURACY_HIGH 
  };
  static const int8_t sOffset = -1; 
