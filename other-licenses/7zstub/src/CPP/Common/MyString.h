...
public:
  ...
  void SetFrom(const char *s, unsigned len); 
...
void operator+(char c, const AString &s); 
...
class UString
{
  ...
  UString(unsigned num, const wchar_t *s); 
  UString(unsigned num, const UString &s); 
  UString(const UString &s, wchar_t c); 
...
public:
  ...
  void SetFrom(const wchar_t *s, unsigned len); 
...
void operator+(wchar_t c, const UString &s); 
