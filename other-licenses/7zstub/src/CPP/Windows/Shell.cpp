...
bool BrowseForFolder(HWND , LPCTSTR ,
    LPCTSTR , CSysString & )
{
...
int CALLBACK BrowseCallbackProc(HWND hwnd, UINT uMsg, LPARAM , LPARAM data)
{
  #ifndef UNDER_CE
  switch (uMsg)
  {
...
int CALLBACK BrowseCallbackProc2(HWND hwnd, UINT uMsg, LPARAM , LPARAM data)
{
  switch (uMsg)
  {
    case BFFM_INITIALIZED:
