...
HRESULT CUpdateCallbackAgent::WriteSfx(const wchar_t * , UInt64 )
{
  return S_OK;
}
...
HRESULT CUpdateCallbackAgent::GetStream(const wchar_t *name, bool isDir, bool , UInt32 mode)
{
  if (Callback2)
...
HRESULT CUpdateCallbackAgent::ShowDeleteFile(const wchar_t *name, bool )
{
