...
struct COpenType
{
      ...
      MaxStartOffset(0)
  {
    ...
    SpecUnknownExt.CanReturnTail = true; 
    SpecUnknownExt.CanReturnMid = true;
    SpecUnknownExt.CanReturnFrontal = true; 
...
public:
  ...
  UInt64 ArcStreamOffset; 
  Int64 GetGlobalOffset() const { return ArcStreamOffset + Offset; } 
