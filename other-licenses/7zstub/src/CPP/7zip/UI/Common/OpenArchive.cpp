...
STDMETHODIMP CExtractCallback_To_OpenCallback::SetTotal(UInt64 )
{
  return S_OK;
}

STDMETHODIMP CExtractCallback_To_OpenCallback::SetCompleted(const UInt64 * )
{
  return S_OK;
}

STDMETHODIMP CExtractCallback_To_OpenCallback::SetRatioInfo(const UInt64 *inSize, const UInt64 * )
{
  if (Callback)
  {
    UInt64 value = Offset;
...
STDMETHODIMP CExtractCallback_To_OpenCallback::GetStream(UInt32 , ISequentialOutStream **outStream, Int32 )
{
  *outStream = 0;
  return S_OK;
}

STDMETHODIMP CExtractCallback_To_OpenCallback::PrepareOperation(Int32 )
{
  return S_OK;
}

STDMETHODIMP CExtractCallback_To_OpenCallback::SetOperationResult(Int32 )
{
  return S_OK;
}
...
HRESULT CArc::OpenStream2(const COpenOptions &op)
{
  ...
  
  {
    ...
    if (mode.CanReturnParser)
    {
      bool returnParser = (handlerSpec->_items.Size() == 1); 
