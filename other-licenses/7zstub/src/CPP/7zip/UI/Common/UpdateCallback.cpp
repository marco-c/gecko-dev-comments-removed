...
STDMETHODIMP CArchiveUpdateCallback::GetParent(UInt32 , UInt32 *parent, UInt32 *parentType)
{
...
STDMETHODIMP CArchiveUpdateCallback::GetRawPropInfo(UInt32 , BSTR *name, PROPID *propID)
{
  *name = NULL;
  *propID = kpidNtSecure;
  return S_OK;
