...
HRESULT CAltStreamsFolder::Init(const FString &path )
{
...
STDMETHODIMP CAltStreamsFolder::GetItemPrefix(UInt32 , const wchar_t **name, unsigned *len)
{
  *name = 0;
  *len = 0;
  return S_OK;
...
STDMETHODIMP_(Int32) CAltStreamsFolder::CompareItems(UInt32 index1, UInt32 index2, PROPID propID, Int32 )
{
...
STDMETHODIMP CAltStreamsFolder::BindToFolder(UInt32 , IFolderFolder **resultFolder)
{
  *resultFolder = 0;
  return E_INVALIDARG;
}

STDMETHODIMP CAltStreamsFolder::BindToFolder(const wchar_t * , IFolderFolder **resultFolder)
{
  *resultFolder = 0;
  return E_INVALIDARG;
}
...
STDMETHODIMP CAltStreamsFolder::CreateFolder(const wchar_t * , IProgress * )
{
  return E_NOTIMPL;
}

STDMETHODIMP CAltStreamsFolder::CreateFile(const wchar_t *name, IProgress * )
{
  FString absPath;
...
STDMETHODIMP CAltStreamsFolder::SetProperty(UInt32 , PROPID ,
    const PROPVARIANT * , IProgress * )
{
  return E_NOTIMPL;
}
...
STDMETHODIMP CAltStreamsFolder::CopyFrom(Int32 , const wchar_t * ,
    const wchar_t * const * , UInt32 , IProgress * )
{
...
STDMETHODIMP CAltStreamsFolder::CopyFromFile(UInt32 , const wchar_t * , IProgress * )
{
  return E_NOTIMPL;
}
