...
bool CBrowseDialog::OnSize(WPARAM , int xSize, int ySize)
{
  int mx, my;
  {
    RECT r;
...
bool CBrowseDialog::OnNotify(UINT , LPNMHDR header)
{
...
bool CorrectFsPath(const UString & , const UString &path, UString &result)
{
  result = path;
  return true;
}
