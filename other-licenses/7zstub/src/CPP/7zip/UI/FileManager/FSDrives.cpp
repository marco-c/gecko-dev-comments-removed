...
STDMETHODIMP CFSDrives::CopyFrom(Int32 , const wchar_t * ,
    const wchar_t * const * , UInt32 , IProgress * )
{
  return E_NOTIMPL;
}

STDMETHODIMP CFSDrives::CopyFromFile(UInt32 , const wchar_t * , IProgress * )
{
  return E_NOTIMPL;
}

STDMETHODIMP CFSDrives::CreateFolder(const wchar_t * , IProgress * )
{
  return E_NOTIMPL;
}

STDMETHODIMP CFSDrives::CreateFile(const wchar_t * , IProgress * )
{
  return E_NOTIMPL;
}

STDMETHODIMP CFSDrives::Rename(UInt32 , const wchar_t * , IProgress * )
{
  return E_NOTIMPL;
}

STDMETHODIMP CFSDrives::Delete(const UInt32 * , UInt32 , IProgress * )
{
  return E_NOTIMPL;
}

STDMETHODIMP CFSDrives::SetProperty(UInt32 , PROPID ,
