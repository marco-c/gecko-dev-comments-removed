...
STDMETHODIMP CExtractCallbackImp::PrepareOperation(const wchar_t *name, Int32 isFolder, Int32 askExtractMode, const UInt64 * )
{
...
HRESULT CExtractCallbackImp::BeforeOpen(const wchar_t *name, bool )
{
  #ifndef _SFX
