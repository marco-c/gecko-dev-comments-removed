...
STDMETHODIMP CUpdateCallback100Imp::ScanProgress(UInt64 , UInt64 numFiles, UInt64 totalSize, const wchar_t *path, Int32 )
{
...
STDMETHODIMP CUpdateCallback100Imp::OperationResult(Int32 )
{
...
STDMETHODIMP CUpdateCallback100Imp::SetTotal(const UInt64 * , const UInt64 * )
{
  return S_OK;
}

STDMETHODIMP CUpdateCallback100Imp::SetCompleted(const UInt64 * , const UInt64 * )
{
