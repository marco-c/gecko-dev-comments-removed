...
struct CCdInfo
{
  ...
  void ParseEcd32(const Byte *p);   
  void ParseEcd64e(const Byte *p);  
...
public:
  ...
  bool NoCentralDir;
  bool Overflow32bit; 
  bool Cd_NumEntries_Overflow_16bit; 
