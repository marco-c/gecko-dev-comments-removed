...
static const char * const kResFileName = "rsrc"; 
...
static const UInt32 kMethod_Attr     = 3; 
static const UInt32 kMethod_Resource = 4; 
...
STDMETHODIMP CHandler::GetRawPropInfo(UInt32 , BSTR *name, PROPID *propID)
{
  *name = NULL;
  *propID = 0;
  return S_OK;
