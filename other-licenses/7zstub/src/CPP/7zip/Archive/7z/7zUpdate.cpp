...
static int Parse_EXE(const Byte *buf, size_t size, CFilterMode *filterMode)
{
  ...
  switch (GetUi16(p))
  {
    ...
    case 0x01C0:                            
    case 0x01C2:  filterId = k_ARM; break;  
    case 0x01C4:  filterId = k_ARMT; break; 
...
static int Parse_ELF(const Byte *buf, size_t size, CFilterMode *filterMode)
{
  ...
  switch (buf[4])
  {
    case ELF_CLASS_32:  break;
    case ELF_CLASS_64:  break;
    default: return 0;
  }
...
static unsigned Parse_MACH(const Byte *buf, size_t size, CFilterMode *filterMode)
{
  ...
  switch (GetUi32(buf))
  {
    case MACH_SIG_BE_32:  be = True; break;
    case MACH_SIG_BE_64:  be = True; break;
    case MACH_SIG_LE_32:  be = False; break;
    case MACH_SIG_LE_64:  be = False; break;
    default: return 0;
  }
...
static HRESULT MakeExeMethod(CCompressionMethodMode &mode,
    const CFilterMode &filterMode,  bool bcj2Filter)
{
        ...
        UInt64 curUnpackSize;
        {
          ...
          CMyComPtr<ISequentialInStream> inStreamSizeCount = inStreamSizeCountSpec;
          {
            ...
            if (options.MultiThreadMixer)
            {
              ...
              threadDecoder.StartPos = db->ArcInfo.DataStartPosition; 
