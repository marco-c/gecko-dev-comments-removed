...
{
  SamplePrintWordWithBreak();
  SampleFindWordBreakFromPosition(0,0);  
  SampleFindWordBreakFromPosition(1,0);  
  SampleFindWordBreakFromPosition(2,0);  
  SampleFindWordBreakFromPosition(2,1);  
  SampleFindWordBreakFromPosition(2,9);  
  SampleFindWordBreakFromPosition(2,10); 
  SampleFindWordBreakFromPosition(3,4);  
  SampleFindWordBreakFromPosition(3,8);  
  SampleFindWordBreakFromPosition(4,6);  
  SampleFindWordBreakFromPosition(4,7);  
}
