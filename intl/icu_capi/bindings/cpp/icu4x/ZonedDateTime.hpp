...
inline icu4x::ZonedDateTime icu4x::ZonedDateTime::FromFFI(icu4x::capi::ZonedDateTime c_struct) {
  return icu4x::ZonedDateTime {
     std::unique_ptr<icu4x::Date>(icu4x::Date::FromFFI(c_struct.date)),
     std::unique_ptr<icu4x::Time>(icu4x::Time::FromFFI(c_struct.time)),
     std::unique_ptr<icu4x::TimeZoneInfo>(icu4x::TimeZoneInfo::FromFFI(c_struct.zone)),
  };
}
