...
static const char16_t LOCALE_SEP  = 95; 




static const char16_t ANY[] = { 0x41, 0x6E, 0x79, 0 }; 
static const char16_t LAT[] = { 0x4C, 0x61, 0x74, 0 }; 
        ...
        if (parser.idBlockVector.isEmpty() && parser.dataVector.isEmpty()) {
            ...
            for (int32_t i = 0; i < limit; i++) {
                ...
                if (!parser.dataVector.isEmpty()) {
                    ...
                    entry->stringArg += static_cast<char16_t>(0xffff); 
                }
            }
        }
    }
...
static const char16_t TRANSLITERATE_TO[] = {84,114,97,110,115,108,105,116,101,114,97,116,101,84,111,0}; 

static const char16_t TRANSLITERATE_FROM[] = {84,114,97,110,115,108,105,116,101,114,97,116,101,70,114,111,109,0}; 

static const char16_t TRANSLITERATE[] = {84,114,97,110,115,108,105,116,101,114,97,116,101,0}; 
