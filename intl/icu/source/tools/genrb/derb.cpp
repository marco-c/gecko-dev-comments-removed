...
static UOption options[]={
    ...
    UOPTION_ENCODING,
    { "to-stdout", nullptr, nullptr, nullptr, 'c', UOPT_NO_ARG, 0 } ,
    { "truncate", nullptr, nullptr, nullptr, 't', UOPT_OPTIONAL_ARG, 0 },
    UOPTION_VERBOSE,
    UOPTION_DESTDIR,
    UOPTION_SOURCEDIR,
    { "bom", nullptr, nullptr, nullptr, 0, UOPT_NO_ARG, 0 },
    UOPTION_ICUDATADIR,
   UOPTION_VERSION,
   { "suppressAliases", nullptr, nullptr, nullptr, 'A', UOPT_NO_ARG, 0 },
};
...
static void printOutAlias(UFILE *out,  UResourceBundle *parent, Resource r, const char *key, int32_t indent, const char *pname, UErrorCode *status) {
    ...
    if(U_SUCCESS(*status)) {
        static const char16_t openStr[] = { 0x003A, 0x0061, 0x006C, 0x0069, 0x0061, 0x0073, 0x0020, 0x007B, 0x0020, 0x0022 }; 
...
static void printOutBundle(UFILE *out, UResourceBundle *resource, int32_t indent, const char *pname, UErrorCode *status)
{
    ...
    case URES_INT :
        {
            static const char16_t openStr[] = { 0x003A, 0x0069, 0x006E, 0x0074, 0x0020, 0x007B, 0x0020 }; 
    ...
    case URES_BINARY :
        {
            ...
            if(U_SUCCESS(*status)) {
                static const char16_t openStr[] = { 0x003A, 0x0062, 0x0069, 0x006E, 0x0061, 0x0072, 0x0079, 0x0020, 0x007B, 0x0020 }; 
    ...
    case URES_INT_VECTOR :
        {
            ...
            if(U_SUCCESS(*status)) {
                static const char16_t openStr[] = { 0x003A, 0x0069, 0x006E, 0x0074, 0x0076, 0x0065, 0x0063, 0x0074, 0x006F, 0x0072, 0x0020, 0x007B, 0x0020 }; 
                static const char16_t closeStr[] = { 0x0020, 0x007D, 0x0020 }; 
                char16_t num[20];
