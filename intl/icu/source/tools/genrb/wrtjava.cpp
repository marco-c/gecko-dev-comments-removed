...
static void
intvector_write_java(const IntVectorResource *res, UErrorCode * ) {
    uint32_t i = 0;
...
static void
int_write_java(const IntResource *res, UErrorCode * ) {
...
static void
bytes_write_java(const BinaryResource *res, UErrorCode * ) {
