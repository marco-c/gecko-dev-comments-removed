...
static void
string_write_xml(StringResource *res, const char* id, const char* , UErrorCode *status) {
...
static void
alias_write_xml(AliasResource *res, const char* id, const char* , UErrorCode *status) {
    char *sid = NULL;
    char* buf = NULL;
    int32_t bufLen=0;
...
static void
intvector_write_xml(IntVectorResource *res, const char* id, const char* , UErrorCode *status) {
    char* sid = NULL;
    char* ivd = NULL;
    uint32_t i=0;
    uint32_t len=0;
...
static void
int_write_xml(IntResource *res, const char* id, const char* , UErrorCode *status) {
    char* sid = NULL;
    char buf[256] = {0};
    uint32_t len = 0;
...
static void
bin_write_xml(BinaryResource *res, const char* id, const char* , UErrorCode *status) {
