...
ExtraData::ExtraData(Norms &n, UBool fast) :
        Norms::Enumerator(n),
        yesYesCompositions(1000, static_cast<UChar32>(0xffff), 2), 
        yesNoMappingsAndCompositions(1000, static_cast<UChar32>(0), 1), 
        yesNoMappingsOnly(1000, static_cast<UChar32>(0), 1), 
        optimizeFast(fast) {
