...
const char* mozilla::intl::Locale::ReplaceUnicodeExtensionType(
  ...
  if (IsUnicodeKey(key, "ca")) {
    ...
    static const char* types[40] = {
         ...
         "cathu"  ,  "cayzf"  ,  "cnckg"  ,  "cnhrb"  ,  "cnkhg"  ,   "cuba"  ,
         "egypt"  ,   "eire"  ,   "est"   ,   "gaza"  ,   "gmt0"  , "hongkong",
          "hst"   , "iceland" ,   "iran"  ,  "israel" , "jamaica" ,  "japan"  ,
         "libya"  ,   "mst"   ,  "mxstis" ,  "navajo" ,  "poland" , "portugal",
          "prc"   ,   "roc"   ,   "rok"   ,  "turkey" ,  "uaozh"  ,  "uauzh"  ,
          "uct"   ,  "umjon"  , "usnavajo",   "zulu"  ,
    };
    static const char* aliases[40] = {
         "nzakl"  ,  "auhba"  ,  "cawnp"  ,  "cator"  ,  "cator"  ,  "caiql"  ,
         "cator"  ,  "caedm"  ,  "cnsha"  ,  "cnsha"  ,  "cnurc"  ,  "cuhav"  ,
         "egcai"  ,  "iedub"  ,  "utcw05" , "gazastrp",   "gmt"   ,  "hkhkg"  ,
         "utcw10" ,  "isrey"  ,  "irthr"  , "jeruslm" ,  "jmkin"  ,  "jptyo"  ,
         "lytip"  ,  "utcw07" ,  "mxtij"  ,  "usden"  ,  "plwaw"  ,  "ptlis"  ,
         "cnsha"  ,  "twtpe"  ,  "krsel"  ,  "trist"  ,  "uaiev"  ,  "uaiev"  ,
          "utc"   ,  "ushnl"  ,  "usden"  ,   "utc"   ,
    };
    return SearchUnicodeReplacement(types, aliases, type);
  }
