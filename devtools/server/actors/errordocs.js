...
const ErrorDocs = {
  ...
  JSMSG_CANT_DEFINE_PROP_OBJECT_NOT_EXTENSIBLE: "Cant_define_property_object_not_extensible",
...
const PUBLIC_KEY_PINS_LEARN_MORE = "https://developer.mozilla.org/en-US/docs/Web/HTTP/Public_Key_Pinning";
const STRICT_TRANSPORT_SECURITY_LEARN_MORE = "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Strict-Transport-Security";
