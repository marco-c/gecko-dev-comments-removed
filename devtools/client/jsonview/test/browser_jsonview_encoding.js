...
add_task(function* () {
  ...
  for (let test of tests) {
    ...
    for (let [encoding, data] of Object.entries(test)) {
      ...
      yield testData(data, result);

      
      yield testData(data, result, ";charset=ANSI");
    }
  }
});

function* testData(data, result, params = "") {
  yield addJsonViewTab("data:application/json" + params + "," + data);
  ...
  is(text, result, "The right data has been received.");
}
