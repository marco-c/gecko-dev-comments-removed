...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
 __webpack_require__.d(__webpack_exports__, "Node", function() { return Node; });
 __webpack_require__.d(__webpack_exports__, "Parser", function() { return Parser; });
 __webpack_require__.d(__webpack_exports__, "Position", function() { return Position; });
 __webpack_require__.d(__webpack_exports__, "SourceLocation", function() { return SourceLocation; });
 __webpack_require__.d(__webpack_exports__, "TokContext", function() { return TokContext; });
 __webpack_require__.d(__webpack_exports__, "Token", function() { return Token; });
 __webpack_require__.d(__webpack_exports__, "TokenType", function() { return TokenType; });
 __webpack_require__.d(__webpack_exports__, "defaultOptions", function() { return defaultOptions; });
 __webpack_require__.d(__webpack_exports__, "getLineInfo", function() { return getLineInfo; });
 __webpack_require__.d(__webpack_exports__, "isIdentifierChar", function() { return isIdentifierChar; });
 __webpack_require__.d(__webpack_exports__, "isIdentifierStart", function() { return isIdentifierStart; });
 __webpack_require__.d(__webpack_exports__, "isNewLine", function() { return isNewLine; });
 __webpack_require__.d(__webpack_exports__, "keywordTypes", function() { return keywords$1; });
 __webpack_require__.d(__webpack_exports__, "lineBreak", function() { return lineBreak; });
 __webpack_require__.d(__webpack_exports__, "lineBreakG", function() { return lineBreakG; });
 __webpack_require__.d(__webpack_exports__, "nonASCIIwhitespace", function() { return nonASCIIwhitespace; });
 __webpack_require__.d(__webpack_exports__, "parse", function() { return parse; });
 __webpack_require__.d(__webpack_exports__, "parseExpressionAt", function() { return parseExpressionAt; });
 __webpack_require__.d(__webpack_exports__, "tokContexts", function() { return types$1; });
 __webpack_require__.d(__webpack_exports__, "tokTypes", function() { return types; });
 __webpack_require__.d(__webpack_exports__, "tokenizer", function() { return tokenizer; });
...
function prependWhiteSpace(token, lastToken, addedNewline, addedSpace, write, options, indentLevel, stack) {
  ...
  const ltt = lastToken === null || lastToken === void 0 ? void 0 : (_lastToken$type = lastToken.type) === null || _lastToken$type === void 0 ? void 0 : _lastToken$type.label; 
