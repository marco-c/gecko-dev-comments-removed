...
const { workerUtils: { WorkerDispatcher } } = __webpack_require__(28);
...
(function(module) {var root = __webpack_require__(18),
...
}.call(exports, __webpack_require__(73)(module)))

 }),

 (function(module, exports, __webpack_require__) {

(function(module) {var freeGlobal = __webpack_require__(52);
...
function (_LValParser) {
  ...
  _proto.parseConditional = function parseConditional(expr, noIn, startPos, startLoc, 
  refNeedsArrowPos) {
        ...
        while (stack.length !== 0) {
          ...
          if (_node.type === "ArrowFunctionExpression") {
            if (_node.typeParameters || !_node.returnType) {
              ...
              _node.params, true, "arrow function parameters"); 
...
var typescriptPlugin = (function (superClass) {
  return (
    ...
    function (_superClass) {
      ...
      _proto.checkReservedWord = function checkReservedWord(word, startLoc, checkKeywords, 
      isBinding) {} 
