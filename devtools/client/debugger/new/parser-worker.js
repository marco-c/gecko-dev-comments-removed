...
}.call(exports, __webpack_require__(793)(module)))
...
}.call(exports, __webpack_require__(792), __webpack_require__(120)))
...
var _chalk = __webpack_require__(1291);
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
 __webpack_require__.d(__webpack_exports__, "extractScriptTags", function() { return extractScriptTags; });
 __webpack_require__.d(__webpack_exports__, "generateWhitespace", function() { return generateWhitespace; });
 __webpack_require__.d(__webpack_exports__, "getCandidateScriptLocations", function() { return getCandidateScriptLocations; });
 __webpack_require__.d(__webpack_exports__, "parseScript", function() { return parseScript; });
 __webpack_require__.d(__webpack_exports__, "parseScripts", function() { return parseScripts; });
 __webpack_require__.d(__webpack_exports__, "parseScriptTags", function() { return parseScriptTags; });
...
function extractScriptTags(source) {
 ...
 __webpack_exports__["default"] = (parseScriptTags);
...
var _inferClassName = __webpack_require__(1294);
...
var ansiStyles = __webpack_require__(1292);
var stripAnsi = __webpack_require__(634);
var hasAnsi = __webpack_require__(636);
var supportsColor = __webpack_require__(1293);
...
function fromCallExpression(callExpression) {
  var whitelist = ["extend", "createClass"];
  var callee = callExpression.node.callee;
  if (!callee) {
    return null;
  }

  var name = t.isMemberExpression(callee) ? callee.property.name : callee.name;

  if (!whitelist.includes(name)) {
    return null;
  }

  var variable = callExpression.findParent(_p => _p.isVariableDeclarator());
  if (variable) {
    return variable.node.id.name;
  }

  var assignment = callExpression.findParent(_p => _p.isAssignmentExpression());

  if (!assignment) {
    return null;
  }

  var left = assignment.node.left;
...
function inferClassName(path) {
  ...
  var callExpression = path.findParent(_p => _p.isCallExpression());
  if (callExpression) {
    return fromCallExpression(callExpression);
  }

  var assignment = path.findParent(_p => _p.isAssignmentExpression());
  if (assignment) {
