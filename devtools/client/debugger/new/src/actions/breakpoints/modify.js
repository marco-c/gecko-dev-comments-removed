...
export function addBreakpoint(
  ...
  return async ({ dispatch, getState, sourceMaps, client }: ThunkArgs) => {
    ...
    await dispatch(loadSourceText(getSourceFromId(getState(), location.sourceId)));
    await dispatch(loadSourceText(getSourceFromId(getState(), generatedLocation.sourceId)));
