...
(function (global, factory) {
  ...
  function pageScrollX(doc) {
    ...
    return (doc.defaultView && doc.defaultView.pageXOffset) || (doc.documentElement || doc.body).scrollLeft
  }
  function pageScrollY(doc) {
    if (chrome && android) { return -(doc.body.getBoundingClientRect().top - parseInt(getComputedStyle(doc.body).marginTop)) }
    return (doc.defaultView && doc.defaultView.pageYOffset) || (doc.documentElement || doc.body).scrollTop
  }
