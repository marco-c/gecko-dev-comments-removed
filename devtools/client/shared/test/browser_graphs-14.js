...
async function testGraph(graph) {
  ...
  is(mouseDownEvents, 1, "One mousedown event should have been fired.");
  is(mouseUpEvents, 1, "One mouseup event should have been fired.");
  is(scrollEvents, 0, "No scroll event should have been fired.");
  ...
  is(mouseDownEvents, 1, "No more mousedown events should have been fired.");
  is(mouseUpEvents, 1, "No more mouseup events should have been fired.");
  is(scrollEvents, 1, "One scroll event should have been fired.");
}
