...
function testOpen() {
  openScratchpad(
    function(win) {
      ...
      is(
        win.Scratchpad.executionContext,
        win.SCRATCHPAD_CONTEXT_CONTENT,
  ...
  openScratchpad(
    function(win) {
      ...
      is(
        ...
        "Execution context loaded from state"
      );
  ...
  openScratchpad(
    function(win) {
      ...
      try {
        win.Scratchpad.importFromFile(
          ...
          function(aStatus, content) {
            ...
            is(
              ...
              "notification priority is correct"
            );
            is(
              cn.getAttribute("value"),
              "file-import-convert-failed",
              "notification value is corrent"
            );
            is(
              cn.getAttribute("type"),
              "warning",
        ...
        ok(
          false,
          "importFromFile causes exception " +
