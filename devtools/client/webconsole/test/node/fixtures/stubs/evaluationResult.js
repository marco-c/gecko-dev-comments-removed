...
rawPackets.set(`new Date(0)`, {
  ...
  "result": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj21",
      "class": "Date",
      "ownPropertyLength": 0,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj21"
  },
...
rawPackets.set(`asdf()`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj23",
    ...
    "actorID": "server0.conn0.watcher2.process2//obj23"
  },
...
rawPackets.set(`1 + @`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj24",
      "class": "SyntaxError",
      "ownPropertyLength": 4,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj24"
  },
  "exceptionMessage": "SyntaxError: illegal character U+0040",
  "exceptionDocURL": "https://developer.mozilla.org/docs/Web/JavaScript/Reference/Errors/Illegal_character?utm_source=devtools&utm_medium=firefox-console-errors&utm_campaign=default",
  "hasException": true,
  "frame": {
    "source": "debugger eval code",
    "line": 1,
...
rawPackets.set(`inspect({a: 1})`, {
  ...
  "helperResult": {
    ...
    "object": {
      "_grip": {
        "type": "object",
        "actor": "server0.conn0.watcher2.process2//obj26",
        "class": "Object",
        "ownPropertyLength": 1,
        "extensible": true,
        "frozen": false,
      ...
      "actorID": "server0.conn0.watcher2.process2//obj26"
    },
...
rawPackets.set(`longString message Error`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj29",
      "class": "Error",
      "ownPropertyLength": 4,
      "extensible": true,
      "frozen": false,
      ...
      "preview": {
        ...
        "message": {
          "_grip": {
            "type": "longString",
            "actor": "server0.conn0.watcher2.process2//longstractor30",
            "length": 110000,
          ...
          "actorID": "server0.conn0.watcher2.process2//longstractor30"
        },
    ...
    "actorID": "server0.conn0.watcher2.process2//obj29"
  },
  "exceptionMessage": {
    "_grip": {
      "type": "longString",
      "actor": "server0.conn0.watcher2.process2//longstractor31",
      "length": 110007,
    ...
    "actorID": "server0.conn0.watcher2.process2//longstractor31"
  },
  "exceptionStack": [
    {
      "filename": "debugger eval code",
...
rawPackets.set(`eval throw Symbol`, {
  ...
  "exception": {
    "type": "symbol",
    "actor": "server0.conn0.watcher2.process2//symbol39",
    "name": "potato"
  },
...
rawPackets.set(`eval throw Object`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj41",
      "class": "Object",
      "ownPropertyLength": 1,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj41"
  },
...
rawPackets.set(`eval throw Error Object`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj43",
      "class": "Error",
      "ownPropertyLength": 4,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj43"
  },
...
rawPackets.set(`eval throw Error Object with custom name`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj45",
      "class": "Error",
      "ownPropertyLength": 6,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj45"
  },
...
rawPackets.set(`eval throw Error Object with error cause`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj47",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
      ...
      "preview": {
        ...
        "cause": {
          "type": "object",
          "actor": "server0.conn0.watcher2.process2//obj48",
          "class": "SyntaxError",
          "ownPropertyLength": 4,
          "extensible": true,
          "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj47"
  },
...
rawPackets.set(`eval throw Error Object with cause chain`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj50",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
      ...
      "preview": {
        ...
        "cause": {
          "type": "object",
          "actor": "server0.conn0.watcher2.process2//obj51",
          "class": "Error",
          "ownPropertyLength": 5,
          "extensible": true,
          "frozen": false,
          ...
          "preview": {
            ...
            "cause": {
              "type": "object",
              "actor": "server0.conn0.watcher2.process2//obj52",
              "class": "Error",
              "ownPropertyLength": 5,
              "extensible": true,
              "frozen": false,
              ...
              "preview": {
                ...
                "cause": {
                  "type": "object",
                  "actor": "server0.conn0.watcher2.process2//obj53",
                  "class": "Error",
                  "ownPropertyLength": 4,
                  "extensible": true,
                  "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj50"
  },
...
rawPackets.set(`eval throw Error Object with cyclical cause chain`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj55",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
      ...
      "preview": {
        ...
        "cause": {
          "type": "object",
          "actor": "server0.conn0.watcher2.process2//obj56",
          "class": "Error",
          "ownPropertyLength": 5,
          "extensible": true,
          "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj55"
  },
...
rawPackets.set(`eval throw Error Object with falsy cause`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj58",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj58"
  },
...
rawPackets.set(`eval throw Error Object with null cause`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj60",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj60"
  },
...
rawPackets.set(`eval throw Error Object with undefined cause`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj62",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj62"
  },
...
rawPackets.set(`eval throw Error Object with number cause`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj64",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj64"
  },
...
rawPackets.set(`eval throw Error Object with string cause`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj66",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj66"
  },
...
rawPackets.set(`eval throw Error Object with object cause`, {
  ...
  "exception": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj68",
      "class": "Error",
      "ownPropertyLength": 5,
      "extensible": true,
      "frozen": false,
      ...
      "preview": {
        ...
        "cause": {
          "type": "object",
          "actor": "server0.conn0.watcher2.process2//obj69",
          "class": "Object",
          "ownPropertyLength": 2,
          "extensible": true,
          "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj68"
  },
...
rawPackets.set(`eval pending promise`, {
  ...
  "result": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj71",
      "class": "Promise",
      "ownPropertyLength": 0,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj71"
  },
  "startTime": 1572867483805,
  "timestamp": 1572867483805
});
...
rawPackets.set(`eval Promise.resolve`, {
  ...
  "result": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj73",
      "class": "Promise",
      "ownPropertyLength": 0,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj73"
  },
  "startTime": 1572867483805,
  "timestamp": 1572867483805
});
...
rawPackets.set(`eval Promise.reject`, {
  ...
  "result": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj75",
      "class": "Promise",
      "ownPropertyLength": 0,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj75"
  },
  "startTime": 1572867483805,
  "timestamp": 1572867483805
});
...
rawPackets.set(`eval resolved promise`, {
  ...
  "result": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj77",
      "class": "Promise",
      "ownPropertyLength": 0,
      "extensible": true,
      "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj77"
  },
  "startTime": 1572867483805,
  "timestamp": 1572867483805
});
...
rawPackets.set(`eval rejected promise`, {
  ...
  "result": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj79",
      "class": "Promise",
      "ownPropertyLength": 0,
      "extensible": true,
      "frozen": false,
      ...
      "preview": {
        ...
        "ownProperties": {
          ...
          "<reason>": {
            "value": {
              "type": "object",
              "actor": "server0.conn0.watcher2.process2//obj80",
              "class": "ReferenceError",
              "ownPropertyLength": 4,
              "extensible": true,
              "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj79"
  },
  "startTime": 1572867483805,
  "timestamp": 1572867483805
});
...
rawPackets.set(`eval rejected promise with Error`, {
  ...
  "result": {
    "_grip": {
      "type": "object",
      "actor": "server0.conn0.watcher2.process2//obj83",
      "class": "Promise",
      "ownPropertyLength": 0,
      "extensible": true,
      "frozen": false,
      ...
      "preview": {
        ...
        "ownProperties": {
          ...
          "<reason>": {
            "value": {
              "type": "object",
              "actor": "server0.conn0.watcher2.process2//obj84",
              "class": "Error",
              "ownPropertyLength": 5,
              "extensible": true,
              "frozen": false,
              ...
              "preview": {
                ...
                "cause": {
                  "type": "object",
                  "actor": "server0.conn0.watcher2.process2//obj85",
                  "class": "ReferenceError",
                  "ownPropertyLength": 4,
                  "extensible": true,
                  "frozen": false,
    ...
    "actorID": "server0.conn0.watcher2.process2//obj83"
  },
  "startTime": 1572867483805,
  "timestamp": 1572867483805
});
