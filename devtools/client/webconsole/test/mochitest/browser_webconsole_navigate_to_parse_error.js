...
const TEST_URI = "data:text/html;charset=utf8,Web Console navigate-to parse error test";
...
const CSP_VIOLATION_MSG = "Content Security Policy: Couldn\u2019t process unknown directive \u2018navigate-to\u2019";
