...
async def retry_download(*args, **kwargs):  
...
async def download(url, dest, mode=None):  
...
class WorkEnv(object):
    ...
    def __init__(self, mar=None, mbsdiff=None):
        ...
        self.urls = {
            'unwrap_full_update.pl': 'https://hg.mozilla.org/mozilla-central/raw-file/default/tools/update-packaging/unwrap_full_update.pl',
            'mar': 'https://ftp.mozilla.org/pub/mozilla.org/firefox/nightly/latest-mozilla-central/mar-tools/linux64/mar',
            'mbsdiff': 'https://ftp.mozilla.org/pub/mozilla.org/firefox/nightly/latest-mozilla-central/mar-tools/linux64/mbsdiff'
        }
        if mar:
            self.urls['mar'] = mar
        if mbsdiff:
