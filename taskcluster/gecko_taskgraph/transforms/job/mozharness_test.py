...
class MozharnessTestSchema(Schema, forbid_unknown_fields=False, kw_only=True):
    test_platform: str
    mozharness: TestDescriptionSchema.__annotations__["mozharness"]  
    docker_image: TestDescriptionSchema.__annotations__[
        "docker_image"  
    ]
    loopback_video: TestDescriptionSchema.__annotations__["loopback_video"]  
    loopback_audio: TestDescriptionSchema.__annotations__["loopback_audio"]  
    max_run_time: TestDescriptionSchema.__annotations__["max_run_time"]  
