...
void StaticAssertions() {
  ...
  TEST_MOZ_DBG_TYPE_SAME(x);        
  TEST_MOZ_DBG_TYPE_SAME(y);        
  TEST_MOZ_DBG_TYPE_SAME(x = 234);  
  TEST_MOZ_DBG_TYPE_SAME(y = z);    
  TEST_MOZ_DBG_TYPE_SAME(w);        
  ...
  TEST_MOZ_DBG_TYPE_SAME(std::move(y));  
  TEST_MOZ_DBG_TYPE_SAME(std::move(y));  
  TEST_MOZ_DBG_TYPE_SAME(std::move(w));  
