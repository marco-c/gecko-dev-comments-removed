...
{
#if (LZ4_HEAPMODE)
    void* ctxPtr = ALLOCATOR(1, sizeof(LZ4_stream_t));   
#else
    LZ4_stream_t ctx;
                 ...
                 const tableType_t tableType)
{
    ...
    BYTE* const oMaxLit = op + targetDstSize - 2  - 8  - 1 ;
    BYTE* const oMaxMatch = op + targetDstSize - (LASTLITERALS + 1 );
...
{
#if (LZ4_HEAPMODE)
    LZ4_stream_t* ctx = (LZ4_stream_t*)ALLOCATOR(1, sizeof(LZ4_stream_t));   
#else
