...
add_task(async function test_ensureLoggedIn() {
  ...
  let d2 = collectionKeys._compareKeyBundleCollections(coll1, coll3); 
  let d3 = collectionKeys._compareKeyBundleCollections(coll3, coll2); 
  let d4 = collectionKeys._compareKeyBundleCollections(coll1, coll4); 
  let d5 = collectionKeys._compareKeyBundleCollections(coll5, coll2); 
  let d6 = collectionKeys._compareKeyBundleCollections(coll6, coll1); 
