...
`here <https://searchfox.org/firefox-main/source/services/sync/modules/engines>`_
...
The `SyncedTabs module <https://searchfox.org/firefox-main/source/services/sync/modules/SyncedTabs.sys.mjs>`_
...
`next to the storage implementation <https://searchfox.org/firefox-main/source/toolkit/components/formautofill/FormAutofillSync.sys.mjs>`_.
