...
there's the concept of a `bridged-engine <https://searchfox.org/firefox-main/source/services/sync/modules/bridged_engine.js>`_.
In short, this is just a shim between the existing
`Sync Service <https://searchfox.org/firefox-main/source/services/sync/modules/service.js>`_
and the Rust code.
