...
_IGNORE_WARNINGS = (
    ...
    r'Warning in obj/third_party/androidx/androidx_test_espresso_espresso_core_java',  
    r'Warning in obj/third_party/androidx/androidx_test_espresso_espresso_web_java',  
