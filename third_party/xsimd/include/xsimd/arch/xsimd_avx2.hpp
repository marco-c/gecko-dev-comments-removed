    ...
    namespace kernel
    {
        ...
        namespace detail
        {
            ...
            inline batch<float, A> fast_cast(batch<uint32_t, A> const& v, batch<float, A> const&, requires_arch<avx2>) noexcept
            {
                ...
                __m256i v_lo = _mm256_and_si256(v, msk_lo); 
                __m256i v_hi = _mm256_srli_epi32(v, 16); 
                __m256 v_lo_flt = _mm256_cvtepi32_ps(v_lo); 
                __m256 v_hi_flt = _mm256_cvtepi32_ps(v_hi); 
                v_hi_flt = _mm256_mul_ps(cnst65536f, v_hi_flt); 
                return _mm256_add_ps(v_hi_flt, v_lo_flt); 
            }
            ...
            inline batch<double, A> fast_cast(batch<uint64_t, A> const& x, batch<double, A> const&, requires_arch<avx2>) noexcept
            {
                ...
                xH = _mm256_or_si256(xH, _mm256_castpd_si256(_mm256_set1_pd(19342813113834066795298816.))); 
                ...
                __m256i xL = _mm256_or_si256(_mm256_and_si256(mask, x), _mm256_andnot_si256(mask, _mm256_castpd_si256(_mm256_set1_pd(0x0010000000000000)))); 
                __m256d f = _mm256_sub_pd(_mm256_castsi256_pd(xH), _mm256_set1_pd(19342813118337666422669312.)); 
            ...
            inline batch<double, A> fast_cast(batch<int64_t, A> const& x, batch<double, A> const&, requires_arch<avx2>) noexcept
            {
                ...
                __m256i xL = _mm256_or_si256(_mm256_and_si256(mask, x), _mm256_andnot_si256(mask, _mm256_castpd_si256(_mm256_set1_pd(0x0010000000000000)))); 
                __m256d f = _mm256_sub_pd(_mm256_castsi256_pd(xH), _mm256_set1_pd(442726361368656609280.)); 
                return _mm256_add_pd(f, _mm256_castsi256_pd(xL));
            }
        }
