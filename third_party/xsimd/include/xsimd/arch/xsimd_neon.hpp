...
#undef xsimd_aligned_load
        ...
        {
            template <class A, class T>
            inline batch<T, A> extract_pair(batch<T, A> const&, batch<T, A> const& , std::size_t, ::xsimd::detail::index_sequence<>) noexcept
            {
        ...
        {
            template <class A, class T>
            inline batch<T, A> bitwise_lshift(batch<T, A> const& , int , ::xsimd::detail::int_sequence<>) noexcept
            {
        ...
        {
            template <class A, class T>
            inline batch<T, A> bitwise_rshift(batch<T, A> const& , int , ::xsimd::detail::int_sequence<>) noexcept
            {
