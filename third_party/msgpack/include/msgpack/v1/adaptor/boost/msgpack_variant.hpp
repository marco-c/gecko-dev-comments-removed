...
struct basic_variant :
    boost::variant<
        ...
        boost::recursive_wrapper<std::vector<basic_variant<STR, BIN, EXT> > >, 
        boost::recursive_wrapper<std::map<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT> > >, 
        boost::recursive_wrapper<std::multimap<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT> > >
    >,
