...
mod tests {
    ...
    fn test_raise() {
        ...
        assert!(level.raise(1).is_err()); 
        assert!(level.raise(250).is_err()); 
        assert_eq!(level.number(), 126);
    }
    ...
    fn test_raise_explicit() {
        ...
        assert!(level.raise_explicit(1).is_err()); 
        assert!(level.raise_explicit(250).is_err()); 
        assert_eq!(level.number(), 125);
    }
    ...
    fn test_lower() {
        ...
        assert_eq!(level.number(), 0);
        assert!(level.lower(1).is_err()); 
        assert!(level.lower(250).is_err()); 
        assert_eq!(level.number(), 0);
    }
