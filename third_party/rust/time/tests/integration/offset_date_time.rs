...
fn replace_ordinal() {
    ...
    assert!(datetime!(2022-049 12:00 +01).replace_ordinal(0).is_err()); 
    assert!(datetime!(2022-049 12:00 +01).replace_ordinal(366).is_err()); 
    assert!(datetime!(2022-049 12:00 +01).replace_ordinal(367).is_err()); 
}
