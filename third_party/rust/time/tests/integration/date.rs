...
fn replace_year() {
    ...
    assert!(date!(2022-02-18).replace_year(-1_000_000_000).is_err()); 
    assert!(date!(2022-02-18).replace_year(1_000_000_000).is_err()); 
...
fn replace_day() {
    ...
    assert!(date!(2022-02-18).replace_day(0).is_err()); 
    assert!(date!(2022-02-18).replace_day(30).is_err()); 
}
...
fn replace_ordinal() {
    ...
    assert!(date!(2022-049).replace_ordinal(0).is_err()); 
    assert!(date!(2022-049).replace_ordinal(366).is_err()); 
    assert!(date!(2022-049).replace_ordinal(367).is_err()); 
}
