...
fn test_identifier() {
    ...
    assert_parses("var x\u{200c};"); 
    assert_parses("_\u{200d}();"); 
    assert_parses("_\u{200d}__();"); 
    assert_parses("_\u{200d}\u{200c}();"); 
    assert_illegal_character("var \u{200c};"); 
    assert_illegal_character("x = \u{200d};"); 
