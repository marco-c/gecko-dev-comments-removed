...
const CHANCE_OFFSET_INBOUNDS: usize = 10; 
const CHANCE_SEGMENT_ON_EMPTY: usize = 10; 
const PCT_INBOUNDS: f64 = 0.995; 
            ...
            let serialized_sig_idx = match available_types.get_mut(parsed_sig_idx as usize) {
                ...
                Some((func_type, index_store)) => {
                    ...
                    new_types.push(SubType {
                        is_final: true,
                        supertype: None,
                        composite_type: CompositeType::new_func(Rc::clone(&func_type), false), 
                    });
                    new_index
                }
            };
