...
impl Draw {
    ...
    pub(crate) fn inject_validation_pass(
        ...
        let max_staging_buffer_size = 1 << 26; 
...
impl MetadataEntry {
    fn new(
        ...
        let max_limit = u32::MAX as u64 + u32::MAX as u64; 

        let vertex_or_index_limit = vertex_or_index_limit.min(max_limit);
        let vertex_or_index_limit_bit_32 = (vertex_or_index_limit >> 32) as u32; 
        let vertex_or_index_limit = vertex_or_index_limit as u32; 
