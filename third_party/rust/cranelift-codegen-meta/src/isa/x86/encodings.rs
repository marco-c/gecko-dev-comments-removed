...
pub fn define(
    ...
    insertlane_mapping.insert(8, (vec![0x66, 0x0f, 0x3a, 0x20], use_sse41)); 
    insertlane_mapping.insert(16, (vec![0x66, 0x0f, 0xc4], use_sse2)); 
    insertlane_mapping.insert(32, (vec![0x66, 0x0f, 0x3a, 0x22], use_sse41)); 
    insertlane_mapping.insert(64, (vec![0x66, 0x0f, 0x3a, 0x22], use_sse41)); 
