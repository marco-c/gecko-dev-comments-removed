...
impl<T> MidiInputConnection<T> {
    pub fn close(self) -> (MidiInput, T) {
        ...
        let device_selector = MidiInPort::GetDeviceSelector().expect("GetDeviceSelector failed"); 
...
impl MidiOutputConnection {
    pub fn close(self) -> MidiOutput {
        ...
        let device_selector = MidiOutPort::GetDeviceSelector().expect("GetDeviceSelector failed"); 
        MidiOutput {
            selector: device_selector,
        }
    }
