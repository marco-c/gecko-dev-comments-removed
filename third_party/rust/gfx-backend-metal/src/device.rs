...
const STRIDE_GRANULARITY: pso::ElemStride = 4; 
...
impl adapter::PhysicalDevice<Backend> for PhysicalDevice {
    ...
    fn limits(&self) -> hal::Limits {
        ...
        hal::Limits {
            ...
            max_per_stage_descriptor_input_attachments: pc.max_textures_per_stage as usize, 
            max_per_stage_resources: 0x100,                                                 
            ...
            max_compute_work_group_count: [16; 3], 
            max_compute_work_group_size: [64; 3],  

            max_vertex_input_attributes: 31,
            max_vertex_input_bindings: 31,
            max_vertex_input_attribute_offset: 255, 
            max_vertex_input_binding_stride: 256,   
...
impl hal::device::Device<Backend> for Device {
    ...
    unsafe fn create_graphics_pipeline<'a>(
        ...
        for (i, (vb, _)) in vertex_buffers.iter().enumerate() {
            ...
            if vb.stride != 0 {
                ...
                mtl_buffer_desc.set_stride(256); 
                mtl_buffer_desc.set_step_function(MTLVertexStepFunction::PerInstance);
    ...
    unsafe fn create_shader_module(
        ...
        let depends_on_pipeline_layout = true; 
        ...
        if self.shared.private_caps.argument_buffers {
            ...
            desc_layouts.dedup_by(|a, b| {
                if (a.binding, a.array_index) == (b.binding, b.array_index) {
                    ...
                    debug_assert_eq!(a.content, b.content); 
                    b.stages |= a.stages; 
                    true
                } else {
                    false
