...
class Weird {
  ...
  unsigned char          mClipRule;         
  unsigned char          mColorInterpolation; 
  unsigned char          mColorInterpolationFilters; 
  unsigned char          mFillRule;         
  unsigned char          mImageRendering;   
  unsigned char          mPaintOrder;       
  unsigned char          mShapeRendering;   
  unsigned char          mStrokeLinecap;    
  unsigned char          mStrokeLinejoin;   
