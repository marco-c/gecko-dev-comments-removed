...
async fn test_caller_pushed_rbp() {
    ...
    stack = stack
        ...
        .D64(0x00007400b0000000) 
        .D64(0x00007500b0000000) 
        .D64(0x00007400c0001000) 
        .D64(0x00007500b000aaaa) 
        .mark(&frame0_rbp)
        .D64(&frame1_rbp) 
        .D64(return_address) 
...
async fn test_scan_with_symbols() {
    ...
    stack = stack
        ...
        .append_repeated(0, 16) 
        .D64(0x00007400b0000000u64) 
        .D64(0x00007500b0000000u64) 
        .D64(0x00007400c0001000u64) 
        .D64(0x00007500b000aaaau64) 
        .D64(return_address) 
...
async fn test_cfi_at_4002() {
    ...
    f.raw.set_register("rbx", 0xed1b02e8cc0fc79c); 
    f.raw.set_register("r12", 0xb0118de918a4bcea); 
...
async fn test_cfi_at_4003() {
    ...
    let frame1_rsp = Label::new();
    stack = stack
        .D64(0x0e023828dffd4d81) 
        .D64(0x1d20ad8acacbe930) 
        .D64(0x319e68b49e3ace0f) 
        .D64(0x5a5beeb38de23be8) 
        .D64(0x00007400c0005510) 
        .mark(&frame1_rsp)
        .append_repeated(0, 1000);
    ...
    f.raw.set_register("rbx", 0xed1b02e8cc0fc79c); 
    f.raw.set_register("r12", 0x89d04fa804c87a43); 
    f.raw.set_register("r13", 0x5118e02cbdb24b03); 
...
async fn test_cfi_at_4004() {
    ...
    f.raw.set_register("rbx", 0xed1b02e8cc0fc79c); 
    f.raw.set_register("r12", 0x46b1b8868891b34a); 
    f.raw.set_register("r13", 0x5118e02cbdb24b03); 
...
async fn test_cfi_at_4005() {
    ...
    let frame1_rsp = Label::new();
    stack = stack
        .D64(0x4b516dd035745953) 
        .D64(0x1d20ad8acacbe930) 
        .D64(0xa6d445e16ae3d872) 
        .D64(0x5a5beeb38de23be8) 
        .D64(0xaa95fa054aedfbae) 
        .mark(&frame1_rsp)
        .append_repeated(0, 1000);
    ...
    f.raw.set_register("rbx", 0xed1b02e8cc0fc79c); 
    f.raw.set_register("r12", 0x46b1b8868891b34a); 
    f.raw.set_register("r13", 0x00007400c0005510); 
...
async fn test_cfi_at_4006() {
    ...
    let frame1_rsp = Label::new();
    stack = stack
        .D64(0x043c6dfceb91aa34) 
        .D64(0x1d20ad8acacbe930) 
        .D64(0x68995b1de4700266) 
        .mark(&frame0_rbp) 
        .D64(0x5a5beeb38de23be8) 
        .D64(0xf015ee516ad89eab) 
        .mark(&frame1_rsp)
        .append_repeated(0, 1000);
    ...
    f.raw.set_register("rbx", 0xed1b02e8cc0fc79c); 
    f.raw.set_register("r12", 0x26e007b341acfebd); 
    f.raw.set_register("r13", 0x00007400c0005510); 
