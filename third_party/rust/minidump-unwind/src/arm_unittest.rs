...
async fn test_cfi_at_4002() {
    ...
    f.raw.iregs[0] = 0xb5d55e68; 
    f.raw.iregs[1] = 0xebd134f3; 
    f.raw.iregs[2] = 0xa31e74bc; 
    f.raw.iregs[3] = 0x2dcb16b3; 
    f.raw.iregs[4] = 0xfdd35466; 
    f.raw.iregs[5] = 0xf18c946c; 
    f.raw.iregs[6] = 0xac2079e8; 
    f.raw.iregs[7] = 0xa449829f; 
    f.raw.set_register("fp", 0xbe145fc4);
