...
async fn test_frame_pointer_ptr_auth_strip() {
    ...
    stack = stack
        ...
        .D64(0xF0000000) 
        .mark(&frame0_fp) 
        .D64(&authenticated_frame1_fp) 
        .D64(authenticated_return_address1) 
        .mark(&frame1_sp)
...
async fn test_cfi_at_4001() {
    ...
    let frame1_sp = Label::new();
    stack = stack
        .D64(0x5e68b5d5b5d55e68) 
        .D64(0x34f3ebd1ebd134f3) 
        .D64(0x0000_00a2_8112_e110) 
        .D64(0x0000_0000_4000_5510) 
        .mark(&frame1_sp)
...
async fn test_cfi_at_4002() {
    ...
    f.raw.iregs[0] = 0x5e68b5d5b5d55e68; 
    f.raw.iregs[1] = 0x34f3ebd1ebd134f3; 
    f.raw.iregs[2] = 0x74bca31ea31e74bc; 
    f.raw.iregs[3] = 0x16b32dcb2dcb16b3; 
    f.raw.iregs[19] = 0xadc9f635a635adc9; 
    f.raw.iregs[20] = 0x623135ac35ac6231; 
    f.raw.iregs[21] = 0xac4543564356ac45; 
    f.raw.iregs[22] = 0x2561562f562f2561; 
    f.raw.set_register("fp", 0x5fc4be14be145fc4);
...
async fn test_cfi_at_4005_ptr_auth_strip_apple() {
    ...
    stack = stack
        ...
        .D64(0xff3dfb81fb81ff3d) 
        .D64(0x34f3ebd1ebd134f3) 
        .D64(0xae23_80a2_8112_e110) 
        .D64(0xae1d_0000_4000_5510) 
        .mark(&frame1_sp)
        .append_repeated(0, 120);
...
async fn test_cfi_at_4005_ptr_auth_strip_high() {
    ...
    stack = stack
        ...
        .D64(0xff3dfb81fb81ff3d) 
        .D64(0x34f3ebd1ebd134f3) 
        .D64(0x1003_45a2_8112_e110) 
        .D64(0x100d_f700_4000_5510) 
        .mark(&frame1_sp)
        .append_repeated(0, 120);
...
async fn test_cfi_at_4006() {
    ...
    let frame1_sp = Label::new();
    stack = stack
        .D64(0x0000000040005510) 
        .D64(0xdd5a48c848c8dd5a) 
        .D64(0xff3dfb81fb81ff3d) 
        .D64(0x34f3ebd1ebd134f3) 
        .D64(0x0000_00a2_8112_e110) 
        .D64(0xf8d157835783f8d1) 
        .mark(&frame1_sp)
        .append_repeated(0, 120);
