...
fn test_hebrew() {
    ...
    let cases: &[(&Date<Hebrew>, &Date<Hebrew>, u64, (u32, u64), (u32, u64), (u32, u32, u64))] = &[
        ...
        (&m05l_15, &m06b_15, 385, (55, 0), (13, 0),  (1, 0, 0)), 
        (&m05l_15, &m07b_20, 419, (59, 6), (14, 5),  (1, 1, 5)), 

        (&m05l_30, &m06a_29, 29,  (4, 1),  (0, 29),  (0, 0, 29)),
        (&m05l_30, &m07a_10, 39,  (5, 4),  (1, 10),  (0, 1, 10)),
        (&m05l_30, &m06b_15, 370, (52, 6), (12, 15), (0, 12, 15)), 
        (&m05l_30, &m07b_20, 404, (57, 5), (13, 20), (1, 0, 20)), 

        (&m06a_29, &m07a_10, 10,  (1, 3),  (0, 10),  (0, 0, 10)),
        (&m06a_29, &m06b_15, 341, (48, 5), (11, 16), (0, 11, 16)), 
        (&m06a_29, &m07b_20, 375, (53, 4), (12, 20), (1, 0, 20)), 
        (&m07a_10, &m06b_15, 331, (47, 2), (11, 5),  (0, 11, 5)), 
        (&m07a_10, &m07b_20, 365, (52, 1), (12, 10), (1, 0, 10)), 
