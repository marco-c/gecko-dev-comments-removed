...
impl ThreadInfoX86 {
    ...
    pub fn create_impl(_pid: Pid, tid: Pid) -> Result<Self> {
        ...
        for idx in 0..NUM_DEBUG_REGISTERS {
            ...
            #[cfg(target_arch = "x86_64")]
            {
                dregs[idx] = chunk as u64; 
            }
            #[cfg(target_arch = "x86")]
            {
                dregs[idx] = chunk as i32; 
            }
        }
    ...
    pub fn fill_cpu_context(&self, out: &mut RawContextCPU) {
        ...
        out.flt_save.tag_word = self.fpregs.ftw as u8; 
        out.flt_save.error_opcode = self.fpregs.fop;
        out.flt_save.error_offset = self.fpregs.rip as u32; 
        out.flt_save.error_selector = 0; 
        out.flt_save.data_offset = self.fpregs.rdp as u32; 
