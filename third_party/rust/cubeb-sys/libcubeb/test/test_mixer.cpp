...
float const LS = 5.0f;    
float const RS = 6.0f;    
float const RLS = 7.0f;   
float const RC = 8.0f;    
float const RRS = 9.0f;   
float const LFE = 10.0f;  

float const INV_SQRT_2 = 0.707106f; 
static float const DOWNMIX_3F2_RESULTS[2][12][5] = {
  
  {
    { INV_SQRT_2*(L+R) + C + 0.5f*(LS+RS) },                          
    { INV_SQRT_2*(L+R) + C + 0.5f*(LS+RS), 0 },                       
    { L + INV_SQRT_2*(C+LS), R + INV_SQRT_2*(C+RS) },                 
    { L + INV_SQRT_2*(C+LS), R + INV_SQRT_2*(C+RS), 0 },              
    { L + INV_SQRT_2*LS, R + INV_SQRT_2*RS, C },                      
    { L + INV_SQRT_2*LS, R + INV_SQRT_2*RS, C, 0 },                   
    { L + C*INV_SQRT_2, R + C*INV_SQRT_2, INV_SQRT_2*(LS+RS) },       
    { L + C*INV_SQRT_2, R + C*INV_SQRT_2, 0, INV_SQRT_2*(LS+RS) },    
    { L, R, C, INV_SQRT_2*(LS+RS) },                                  
    { L, R, C, 0, INV_SQRT_2*(LS+RS) },                               
    { L + INV_SQRT_2*C, R + INV_SQRT_2*C, LS, RS },                   
    { L + INV_SQRT_2*C, R + INV_SQRT_2*C, 0, LS, RS }                 
  },
  
  {
    { INV_SQRT_2*(L+R) + C + 0.5f*(LS+RS) },                          
    { INV_SQRT_2*(L+R) + C + 0.5f*(LS+RS), LFE },                     
    { L + INV_SQRT_2*(C+LS), R + INV_SQRT_2*(C+RS) },                 
    { L + INV_SQRT_2*(C+LS), R + INV_SQRT_2*(C+RS), LFE },            
    { L + INV_SQRT_2*LS, R + INV_SQRT_2*RS, C },                      
    { L + INV_SQRT_2*LS, R + INV_SQRT_2*RS, C, LFE },                 
    { L + C*INV_SQRT_2, R + C*INV_SQRT_2, INV_SQRT_2*(LS+RS) },       
    { L + C*INV_SQRT_2, R + C*INV_SQRT_2, LFE, INV_SQRT_2*(LS+RS) },  
    { L, R, C, INV_SQRT_2*(LS+RS) },                                  
    { L, R, C, LFE, INV_SQRT_2*(LS+RS) },                             
    { L + INV_SQRT_2*C, R + INV_SQRT_2*C, LS, RS },                   
    { L + INV_SQRT_2*C, R + INV_SQRT_2*C, LFE, LS, RS }               
  }
};
