...
mod test {
    ...
    fn test_timespec() {
        ...
        ts_vec.push(time::Timespec::new(10_000, 0)); 
        ts_vec.push(time::Timespec::new(10_000, 1000)); 
        ts_vec.push(time::Timespec::new(1_500_391_124, 1_000_000)); 
        ts_vec.push(time::Timespec::new(2_000_000_000, 2_000_000)); 
        ts_vec.push(time::Timespec::new(3_000_000_000, 999_999_999)); 
        ts_vec.push(time::Timespec::new(10_000_000_000, 0)); 
