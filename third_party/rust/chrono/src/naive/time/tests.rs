...
fn test_time_from_hms_milli() {
    ...
    assert_eq!(NaiveTime::from_hms_milli_opt(3, 5, 59, 5_000), None); 
...
fn test_time_from_hms_micro() {
    ...
    assert_eq!(NaiveTime::from_hms_micro_opt(3, 5, 59, 5_000_000), None); 
...
fn test_time_add() {
    ...
    check!(hmsm(3, 5, 59, 900), TimeDelta::try_seconds(86399).unwrap(), hmsm(3, 5, 58, 900)); 
