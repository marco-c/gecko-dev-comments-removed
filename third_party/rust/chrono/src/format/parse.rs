...
mod tests {
    ...
    fn test_parse_numeric() {
        ...
        check("0x12", &[num(Year)], Err(TOO_LONG)); 
        ...
        check("  −42195", &[Space("  "), num(Year)], Err(INVALID)); 
        check("  +42195", &[Space("  "), num(Year)], parsed!(year: 42195));
    ...
    fn test_parse_fixed() {
        ...
        check("April", &[fixed(ShortMonthName)], Err(TOO_LONG)); 
        ...
        check("Apri", &[fixed(LongMonthName)], Err(TOO_LONG)); 
        ...
        check("April", &[fixed(LongMonthName), Literal("il")], Err(TOO_SHORT)); 
        check("thu", &[fixed(ShortWeekdayName)], parsed!(weekday: Weekday::Thu));
        check("Thu", &[fixed(ShortWeekdayName)], parsed!(weekday: Weekday::Thu));
        check("THU", &[fixed(ShortWeekdayName)], parsed!(weekday: Weekday::Thu));
        check("tHu", &[fixed(ShortWeekdayName)], parsed!(weekday: Weekday::Thu));
        check("Thursday", &[fixed(ShortWeekdayName)], Err(TOO_LONG)); 
        ...
        check("Thur", &[fixed(LongWeekdayName)], Err(TOO_LONG)); 
        check("Thurs", &[fixed(LongWeekdayName)], Err(TOO_LONG)); 
        ...
        check("Thursday", &[fixed(LongWeekdayName), Literal("rsday")], Err(TOO_SHORT)); 
        ...
        check("A.M.", &[fixed(LowerAmPm)], Err(INVALID));
        check("ame", &[fixed(LowerAmPm)], Err(TOO_LONG)); 
    ...
    fn test_parse_fixed_nanosecond() {
        ...
        check("", &[fixed(Nanosecond)], parsed!()); 
        check(".", &[fixed(Nanosecond)], Err(TOO_SHORT));
        check("4", &[fixed(Nanosecond)], Err(TOO_LONG)); 
        ...
        check("", &[fixed(Nanosecond3)], parsed!()); 
        check("4", &[fixed(Nanosecond3)], Err(TOO_LONG)); 
        ...
        check("", &[fixed(Nanosecond6)], parsed!()); 
        check("4", &[fixed(Nanosecond6)], Err(TOO_LONG)); 
        ...
        check("", &[fixed(Nanosecond9)], parsed!()); 
        check("4", &[fixed(Nanosecond9)], Err(TOO_LONG)); 
    ...
    fn test_parse_fixed_timezone_offset() {
        ...
        check("cest", &[fixed(TimezoneName)], parsed!()); 
        check("XXXXXXXX", &[fixed(TimezoneName)], parsed!()); 
        check("!!!!", &[fixed(TimezoneName)], parsed!()); 
    ...
    fn test_rfc2822() {
        ...
        let testdates = [
            ("Tue, 20 Jan 2015 17:35:20 -0800", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 20, 0, -8))), 
            ("Fri,  2 Jan 2015 17:35:20 -0800", Ok(ymd_hmsn(2015, 1, 2, 17, 35, 20, 0, -8))), 
            ("Fri, 02 Jan 2015 17:35:20 -0800", Ok(ymd_hmsn(2015, 1, 2, 17, 35, 20, 0, -8))), 
            ("Tue, 20 Jan 2015 17:35:20 -0800 (UTC)", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 20, 0, -8))), 
            (
            ...
            ("20 Jan 2015 17:35:20 -0800", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 20, 0, -8))), 
            ("20 JAN 2015 17:35:20 -0800", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 20, 0, -8))), 
            ("Tue, 20 Jan 2015 17:35 -0800", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 0, 0, -8))), 
            ...
            ("Tue, 20 Jan 2015 17:35:20 -0890", Err(OUT_OF_RANGE)), 
            ("Tue, 20 Jan 2015 17:35:20Z", Err(INVALID)),           
            ("Tue, 20 Jan 2015 17:35:20 Zulu", Err(INVALID)),       
            ("Tue, 20 Jan 2015 17:35:20 ZULU", Err(INVALID)),       
            ("Tue, 20 Jan 2015 17:35:20 −0800", Err(INVALID)), 
            ("Tue, 20 Jan 2015 17:35:20 0800", Err(INVALID)),  
            ("Tue, 20 Jan 2015 17:35:20 HAS", Err(INVALID)),   
            ("Tue, 20 Jan 2015😈17:35:20 -0800", Err(INVALID)), 
        ];
        ...
        for &(date, checkdate) in testdates.iter() {
            ...
            let dt = rfc2822_to_datetime(date); 
            if dt != checkdate {
    ...
    fn test_rfc3339() {
        ...
        let testdates = [
            ("2015-01-20T17:35:20-08:00", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 20, 0, -8))), 
            ("2015-01-20T17:35:20−08:00", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 20, 0, -8))), 
            ("1944-06-06T04:04:00Z", Ok(ymd_hmsn(1944, 6, 6, 4, 4, 0, 0, 0))),           
            ...
            ("2015-01-20 17:35:20-08:00", Ok(ymd_hmsn(2015, 1, 20, 17, 35, 20, 0, -8))), 
            ("2015/01/20T17:35:20.001-08:00", Err(INVALID)), 
            ("2015-01-20T17-35-20.001-08:00", Err(INVALID)), 
            ("-01-20T17:35:20-08:00", Err(INVALID)),         
            ("99-01-20T17:35:20-08:00", Err(INVALID)),       
            ...
            ("2015-01-20T17:35:2008:00", Err(INVALID)),      
            ("2015-01-20T17:35:20 08:00", Err(INVALID)),     
            ("2015-01-20T17:35:20Zulu", Err(TOO_LONG)),      
            ("2015-01-20T17:35:20 Zulu", Err(INVALID)),      
            ("2015-01-20T17:35:20GMT", Err(INVALID)),        
            ("2015-01-20T17:35:20 GMT", Err(INVALID)),       
            ("2015-01-20T17:35:20+GMT", Err(INVALID)),       
            ("2015-01-20T17:35:20++08:00", Err(INVALID)),    
            ("2015-01-20T17:35:20--08:00", Err(INVALID)),    
            ("2015-01-20T17:35:20−−08:00", Err(INVALID)), 
            ...
            ("2015-01-20T17:35:20-08:0", Err(TOO_SHORT)), 
            ("2015-01-20T17:35:20-08:AA", Err(INVALID)),  
            ("2015-01-20T17:35:20-08:ZZ", Err(INVALID)),  
            ("2015-01-20T17:35:20.001-08 : 00", Err(INVALID)), 
