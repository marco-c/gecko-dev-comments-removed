...
fn signed_duration_since_autoref() {
    ...
    let diff1 = dt1.signed_duration_since(dt2); 
...
fn test_parse_datetime_utc() {
    ...
    let invalid = [
        ...
        "+1441497364",                                               
        "+1441497364Z",                                              
        "2014/02/03 04:05:06Z",                                      
        "2001-02-03T04:05:0600:00", 
        "2015-15-15T15:15:15Z",     
        "2012-12-12T12:12:12x",     
        "2012-123-12T12:12:12Z",    
        "2012-12-77T12:12:12Z",     
        "2012-12-12T26:12:12Z",     
        "2012-12-12T12:61:12Z",     
        "2012-12-12T12:12:62Z",     
        "2012-12-12 T12:12:12Z",    
        "2012-12-12T12:12:12ZZ",    
        "+802701-12-12T12:12:12Z",  
        "+ 2012-12-12T12:12:12Z",   
        "  +82701  -  05  -  6  T  15  :  9  : 60.898989898989   Z", 
    ];
    for &s in &invalid {
...
fn test_parse_from_str() {
    ...
    assert!(DateTime::parse_from_str("20140507000000", "%Y%m%d%H%M%S").is_err()); 
    assert!(
