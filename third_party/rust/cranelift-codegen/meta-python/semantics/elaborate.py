...
try:
    from typing import TYPE_CHECKING, Dict, Union, List, Set, Tuple 
    from cdsl.xform import XForm 
    from cdsl.ast import Def, VarAtomMap 
...
def find_matching_xform(d):
    ...
    """
    res = []  
    typing = {v:   v.get_typevar() for v in d.vars()}  
