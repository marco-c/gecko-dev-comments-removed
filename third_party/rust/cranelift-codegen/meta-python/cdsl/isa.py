...
try:
    from typing import Tuple, Union, Any, Iterable, Sequence, List, Set, Dict, TYPE_CHECKING  
    if TYPE_CHECKING:
        from .instructions import MaybeBoundInst, InstructionFormat  
        from .predicates import PredNode, PredKey  
        from .settings import SettingGroup  
        from .registers import RegBank  
        from .xform import XFormGroup  
...
class CPUMode(object):
    ...
    def __init__(self, name, isa):
        ...
        self.default_legalize = None  
        self.type_legalize = OrderedDict()  
