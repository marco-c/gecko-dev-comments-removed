...
try:
    from typing import Dict, TYPE_CHECKING, Union, Tuple, Optional, Set 
    from typing import Iterable, List, Any, TypeVar as MTypeVar 
...
class TypeConstraint(object):
    ...
    def __eq__(self, other):
        ...
        assert isinstance(other, TypeConstraint)  
