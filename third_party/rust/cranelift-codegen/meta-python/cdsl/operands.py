...
try:
    ...
    if TYPE_CHECKING:
        from .ast import Enumerator, ConstantInt, ConstantBits, Literal  
except ImportError:
    pass
...
class ImmediateKind(OperandKind):
    ...
    def possible_values(self):
        ...
        from cdsl.ast import Enumerator 
