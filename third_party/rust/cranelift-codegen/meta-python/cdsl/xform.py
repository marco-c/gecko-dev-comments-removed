...
try:
    from typing import Union, Iterator, Sequence, Iterable, List, Dict  
    from typing import Optional, Set 
    from .ast import Expr, VarAtomMap  
    from .isa import TargetISA  
    from .typevar import TypeVar  
    from .instructions import ConstrList, Instruction 
