...
try:
    from typing import Union, Tuple, Sequence, TYPE_CHECKING, Dict, List  
    from typing import Optional, Set, Any 
    if TYPE_CHECKING:
        from .operands import ImmediateKind  
        from .predicates import PredNode  
...
def replace_var(arg, m):
    ...
    if isinstance(arg, Var):
        new_arg = m.get(arg, Var(arg.name))  
        m[arg] = new_arg
        return new_arg
    return arg
