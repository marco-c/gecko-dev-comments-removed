...
try:
    from typing import Sequence, Set, Tuple, List, Dict, Iterable, DefaultDict, TYPE_CHECKING  
    if TYPE_CHECKING:
        from cdsl.isa import TargetISA, OperandConstraint, Encoding, CPUMode, EncRecipe, RecipePred  
        from cdsl.predicates import PredNode, PredLeaf  
        from cdsl.types import ValueType  
        from cdsl.instructions import Instruction  
        from cdsl.xform import XFormGroup  
except ImportError:
    pass
