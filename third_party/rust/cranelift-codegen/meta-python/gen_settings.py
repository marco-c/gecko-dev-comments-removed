...
try:
    from typing import Sequence, Set, Tuple, List, Union, TYPE_CHECKING  
    if TYPE_CHECKING:
        from cdsl.isa import TargetISA  
        from cdsl.settings import Setting, Preset, SettingGroup  
        from cdsl.predicates import Predicate, PredContext  
except ImportError:
    pass
