...
fn test_x64_emit() {
    ...
    insns.push((
        Inst::div(4, true , RegMem::reg(regs::rsi())),
        "F7FE",
        "idiv    %esi",
    ));
    insns.push((
        Inst::div(8, true , RegMem::reg(regs::r15())),
        "49F7FF",
        "idiv    %r15",
    ));
    insns.push((
        Inst::div(4, false , RegMem::reg(regs::r14())),
        "41F7F6",
        "div     %r14d",
    ));
    insns.push((
        Inst::div(8, false , RegMem::reg(regs::rdi())),
        "48F7F7",
        "div     %rdi",
    ));
    ...
    insns.push((
        Inst::mul_hi(4, true , RegMem::reg(regs::rsi())),
        "F7EE",
        "imul    %esi",
    ));
    insns.push((
        Inst::mul_hi(8, true , RegMem::reg(regs::r15())),
        "49F7EF",
        "imul    %r15",
    ));
    insns.push((
        Inst::mul_hi(4, false , RegMem::reg(regs::r14())),
        "41F7E6",
        "mul     %r14d",
    ));
    insns.push((
        Inst::mul_hi(8, false , RegMem::reg(regs::rdi())),
        "48F7E7",
        "mul     %rdi",
    ));
