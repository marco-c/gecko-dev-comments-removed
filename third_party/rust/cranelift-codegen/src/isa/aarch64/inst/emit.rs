    ...
    fn emit(&self, sink: &mut MachBuffer<Inst>, emit_info: &Self::Info, state: &mut EmitState) {
        ...
        match self {
            ...
            &Inst::AtomicRMW { ty, op } => {
                ...
                sink.put4(enc_ldxr(ty, x27wr, x25)); 
                ...
                sink.put4(enc_stxr(ty, x24wr, x28, x25)); 
            ...
            &Inst::AtomicLoad { ty, r_data, r_addr } => {
                ...
                let uimm12scaled_zero = UImm12Scaled::zero(I8 );
            ...
            &Inst::FpuMove64 { rd, rn } => {
                sink.put4(enc_vecmov( false, rd, rn));
            }
            &Inst::FpuMove128 { rd, rn } => {
                sink.put4(enc_vecmov( true, rd, rn));
            }
            ...
            &Inst::VecCSel { rd, rn, rm, cond } => {
                ...
                sink.put4(enc_vecmov( true, rd, rm));
            ...
            &Inst::Extend {
                ...
                let top22 = match (signed, from_bits, to_bits) {
                    (false, 8, 32) => 0b010_100110_0_000000_000111, 
                    (false, 16, 32) => 0b010_100110_0_000000_001111, 
                    (true, 8, 32) => 0b000_100110_0_000000_000111,  
                    (true, 16, 32) => 0b000_100110_0_000000_001111, 
                    
                    
                    (false, 8, 64) => 0b010_100110_0_000000_000111, 
                    (false, 16, 64) => 0b010_100110_0_000000_001111, 
                    (true, 8, 64) => 0b100_100110_1_000000_000111,  
                    (true, 16, 64) => 0b100_100110_1_000000_001111, 
                    
                    (false, 32, 64) => 0,                           
                    (true, 32, 64) => 0b100_100110_1_000000_011111, 
                    _ => panic!(
