...
fn enc_vrr(opcode: u16, v1: Reg, v2: Reg, v3: Reg, m4: u8, m5: u8, m6: u8) -> [u8; 6] {
    ...
    let opcode2 = (opcode & 0xff) as u8;
    let rxb = 0; 
    let v1 = machreg_to_fpr(v1) & 0x0f; 
    let v2 = machreg_to_fpr(v2) & 0x0f; 
    let v3 = machreg_to_fpr(v3) & 0x0f; 
    let m4 = m4 & 0x0f;
    let m5 = m5 & 0x0f;
    let m6 = m6 & 0x0f;
        ...
        match self {
            &Inst::AluRRR { alu_op, rd, rn, rm } => {
                let (opcode, have_rr) = match alu_op {
                    ALUOp::Add32 => (0xb9f8, true),     
                    ALUOp::Add64 => (0xb9e8, true),     
                    ALUOp::Sub32 => (0xb9f9, true),     
                    ALUOp::Sub64 => (0xb9e9, true),     
                    ALUOp::Mul32 => (0xb9fd, true),     
                    ALUOp::Mul64 => (0xb9ed, true),     
                    ALUOp::And32 => (0xb9f4, true),     
                    ALUOp::And64 => (0xb9e4, true),     
                    ALUOp::Orr32 => (0xb9f6, true),     
                    ALUOp::Orr64 => (0xb9e6, true),     
                    ALUOp::Xor32 => (0xb9f7, true),     
                    ALUOp::Xor64 => (0xb9e7, true),     
                    ALUOp::AndNot32 => (0xb974, false), 
                    ALUOp::AndNot64 => (0xb964, false), 
                    ALUOp::OrrNot32 => (0xb976, false), 
                    ALUOp::OrrNot64 => (0xb966, false), 
                    ALUOp::XorNot32 => (0xb977, false), 
                    ALUOp::XorNot64 => (0xb967, false), 
                    _ => unreachable!(),
                };
            ...
            &Inst::AluRR { alu_op, rd, rm } => {
                let (opcode, is_rre) = match alu_op {
                    ALUOp::Add32 => (0x1a, false),       
                    ALUOp::Add64 => (0xb908, true),      
                    ALUOp::Add64Ext32 => (0xb918, true), 
                    ALUOp::Sub32 => (0x1b, false),       
                    ALUOp::Sub64 => (0xb909, true),      
                    ALUOp::Sub64Ext32 => (0xb919, true), 
                    ALUOp::Mul32 => (0xb252, true),      
                    ALUOp::Mul64 => (0xb90c, true),      
                    ALUOp::Mul64Ext32 => (0xb91c, true), 
                    ALUOp::And32 => (0x14, false),       
                    ALUOp::And64 => (0xb980, true),      
                    ALUOp::Orr32 => (0x16, false),       
                    ALUOp::Orr64 => (0xb981, true),      
                    ALUOp::Xor32 => (0x17, false),       
                    ALUOp::Xor64 => (0xb982, true),      
                    _ => unreachable!(),
                };
                if is_rre {
            ...
            &Inst::AluRX {
                ...
                let (opcode_rx, opcode_rxy) = match alu_op {
                    ALUOp::Add32 => (Some(0x5a), Some(0xe35a)),      
                    ALUOp::Add32Ext16 => (Some(0x4a), Some(0xe34a)), 
                    ALUOp::Add64 => (None, Some(0xe308)),            
                    ALUOp::Add64Ext16 => (None, Some(0xe338)),       
                    ALUOp::Add64Ext32 => (None, Some(0xe318)),       
                    ALUOp::Sub32 => (Some(0x5b), Some(0xe35b)),      
                    ALUOp::Sub32Ext16 => (Some(0x4b), Some(0xe37b)), 
                    ALUOp::Sub64 => (None, Some(0xe309)),            
                    ALUOp::Sub64Ext16 => (None, Some(0xe339)),       
                    ALUOp::Sub64Ext32 => (None, Some(0xe319)),       
                    ALUOp::Mul32 => (Some(0x71), Some(0xe351)),      
                    ALUOp::Mul32Ext16 => (Some(0x4c), Some(0xe37c)), 
                    ALUOp::Mul64 => (None, Some(0xe30c)),            
                    ALUOp::Mul64Ext16 => (None, Some(0xe33c)),       
                    ALUOp::Mul64Ext32 => (None, Some(0xe31c)),       
                    ALUOp::And32 => (Some(0x54), Some(0xe354)),      
                    ALUOp::And64 => (None, Some(0xe380)),            
                    ALUOp::Orr32 => (Some(0x56), Some(0xe356)),      
                    ALUOp::Orr64 => (None, Some(0xe381)),            
                    ALUOp::Xor32 => (Some(0x57), Some(0xe357)),      
                    ALUOp::Xor64 => (None, Some(0xe382)),            
                    _ => unreachable!(),
                };
                let rd = rd.to_reg();
                mem_emit(
            ...
            &Inst::ShiftRR {
                ...
                let opcode = match shift_op {
                    ShiftOp::RotL32 => 0xeb1d, 
                    ShiftOp::RotL64 => 0xeb1c, 
                    ShiftOp::LShL32 => 0xebdf, 
                    ShiftOp::LShL64 => 0xeb0d, 
                    ShiftOp::LShR32 => 0xebde, 
                    ShiftOp::LShR64 => 0xeb0c, 
                    ShiftOp::AShR32 => 0xebdc, 
                    ShiftOp::AShR64 => 0xeb0a, 
                };
            ...
            &Inst::CmpRR { op, rn, rm } => {
                let (opcode, is_rre) = match op {
                    CmpOp::CmpS32 => (0x19, false),       
                    CmpOp::CmpS64 => (0xb920, true),      
                    CmpOp::CmpS64Ext32 => (0xb930, true), 
                    CmpOp::CmpL32 => (0x15, false),       
                    CmpOp::CmpL64 => (0xb921, true),      
                    CmpOp::CmpL64Ext32 => (0xb931, true), 
                    _ => unreachable!(),
                };
                if is_rre {
            ...
            &Inst::CmpRX { op, rn, ref mem } => {
                let (opcode_rx, opcode_rxy, opcode_ril) = match op {
                    CmpOp::CmpS32 => (Some(0x59), Some(0xe359), Some(0xc6d)), 
                    CmpOp::CmpS32Ext16 => (Some(0x49), Some(0xe379), Some(0xc65)), 
                    CmpOp::CmpS64 => (None, Some(0xe320), Some(0xc68)),       
                    CmpOp::CmpS64Ext16 => (None, Some(0xe334), Some(0xc64)),  
                    CmpOp::CmpS64Ext32 => (None, Some(0xe330), Some(0xc6c)),  
                    CmpOp::CmpL32 => (Some(0x55), Some(0xe355), Some(0xc6f)), 
                    CmpOp::CmpL32Ext16 => (None, None, Some(0xc67)),          
                    CmpOp::CmpL64 => (None, Some(0xe321), Some(0xc6a)),       
                    CmpOp::CmpL64Ext16 => (None, None, Some(0xc66)),          
                    CmpOp::CmpL64Ext32 => (None, Some(0xe331), Some(0xc6e)),  
                };
                mem_emit(
            ...
            | &Inst::FpuLoad64 { rd, ref mem } => {
                let (opcode_rx, opcode_rxy, opcode_ril) = match self {
                    ...
                    &Inst::Load32ZExt8 { .. } => (None, Some(0xe394), None),         
                    &Inst::Load32SExt8 { .. } => (None, Some(0xe376), None),         
                    &Inst::Load32ZExt16 { .. } => (None, Some(0xe395), Some(0xc42)), 
                    &Inst::Load32SExt16 { .. } => (Some(0x48), Some(0xe378), Some(0xc45)), 
                    &Inst::Load64 { .. } => (None, Some(0xe304), Some(0xc48)), 
                    &Inst::Load64ZExt8 { .. } => (None, Some(0xe390), None),   
                    &Inst::Load64SExt8 { .. } => (None, Some(0xe377), None),   
                    &Inst::Load64ZExt16 { .. } => (None, Some(0xe391), Some(0xc46)), 
                    &Inst::Load64SExt16 { .. } => (None, Some(0xe315), Some(0xc44)), 
                    &Inst::Load64ZExt32 { .. } => (None, Some(0xe316), Some(0xc4e)), 
                    &Inst::Load64SExt32 { .. } => (None, Some(0xe314), Some(0xc4c)), 
                    &Inst::LoadRev16 { .. } => (None, Some(0xe31f), None),     
                    &Inst::LoadRev32 { .. } => (None, Some(0xe31e), None),     
                    &Inst::LoadRev64 { .. } => (None, Some(0xe30f), None),     
                    &Inst::FpuLoad32 { .. } => (Some(0x78), Some(0xed64), None), 
                    &Inst::FpuLoad64 { .. } => (Some(0x68), Some(0xed65), None), 
                    _ => unreachable!(),
                };
                let rd = rd.to_reg();
                mem_emit(
            ...
            &Inst::FpuLoadRev32 { rd, ref mem } | &Inst::FpuLoadRev64 { rd, ref mem } => {
                let opcode = match self {
                    &Inst::FpuLoadRev32 { .. } => 0xe603, 
                    &Inst::FpuLoadRev64 { .. } => 0xe602, 
                    _ => unreachable!(),
                };
            ...
            | &Inst::FpuStore64 { rd, ref mem } => {
                let (opcode_rx, opcode_rxy, opcode_ril) = match self {
                    &Inst::Store8 { .. } => (Some(0x42), Some(0xe372), None), 
                    &Inst::Store16 { .. } => (Some(0x40), Some(0xe370), Some(0xc47)), 
                    &Inst::Store32 { .. } => (Some(0x50), Some(0xe350), Some(0xc4f)), 
                    &Inst::Store64 { .. } => (None, Some(0xe324), Some(0xc4b)),       
                    &Inst::StoreRev16 { .. } => (None, Some(0xe33f), None),           
                    &Inst::StoreRev32 { .. } => (None, Some(0xe33e), None),           
                    &Inst::StoreRev64 { .. } => (None, Some(0xe32f), None),           
                    &Inst::FpuStore32 { .. } => (Some(0x70), Some(0xed66), None),     
                    &Inst::FpuStore64 { .. } => (Some(0x60), Some(0xed67), None),     
                    _ => unreachable!(),
                };
                mem_emit(
                    rd, mem, opcode_rx, opcode_rxy, opcode_ril, true, sink, emit_info, state,
            ...
            | &Inst::StoreImm64SExt16 { imm, ref mem } => {
                let opcode = match self {
                    &Inst::StoreImm16 { .. } => 0xe544,       
                    &Inst::StoreImm32SExt16 { .. } => 0xe54c, 
                    &Inst::StoreImm64SExt16 { .. } => 0xe548, 
                    _ => unreachable!(),
                };
            ...
            &Inst::FpuStoreRev32 { rd, ref mem } | &Inst::FpuStoreRev64 { rd, ref mem } => {
                let opcode = match self {
                    &Inst::FpuStoreRev32 { .. } => 0xe60b, 
                    &Inst::FpuStoreRev64 { .. } => 0xe60a, 
                    _ => unreachable!(),
                };
            ...
            &Inst::LoadAddr { rd, ref mem } => {
                let opcode_rx = Some(0x41); 
                let opcode_rxy = Some(0xe371); 
                let opcode_ril = Some(0xc00); 
                let rd = rd.to_reg();
                mem_emit(
            ...
            &Inst::FpuRR { fpu_op, rd, rn } => {
                let opcode = match fpu_op {
                    ...
                    FPUOp1::Neg32 => 0xb303,     
                    FPUOp1::Neg64 => 0xb313,     
                    FPUOp1::NegAbs32 => 0xb301,  
                    FPUOp1::NegAbs64 => 0xb311,  
                    FPUOp1::Sqrt32 => 0xb314,    
                    FPUOp1::Sqrt64 => 0xb315,    
                    FPUOp1::Cvt32To64 => 0xb304, 
                    FPUOp1::Cvt64To32 => 0xb344, 
                };
                put(sink, &enc_rre(opcode, rd.to_reg(), rn));
            }
            ...
            &Inst::FpuRRRR { fpu_op, rd, rn, rm } => {
                let opcode = match fpu_op {
                    FPUOp3::MAdd32 => 0xb30e, 
                    FPUOp3::MAdd64 => 0xb31e, 
                    FPUOp3::MSub32 => 0xb30f, 
                    FPUOp3::MSub64 => 0xb31f, 
                };
                put(sink, &enc_rrd(opcode, rd.to_reg(), rm, rn));
            }
            &Inst::FpuToInt { op, rd, rn } => {
                let opcode = match op {
                    FpuToIntOp::F32ToI32 => 0xb398, 
                    FpuToIntOp::F32ToU32 => 0xb39c, 
                    FpuToIntOp::F32ToI64 => 0xb3a8, 
                    FpuToIntOp::F32ToU64 => 0xb3ac, 
                    FpuToIntOp::F64ToI32 => 0xb399, 
                    FpuToIntOp::F64ToU32 => 0xb39d, 
                    FpuToIntOp::F64ToI64 => 0xb3a9, 
                    FpuToIntOp::F64ToU64 => 0xb3ad, 
                };
                put(sink, &enc_rrf_cde(opcode, rd.to_reg(), rn, 5, 0));
            }
            &Inst::IntToFpu { op, rd, rn } => {
                let opcode = match op {
                    IntToFpuOp::I32ToF32 => 0xb394, 
                    IntToFpuOp::U32ToF32 => 0xb390, 
                    IntToFpuOp::I64ToF32 => 0xb3a4, 
                    IntToFpuOp::U64ToF32 => 0xb3a0, 
                    IntToFpuOp::I32ToF64 => 0xb395, 
                    IntToFpuOp::U32ToF64 => 0xb391, 
                    IntToFpuOp::I64ToF64 => 0xb3a5, 
                    IntToFpuOp::U64ToF64 => 0xb3a1, 
                };
                put(sink, &enc_rrf_cde(opcode, rd.to_reg(), rn, 0, 0));
            }
            &Inst::FpuRound { op, rd, rn } => {
                let (opcode, m3) = match op {
                    FpuRoundMode::Minus32 => (0xb357, 7),   
                    FpuRoundMode::Minus64 => (0xb35f, 7),   
                    FpuRoundMode::Plus32 => (0xb357, 6),    
                    FpuRoundMode::Plus64 => (0xb35f, 6),    
                    FpuRoundMode::Zero32 => (0xb357, 5),    
                    FpuRoundMode::Zero64 => (0xb35f, 5),    
                    FpuRoundMode::Nearest32 => (0xb357, 4), 
                    FpuRoundMode::Nearest64 => (0xb35f, 4), 
                };
                put(sink, &enc_rrf_cde(opcode, rd.to_reg(), rn, m3, 0));
            }
            &Inst::FpuVecRRR { fpu_op, rd, rn, rm } => {
                let (opcode, m4) = match fpu_op {
                    FPUOp2::Max32 => (0xe7ef, 2), 
                    FPUOp2::Max64 => (0xe7ef, 3), 
                    FPUOp2::Min32 => (0xe7ee, 2), 
                    FPUOp2::Min64 => (0xe7ee, 3), 
                    _ => unimplemented!(),
                };
