...
impl FrameHeader {
    ...
    pub fn is444(&self) -> bool {
        self.hshift(0) == 0 && self.vshift(0) == 0 &&  
        self.hshift(2) == 0 && self.vshift(2) == 0 &&  
        self.hshift(1) == 0 && self.vshift(1) == 0 
    }
    pub fn is420(&self) -> bool {
        self.hshift(0) == 1 && self.vshift(0) == 1 &&  
        self.hshift(2) == 1 && self.vshift(2) == 1 &&  
        self.hshift(1) == 0 && self.vshift(1) == 0 
    }
    pub fn is422(&self) -> bool {
        self.hshift(0) == 1 && self.vshift(0) == 0 &&  
        self.hshift(2) == 1 && self.vshift(2) == 0 &&  
        self.hshift(1) == 0 && self.vshift(1) == 0 
    }
    pub fn is440(&self) -> bool {
        self.hshift(0) == 0 && self.vshift(0) == 1 &&  
        self.hshift(2) == 0 && self.vshift(2) == 1 &&  
        self.hshift(1) == 0 && self.vshift(1) == 0 
    }
