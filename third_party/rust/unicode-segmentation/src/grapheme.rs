...
fn check_pair(before: GraphemeCat, after: GraphemeCat) -> PairResult {
    ...
    match (before, after) {
        ...
        (GC_E_Base, GC_E_Modifier) => NotBreak,  
        (GC_E_Base_GAZ, GC_E_Modifier) => NotBreak,  
        (GC_Extend, GC_E_Modifier) => Emoji,  
        (GC_ZWJ, GC_Glue_After_Zwj) => NotBreak,  
        (GC_ZWJ, GC_E_Base_GAZ) => NotBreak,  
