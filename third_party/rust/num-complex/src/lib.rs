...
pub(crate) mod test {
    ...
    pub(crate) mod float {
        ...
        fn test_exp() {
            ...
            assert!(close_naninf(_neginf_infi.exp(), _0_0i)); 
            assert!(close_naninf(_inf_infi.exp(), _inf_nani)); 
            assert!(close_naninf(_neginf_nani.exp(), _0_0i)); 
            assert!(close_naninf(_inf_nani.exp(), _inf_nani)); 
