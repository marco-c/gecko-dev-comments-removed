    ...
    fn enumerate_adapters(&self) -> Vec<adapter::Adapter<Backend>> {
            ...
            dxgi::get_adapter(idx, self.factory.as_raw(), self.dxgi_version)
        {
            ...
            let limits = hal::Limits {
                ...
                max_texel_elements: d3d11::D3D11_REQ_TEXTURE2D_U_OR_V_DIMENSION as _, 
                max_patch_size: 0,                                                    
                ...
                framebuffer_color_sample_counts: 1,      
                framebuffer_depth_sample_counts: 1,      
                framebuffer_stencil_sample_counts: 1,    
