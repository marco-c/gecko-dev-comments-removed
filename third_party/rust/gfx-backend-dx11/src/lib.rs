...
fn get_features(
    ...
    if feature_level >= d3dcommon::D3D_FEATURE_LEVEL_11_1 {
        features |= hal::Features::LOGIC_OP; 
    }
...
fn get_limits(feature_level: d3dcommon::D3D_FEATURE_LEVEL) -> hal::Limits {
    ...
    let max_samples = match feature_level {
        ...
        | d3dcommon::D3D_FEATURE_LEVEL_9_2
        | d3dcommon::D3D_FEATURE_LEVEL_9_3
        | d3dcommon::D3D_FEATURE_LEVEL_10_0 => 0b0001, 
        d3dcommon::D3D_FEATURE_LEVEL_10_1 => 0b0101, 
        d3dcommon::D3D_FEATURE_LEVEL_11_0 | d3dcommon::D3D_FEATURE_LEVEL_11_1 | _ => 0b1101, 
    };
    ...
    let max_compute_shared_memory_size = match feature_level {
        d3dcommon::D3D_FEATURE_LEVEL_10_0 | d3dcommon::D3D_FEATURE_LEVEL_10_1 => 4096 * 4, 
        d3dcommon::D3D_FEATURE_LEVEL_11_0 | d3dcommon::D3D_FEATURE_LEVEL_11_1 => {
    ...
    hal::Limits {
        ...
        descriptor_limits: hal::DescriptorLimits {
            ...
            ..hal::DescriptorLimits::default()             
        },
        max_bound_descriptor_sets: pso::DescriptorSetIndex::MAX,
        max_texel_elements: max_texture_uv_dimension as _, 
        ...
        max_vertex_input_attribute_offset: 255, 
        ...
        max_vertex_input_binding_stride: d3d11::D3D11_REQ_MULTI_ELEMENT_STRUCTURE_SIZE_IN_BYTES
            as _,
        max_vertex_input_bindings: d3d11::D3D11_IA_VERTEX_INPUT_RESOURCE_SLOT_COUNT as _, 
        max_vertex_output_components: d3d11::D3D11_VS_OUTPUT_REGISTER_COUNT as _,         
