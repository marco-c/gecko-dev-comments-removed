...
pub const IFF_UP: ::c_int = 0x0000000001; 
pub const IFF_BROADCAST: ::c_int = 0x0000000002; 
pub const IFF_DEBUG: ::c_int = 0x0000000004; 
pub const IFF_LOOPBACK: ::c_int = 0x0000000008; 
pub const IFF_POINTOPOINT: ::c_int = 0x0000000010; 
pub const IFF_NOTRAILERS: ::c_int = 0x0000000020; 
pub const IFF_RUNNING: ::c_int = 0x0000000040; 
pub const IFF_NOARP: ::c_int = 0x0000000080; 
pub const IFF_PROMISC: ::c_int = 0x0000000100; 
pub const IFF_ALLMULTI: ::c_int = 0x0000000200; 
pub const IFF_INTELLIGENT: ::c_int = 0x0000000400; 
pub const IFF_MULTICAST: ::c_int = 0x0000000800; 

pub const IFF_MULTI_BCAST: ::c_int = 0x0000001000;
pub const IFF_UNNUMBERED: ::c_int = 0x0000002000; 
pub const IFF_DHCPRUNNING: ::c_int = 0x0000004000; 
pub const IFF_PRIVATE: ::c_int = 0x0000008000; 
pub const IFF_NOXMIT: ::c_int = 0x0000010000; 

pub const IFF_NOLOCAL: ::c_int = 0x0000020000;
pub const IFF_DEPRECATED: ::c_int = 0x0000040000; 
pub const IFF_ADDRCONF: ::c_int = 0x0000080000; 
pub const IFF_ROUTER: ::c_int = 0x0000100000; 
pub const IFF_NONUD: ::c_int = 0x0000200000; 
pub const IFF_ANYCAST: ::c_int = 0x0000400000; 
pub const IFF_NORTEXCH: ::c_int = 0x0000800000; 
pub const IFF_IPV4: ::c_int = 0x0001000000; 
pub const IFF_IPV6: ::c_int = 0x0002000000; 
pub const IFF_NOFAILOVER: ::c_int = 0x0008000000; 
pub const IFF_FAILED: ::c_int = 0x0010000000; 
pub const IFF_STANDBY: ::c_int = 0x0020000000; 
pub const IFF_INACTIVE: ::c_int = 0x0040000000; 
pub const IFF_OFFLINE: ::c_int = 0x0080000000; 

pub const IFF_COS_ENABLED: ::c_longlong = 0x0200000000;
pub const IFF_PREFERRED: ::c_longlong = 0x0400000000; 
pub const IFF_TEMPORARY: ::c_longlong = 0x0800000000; 
pub const IFF_FIXEDMTU: ::c_longlong = 0x1000000000; 
pub const IFF_VIRTUAL: ::c_longlong = 0x2000000000; 
pub const IFF_DUPLICATE: ::c_longlong = 0x4000000000; 
pub const IFF_IPMP: ::c_longlong = 0x8000000000; 
...
pub const _MUTEX_MAGIC: u16 = 0x4d58; 
pub const _COND_MAGIC: u16 = 0x4356;  
pub const _RWL_MAGIC: u16 = 0x5257;   
