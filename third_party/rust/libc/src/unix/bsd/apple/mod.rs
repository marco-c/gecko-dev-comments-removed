...
pub const DLT_NULL: ::c_uint = 0;         
pub const DLT_EN10MB: ::c_uint = 1;       
pub const DLT_EN3MB: ::c_uint = 2;        
pub const DLT_AX25: ::c_uint = 3;         
pub const DLT_PRONET: ::c_uint = 4;       
pub const DLT_CHAOS: ::c_uint = 5;        
pub const DLT_IEEE802: ::c_uint = 6;      
pub const DLT_ARCNET: ::c_uint = 7;       
pub const DLT_SLIP: ::c_uint = 8;         
pub const DLT_PPP: ::c_uint = 9;          
pub const DLT_FDDI: ::c_uint = 10;        
pub const DLT_ATM_RFC1483: ::c_uint = 11; 
