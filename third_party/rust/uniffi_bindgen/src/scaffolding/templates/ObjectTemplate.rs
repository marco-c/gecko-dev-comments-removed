...
{%          when UniffiTrait::Debug { fmt }%}
    {% call rs::method_decl_prelude(fmt) %}
        {
            uniffi::deps::static_assertions::assert_impl_all!({{ obj.rust_name() }}: std::fmt::Debug); 
            format!(
                "{:?}",
...
{%          when UniffiTrait::Display { fmt }%}
    {% call rs::method_decl_prelude(fmt) %}
        {
            uniffi::deps::static_assertions::assert_impl_all!({{ obj.rust_name() }}: std::fmt::Display); 
            format!(
                "{}",
                match<std::sync::Arc<{{ obj.rust_name() }}> as ::uniffi::FfiConverter<crate::UniFfiTag>>::try_lift(r#ptr) {
                    Ok(ref val) => val,
    ...
    {% call rs::method_decl_prelude(hash) %}
            {
                ...
                uniffi::deps::static_assertions::assert_impl_all!({{ obj.rust_name() }}: Hash); 
        ...
        {% call rs::method_decl_prelude(eq) %}
            {
                ...
                uniffi::deps::static_assertions::assert_impl_all!({{ obj.rust_name() }}: PartialEq); 
