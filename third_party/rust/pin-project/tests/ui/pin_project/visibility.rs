...
pub mod pub_use {
    #[rustfmt::skip]
    pub use crate::pub_::__DefaultProjection; 
    #[rustfmt::skip]
    pub use crate::pub_::__DefaultProjectionRef; 
    #[rustfmt::skip]
    pub use crate::pub_::__ReplaceProjection; 
    #[rustfmt::skip]
    pub use crate::pub_::__ReplaceProjectionOwned; 
    #[rustfmt::skip]
    pub use crate::pub_::__ReplaceProjectionRef; 
...
pub mod pub_renamed_use {
    #[rustfmt::skip]
    pub use crate::pub_renamed::DProj; 
    #[rustfmt::skip]
    pub use crate::pub_renamed::DProjRef; 
    #[rustfmt::skip]
    pub use crate::pub_renamed::RProj; 
    #[rustfmt::skip]
    pub use crate::pub_renamed::RProjOwn; 
    #[rustfmt::skip]
    pub use crate::pub_renamed::RProjRef; 
