...
const IDENT_FIRST_CHAR: u8 = 1 << 2; 
const IDENT_OTHER_CHAR: u8 = 1 << 3; 
const IDENT_RAW_CHAR: u8 = 1 << 4; 
const WHITESPACE_CHAR: u8 = 1 << 5; 


const DIGIT: u8 = INT_CHAR | FLOAT_CHAR | IDENT_OTHER_CHAR | IDENT_RAW_CHAR; 
const ABCDF: u8 = INT_CHAR | IDENT_FIRST_CHAR | IDENT_OTHER_CHAR | IDENT_RAW_CHAR; 
const UNDER: u8 = INT_CHAR | FLOAT_CHAR | IDENT_FIRST_CHAR | IDENT_OTHER_CHAR | IDENT_RAW_CHAR; 
const E____: u8 = INT_CHAR | FLOAT_CHAR | IDENT_FIRST_CHAR | IDENT_OTHER_CHAR | IDENT_RAW_CHAR; 
const G2Z__: u8 = IDENT_FIRST_CHAR | IDENT_OTHER_CHAR | IDENT_RAW_CHAR; 
...
const ENCODINGS: [u8; 256] = [
 ...
 _____, _____, _____, _____, _____, _____, _____, _____, _____, WS___,
 WS___, _____, _____, WS___, _____, _____, _____, _____, _____, _____,
 _____, _____, _____, _____, _____, _____, _____, _____, _____, _____,
 _____, _____, WS___, _____, _____, _____, _____, _____, _____, _____,
 _____, _____, _____, PUNCT, _____, PUNCT, PUNCT, _____, DIGIT, DIGIT,
 DIGIT, DIGIT, DIGIT, DIGIT, DIGIT, DIGIT, DIGIT, DIGIT, _____, _____,
 _____, _____, _____, _____, _____, ABCDF, ABCDF, ABCDF, ABCDF, E____,
 ABCDF, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__,
 G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__,
 G2Z__, _____, _____, _____, _____, UNDER, _____, ABCDF, ABCDF, ABCDF,
 ABCDF, E____, ABCDF, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__,
 G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__, G2Z__,
 G2Z__, G2Z__, G2Z__, _____, _____, _____, _____, _____, _____, _____,
 _____, _____, _____, _____, _____, _____, _____, _____, _____, _____,
 _____, _____, _____, _____, _____, _____, _____, _____, _____, _____,
 _____, _____, _____, _____, _____, _____, _____, _____, _____, _____,
 _____, _____, _____, _____, _____, _____, _____, _____, _____, _____,
        ...
        T: FromStr,
    {
        for literal in &["inf", "+inf", "-inf", "NaN", "+NaN", "-NaN"] {
            if self.consume_ident(literal) {
                return FromStr::from_str(literal).map_err(|_| unreachable!()); 
            }
        }
