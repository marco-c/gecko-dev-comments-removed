    ...
    fn swizzle(
        ...
        match self.expressions[src_constant] {
            ...
            Expression::Compose { ty, ref components } => {
                ...
                let mut flattened = [src_constant; 4]; 
                let len =
            ...
            Expression::Literal(literal) => {
                let literal = match target {
                    Sc::I32 => Literal::I32(match literal {
                        ...
                        Literal::F16(v) => f16::to_i32(&v).unwrap(), 
                    ...
                    Sc::U32 => Literal::U32(match literal {
                        ...
                        Literal::F16(v) => f16::to_u32(&v).unwrap(), 
                    ...
                    Sc::I64 => Literal::I64(match literal {
                        ...
                        Literal::F16(v) => f16::to_i64(&v).unwrap(), 
                    ...
                    Sc::U64 => Literal::U64(match literal {
                        ...
                        Literal::U64(v) => v,
                        Literal::F16(v) => f16::to_u64(&v).unwrap(), 
