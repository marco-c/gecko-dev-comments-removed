...
pub const WGXERR_BADNUMBER: HRESULT =                     MAKE_WGXHR_ERR(0x00A);   
...
pub const    PathPointTypeStart: u8           = 0;    
pub const    PathPointTypeLine: u8            = 1;    
pub const    PathPointTypeBezier: u8          = 3;    
pub const    PathPointTypePathTypeMask: u8    = 0x07; 
pub const    PathPointTypeCloseSubpath: u8    = 0x80; 
