...
fn it_can_round_complex_numbers_using_bankers_rounding() {
    ...
    let part = part.round_dp_with_strategy(2, RoundingStrategy::MidpointNearestEven); 
...
fn it_can_round_complex_numbers_using_round_half_up() {
    ...
    let part = part.round_dp_with_strategy(2, RoundingStrategy::MidpointAwayFromZero); 
...
fn it_can_round_complex_numbers_using_round_half_down() {
    ...
    let part = part.round_dp_with_strategy(2, RoundingStrategy::MidpointTowardZero); 
    assert_eq!("0.16", part.to_string(), "RoundHalfDown");
}
