...
mod test {
    ...
    fn value_stability_sample() {
        ...
        do_test(10, 6, &[8, 0, 3, 5, 9, 6]); 
        do_test(25, 10, &[18, 15, 14, 9, 0, 13, 5, 24]); 
        do_test(300, 8, &[30, 283, 150, 1, 73, 13, 285, 35]); 
        do_test(300, 80, &[31, 289, 248, 154, 5, 78, 19, 286]); 
        do_test(300, 180, &[31, 289, 248, 154, 5, 78, 19, 286]); 
