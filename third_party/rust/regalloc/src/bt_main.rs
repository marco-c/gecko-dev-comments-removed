...
pub fn alloc_main<F: Function>(
    ...
    assert!(mb_reg_to_ranges_maps.is_some()); 
    assert!(mb_move_info.is_some()); 
    ...
    let mut num_vlrs_processed = 0; 
    let mut num_vlrs_spilled = 0; 
    let mut num_vlrs_evicted = 0; 
    ...
    let mut n_edit_list_move_processed = 0; 
    let mut i_min = 0;
    loop {
