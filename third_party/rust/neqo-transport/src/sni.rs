...
mod tests {
    const BUF_WITH_SNI: &[u8] = &[
        ...
        0x00, 
        0x00, 0x08, 
        0x13, 0x01, 0x13, 0x03, 0x13, 0x02, 0xca, 0xca, 
        0x01, 
        0x00, 
        0x01, 0xcb, 
        0xff, 0x01, 0x00, 0x01, 0x00, 
        0x00, 0x2d, 0x00, 0x03, 0x02, 0x01, 0x87, 
    ...
    fn find_sni_no_sni() {
        ...
        buf[len - 2..len].copy_from_slice(&[0x00, 0x00]); 
    ...
    fn find_sni_invalid_sni_length() {
        ...
        buf[len - 23..len - 21].copy_from_slice(&[0x00, 0x02]); 
        assert!(super::find_sni(&buf).is_none());
    }
