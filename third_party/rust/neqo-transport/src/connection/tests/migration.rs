...
fn path_forwarding_attack() {
    ...
    assert_v4_path(&new_probe, false); 
    ...
    assert_v6_path(&client_data1, false); 
    ...
    assert_v4_path(&padded_resp, true); 
