...
where
    A: FunctionalSequence<i32>,                                                                 
    B: FunctionalSequence<i32, Length = A::Length>,                                             
    A: MappedGenericSequence<i32, i32>,                                                         
    B: MappedGenericSequence<i32, i32, Mapped = MappedSequence<A, i32, i32>>,                   
    A::Item: Add<B::Item, Output = i32>,                                                        
    MappedSequence<A, i32, i32>: MappedGenericSequence<i32, i32> + FunctionalSequence<i32>,     
    SequenceItem<MappedSequence<A, i32, i32>>: Add<i32, Output=i32>,                            
    MappedSequence<MappedSequence<A, i32, i32>, i32, i32>: Debug,                               
    MappedSequence<MappedSequence<A, i32, i32>, i32, i32>: FunctionalSequence<i32>,             
    SequenceItem<MappedSequence<MappedSequence<A, i32, i32>, i32, i32>>: Add<i32, Output=i32>   
{
