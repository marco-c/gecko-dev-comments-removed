...
pub const IDENTITY_MAPPING: UINT = 0x1688; 
...
impl d::Device<B> for Device {
    unsafe fn allocate_memory(
        ...
        let desc = d3d12::D3D12_HEAP_DESC {
            ...
            Alignment: d3d12::D3D12_DEFAULT_MSAA_RESOURCE_PLACEMENT_ALIGNMENT as _, 
        ...
        ID::Item: Borrow<pass::SubpassDependency>,
    {
        ...
        let mut att_infos = (0 .. attachments.len())
            .map(|_| AttachmentInfo {
                ...
                last_state: d3d12::D3D12_RESOURCE_STATE_COMMON, 
    ...
    unsafe fn create_buffer_view(
        ...
        let num_elements = size / bytes_per_texel; 
        ...
        I::Item: Borrow<(&'a r::Memory, memory::Segment)>,
    {
        for range in ranges {
            ...
            if let Some(mem) = memory.resource {
                ...
                let end = segment.size.map_or(memory.size, |s| start + s); 
        ...
        I::Item: Borrow<r::Fence>,
    {
        ...
        match hr {
            ...
            winbase::WAIT_ABANDONED_0 ..= WAIT_ABANDONED_LAST => Ok(true), 
