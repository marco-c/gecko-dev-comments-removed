...
pub mod tests {
    ...
    pub const AUTHENTICATOR_INFO_PAYLOAD: [u8; 89] = [
        ...
        0x75, 0x76, 0x6d, 
        0x6b, 
        0x68, 0x6d, 0x61, 0x63, 0x2d, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 
        0x03, 
        0x50, 
        0xf8, 0xa0, 0x11, 0xf3, 0x8c, 0x0a, 0x4d, 0x15, 0x80, 0x06, 0x17, 0x11, 0x1f, 0x9e, 0xdc,
        0x7d, 
        ...
        0xf4, 
        0x69, 
        0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x50, 0x69, 0x6e, 
        0xf4, 
        0x05, 
        0x19, 0x04, 0xb0, 
        0x06, 
    ...
    pub const AUTHENTICATOR_INFO_PAYLOAD_YK_BIO_5C: [u8; 409] = [
        ...
        0x45, 
        0x68, 
        0x46, 0x49, 0x44, 0x4F, 0x5F, 0x32, 0x5F, 0x31, 
        0x02, 
        0x85, 
        0x6B, 
        0x63, 0x72, 0x65, 0x64, 0x50, 0x72, 0x6F, 0x74, 0x65, 0x63, 0x74, 
        0x6B, 
        0x68, 0x6D, 0x61, 0x63, 0x2D, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 
        0x6C, 
        ...
        0xF4, 
        0x67, 
        0x75, 0x76, 0x54, 0x6F, 0x6B, 0x65, 0x6E, 
        0xF5, 
        0x68, 
        0x61, 0x6C, 0x77, 0x61, 0x79, 0x73, 0x55, 0x76, 
        0xF5, 
        0x68, 
        0x63, 0x72, 0x65, 0x64, 0x4D, 0x67, 0x6D, 0x74, 
        0xF5, 
        0x69, 
        0x61, 0x75, 0x74, 0x68, 0x6E, 0x72, 0x43, 0x66, 0x67, 
        0xF5, 
        0x69, 
        0x62, 0x69, 0x6F, 0x45, 0x6E, 0x72, 0x6F, 0x6C, 0x6C, 
        0xF5, 
        0x69, 
        0x63, 0x6C, 0x69, 0x65, 0x6E, 0x74, 0x50, 0x69, 0x6E, 
        0xF5, 
        0x6A, 
        0x6C, 0x61, 0x72, 0x67, 0x65, 0x42, 0x6C, 0x6F, 0x62, 0x73, 
        0xF5, 
        0x6E, 
    ...
    pub const AUTHENTICATOR_INFO_FIDO_2_2: &[u8] = &[
        ...
        0x46, 0x49, 0x44, 0x4f, 0x5f, 0x32, 0x5f, 0x30, 
        0x68, 
        0x46, 0x49, 0x44, 0x4f, 0x5f, 0x32, 0x5f, 0x32, 
        0x03, 
        0x50, 
        0xf8, 0xa0, 0x11, 0xf3, 0x8c, 0x0a, 0x4d, 0x15, 0x80, 0x06, 0x17, 0x11, 0x1f, 0x9e, 0xdc,
        0x7d, 
    ...
    fn parse_authenticator_info() {
        ...
        broken_payload.extend_from_slice(&[
            0x17, 
            0x6B, 
            0x69, 0x6E, 0x76, 0x61, 0x6C, 0x69, 0x64, 0x5F, 0x6B, 0x65, 0x79, 
        ]);
    ...
    fn test_get_info_ctap2_only() {
        ...
        msg.extend(vec![HIDCmd::Init.into(), 0x00, 0x08]); 
        ...
        msg.extend(vec![0x02, 0x04, 0x01, 0x08, 0x01 | 0x04 | 0x08]); 
        ...
        let mut msg = cid.to_vec();
        msg.extend(vec![HIDCmd::Cbor.into(), 0x00, 0x5A]); 
        msg.extend(vec![0]); 
    ...
    fn parse_authenticator_info_protocol_versions() {
        ...
        raw_empty_list[raw_list_len - 1] = 0x80; 
