...
pub const FIDO_USAGE_DATA_IN: u8 = 0x20; 
pub const FIDO_USAGE_DATA_OUT: u8 = 0x21; 



pub const U2FHID_IF_VERSION: u32 = 2; 
pub const U2FHID_FRAME_TIMEOUT: u32 = 500; 
...
pub const U2F_REGISTER_HASH_ID: u8 = 0x00; 
