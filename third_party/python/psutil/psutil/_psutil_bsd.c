...
psutil_proc_oneshot_info(PyObject *self, PyObject *args) {
    ...
    py_retlist = Py_BuildValue(
        ...
        PSUTIL_TV2DOUBLE(kp.ki_rusage.ru_utime),     
        PSUTIL_TV2DOUBLE(kp.ki_rusage.ru_stime),     
        PSUTIL_TV2DOUBLE(kp.ki_rusage_ch.ru_utime),  
        ...
        PSUTIL_KPT2DOUBLE(kp.p_uutime),  
        PSUTIL_KPT2DOUBLE(kp.p_ustime),  
        
        
        kp.p_uctime_sec + kp.p_uctime_usec / 1000000.0,  
        kp.p_uctime_sec + kp.p_uctime_usec / 1000000.0,  
