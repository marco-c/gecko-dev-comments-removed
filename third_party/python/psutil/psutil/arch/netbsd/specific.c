...
psutil_virtual_mem(PyObject *self, PyObject *args) {
    ...
    return Py_BuildValue("KKKKKKKK",
        (unsigned long long) uv.npages << uv.pageshift,  
        (unsigned long long) uv.free << uv.pageshift,  
        (unsigned long long) uv.active << uv.pageshift,  
        (unsigned long long) uv.inactive << uv.pageshift,  
        (unsigned long long) uv.wired << uv.pageshift,  
...
psutil_swap_mem(PyObject *self, PyObject *args) {
    ...
    return Py_BuildValue("(LLLll)",
                         ...
                         swap_free,
                         (long) uv.pgswapin * pagesize,  
                         (long) uv.pgswapout * pagesize);  
