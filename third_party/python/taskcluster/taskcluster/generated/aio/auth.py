...
class Auth(AsyncBaseClient):
    ...
    async def getEntityHistory(self, *args, **kwargs):
        ...
        return await self._makeApiCall(
            self.funcinfo["getEntityHistory"], *args, **kwargs
        )
    ...
    async def listAuditHistory(self, *args, **kwargs):
        ...
        return await self._makeApiCall(
            self.funcinfo["listAuditHistory"], *args, **kwargs
        )
    ...
    async def resetAccessToken(self, *args, **kwargs):
        ...
        return await self._makeApiCall(
            self.funcinfo["resetAccessToken"], *args, **kwargs
        )
    ...
    async def websocktunnelToken(self, *args, **kwargs):
        ...
        return await self._makeApiCall(
            self.funcinfo["websocktunnelToken"], *args, **kwargs
        )
    ...
    async def authenticateHawk(self, *args, **kwargs):
        ...
        return await self._makeApiCall(
            self.funcinfo["authenticateHawk"], *args, **kwargs
        )
    ...
    async def testAuthenticate(self, *args, **kwargs):
        ...
        return await self._makeApiCall(
            self.funcinfo["testAuthenticate"], *args, **kwargs
        )
    ...
    async def testAuthenticateGet(self, *args, **kwargs):
        ...
        return await self._makeApiCall(
            self.funcinfo["testAuthenticateGet"], *args, **kwargs
        )
