...
class PythonInfo(object):
    ...
    def __init__(self):
        ...
        self.prefix = u(abs_path(getattr(sys, "prefix", None)))  
        self.base_prefix = u(abs_path(getattr(sys, "base_prefix", None)))  
        self.real_prefix = u(abs_path(getattr(sys, "real_prefix", None)))  
        ...
        self.executable = u(abs_path(sys.executable))  
        self.original_executable = u(abs_path(self.executable))  
