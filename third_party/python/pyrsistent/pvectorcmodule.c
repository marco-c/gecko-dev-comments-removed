...
static PySequenceMethods PVector_sequence_methods = {
    (lenfunc)PVector_len,            
    (binaryfunc)PVector_extend,      
    (ssizeargfunc)PVector_repeat,    
    (ssizeargfunc)PVector_get_item,  
...
static PyTypeObject PVectorType = {
  ...
  sizeof(PVector),                            
  0,		                              
  (destructor)PVector_dealloc,                
  0,                                          
  0,                                          
  0,                                          
  0,                                          
  (reprfunc)PVector_repr,                     
  0,                                          
  &PVector_sequence_methods,                  
  &PVector_mapping_methods,                   
  (hashfunc)PVector_hash,                     
  0,                                          
  0,                                          
  0,                                          
  0,                                          
  ...
  "Persistent vector",   	              
  (traverseproc)PVector_traverse,             
  0,                                          
  PVector_richcompare,                        
  offsetof(PVector, in_weakreflist),          
  PVectorIter_iter,                           
  0,                                          
  PVector_methods,                            
  PVector_members,                            
...
static PyTypeObject PVectorIterType = {
    ...
    (destructor)PVectorIter_dealloc,            
    0,                                          
    0,                                          
    0,                                          
    0,                                          
    ...
    Py_TPFLAGS_DEFAULT | Py_TPFLAGS_HAVE_GC,    
    0,                                          
    (traverseproc)PVectorIter_traverse,         
    0,                                          
    0,                                          
    0,                                          
    PyObject_SelfIter,                          
    (iternextfunc)PVectorIter_next,             
    PVectorIter_methods,                        
    0,                                          
};
...
static PyTypeObject PVectorEvolverType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    "pvector_evolver",                          
    sizeof(PVectorEvolver),                     
    0,                                          
    
    (destructor)PVectorEvolver_dealloc,         
    0,                                          
    0,                                          
    0,                                          
    0,                                          
    ...
    Py_TPFLAGS_DEFAULT | Py_TPFLAGS_HAVE_GC,    
    0,                                          
    (traverseproc)PVectorEvolver_traverse,      
    0,                                          
    0,                                          
    0,                                          
    0,                                          
