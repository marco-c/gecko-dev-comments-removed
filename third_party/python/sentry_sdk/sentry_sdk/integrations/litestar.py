...
try:
    ...
    from litestar.data_extractors import ConnectionDataExtractor  
...
class LitestarIntegration(Integration):
    ...
    def __init__(
        self,
        failed_request_status_codes=_DEFAULT_FAILED_REQUEST_STATUS_CODES,  
    ) -> None:
...
def patch_app_init():
    ...
    def injection_wrapper(self, *args, **kwargs):
        ...
        SentryLitestarASGIMiddleware.__call__ = SentryLitestarASGIMiddleware._run_asgi3  
