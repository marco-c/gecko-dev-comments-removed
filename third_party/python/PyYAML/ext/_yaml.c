...
static int __pyx_f_5_yaml_input_handler(void *, char *, size_t, size_t *); 
static int __pyx_f_5_yaml_output_handler(void *, char *, size_t); 
static PyObject *__pyx_f_5_yaml___pyx_unpickle_Mark__set_state(struct __pyx_obj_5_yaml_Mark *, PyObject *); 
...
static int __pyx_pymod_exec__yaml(PyObject* module); 
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_yaml(void) CYTHON_SMALL_CODE; 
__Pyx_PyMODINIT_FUNC init_yaml(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__yaml(void) CYTHON_SMALL_CODE; 
