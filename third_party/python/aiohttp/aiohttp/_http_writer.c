...
static PyObject *__pyx_f_7aiohttp_12_http_writer_to_str(PyObject *); 
static void __pyx_f_7aiohttp_12_http_writer__safe_header(PyObject *); 
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_http_writer(void) CYTHON_SMALL_CODE; 
