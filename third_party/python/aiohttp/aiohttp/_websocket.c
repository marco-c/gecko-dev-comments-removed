...
static int __pyx_pymod_exec__websocket(PyObject* module); 
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_websocket(void) CYTHON_SMALL_CODE; 
__Pyx_PyMODINIT_FUNC init_websocket(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__websocket(void) CYTHON_SMALL_CODE; 
