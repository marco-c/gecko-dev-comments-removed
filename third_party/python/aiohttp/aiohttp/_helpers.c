...
static PyObject *__pyx_f_7aiohttp_8_helpers___pyx_unpickle_reify__set_state(struct __pyx_obj_7aiohttp_8_helpers_reify *, PyObject *); 
...
static PyObject *__pyx_tp_new_7aiohttp_8_helpers_reify(PyTypeObject *t, PyObject *a, PyObject *k); 
...
static int __pyx_pymod_exec__helpers(PyObject* module); 
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_helpers(void) CYTHON_SMALL_CODE; 
__Pyx_PyMODINIT_FUNC init_helpers(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__helpers(void) CYTHON_SMALL_CODE; 
