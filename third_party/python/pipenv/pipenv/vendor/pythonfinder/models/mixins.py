...
class BasePath(object):
    ...
    _py_version = attr.ib(default=None, cmp=False)  
    _pythons = attr.ib(
        default=attr.Factory(defaultdict), cmp=False
    )  
    _is_dir = attr.ib(default=None, cmp=False)  
    _is_executable = attr.ib(default=None, cmp=False)  
    _is_python = attr.ib(default=None, cmp=False)  
...
class BaseFinder(object):
    def __init__(self):
        ...
        self._pythons = defaultdict(PathEntry)  
        self._versions = defaultdict(PathEntry)  
