...
@attr.s(slots=True, frozen=True)
class Extra(object):
    name = attr.ib(default=None, cmp=True)  
...
class SetupInfo(object):
    name = attr.ib(default=None, eq=True)  
    base_dir = attr.ib(default=None, eq=True, hash=False)  
    _version = attr.ib(default=None, eq=True)  
    _requirements = attr.ib(
        type=frozenset, factory=frozenset, eq=True, hash=True
    )  
    build_requires = attr.ib(default=None, eq=True)  
    build_backend = attr.ib(eq=True)  
    setup_requires = attr.ib(default=None, eq=True)  
    python_requires = attr.ib(
        default=None, eq=True
    )  
    _extras_requirements = attr.ib(default=None, eq=True)  
    ...
    stack = attr.ib(default=None, eq=False)  
    _finalizer = attr.ib(default=None, eq=False)  
