...
from six.moves import Sequence  
...
class Dependency(object):
    ...
    extras = attr.ib(factory=tuple, validator=validate_extras)  
    
    from_extras = attr.ib(default=None, eq=False)  
    ...
    markers = attr.ib(default=None, eq=False)  
...
class ReleaseUrl(object):
    ...
    upload_time = attr.ib(
        ...
        converter=instance_check_converter(datetime.datetime, dateutil.parser.parse),  
    )
    ...
    digests = attr.ib(
        converter=instance_check_converter(list, create_digest_collection)  
    )  
...
class ReleaseCollection(object):
    releases = attr.ib(
        factory=list, converter=instance_check_converter(list, get_releases_from_package),  
    )  
...
class PackageInfo(object):
    ...
    keywords = attr.ib(factory=list, converter=split_keywords)  
    ...
    downloads = attr.ib(factory=dict)  
    docs_url = attr.ib(default=None)  
    platform = attr.ib(type=str, default="")
    project_url = attr.ib(type=str, default="")
    project_urls = attr.ib(factory=dict)  
    requires_python = attr.ib(default=None)  
    requires_dist = attr.ib(factory=list)  
    release_url = attr.ib(default=None)  
    description_content_type = attr.ib(type=str, default="text/md")
    bugtrack_url = attr.ib(default=None)  
    classifiers = attr.ib(factory=list)  
    author_email = attr.ib(default=None)  
    markers = attr.ib(default=None)  
    dependencies = attr.ib(default=None)  
