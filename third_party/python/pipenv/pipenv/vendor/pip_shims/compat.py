...
def get_requirement_tracker(req_tracker_creator=None):
    ...
    if not req_tracker_creator:
        ...
        req_tracker_args = []
        _, required_args = get_method_args(req_tracker_creator.__init__)  
...
def make_preparer(
    ...
    required_args, required_kwargs = get_allowed_args(preparer_fn)  
    ...
    if wheel_cache is not None:
        ...
        with ExitStack() as stack:
            ...
            format_control = getattr(
                options,
                "format_control",
                format_control_provider(None, None),  
            )
...
def resolve(  
    ireq,  
    reqset_provider=None,  
    req_tracker_provider=None,  
    install_cmd_provider=None,  
    install_command=None,  
    finder_provider=None,  
...
def build_wheel(  
    ...
    wheel_builder_provider=None,  
    build_one_provider=None,  
    build_one_inside_env_provider=None,  
    build_many_provider=None,  
    install_command_provider=None,  
    finder_provider=None,  
    reqset_provider=None,  
):
