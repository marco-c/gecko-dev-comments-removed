...
class Key:
    ...
    def __init__(self, k, t=None, sep=None, dotted=False):  
        if t is None:
            if any(
...
class Whitespace(Item):
    ...
    def __init__(self, s, fixed=False):  
        self._s = s
        self._fixed = fixed
...
class Integer(long, Item):
    ...
    def __new__(cls, value, trivia, raw):  
        return super(Integer, cls).__new__(cls, value)

    def __init__(self, _, trivia, raw):  
...
class Date(Item, date):
    ...
    def __new__(cls, year, month, day, *_):  
...
class Array(Item, list):
    ...
    def __init__(self, value, trivia, multiline=False):  
...
class Table(Item, dict):
    ...
    def is_aot_element(self):  
        return self._is_aot_element

    def is_super_table(self):  
