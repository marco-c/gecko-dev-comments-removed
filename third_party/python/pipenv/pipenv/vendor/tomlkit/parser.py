...
class Parser:
    ...
    def inc_n(self, n, exception=None):  
        """
    ...
    def _merge_ws(self, item, container):  
        """
    ...
    def _split_table_name(self, name):  
        in_name = False
        current = ""
        t = KeyType.Bare
        parts = 0
    ...
    def _parse_number(self, raw, trivia):  
