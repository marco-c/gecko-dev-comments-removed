...
int main(int argc, char* argv[]) {
  ...
  RTC_CHECK(FLAG_red >= 0 && FLAG_red <= 127);  
  RTC_CHECK(FLAG_audio_level == -1 ||  
      (FLAG_audio_level > 0 && FLAG_audio_level <= 255));  
  RTC_CHECK(FLAG_abs_send_time == -1 ||  
      (FLAG_abs_send_time > 0 && FLAG_abs_send_time <= 255));  
