...
void DcSctpSocket::HandleData(const CommonHeader& ,
                              const SctpPacket::ChunkDescriptor& descriptor) {
...
void DcSctpSocket::HandleIData(const CommonHeader& ,
                               const SctpPacket::ChunkDescriptor& descriptor) {
...
void DcSctpSocket::HandleInit(const CommonHeader& ,
                              const SctpPacket::ChunkDescriptor& descriptor) {
  ...
  InitAckChunk init_ack(my_verification_tag,
                        options_.max_receiver_window_buffer_size,
                        options_.announced_maximum_outgoing_streams,
                        options_.announced_maximum_incoming_streams,
...
void DcSctpSocket::HandleSack(const CommonHeader& ,
                              const SctpPacket::ChunkDescriptor& descriptor) {
...
void DcSctpSocket::HandleAbort(const CommonHeader& ,
                               const SctpPacket::ChunkDescriptor& descriptor) {
...
void DcSctpSocket::HandleError(const CommonHeader& ,
                               const SctpPacket::ChunkDescriptor& descriptor) {
