...
class FuzzerTimeout : public Timeout {
 public:
  ...
  void Start(DurationMs , TimeoutID timeout_id) override {
...
class FuzzerCallbacks : public DcSctpSocketCallbacks {
 public:
  ...
  uint32_t GetRandomInt(uint32_t , uint32_t ) override {
    return kRandomValue;
  }
  void OnMessageReceived(DcSctpMessage ) override {}
  void OnError(ErrorKind ,
               absl::string_view ) override {}
  void OnAborted(ErrorKind ,
                 absl::string_view ) override {}
