...
public class PeerConnectionEndToEndTest {
  ...
  public void testCompleteSession() throws Exception {
    ...
    final CameraEnumerator enumerator = new Camera1Enumerator(false );
    final VideoCapturer videoCapturer =
        enumerator.createCapturer(enumerator.getDeviceNames()[0], null );
    final SurfaceTextureHelper surfaceTextureHelper =
        SurfaceTextureHelper.create("SurfaceTextureHelper",  null);
    final VideoSource videoSource = factory.createVideoSource( false);
