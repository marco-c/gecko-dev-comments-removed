...
public class GlRectDrawerTest {
  ...
  public void testRgbRendering() {
    ...
    drawer.drawRgb(rgbTexture, IDENTITY_MATRIX, WIDTH, HEIGHT, 0 , 0 ,
        WIDTH, HEIGHT);
  ...
  public void testYuvRendering() {
    ...
    final GlRectDrawer drawer = new GlRectDrawer();
    drawer.drawYuv(yuvTextures, IDENTITY_MATRIX, WIDTH, HEIGHT, 0 ,
        0 , WIDTH, HEIGHT);
  ...
  public void testOesRendering() throws InterruptedException {
    ...
    class StubOesTextureProducer {
      ...
      public void draw(ByteBuffer rgbPlane) {
        ...
        drawer.drawRgb(rgbTexture, IDENTITY_MATRIX, WIDTH, HEIGHT, 0 ,
            0 , WIDTH, HEIGHT);
        eglBase.swapBuffers();
      }
