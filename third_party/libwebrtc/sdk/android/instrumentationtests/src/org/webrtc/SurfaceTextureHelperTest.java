...
public class SurfaceTextureHelperTest {
  ...
  public void testDispose() throws InterruptedException {
    ...
    surfaceTextureHelper.setTextureSize( 32,  32);
    eglBase.createSurface(surfaceTextureHelper.getSurfaceTexture());
    eglBase.makeCurrent();
    
    listener.assertNoFrameIsDelivered( 1);
    ...
    listener.assertNoFrameIsDelivered( 500);
  ...
  public void testRestartListeningWithNewListener() throws InterruptedException {
    ...
    listener1.assertNoFrameIsDelivered( 1);
    ...
    listener2.assertNoFrameIsDelivered( 1);
