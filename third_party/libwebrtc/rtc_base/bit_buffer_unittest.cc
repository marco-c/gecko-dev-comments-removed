...
TEST(BitBufferWriterTest, NonSymmetricReadsMatchesWrites) {
  ...
  EXPECT_EQ(reader.ReadNonSymmetric(6), 0u);
  EXPECT_EQ(reader.ReadNonSymmetric(6), 1u);
  EXPECT_EQ(reader.ReadNonSymmetric(6), 2u);
  EXPECT_EQ(reader.ReadNonSymmetric(6), 3u);
  EXPECT_EQ(reader.ReadNonSymmetric(6), 4u);
  EXPECT_EQ(reader.ReadNonSymmetric(6), 5u);
