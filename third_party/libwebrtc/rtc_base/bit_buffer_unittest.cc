...
TEST(BitBufferTest, ReadNonSymmetricSameNumberOfBitsWhenNumValuesPowerOf2) {
  ...
  EXPECT_TRUE(reader.ReadNonSymmetric(1 << 4, values[0]));
  EXPECT_TRUE(reader.ReadNonSymmetric(1 << 4, values[1]));
  EXPECT_TRUE(reader.ReadNonSymmetric(1 << 4, values[2]));
  EXPECT_TRUE(reader.ReadNonSymmetric(1 << 4, values[3]));
...
TEST(BitBufferWriterTest, NonSymmetricReadsMatchesWrites) {
  ...
  uint32_t values[6];
  EXPECT_TRUE(reader.ReadNonSymmetric(6, values[0]));
  EXPECT_TRUE(reader.ReadNonSymmetric(6, values[1]));
  EXPECT_TRUE(reader.ReadNonSymmetric(6, values[2]));
  EXPECT_TRUE(reader.ReadNonSymmetric(6, values[3]));
  EXPECT_TRUE(reader.ReadNonSymmetric(6, values[4]));
  EXPECT_TRUE(reader.ReadNonSymmetric(6, values[5]));
...
TEST(BitBufferTest, ReadNonSymmetricOnlyValueConsumesNoBits) {
  ...
  EXPECT_TRUE(reader.ReadNonSymmetric(1, value));
