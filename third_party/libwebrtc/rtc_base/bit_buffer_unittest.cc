...
TEST(BitBufferTest, ReadNonSymmetricSameNumberOfBitsWhenNumValuesPowerOf2) {
  ...
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[0], 1 << 4));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[1], 1 << 4));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[2], 1 << 4));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[3], 1 << 4));
...
TEST(BitBufferWriterTest,
  ...
  EXPECT_TRUE(writer.WriteNonSymmetric(0xf, 1 << 4));
  ASSERT_EQ(writer.RemainingBitCount(), 12u);
  EXPECT_TRUE(writer.WriteNonSymmetric(0x3, 1 << 4));
  ASSERT_EQ(writer.RemainingBitCount(), 8u);
  EXPECT_TRUE(writer.WriteNonSymmetric(0xa, 1 << 4));
  ASSERT_EQ(writer.RemainingBitCount(), 4u);
  EXPECT_TRUE(writer.WriteNonSymmetric(0x0, 1 << 4));
...
TEST(BitBufferWriterTest, NonSymmetricReadsMatchesWrites) {
  ...
  EXPECT_EQ(BitBufferWriter::SizeNonSymmetricBits(1, 6),
            2u);
  EXPECT_EQ(BitBufferWriter::SizeNonSymmetricBits(2, 6),
            3u);
  
  ASSERT_EQ(writer.RemainingBitCount(), 16u);
  EXPECT_TRUE(writer.WriteNonSymmetric(0, 6));
  ASSERT_EQ(writer.RemainingBitCount(), 14u);
  EXPECT_TRUE(writer.WriteNonSymmetric(1, 6));
  ASSERT_EQ(writer.RemainingBitCount(), 12u);
  
  EXPECT_TRUE(writer.WriteNonSymmetric(2, 6));
  ASSERT_EQ(writer.RemainingBitCount(), 9u);
  EXPECT_TRUE(writer.WriteNonSymmetric(3, 6));
  ASSERT_EQ(writer.RemainingBitCount(), 6u);
  EXPECT_TRUE(writer.WriteNonSymmetric(4, 6));
  ASSERT_EQ(writer.RemainingBitCount(), 3u);
  EXPECT_TRUE(writer.WriteNonSymmetric(5, 6));
  ASSERT_EQ(writer.RemainingBitCount(), 0u);
  ...
  uint32_t values[6];
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[0], 6));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[1], 6));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[2], 6));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[3], 6));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[4], 6));
  EXPECT_TRUE(reader.ReadNonSymmetric(&values[5], 6));
...
TEST(BitBufferTest, ReadNonSymmetricOnlyValueConsumesNoBits) {
  ...
  EXPECT_TRUE(reader.ReadNonSymmetric(&value, 1));
...
TEST(BitBufferWriterTest, WriteNonSymmetricOnlyValueConsumesNoBits) {
  ...
  EXPECT_TRUE(writer.WriteNonSymmetric(0, 1));
