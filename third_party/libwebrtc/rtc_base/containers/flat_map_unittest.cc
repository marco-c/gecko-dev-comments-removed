...
TEST(FlatMap, InsertOrAssignMoveOnlyKey) {
  ...
  EXPECT_EQ(1u, m.size());
  EXPECT_EQ(0, key.data());  
  EXPECT_EQ(0, val.data());  
...
TEST(FlatMap, TryEmplaceMoveOnlyKey) {
  ...
  EXPECT_EQ(1u, m.size());
  EXPECT_EQ(0, key.data());   
  EXPECT_EQ(0, val1.data());  
  EXPECT_EQ(0, val2.data());  
  ...
  EXPECT_EQ(1u, m.size());
  EXPECT_EQ(1, key.data());                 
  EXPECT_EQ(33, paired_val.first.data());   
  EXPECT_EQ(55, paired_val.second.data());  
