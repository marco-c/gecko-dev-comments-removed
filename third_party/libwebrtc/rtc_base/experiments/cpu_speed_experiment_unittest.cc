...
TEST(CpuSpeedExperimentTest, NoValueIfNotEnabled) {
  ...
  EXPECT_FALSE(cpu_speed_config.GetValue(1, 1));
}
...
TEST(CpuSpeedExperimentTest, GetValue) {
  ...
  CpuSpeedExperiment cpu_speed_config;
  EXPECT_EQ(-12, cpu_speed_config.GetValue(1, 1));
  EXPECT_EQ(-12, cpu_speed_config.GetValue(1000, 1));
  EXPECT_EQ(-16, cpu_speed_config.GetValue(1001, 1));
}
...
TEST(CpuSpeedExperimentTest, GetValueWithList) {
  ...
  CpuSpeedExperiment cpu_speed_config;
  EXPECT_EQ(-1, cpu_speed_config.GetValue(1, 1));
  EXPECT_EQ(-1, cpu_speed_config.GetValue(1000, 1));
  EXPECT_EQ(-10, cpu_speed_config.GetValue(1001, 1));
  EXPECT_EQ(-10, cpu_speed_config.GetValue(2000, 1));
  EXPECT_EQ(-16, cpu_speed_config.GetValue(2001, 1));
  EXPECT_EQ(-16, cpu_speed_config.GetValue(3000, 1));
  EXPECT_EQ(-16, cpu_speed_config.GetValue(3001, 1));
}
...
TEST(CpuSpeedExperimentTest, GetValueWithCores) {
  ...
  CpuSpeedExperiment cpu_speed_config;
  EXPECT_EQ(-5, cpu_speed_config.GetValue(1000, 1));
  EXPECT_EQ(-11, cpu_speed_config.GetValue(2000, 2));
  EXPECT_EQ(-1, cpu_speed_config.GetValue(1000, 3));
  EXPECT_EQ(-10, cpu_speed_config.GetValue(2000, 4));
}
...
TEST(CpuSpeedExperimentTest, GetValueWithCoresUnconfigured) {
  ...
  CpuSpeedExperiment cpu_speed_config;
  EXPECT_EQ(-1, cpu_speed_config.GetValue(1000, 1));
  EXPECT_EQ(-10, cpu_speed_config.GetValue(2000, 2));
}
