...
TEST(EventBasedExponentialMovingAverageTest, Almost100) {
  ...
  EXPECT_NEAR(19.7, average.GetConfidenceInterval(), kError);  
  ...
  EXPECT_NEAR(7.6, average.GetConfidenceInterval(), kError);  
}
...
TEST(EventBasedExponentialMovingAverageTest, NonUniformSamplesHalftime100) {
...

  {
    ...
    EXPECT_NEAR(86.2, average.GetConfidenceInterval(), kError);  
  }

  {
    ...
    EXPECT_NEAR(65.4, average.GetConfidenceInterval(), kError);  
  }

  {
    ...
    EXPECT_NEAR(59.1, average.GetConfidenceInterval(), kError);  
  }

  {
    ...
    EXPECT_NEAR(4.9, average.GetConfidenceInterval(), kError);  
  }
}
