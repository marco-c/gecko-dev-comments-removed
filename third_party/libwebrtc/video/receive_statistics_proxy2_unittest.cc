...
TEST_P(ReceiveStatisticsProxy2TestWithContent, DownscalesReported) {
  const int kInterFrameDelayMs = 2000;  
  ...
  statistics_proxy_->UpdateHistograms(absl::nullopt, StreamDataCounters(),
                                      nullptr);
  const int kExpectedDownscales = 30;  
  if (videocontenttypehelpers::IsScreenshare(content_type_)) {
    EXPECT_METRIC_EQ(
        kExpectedDownscales,
...
TEST_P(ReceiveStatisticsProxy2TestWithDecodeTimeHistograms,
  ...
  statistics_proxy_->OnPreDecode(codec_type_, 0);
...
const auto kVp94kHw = std::make_tuple(false,
                                      10,
                                      3840,
                                      2160,
                                      kVideoCodecVP9,
                                      "ExternalDecoder");
const auto kVp94kSw = std::make_tuple(false,
                                      10,
                                      3840,
                                      2160,
                                      kVideoCodecVP9,
                                      "libvpx");
const auto kVp9HdHw = std::make_tuple(false,
                                      10,
                                      1920,
                                      1080,
                                      kVideoCodecVP9,
                                      "ExternalDecoder");
const auto kVp9HdSw = std::make_tuple(false,
                                      10,
                                      1920,
                                      1080,
                                      kVideoCodecVP9,
                                      "libvpx");
const auto kH2644kHw = std::make_tuple(false,
                                       10,
                                       3840,
                                       2160,
                                       kVideoCodecH264,
                                       "ExternalDecoder");
const auto kH2644kSw = std::make_tuple(false,
                                       10,
                                       3840,
                                       2160,
                                       kVideoCodecH264,
                                       "FFmpeg");
const auto kH264HdHw = std::make_tuple(false,
                                       10,
                                       1920,
                                       1080,
                                       kVideoCodecH264,
                                       "ExternalDecoder");
const auto kH264HdSw = std::make_tuple(false,
                                       10,
                                       1920,
                                       1080,
                                       kVideoCodecH264,
