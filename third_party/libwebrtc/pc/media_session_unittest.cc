...
TEST_F(MediaSessionDescriptionFactoryTest, TestCreateMultiStreamVideoOffer) {
  ...
  EXPECT_EQ(kAudioTrack3, updated_audio_streams[1].id);  
  ...
  EXPECT_EQ(kDataTrack3, updated_data_streams[1].id);  
