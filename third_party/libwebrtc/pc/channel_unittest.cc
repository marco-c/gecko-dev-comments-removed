...
class ChannelTest : public ::testing::Test {
 public:
  ...
  void TestRemovesExtensionNotPresentInRemoteAnswer() {
    ...
    CreateContent(0, kPcmuCodec, kH264Codec, &local);
    CreateContent(0, kPcmuCodec, kH264Codec, &remote);
  ...
  void TestRtpHeaderExtensionIdReassignment() {
    ...
    CreateContent(0, kPcmuCodec, kH264Codec, &local_updated);
  ...
  void TestRtpHeaderExtensionIdHistoryReassignment() {
    ...
    CreateContent(0, kPcmuCodec, kH264Codec, &local_empty);
