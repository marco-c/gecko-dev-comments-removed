...
TEST(ChannelReceiveFrameTransformerDelegateTest,
  ...
  scoped_refptr<ChannelReceiveFrameTransformerDelegate> delegate =
      make_ref_counted<ChannelReceiveFrameTransformerDelegate>(
          ...
          mock_frame_transformer, main_thread.task_queue());
...
TEST(ChannelReceiveFrameTransformerDelegateTest,
  ...
  delegate->Transform(packet, header, 1111, "audio/opus",
...
TEST(ChannelReceiveFrameTransformerDelegateTest,
  ...
  AudioLevel audio_level(true, audio_level_dbov);
...
TEST(ChannelReceiveFrameTransformerDelegateTest,
  ...
  for (auto offset : sender_capture_time_offsets) {
    ...
    delegate->Transform(packet, header, 1111,
                        "audio/opus", kFakeReceiveTimestamp);
...
TEST(ChannelReceiveFrameTransformerDelegateTest, SetAudioLevel) {
  ...
  delegate->Transform(packet, RTPHeader(), 1111,
                      "audio/opus", kFakeReceiveTimestamp);
