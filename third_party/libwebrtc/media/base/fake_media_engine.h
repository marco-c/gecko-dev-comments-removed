...
class RtpReceiveChannelHelper : public Base, public MediaChannelUtil {
 public:
  ...
  void SetFrameDecryptor(uint32_t ,
                         scoped_refptr<webrtc::FrameDecryptorInterface>
                         ) override {}

  void SetDepacketizerToDecoderFrameTransformer(
      uint32_t ,
      scoped_refptr<webrtc::FrameTransformerInterface> )
      override {}
...
class RtpSendChannelHelper : public Base, public MediaChannelUtil {
 ...
 protected:
  ...
  void OnPacketSent(const SentPacketInfo& ) override {}
  void OnReadyToSend(bool ready) override { ready_to_send_ = ready; }
  void OnNetworkRouteChanged(absl::string_view ,
...
class FakeVoiceMediaReceiveChannel
 ...
 public:
  ...
  void SetReceiveNackEnabled(bool ) override {}
...
class FakeVoiceMediaSendChannel
 ...
 public:
  ...
  void SetReceiveNackEnabled(bool ) {}
  void SetReceiveNonSenderRttEnabled(bool ) {}
...
class FakeVideoMediaReceiveChannel
 ...
 public:
  ...
  bool AddDefaultRecvStreamForTesting(const StreamParams& ) override {
