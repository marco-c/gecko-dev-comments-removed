...
class FakeAudioSendStream final : public webrtc::AudioSendStream {
 ...
 private:
  ...
  void SendAudioData(
      std::unique_ptr<webrtc::AudioFrame> ) override {}
...
class FakeVideoReceiveStream final
 ...
 public:
  ...
  void SetDepacketizerToDecoderFrameTransformer(
      rtc::scoped_refptr<
          webrtc::FrameTransformerInterface> ) override {
  }
...
class FakePayloadTypeSuggester : public webrtc::PayloadTypeSuggester {
 public:
  ...
  webrtc::RTCError AddLocalMapping(const std::string& ,
                                   webrtc::PayloadType ,
...
class FakeCall final : public webrtc::Call, public webrtc::PacketReceiver {
 public:
  ...
  void SetClientBitratePreferences(
      const webrtc::BitrateSettings& ) override {}
 ...
 private:
  ...
  void DeliverRtcpPacket(rtc::CopyOnWriteBuffer ) override {}
