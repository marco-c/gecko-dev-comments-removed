...
class FormatDataPackUnittest(unittest.TestCase):
  def testReadDataPackV4(self):
    expected_data = (
        ...
        b'\x04\x00\x00\x00'                  
        b'\x01'                              
        b'\x01\x00\x27\x00\x00\x00'          
        b'\x04\x00\x27\x00\x00\x00'          
        b'\x06\x00\x33\x00\x00\x00'          
        b'\x0a\x00\x3f\x00\x00\x00'          
        b'\x00\x00\x3f\x00\x00\x00'          
        b'this is id 4this is id 6')         
  ...
  def testReadWriteDataPackV5(self):
    expected_data = (
        ...
        b'\x03\x00'                          
        b'\x01\x00'                          
        b'\x01\x00\x28\x00\x00\x00'          
        b'\x04\x00\x28\x00\x00\x00'          
        b'\x06\x00\x34\x00\x00\x00'          
