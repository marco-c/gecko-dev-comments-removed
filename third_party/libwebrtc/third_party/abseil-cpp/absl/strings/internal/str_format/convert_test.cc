...
NativePrintfTraits VerifyNativeImplementationImpl() {
  ...
  const double d0079 = 65657.0;  
  const double d0179 = 65913.0;  
  const double d0080 = 65664.0;  
  const double d0180 = 65920.0;  
  const double d0081 = 65665.0;  
  const double d0181 = 65921.0;  
...
TEST_F(FormatConvertTest, DoubleRoundA) {
  ...
  EXPECT_EQ(format("%.4a", on_boundary_odd), "0x1.0002p+100");  
  ...
  EXPECT_EQ(format("%.4a", on_boundary_even), "0x1.0002p-2");  
