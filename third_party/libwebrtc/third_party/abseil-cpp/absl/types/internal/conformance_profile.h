...
struct ConformanceProfile {
  ...
  static constexpr move_constructible move_constructible_support =  
      MoveConstructibleValue;

  static constexpr copy_constructible copy_constructible_support =  
      CopyConstructibleValue;

  static constexpr move_assignable move_assignable_support =  
      MoveAssignableValue;

  static constexpr copy_assignable copy_assignable_support =  
      CopyAssignableValue;

  static constexpr destructible destructible_support =  
      DestructibleValue;

  static constexpr equality_comparable equality_comparable_support =  
  ...
  static constexpr swappable swappable_support = SwappableValue;  

  static constexpr hashable hashable_support = HashableValue;  
  ...
  static constexpr bool is_inequality_comparable =  
      InequalityComparableValue != inequality_comparable::maybe;

  static constexpr bool is_less_than_comparable =  
      LessThanComparableValue != less_than_comparable::maybe;

  static constexpr bool is_less_equal_comparable =  
      LessEqualComparableValue != less_equal_comparable::maybe;

  static constexpr bool is_greater_equal_comparable =  
      GreaterEqualComparableValue != greater_equal_comparable::maybe;

  static constexpr bool is_greater_than_comparable =  
...
struct MinimalProfiles {
  ...
  static constexpr swappable swappable_support =  
      (MinEnum)(PropertiesOfT<Profs>::swappable_support...);

  static constexpr hashable hashable_support =  
