...
static const int kNonceTimeout = 60 * 60 * 1000;              
static const int kDefaultAllocationTimeout = 10 * 60 * 1000;  
static const int kPermissionTimeout = 5 * 60 * 1000;          
static const int kChannelTimeout = 10 * 60 * 1000;            
...
int TurnServerAllocation::ComputeLifetime(const TurnMessage* msg) {
  ...
  int lifetime = kDefaultAllocationTimeout / 1000;  
