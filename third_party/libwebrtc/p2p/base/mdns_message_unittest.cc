...
const uint8_t kSingleQuestionForIPv4AddrWithUnicastResponse[] = {
    ...
    0x00, 0x00,                                
    0x00, 0x00,                                
    0x06, 0x77, 0x65, 0x62, 0x72, 0x74, 0x63,  
    0x03, 0x6f, 0x72, 0x67,                    
    0x00,                                      
    0x00, 0x01,                                
    0x80, 0x01,                                
...
const uint8_t kTwoQuestionsForIPv4AndIPv6AddrWithMulticastResponse[] = {
    ...
    0x00, 0x00,                                      
    0x00, 0x00,                                      
    0x07, 0x77, 0x65, 0x62, 0x72, 0x74, 0x63, 0x34,  
    0x03, 0x6f, 0x72, 0x67,                          
    0x00,                                            
    0x00, 0x01,                                      
    0x00, 0x01,  
    0x07, 0x77, 0x65, 0x62, 0x72, 0x74, 0x63, 0x36,  
    0x03, 0x6f, 0x72, 0x67,                          
    0x00,                                            
    0x00, 0x1C,                                      
    0x00, 0x01,  
...
const uint8_t kTwoAuthoritativeAnswersWithIPv4AndIPv6Addr[] = {
    ...
    0x00, 0x00, 0x00, 0x78,                          
    0x00, 0x10,                                      
    0xfd, 0x12, 0x34, 0x56, 0x78, 0x9a, 0x00, 0x01,  
