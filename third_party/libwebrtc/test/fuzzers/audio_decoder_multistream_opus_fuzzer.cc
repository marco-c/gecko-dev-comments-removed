...
void FuzzOneInput(const uint8_t* data, size_t size) {
  const AudioDecoderMultiChannelOpusConfig kSurroundConfigs[] = {
      MakeDecoderConfig(1, 1, 0, {0}),  

      MakeDecoderConfig(2, 2, 0, {0, 0}),  
      ...
      MakeDecoderConfig(4, 2, 2, {0, 1, 2, 3}),             
      MakeDecoderConfig(6, 4, 2, {0, 4, 1, 2, 3, 5}),       
      MakeDecoderConfig(8, 5, 3, {0, 6, 1, 2, 3, 4, 5, 7})  
  };
