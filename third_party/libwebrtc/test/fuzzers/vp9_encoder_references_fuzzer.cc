...
static_assert(DropAbove(0b1011, 0) == false, "");
static_assert(DropAbove(0b1011, 1) == false, "");
static_assert(DropAbove(0b1011, 2) == true, "");
static_assert(DropAbove(0b1011, 3) == true, "");
...
static_assert(DropBelow(0b1101, 0, 4) == true, "");
static_assert(DropBelow(0b1101, 1, 4) == true, "");
static_assert(DropBelow(0b1101, 2, 4) == false, "");
static_assert(DropBelow(0b1101, 3, 4) == false, "");
