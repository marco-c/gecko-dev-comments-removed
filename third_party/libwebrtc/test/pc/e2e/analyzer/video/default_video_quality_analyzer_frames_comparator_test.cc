...
TEST(DefaultVideoQualityAnalyzerFramesComparatorTest,
  ...
  ExpectSizeAndAllElementsAre(stats.at(stats_key).transport_time_ms, 1,
                              20.0);
  ExpectSizeAndAllElementsAre(stats.at(stats_key).total_delay_incl_transport_ms,
                              1, 60.0);
  ExpectSizeAndAllElementsAre(stats.at(stats_key).encode_time_ms, 1,
                              10.0);
  ExpectSizeAndAllElementsAre(stats.at(stats_key).decode_time_ms, 1,
                              0.01);
...
TEST(
  ...
  FrameStats frame_stats2 = FrameStatsWith10msDeltaBetweenPhasesAnd10x10Frame(
      2, stream_start_time + TimeDelta::Millis(15));
  ...
  ExpectSizeAndAllElementsAre(
      stats.at(stats_key).time_between_rendered_frames_ms, 1,
      15.0);
...
TEST(DefaultVideoQualityAnalyzerFramesComparatorTest,
  ...
  FrameStats frame_stats(1, stream_start_time);
...
TEST(DefaultVideoQualityAnalyzerFramesComparatorTest,
  ...
  FrameStats frame_stats(1, captured_time);

  comparator.Start(1);
  comparator.EnsureStatsForStream(stream, sender, 2,
  ...
  ExpectSizeAndAllElementsAre(stats.freeze_time_ms, 1, 0);
...
TEST(DefaultVideoQualityAnalyzerFramesComparatorTest,
  ...
  ExpectEmpty(stats.time_between_rendered_frames_ms);
  ExpectEmpty(stats.encode_frame_rate);
  ExpectSizeAndAllElementsAre(stats.encode_time_ms, 1, 10.0);
  ExpectEmpty(stats.decode_time_ms);
  ExpectEmpty(stats.receive_to_render_time_ms);
  ExpectEmpty(stats.skipped_between_rendered);
  ExpectSizeAndAllElementsAre(stats.freeze_time_ms, 1, 0);
  ExpectEmpty(stats.time_between_freezes_ms);
  ExpectEmpty(stats.resolution_of_decoded_frame);
  ExpectSizeAndAllElementsAre(stats.target_encode_bitrate, 1,
                              2000.0);
  EXPECT_THAT(stats.spatial_layers_qp, SizeIs(1));
  ExpectSizeAndAllElementsAre(stats.spatial_layers_qp[0], 2,
                              5.0);
  ExpectEmpty(stats.rendered_frame_qp);
  ExpectEmpty(stats.recv_key_frame_size_bytes);
  ExpectEmpty(stats.recv_delta_frame_size_bytes);
...
TEST(DefaultVideoQualityAnalyzerFramesComparatorTest,
  ...
  ExpectEmpty(stats.psnr);
  ExpectEmpty(stats.ssim);
  ExpectSizeAndAllElementsAre(stats.transport_time_ms, 1,
                              20.0);
  ExpectEmpty(stats.total_delay_incl_transport_ms);
  ExpectEmpty(stats.time_between_rendered_frames_ms);
  ExpectEmpty(stats.encode_frame_rate);
  ...
  ExpectSizeAndAllElementsAre(stats.spatial_layers_qp[0], 2,
                              5.0);
  ExpectEmpty(stats.rendered_frame_qp);
  ExpectSizeAndAllElementsAre(stats.recv_key_frame_size_bytes, 1,
                              500.0);
  ExpectEmpty(stats.recv_delta_frame_size_bytes);
  EXPECT_EQ(stats.total_encoded_images_payload, 1000);
  EXPECT_EQ(stats.num_send_key_frames, 1);
...
TEST(DefaultVideoQualityAnalyzerFramesComparatorTest,
  ...
  ExpectEmpty(stats.encode_frame_rate);
  ExpectSizeAndAllElementsAre(stats.encode_time_ms, 1, 10.0);
  ExpectSizeAndAllElementsAre(stats.decode_time_ms, 1, 10.0);
  ExpectEmpty(stats.receive_to_render_time_ms);
  ExpectEmpty(stats.skipped_between_rendered);
  ExpectSizeAndAllElementsAre(stats.freeze_time_ms, 1, 0);
  ExpectEmpty(stats.time_between_freezes_ms);
  ...
  ExpectSizeAndAllElementsAre(stats.spatial_layers_qp[0], 2,
                              5.0);
  ExpectSizeAndAllElementsAre(stats.rendered_frame_qp, 1,
                              10.0);
  ExpectSizeAndAllElementsAre(stats.recv_key_frame_size_bytes, 1,
                              500.0);
  ExpectEmpty(stats.recv_delta_frame_size_bytes);
...
TEST(DefaultVideoQualityAnalyzerFramesComparatorTest,
  ...
  VideoFrame frame =
      CreateFrame(frame_id, 320, 180, captured_time);
  FrameStats frame_stats(1, captured_time);
  ...
  comparator.AddComparison(stats_key,
                           frame,
                           frame, FrameComparisonType::kRegular,
                           frame_stats);
  comparator.Stop({});
