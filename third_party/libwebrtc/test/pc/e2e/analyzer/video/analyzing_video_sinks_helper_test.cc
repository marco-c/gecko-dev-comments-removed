...
TEST(AnalyzingVideoSinksHelperTest, ConfigsCanBeAdded) {
  VideoConfig config("alice_video", 1280, 720, 30);
...
TEST(AnalyzingVideoSinksHelperTest, AddingForExistingLabelWillOverwriteValue) {
  VideoConfig config_before("alice_video", 1280, 720,
                            30);
  VideoConfig config_after("alice_video", 640, 360,
                           15);
...
TEST(AnalyzingVideoSinksHelperTest, ClearRemovesAllConfigs) {
  VideoConfig config1("alice_video", 640, 360, 30);
  VideoConfig config2("bob_video", 640, 360, 30);
