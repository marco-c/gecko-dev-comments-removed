...
TEST(StreamStateTest, PopFrontAndFrontIndependentForEachPeer) {
  ...
  EXPECT_EQ(state.PopFront(1), 1);
  EXPECT_EQ(state.Front(1), 2);
  EXPECT_EQ(state.PopFront(1), 2);
  EXPECT_EQ(state.Front(2), 1);
  EXPECT_EQ(state.PopFront(2), 1);
  EXPECT_EQ(state.Front(2), 2);
  EXPECT_EQ(state.PopFront(2), 2);
}
