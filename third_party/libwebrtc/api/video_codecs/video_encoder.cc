...
int32_t VideoEncoder::InitEncode(const VideoCodec* codec_settings,
  ...
  const VideoEncoder::Capabilities capabilities( false);
...
void VideoEncoder::OnPacketLossRateUpdate(float ) {}

void VideoEncoder::OnRttUpdate(int64_t ) {}

void VideoEncoder::OnLossNotification(
    const LossNotification& ) {}
