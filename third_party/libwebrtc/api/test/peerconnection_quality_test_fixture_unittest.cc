...
TEST(PclfVideoSubscription, WhenSpecIsNotSetFieldsAreCompared) {
  VideoSubscription::Resolution test_resolution(1, 2,
                                                3);
  VideoSubscription::Resolution equal_resolution(1, 2,
                                                 3);
  VideoSubscription::Resolution different_width(10, 2,
                                                3);
  VideoSubscription::Resolution different_height(1, 20,
                                                 3);
  VideoSubscription::Resolution different_fps(1, 20,
                                              30);
