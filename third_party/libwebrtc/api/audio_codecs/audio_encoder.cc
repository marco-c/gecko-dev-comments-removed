...
bool AudioEncoder::SetApplication(Application ) {
  return false;
}

void AudioEncoder::SetMaxPlaybackRate(int ) {}

void AudioEncoder::SetTargetBitrate(int ) {}
...
bool AudioEncoder::EnableAudioNetworkAdaptor(absl::string_view ) {
  return false;
}
...
void AudioEncoder::OnReceivedRtt(int ) {}

void AudioEncoder::OnReceivedOverhead(size_t ) {}

void AudioEncoder::SetReceiverFrameLengthRange(int ,
                                               int ) {}
