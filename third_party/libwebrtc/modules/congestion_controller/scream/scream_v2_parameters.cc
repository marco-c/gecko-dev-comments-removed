...
ScreamV2Parameters::ScreamV2Parameters(const FieldTrialsView& trials)
    : min_ref_window("MinRefWindow", DataSize::Bytes(1000)),
      ...
      loss_event_rate_avg_g_loss("LossEventRateAvgGLoss", 0.1),
      loss_event_rate_avg_g_no_loss("LossEventRateAvgGNoLoss", 0.2),
      loss_event_rate_threshold_discard("LossEventRateDiscardThreshold", 0.25),
      loss_event_rate_threshold_increase("LossEventRateIncreaseThreshold",
                                         0.10),
