...
TEST(RnnVadTest, SequenceBufferPushOpsUnsigned) {
  TestSequenceBufferPushOp<uint8_t, 32, 8>();   
  TestSequenceBufferPushOp<uint8_t, 32, 16>();  
  TestSequenceBufferPushOp<uint8_t, 32, 32>();  
  TestSequenceBufferPushOp<uint8_t, 23, 7>();   
}

TEST(RnnVadTest, SequenceBufferPushOpsSigned) {
  TestSequenceBufferPushOp<int, 32, 8>();   
  TestSequenceBufferPushOp<int, 32, 16>();  
  TestSequenceBufferPushOp<int, 32, 32>();  
  TestSequenceBufferPushOp<int, 23, 7>();   
}

TEST(RnnVadTest, SequenceBufferPushOpsFloating) {
  TestSequenceBufferPushOp<float, 32, 8>();   
  TestSequenceBufferPushOp<float, 32, 16>();  
  TestSequenceBufferPushOp<float, 32, 32>();  
  TestSequenceBufferPushOp<float, 23, 7>();   
}
