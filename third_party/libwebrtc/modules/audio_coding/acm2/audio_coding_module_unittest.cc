...
TEST_F(AcmSenderBitExactnessOldApi, MAYBE_Ilbc_30ms) {
  ...
  Run(AcmReceiverBitExactnessOldApi::PlatformChecksum(
          ...
          "b14dba0de36efa5ec88a32c0b320b70f", "android_arm32_audio",
          "android_arm64_audio", "android_arm64_clang_audio",
          "b14dba0de36efa5ec88a32c0b320b70f"),
      AcmReceiverBitExactnessOldApi::PlatformChecksum(
...
TEST_F(AcmSenderBitExactnessOldApi, MAYBE_G722_20ms) {
  ...
  Run(AcmReceiverBitExactnessOldApi::PlatformChecksum(
          ...
          "a87a91ec0124510a64967f5d768554ff", "android_arm32_audio",
          "android_arm64_audio", "android_arm64_clang_audio",
          "a87a91ec0124510a64967f5d768554ff"),
      AcmReceiverBitExactnessOldApi::PlatformChecksum(
...
TEST_F(AcmSenderBitExactnessOldApi, MAYBE_G722_stereo_20ms) {
  ...
  Run(AcmReceiverBitExactnessOldApi::PlatformChecksum(
          ...
          "be0b8528ff9db3a2219f55ddd36faf7f", "android_arm32_audio",
          "android_arm64_audio", "android_arm64_clang_audio",
          "be0b8528ff9db3a2219f55ddd36faf7f"),
      AcmReceiverBitExactnessOldApi::PlatformChecksum(
