...
TEST_P(BitrateAdaptationTest, BitrateAdaptation) {
  ...
  std::map<uint32_t, EncodingSettings> encoding_settings2 =
      VideoCodecTester::CreateEncodingSettings(
          codec_type, "L1T1",
          640, 360, {bitrate_kbps.second},
          30, num_frames, initial_timestamp_rtp);
