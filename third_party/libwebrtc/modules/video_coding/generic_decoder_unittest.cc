...
class ReceiveCallback : public VCMReceiveCallback {
 public:
  int32_t FrameToRender(VideoFrame& videoFrame,  
 ...
 protected:
  GenericDecoderTest()
      : clock_(0),
        ...
        generic_decoder_(&decoder_, true) {}
  ...
  void SetUp() override {
    ...
    settings.width = 10;
    settings.height = 10;
    generic_decoder_.InitDecode(&settings, 4);
  }
...
TEST_F(GenericDecoderTest, MaxCompositionDelayActivatedByPlayoutDelay) {
  ...
  constexpr int kMaxCompositionDelayInFrames = 3;  
