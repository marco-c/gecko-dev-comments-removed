...
TEST(DesktopRegionTest, TwoRects) {
  struct Case {
    ...
    DesktopRect expected_rects[3];
      ...
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(0, 100, 100, 200),
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(0, 100, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(100, 0, 200, 100),
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(100, 0, 200, 200)}},

      
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(0, 150, 100, 250),
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(100, 100, 200, 150),
                          DesktopRect::MakeLTRB(0, 150, 200, 200),
                          DesktopRect::MakeLTRB(0, 200, 100, 250)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(0, 50, 100, 150),
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(0, 50, 100, 100),
                          DesktopRect::MakeLTRB(0, 100, 200, 150),
                          DesktopRect::MakeLTRB(100, 150, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(0, 120, 100, 180),
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(100, 100, 200, 120),
                          DesktopRect::MakeLTRB(0, 120, 200, 180),
                          DesktopRect::MakeLTRB(100, 180, 200, 200)}},

      
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(150, 0, 250, 100),
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(150, 0, 250, 100),
                          DesktopRect::MakeLTRB(100, 100, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(50, 0, 150, 100),
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(50, 0, 150, 100),
                          DesktopRect::MakeLTRB(100, 100, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(120, 0, 180, 100),
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(120, 0, 180, 100),
                          DesktopRect::MakeLTRB(100, 100, 200, 200)}},

      
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(50, 50, 150, 150),
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(50, 50, 150, 100),
                          DesktopRect::MakeLTRB(50, 100, 200, 150),
                          DesktopRect::MakeLTRB(100, 150, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(150, 50, 250, 150),
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(150, 50, 250, 100),
                          DesktopRect::MakeLTRB(100, 100, 250, 150),
                          DesktopRect::MakeLTRB(100, 150, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(0, 120, 150, 180),
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(100, 100, 200, 120),
                          DesktopRect::MakeLTRB(0, 120, 200, 180),
                          DesktopRect::MakeLTRB(100, 180, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(120, 0, 180, 150),
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(120, 0, 180, 100),
                          DesktopRect::MakeLTRB(100, 100, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 0, 200, 300),
       .input_rect2 = DesktopRect::MakeLTRB(0, 100, 300, 200),
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(100, 0, 200, 100),
                          DesktopRect::MakeLTRB(0, 100, 300, 200),
                          DesktopRect::MakeLTRB(100, 200, 200, 300)}},

      
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(150, 150, 180, 180),
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(100, 100, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(100, 100, 180, 180),
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(100, 100, 200, 200)}},
      {.input_rect1 = DesktopRect::MakeLTRB(100, 100, 200, 200),
       .input_rect2 = DesktopRect::MakeLTRB(150, 150, 200, 200),
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(100, 100, 200, 200)}},
  };
    ...
    DesktopRect expected_rects[6];
      ...
      {.input_count = 3,
       ...
       .expected_rects = {DesktopRect::MakeLTRB(0, 100, 200, 200),
                          DesktopRect::MakeLTRB(310, 110, 320, 120)}},
      {.input_count = 3,
       .input_rects = {DesktopRect::MakeLTRB(100, 100, 200, 200),
      ...
      {.input_count = 3,
       .input_rects = {DesktopRect::MakeLTRB(10, 10, 40, 20),
                       DesktopRect::MakeLTRB(10, 30, 40, 40),
                       DesktopRect::MakeLTRB(10, 20, 40, 30)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(10, 10, 40, 40)}},
  };
...
TEST(DesktopRegionTest, Equals) {
  struct Region {
    ...
    int id;
      ...
      {.count = 2,
       .rects = {DesktopRect::MakeLTRB(0, 100, 200, 200),
                 DesktopRect::MakeLTRB(310, 110, 320, 120)},
       .id = 0},
      {.count = 2,
       .rects = {DesktopRect::MakeLTRB(0, 100, 201, 200),
                 DesktopRect::MakeLTRB(310, 110, 320, 120)},
       .id = 1},
      {.count = 2,
       .rects = {DesktopRect::MakeLTRB(0, 100, 200, 201),
                 DesktopRect::MakeLTRB(310, 110, 320, 120)},
       .id = 2},
      ...
      {.count = 4,
       .rects = {DesktopRect::MakeLTRB(0, 0, 30, 30),
                 DesktopRect::MakeLTRB(10, 10, 40, 40),
                 DesktopRect::MakeLTRB(20, 20, 50, 50),
                 DesktopRect::MakeLTRB(50, 0, 65, 15)},
       .id = 3},
      ...
      {.count = 3,
       .rects = {DesktopRect::MakeLTRB(100, 100, 200, 200),
                 DesktopRect::MakeLTRB(50, 50, 150, 150),
                 DesktopRect::MakeLTRB(300, 125, 350, 175)},
       .id = 6},
      {.count = 4,
      ...
      {.count = 3,
       .rects = {DesktopRect::MakeLTRB(10, 10, 40, 20),
                 DesktopRect::MakeLTRB(10, 30, 40, 40),
                 DesktopRect::MakeLTRB(10, 20, 40, 30)},
       .id = 7},
      {.count = 1, .rects = {DesktopRect::MakeLTRB(10, 10, 40, 40)}, .id = 7},
  };
  ...
  struct Case {
    ...
    DesktopRect expected_rects[5];
      ...
      {.input_count = 3,
       ...
       .dy = 5,
       .expected_count = 5,
       .expected_rects = {DesktopRect::MakeLTRB(3, 5, 33, 15),
...
TEST(DesktopRegionTest, Intersect) {
  struct Case {
    ...
    DesktopRect expected_rects[5];
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(50, 50, 150, 150)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(50, 50, 100, 100)}},

      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(100, 0, 200, 300)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(0, 100, 300, 200)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(100, 100, 200, 200)}},
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 2,
       .input2_rects = {DesktopRect::MakeLTRB(50, 10, 150, 30),
                        DesktopRect::MakeLTRB(50, 30, 160, 50)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(50, 10, 100, 50)}},
      ...
      {.input1_count = 1,
       ...
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(50, 10, 100, 30),
                          DesktopRect::MakeLTRB(50, 30, 90, 50)}},
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(100, 50, 200, 200)},
       .expected_count = 0,
       .expected_rects = {}},
  };
  ...
  struct Case {
    ...
    DesktopRect expected_rects[5];
      ...
      {.input1_count = 1,
       ...
       .input2_rects = {DesktopRect::MakeLTRB(50, 50, 150, 150)},
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 50),
                          DesktopRect::MakeLTRB(0, 50, 50, 100)}},

      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(-50, -50, 50, 50)},
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(50, 0, 100, 50),
                          DesktopRect::MakeLTRB(0, 50, 100, 100)}},

      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(-50, 50, 50, 150)},
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 50),
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(50, 50, 150, 70)},
       .expected_count = 3,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 50),
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(50, 50, 70, 70)},
       .expected_count = 4,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 50),
                          DesktopRect::MakeLTRB(0, 50, 50, 70),
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .expected_count = 0,
       .expected_rects = {}},
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(-10, -10, 110, 110)},
       .expected_count = 0,
       .expected_rects = {}},
      ...
      {.input1_count = 3,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 10, 10),
                        DesktopRect::MakeLTRB(20, 20, 30, 30),
                        DesktopRect::MakeLTRB(40, 0, 50, 10)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(20, 20, 30, 30)},
       .expected_count = 2,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 10, 10),
                          DesktopRect::MakeLTRB(40, 0, 50, 10)}},

      
      {.input1_count = 3,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 50),
                        DesktopRect::MakeLTRB(0, 50, 150, 70),
                        DesktopRect::MakeLTRB(0, 70, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(100, 50, 150, 70)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)}},

      
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(100, 0, 200, 100)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)}},
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(-100, 0, 0, 100)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)}},
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(0, 100, 0, 200)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)}},
      ...
      {.input1_count = 1,
       .input1_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)},
       .input2_count = 1,
       .input2_rects = {DesktopRect::MakeLTRB(0, -100, 100, 0)},
       .expected_count = 1,
       .expected_rects = {DesktopRect::MakeLTRB(0, 0, 100, 100)}},
  };
...
TEST(DesktopRegionTest, SubtractRectOnSameRow) {
  ...
  struct SpanSet {
    ...
    struct Range {
      ...
      {.count = 1, .spans = {{.start = 0, .end = 3}}},
      {.count = 1, .spans = {{.start = 0, .end = 5}}},
      {.count = 1, .spans = {{.start = 0, .end = 7}}},
      {.count = 1, .spans = {{.start = 0, .end = 12}}},
      {.count = 2,
       .spans = {{.start = 0, .end = 3},
                 {.start = 4, .end = 5},
                 {.start = 6, .end = 16}}},
