...
void DesktopCapturer::SetExcludedWindow(WindowId ) {}

bool DesktopCapturer::GetSourceList(SourceList* ) {
  return true;
}

bool DesktopCapturer::SelectSource(SourceId ) {
  return false;
}
...
bool DesktopCapturer::IsOccluded(const DesktopVector& ) {
  return false;
}
