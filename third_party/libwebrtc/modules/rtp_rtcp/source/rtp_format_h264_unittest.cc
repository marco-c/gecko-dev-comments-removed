...
TEST_P(RtpPacketizerH264ModeTest,
  ...
  Buffer nalus[] = {GenerateNalUnit(195),
                    GenerateNalUnit(200),
                    GenerateNalUnit(200)};
  Buffer frame = CreateFrame(nalus);
...
TEST_P(RtpPacketizerH264ModeTest,
  ...
  Buffer nalus[] = {GenerateNalUnit(200),
                    GenerateNalUnit(200),
                    GenerateNalUnit(195)};
  Buffer frame = CreateFrame(nalus);
...
TEST(RtpPacketizerH264Test, StapA) {
  Buffer nalus[] = {GenerateNalUnit(2), GenerateNalUnit(2),
...
TEST(RtpPacketizerH264Test, StapARespectsFirstPacketReduction) {
  ...
  Buffer nalus[] = {GenerateNalUnit(kFirstFragmentSize),
                    GenerateNalUnit(2), GenerateNalUnit(2)};
  Buffer frame = CreateFrame(nalus);
...
TEST(RtpPacketizerH264Test, StapARespectsSinglePacketReduction) {
  ...
  Buffer first_nalus[] = {GenerateNalUnit(2),
                          GenerateNalUnit(2),
                          GenerateNalUnit(981)};
  ...
  Buffer second_nalus[] = {GenerateNalUnit(2),
                           GenerateNalUnit(2),
                           GenerateNalUnit(982)};
...
TEST(RtpPacketizerH264Test, DoesNotPacketizeWithEmptyNalUnit) {
  ...
  uint8_t empty_nal_input[] = {0x00, 0x00, 0x01, 
                               0x00, 0x00, 0x01, 0x01};
