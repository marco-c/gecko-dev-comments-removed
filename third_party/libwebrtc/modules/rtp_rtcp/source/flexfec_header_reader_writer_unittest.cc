...
constexpr uint8_t kMask0[] = {0x2B, 0xCD};  
constexpr uint8_t kMask1[] = {0x92, 0x34,   
                              0x76, 0x78, 0x9A, 0xBC};  
constexpr uint8_t kMask2[] = {0x92, 0x34,               
                              0xD6, 0x78, 0x9A, 0xBC,   
...
TEST(FlexfecHeaderReaderWriterTest,
  ...
  constexpr uint8_t kUlpfecPacketMask[] = {0xAA, 0xFF};  
  constexpr uint16_t kMediaStartSeqNum = 1234;
