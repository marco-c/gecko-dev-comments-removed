...
TEST(ReviseJitterTest,
  ...
  std::unique_ptr<ReceiveStatistics> statistics =
      ReceiveStatistics::Create(&clock);
  RtpPacketReceived packet1 = MakeRtpPacket(0,
                                            1);
  RtpPacketReceived packet2 = MakeNextRtpPacket(
      packet1, 8'000, 1 + 160);
  RtpPacketReceived packet3 = MakeNextRtpPacket(
...
TEST(ReviseJitterTest,
  ...
  RtpPacketReceived packet4 =
      MakeNextRtpPacket(packet3, 8'000,
                        1 + 160 + 960 + 160);
...
TEST(ReviseJitterTest,
  ...
  std::unique_ptr<ReceiveStatistics> statistics =
      ReceiveStatistics::Create(&clock);
  RtpPacketReceived packet1 = MakeRtpPacket(48'000,
                                            1);
  RtpPacketReceived packet2 = MakeNextRtpPacket(
      packet1, 48'000, 1 + 960);
  RtpPacketReceived packet3 = MakeNextRtpPacket(
      packet2, 0, 1 + 960 + 55);
  RtpPacketReceived packet4 =
      MakeNextRtpPacket(packet3, 8'000,
...
TEST(ReviseJitterTest,
  ...
  RtpPacketReceived packet3 = MakeNextRtpPacket(
      packet2, 0, 1 + 960 + 55);
  RtpPacketReceived packet4 =
      MakeNextRtpPacket(packet3, 48'000,
                        1 + 960 + 55 + 960);
...
TEST(ReviseJitterTest, TwoPacketsWithMaximumRtpTimestampDifference) {
  ...
  std::unique_ptr<ReceiveStatistics> statistics =
      ReceiveStatistics::Create(&clock);
  RtpPacketReceived packet1 = MakeRtpPacket(90'000,
                                            0x01234567);
  RtpPacketReceived packet2 =
