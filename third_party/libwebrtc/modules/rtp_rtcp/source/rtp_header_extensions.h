...
class AbsoluteSendTime {
 public:
  ...
  static size_t ValueSize(uint32_t ) {
...
class AudioLevelExtension {
 public:
  ...
  static size_t ValueSize(const AudioLevel& ) {
    return kValueSizeBytes;
  }
...
class TransmissionOffset {
 public:
  ...
  static size_t ValueSize(int32_t ) { return kValueSizeBytes; }
...
class VideoOrientation {
 public:
  ...
  static size_t ValueSize(uint8_t ) { return kValueSizeBytes; }
...
class VideoTimingExtension {
 public:
  ...
  static size_t ValueSize(uint16_t , uint8_t ) {
    return kValueSizeBytes;
  }
...
class ColorSpaceExtension {
 ...
 private:
  static constexpr int kChromaticityDenominator = 50000;  
  static constexpr int kLuminanceMaxDenominator = 1;      
  static constexpr int kLuminanceMinDenominator = 10000;  
...
class InbandComfortNoiseExtension {
 public:
  ...
  static size_t ValueSize(std::optional<uint8_t> ) {
    return kValueSizeBytes;
  }
