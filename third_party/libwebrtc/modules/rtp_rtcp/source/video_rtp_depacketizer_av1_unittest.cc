...
TEST(VideoRtpDepacketizerAv1Test, AssembleFrameFromOnePacketWithTwoObus) {
  const uint8_t payload1[] = {0b00'10'0000,  
                              2,             
                              0b0'0001'000,  
                              10,            
                              0b0'0110'000,  
...
TEST(VideoRtpDepacketizerAv1Test, AssembleFrameFromTwoPacketsWithTwoObu) {
  const uint8_t payload1[] = {0b01'10'0000,  
                              2,             
                              0b0'0001'000,  
                              10,            
                              0b0'0110'000,  
...
TEST(VideoRtpDepacketizerAv1Test,
  ...
  const uint8_t payload1[] = {0b01'00'0000,  
                              2,             
                              0b0'0001'000,  
                              10,            
                              2,             
...
TEST(VideoRtpDepacketizerAv1Test, AssembleFrameWithOneObuFromManyPackets) {
  const uint8_t payload1[] = {0b01'01'0000,  
                              0b0'0110'000, 11, 12};
  const uint8_t payload2[] = {0b11'01'0000,  
                              13, 14};
  const uint8_t payload3[] = {0b11'01'0000,  
                              15, 16, 17};
...
TEST(VideoRtpDepacketizerAv1Test,
  ...
  const uint8_t payload3[] = {0b01'10'0000,  
                              3,             
                              0b0'0111'000,  
                              11,
                              12,
...
TEST(VideoRtpDepacketizerAv1Test,
  ...
  memset(payload1, 0, sizeof(payload1));
  payload1[0] = 0b01'00'0000;  
  payload1[1] = 33;            
  payload1[2] = 0b0'0110'000;  
  payload1[3 + 10] = 0x10;
  uint8_t payload2[2 + 96];
  memset(payload2, 0, sizeof(payload2));
  payload2[0] = 0b10'00'0000;  
  payload2[1] = 96;            
  payload2[2 + 20] = 0x20;
