...
#pragma clang diagnostic pop
 public:
  ...
  void SetNonSenderRttMeasurement(bool ) override {}
  ...
  bool CanSendPacket(const RtpPacketToSend& ) const override {
    RTC_DCHECK_NOTREACHED() << "Not implemented";
    return false;
  }

  void AssignSequenceNumber(RtpPacketToSend& ) override {
    RTC_DCHECK_NOTREACHED() << "Not implemented";
  }

  void SendPacket(std::unique_ptr<RtpPacketToSend> ,
