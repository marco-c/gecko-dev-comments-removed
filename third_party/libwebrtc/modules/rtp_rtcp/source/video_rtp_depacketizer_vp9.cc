...
int VideoRtpDepacketizerVp9::ParseRtpPayload(
  ...
  bool i_bit = first_byte & 0b1000'0000;  
  bool p_bit = first_byte & 0b0100'0000;  
  bool l_bit = first_byte & 0b0010'0000;  
  bool f_bit = first_byte & 0b0001'0000;  
  bool b_bit = first_byte & 0b0000'1000;  
  bool e_bit = first_byte & 0b0000'0100;  
  bool v_bit = first_byte & 0b0000'0010;  
  bool z_bit = first_byte & 0b0000'0001;  
