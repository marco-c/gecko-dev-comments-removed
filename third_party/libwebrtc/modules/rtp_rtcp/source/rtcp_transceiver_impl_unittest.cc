...
TEST(RtcpTransceiverImplTest, CalculatesRoundTripTimeOnDlrr) {
  ...
  EXPECT_CALL(rtt_observer, OnRttUpdate(100 ));
...
TEST(RtcpTransceiverImplTest, PassRttFromDlrrToLinkObserver) {
  ...
  rti.delay_since_last_rr = SaturatedUsToCompactNtp(10'000);  
...
TEST(RtcpTransceiverImplTest, CalculatesRoundTripTimeFromReportBlocks) {
  ...
  rb1.SetDelayLastSr(SaturatedUsToCompactNtp(10'000));  
  ...
  rb2.SetDelayLastSr(SaturatedUsToCompactNtp(20'000));  
