...
void Query() {
  {
    ...
    gimp_install_procedure(
        kLoadProc, "Loads JPEG XL image files",
        "Loads JPEG XL image files", "JPEG XL Project",
        "JPEG XL Project", "2019",
        "JPEG XL image", nullptr,
        GIMP_PLUGIN, G_N_ELEMENTS(load_args),
...

  {
    ...
    gimp_install_procedure(
        kSaveProc, "Saves JPEG XL image files",
        "Saves JPEG XL image files", "JPEG XL Project",
        "JPEG XL Project", "2019",
        "JPEG XL image", "RGB*, GRAY*",
        GIMP_PLUGIN, G_N_ELEMENTS(save_args),
        0, save_args,
        nullptr);
