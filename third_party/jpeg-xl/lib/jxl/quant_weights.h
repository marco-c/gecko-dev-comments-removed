...
struct QuantEncodingInternal {
  ...
  constexpr QuantEncodingInternal(Tag<kQuantModeLibrary> ,
                                  uint8_t predefined)
  ...
  constexpr QuantEncodingInternal(Tag<kQuantModeDCT2> ,
  ...
  constexpr QuantEncodingInternal(Tag<kQuantModeDCT4> ,
  ...
  constexpr QuantEncodingInternal(Tag<kQuantModeDCT4X8> ,
                                  const DctQuantWeightParams& params,
  ...
  constexpr QuantEncodingInternal(Tag<kQuantModeDCT> ,
                                  const DctQuantWeightParams& params)
  ...
  constexpr QuantEncodingInternal(Tag<kQuantModeAFV> ,
                                  const DctQuantWeightParams& params4x8,
