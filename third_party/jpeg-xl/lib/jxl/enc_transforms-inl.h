...
HWY_MAYBE_UNUSED void DCFromLowestFrequencies(const AcStrategy::Type strategy,
  ...
  switch (strategy) {
    case Type::DCT16X8: {
      ReinterpretingIDCT<2 * kBlockDim, kBlockDim,
                         2, 1, 2, 1>(
          block, 2 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT8X16: {
      ReinterpretingIDCT<kBlockDim, 2 * kBlockDim,
                         1, 2, 1, 2>(
          block, 2 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT16X16: {
      ReinterpretingIDCT<2 * kBlockDim, 2 * kBlockDim,
                         2, 2, 2, 2>(
          block, 2 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT32X8: {
      ReinterpretingIDCT<4 * kBlockDim, kBlockDim,
                         4, 1, 4, 1>(
          block, 4 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT8X32: {
      ReinterpretingIDCT<kBlockDim, 4 * kBlockDim,
                         1, 4, 1, 4>(
          block, 4 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT32X16: {
      ReinterpretingIDCT<4 * kBlockDim, 2 * kBlockDim,
                         4, 2, 4, 2>(
          block, 4 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT16X32: {
      ReinterpretingIDCT<2 * kBlockDim, 4 * kBlockDim,
                         2, 4, 2, 4>(
          block, 4 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT32X32: {
      ReinterpretingIDCT<4 * kBlockDim, 4 * kBlockDim,
                         4, 4, 4, 4>(
          block, 4 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT64X32: {
      ReinterpretingIDCT<8 * kBlockDim, 4 * kBlockDim,
                         8, 4, 8, 4>(
          block, 8 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT32X64: {
      ReinterpretingIDCT<4 * kBlockDim, 8 * kBlockDim,
                         4, 8, 4, 8>(
          block, 8 * kBlockDim, dc, dc_stride);
      break;
    }
    case Type::DCT64X64: {
      ReinterpretingIDCT<8 * kBlockDim, 8 * kBlockDim,
                         8, 8, 8, 8>(
          block, 8 * kBlockDim, dc, dc_stride);
      break;
    }
