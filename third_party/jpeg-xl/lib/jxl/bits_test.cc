...
TEST(BitsTest, TestFloorLog2) {
  ...
  EXPECT_EQ(11u, FloorLog2Nonzero(0x00000fffu));  
  EXPECT_EQ(12u, FloorLog2Nonzero(0x00001000u));  
  EXPECT_EQ(12u, FloorLog2Nonzero(0x00001001u));  
...
TEST(BitsTest, TestCeilLog2) {
  ...
  EXPECT_EQ(12u, CeilLog2Nonzero(0x00000fffu));  
  EXPECT_EQ(12u, CeilLog2Nonzero(0x00001000u));  
  EXPECT_EQ(13u, CeilLog2Nonzero(0x00001001u));  
