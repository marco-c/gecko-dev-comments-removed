...
HWY_MAYBE_UNUSED void LowestFrequenciesFromDC(const AcStrategyType strategy,
  ...
  switch (strategy) {
    case Type::DCT16X8: {
      ReinterpretingDCT<2 * kBlockDim, kBlockDim,
                        2, 1, 2, 1>(
          dc, dc_stride, llf, 2 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT8X16: {
      ReinterpretingDCT<kBlockDim, 2 * kBlockDim,
                        1, 2, 1, 2>(
          dc, dc_stride, llf, 2 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT16X16: {
      ReinterpretingDCT<2 * kBlockDim, 2 * kBlockDim,
                        2, 2, 2, 2>(
          dc, dc_stride, llf, 2 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT32X8: {
      ReinterpretingDCT<4 * kBlockDim, kBlockDim,
                        4, 1, 4, 1>(
          dc, dc_stride, llf, 4 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT8X32: {
      ReinterpretingDCT<kBlockDim, 4 * kBlockDim,
                        1, 4, 1, 4>(
          dc, dc_stride, llf, 4 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT32X16: {
      ReinterpretingDCT<4 * kBlockDim, 2 * kBlockDim,
                        4, 2, 4, 2>(
          dc, dc_stride, llf, 4 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT16X32: {
      ReinterpretingDCT<2 * kBlockDim, 4 * kBlockDim,
                        2, 4, 2, 4>(
          dc, dc_stride, llf, 4 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT32X32: {
      ReinterpretingDCT<4 * kBlockDim, 4 * kBlockDim,
                        4, 4, 4, 4>(
          dc, dc_stride, llf, 4 * kBlockDim, warm_block, warm_scratch_space);
      break;
    }
    case Type::DCT64X32: {
      ReinterpretingDCT<8 * kBlockDim, 4 * kBlockDim,
                        8, 4, 8, 4>(
          dc, dc_stride, llf, 8 * kBlockDim, scratch, scratch + 8 * 4);
      break;
    }
    case Type::DCT32X64: {
      ReinterpretingDCT<4 * kBlockDim, 8 * kBlockDim,
                        4, 8, 4, 8>(
          dc, dc_stride, llf, 8 * kBlockDim, scratch, scratch + 4 * 8);
      break;
    }
    case Type::DCT64X64: {
      ReinterpretingDCT<8 * kBlockDim, 8 * kBlockDim,
                        8, 8, 8, 8>(
          dc, dc_stride, llf, 8 * kBlockDim, scratch, scratch + 8 * 8);
      break;
    }
    case Type::DCT128X64: {
      ReinterpretingDCT<16 * kBlockDim, 8 * kBlockDim,
                        16, 8, 16, 8>(
          dc, dc_stride, llf, 16 * kBlockDim, scratch, scratch + 16 * 8);
      break;
    }
    case Type::DCT64X128: {
      ReinterpretingDCT<8 * kBlockDim, 16 * kBlockDim,
                        8, 16, 8, 16>(
