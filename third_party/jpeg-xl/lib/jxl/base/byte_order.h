...
static JXL_INLINE void Store16(OrderBE , const uint32_t native,
                               uint8_t* p) {
  return StoreBE16(native, p);
}

static JXL_INLINE void Store16(OrderLE , const uint32_t native,
                               uint8_t* p) {
  return StoreLE16(native, p);
}

static JXL_INLINE void Store24(OrderBE , const uint32_t native,
                               uint8_t* p) {
  return StoreBE24(native, p);
}

static JXL_INLINE void Store24(OrderLE , const uint32_t native,
                               uint8_t* p) {
  return StoreLE24(native, p);
}
static JXL_INLINE void Store32(OrderBE , const uint32_t native,
                               uint8_t* p) {
  return StoreBE32(native, p);
}

static JXL_INLINE void Store32(OrderLE , const uint32_t native,
                               uint8_t* p) {
  return StoreLE32(native, p);
}

static JXL_INLINE uint32_t Load16(OrderBE , const uint8_t* p) {
  return LoadBE16(p);
}

static JXL_INLINE uint32_t Load16(OrderLE , const uint8_t* p) {
  return LoadLE16(p);
}

static JXL_INLINE uint32_t Load24(OrderBE , const uint8_t* p) {
  return LoadBE24(p);
}

static JXL_INLINE uint32_t Load24(OrderLE , const uint8_t* p) {
  return LoadLE24(p);
}
static JXL_INLINE uint32_t Load32(OrderBE , const uint8_t* p) {
  return LoadBE32(p);
}

static JXL_INLINE uint32_t Load32(OrderLE , const uint8_t* p) {
  return LoadLE32(p);
}
