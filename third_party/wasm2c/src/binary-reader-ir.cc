...
class BinaryReaderIR : public BinaryReaderNop {
  static constexpr size_t kMaxNestingDepth = 16384;  
  static constexpr size_t kMaxFunctionLocals = 50000;  
  static constexpr size_t kMaxFunctionParams = 1000;   
  static constexpr size_t kMaxFunctionResults = 1000;  
