...
typedef ::testing::Types<BitDepthParams<uint8_t, 8, false>,   
                         BitDepthParams<uint16_t, 8, true>,   
                         BitDepthParams<uint16_t, 10, true>,  
