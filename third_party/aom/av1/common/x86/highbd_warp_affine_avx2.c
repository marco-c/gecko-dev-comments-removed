    ...
    for (int j = 0; j < p_width; j += 8) {
      ...
      if (ix4 <= -7) {
        ...
        if (beta == 0 && alpha == 0) {
          ...
          __m256i v_c01 = _mm256_broadcastd_epi32(v_01);     
          __m256i v_c23 = _mm256_broadcastd_epi32(
              _mm_shuffle_epi32(v_01, 1));  
          __m256i v_c45 = _mm256_broadcastd_epi32(
              _mm_shuffle_epi32(v_01, 2));  
          __m256i v_c67 = _mm256_broadcastd_epi32(
              _mm_shuffle_epi32(v_01, 3));  
          for (int k = -7; k < AOMMIN(8, p_height - i); ++k) {
            int iy = iy4 + k;
            if (iy < 0)
              iy = 0;
            ...
            __m256i v_refu =
                _mm256_alignr_epi8(v_ref, v_refl, 2);  
            v_refl = _mm256_inserti128_si256(
            ...
            parsum = _mm256_madd_epi16(
                v_c23,
                _mm256_alignr_epi8(v_refu, v_refl, 4));  
          ...
          __m256i v_c01 = _mm256_unpacklo_epi64(
              v_c0123, v_c4567);  
          __m256i v_c23 =
              _mm256_unpackhi_epi64(v_c0123, v_c4567);  
          __m256i v_c45 =
              _mm256_unpacklo_epi64(v_c0123u, v_c4567u);  
          __m256i v_c67 =
              _mm256_unpackhi_epi64(v_c0123u, v_c4567u);  
      ...
      for (int k = -4; k < AOMMIN(4, p_height - i - 4); ++k) {
        ...
        __m256i v_src01l =
            _mm256_unpacklo_epi32(src[0], src[1]);  
        __m256i v_src01u =
            _mm256_unpackhi_epi32(src[0], src[1]);  
        __m256i v_sum =
        ...
        __m256i v_suml =
            _mm256_permute4x64_epi64(v_sum, 0xD8);  
        __m256i v_sumh =
            _mm256_permute4x64_epi64(v_sum, 0x32);      
        v_sum = _mm256_unpacklo_epi32(v_suml, v_sumh);  
