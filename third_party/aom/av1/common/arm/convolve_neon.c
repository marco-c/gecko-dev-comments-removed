  ...
  if (h == 4) {
    ...
    do {
      ...
      do {
        ...
        s1 = vextq_s16(s11, s7, 1);  
        s2 = vextq_s16(s11, s7, 2);  
        s3 = vextq_s16(s11, s7, 3);  
        s4 = vextq_s16(s11, s7, 4);  
        s5 = vextq_s16(s11, s7, 5);  
        s6 = vextq_s16(s11, s7, 6);  
        s7 = vextq_s16(s11, s7, 7);  
  ...
  if (w <= 4) {
    ...
    do {
      ...
      if ((w == 4) && (h != 2)) {
        ...
        dst += dst_stride;
        vst1_lane_u16((uint16_t *)dst, vreinterpret_u16_u8(d01), 2);  
        dst += dst_stride;
        vst1_lane_u16((uint16_t *)dst, vreinterpret_u16_u8(d23), 0);  
        dst += dst_stride;
        vst1_lane_u16((uint16_t *)dst, vreinterpret_u16_u8(d23), 2);  
        dst += dst_stride;
      } else if ((w == 2) && (h == 2)) {
        vst1_lane_u16((uint16_t *)dst, vreinterpret_u16_u8(d01), 0);  
        dst += dst_stride;
  ...
  if (w <= 4) {
    ...
    do {
      ...
      do {
        ...
        s1 = vextq_s16(sum, s7, 1);  
        s2 = vextq_s16(sum, s7, 2);  
        s3 = vextq_s16(sum, s7, 3);  
        s4 = vextq_s16(sum, s7, 4);  
        s5 = vextq_s16(sum, s7, 5);  
        s6 = vextq_s16(sum, s7, 6);  
        s7 = vextq_s16(sum, s7, 7);  
