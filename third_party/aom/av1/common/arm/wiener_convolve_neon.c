  ...
  if (!(h & 7)) {
    ...
    do {
      ...
      do {
        ...
        t1 = vext_u8(temp_0, t7, 1);  
        t2 = vext_u8(temp_0, t7, 2);  
        t3 = vext_u8(temp_0, t7, 3);  
        t4 = vext_u8(temp_0, t7, 4);  
        t5 = vext_u8(temp_0, t7, 5);  
        t6 = vext_u8(temp_0, t7, 6);  
        t7 = vext_u8(temp_0, t7, 7);  
    ...
    do {
      ...
      do {
        ...
        s11 = vget_high_s16(tt0); 
        s12 = vget_high_s16(tt1); 
        s13 = vget_high_s16(tt2); 
        s14 = vget_high_s16(tt3); 
