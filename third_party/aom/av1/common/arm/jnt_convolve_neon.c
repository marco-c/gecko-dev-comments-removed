  ...
  if (w == 4) {
    ...
    do {
      ...
      do {
        ...
        s1 = vextq_s16(temp_0, s7, 1);  
        s2 = vextq_s16(temp_0, s7, 2);  
        s3 = vextq_s16(temp_0, s7, 3);  
        s4 = vextq_s16(temp_0, s7, 4);  
        s5 = vextq_s16(temp_0, s7, 5);  
        s6 = vextq_s16(temp_0, s7, 6);  
        s7 = vextq_s16(temp_0, s7, 7);  
