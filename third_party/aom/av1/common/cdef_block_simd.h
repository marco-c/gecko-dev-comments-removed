...
int SIMD_FUNC(cdef_find_dir)(const uint16_t *img, int stride, int32_t *var,
  ...
  best_dir = get_msb(best_dir ^ (best_dir - 1));  
...
void SIMD_FUNC(cdef_filter_8_0)(void *dest, int dstride, const uint16_t *in,
                                ...
                                int block_height) {
  if (block_width == 8) {
    filter_block_8x8(1, dest, dstride, in, pri_strength,
                     sec_strength, dir, pri_damping, sec_damping, coeff_shift,
                     block_height, 1,
                     1);
  } else {
    filter_block_4x4(1, dest, dstride, in, pri_strength,
                     sec_strength, dir, pri_damping, sec_damping, coeff_shift,
                     block_height, 1,
                     1);
  }
...
void SIMD_FUNC(cdef_filter_8_3)(void *dest, int dstride, const uint16_t *in,
  ...
  if (block_width == 8) {
    copy_block_8xh(1, dest, dstride, in, block_height);
  } else {
    copy_block_4xh(1, dest, dstride, in, block_height);
  }
}
...
void SIMD_FUNC(cdef_filter_16_0)(void *dest, int dstride, const uint16_t *in,
                                 ...
                                 int block_height) {
  if (block_width == 8) {
    filter_block_8x8(0, dest, dstride, in, pri_strength,
                     sec_strength, dir, pri_damping, sec_damping, coeff_shift,
                     block_height, 1,
                     1);
  } else {
    filter_block_4x4(0, dest, dstride, in, pri_strength,
                     sec_strength, dir, pri_damping, sec_damping, coeff_shift,
                     block_height, 1,
                     1);
  }
...
void SIMD_FUNC(cdef_filter_16_3)(void *dest, int dstride, const uint16_t *in,
  ...
  (void)block_width;
  if (block_width == 8) {
    copy_block_8xh(0, dest, dstride, in, block_height);
  } else {
    copy_block_4xh(0, dest, dstride, in, block_height);
  }
}
