...
void av1_highbd_iht4x4_16_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_4[] = {
    { highbd_idct4, highbd_idct4 },    
    { highbd_iadst4, highbd_idct4 },   
    { highbd_idct4, highbd_iadst4 },   
    ...
    { highbd_idct4, highbd_iidtx4_c },     
    { highbd_iidtx4_c, highbd_idct4 },     
    { highbd_iadst4, highbd_iidtx4_c },    
    { highbd_iidtx4_c, highbd_iadst4 },    
    { highbd_iadst4, highbd_iidtx4_c },    
    { highbd_iidtx4_c, highbd_iadst4 },    
#endif                                     
  };
...
void av1_highbd_iht4x8_32_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_4x8[] = {
    { highbd_idct8, highbd_idct4 },    
    { highbd_iadst8, highbd_idct4 },   
    { highbd_idct8, highbd_iadst4 },   
    { highbd_iadst8, highbd_iadst4 },  
#if CONFIG_EXT_TX
    { highbd_iadst8, highbd_idct4 },       
    { highbd_idct8, highbd_iadst4 },       
    { highbd_iadst8, highbd_iadst4 },      
    ...
    { highbd_idct8, highbd_iidtx4_c },     
    { highbd_iidtx8_c, highbd_idct4 },     
    { highbd_iadst8, highbd_iidtx4_c },    
    { highbd_iidtx8_c, highbd_iadst4 },    
    { highbd_iadst8, highbd_iidtx4_c },    
    { highbd_iidtx8_c, highbd_iadst4 },    
#endif                                     
  };
...
void av1_highbd_iht8x4_32_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_8x4[] = {
    { highbd_idct4, highbd_idct8 },    
    { highbd_iadst4, highbd_idct8 },   
    { highbd_idct4, highbd_iadst8 },   
    { highbd_iadst4, highbd_iadst8 },  
#if CONFIG_EXT_TX
    { highbd_iadst4, highbd_idct8 },       
    { highbd_idct4, highbd_iadst8 },       
    { highbd_iadst4, highbd_iadst8 },      
    ...
    { highbd_idct4, highbd_iidtx8_c },     
    { highbd_iidtx4_c, highbd_idct8 },     
    { highbd_iadst4, highbd_iidtx8_c },    
    { highbd_iidtx4_c, highbd_iadst8 },    
    { highbd_iadst4, highbd_iidtx8_c },    
    { highbd_iidtx4_c, highbd_iadst8 },    
#endif                                     
  };
...
void av1_highbd_iht4x16_64_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_4x16[] = {
    { highbd_idct16, highbd_idct4 },    
    { highbd_iadst16, highbd_idct4 },   
    { highbd_idct16, highbd_iadst4 },   
    { highbd_iadst16, highbd_iadst4 },  
#if CONFIG_EXT_TX
    { highbd_iadst16, highbd_idct4 },       
    { highbd_idct16, highbd_iadst4 },       
    { highbd_iadst16, highbd_iadst4 },      
    ...
    { highbd_idct16, highbd_iidtx4_c },     
    { highbd_iidtx16_c, highbd_idct4 },     
    { highbd_iadst16, highbd_iidtx4_c },    
    { highbd_iidtx16_c, highbd_iadst4 },    
    { highbd_iadst16, highbd_iidtx4_c },    
    { highbd_iidtx16_c, highbd_iadst4 },    
#endif                                      
  };
...
void av1_highbd_iht16x4_64_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_16x4[] = {
    { highbd_idct4, highbd_idct16 },    
    { highbd_iadst4, highbd_idct16 },   
    { highbd_idct4, highbd_iadst16 },   
    { highbd_iadst4, highbd_iadst16 },  
#if CONFIG_EXT_TX
    { highbd_iadst4, highbd_idct16 },       
    { highbd_idct4, highbd_iadst16 },       
    { highbd_iadst4, highbd_iadst16 },      
    ...
    { highbd_idct4, highbd_iidtx16_c },     
    { highbd_iidtx4_c, highbd_idct16 },     
    { highbd_iadst4, highbd_iidtx16_c },    
    { highbd_iidtx4_c, highbd_iadst16 },    
    { highbd_iadst4, highbd_iidtx16_c },    
    { highbd_iidtx4_c, highbd_iadst16 },    
#endif                                      
  };
...
void av1_highbd_iht8x16_128_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_8x16[] = {
    { highbd_idct16, highbd_idct8 },    
    { highbd_iadst16, highbd_idct8 },   
    { highbd_idct16, highbd_iadst8 },   
    { highbd_iadst16, highbd_iadst8 },  
#if CONFIG_EXT_TX
    { highbd_iadst16, highbd_idct8 },       
    { highbd_idct16, highbd_iadst8 },       
    { highbd_iadst16, highbd_iadst8 },      
    ...
    { highbd_idct16, highbd_iidtx8_c },     
    { highbd_iidtx16_c, highbd_idct8 },     
    { highbd_iadst16, highbd_iidtx8_c },    
    { highbd_iidtx16_c, highbd_iadst8 },    
    { highbd_iadst16, highbd_iidtx8_c },    
    { highbd_iidtx16_c, highbd_iadst8 },    
#endif                                      
  };
...
void av1_highbd_iht16x8_128_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_16x8[] = {
    { highbd_idct8, highbd_idct16 },    
    { highbd_iadst8, highbd_idct16 },   
    { highbd_idct8, highbd_iadst16 },   
    { highbd_iadst8, highbd_iadst16 },  
#if CONFIG_EXT_TX
    { highbd_iadst8, highbd_idct16 },       
    { highbd_idct8, highbd_iadst16 },       
    { highbd_iadst8, highbd_iadst16 },      
    ...
    { highbd_idct8, highbd_iidtx16_c },     
    { highbd_iidtx8_c, highbd_idct16 },     
    { highbd_iadst8, highbd_iidtx16_c },    
    { highbd_iidtx8_c, highbd_iadst16 },    
    { highbd_iadst8, highbd_iidtx16_c },    
    { highbd_iidtx8_c, highbd_iadst16 },    
#endif                                      
  };
...
void av1_highbd_iht8x32_256_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_8x32[] = {
    { highbd_idct32, highbd_idct8 },           
    { highbd_ihalfright32_c, highbd_idct8 },   
    { highbd_idct32, highbd_iadst8 },          
    { highbd_ihalfright32_c, highbd_iadst8 },  
#if CONFIG_EXT_TX
    { highbd_ihalfright32_c, highbd_idct8 },     
    { highbd_idct32, highbd_iadst8 },            
    { highbd_ihalfright32_c, highbd_iadst8 },    
    ...
    { highbd_idct32, highbd_iidtx8_c },          
    { highbd_iidtx32_c, highbd_idct8 },          
    { highbd_ihalfright32_c, highbd_iidtx8_c },  
    { highbd_iidtx32_c, highbd_iadst8 },         
    { highbd_ihalfright32_c, highbd_iidtx8_c },  
    { highbd_iidtx32_c, highbd_iadst8 },         
#endif                                           
  };
...
void av1_highbd_iht32x8_256_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_32x8[] = {
    { highbd_idct8, highbd_idct32 },           
    { highbd_iadst8, highbd_idct32 },          
    { highbd_idct8, highbd_ihalfright32_c },   
    { highbd_iadst8, highbd_ihalfright32_c },  
#if CONFIG_EXT_TX
    { highbd_iadst8, highbd_idct32 },            
    { highbd_idct8, highbd_ihalfright32_c },     
    { highbd_iadst8, highbd_ihalfright32_c },    
    ...
    { highbd_idct8, highbd_iidtx32_c },          
    { highbd_iidtx8_c, highbd_idct32 },          
    { highbd_iadst8, highbd_iidtx32_c },         
...
void av1_highbd_iht16x32_512_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_16x32[] = {
    { highbd_idct32, highbd_idct16 },           
    { highbd_ihalfright32_c, highbd_idct16 },   
    { highbd_idct32, highbd_iadst16 },          
    { highbd_ihalfright32_c, highbd_iadst16 },  
#if CONFIG_EXT_TX
    { highbd_ihalfright32_c, highbd_idct16 },     
    { highbd_idct32, highbd_iadst16 },            
    { highbd_ihalfright32_c, highbd_iadst16 },    
    ...
    { highbd_idct32, highbd_iidtx16_c },          
    { highbd_iidtx32_c, highbd_idct16 },          
    { highbd_ihalfright32_c, highbd_iidtx16_c },  
    { highbd_iidtx32_c, highbd_iadst16 },         
    { highbd_ihalfright32_c, highbd_iidtx16_c },  
    { highbd_iidtx32_c, highbd_iadst16 },         
#endif                                            
  };
...
void av1_highbd_iht32x16_512_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_32x16[] = {
    { highbd_idct16, highbd_idct32 },           
    { highbd_iadst16, highbd_idct32 },          
    { highbd_idct16, highbd_ihalfright32_c },   
    { highbd_iadst16, highbd_ihalfright32_c },  
#if CONFIG_EXT_TX
    { highbd_iadst16, highbd_idct32 },            
    { highbd_idct16, highbd_ihalfright32_c },     
    { highbd_iadst16, highbd_ihalfright32_c },    
    ...
    { highbd_idct16, highbd_iidtx32_c },          
    { highbd_iidtx16_c, highbd_idct32 },          
    { highbd_iadst16, highbd_iidtx32_c },         
...
void av1_highbd_iht8x8_64_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_8[] = {
    { highbd_idct8, highbd_idct8 },    
    { highbd_iadst8, highbd_idct8 },   
    { highbd_idct8, highbd_iadst8 },   
    ...
    { highbd_idct8, highbd_iidtx8_c },     
    { highbd_iidtx8_c, highbd_idct8 },     
    { highbd_iadst8, highbd_iidtx8_c },    
    { highbd_iidtx8_c, highbd_iadst8 },    
    { highbd_iadst8, highbd_iidtx8_c },    
    { highbd_iidtx8_c, highbd_iadst8 },    
#endif                                     
  };
...
void av1_highbd_iht16x16_256_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_16[] = {
    { highbd_idct16, highbd_idct16 },    
    { highbd_iadst16, highbd_idct16 },   
    { highbd_idct16, highbd_iadst16 },   
    ...
    { highbd_idct16, highbd_iidtx16_c },     
    { highbd_iidtx16_c, highbd_idct16 },     
    { highbd_iadst16, highbd_iidtx16_c },    
    { highbd_iidtx16_c, highbd_iadst16 },    
    { highbd_iadst16, highbd_iidtx16_c },    
    { highbd_iidtx16_c, highbd_iadst16 },    
#endif                                       
  };
...
static void highbd_iht32x32_1024_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_32[] = {
    { highbd_idct32, highbd_idct32 },                  
    { highbd_ihalfright32_c, highbd_idct32 },          
    { highbd_idct32, highbd_ihalfright32_c },          
    ...
    { highbd_idct32, highbd_iidtx32_c },               
    { highbd_iidtx32_c, highbd_idct32 },               
