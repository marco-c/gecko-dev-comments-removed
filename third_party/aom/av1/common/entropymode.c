...
static const aom_prob default_inter_compound_mode_probs
    [INTER_MODE_CONTEXTS][INTER_COMPOUND_MODES - 1] = {
      { 2, 173, 68, 192, 64, 192, 128, 180, 180 },   
      { 7, 145, 160, 192, 64, 192, 128, 180, 180 },  
      { 7, 166, 126, 192, 64, 192, 128, 180, 180 },  
      { 7, 94, 132, 192, 64, 192, 128, 180, 180 },   
      { 8, 64, 64, 192, 64, 192, 128, 180, 180 },    
      { 17, 81, 52, 192, 64, 192, 128, 180, 180 },   
      { 25, 29, 50, 192, 64, 192, 128, 180, 180 },   
    };
...
const aom_tree_index av1_interintra_mode_tree[TREE_SIZE(INTERINTRA_MODES)] = {
  ...
  8, 12,                            
  -II_H_PRED, 10,                   
  -II_D135_PRED, -II_D117_PRED,     
  -II_D45_PRED, 14,                 
  -II_D63_PRED, 16,                 
  -II_D153_PRED, -II_D207_PRED      
};
