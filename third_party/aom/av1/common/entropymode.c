...
static const aom_prob
    default_partition_probs[PARTITION_CONTEXTS][EXT_PARTITION_TYPES - 1] = {
      ...
      { 199, 122, 141, 128, 128, 128, 255, 128, 255 },  
      { 147, 63, 159, 128, 128, 128, 255, 128, 255 },   
      { 148, 133, 118, 128, 128, 128, 255, 128, 255 },  
      { 121, 104, 114, 128, 128, 128, 255, 128, 255 },  
      
      { 174, 73, 87, 128, 128, 128, 255, 128, 255 },  
      { 92, 41, 83, 128, 128, 128, 255, 128, 255 },   
      { 82, 99, 50, 128, 128, 128, 255, 128, 255 },   
      { 53, 39, 39, 128, 128, 128, 255, 128, 255 },   
      
      { 177, 58, 59, 128, 128, 85, 128, 85, 128 },  
      { 68, 26, 63, 128, 128, 85, 128, 85, 128 },   
      { 52, 79, 25, 128, 128, 85, 128, 85, 128 },   
      { 17, 14, 12, 128, 128, 85, 128, 85, 128 },   
      
      { 222, 34, 30, 128, 128, 128, 255, 128, 255 },  
      { 72, 16, 44, 128, 128, 128, 255, 128, 255 },   
      { 58, 32, 12, 128, 128, 128, 255, 128, 255 },   
      { 10, 7, 6, 128, 128, 128, 255, 128, 255 },     
...
static const aom_prob default_inter_compound_mode_probs
    [INTER_MODE_CONTEXTS][INTER_COMPOUND_MODES - 1] = {
      { 154, 167, 233, 165, 143, 170, 167 },  
      { 75, 168, 237, 155, 135, 176, 172 },   
      { 7, 173, 227, 128, 153, 188, 189 },    
      { 8, 120, 214, 113, 154, 178, 174 },    
      { 4, 85, 194, 94, 155, 173, 167 },      
      { 23, 89, 180, 73, 157, 151, 155 },     
      { 27, 49, 152, 91, 134, 153, 142 },     
    };
...
static const aom_prob
    default_ncobmc_mode_prob[ADAPT_OVERLAP_BLOCKS][MAX_NCOBMC_MODES - 1] = {
      { 23, 37, 37, 38, 65, 71, 81, 86 },   
      { 28, 32, 37, 43, 51, 64, 85, 128 },  
      { 86, 22, 32, 25, 10, 40, 97, 65 },   
      { 28, 32, 37, 43, 51, 64, 85, 128 }   
    };
static const aom_cdf_prob
