...
static const fwd_transform_1d_col_many_neon
    col_highbd_txfm8_xn_arr[TX_TYPES] = {
      highbd_fdct8_col_many_neon,       
      highbd_fadst8_col_many_neon,      
      highbd_fdct8_col_many_neon,       
      highbd_fadst8_col_many_neon,      
      highbd_fadst8_col_many_neon,      
      highbd_fdct8_col_many_neon,       
      ...
      highbd_fadst8_col_many_neon,      
      highbd_fadst8_col_many_neon,      
      highbd_fidentity8_col_many_neon,  
      highbd_fdct8_col_many_neon,       
      highbd_fidentity8_col_many_neon,  
      highbd_fadst8_col_many_neon,      
      highbd_fidentity8_col_many_neon,  
...
static const fwd_transform_1d_col_neon col_highbd_txfm8_x4_arr[TX_TYPES] = {
  highbd_fdct8_col_neon,       
  highbd_fadst8_col_neon,      
  highbd_fdct8_col_neon,       
  highbd_fadst8_col_neon,      
  highbd_fadst8_col_neon,      
  highbd_fdct8_col_neon,       
...
static const fwd_transform_1d_col_many_neon
    col_highbd_txfm16_xn_arr[TX_TYPES] = {
      ...
      highbd_fadst16_col_many_neon,      
      highbd_fadst16_col_many_neon,      
      highbd_fidentity16_col_many_neon,  
      highbd_fdct16_col_many_neon,       
      highbd_fidentity16_col_many_neon,  
      highbd_fadst16_col_many_neon,      
      highbd_fidentity16_col_many_neon,  
...
static const fwd_transform_1d_col_many_neon
    col_highbd_txfm4_xn_arr[TX_TYPES] = {
      highbd_fdct4_col_many_neon,       
      highbd_fadst4_col_many_neon,      
      highbd_fdct4_col_many_neon,       
      highbd_fadst4_col_many_neon,      
      highbd_fadst4_col_many_neon,      
      highbd_fdct4_col_many_neon,       
      ...
      highbd_fadst4_col_many_neon,      
      highbd_fadst4_col_many_neon,      
      highbd_fidentity4_col_many_neon,  
      highbd_fdct4_col_many_neon,       
      highbd_fidentity4_col_many_neon,  
      highbd_fadst4_col_many_neon,      
      highbd_fidentity4_col_many_neon,  
...
static const fwd_transform_1d_row_neon row_highbd_txfm16_xn_arr[TX_TYPES] = {
  highbd_fdct16_row_neon,       
  highbd_fdct16_row_neon,       
  highbd_fadst16_row_neon,      
  highbd_fadst16_row_neon,      
  highbd_fdct16_row_neon,       
  highbd_fadst16_row_neon,      
  highbd_fadst16_row_neon,      
...
static const fwd_transform_1d_row_many_neon
    row_rect_highbd_txfm16_xn_arr[TX_TYPES] = {
      highbd_fdct16_row_rect_many_neon,       
      highbd_fdct16_row_rect_many_neon,       
      highbd_fadst16_row_rect_many_neon,      
      highbd_fadst16_row_rect_many_neon,      
      highbd_fdct16_row_rect_many_neon,       
      highbd_fadst16_row_rect_many_neon,      
      highbd_fadst16_row_rect_many_neon,      
      highbd_fadst16_row_rect_many_neon,      
      highbd_fadst16_row_rect_many_neon,      
      highbd_fidentity16_row_rect_many_neon,  
      highbd_fidentity16_row_rect_many_neon,  
      highbd_fdct16_row_rect_many_neon,       
      highbd_fidentity16_row_rect_many_neon,  
      highbd_fadst16_row_rect_many_neon,      
...
static const fwd_transform_1d_row_many_neon
    row_highbd_txfm8_xn_arr[TX_TYPES] = {
      highbd_fdct8_row_many_neon,       
      highbd_fdct8_row_many_neon,       
      highbd_fadst8_row_many_neon,      
      highbd_fadst8_row_many_neon,      
      highbd_fdct8_row_many_neon,       
      highbd_fadst8_row_many_neon,      
      highbd_fadst8_row_many_neon,      
      highbd_fadst8_row_many_neon,      
      highbd_fadst8_row_many_neon,      
      highbd_fidentity8_row_many_neon,  
      highbd_fidentity8_row_many_neon,  
      highbd_fdct8_row_many_neon,       
      highbd_fidentity8_row_many_neon,  
      highbd_fadst8_row_many_neon,      
...
static const fwd_transform_1d_row_many_neon
    row_rect_highbd_txfm8_xn_arr[TX_TYPES] = {
      highbd_fdct8_row_rect_many_neon,       
      highbd_fdct8_row_rect_many_neon,       
      highbd_fadst8_row_rect_many_neon,      
      highbd_fadst8_row_rect_many_neon,      
      highbd_fdct8_row_rect_many_neon,       
      highbd_fadst8_row_rect_many_neon,      
      highbd_fadst8_row_rect_many_neon,      
      highbd_fadst8_row_rect_many_neon,      
      highbd_fadst8_row_rect_many_neon,      
      highbd_fidentity8_row_rect_many_neon,  
      highbd_fidentity8_row_rect_many_neon,  
      highbd_fdct8_row_rect_many_neon,       
      highbd_fidentity8_row_rect_many_neon,  
      highbd_fadst8_row_rect_many_neon,      
...
static const fwd_transform_1d_row_neon row_highbd_txfm8_x4_arr[TX_TYPES] = {
  ...
  highbd_fadst8_row_rect_neon,      
  highbd_fadst8_row_rect_neon,      
  highbd_fidentity8_row_rect_neon,  
  highbd_fidentity8_row_rect_neon,  
  highbd_fdct8_row_rect_neon,       
  highbd_fidentity8_row_rect_neon,  
  highbd_fadst8_row_rect_neon,      
...
static const fwd_transform_1d_row_many_neon
    row_highbd_txfm4_xn_arr[TX_TYPES] = {
      ...
      highbd_fadst4_row_many_neon,      
      highbd_fadst4_row_many_neon,      
      highbd_fidentity4_row_many_neon,  
      highbd_fidentity4_row_many_neon,  
      highbd_fdct4_row_many_neon,       
      highbd_fidentity4_row_many_neon,  
      highbd_fadst4_row_many_neon,      
...
static const fwd_transform_1d_row_many_neon
    row_rect_highbd_txfm4_xn_arr[TX_TYPES] = {
      highbd_fdct4_row_rect_many_neon,       
      highbd_fdct4_row_rect_many_neon,       
      highbd_fadst4_row_rect_many_neon,      
      highbd_fadst4_row_rect_many_neon,      
      highbd_fdct4_row_rect_many_neon,       
      highbd_fadst4_row_rect_many_neon,      
      highbd_fadst4_row_rect_many_neon,      
      highbd_fadst4_row_rect_many_neon,      
      highbd_fadst4_row_rect_many_neon,      
      highbd_fidentity4_row_rect_many_neon,  
      highbd_fidentity4_row_rect_many_neon,  
      highbd_fdct4_row_rect_many_neon,       
      highbd_fidentity4_row_rect_many_neon,  
      highbd_fadst4_row_rect_many_neon,      
...
static const fwd_transform_1d_col_many_neon
    col_highbd_txfm32_x4_arr[TX_TYPES] = {
      ...
      NULL,                              
      NULL,                              
      highbd_fidentity32_col_many_neon,  
      NULL,                              
      NULL,                              
      NULL,                              
      NULL,                              
...
static const fwd_transform_1d_row_many_neon
    row_highbd_txfm32_x4_arr[TX_TYPES] = {
      ...
      NULL,                              
      NULL,                              
      highbd_fidentity32_row_many_neon,  
      NULL,                              
      NULL,                              
      NULL,                              
      NULL,                              
...
static const fwd_transform_1d_row_many_neon
    row_rect_highbd_txfm32_x4_arr[TX_TYPES] = {
      highbd_fdct32_row_rect_many_neon,       
      NULL,                                   
      NULL,                                   
      NULL,                                   
      NULL,                                   
      ...
      NULL,                                   
      NULL,                                   
      highbd_fidentity32_row_rect_many_neon,  
      NULL,                                   
      NULL,                                   
      NULL,                                   
      NULL,                                   
...
void av1_fwd_txfm2d_16x8_neon(const int16_t *input, int32_t *coeff, int stride,
  ...
  int32x4_t buf0[32];
  if (lr_flip) {
    col_txfm(input, buf0 + 3 * 8, stride, bit, 1, 4,
             -8);
  } else {
    col_txfm(input, buf0, stride, bit, 0, 4,
             8);
  }
...
void av1_fwd_txfm2d_8x16_neon(const int16_t *input, int32_t *coeff, int stride,
  ...
  int32x4_t buf0[32];
  if (lr_flip) {
    col_txfm(input, buf0 + 16, stride, bit, 1, 2,
             -16);
  } else {
    col_txfm(input, buf0, stride, bit, 0, 2,
             16);
  }
  shift_right_2_round_s32_x4(buf0, buf0, 32);
...
void av1_fwd_txfm2d_4x16_neon(const int16_t *input, int32_t *coeff, int stride,
  ...
  int32x4_t buf0[16];
  if (lr_flip) {
    col_txfm(input, buf0, stride, bitcol, 1, 1,
             0);
  } else {
    col_txfm(input, buf0, stride, bitcol, 0, 1,
             0);
  }
  shift_right_1_round_s32_x4(buf0, buf0, 16);
...
void av1_fwd_txfm2d_16x4_neon(const int16_t *input, int32_t *coeff, int stride,
  ...
  int32x4_t buf0[16];
  if (lr_flip) {
    col_txfm(input, buf0 + 3 * 4, stride, bitcol, 1, 4,
             -4);
  } else {
    col_txfm(input, buf0, stride, bitcol, 0, 4,
             4);
  }
...
void av1_fwd_txfm2d_32x16_neon(const int16_t *input, int32_t *coeff, int stride,
  ...
  int32x4_t buf0[128];
  col_txfm(input, buf0, stride, bitcol, 0, 8,
           16);
  shift_right_4_round_s32_x4(buf0, buf0, 128);
...
void av1_fwd_txfm2d_8x32_neon(const int16_t *input, int32_t *coeff, int stride,
  ...
  int32x4_t buf0[64];
  col_txfm(input, buf0, stride, bitcol, 0, 2,
           32);
  shift_right_2_round_s32_x4(buf0, buf0, 64);
...
void av1_fwd_txfm2d_8x4_neon(const int16_t *input, int32_t *coeff, int stride,
  ...
  int32x4_t buf0[8];
  if (lr_flip) {
    col_txfm(input, buf0 + 4, stride, bitcol, 1, 2,
             -4);
  } else {
    col_txfm(input, buf0, stride, bitcol, 0, 2,
             4);
...
void av1_fwd_txfm2d_32x32_neon(const int16_t *input, int32_t *output,
  ...
  int32x4_t buf0[256];
  col_txfm(input, buf0, stride, 12, 0, 8,
           32);
  shift_right_4_round_s32_x4(buf0, buf0, 256);
