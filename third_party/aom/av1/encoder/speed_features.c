...
static void set_good_speed_feature_framesize_dependent(AV1_COMP *cpi,
  ...
  if (!is_720p_or_larger) {
    sf->ml_partition_search_breakout_thresh[0] = 200;  
    sf->ml_partition_search_breakout_thresh[1] = 250;  
    sf->ml_partition_search_breakout_thresh[2] = 300;  
    sf->ml_partition_search_breakout_thresh[3] = 500;  
    sf->ml_partition_search_breakout_thresh[4] = -1;   
  }
  ...
  if (speed >= 1) {
    ...
    if (!is_720p_or_larger) {
      ...
      sf->ml_partition_search_breakout_thresh[1] = 250;  
      sf->ml_partition_search_breakout_thresh[2] = 300;  
      sf->ml_partition_search_breakout_thresh[3] = 300;  
      sf->ml_partition_search_breakout_thresh[4] = -1;   
    }
  }
