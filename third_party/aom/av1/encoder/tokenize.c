...
const av1_extra_bit av1_extra_bits[ENTROPY_TOKENS] = {
  ...
  { 0, 0, 3, sign_cost },                        
  { 0, 0, 4, sign_cost },                        
  { av1_cat1_cdf, 1, CAT1_MIN_VAL, cat1_cost },  
  { av1_cat2_cdf, 2, CAT2_MIN_VAL, cat2_cost },  
  { av1_cat3_cdf, 3, CAT3_MIN_VAL, cat3_cost },  
  { av1_cat4_cdf, 4, CAT4_MIN_VAL, cat4_cost },  
  { av1_cat5_cdf, 5, CAT5_MIN_VAL, cat5_cost },  
  { av1_cat6_cdf, 18, CAT6_MIN_VAL, 0 },         
  { 0, 0, 0, zero_cost }                         
};
#else
const av1_extra_bit av1_extra_bits[ENTROPY_TOKENS] = {
  ...
  { 0, 0, 3, sign_cost },                         
  { 0, 0, 4, sign_cost },                         
  { av1_cat1_prob, 1, CAT1_MIN_VAL, cat1_cost },  
  { av1_cat2_prob, 2, CAT2_MIN_VAL, cat2_cost },  
  { av1_cat3_prob, 3, CAT3_MIN_VAL, cat3_cost },  
  { av1_cat4_prob, 4, CAT4_MIN_VAL, cat4_cost },  
  { av1_cat5_prob, 5, CAT5_MIN_VAL, cat5_cost },  
  { av1_cat6_prob, 18, CAT6_MIN_VAL, 0 },         
  { 0, 0, 0, zero_cost }                          
};
#endif
