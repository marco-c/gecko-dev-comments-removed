...
void av1_source_content_sb(AV1_COMP *cpi, MACROBLOCK *x, TileDataEnc *tile_data,
  ...
  uint64_t avg_source_sse_threshold_verylow = 10000;     
  uint64_t avg_source_sse_threshold_low[2] = { 100000,   
                                               36000 };  

  uint64_t avg_source_sse_threshold_high = 1000000;  
...
void av1_set_cost_upd_freq(AV1_COMP *cpi, ThreadData *td,
  ...
  switch (cpi->sf.inter_sf.coeff_cost_upd_level) {
    ...
    case INTERNAL_COST_UPD_TILE:  
      break;
    case INTERNAL_COST_UPD_SBROW_SET:  
    case INTERNAL_COST_UPD_SBROW:      
    case INTERNAL_COST_UPD_SB:         
