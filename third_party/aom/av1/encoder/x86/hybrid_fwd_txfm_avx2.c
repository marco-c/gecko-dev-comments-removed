...
static void fdct16_avx2(__m256i *in) {
  ...
  v2 = butter_fly(&x0, &x1, &cospi_p16_p16);  
  v1 = butter_fly(&x0, &x1, &cospi_p16_m16);  

  s0 = _mm256_add_epi16(v0, v1);  
  s1 = _mm256_sub_epi16(v0, v1);  
  s2 = _mm256_sub_epi16(v3, v2);  
  s3 = _mm256_add_epi16(v3, v2);  
