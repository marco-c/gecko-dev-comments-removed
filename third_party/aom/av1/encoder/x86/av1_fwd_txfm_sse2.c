...
static void fdct4x4_new_sse2(const __m128i *input, __m128i *output,
  ...
  u[0] = _mm_madd_epi16(v[0], cospi_p32_p32);  
  u[1] = _mm_madd_epi16(v[0], cospi_p32_m32);  
  u[2] = _mm_madd_epi16(v[1], cospi_p16_p48);  
  u[3] = _mm_madd_epi16(v[1], cospi_p48_m16);  
...
static void fadst4x4_new_sse2(const __m128i *input, __m128i *output,
  ...
  v[0] = _mm_madd_epi16(u[0], sinpi_p01_p02);  
  v[1] = _mm_madd_epi16(u[1], sinpi_p03_p04);  
  v[2] = _mm_madd_epi16(u[2], sinpi_p03_p03);  
  v[3] = _mm_madd_epi16(u[0], sinpi_p04_m01);  
  v[4] = _mm_madd_epi16(u[1], sinpi_m03_p02);  
  v[5] = _mm_madd_epi16(u[3], sinpi_p03_p03);  
...
static void fadst8x4_new_sse2(const __m128i *input, __m128i *output,
  ...
  v_lo[0] = _mm_madd_epi16(u_lo[0], sinpi_p01_p02);  
  v_hi[0] = _mm_madd_epi16(u_hi[0], sinpi_p01_p02);  
  v_lo[1] = _mm_madd_epi16(u_lo[1], sinpi_p03_p04);  
  v_hi[1] = _mm_madd_epi16(u_hi[1], sinpi_p03_p04);  
  v_lo[2] = _mm_madd_epi16(u_lo[2], sinpi_p03_p03);  
  v_hi[2] = _mm_madd_epi16(u_hi[2], sinpi_p03_p03);  
  v_lo[3] = _mm_madd_epi16(u_lo[0], sinpi_p04_m01);  
  v_hi[3] = _mm_madd_epi16(u_hi[0], sinpi_p04_m01);  
  v_lo[4] = _mm_madd_epi16(u_lo[1], sinpi_m03_p02);  
  v_hi[4] = _mm_madd_epi16(u_hi[1], sinpi_m03_p02);  
  v_lo[5] = _mm_madd_epi16(u_lo[3], sinpi_p03_p03);  
  v_hi[5] = _mm_madd_epi16(u_hi[3], sinpi_p03_p03);  
