...
struct Pack8<5> {
  ...
  HWY_INLINE void Unpack(D8 d8, const uint8_t* HWY_RESTRICT packed_in,
    ...
    const VU16 mask = Set(d16, 0x1F1Fu);  
...
struct Pack8<6> {
  ...
  HWY_INLINE void Unpack(D8 d8, const uint8_t* HWY_RESTRICT packed_in,
    ...
    using VU16 = Vec<decltype(d16)>;
    const size_t N8 = Lanes(d8);
    const VU16 mask = Set(d16, 0x3F3Fu);  
...
struct Pack8<7> {
  ...
  HWY_INLINE void Unpack(D8 d8, const uint8_t* HWY_RESTRICT packed_in,
    ...
    const VU16 mask = Set(d16, 0x7F7Fu);  
...
struct Pack16<3> {
  ...
  HWY_INLINE void Pack(D d, const uint16_t* HWY_RESTRICT raw,
    ...
    packed0 = Or(packed0, ShiftLeft<15>(rawF));  
...
struct Pack16<4> {
  ...
  HWY_INLINE void Unpack(D d, const uint16_t* HWY_RESTRICT packed_in,
    ...
    const VU16 raw6 = ShiftRight<12>(packed0);  
    StoreU(raw6, d, raw + 6 * N);

    const VU16 raw7 = ShiftRight<12>(packed1);  
    StoreU(raw7, d, raw + 7 * N);
    ...
    const VU16 rawE = ShiftRight<12>(packed2);  
    StoreU(rawE, d, raw + 0xE * N);

    const VU16 rawF = ShiftRight<12>(packed3);  
    StoreU(rawF, d, raw + 0xF * N);
  }
};  
...
struct Pack16<6> {
  ...
  HWY_INLINE void Unpack(D d, const uint16_t* HWY_RESTRICT packed_in,
    ...
    const VU16 raw7 = ShiftRight<6>(packed3);  
    StoreU(raw7, d, raw + 7 * N);

    const VU16 rawF = ShiftRight<6>(packed7);  
    StoreU(rawF, d, raw + 0xF * N);
  }
};  
...
struct Pack16<7> {
  ...
  HWY_INLINE void Unpack(D d, const uint16_t* HWY_RESTRICT packed_in,
    ...
    const VU16 rawF = ShiftRight<7>(packed7);  
    StoreU(rawF, d, raw + 0xF * N);
  }
};  
...
struct Pack16<8> {
  ...
  HWY_INLINE void Unpack(D d, const uint16_t* HWY_RESTRICT packed_in,
    ...
    const VU16 raw2 = ShiftRight<8>(packed0);  
    StoreU(raw2, d, raw + 2 * N);

    const VU16 raw3 = ShiftRight<8>(packed1);  
    StoreU(raw3, d, raw + 3 * N);
    ...
    const VU16 raw6 = ShiftRight<8>(packed2);  
    StoreU(raw6, d, raw + 6 * N);

    const VU16 raw7 = ShiftRight<8>(packed3);  
    StoreU(raw7, d, raw + 7 * N);
    ...
    const VU16 rawA = ShiftRight<8>(packed4);  
    StoreU(rawA, d, raw + 0xA * N);

    const VU16 rawB = ShiftRight<8>(packed5);  
    StoreU(rawB, d, raw + 0xB * N);
    ...
    const VU16 rawE = ShiftRight<8>(packed6);  
    StoreU(rawE, d, raw + 0xE * N);

    const VU16 rawF = ShiftRight<8>(packed7);  
    StoreU(rawF, d, raw + 0xF * N);
  }
};  
