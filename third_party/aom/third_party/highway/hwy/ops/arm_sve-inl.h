...
HWY_API svint8_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
...
HWY_API svuint8_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
                                      TFromD<D> t2, TFromD<D> t3, TFromD<D> t4,
                                      TFromD<D> t5, TFromD<D> t6, TFromD<D> t7,
                                      TFromD<D> t8, TFromD<D> t9, TFromD<D> t10,
                                      TFromD<D> t11, TFromD<D> t12,
...
HWY_API svint16_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
                                      TFromD<D> t2, TFromD<D> t3, TFromD<D> t4,
...
HWY_API svuint16_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
                                       TFromD<D> t2, TFromD<D> t3, TFromD<D> t4,
                                       TFromD<D> t5, TFromD<D> t6,
                                       TFromD<D> t7) {
...
HWY_API svfloat16_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
...
HWY_API svint32_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
                                      TFromD<D> t2, TFromD<D> t3) {
  return svdupq_n_s32(t0, t1, t2, t3);
}

template <class D, HWY_IF_U32_D(D)>
HWY_API svuint32_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
                                       TFromD<D> t2, TFromD<D> t3) {
  return svdupq_n_u32(t0, t1, t2, t3);
}

template <class D, HWY_IF_F32_D(D)>
HWY_API svfloat32_t Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> t1,
                                        TFromD<D> t2, TFromD<D> t3) {
...
HWY_API TFromD<D> MaskedReduceSum(D , M m, VFromD<D> v) {
  return detail::SumOfLanesM(m, v);
}
template <class D, class M>
HWY_API TFromD<D> MaskedReduceMin(D , M m, VFromD<D> v) {
  return detail::MinOfLanesM(m, v);
}
template <class D, class M>
HWY_API TFromD<D> MaskedReduceMax(D , M m, VFromD<D> v) {
...
HWY_API VBF16 DemoteTo(Simd<bfloat16_t, N, kPow2> dbf16, svfloat32_t v) {
  ...
  return BitCast(dbf16, detail::ConcatOddFull(in_odd, in_odd));  
#endif
}
...
HWY_API V InterleaveLowerBlocks(D d, V a, V b) {
  ...
  svuint64_t even = detail::InterleaveEven(a64, b64);  
  svuint64_t odd = detail::InterleaveOdd(a64, b64);    
...
HWY_API V InterleaveUpperBlocks(D d, V a, V b) {
  ...
  HWY_IF_CONSTEXPR(detail::IsFull(d)) {
    return BitCast(d, detail::ZipUpperSame(even, odd));  
  }
...
#endif
  (void)d;
  const auto odd_in_even = detail::Ext<1>(v, v);  
...
HWY_API VBF16 OrderedDemote2To(Simd<bfloat16_t, N, kPow2> dbf16, svfloat32_t a,
  ...
  return BitCast(dbf16, ConcatOdd(du16, b_in_odd, a_in_odd));  
#endif
}
...
template <class DI32, HWY_IF_I32_D(DI32)>
HWY_API VFromD<DI32> SumOfMulQuadAccumulate(DI32 , svint8_t a,
...
HWY_API VFromD<DU32> SumOfMulQuadAccumulate(DU32 , svuint8_t a,
...
HWY_API VFromD<DI64> SumOfMulQuadAccumulate(DI64 , svint16_t a,
...
HWY_API VFromD<DU64> SumOfMulQuadAccumulate(DU64 , svuint16_t a,
