...
struct aom_codec_iface {
  ...
  aom_codec_init_fn_t init;           
  aom_codec_destroy_fn_t destroy;     
  aom_codec_ctrl_fn_map_t *ctrl_maps; 
  struct aom_codec_dec_iface {
    aom_codec_peek_si_fn_t peek_si; 
    aom_codec_get_si_fn_t get_si;   
    aom_codec_decode_fn_t decode;   
