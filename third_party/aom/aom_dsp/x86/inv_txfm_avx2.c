...
static INLINE void transpose_col_to_row_nz4x4(__m256i *in ) {
...
static INLINE void transpose_col_to_row_nz4x16(__m256i *in ) {
  int i;
  for (i = 0; i < 16; i += 4) {
...
static INLINE void idct16_10(__m256i *in ) {
  __m256i out[16];
...
void transpose_col_to_row_nz8x8(__m256i *in ) {
...
static INLINE void transpose_col_to_row_nz8x16(__m256i *in ) {
...
static INLINE void idct16_38(__m256i *in ) {
  __m256i out[16];
...
static void load_buffer_32x16(const tran_low_t *input, __m256i *in ) {
  int i;
  for (i = 0; i < 16; ++i) {
...
static void idct32_full_16x32_quarter_2(const __m256i *in ,
                                        __m256i *out ) {
...
static void idct32_full_16x32_quarter_1(const __m256i *in ,
                                        __m256i *out ) {
...
static void idct32_full_16x32_quarter_3_4(const __m256i *in ,
                                          __m256i *out ) {
...
static void idct32_full_16x32_quarter_1_2(const __m256i *in ,
                                          __m256i *out ) {
  __m256i temp[16];
...
static void idct32_16x32(const __m256i *in ,
                         __m256i *out ) {
  __m256i temp[32];
...
static void idct32_16x32_135_quarter_1(const __m256i *in ,
                                       __m256i *out ) {
  __m256i u0, u1, u2, u3, u4, u5, u6, u7;
  __m256i v0, v1, v2, v3, v4, v5, v6, v7;
...
static void idct32_16x32_135_quarter_2(const __m256i *in ,
                                       __m256i *out ) {
  __m256i u8, u9, u10, u11, u12, u13, u14, u15;
  __m256i v8, v9, v10, v11, v12, v13, v14, v15;
...
static void idct32_16x32_quarter_1_2(const __m256i *in ,
                                     __m256i *out ) {
  __m256i temp[16];
...
static void idct32_16x32_quarter_3_4(const __m256i *in ,
                                     __m256i *out ) {
  __m256i v16, v17, v18, v19, v20, v21, v22, v23;
  __m256i v24, v25, v26, v27, v28, v29, v30, v31;
  __m256i u16, u17, u18, u19, u20, u21, u22, u23;
...
static void idct32_16x32_135(__m256i *in ) {
  __m256i out[32];
...
static void idct32_34_first_half(const __m256i *in, __m256i *stp1) {
  ...
  u2 = _mm256_mulhrs_epi16(in[2], stk2_1);  
  u3 = _mm256_mulhrs_epi16(in[6], stk2_7);  
  v15 = _mm256_add_epi16(u2, u3);
  
  x0 = _mm256_mulhrs_epi16(in[0], stk4_0);  
  x7 = _mm256_mulhrs_epi16(in[4], stk3_1);  
  v0 = _mm256_add_epi16(x0, x7);            
  stp1[0] = _mm256_add_epi16(v0, v15);
  stp1[15] = _mm256_sub_epi16(v0, v15);

  
  u0 = _mm256_mulhrs_epi16(in[2], stk2_0);          
  u1 = _mm256_mulhrs_epi16(in[6], stk2_6);          
  ...
  x1 = _mm256_mulhrs_epi16(in[0], stk4_0);  
  
  x4 = _mm256_mulhrs_epi16(in[4], stk3_0);  
  butterfly(&x7, &x4, &stg4_1, &stg4_0, &x5, &x6);
  v1 = _mm256_add_epi16(x1, x6);  
  v2 = _mm256_add_epi16(x0, x5);  
  ...
  v3 = _mm256_add_epi16(x1, x4);  
  v4 = _mm256_sub_epi16(x1, x4);  

  v5 = _mm256_sub_epi16(x0, x5);  

  v6 = _mm256_sub_epi16(x1, x6);  
  v7 = _mm256_sub_epi16(x0, x7);  
...
static void idct32_16x32_34(__m256i *in ) {
  __m256i out[32];
