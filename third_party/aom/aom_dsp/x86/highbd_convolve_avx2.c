...
static INLINE void pack_pixels(const __m256i *s, __m256i *p ) {
  ...
  p[0] = _mm256_shuffle_epi8(*s, sf0);  
  p[1] = _mm256_shuffle_epi8(*s, sf1);  
  p[2] = _mm256_shuffle_epi8(c, sf0);   
  p[3] = _mm256_shuffle_epi8(c, sf1);   
}
...
static void pack_16x9_init(const uint16_t *src, ptrdiff_t pitch, __m256i *sig) {
  ...
  u0 = _mm256_permute2x128_si256(s0, s1, 0x20);  
  u1 = _mm256_permute2x128_si256(s0, s1, 0x31);  

  u2 = _mm256_permute2x128_si256(s1, s2, 0x20);  
  u3 = _mm256_permute2x128_si256(s1, s2, 0x31);  
