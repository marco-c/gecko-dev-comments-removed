...
static INLINE void load16_8to16_sse2(const uint8_t *const p, __m128i *out) {
  ...
  out[0] = _mm_unpacklo_epi8(p0, _mm_setzero_si128());  
  out[1] = _mm_unpackhi_epi8(p0, _mm_setzero_si128());  
}
...
AOM_VAR_LOOP_SSE2(32, 64, 11, 32)  

AOM_VAR_LOOP_SSE2(64, 32, 11, 16)   
AOM_VAR_LOOP_SSE2(64, 64, 12, 16)   
AOM_VAR_LOOP_SSE2(64, 128, 13, 16)  

AOM_VAR_LOOP_SSE2(128, 64, 13, 8)   
AOM_VAR_LOOP_SSE2(128, 128, 14, 8)  
