...
static void idct32_34_first_half(const __m128i *in, __m128i *stp1) {
  ...
  u2 = _mm_mulhrs_epi16(in[2], stk2_1);  
  u3 = _mm_mulhrs_epi16(in[6], stk2_7);  
  v15 = _mm_add_epi16(u2, u3);
  
  x0 = _mm_mulhrs_epi16(in[0], stk4_0);  
  x7 = _mm_mulhrs_epi16(in[4], stk3_1);  
  v0 = _mm_add_epi16(x0, x7);            
  stp1[0] = _mm_add_epi16(v0, v15);
  stp1[15] = _mm_sub_epi16(v0, v15);

  
  u0 = _mm_mulhrs_epi16(in[2], stk2_0);             
  u1 = _mm_mulhrs_epi16(in[6], stk2_6);             
  butterfly(&u0, &u2, &stg4_4, &stg4_5, &u4, &u5);  
  butterfly(&u1, &u3, &stg4_6, &stg4_4, &u6, &u7);  
  ...
  x1 = _mm_mulhrs_epi16(in[0], stk4_0);  
  
  x4 = _mm_mulhrs_epi16(in[4], stk3_0);  
  butterfly(&x7, &x4, &stg4_1, &stg4_0, &x5, &x6);
  v1 = _mm_add_epi16(x1, x6);  
  v2 = _mm_add_epi16(x0, x5);  
  ...
  v3 = _mm_add_epi16(x1, x4);  
  v4 = _mm_sub_epi16(x1, x4);  

  v5 = _mm_sub_epi16(x0, x5);  

  v6 = _mm_sub_epi16(x1, x6);  
  v7 = _mm_sub_epi16(x0, x7);  
...
static void idct32_8x32_135_quarter_1(const __m128i *in ,
                                      __m128i *out ) {
  __m128i u0, u1, u2, u3, u4, u5, u6, u7;
...
static void idct32_8x32_135_quarter_2(const __m128i *in ,
                                      __m128i *out ) {
...
static void idct32_8x32_quarter_1_2(const __m128i *in ,
                                    __m128i *out ) {
  __m128i temp[16];
...
static void idct32_8x32_quarter_3_4(const __m128i *in ,
                                    __m128i *out ) {
  __m128i v16, v17, v18, v19, v20, v21, v22, v23;
  __m128i v24, v25, v26, v27, v28, v29, v30, v31;
  __m128i u16, u17, u18, u19, u20, u21, u22, u23;
...
static void idct32_8x32_135(__m128i *in ) {
  __m128i out[32];
...
static void idct32_full_8x32_quarter_2(const __m128i *in ,
                                       __m128i *out ) {
  __m128i u8, u9, u10, u11, u12, u13, u14, u15;  
  __m128i v8, v9, v10, v11, v12, v13, v14, v15;  
...
static void idct32_full_8x32_quarter_1(const __m128i *in ,
                                       __m128i *out ) {
  __m128i u0, u1, u2, u3, u4, u5, u6, u7;  
  __m128i v0, v1, v2, v3, v4, v5, v6, v7;  
...
static void idct32_full_8x32_quarter_3_4(const __m128i *in ,
                                         __m128i *out ) {
  __m128i v16, v17, v18, v19, v20, v21, v22, v23;
  __m128i v24, v25, v26, v27, v28, v29, v30, v31;
  __m128i u16, u17, u18, u19, u20, u21, u22, u23;
...
static void idct32_full_8x32_quarter_1_2(const __m128i *in ,
                                         __m128i *out ) {
  __m128i temp[16];
...
static void idct32_full_8x32(const __m128i *in ,
                             __m128i *out ) {
  __m128i temp[32];
