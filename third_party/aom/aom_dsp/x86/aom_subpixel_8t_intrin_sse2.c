...
void aom_filter_block1d16_h4_sse2(const uint8_t *src_ptr,
  ...
  secondFilters = _mm_unpackhi_epi64(tmp_0, tmp_0);  
  thirdFilters = _mm_unpacklo_epi64(tmp_1, tmp_1);   
...
void aom_filter_block1d16_v4_sse2(const uint8_t *src_ptr, ptrdiff_t src_pitch,
  ...
  secondFilters = _mm_unpackhi_epi64(tmp0, tmp0);  
  thirdFilters = _mm_unpacklo_epi64(tmp1, tmp1);   
