...
static INLINE void highbd_transpose(uint16_t *src[], int in_p, uint16_t *dst[],
  ...
  do {
    ...
    p0 =
        _mm_loadu_si128((__m128i *)(in + 0 * in_p));  
    p1 =
        _mm_loadu_si128((__m128i *)(in + 1 * in_p));  
    p2 =
        _mm_loadu_si128((__m128i *)(in + 2 * in_p));  
    p3 =
        _mm_loadu_si128((__m128i *)(in + 3 * in_p));  
    p4 =
        _mm_loadu_si128((__m128i *)(in + 4 * in_p));  
    p5 =
        _mm_loadu_si128((__m128i *)(in + 5 * in_p));  
    p6 =
        _mm_loadu_si128((__m128i *)(in + 6 * in_p));  
    p7 =
        _mm_loadu_si128((__m128i *)(in + 7 * in_p));  
