...
static INLINE void idct32_transpose_pair(int16_t *input, int16_t *t_buf) {
  ...
  for (i = 0; i < 4; i++, input += 8) {
    ...
    q8s16 = vcombine_s16(d16s16, d24s16);   
    q9s16 = vcombine_s16(d18s16, d26s16);   
    q10s16 = vcombine_s16(d20s16, d28s16);  
    q11s16 = vcombine_s16(d22s16, d30s16);  
    ...
    q0x2s16 = vtrnq_s16(vreinterpretq_s16_s32(q0x2s32.val[0]),   
                        vreinterpretq_s16_s32(q1x2s32.val[0]));  
    q1x2s16 = vtrnq_s16(vreinterpretq_s16_s32(q0x2s32.val[1]),   
                        vreinterpretq_s16_s32(q1x2s32.val[1]));  
    q2x2s16 = vtrnq_s16(vreinterpretq_s16_s32(q2x2s32.val[0]),   
                        vreinterpretq_s16_s32(q3x2s32.val[0]));  
    q3x2s16 = vtrnq_s16(vreinterpretq_s16_s32(q2x2s32.val[1]),   
                        vreinterpretq_s16_s32(q3x2s32.val[1]));  
...
void aom_idct32x32_1024_add_neon(int16_t *input, uint8_t *dest, int stride) {
  ...
  for (idct32_pass_loop = 0, out = pass1; idct32_pass_loop < 2;
      ...
      input = pass1,  
       out = pass2) {
    for (i = 0; i < 4; i++, input += 32 * 8, out += 8) {  
