...
static INLINE void transpose_elems_s32_4x8(int32x4_t a0, int32x4_t a1,
  ...
  transpose_elems_inplace_s32_4x4(&a0, &a1, &a2, &a3);  
  transpose_elems_inplace_s32_4x4(&a4, &a5, &a6, &a7);  
...
static INLINE void transpose_elems_inplace_s32_8x8(
  ...
  transpose_elems_inplace_s32_4x4(&q0_v1, &q0_v2, &q0_v3, &q0_v4);  
  transpose_elems_inplace_s32_4x4(&q1_v1, &q1_v2, &q1_v3, &q1_v4);  
  transpose_elems_inplace_s32_4x4(&q2_v1, &q2_v2, &q2_v3, &q2_v4);  
  transpose_elems_inplace_s32_4x4(&q3_v1, &q3_v2, &q3_v3, &q3_v4);  
