...
simde_mm_movm_epi16 (simde__mmask8 k) {
    ...
    const simde__m128i bits = simde_mm_set_epi16(0x0100, 0x0200, 0x0400, 0x0800, 0x1000, 0x2000, 0x4000, INT16_MIN );
    simde__m128i r;
...
simde_mm256_movm_epi16 (simde__mmask16 k) {
    ...
    const __m256i bits = _mm256_set_epi16(0x0001, 0x0002, 0x0004, 0x0008, 0x0010, 0x0020, 0x0040, 0x0080,
                                          0x0100, 0x0200, 0x0400, 0x0800, 0x1000, 0x2000, 0x4000, INT16_MIN );
    __m256i r;
...
simde_mm_movm_epi32 (simde__mmask8 k) {
    ...
    return r;
  #elif defined(SIMDE_X86_SSE2_NATIVE)
    const simde__m128i bits = simde_mm_set_epi32(0x10000000, 0x20000000, 0x40000000, INT32_MIN );
    simde__m128i r;
...
simde_mm_movm_epi64 (simde__mmask8 k) {
    ...
    return r;
  #elif defined(SIMDE_X86_SSE2_NATIVE)
    const simde__m128i bits = simde_mm_set_epi32(0x40000000, 0x40000000, INT32_MIN , INT32_MIN );
    simde__m128i r;
