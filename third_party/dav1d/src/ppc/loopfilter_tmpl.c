                ...
                HIGHBD_DECL_SUFFIX)
{
    ...
    u8x16 p1p0ab = (u8x16)vec_mergeh(p1, p0); 
    u8x16 q0q1ab = (u8x16)vec_mergeh(q0, q1); 
    u8x16 p1p0cd = (u8x16)vec_mergel(p1, p0); 
    u8x16 q0q1cd = (u8x16)vec_mergel(q0, q1); 

    u8x16 outa = (u8x16)vec_mergeh((u16x8)p1p0ab, (u16x8)q0q1ab); 
                    ...
                    HIGHBD_DECL_SUFFIX)
{
    ...
    MERGEHL_U16(ab_p2p1p0q0, p2p1h, p0q0h)       
                                                 
    MERGEHL_U16(cd_p2p1p0q0, p2p1l, p0q0l)       
                                                 
    MERGEHL_U16(ab_q1q2, q1q2h, q1q2h)           
                                                 
    MERGEHL_U16(cd_q1q2, q1q2l, q1q2l)           
                                                 

    MERGEHL_U32(a, ab_p2p1p0q0h, ab_q1q2h) 
                                           
    MERGEHL_U32(b, ab_p2p1p0q0l, ab_q1q2l) 
                                           
    MERGEHL_U32(c, cd_p2p1p0q0h, cd_q1q2h) 
                                           
    MERGEHL_U32(d, cd_p2p1p0q0l, cd_q1q2l) 
                    ...
                    HIGHBD_DECL_SUFFIX)
{
    ...
    MERGEHL_U32(a_p5p4p3p2q2q3q4q5, ab_p5p4p3p2h, ab_q2q3q4q5h) 
                                                                
    MERGEHL_U32(a_p1p0q0q1q2q3q4q5, ab_p1p0q0q1h, ab_q2q3q4q5h) 
                                                                
    MERGEHL_U32(b_p5p4p3p2q2q3q4q5, ab_p5p4p3p2l, ab_q2q3q4q5l) 
                                                                
    MERGEHL_U32(b_p1p0q0q1q2q3q4q5, ab_p1p0q0q1l, ab_q2q3q4q5l) 
                                                                
    MERGEHL_U32(c_p5p4p3p2q2q3q4q5, cd_p5p4p3p2h, cd_q2q3q4q5h) 
                                                                
    MERGEHL_U32(c_p1p0q0q1q2q3q4q5, cd_p1p0q0q1h, cd_q2q3q4q5h) 
                                                                
    MERGEHL_U32(d_p5p4p3p2q2q3q4q5, cd_p5p4p3p2l, cd_q2q3q4q5l) 
                                                                
    MERGEHL_U32(d_p1p0q0q1q2q3q4q5, cd_p1p0q0q1l, cd_q2q3q4q5l) 
                                                                

    MERGEHL_U32(a01, a_p5p4p3p2q2q3q4q5h, a_p1p0q0q1q2q3q4q5h) 
                                                               
    vec_xst_len(a01h, dst2, 12);
    dst2 += stridea;
    vec_xst_len(a01l, dst2, 12);
    dst2 += stridea;
    MERGEHL_U32(a23, a_p5p4p3p2q2q3q4q5l, a_p1p0q0q1q2q3q4q5l) 
                                                               
    vec_xst_len(a23h, dst2, 12);
    dst2 += stridea;
    vec_xst_len(a23l, dst2, 12);
    dst2 += stridea;
    MERGEHL_U32(b01, b_p5p4p3p2q2q3q4q5h, b_p1p0q0q1q2q3q4q5h) 
                                                               
    vec_xst_len(b01h, dst2, 12);
    dst2 += stridea;
    vec_xst_len(b01l, dst2, 12);
    dst2 += stridea;
    MERGEHL_U32(b23, b_p5p4p3p2q2q3q4q5l, b_p1p0q0q1q2q3q4q5l) 
                                                               
    vec_xst_len(b23h, dst2, 12);
    dst2 += stridea;
    vec_xst_len(b23l, dst2, 12);
    dst2 += stridea;
    MERGEHL_U32(c01, c_p5p4p3p2q2q3q4q5h, c_p1p0q0q1q2q3q4q5h) 
                                                               
    vec_xst_len(c01h, dst2, 12);
    dst2 += stridea;
    vec_xst_len(c01l, dst2, 12);
    dst2 += stridea;
    MERGEHL_U32(c23, c_p5p4p3p2q2q3q4q5l, c_p1p0q0q1q2q3q4q5l) 
                                                               
    vec_xst_len(c23h, dst2, 12);
    dst2 += stridea;
    vec_xst_len(c23l, dst2, 12);
    dst2 += stridea;
    MERGEHL_U32(d01, d_p5p4p3p2q2q3q4q5h, d_p1p0q0q1q2q3q4q5h) 
                                                               
    vec_xst_len(d01h, dst2, 12);
    dst2 += stridea;
    vec_xst_len(d01l, dst2, 12);
    dst2 += stridea;
    MERGEHL_U32(d23, d_p5p4p3p2q2q3q4q5l, d_p1p0q0q1q2q3q4q5l) 
                 ...
                 HIGHBD_DECL_SUFFIX)
{
    ...
    for (;
        ...
        if (!(vm & 0x0f))
            continue;
        u32x4 la = (u32x4)vec_xl(0, (uint8_t *)pl);  
        ...
        u32x4 Lac = vec_mergeh(la, lc); 
        u32x4 Lbd = vec_mergeh(lb, ld); 

        u32x4 wd16 = vec_and(vm2, mm); 
        u32x4 wd8 = vec_and(vm1, mm); 
        u32x4 wd4 = vec_and(vm0, mm); 

        u32x4 L_1 = (u32x4)vec_mergeh(Lac, Lbd); 
        u32x4 L_0 = (u32x4)vec_mergel(Lac, Lbd); 

        b8x16 mask = vec_cmpeq((u8x16)L_0, (u8x16)zero);

        u32x4 L4 = (u32x4)vec_sel((u8x16)L_0, (u8x16)L_1, mask); 

        u8x16 L = (u8x16)vec_perm((u8x16)L4, (u8x16)L4, spread); 
                 ...
                 HIGHBD_DECL_SUFFIX)
{
    ...
    for (;
        ...
        u32x4 L4 = (u32x4)vec_sel((u8x16)L_0, (u8x16)L_b4, mask); 
