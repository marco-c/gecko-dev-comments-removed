...
static inline int get_seqlen(void) {
    ...
    if      (prob < 25000) len = 1;       
    else if (prob < 63000) len = 2;       
    else if (prob < 65500) len = 3;       
    else if (prob < 84500) len = 4;       
    else if (prob < 88000) max_len = 7;   
    else if (prob < 93500) len = 8;       
    else if (prob < 95500) max_len = 15;  
    else if (prob < 97370) len = 16;      
    else if (prob < 98230) max_len = 31;  
    else if (prob < 98630) len = 32;      
    else if (prob < 98810) max_len = 47;  
    else if (prob < 99010) len = 48;      
    else if (prob < 99077) max_len = 63;  
    else if (prob < 99242) len = 64;      
    else if (prob < 99720) max_len = 239; 
    else                   len = 240;     
