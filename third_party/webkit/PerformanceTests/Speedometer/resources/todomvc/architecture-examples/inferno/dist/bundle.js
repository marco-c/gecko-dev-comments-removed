 ...
 function(module, exports, __webpack_require__) {
    ...
    function normalizeProps(vNode, props, children) {
        if (!(vNode.flags & 28 ) && isNullOrUndef(children) && !isNullOrUndef(props.children)) {
    ...
    function normalize(vNode) {
        ...
        if (isString(vNode.type) && (vNode.flags & 28 )) {
            vNode.flags = 3970 ;
        }
        if (props) {
    ...
    function createVNode(flags, type, props, children, events, key, ref, noNormalise) {
        if (flags & 16 ) {
            flags = isStatefulComponent(type) ? 4  : 8 ;
        }
        var vNode = {
    ...
    function createTextVNode(text) {
        return createVNode(1 , null, null, text);
    }
    function isVNode(o) {
        return !!o.flags;
    }
    ...
    function patch(lastVNode, nextVNode, parentDom, lifecycle, context, isSVG, isRecycling) {
        if (lastVNode !== nextVNode) {
            ...
            if (nextFlags & 28 ) {
                if (lastFlags & 28 ) {
                    patchComponent(lastVNode, nextVNode, parentDom, lifecycle, context, isSVG, nextFlags & 4 , isRecycling);
                }
                else {
                    replaceVNode(parentDom, mountComponent(nextVNode, null, lifecycle, context, isSVG, nextFlags & 4 ), lastVNode, lifecycle, isRecycling);
                }
            }
    ...
    function patchChildren(lastFlags, nextFlags, lastChildren, nextChildren, dom, lifecycle, context, isSVG, isRecycling) {
        ...
        else if ((lastFlags & 32 ) && (nextFlags & 32 )) {
            patchKeyed = true;
            patchArray = true;
        }
        ...
        if (lastType !== nextType) {
            ...
            if (isClass) {
                ...
                if (instance._unmounted) {
                    ...
                    replaceChild(parentDom, mountComponent(nextVNode, null, lifecycle, context, isSVG, nextVNode.flags & 4 ), lastVNode.dom);
                }
                else {
                ...
                if (nextInput$2.flags & 28 ) {
                    nextInput$2.parentVNode = nextVNode;
                }
                else if (lastInput$2.flags & 28 ) {
    ...
    function recycleComponent(vNode, lifecycle, context, isSVG) {
        ...
        if (!isUndefined(pools)) {
            ...
            if (!isUndefined(pool)) {
                ...
                if (!isUndefined(recycledVNode)) {
                    var flags = vNode.flags;
                    var failed = patchComponent(recycledVNode, vNode, null, lifecycle, context, isSVG, flags & 4 , true);
                    if (!failed) {
                        return vNode.dom;
                    }
                }
    ...
    function hydrate(vNode, dom, lifecycle, context, isSVG) {
        ...
        var flags = vNode.flags;
        if (flags & 28 ) {
            return hydrateComponent(vNode, dom, lifecycle, context, isSVG, flags & 4 );
        }
        else if (flags & 3970 ) {
 ...
 function(module, exports, __webpack_require__) {
    ...
    function createVoidVNode() {
        return inferno.createVNode(4096 );
    }
