...
public:
  ...
  {}
   ...
   SystemTimestamp(const std::chrono::system_clock::time_point &time_point) noexcept
...
public:
  ...
  {}
   ...
   SteadyTimestamp(const std::chrono::steady_clock::time_point &time_point) noexcept
