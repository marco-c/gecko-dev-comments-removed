...
struct Pack8<3> {
  ...
  HWY_INLINE void Unpack(D8 d8, const uint8_t* HWY_RESTRICT packed_in,
    ...
    VU16 packed3 = And(mask2, packed0);  
    packed3 = ShiftLeft<2>(packed3);
    packed3 = OrAnd(packed3, mask2, packed1);  
    packed3 = ShiftLeft<2>(packed3);
    packed3 = OrAnd(packed3, mask2, packed2);  
...
struct Pack8<6> {
  ...
  HWY_INLINE void Unpack(D8 d8, const uint8_t* HWY_RESTRICT packed_in,
    ...
    VU16 raw3 = And(mask, packed2);  
    raw3 = ShiftRight<2>(raw3);
    raw3 = OrAnd(raw3, mask, packed1);  
    raw3 = ShiftRight<2>(raw3);
    raw3 = OrAnd(raw3, mask, packed0);  
    raw3 = ShiftRight<2>(raw3);
    StoreU(BitCast(d8, raw3), d8, raw + 3 * N8);
  }
};  
...
struct Pack16<5> {
  ...
  HWY_INLINE void Pack(D d, const uint16_t* HWY_RESTRICT raw,
    ...
    const VU16 hi1 = Set(d, 0x8000u);
    const VU16 packed0 = Or(rawA50, ShiftLeft<15>(rawF));  
...
struct Pack16<6> {
  ...
  HWY_INLINE void Pack(D d, const uint16_t* HWY_RESTRICT raw,
    ...
    packed0 = Or(packed0, ShiftLeft<12>(packed3));  
...
struct Pack16<7> {
  ...
  HWY_INLINE void Pack(D d, const uint16_t* HWY_RESTRICT raw,
    ...
    packed0 = Or(packed0, ShiftLeft<14>(packed7));  
