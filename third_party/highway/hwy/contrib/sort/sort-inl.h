...
Runs<D> StoreVectors(D d, Vec<D> v0, Vec<D> v1) {
  ...
  Runs<D> runs(d, kRegs, kRegs * Lanes(d), false);
  runs.StoreVector(d, 0, v0);
...
HWY_INLINE void Transpose4x4(D d, V& v0, V& v1, V& v2, V& v3) {
  ...
  const V t0 = InterleaveLower(d, v0, v1);  
  const V t1 = InterleaveLower(d, v2, v3);  
  const V t2 = InterleaveUpper(d, v0, v1);  
  const V t3 = InterleaveUpper(d, v2, v3);  
...
template <SortOrder kOrder, typename T>
HWY_INLINE void SortDistance4LanesV(Simd<T, 4> , ...) {}
...
HWY_API size_t FourQuartetsPerVector(Simd<T, 16> d, V& q0, V& q1, V& q2, V& q3,
  ...
  V v0 = Shuffle128_2020(q11_01_10_00, q13_03_12_02);  

  const V q15_05_14_04 = Shuffle128_2020(q4, q5);
  const V q17_07_16_06 = Shuffle128_2020(q6, q7);
  V v1 = Shuffle128_2020(q15_05_14_04, q17_07_16_06);  

  const V q19_09_18_08 = Shuffle128_3131(q0, q1);
  const V q1b_0b_1a_0a = Shuffle128_3131(q2, q3);
  V v3 = Reverse(d, Shuffle128_2020(q19_09_18_08, q1b_0b_1a_0a));  

  const V q1d_0d_1c_0c = Shuffle128_3131(q4, q5);
  const V q1f_0f_1e_0e = Shuffle128_3131(q6, q7);
  V v2 = Reverse(d, Shuffle128_2020(q1d_0d_1c_0c, q1f_0f_1e_0e));  

  detail::BitonicMergeTo64<kOrder>(d, v0, v1, v2, v3, -1);

  
  V v4 = Shuffle128_3131(q11_01_10_00, q13_03_12_02);              
  V v5 = Shuffle128_3131(q15_05_14_04, q17_07_16_06);              
  V v7 = Reverse(d, Shuffle128_3131(q19_09_18_08, q1b_0b_1a_0a));  
  V v6 = Reverse(d, Shuffle128_3131(q1d_0d_1c_0c, q1f_0f_1e_0e));  
...
template <SortOrder kOrder, typename T>
HWY_API size_t TwoQuartetsPerVector(Simd<T, 4> , ...) {
  return 0;
}

template <SortOrder kOrder, typename T>
HWY_API size_t FourQuartetsPerVector(Simd<T, 4> , ...) {
  return 0;
}
template <SortOrder kOrder, typename T>
HWY_API size_t FourQuartetsPerVector(Simd<T, 8> , ...) {
  return 0;
}
...
template <SortOrder kOrder, class D>
HWY_API size_t SortBatch(D , TFromD<D>* ) {
  return 0;
}
