...
struct TestExtractLane {
  ...
  static HWY_INLINE void DoTestExtractLaneWithConstAmt_0_7(D , Vec<D> v) {
  ...
  static HWY_INLINE void DoTestExtractLaneWithConstAmt_8_15(D ,
                                                            Vec<D> ) {}

  template <class D, HWY_IF_LANES_GT_D(BlockDFromD<D>, 8)>
  static HWY_INLINE void DoTestExtractLaneWithConstAmt_8_15(D , Vec<D> v) {
...
class TestBroadcastLane {
 private:
  ...
  static HWY_INLINE void DoTestBroadcastLane(D , const size_t ) {
