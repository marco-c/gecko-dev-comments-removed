...
struct TestSumsOfAdjQuadAbsDiff {
  ...
  static HWY_INLINE void DoTestSumsOfAdjQuadAbsDiff(D ,
                                                    RandomState& ) {}
  ...
  static HWY_INLINE void FullOrFixedVecQuadSumTests(D ,
                                                    RandomState& ) {}
...
struct TestSumsOfShuffledQuadAbsDiff {
  ...
  static HWY_INLINE void AtLeast8LanesShufQuadSumTests(D ,
                                                       RandomState& ) {}
  ...
  static HWY_INLINE void AtLeast16LanesShufQuadSumTests(D ,
                                                        RandomState& ) {}
  ...
  template <class D, class D2 = DFromV<Vec<D>>,
            HWY_IF_LANES_LE_D(D, HWY_MAX_LANES_D(D2) - 1)>
  static HWY_INLINE void FullOrFixedVecShufQuadSumTests(D ,
                                                        RandomState& ) {}
