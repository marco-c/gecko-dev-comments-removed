...
template <typename T>
HWY_API Vec256<T> BitCastFromByte(Full256<T> , Vec256<uint8_t> v) {
...
template <typename T>
HWY_API void ScatterOffset(hwy::SizeTag<8> , Vec256<T> v,
                           Full256<T> , T* HWY_RESTRICT base,
                           const Vec256<int64_t> offset) {
  _mm256_i64scatter_epi64(base, offset.raw, v.raw, 1);
}
template <typename T>
HWY_API void ScatterIndex(hwy::SizeTag<8> , Vec256<T> v,
                          Full256<T> , T* HWY_RESTRICT base,
...
template <>
HWY_INLINE void ScatterOffset<float>(Vec256<float> v, Full256<float> ,
                                     float* HWY_RESTRICT base,
                                     const Vec256<int32_t> offset) {
  _mm256_i32scatter_ps(base, offset.raw, v.raw, 1);
}
template <>
HWY_INLINE void ScatterIndex<float>(Vec256<float> v, Full256<float> ,
                                    float* HWY_RESTRICT base,
                                    const Vec256<int32_t> index) {
...
template <typename T>
HWY_API Vec256<T> GatherOffset(hwy::SizeTag<4> , Full256<T> ,
...
template <typename T>
HWY_API Vec256<T> GatherIndex(hwy::SizeTag<4> , Full256<T> ,
                              const T* HWY_RESTRICT base,
                              const Vec256<int32_t> index) {
  return Vec256<T>{_mm256_i32gather_epi32(
...
template <typename T>
HWY_API Vec256<T> GatherOffset(hwy::SizeTag<8> , Full256<T> ,
                               const T* HWY_RESTRICT base,
                               const Vec256<int64_t> offset) {
...
template <typename T>
HWY_API Vec256<T> GatherIndex(hwy::SizeTag<8> , Full256<T> ,
                              const T* HWY_RESTRICT base,
                              const Vec256<int64_t> index) {
  return Vec256<T>{_mm256_i64gather_epi64(
...
template <>
HWY_INLINE Vec256<float> GatherOffset<float>(Full256<float> ,
                                             const float* HWY_RESTRICT base,
                                             const Vec256<int32_t> offset) {
  return Vec256<float>{_mm256_i32gather_ps(base, offset.raw, 1)};
}
template <>
HWY_INLINE Vec256<float> GatherIndex<float>(Full256<float> ,
                                            const float* HWY_RESTRICT base,
                                            const Vec256<int32_t> index) {
...
template <>
HWY_INLINE Vec256<double> GatherOffset<double>(Full256<double> ,
                                               const double* HWY_RESTRICT base,
                                               const Vec256<int64_t> offset) {
  return Vec256<double>{_mm256_i64gather_pd(base, offset.raw, 1)};
}
template <>
HWY_INLINE Vec256<double> GatherIndex<double>(Full256<double> ,
                                              const double* HWY_RESTRICT base,
                                              const Vec256<int64_t> index) {
...
template <typename T>
HWY_API Vec256<T> OddEven(hwy::SizeTag<1> , const Vec256<T> a,
                          const Vec256<T> b) {
  const Full256<T> d;
  const Full256<uint8_t> d8;
...
template <typename T>
HWY_API Vec256<T> OddEven(hwy::SizeTag<2> , const Vec256<T> a,
                          const Vec256<T> b) {
  return Vec256<T>{_mm256_blend_epi16(a.raw, b.raw, 0x55)};
}
template <typename T>
HWY_API Vec256<T> OddEven(hwy::SizeTag<4> , const Vec256<T> a,
                          const Vec256<T> b) {
  return Vec256<T>{_mm256_blend_epi32(a.raw, b.raw, 0x55)};
}
template <typename T>
HWY_API Vec256<T> OddEven(hwy::SizeTag<8> , const Vec256<T> a,
                          const Vec256<T> b) {
...
template <typename T>
HWY_API uint64_t BitsFromMask(hwy::SizeTag<1> , const Mask256<T> mask) {
  const Full256<T> d;
  const Full256<uint8_t> d8;
...
template <typename T>
HWY_API uint64_t BitsFromMask(hwy::SizeTag<2> , const Mask256<T> mask) {
#if HWY_ARCH_X86_64
...
template <typename T>
HWY_API uint64_t BitsFromMask(hwy::SizeTag<4> , const Mask256<T> mask) {
  const Full256<T> d;
  const Full256<float> df;
...
template <typename T>
HWY_API uint64_t BitsFromMask(hwy::SizeTag<8> , const Mask256<T> mask) {
  const Full256<T> d;
...
template <typename T>
HWY_API Vec256<T> Compress(hwy::SizeTag<4> , Vec256<T> v,
...
template <typename T>
HWY_API Vec256<T> Compress(hwy::SizeTag<8> , Vec256<T> v,
                           const uint64_t mask_bits) {
...
template <typename T>
HWY_API Vec256<T> Compress(hwy::SizeTag<2> , Vec256<T> v,
                           const uint64_t mask_bits) {
  using D = Full256<T>;
...
template <typename T>
HWY_API Vec256<T> SumOfLanes(hwy::SizeTag<4> , const Vec256<T> v3210) {
...
template <typename T>
HWY_API Vec256<T> MinOfLanes(hwy::SizeTag<4> , const Vec256<T> v3210) {
  const auto v1032 = Shuffle1032(v3210);
...
template <typename T>
HWY_API Vec256<T> MaxOfLanes(hwy::SizeTag<4> , const Vec256<T> v3210) {
  const auto v1032 = Shuffle1032(v3210);
...
template <typename T>
HWY_API Vec256<T> SumOfLanes(hwy::SizeTag<8> , const Vec256<T> v10) {
  const auto v01 = Shuffle01(v10);
  return v10 + v01;
}
template <typename T>
HWY_API Vec256<T> MinOfLanes(hwy::SizeTag<8> , const Vec256<T> v10) {
  const auto v01 = Shuffle01(v10);
  return Min(v10, v01);
}
template <typename T>
HWY_API Vec256<T> MaxOfLanes(hwy::SizeTag<8> , const Vec256<T> v10) {
  const auto v01 = Shuffle01(v10);
  return Max(v10, v01);
}
