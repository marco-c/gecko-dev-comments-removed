...
HWY_API VFromD<DU> Iota0(const D ) {
  Lanes(DU());
...
HWY_API Vu16m2 PromoteTo(Du16m2 , Vu8m1 v) { return vzext_vf2_u16m2(v); }
HWY_API Vu16m4 PromoteTo(Du16m4 , Vu8m2 v) { return vzext_vf2_u16m4(v); }
HWY_API Vu16m8 PromoteTo(Du16m8 , Vu8m4 v) { return vzext_vf2_u16m8(v); }

HWY_API Vu32m4 PromoteTo(Du32m4 , Vu8m1 v) { return vzext_vf4_u32m4(v); }
HWY_API Vu32m8 PromoteTo(Du32m8 , Vu8m2 v) { return vzext_vf4_u32m8(v); }

HWY_API Vu32m2 PromoteTo(Du32m2 , const Vu16m1 v) {
  return vzext_vf2_u32m2(v);
}
HWY_API Vu32m4 PromoteTo(Du32m4 , const Vu16m2 v) {
  return vzext_vf2_u32m4(v);
}
HWY_API Vu32m8 PromoteTo(Du32m8 , const Vu16m4 v) {
  return vzext_vf2_u32m8(v);
}

HWY_API Vu64m2 PromoteTo(Du64m2 , const Vu32m1 v) {
  return vzext_vf2_u64m2(v);
}
HWY_API Vu64m4 PromoteTo(Du64m4 , const Vu32m2 v) {
  return vzext_vf2_u64m4(v);
}
HWY_API Vu64m8 PromoteTo(Du64m8 , const Vu32m4 v) {
...
HWY_API Vi16m2 PromoteTo(Di16m2 , Vi8m1 v) { return vsext_vf2_i16m2(v); }
HWY_API Vi16m4 PromoteTo(Di16m4 , Vi8m2 v) { return vsext_vf2_i16m4(v); }
HWY_API Vi16m8 PromoteTo(Di16m8 , Vi8m4 v) { return vsext_vf2_i16m8(v); }

HWY_API Vi32m4 PromoteTo(Di32m4 , Vi8m1 v) { return vsext_vf4_i32m4(v); }
HWY_API Vi32m8 PromoteTo(Di32m8 , Vi8m2 v) { return vsext_vf4_i32m8(v); }

HWY_API Vi32m2 PromoteTo(Di32m2 , const Vi16m1 v) {
  return vsext_vf2_i32m2(v);
}
HWY_API Vi32m4 PromoteTo(Di32m4 , const Vi16m2 v) {
  return vsext_vf2_i32m4(v);
}
HWY_API Vi32m8 PromoteTo(Di32m8 , const Vi16m4 v) {
  return vsext_vf2_i32m8(v);
}

HWY_API Vi64m2 PromoteTo(Di64m2 , const Vi32m1 v) {
  return vsext_vf2_i64m2(v);
}
HWY_API Vi64m4 PromoteTo(Di64m4 , const Vi32m2 v) {
  return vsext_vf2_i64m4(v);
}
HWY_API Vi64m8 PromoteTo(Di64m8 , const Vi32m4 v) {
  return vsext_vf2_i64m8(v);
}



HWY_API Vf32m2 PromoteTo(Df32m2 , const Vf16m1 v) {
  return vfwcvt_f_f_v_f32m2(v);
}
HWY_API Vf32m4 PromoteTo(Df32m4 , const Vf16m2 v) {
  return vfwcvt_f_f_v_f32m4(v);
}
HWY_API Vf32m8 PromoteTo(Df32m8 , const Vf16m4 v) {
  return vfwcvt_f_f_v_f32m8(v);
}

HWY_API Vf64m2 PromoteTo(Df64m2 , const Vf32m1 v) {
  return vfwcvt_f_f_v_f64m2(v);
}
HWY_API Vf64m4 PromoteTo(Df64m4 , const Vf32m2 v) {
  return vfwcvt_f_f_v_f64m4(v);
}
HWY_API Vf64m8 PromoteTo(Df64m8 , const Vf32m4 v) {
  return vfwcvt_f_f_v_f64m8(v);
}

HWY_API Vf64m2 PromoteTo(Df64m2 , const Vi32m1 v) {
  return vfwcvt_f_x_v_f64m2(v);
}
HWY_API Vf64m4 PromoteTo(Df64m4 , const Vi32m2 v) {
  return vfwcvt_f_x_v_f64m4(v);
}
HWY_API Vf64m8 PromoteTo(Df64m8 , const Vi32m4 v) {
...
HWY_API Vi8m1 DemoteTo(Di8m1 , const Vi16m2 v) {
  return vnclip_wx_i8m1(v, 0);
}
HWY_API Vi8m2 DemoteTo(Di8m2 , const Vi16m4 v) {
  return vnclip_wx_i8m2(v, 0);
}
HWY_API Vi8m4 DemoteTo(Di8m4 , const Vi16m8 v) {
  return vnclip_wx_i8m4(v, 0);
}

HWY_API Vi16m1 DemoteTo(Di16m1 , const Vi32m2 v) {
  return vnclip_wx_i16m1(v, 0);
}
HWY_API Vi16m2 DemoteTo(Di16m2 , const Vi32m4 v) {
  return vnclip_wx_i16m2(v, 0);
}
HWY_API Vi16m4 DemoteTo(Di16m4 , const Vi32m8 v) {
...
HWY_API Vf16m1 DemoteTo(Df16m1 , const Vf32m2 v) {
  return vfncvt_rod_f_f_w_f16m1(v);
}
HWY_API Vf16m2 DemoteTo(Df16m2 , const Vf32m4 v) {
  return vfncvt_rod_f_f_w_f16m2(v);
}
HWY_API Vf16m4 DemoteTo(Df16m4 , const Vf32m8 v) {
  return vfncvt_rod_f_f_w_f16m4(v);
}

HWY_API Vf32m1 DemoteTo(Df32m1 , const Vf64m2 v) {
  return vfncvt_rod_f_f_w_f32m1(v);
}
HWY_API Vf32m2 DemoteTo(Df32m2 , const Vf64m4 v) {
  return vfncvt_rod_f_f_w_f32m2(v);
}
HWY_API Vf32m4 DemoteTo(Df32m4 , const Vf64m8 v) {
  return vfncvt_rod_f_f_w_f32m4(v);
}

HWY_API Vi32m1 DemoteTo(Di32m1 , const Vf64m2 v) {
  return vfncvt_rtz_x_f_w_i32m1(v);
}
HWY_API Vi32m2 DemoteTo(Di32m2 , const Vf64m4 v) {
  return vfncvt_rtz_x_f_w_i32m2(v);
}
HWY_API Vi32m4 DemoteTo(Di32m4 , const Vf64m8 v) {
...
HWY_API V SumOfLanes(const V v) {
  using T = TFromV<V>;
  const auto v0 = Zero(Simd<T, HWY_LANES(T)>());  
