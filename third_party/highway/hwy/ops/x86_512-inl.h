...
template <typename T>
HWY_API Vec512<T> BitCastFromByte(Full512<T> , Vec512<uint8_t> v) {
...
template <typename T>
HWY_API Vec512<T> IfThenElse(hwy::SizeTag<1> , const Mask512<T> mask,
                             const Vec512<T> yes, const Vec512<T> no) {
  return Vec512<T>{_mm512_mask_mov_epi8(no.raw, mask.raw, yes.raw)};
}
template <typename T>
HWY_API Vec512<T> IfThenElse(hwy::SizeTag<2> , const Mask512<T> mask,
                             const Vec512<T> yes, const Vec512<T> no) {
  return Vec512<T>{_mm512_mask_mov_epi16(no.raw, mask.raw, yes.raw)};
}
template <typename T>
HWY_API Vec512<T> IfThenElse(hwy::SizeTag<4> , const Mask512<T> mask,
                             const Vec512<T> yes, const Vec512<T> no) {
  return Vec512<T>{_mm512_mask_mov_epi32(no.raw, mask.raw, yes.raw)};
}
template <typename T>
HWY_API Vec512<T> IfThenElse(hwy::SizeTag<8> , const Mask512<T> mask,
                             const Vec512<T> yes, const Vec512<T> no) {
...
template <typename T>
HWY_API Mask512<T> TestBit(hwy::SizeTag<1> , const Vec512<T> v,
                           const Vec512<T> bit) {
  return Mask512<T>{_mm512_test_epi8_mask(v.raw, bit.raw)};
}
template <typename T>
HWY_API Mask512<T> TestBit(hwy::SizeTag<2> , const Vec512<T> v,
                           const Vec512<T> bit) {
  return Mask512<T>{_mm512_test_epi16_mask(v.raw, bit.raw)};
}
template <typename T>
HWY_API Mask512<T> TestBit(hwy::SizeTag<4> , const Vec512<T> v,
                           const Vec512<T> bit) {
  return Mask512<T>{_mm512_test_epi32_mask(v.raw, bit.raw)};
}
template <typename T>
HWY_API Mask512<T> TestBit(hwy::SizeTag<8> , const Vec512<T> v,
                           const Vec512<T> bit) {
...
template <typename T>
HWY_API Mask512<T> MaskFromVec(hwy::SizeTag<1> , const Vec512<T> v) {
  return Mask512<T>{_mm512_movepi8_mask(v.raw)};
}
template <typename T>
HWY_API Mask512<T> MaskFromVec(hwy::SizeTag<2> , const Vec512<T> v) {
  return Mask512<T>{_mm512_movepi16_mask(v.raw)};
}
template <typename T>
HWY_API Mask512<T> MaskFromVec(hwy::SizeTag<4> , const Vec512<T> v) {
  return Mask512<T>{_mm512_movepi32_mask(v.raw)};
}
template <typename T>
HWY_API Mask512<T> MaskFromVec(hwy::SizeTag<8> , const Vec512<T> v) {
...
template <typename T>
HWY_API Mask512<T> Not(hwy::SizeTag<1> , const Mask512<T> m) {
...
template <typename T>
HWY_API Mask512<T> Not(hwy::SizeTag<2> , const Mask512<T> m) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Not(hwy::SizeTag<4> , const Mask512<T> m) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Not(hwy::SizeTag<8> , const Mask512<T> m) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> And(hwy::SizeTag<1> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> And(hwy::SizeTag<2> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> And(hwy::SizeTag<4> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> And(hwy::SizeTag<8> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> AndNot(hwy::SizeTag<1> , const Mask512<T> a,
                          const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> AndNot(hwy::SizeTag<2> , const Mask512<T> a,
                          const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> AndNot(hwy::SizeTag<4> , const Mask512<T> a,
                          const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> AndNot(hwy::SizeTag<8> , const Mask512<T> a,
                          const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Or(hwy::SizeTag<1> , const Mask512<T> a,
                      const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Or(hwy::SizeTag<2> , const Mask512<T> a,
                      const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Or(hwy::SizeTag<4> , const Mask512<T> a,
                      const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Or(hwy::SizeTag<8> , const Mask512<T> a,
                      const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Xor(hwy::SizeTag<1> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Xor(hwy::SizeTag<2> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Xor(hwy::SizeTag<4> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API Mask512<T> Xor(hwy::SizeTag<8> , const Mask512<T> a,
                       const Mask512<T> b) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API void ScatterOffset(hwy::SizeTag<8> , Vec512<T> v,
                           Full512<T> , T* HWY_RESTRICT base,
                           const Vec512<int64_t> offset) {
  _mm512_i64scatter_epi64(base, offset.raw, v.raw, 1);
}
template <typename T>
HWY_API void ScatterIndex(hwy::SizeTag<8> , Vec512<T> v,
                          Full512<T> , T* HWY_RESTRICT base,
...
template <>
HWY_INLINE void ScatterOffset<float>(Vec512<float> v, Full512<float> ,
                                     float* HWY_RESTRICT base,
                                     const Vec512<int32_t> offset) {
  _mm512_i32scatter_ps(base, offset.raw, v.raw, 1);
}
template <>
HWY_INLINE void ScatterIndex<float>(Vec512<float> v, Full512<float> ,
                                    float* HWY_RESTRICT base,
                                    const Vec512<int32_t> index) {
...
template <typename T>
HWY_API Vec512<T> GatherOffset(hwy::SizeTag<4> , Full512<T> ,
                               const T* HWY_RESTRICT base,
                               const Vec512<int32_t> offset) {
  return Vec512<T>{_mm512_i32gather_epi32(offset.raw, base, 1)};
}
template <typename T>
HWY_API Vec512<T> GatherIndex(hwy::SizeTag<4> , Full512<T> ,
                              const T* HWY_RESTRICT base,
                              const Vec512<int32_t> index) {
...
template <typename T>
HWY_API Vec512<T> GatherOffset(hwy::SizeTag<8> , Full512<T> ,
                               const T* HWY_RESTRICT base,
                               const Vec512<int64_t> offset) {
  return Vec512<T>{_mm512_i64gather_epi64(offset.raw, base, 1)};
}
template <typename T>
HWY_API Vec512<T> GatherIndex(hwy::SizeTag<8> , Full512<T> ,
                              const T* HWY_RESTRICT base,
                              const Vec512<int64_t> index) {
...
template <>
HWY_INLINE Vec512<float> GatherOffset<float>(Full512<float> ,
                                             const float* HWY_RESTRICT base,
                                             const Vec512<int32_t> offset) {
  return Vec512<float>{_mm512_i32gather_ps(offset.raw, base, 1)};
}
template <>
HWY_INLINE Vec512<float> GatherIndex<float>(Full512<float> ,
                                            const float* HWY_RESTRICT base,
                                            const Vec512<int32_t> index) {
...
template <>
HWY_INLINE Vec512<double> GatherOffset<double>(Full512<double> ,
                                               const double* HWY_RESTRICT base,
                                               const Vec512<int64_t> offset) {
  return Vec512<double>{_mm512_i64gather_pd(offset.raw, base, 1)};
}
template <>
HWY_INLINE Vec512<double> GatherIndex<double>(Full512<double> ,
                                              const double* HWY_RESTRICT base,
                                              const Vec512<int64_t> index) {
...
template <typename T>
HWY_API bool AllFalse(hwy::SizeTag<1> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API bool AllFalse(hwy::SizeTag<2> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API bool AllFalse(hwy::SizeTag<4> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API bool AllFalse(hwy::SizeTag<8> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API bool AllTrue(hwy::SizeTag<1> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API bool AllTrue(hwy::SizeTag<2> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API bool AllTrue(hwy::SizeTag<4> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
template <typename T>
HWY_API bool AllTrue(hwy::SizeTag<8> , const Mask512<T> v) {
#if HWY_COMPILER_HAS_MASK_INTRINSICS
...
HWY_API void StoreInterleaved3(const Vec512<uint8_t> a, const Vec512<uint8_t> b,
  ...
  StoreU(Vec512<uint8_t>{i1_k0_j0_i0}, d, unaligned + 0 * 64);  
  StoreU(Vec512<uint8_t>{j2_i2_k1_j1}, d, unaligned + 1 * 64);  
  StoreU(Vec512<uint8_t>{k3_j3_i3_k2}, d, unaligned + 2 * 64);  
}
...
HWY_API void StoreInterleaved4(const Vec512<uint8_t> v0,
  ...
  const auto i = ZipLower(ba0, dc0).raw;  
  const auto j = ZipUpper(ba0, dc0).raw;  
  const auto k = ZipLower(ba8, dc8).raw;  
  const auto l = ZipUpper(ba8, dc8).raw;  
