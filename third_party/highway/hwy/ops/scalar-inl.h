...
template <typename T>
HWY_API void Store(const Vec1<T> v, Sisd<T> ,
...
HWY_API Vec1<float16_t> DemoteTo(Sisd<float16_t> ,
                                 const Vec1<float> v) {
  uint32_t bits32;
...
HWY_API Vec1<uint8_t> TruncateTo(Sisd<uint8_t> ,
                                 const Vec1<uint64_t> v) {
  return Vec1<uint8_t>{static_cast<uint8_t>(v.raw & 0xFF)};
}

HWY_API Vec1<uint16_t> TruncateTo(Sisd<uint16_t> ,
                                  const Vec1<uint64_t> v) {
  return Vec1<uint16_t>{static_cast<uint16_t>(v.raw & 0xFFFF)};
}

HWY_API Vec1<uint32_t> TruncateTo(Sisd<uint32_t> ,
                                  const Vec1<uint64_t> v) {
...
template <typename T>
HWY_API Mask1<T> LoadMaskBits(Sisd<T> ,
...
HWY_API Vec1<float> ReorderWidenMulAccumulate(Sisd<float> ,
                                              Vec1<bfloat16_t> a,
                                              Vec1<bfloat16_t> b,
...
HWY_API Vec1<int32_t> ReorderWidenMulAccumulate(Sisd<int32_t> ,
                                                Vec1<int16_t> a,
                                                Vec1<int16_t> b,
