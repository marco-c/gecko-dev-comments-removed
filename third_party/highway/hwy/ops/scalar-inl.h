...
HWY_API VFromD<D> Dup128VecFromValues(D , TFromD<D> t0, TFromD<D> ,
                                      TFromD<D> , TFromD<D> ,
                                      TFromD<D> , TFromD<D> ,
                                      TFromD<D> , TFromD<D> ,
                                      TFromD<D> , TFromD<D> ,
...
HWY_API VFromD<DI32> DemoteToNearestInt(DI32 , const Vec1<double> v) {
  using T = double;
  using TI = int32_t;
...
HWY_API VFromD<D32> DemoteInRangeTo(D32 ,
...
HWY_API Vec1<float16_t> DemoteTo(D , const Vec1<float> v) {
...
HWY_API MFromD<D> Dup128MaskFromMaskBits(D , unsigned mask_bits) {
...
HWY_API Vec1<float> WidenMulPairwiseAdd(D32 , Vec1<bfloat16_t> a,
                                        Vec1<bfloat16_t> b) {
  return Vec1<float>(F32FromBF16(a.raw)) * Vec1<float>(F32FromBF16(b.raw));
}

template <class D32, HWY_IF_I32_D(D32)>
HWY_API Vec1<int32_t> WidenMulPairwiseAdd(D32 , Vec1<int16_t> a,
                                          Vec1<int16_t> b) {
...
HWY_API Vec1<int16_t> SatWidenMulPairwiseAdd(DI16 , Vec1<uint8_t> a,
                                             Vec1<int8_t> b) {
...
template <class D32, HWY_IF_F32_D(D32)>
HWY_API Vec1<float> ReorderWidenMulAccumulate(D32 , Vec1<bfloat16_t> a,
                                              Vec1<bfloat16_t> b,
...
template <class D32, HWY_IF_I32_D(D32)>
HWY_API Vec1<int32_t> ReorderWidenMulAccumulate(D32 , Vec1<int16_t> a,
                                                Vec1<int16_t> b,
...
HWY_API Vec1<uint32_t> ReorderWidenMulAccumulate(DU32 ,
                                                 Vec1<uint16_t> a,
                                                 Vec1<uint16_t> b,
