...
HWY_INLINE Vec1<T> BitCast(Sisd<T> , Vec1<FromT> v) {
...
template <typename T>
HWY_INLINE Vec1<T> Zero(Sisd<T> ) {
  return Vec1<T>(T(0));
}

template <typename T, typename T2>
HWY_INLINE Vec1<T> Set(Sisd<T> , const T2 t) {
...
template <typename T, typename T2>
Vec1<T> Iota(const Sisd<T> , const T2 first) {
...
template <typename T>
HWY_INLINE Mask1<T> FirstN(Sisd<T> , size_t n) {
...
template <typename T>
HWY_INLINE Vec1<T> Load(Sisd<T> , const T* HWY_RESTRICT aligned) {
  T t;
...
template <typename T>
HWY_INLINE void Store(const Vec1<T> v, Sisd<T> ,
...
HWY_INLINE Vec1<ToT> PromoteTo(Sisd<ToT> , Vec1<FromT> from) {
...
HWY_INLINE Vec1<ToT> DemoteTo(Sisd<ToT> , Vec1<FromT> from) {
...
static HWY_INLINE Vec1<float> PromoteTo(Sisd<float> ,
...
static HWY_INLINE Vec1<float16_t> DemoteTo(Sisd<float16_t> ,
                                           const Vec1<float> v) {
  uint32_t bits32;
...
template <typename FromT, typename ToT, HWY_IF_FLOAT(FromT)>
HWY_INLINE Vec1<ToT> ConvertTo(Sisd<ToT> , Vec1<FromT> from) {
