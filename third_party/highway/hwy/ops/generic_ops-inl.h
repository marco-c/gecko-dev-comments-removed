...
HWY_API void LoadInterleaved2(Simd<T, N, 0> d, const T* HWY_RESTRICT unaligned,
                              V& v0, V& v1) {
  const V A = LoadU(d, unaligned + 0 * N);  
...
HWY_API void LoadInterleaved4(Simd<T, N, 0> d, const T* HWY_RESTRICT unaligned,
  ...
  const V v5140 = InterleaveLower(d, A, B);  
  const V vd9c8 = InterleaveLower(d, C, D);  
  const V v7362 = InterleaveUpper(d, A, B);  
  const V vfbea = InterleaveUpper(d, C, D);  
...
HWY_API void LoadInterleaved4(Simd<T, N, 0> d, const T* HWY_RESTRICT unaligned,
  ...
  const V va820 = InterleaveLower(d, A, B);  
  const V vec64 = InterleaveLower(d, C, D);  
  const V vb931 = InterleaveUpper(d, A, B);  
  const V vfd75 = InterleaveUpper(d, C, D);  
...
HWY_API void LoadInterleaved4(Simd<T, N, 0> d, const T* HWY_RESTRICT unaligned,
  ...
  V D;  
  detail::LoadTransposedBlocks4(d, unaligned, A, B, C, D);
  const V v10_ev = InterleaveLower(d, A, C);  
  const V v10_od = InterleaveLower(d, B, D);  
  const V v32_ev = InterleaveUpper(d, A, C);  
  const V v32_od = InterleaveUpper(d, B, D);  
...
HWY_API void StoreInterleaved3(const Vec128<T, N> part0,
                               ...
                               const Vec128<T, N> part2, Simd<T, N, 0> ,
                               T* HWY_RESTRICT unaligned) {
...
HWY_API void StoreInterleaved3(const Vec128<T, 2> part0,
                               ...
                               const Vec128<T, 2> part2, Simd<T, 2, 0> ,
                               T* HWY_RESTRICT unaligned) {
...
HWY_API void StoreInterleaved4(const V v0, const V v1, const V v2, const V v3,
  ...
  const auto A = BitCast(d, InterleaveLower(dw, v10L, v32L));  
...
HWY_API void StoreInterleaved4(const V v0, const V v1, const V v2, const V v3,
  ...
  const auto A = InterleaveLower(d, v0, v1);  
...
HWY_API void StoreInterleaved4(const Vec128<T, N> part0,
                               ...
                               const Vec128<T, N> part3, Simd<T, N, 0> ,
                               T* HWY_RESTRICT unaligned) {
