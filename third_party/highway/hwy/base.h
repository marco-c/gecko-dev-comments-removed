...
template <>
HWY_INLINE constexpr bool IsNonCvInteger<short>() {  
  return true;
}
template <>
HWY_INLINE constexpr bool IsNonCvInteger<unsigned short>() {  
  return true;
}
template <>
...
template <>
HWY_INLINE constexpr bool IsNonCvInteger<long>() {  
  return true;
}
template <>
HWY_INLINE constexpr bool IsNonCvInteger<unsigned long>() {  
  return true;
}
template <>
HWY_INLINE constexpr bool IsNonCvInteger<long long>() {  
  return true;
}
template <>
HWY_INLINE constexpr bool IsNonCvInteger<unsigned long long>() {  
  return true;
}
