...
TEST_F(EncodedViewTest, Unlabeled) {
  ...
  std::vector<size_t> expected = {
      0,                                     
      kBaseReferenceProjection + 0 + 0 * 3,  
      PADDING,
      kBaseReferenceProjection + 1 + 0 * 3,  
      PADDING,
      PADDING,
      PADDING,
      7,                                     
      ...
      kBaseReferenceProjection + 0 + 0 * 3,  
      PADDING,
      kBaseReferenceProjection + 2 + 0 * 3,  
      PADDING,
      PADDING,
      15,  
      16,
...
TEST_F(EncodedViewTest, Labeled) {
  ...
  std::vector<size_t> expected = {
      ...
      kBaseReferenceProjection + 0 + 0 * 3,  
      PADDING,
      kBaseReferenceProjection + 1 + 2 * 3,  
      PADDING,
      PADDING,
      PADDING,
      7,                                     
      kBaseReferenceProjection + 0 + 2 * 3,  
      PADDING,
      kBaseReferenceProjection + 0 + 1 * 3,  
      PADDING,
      kBaseReferenceProjection + 2 + 0 * 3,  
      PADDING,
      PADDING,
