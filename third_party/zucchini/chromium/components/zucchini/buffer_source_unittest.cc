...
TEST_F(BufferSourceTest, Skip) {
  ...
  EXPECT_TRUE(source_.Skip(bytes_.size() - 2));  
...
TEST_F(BufferSourceTest, GetUleb128) {
  ...
  constexpr uint32_t kUnInit = 0xCCCCCCCC;  
  ...
  EXPECT_EQ(kBad, run("80"));               
  EXPECT_EQ(good(0x0U, 2U), run("80 00"));  
  EXPECT_EQ(good(0x80U, 2U), run("80 01"));
  EXPECT_EQ(good(0x7FU, 2U), run("FF 00"));  
  EXPECT_EQ(good(0x3FFFU, 2U), run("FF 7F"));
  EXPECT_EQ(good(0x0U, 1U), run("00 80"));     
  EXPECT_EQ(kBad, run("80 80"));               
  EXPECT_EQ(kBad, run("F1 88"));               
  EXPECT_EQ(good(0x0U, 3U), run("80 80 00"));  
  ...
  EXPECT_EQ(good(0x0U, 1U), run("00 00 80"));     
  EXPECT_EQ(kBad, run("80 80 80"));               
  EXPECT_EQ(kBad, run("AB CD EF"));               
  EXPECT_EQ(good(0x0U, 4U), run("80 80 80 00"));  
  ...
  EXPECT_EQ(good(0x0U, 5U), run("80 80 80 80 00"));  
  ...
  EXPECT_EQ(kBad, run("FF FF FF FF 80"));  
  EXPECT_EQ(good(0x0FFFFFFFU, 5U), run("FF FF FF FF 10"));  
  EXPECT_EQ(good(0x00000000U, 5U), run("80 80 80 80 20"));  
  EXPECT_EQ(good(0xA54A952AU, 5U), run("AA AA AA AA 7A"));  
  EXPECT_EQ(kBad, run("FF FF FF FF FF 00"));                
}
...
TEST_F(BufferSourceTest, GetSleb128) {
  ...
  constexpr int32_t kUnInit = 0xCCCCCCCC;  
  constexpr Result kBad{false, kUnInit, 0U};
  ...
  EXPECT_EQ(kBad, run("80"));              
  EXPECT_EQ(good(0x0, 2U), run("80 00"));  
  EXPECT_EQ(good(0x80, 2U), run("80 01"));
  EXPECT_EQ(good(0x7F, 2U), run("FF 00"));    
  EXPECT_EQ(good(-0x1, 2U), run("FF 7F"));    
  EXPECT_EQ(good(0x0, 1U), run("00 80"));     
  EXPECT_EQ(kBad, run("80 80"));              
  EXPECT_EQ(kBad, run("F1 88"));              
  EXPECT_EQ(good(0x0, 3U), run("80 80 00"));  
  EXPECT_EQ(good(0x4000, 3U), run("80 80 01"));
  EXPECT_EQ(good(-0x100000, 3U), run("80 80 40"));
  EXPECT_EQ(good(-0x1, 3U), run("FF FF 7F"));    
  EXPECT_EQ(good(0x0, 1U), run("00 00 80"));     
  EXPECT_EQ(kBad, run("80 80 80"));              
  EXPECT_EQ(kBad, run("AB CD EF"));              
  EXPECT_EQ(good(0x0, 4U), run("80 80 80 00"));  
  ...
  EXPECT_EQ(good(0x0, 5U), run("80 80 80 80 00"));  
  ...
  EXPECT_EQ(good(-0x1, 5U), run("FF FF FF FF 0F"));  
  EXPECT_EQ(kBad, run("FF FF FF FF 80"));            
  EXPECT_EQ(good(0x0FFFFFFF, 5U), run("FF FF FF FF 10"));   
  EXPECT_EQ(good(0x00000000, 5U), run("80 80 80 80 20"));   
  EXPECT_EQ(good(-0x5AB56AD6, 5U), run("AA AA AA AA 7A"));  
  EXPECT_EQ(kBad, run("FF FF FF FF FF 00"));                
}
...
TEST_F(BufferSourceTest, SkipLeb128) {
  ...
  EXPECT_EQ(kBad, run("80"));         
  EXPECT_EQ(good(2U), run("80 00"));  
  EXPECT_EQ(good(2U), run("80 01"));
  EXPECT_EQ(good(2U), run("FF 00"));  
  EXPECT_EQ(good(2U), run("FF 7F"));
  EXPECT_EQ(good(1U), run("00 80"));     
  EXPECT_EQ(kBad, run("80 80"));         
  EXPECT_EQ(kBad, run("F1 88"));         
  EXPECT_EQ(good(3U), run("80 80 00"));  
  EXPECT_EQ(good(3U), run("80 80 01"));
  EXPECT_EQ(good(3U), run("80 80 40"));
  EXPECT_EQ(good(3U), run("FF FF 7F"));
  EXPECT_EQ(good(1U), run("00 00 80"));     
  EXPECT_EQ(kBad, run("80 80 80"));         
  EXPECT_EQ(kBad, run("AB CD EF"));         
  EXPECT_EQ(good(4U), run("80 80 80 00"));  
  ...
  EXPECT_EQ(good(5U), run("80 80 80 80 00"));  
  ...
  EXPECT_EQ(kBad, run("FF FF FF FF 80"));      
  EXPECT_EQ(good(5U), run("FF FF FF FF 10"));  
  EXPECT_EQ(good(5U), run("80 80 80 80 20"));  
  EXPECT_EQ(good(5U), run("AA AA AA AA 7A"));  
  EXPECT_EQ(kBad, run("FF FF FF FF FF 00"));   
}
