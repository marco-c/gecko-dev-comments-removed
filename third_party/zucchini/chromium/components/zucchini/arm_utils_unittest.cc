...
uint32_t kCleanSlateB_A1 = 0x0A000000;    
uint32_t kCleanSlateBL_A1 = 0x0B000000;   
uint32_t kCleanSlateBLX_A2 = 0xFA000000;  
uint16_t kCleanSlateB_T1 = 0xD000;        
uint16_t kCleanSlateB_T2 = 0xE000;        
uint32_t kCleanSlateB_T3 = 0xF0008000;    

uint32_t kCleanSlateB_T4 = 0xF0009000 | 0x00002800;    
uint32_t kCleanSlateBL_T1 = 0xF000D000 | 0x00002800;   
uint32_t kCleanSlateBLX_T2 = 0xF000C000 | 0x00002800;  


uint32_t kCleanSlate64TBZw = 0x36000000;   
uint32_t kCleanSlate64TBZz = 0xB6000000;   
uint32_t kCleanSlate64TBNZw = 0x37000000;  
uint32_t kCleanSlate64TBNZz = 0xB7000000;  
uint32_t kCleanSlate64Bcond = 0x54000000;  
uint32_t kCleanSlate64CBZw = 0x34000000;   
uint32_t kCleanSlate64CBZz = 0xB4000000;   
uint32_t kCleanSlate64CBNZw = 0x35000000;  
uint32_t kCleanSlate64CBNZz = 0xB5000000;  
uint32_t kCleanSlate64B = 0x14000000;      
uint32_t kCleanSlate64BL = 0x94000000;     
...
static bool SplitBits(const std::string& pattern,
  ...
  CHECK_EQ(std::string::npos, bracket_start);  
...
TEST(ArmUtilsTest, SplitBits) {
  ...
  run_test("BAD", "AAAAaaaa BBBB01..", 0xEC06);  
  run_test("BAD", "AAAAaaaa BBBB01..", 0xFC16);  
  run_test("BAD", "AAAAaaaa BBBB01..", 0xFC02);  
}
