...
TEST_F(RelocUtilsWin32Test, RvaReaderEmpty) {
  {
    ...
    EXPECT_EQ(std::vector<uint32_t>(), reloc_block_offsets_);  
...
TEST_F(RelocUtilsWin32Test, RvaReaderBad) {
  std::string test_cases[] = {
      "00 C0 00 00 07 00 00",           
      "00 C0 00 00 08 00 00",           
      "00 C0 00 00 0A 00 00 00 66 31",  
      "00 C0 00 00 0C 00 00 00 66 31 88 31 FF",  
  };
