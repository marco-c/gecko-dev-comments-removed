...
std::string IntegerToString(long i) {  
  if (sizeof(i) <= sizeof(int)) {
    ...
    return IntegerToString(static_cast<long long>(i));  
  }
}
...
std::string IntegerToString(unsigned long i) {  
  if (sizeof(i) <= sizeof(unsigned int)) {
    ...
    return IntegerToString(static_cast<unsigned long long>(i));  
  }
}
...
template <>
void AppendIntegerToString(std::string& str, long i) {  
  if (sizeof(i) <= sizeof(int)) {
    return AppendIntegerToString(str, static_cast<int>(i));
  } else {
    return AppendIntegerToString(str, static_cast<long long>(i));  
  }
}
