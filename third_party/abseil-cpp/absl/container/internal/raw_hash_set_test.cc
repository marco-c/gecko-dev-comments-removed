...
using SmallTableTypes = ::testing::Types<
    ...
    ValueTable<int8_t, true, true>,
    ValueTable<int8_t, false, true>,
    
    ValueTable<int16_t, true, true>,
    ValueTable<int16_t, false, true>,
    
    ValueTable<SizedValue<16>, true, true>,
    ValueTable<SizedValue<16>, false, true>,
    
    ValueTable<SizedValue<24>, true, true>,
    ValueTable<SizedValue<24>, false, true>,
    
    MinimumAlignmentUint8Table, CustomAllocIntTable, ChangingSizeAllocIntTable,
    BadTable,
    
    ValueTable<AlignedValue<uint8_t, 2>, true, true>,
    ValueTable<AlignedValue<uint8_t, 2>, false,
               true>,
    
    ValueTable<AlignedValue<uint8_t, 7>, true, true>,
    ValueTable<AlignedValue<uint8_t, 7>, false,
               true>,
    
    ValueTable<AlignedValue<uint16_t, 3>, true,
               true>,
    ValueTable<AlignedValue<uint16_t, 3>, false,
               true>,
    
    ValueTable<AlignedValue<uint16_t, 5>, true,
               true>,
    ValueTable<AlignedValue<uint16_t, 5>, false,
               true>>;
