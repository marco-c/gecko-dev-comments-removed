...
ListStr = List[str]  
OptManifest = Optional[TOMLDocument]  
...
class State:
    ...
    def __init__(self, fix: bool, config, topsrcdir: str):
        ...
        self._results: List = []  
        self._path: str = ""  
        self._manifest_str: str = ""  
        self._manifest_fixed: int = 0  
        self._fixed: int = 0  
        self.section: str = ""  
        self.condition: str = ""  
        self.section_char: int = 0  
    ...
    def make_result(self, message: str, is_error: bool = False) -> Dict:  
...
def lint(paths, config, fix=None, **lintargs):
    ...
    for file_name in file_names:
        ...
        if state.manifest_fixed() > 0:
            manifest_str: str = alphabetize_toml_str(manifest, True)  
