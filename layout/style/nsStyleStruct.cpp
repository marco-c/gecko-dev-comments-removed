...
nsChangeHint nsStyleFont::CalcDifference(const nsStyleFont& aNewData) const {
 ...
 nscoord nsStyleFont::ZoomText(const nsPresContext* aPresContext,
                                           nscoord aSize) {
 ...
 already_AddRefed<nsAtom> nsStyleFont::GetLanguage(
...
nsChangeHint nsStyleXUL::CalcDifference(const nsStyleXUL& aNewData) const {
 ...
 const uint32_t nsStyleColumn::kColumnCountAuto;
