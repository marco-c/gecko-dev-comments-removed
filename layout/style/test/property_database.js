...
var gCSSProperties = {
  ...
  "border-radius": {
    ...
    other_values: [ "0%", "3%", "1px", "2em", "3em 2px", "2pt 3% 4em", "2px 2px 2px 2px", 
            "3% / 2%", "1px / 4px", "2em / 1em", "3em 2px / 2px 3em", "2pt 3% 4em / 4pt 1% 5em", "2px 2px 2px 2px / 4px 4px 4px 4px", "1pt / 2pt 3pt", "4pt 5pt / 3pt", 
      "calc(-1%)",
      "calc(2px)",
      "calc(50%)",
      "calc(3*25px)",
...
function logical_box_prop_get_computed(cs, property)
{
  ...
  if (/^-moz-/.test(property)) {
    ...
    property = property.replace("offset-", "").replace("inset-", "");  
