...
nsIFrame* nsLayoutUtils::GetStyleFrame(const nsIContent* aContent) {
 ...
 nsIFrame* nsLayoutUtils::GetRealPrimaryFrameFor(
...
nsresult nsLayoutUtils::PaintFrame(gfxContext* aRenderingContext,
  ...
  if (gfxPrefs::GfxLoggingPaintedPixelCountEnabled()) {
    ...
    for (auto i = history.begin(); i != history.end(); i++) {
      ...
      MOZ_ASSERT(paintedInLastSecond);  
    }
...
static void AddStateBitToAncestors(nsIFrame* aFrame, nsFrameState aBit) {
 ...
 nscoord nsLayoutUtils::ComputeCBDependentValue(
...
nsSize nsLayoutUtils::ComputeAutoSizeWithIntrinsicDimensions(
 ...
 nscoord nsLayoutUtils::MinISizeFromInline(
 ...
 nscoord nsLayoutUtils::PrefISizeFromInline(
    nsIFrame* aFrame, gfxContext* aRenderingContext) {
  NS_ASSERTION(!aFrame->IsContainerForFontSizeInflation(),
               "should not be container for font size inflation");
...
void nsLayoutUtils::DrawUniDirString(const char16_t* aString, uint32_t aLength,
 ...
 nscoord nsLayoutUtils::GetCenteredFontBaseline(
 ...
 bool nsLayoutUtils::GetLastLineBaseline(WritingMode aWM,
                                                     const nsIFrame* aFrame,
                                                     nscoord* aResult) {
  if (aFrame->StyleDisplay()->IsContainLayout()) {
    return false;
...
static nscoord CalculateBlockContentBEnd(WritingMode aWM,
 ...
 nscoord nsLayoutUtils::CalculateContentBEnd(WritingMode aWM,
                                                         nsIFrame* aFrame) {
  MOZ_ASSERT(aFrame, "null ptr");
...
static gfxPoint MapToFloatUserPixels(const gfxSize& aSize, const gfxRect& aDest,
 ...
 gfxRect nsLayoutUtils::RectToGfxRect(
...
static ImgDrawResult DrawImageInternal(
 ...
 nsPoint nsLayoutUtils::GetBackgroundFirstTilePos(
 ...
 nsRect nsLayoutUtils::GetWholeImageDestination(
...
static bool NonZeroStyleCoord(const nsStyleCoord& aCoord) {
 ...
 bool nsLayoutUtils::HasNonZeroCorner(
...
static bool IsCornerAdjacentToSide(uint8_t aCorner, Side aSide) {
 ...
 bool nsLayoutUtils::HasNonZeroCornerOnSide(
...
static bool IsInLetterFrame(nsIFrame* aFrame) {
 ...
 void nsLayoutUtils::AssertTreeOnlyEmptyNextInFlows(
...
static void GetFontFacesForFramesInner(
 ...
 nsresult nsLayoutUtils::GetFontFacesForFrames(
...
static void AddFontsFromTextRun(gfxTextRun* aTextRun, nsTextFrame* aFrame,
 ...
 void nsLayoutUtils::GetFontFacesForText(
...
float nsLayoutUtils::FontSizeInflationFor(const nsIFrame* aFrame) {
 ...
 bool nsLayoutUtils::FontSizeInflationEnabled(
    nsPresContext* aPresContext) {
 ...
 nsRect nsLayoutUtils::GetBoxShadowRectForFrame(
...
nsLayoutUtils::ScrollbarAreaToExcludeFromCompositionBoundsFor(
 ...
 nsRect nsLayoutUtils::CalculateExpandedScrollableRect(
    nsIFrame* aFrame) {
 ...
 void nsLayoutUtils::DoLogTestDataForPaint(
...
void MaybeSetupTransactionIdAllocator(layers::LayerManager* aManager,
 ...
 void nsLayoutUtils::SetBSizeFromFontMetrics(
...
static void MaybeReflowForInflationScreenSizeChange(
 ...
 bool nsLayoutUtils::CanScrollOriginClobberApz(
 ...
 bool nsLayoutUtils::ContainsMetricsWithId(
 ...
 void nsLayoutUtils::GetFrameTextContent(nsIFrame* aFrame,
                                                     nsAString& aResult) {
  aResult.Truncate();
...
nsRect nsLayoutUtils::GetSelectionBoundingRect(Selection* aSel) {
 ...
 nsBlockFrame* nsLayoutUtils::GetFloatContainingBlock(
    nsIFrame* aFrame) {
...
static void UpdateDisplayPortMarginsForPendingMetrics(
 ...
 bool nsLayoutUtils::IsTransformed(nsIFrame* aForFrame,
                                               nsIFrame* aTopFrame) {
...
static nsRect ComputeHTMLReferenceRect(nsIFrame* aFrame,
 ...
 nsRect nsLayoutUtils::ComputeGeometryBox(
 ...
 nsPoint nsLayoutUtils::ComputeOffsetToUserSpace(
...
already_AddRefed<nsFontMetrics> nsLayoutUtils::GetMetricsFor(
 ...
 void nsLayoutUtils::FixupNoneGeneric(
 ...
 void nsLayoutUtils::ApplyMinFontSize(
...
static float ResolveTransformOrigin(
 ...
 Maybe<MotionPathData> nsLayoutUtils::ResolveMotionPath(
    const nsIFrame* aFrame) {
  MOZ_ASSERT(aFrame);
