...
bool nsBulletFrame::IsSelfEmpty() {
 ...
 void nsBulletFrame::DidSetComputedStyle(
...
void nsBulletFrame::Reflow(nsPresContext* aPresContext, ReflowOutput& aMetrics,
 ...
 nscoord nsBulletFrame::GetMinISize(
    gfxContext* aRenderingContext) {
  WritingMode wm = GetWritingMode();
 ...
 nscoord nsBulletFrame::GetPrefISize(
    gfxContext* aRenderingContext) {
  WritingMode wm = GetWritingMode();
...
static inline bool IsIgnoreable(const nsIFrame* aFrame, nscoord aISize) {
 ...
 void nsBulletFrame::AddInlineMinISize(
 ...
 void nsBulletFrame::AddInlinePrefISize(
