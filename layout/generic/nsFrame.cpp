...
void
nsIFrame::InvalidateFrameSubtree(bool aRebuildDisplayItems )
{
...
void
nsIFrame::InvalidateFrame(uint32_t aDisplayItemKey, bool aRebuildDisplayItems )
{
  bool hasDisplayItem =
...
void
nsIFrame::InvalidateFrameWithRect(const nsRect& aRect, uint32_t aDisplayItemKey, bool aRebuildDisplayItems )
{
  if (aRect.IsEmpty()) {
    return;
  }
