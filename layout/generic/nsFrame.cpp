...
void nsIFrame::MarkNeedsDisplayItemRebuild() {
 ...
 void nsFrame::DidSetComputedStyle(
...
bool nsIFrame::ComputeBorderRadii(const BorderRadius& aBorderRadius,
 ...
 void nsIFrame::InsetBorderRadii(nscoord aRadii[8],
 ...
 void nsIFrame::OutsetBorderRadii(nscoord aRadii[8],
                                              const nsMargin& aOffsets) {
...
nsresult nsFrame::GetCursor(const nsPoint& aPoint, nsIFrame::Cursor& aCursor) {
 ...
 void nsFrame::AddInlineMinISize(
 ...
 void nsFrame::AddInlinePrefISize(
...
static nsIFrame::IntrinsicISizeOffsetData IntrinsicSizeOffsets(
 ...
 nsIFrame::IntrinsicISizeOffsetData nsFrame::IntrinsicISizeOffsets(
    nscoord aPercentageBasis) {
...
nsRect nsFrame::ComputeSimpleTightBounds(DrawTarget* aDrawTarget) const {
 ...
 nsresult nsIFrame::GetPrefWidthTightBounds(gfxContext* aContext,
                                                         nscoord* aX,
                                                         nscoord* aXMost) {
...
bool nsIFrame::UpdateOverflow() {
 ...
 bool nsFrame::ComputeCustomOverflow(
    nsOverflowAreas& aOverflowAreas) {
  return true;
}

 void nsFrame::UnionChildOverflow(
    nsOverflowAreas& aOverflowAreas) {
  if (!DoesClipChildren() &&
...
void nsIFrame::UpdateStyleOfChildAnonBox(nsIFrame* aChildFrame,
 ...
 void nsIFrame::RemoveInPopupStateBitFromDescendants(
    nsIFrame* aFrame) {
  if (!aFrame->HasAnyStateBits(NS_FRAME_IN_POPUP) ||
...
void DR_cookie::Change() const {
 ...
 void* ReflowInput::DisplayInitConstraintsEnter(
 ...
 void SizeComputationInput::DisplayInitOffsetsExit(
