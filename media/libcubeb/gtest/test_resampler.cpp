...
const uint32_t min_chunks = 10; 
const uint32_t max_chunks = 30; 
...
long data_cb_resampler(cubeb_stream * , void * user_ptr,
...
long test_output_only_noop_data_cb(cubeb_stream * , void * ,
...
long test_drain_data_cb(cubeb_stream * , void * user_ptr,
                        const void * input_buffer,
                        void * output_buffer, long frame_count)
{
  EXPECT_TRUE(output_buffer);
...
long cb_passthrough_resampler_output(cubeb_stream * , void * ,
                                     const void * input_buffer,
                                     void * output_buffer, long frame_count)
{
...
long cb_passthrough_resampler_input(cubeb_stream * , void * ,
                                    const void * input_buffer,
                                    void * output_buffer, long frame_count)
{
...
long cb_passthrough_resampler_duplex(cubeb_stream * , void * user_ptr,
                                     const void * input_buffer,
                                     void * output_buffer, long frame_count)
{
