...
static long
test_data_callback(cubeb_stream * stm, void * user_ptr, const void * , void * outputbuffer, long nframes)
{
...
void
test_state_callback(cubeb_stream * , void * , cubeb_state )
{
}
...
static long
test_drain_data_callback(cubeb_stream * stm, void * user_ptr, const void * , void * outputbuffer, long nframes)
{
  EXPECT_TRUE(stm && user_ptr == &dummy && outputbuffer && nframes > 0);
  assert(outputbuffer);
  if (do_drain == 1) {
...
void
test_drain_state_callback(cubeb_stream * , void * , cubeb_state state)
{
