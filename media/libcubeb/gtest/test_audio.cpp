...
long data_cb_float(cubeb_stream * , void * user, const void * , void * outputbuffer, long nframes)
{
...
long data_cb_short(cubeb_stream * , void * user, const void * , void * outputbuffer, long nframes)
{
  synth_state *synth = (synth_state *)user;
...
void state_cb_audio(cubeb_stream * , void * , cubeb_state )
{
}
