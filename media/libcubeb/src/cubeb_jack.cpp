...
static void
silent_jack_error_callback(char const * )
{
}
...
static char const *
cbjack_get_backend_id(cubeb * )
{
  return "jack";
}

static int
cbjack_get_max_channel_count(cubeb * , uint32_t * max_channels)
{
...
static int
cbjack_get_min_latency(cubeb * ctx, cubeb_stream_params ,
                       uint32_t * latency_ms)
{
...
static int
cbjack_stream_device_destroy(cubeb_stream * , cubeb_device * device)
{
...
static int
cbjack_device_collection_destroy(cubeb * ,
                                 cubeb_device_collection * collection)
{
  XASSERT(collection);
