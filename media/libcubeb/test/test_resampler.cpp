...
long
data_cb_resampler(cubeb_stream * , void * user_ptr,
...
long
test_output_only_noop_data_cb(cubeb_stream * , void * ,
                              const void * input_buffer, void * output_buffer,
                              long frame_count)
{
...
long
test_drain_data_cb(cubeb_stream * , void * user_ptr,
                   const void * input_buffer, void * output_buffer,
                   long frame_count)
{
  EXPECT_TRUE(output_buffer);
...
long
cb_passthrough_resampler_output(cubeb_stream * , void * ,
                                const void * input_buffer, void * output_buffer,
                                long frame_count)
{
...
long
cb_passthrough_resampler_input(cubeb_stream * , void * ,
                               const void * input_buffer, void * output_buffer,
                               long frame_count)
{
...
long
cb_passthrough_resampler_duplex(cubeb_stream * , void * user_ptr,
                                const void * input_buffer, void * output_buffer,
                                long frame_count)
{
...
TEST(cubeb, resampler_passthrough_duplex_callback_reordering)
{
  ...
  for (uint32_t i = 0; i < 300; i++) {
    ...
    if (i != 0 && (i % 100) == 0) {
      long zero = 0;
      got =
          cubeb_resampler_fill(resampler, input_buffer_normal ,
