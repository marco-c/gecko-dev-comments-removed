...
fn read_ftyp() {
    ...
    assert_eq!(parsed.major_brand, 0x6d703432); 
    assert_eq!(parsed.minor_version, 0);
    assert_eq!(parsed.compatible_brands.len(), 2);
    assert_eq!(parsed.compatible_brands[0], 0x69736f6d); 
    assert_eq!(parsed.compatible_brands[1], 0x6d703432); 
}
...
fn read_ftyp_case() {
    ...
    assert_eq!(parsed.minor_version, 0);
    assert_eq!(parsed.compatible_brands.len(), 2);
    assert_eq!(parsed.compatible_brands[0], 0x49534f4d); 
    assert_eq!(parsed.compatible_brands[1], 0x4d503432); 
}
...
fn read_hdlr() {
    ...
    assert_eq!(parsed.handler_type, 0x76696465); 
}
