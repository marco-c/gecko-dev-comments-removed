...
TEST_F(WebRtcIceConnectTest, TestConnectRestartIce) {
  ...
  SendReceive(p1_.get(), p2_.get()); 
  SendReceive(p3_.get(), p2_.get()); 

  p2_->FinalizeIceRestart();
  SendReceive(p3_.get(), p2_.get()); 

  SendReceive(p1_.get(), p2_.get(), false, true); 
...
TEST_F(WebRtcIceConnectTest, TestConnectRestartIceThenAbort) {
  ...
  SendReceive(p3_.get(), p2_.get(), false, true); 
...
TEST_F(WebRtcIcePrioritizerTest, TestPrioritizer) {
  ...
  AddInterface("0", NR_INTERFACE_TYPE_VPN, 100); 
  AddInterface("1", NR_INTERFACE_TYPE_VPN | NR_INTERFACE_TYPE_WIRED, 100); 
  AddInterface("2", NR_INTERFACE_TYPE_VPN | NR_INTERFACE_TYPE_WIFI, 100); 
  AddInterface("3", NR_INTERFACE_TYPE_VPN | NR_INTERFACE_TYPE_MOBILE, 100); 
  AddInterface("4", NR_INTERFACE_TYPE_WIRED, 1000); 
  AddInterface("5", NR_INTERFACE_TYPE_WIRED, 10); 
  AddInterface("6", NR_INTERFACE_TYPE_WIFI, 10); 
  AddInterface("7", NR_INTERFACE_TYPE_WIFI, 1000); 
  AddInterface("8", NR_INTERFACE_TYPE_MOBILE, 10); 
  AddInterface("9", NR_INTERFACE_TYPE_MOBILE, 1000); 
  AddInterface("10", NR_INTERFACE_TYPE_UNKNOWN, 10); 
  AddInterface("11", NR_INTERFACE_TYPE_UNKNOWN, 1000); 
