...
void vp8_short_fdct8x4_neon(int16_t *input, int16_t *output, int pitch) {
  ...
  v2tmp0 = vtrnq_s16(vreinterpretq_s16_s32(v2tmp2.val[0]),   
                     vreinterpretq_s16_s32(v2tmp3.val[0]));  
  v2tmp1 = vtrnq_s16(vreinterpretq_s16_s32(v2tmp2.val[1]),   
                     vreinterpretq_s16_s32(v2tmp3.val[1]));  
