...
const vp9_extra_bit vp9_extra_bits[ENTROPY_TOKENS] = {
  ...
  {0, 0, 3, sign_cost},                          
  {0, 0, 4, sign_cost},                          
  {vp9_cat1_prob, 1,  CAT1_MIN_VAL, cat1_cost},  
  {vp9_cat2_prob, 2,  CAT2_MIN_VAL, cat2_cost},  
  {vp9_cat3_prob, 3,  CAT3_MIN_VAL, cat3_cost},  
  {vp9_cat4_prob, 4,  CAT4_MIN_VAL, cat4_cost},  
  {vp9_cat5_prob, 5,  CAT5_MIN_VAL, cat5_cost},  
  {vp9_cat6_prob, 14, CAT6_MIN_VAL, 0},          
  {0, 0, 0, zero_cost}                           
};
...
const vp9_extra_bit vp9_extra_bits_high10[ENTROPY_TOKENS] = {
  ...
  {vp9_cat4_prob, 4,  CAT4_MIN_VAL, cat4_cost},     
  {vp9_cat5_prob, 5,  CAT5_MIN_VAL, cat5_cost},     
  {vp9_cat6_prob_high12 + 2, 16, CAT6_MIN_VAL, 0},  
  {0, 0, 0, zero_cost}                              
};
const vp9_extra_bit vp9_extra_bits_high12[ENTROPY_TOKENS] = {
  ...
  {vp9_cat4_prob, 4,  CAT4_MIN_VAL, cat4_cost},  
  {vp9_cat5_prob, 5,  CAT5_MIN_VAL, cat5_cost},  
  {vp9_cat6_prob_high12, 18, CAT6_MIN_VAL, 0},   
  {0, 0, 0, zero_cost}                           
};
#endif
