...
static void fdct4_sse2(__m128i *in) {
  ...
  u[1] = _mm_madd_epi16(v[0], k__cospi_p16_m16);  
  u[2] = _mm_madd_epi16(v[1], k__cospi_p08_p24);  
  u[3] = _mm_madd_epi16(v[1], k__cospi_p24_m08);  
...
static void fadst4_sse2(__m128i *in) {
  ...
  v[0] = _mm_madd_epi16(u[0], k__sinpi_p01_p02);  
  v[1] = _mm_madd_epi16(u[1], k__sinpi_p03_p04);  
  v[2] = _mm_madd_epi16(u[2], k__sinpi_p03_p03);  
  v[3] = _mm_madd_epi16(u[0], k__sinpi_p04_m01);  
  v[4] = _mm_madd_epi16(u[1], k__sinpi_m03_p02);  
