...
static INLINE void butterfly_two_coeff_s32_s64_noround(
    ...
    const tran_coef_t constant2, int64x2_t *add_lo ,
    int64x2_t *add_hi , int64x2_t *sub_lo ,
    int64x2_t *sub_hi ) {
...
static INLINE int32x4_t add_s64_round_narrow(const int64x2_t *a ,
                                             const int64x2_t *b ) {
  int64x2_t result[2];
...
static INLINE int32x4_t sub_s64_round_narrow(const int64x2_t *a ,
                                             const int64x2_t *b ) {
  int64x2_t result[2];
