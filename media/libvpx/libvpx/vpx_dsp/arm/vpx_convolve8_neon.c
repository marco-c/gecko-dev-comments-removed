...
void vpx_convolve8_horiz_neon(
  ...
  for (; h > 0; h -= 4,
    ...
    q8u16 = vcombine_u16(d16u16, d18u16);  
    q9u16 = vcombine_u16(d17u16, d19u16);

    d20s16 = vreinterpret_s16_u16(vget_low_u16(q10u16));
    d23s16 = vreinterpret_s16_u16(vget_high_u16(q10u16));  
    for (width = w, psrc = src + 7, pdst = dst;
         width > 0;
         width -= 4, psrc += 4, pdst += 4) {  
      s = psrc;
...
void vpx_convolve8_vert_neon(
  ...
  for (; w > 0; w -= 4, src += 4, dst += 4) {  
    ...
    d22s16 = vreinterpret_s16_u16(vget_low_u16(q11u16));
    d = dst;
    for (height = h; height > 0; height -= 4) {  
