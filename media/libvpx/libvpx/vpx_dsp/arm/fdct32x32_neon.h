...
static INLINE void scale_input(const int16x8_t *in ,
                               int16x8_t *out ) {
...
static INLINE void store32x32_s32(
    tran_low_t *a, const int32x4_t *l1 , const int32x4_t *r1 ,
    const int32x4_t *l2 , const int32x4_t *r2 ,
    const int32x4_t *l3 , const int32x4_t *r3 ,
    const int32x4_t *l4 , const int32x4_t *r4 ) {
  int i;
  for (i = 0; i < 32; i++) {
    vst1q_s32(a, l1[i]);
    vst1q_s32(a + 4, r1[i]);
...
static INLINE void highbd_scale_input(const int16x8_t *a ,
                                      int32x4_t *left ,
                                      int32x4_t *right ) {
...
static INLINE void highbd_cross_input(const int32x4_t *a_left ,
                                      int32x4_t *a_right ,
                                      int32x4_t *b_left ,
                                      int32x4_t *b_right ) {
...
static INLINE void highbd_partial_add_round_shift(int32x4_t *left ,
                                                  int32x4_t *right ) {
...
static INLINE void highbd_partial_sub_round_shift(int32x4_t *left ,
                                                  int32x4_t *right ) {
...
static INLINE void highbd_dct8x32_body_first_pass(int32x4_t *left ,
                                                  int32x4_t *right ) {
...
static INLINE void highbd_dct8x32_body_second_pass(int32x4_t *left ,
                                                   int32x4_t *right ) {
  int32x4_t al[32], ar[32];
  int32x4_t bl[32], br[32];
...
static INLINE void highbd_dct8x32_body_second_pass_rd(int32x4_t *left ,
                                                      int32x4_t *right ) {
  int32x4_t al[32], ar[32];
  int32x4_t bl[32], br[32];
