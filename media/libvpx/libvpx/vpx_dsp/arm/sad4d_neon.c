...
static INLINE void sad_512_pel_final_neon(const uint16x8_t *sum ,
                                          uint32_t *const res) {
...
static INLINE void sad_1024_pel_final_neon(const uint16x8_t *sum ,
                                           uint32_t *const res) {
...
static INLINE void sad_2048_pel_final_neon(const uint16x8_t *sum ,
                                           uint32_t *const res) {
...
static INLINE void sad_4096_pel_final_neon(const uint16x8_t *sum ,
                                           uint32_t *const res) {
  const uint32x4_t a0 = vpaddlq_u16(sum[0]);
  const uint32x4_t a1 = vpaddlq_u16(sum[1]);
  const uint32x4_t a2 = vpaddlq_u16(sum[2]);
