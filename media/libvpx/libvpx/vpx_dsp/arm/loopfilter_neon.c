...
FUN_FILTER_HEV_MASK4(8, _)    
FUN_FILTER_HEV_MASK4(16, q_)  
...
FUN_FILTER_FLAT_HEV_MASK(8, _)    
FUN_FILTER_FLAT_HEV_MASK(16, q_)  
...
FUN_FLIP_SIGN_BACK(8, _)    
FUN_FLIP_SIGN_BACK(16, q_)  
...
static INLINE void calc_7_tap_filter_16(
  ...
  sum0 = vaddl_u8(vget_low_u8(p3), vget_low_u8(p3));    
  sum1 = vaddl_u8(vget_high_u8(p3), vget_high_u8(p3));  
  sum0 = vaddw_u8(sum0, vget_low_u8(p3));               
  sum1 = vaddw_u8(sum1, vget_high_u8(p3));              
  sum0 = vaddw_u8(sum0, vget_low_u8(p2));               
  sum1 = vaddw_u8(sum1, vget_high_u8(p2));              
  sum0 = vaddw_u8(sum0, vget_low_u8(p2));               
  sum1 = vaddw_u8(sum1, vget_high_u8(p2));              
  sum0 = vaddw_u8(sum0, vget_low_u8(p1));               
  sum1 = vaddw_u8(sum1, vget_high_u8(p1));              
  sum0 = vaddw_u8(sum0, vget_low_u8(p0));               
  sum1 = vaddw_u8(sum1, vget_high_u8(p0));              
  sum0 = vaddw_u8(sum0, vget_low_u8(q0));               
  sum1 = vaddw_u8(sum1, vget_high_u8(q0));              
...
FUN_APPLY_7_TAP_FILTER(8, _)    
FUN_APPLY_7_TAP_FILTER(16, q_)  
...
static INLINE void apply_15_tap_filter_16(
  ...
  uint16x8_t sum0, sum1;
  uint8x16_t t;
  sum0 = vshll_n_u8(vget_low_u8(p7), 3);    
  sum1 = vshll_n_u8(vget_high_u8(p7), 3);   
  sum0 = vsubw_u8(sum0, vget_low_u8(p7));   
  sum1 = vsubw_u8(sum1, vget_high_u8(p7));  
  sum0 = vaddw_u8(sum0, vget_low_u8(p6));   
  sum1 = vaddw_u8(sum1, vget_high_u8(p6));  
  sum0 = vaddw_u8(sum0, vget_low_u8(p6));   
  sum1 = vaddw_u8(sum1, vget_high_u8(p6));  
  sum0 = vaddw_u8(sum0, vget_low_u8(p5));   
  sum1 = vaddw_u8(sum1, vget_high_u8(p5));  
  sum0 = vaddw_u8(sum0, vget_low_u8(p4));   
  sum1 = vaddw_u8(sum1, vget_high_u8(p4));  
  sum0 = vaddw_u8(sum0, vget_low_u8(p3));   
  sum1 = vaddw_u8(sum1, vget_high_u8(p3));  
  sum0 = vaddw_u8(sum0, vget_low_u8(p2));   
  sum1 = vaddw_u8(sum1, vget_high_u8(p2));  
...
FUN_HOR_4_KERNEL(_, 8)        
FUN_HOR_4_KERNEL(_dual_, 16)  
