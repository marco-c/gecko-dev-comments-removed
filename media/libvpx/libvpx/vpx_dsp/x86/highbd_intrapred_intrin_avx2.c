...
void vpx_highbd_d63_predictor_32x32_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  const __m256i A0 = _mm256_loadu_si256((const __m256i *)(above));  
  const __m256i A1 =
      _mm256_loadu_si256((const __m256i *)(above + 16));  
...
void vpx_highbd_d207_predictor_32x32_avx2(uint16_t *dst, ptrdiff_t stride,
  ...
  const __m256i A0 = _mm256_loadu_si256((const __m256i *)left);  
  const __m256i A1 =
      _mm256_loadu_si256((const __m256i *)(left + 16));  
