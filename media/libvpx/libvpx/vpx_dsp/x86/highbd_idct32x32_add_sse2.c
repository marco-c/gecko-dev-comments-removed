...
static INLINE void highbd_idct32_4x32_quarter_3_4_stage_4_to_7(
  ...
  step2[20] = _mm_sub_epi32(step1[20], step1[23]);  
  step2[21] = _mm_sub_epi32(step1[21], step1[22]);  
  ...
  step2[26] = _mm_sub_epi32(step1[26], step1[25]);  
  step2[27] = _mm_sub_epi32(step1[27], step1[24]);  
...
static INLINE void highbd_idct32_1024_4x32_quarter_2(
  ...
  step1[10] = _mm_sub_epi32(step2[10], step2[11]);  
  step1[11] = _mm_add_epi32(step2[10], step2[11]);
  step1[12] = _mm_add_epi32(step2[13], step2[12]);
  step1[13] = _mm_sub_epi32(step2[13], step2[12]);  
...
static INLINE void highbd_idct32_34_4x32_quarter_2(const __m128i *in ,
  ...
  step1[10] =
      _mm_sub_epi32(_mm_setzero_si128(), step1[10]);  
  step1[13] =
      _mm_sub_epi32(_mm_setzero_si128(), step1[13]);  
  highbd_idct32_4x32_quarter_2_stage_4_to_6(step1, out);
}
...
static INLINE void highbd_idct32_34_4x32_quarter_3_4(
  ...
  step2[18] =
      _mm_sub_epi32(_mm_setzero_si128(), step2[18]);  
  step2[22] =
      _mm_sub_epi32(_mm_setzero_si128(), step2[22]);  
  step2[25] =
      _mm_sub_epi32(_mm_setzero_si128(), step2[25]);  
  step2[29] =
      _mm_sub_epi32(_mm_setzero_si128(), step2[29]);  
  step1[16] = step2[16];
  step1[31] = step2[31];
  highbd_butterfly_sse2(step2[30], step2[17], cospi_28_64, cospi_4_64,
                        &step1[17], &step1[30]);
