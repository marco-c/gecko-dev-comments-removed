...
static INLINE __m128i dct_const_round_shift_4_sse2(const __m128i in0,
  ...
  const __m128i t2 = _mm_unpacklo_epi64(t0, t1);    
...
static INLINE void highbd_idct4_small_sse2(__m128i *const io) {
  ...
  temp1[0] = _mm_add_epi32(io[0], io[2]);             
  temp2[0] = _mm_sub_epi32(io[0], io[2]);             
  temp1[1] = _mm_srli_si128(temp1[0], 4);             
  temp2[1] = _mm_srli_si128(temp2[0], 4);             
  temp1[0] = _mm_mul_epu32(temp1[0], cospi_p16_p16);  
  temp1[1] = _mm_mul_epu32(temp1[1], cospi_p16_p16);  
  temp2[0] = _mm_mul_epu32(temp2[0], cospi_p16_p16);  
  temp2[1] = _mm_mul_epu32(temp2[1], cospi_p16_p16);  
  ...
  temp1[0] = _mm_mul_epu32(io[1], cospi_p24_p24);     
  temp1[1] = _mm_mul_epu32(temp1[3], cospi_p24_p24);  
  temp2[0] = _mm_mul_epu32(io[1], cospi_p08_p08);     
  temp2[1] = _mm_mul_epu32(temp1[3], cospi_p08_p08);  
  temp1[2] = _mm_mul_epu32(io[3], cospi_p08_p08);     
  temp1[3] = _mm_mul_epu32(temp2[3], cospi_p08_p08);  
  temp2[2] = _mm_mul_epu32(io[3], cospi_p24_p24);     
  temp2[3] = _mm_mul_epu32(temp2[3], cospi_p24_p24);  
  temp1[0] = _mm_sub_epi64(temp1[0], temp1[2]);  
  temp1[1] = _mm_sub_epi64(temp1[1], temp1[3]);  
  temp2[0] = _mm_add_epi64(temp2[0], temp2[2]);  
  temp2[1] = _mm_add_epi64(temp2[1], temp2[3]);  
  step[2] = dct_const_round_shift_4_sse2(temp1[0], temp1[1]);
  step[3] = dct_const_round_shift_4_sse2(temp2[0], temp2[1]);

  
  io[0] = _mm_add_epi32(step[0], step[3]);  
  io[1] = _mm_add_epi32(step[1], step[2]);  
  io[2] = _mm_sub_epi32(step[1], step[2]);  
  io[3] = _mm_sub_epi32(step[0], step[3]);  
}
