...
static void highbd_idct32_1024_4x32(__m128i *const io ) {
  __m128i temp[32];
...
static void highbd_idct32_135_4x32(__m128i *const io ) {
  __m128i temp[32];
...
static INLINE void highbd_idct32_34_4x32_quarter_2(const __m128i *in ,
                                                   __m128i *out ) {
  __m128i step1[32], step2[32];
...
static void highbd_idct32_34_4x32(__m128i *const io ) {
  __m128i temp[32];
