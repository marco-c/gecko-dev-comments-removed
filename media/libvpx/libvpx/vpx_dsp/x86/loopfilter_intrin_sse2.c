...
void vpx_lpf_horizontal_4_sse2(uint8_t *s, int pitch, const uint8_t *blimit,
  ...
  _mm_storeh_pi((__m64 *)(s - 2 * pitch), _mm_castsi128_ps(ps1ps0));  
  _mm_storel_epi64((__m128i *)(s - 1 * pitch), ps1ps0);               
  _mm_storel_epi64((__m128i *)(s + 0 * pitch), qs1qs0);               
  _mm_storeh_pi((__m64 *)(s + 1 * pitch), _mm_castsi128_ps(qs1qs0));  
}
