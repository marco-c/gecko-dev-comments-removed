...
void ScaleRowDown2Box_AVX2(const uint8* src_ptr, ptrdiff_t src_stride,
  ...
  "1:                                          \n"
    "vmovdqu    " MEMACCESS(0) ",%%ymm0        \n"
    "vmovdqu    " MEMACCESS2(0x20,0) ",%%ymm1  \n"
    MEMOPREG(vmovdqu,0x00,0,3,1,ymm2)          
    MEMOPREG(vmovdqu,0x20,0,3,1,ymm3)          
    "lea        " MEMLEA(0x40,0) ",%0          \n"
    "vpmaddubsw %%ymm4,%%ymm0,%%ymm0           \n"
    "vpmaddubsw %%ymm4,%%ymm1,%%ymm1           \n"
...
void ScaleRowDown4Box_SSSE3(const uint8* src_ptr, ptrdiff_t src_stride,
  ...
  "1:                                          \n"
    ...
    "paddw      %%xmm2,%%xmm0                  \n"
    "paddw      %%xmm3,%%xmm1                  \n"
    MEMOPREG(movdqu,0x00,0,4,2,xmm2)           
    MEMOPREG(movdqu,0x10,0,4,2,xmm3)           
    "pmaddubsw  %%xmm4,%%xmm2                  \n"
    "pmaddubsw  %%xmm4,%%xmm3                  \n"
    "paddw      %%xmm2,%%xmm0                  \n"
    "paddw      %%xmm3,%%xmm1                  \n"
...
void ScaleRowDown4Box_AVX2(const uint8* src_ptr, ptrdiff_t src_stride,
  ...
  "1:                                          \n"
    ...
    "vpaddw     %%ymm2,%%ymm0,%%ymm0           \n"
    "vpaddw     %%ymm3,%%ymm1,%%ymm1           \n"
    MEMOPREG(vmovdqu,0x00,0,3,2,ymm2)          
    MEMOPREG(vmovdqu,0x20,0,3,2,ymm3)          
    "vpmaddubsw %%ymm4,%%ymm2,%%ymm2           \n"
    "vpmaddubsw %%ymm4,%%ymm3,%%ymm3           \n"
    "vpaddw     %%ymm2,%%ymm0,%%ymm0           \n"
    "vpaddw     %%ymm3,%%ymm1,%%ymm1           \n"
    MEMOPREG(vmovdqu,0x00,0,4,1,ymm2)          
    MEMOPREG(vmovdqu,0x20,0,4,1,ymm3)          
    "lea        " MEMLEA(0x40,0) ",%0          \n"
    "vpmaddubsw %%ymm4,%%ymm2,%%ymm2           \n"
    "vpmaddubsw %%ymm4,%%ymm3,%%ymm3           \n"
    "vpaddw     %%ymm2,%%ymm0,%%ymm0           \n"
...
void ScaleRowDown34_1_Box_SSSE3(const uint8* src_ptr,
  ...
  "1:                                          \n"
    ...
    MEMOPREG(movdqu,0x00,0,3,1,xmm7)           
    "pavgb     %%xmm7,%%xmm6                   \n"
    "pshufb    %%xmm2,%%xmm6                   \n"
    "pmaddubsw %%xmm5,%%xmm6                   \n"
    "paddsw    %%xmm1,%%xmm6                   \n"
    ...
    MEMOPREG(movdqu,0x10,0,3,1,xmm7)           
    "lea       " MEMLEA(0x20,0) ",%0           \n"
    "pavgb     %%xmm7,%%xmm6                   \n"
    "pshufb    %%xmm4,%%xmm6                   \n"
    "pmaddubsw %4,%%xmm6                       \n"
...
void ScaleRowDown38_2_Box_SSSE3(const uint8* src_ptr,
  ...
  "1:                                          \n"
    "movdqu    " MEMACCESS(0) ",%%xmm0         \n"
    MEMOPREG(movdqu,0x00,0,3,1,xmm1)           
    "lea       " MEMLEA(0x10,0) ",%0           \n"
    "pavgb     %%xmm1,%%xmm0                   \n"
    "movdqa    %%xmm0,%%xmm1                   \n"
    "pshufb    %%xmm2,%%xmm1                   \n"
...
void ScaleRowDown38_3_Box_SSSE3(const uint8* src_ptr,
  ...
  "1:                                          \n"
    "movdqu    " MEMACCESS(0) ",%%xmm0         \n"
    MEMOPREG(movdqu,0x00,0,3,1,xmm6)           
    "movhlps   %%xmm0,%%xmm1                   \n"
    "movhlps   %%xmm6,%%xmm7                   \n"
    "punpcklbw %%xmm5,%%xmm0                   \n"
    "punpcklbw %%xmm5,%%xmm1                   \n"
    ...
    "paddusw   %%xmm6,%%xmm0                   \n"
    "paddusw   %%xmm7,%%xmm1                   \n"
    MEMOPREG(movdqu,0x00,0,3,2,xmm6)           
    "lea       " MEMLEA(0x10,0) ",%0           \n"
    "movhlps   %%xmm6,%%xmm7                   \n"
    "punpcklbw %%xmm5,%%xmm6                   \n"
    "punpcklbw %%xmm5,%%xmm7                   \n"
