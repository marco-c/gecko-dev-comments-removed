...
void aom_comp_mask_upsampled_pred_sse2(MACROBLOCKD *xd, const struct AV1Common *const cm, int mi_row, int mi_col,
                                                       ...
                                                       int ref_stride, const uint8_t *mask, int mask_stride, int invert_mask,
                                                       int subpel_search);
RTCD_EXTERN void (*aom_comp_mask_upsampled_pred)(MACROBLOCKD *xd, const struct AV1Common *const cm, int mi_row, int mi_col,
                                                       const MV *const mv, uint8_t *comp_pred, const uint8_t *pred, int width,
                                                       int height, int subpel_x_q3, int subpel_y_q3, const uint8_t *ref,
                                                       int ref_stride, const uint8_t *mask, int mask_stride, int invert_mask,
                                                       int subpel_search);
...
RTCD_EXTERN unsigned int (*aom_highbd_12_variance128x128)(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
RTCD_EXTERN unsigned int (*aom_highbd_12_variance128x64)(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
RTCD_EXTERN unsigned int (*aom_highbd_12_variance64x128)(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
RTCD_EXTERN unsigned int (*aom_highbd_8_variance128x128)(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
RTCD_EXTERN unsigned int (*aom_highbd_8_variance128x64)(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
RTCD_EXTERN unsigned int (*aom_highbd_8_variance64x128)(const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse);
...
RTCD_EXTERN void (*aom_highbd_jnt_comp_avg_pred)(uint8_t *comp_pred8, const uint8_t *pred8, int width, int height, const uint8_t *ref8, int ref_stride, const JNT_COMP_PARAMS *jcp_param);
...
void aom_highbd_jnt_comp_avg_upsampled_pred_sse2(MACROBLOCKD *xd, const struct AV1Common *const cm, int mi_row, int mi_col,
                                                              ...
                                                              int height, int subpel_x_q3, int subpel_y_q3, const uint8_t *ref8,
                                                              int ref_stride, int bd, const JNT_COMP_PARAMS *jcp_param, int subpel_search);
RTCD_EXTERN void (*aom_highbd_jnt_comp_avg_upsampled_pred)(MACROBLOCKD *xd, const struct AV1Common *const cm, int mi_row, int mi_col,
                                                              const MV *const mv, uint8_t *comp_pred8, const uint8_t *pred8, int width,
                                                              int height, int subpel_x_q3, int subpel_y_q3, const uint8_t *ref8,
                                                              int ref_stride, int bd, const JNT_COMP_PARAMS *jcp_param, int subpel_search);
...
RTCD_EXTERN void (*aom_highbd_sad4x16x4d)(const uint8_t *src_ptr, int src_stride, const uint8_t * const ref_ptr[], int ref_stride, uint32_t *sad_array);
...
RTCD_EXTERN void (*aom_highbd_sad8x32x4d)(const uint8_t *src_ptr, int src_stride, const uint8_t * const ref_ptr[], int ref_stride, uint32_t *sad_array);
...
RTCD_EXTERN unsigned int (*aom_sad128xh)(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, int width, int height);
...
RTCD_EXTERN unsigned int (*aom_sad16xh)(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, int width, int height);
...
RTCD_EXTERN unsigned int (*aom_sad32xh)(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, int width, int height);
...
RTCD_EXTERN unsigned int (*aom_sad4xh)(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, int width, int height);
...
RTCD_EXTERN unsigned int (*aom_sad64xh)(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, int width, int height);
...
RTCD_EXTERN unsigned int (*aom_sad8xh)(const uint8_t *a, int a_stride, const uint8_t *b, int b_stride, int width, int height);
...
static void setup_rtcd_internal(void)
{
    ...
    aom_comp_mask_upsampled_pred = aom_comp_mask_upsampled_pred_c;
    if (flags & HAS_SSE2) aom_comp_mask_upsampled_pred = aom_comp_mask_upsampled_pred_sse2;
    ...
    aom_highbd_jnt_comp_avg_pred = aom_highbd_jnt_comp_avg_pred_c;
    if (flags & HAS_SSE2) aom_highbd_jnt_comp_avg_pred = aom_highbd_jnt_comp_avg_pred_sse2;
    aom_highbd_jnt_comp_avg_upsampled_pred = aom_highbd_jnt_comp_avg_upsampled_pred_c;
    if (flags & HAS_SSE2) aom_highbd_jnt_comp_avg_upsampled_pred = aom_highbd_jnt_comp_avg_upsampled_pred_sse2;
    ...
    aom_sad128xh = aom_sad128xh_c;
    if (flags & HAS_SSE2) aom_sad128xh = aom_sad128xh_sse2;
    ...
    aom_sad16xh = aom_sad16xh_c;
    if (flags & HAS_SSE2) aom_sad16xh = aom_sad16xh_sse2;
    ...
    aom_sad32xh = aom_sad32xh_c;
    if (flags & HAS_SSE2) aom_sad32xh = aom_sad32xh_sse2;
    ...
    aom_sad4xh = aom_sad4xh_c;
    if (flags & HAS_SSE2) aom_sad4xh = aom_sad4xh_sse2;
    ...
    aom_sad64xh = aom_sad64xh_c;
    if (flags & HAS_SSE2) aom_sad64xh = aom_sad64xh_sse2;
    ...
    aom_sad8xh = aom_sad8xh_c;
    if (flags & HAS_SSE2) aom_sad8xh = aom_sad8xh_sse2;
