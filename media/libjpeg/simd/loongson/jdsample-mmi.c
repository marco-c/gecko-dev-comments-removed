                                   ...
                                   JSAMPARRAY *output_data_ptr)
{
  ...
  for (inrow = 0, outrow = 0; outrow < max_v_samp_factor; inrow++) {
    ...
    mm0 = _mm_load_si64((__m64 *)inptr0);     
    mm1 = _mm_load_si64((__m64 *)inptr_1);    
    mm2 = _mm_load_si64((__m64 *)inptr1);     
    ...
    mm1 = _mm_and_si64(mm1, mm7);             
    mm2 = _mm_and_si64(mm2, mm7);             
    ...
    for (incol = downsampled_width; incol > 0;
      ...
      if (incol > 8) {
        ...
        mm0 = _mm_load_si64((__m64 *)inptr0 + 1);   
        mm1 = _mm_load_si64((__m64 *)inptr_1 + 1);  
        mm2 = _mm_load_si64((__m64 *)inptr1 + 1);   
        ...
        _mm_store_si64((__m64 *)outptr0 + 2, mm1);  
        _mm_store_si64((__m64 *)outptr0 + 3, mm5);  
        _mm_store_si64((__m64 *)outptr1 + 2, mm2);
        _mm_store_si64((__m64 *)outptr1 + 3, mm6);

        mm1 = _mm_slli_si64(mm1, (SIZEOF_MMWORD - 2) * BYTE_BIT); 
        mm2 = _mm_slli_si64(mm2, (SIZEOF_MMWORD - 2) * BYTE_BIT); 
        ...
        mm1 = _mm_and_si64(mm1, mm_tmp);      
        mm_tmp = _mm_load_si64((__m64 *)outptr1 + 1);
        mm2 = _mm_and_si64(mm2, mm_tmp);      
