                               ...
                               int num_rows)
{
  ...
  while (--num_rows >= 0) {
    ...
    for (num_cols = out_width; num_cols > 0; num_cols -= 8,
      ...
      mm7 = _mm_slli_pi16(mm7, 7);      
      mm0 = mm4;                        

      mm4 = _mm_and_si64(mm4, mm5);           
      mm5 = _mm_srli_pi16(mm5, BYTE_BIT);     
      mm0 = _mm_and_si64(mm0, mm1);           
      mm1 = _mm_srli_pi16(mm1, BYTE_BIT);     
      ...
      mm2 = mm4;                              
      mm3 = mm5;                              
      mm4 = _mm_add_pi16(mm4, mm4);           
      mm5 = _mm_add_pi16(mm5, mm5);           
      mm6 = mm0;                              
      mm7 = mm1;                              
      mm0 = _mm_add_pi16(mm0, mm0);           
      mm1 = _mm_add_pi16(mm1, mm1);           

      mm4 = _mm_mulhi_pi16(mm4, PW_MF0228);   
      mm5 = _mm_mulhi_pi16(mm5, PW_MF0228);   
      mm0 = _mm_mulhi_pi16(mm0, PW_F0402);    
      mm1 = _mm_mulhi_pi16(mm1, PW_F0402);    
      ...
      mm2 = _mm_packs_pi32(mm2, mm4);  
      mm3 = _mm_packs_pi32(mm3, mm5);  
      mm2 = _mm_sub_pi16(mm2, mm6);  
      mm3 = _mm_sub_pi16(mm3, mm7);  
      ...
      mm4 = _mm_add_pi16(mm4, wk[0]);    
      mm5 = _mm_add_pi16(mm5, wk[1]);    
      ...
      mmC = mmD;
      mmB = mmD;
      mmD = _mm_unpacklo_pi16(mmD, mmH);    
      mmC = _mm_unpackhi_pi16(mmC, mmH);    

      mmB = _mm_srli_si64(mmB, 2 * BYTE_BIT); 

      mmF = mmE;
      mmE = _mm_unpacklo_pi16(mmE, mmB);    
      mmF = _mm_unpackhi_pi16(mmF, mmB);    

      mmA = _mm_unpacklo_pi32(mmA, mmD);    
      mmE = _mm_unpacklo_pi32(mmE, mmG);    
      mmC = _mm_unpacklo_pi32(mmC, mmF);    
      ...
      mmB = _mm_unpacklo_pi8(mmB, mmD);     
      mmF = _mm_unpacklo_pi8(mmF, mmH);     

      mmC = mmA;
      mmA = _mm_unpacklo_pi16(mmA, mmE);    
      mmC = _mm_unpackhi_pi16(mmC, mmE);    
      mmG = mmB;
      mmB = _mm_unpacklo_pi16(mmB, mmF);    
      mmG = _mm_unpackhi_pi16(mmG, mmF);    

      mmD = mmA;
      mmA = _mm_unpacklo_pi32(mmA, mmB);    
      mmD = _mm_unpackhi_pi32(mmD, mmB);    
      mmH = mmC;
      mmC = _mm_unpacklo_pi32(mmC, mmG);    
      mmH = _mm_unpackhi_pi32(mmH, mmG);    
