...
void jsimd_fdct_ifast_neon(DCTELEM *data)
{
  ...
  int16x8_t z11 = vaddq_s16(tmp7, z3);        
  int16x8_t z13 = vsubq_s16(tmp7, z3);

  col5 = vaddq_s16(z13, z2);                  
  ...
  z11 = vaddq_s16(tmp7, z3);                  
  z13 = vsubq_s16(tmp7, z3);

  row5 = vaddq_s16(z13, z2);                  
