...
static VAStatus (*vaMapBufferFn)(VADisplay dpy, VABufferID buf_id, 
                                 void** pbuf );
static VAStatus (*vaUnmapBufferFn)(VADisplay dpy, VABufferID buf_id );
static VAStatus (*vaTerminateFn)(VADisplay dpy);
static VAStatus (*vaInitializeFn)(VADisplay dpy, int* major_version, 
                                  int* minor_version );
...
VAStatus vaMapBuffer(VADisplay dpy, VABufferID buf_id, 
                     void** pbuf ) {
  if (LoadVALibrary()) {
...
VAStatus vaInitialize(VADisplay dpy, int* major_version, 
                      int* minor_version ) {
  if (LoadVALibrary()) {
