...
static const AVOption options[] = {
    ...
    { "good",            "Good quality",      0, AV_OPT_TYPE_CONST, {.i64 = 0 }, 0, 0, VE, .unit = "usage"},
    { "realtime",        "Realtime encoding", 0, AV_OPT_TYPE_CONST, {.i64 = 1 },     0, 0, VE, .unit = "usage"},
    { "allintra",        "All Intra encoding", 0, AV_OPT_TYPE_CONST, {.i64 = 2 },    0, 0, VE, .unit = "usage"},
