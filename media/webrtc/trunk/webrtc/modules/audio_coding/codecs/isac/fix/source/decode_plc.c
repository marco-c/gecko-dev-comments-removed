    ...
    int16_t rshift )
{
  ...
  for (i = 0; i < len; i++)
  {
    ...
    *Out++ = (int16_t)WEBRTC_SPL_MUL_16_16_RSFT( (int16_t)o, decay, 15); 
...
static __inline int16_t  exp2_Q10_T(int16_t x) { 
                                    ...
                                    int16_t *current_framesamples )
{
  ...
  gainQ13 = (int16_t) (tmp32b >> 5); 

  
  for (k = 0; k < FRAMESAMPLES_HALF; k++)
    Vector_Word32_1[k] = (Vector_Word16_2[k] * gainQ13) << 3;  
