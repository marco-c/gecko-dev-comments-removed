...
class APITest : public ACMTest {
 ...
 private:
  ...
  EventTimerWrapper* _pullEventA;      
  EventTimerWrapper* _pushEventA;      
  EventTimerWrapper* _processEventA;   
  EventWrapper* _apiEventA;       
  
  EventTimerWrapper* _pullEventB;      
  EventTimerWrapper* _pushEventB;      
  EventTimerWrapper* _processEventB;   
