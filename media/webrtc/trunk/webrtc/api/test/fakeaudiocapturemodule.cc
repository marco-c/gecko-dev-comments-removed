...
int32_t FakeAudioCaptureModule::SetAGC(bool ) {
...
int32_t FakeAudioCaptureModule::SetWaveOutVolume(uint16_t ,
                                                 uint16_t ) {
  RTC_NOTREACHED();
  return 0;
}
...
int32_t FakeAudioCaptureModule::SetMicrophoneBoost(bool ) {
  RTC_NOTREACHED();
  return 0;
}

int32_t FakeAudioCaptureModule::MicrophoneBoost(bool* ) const {
  RTC_NOTREACHED();
  return 0;
}
...
int32_t FakeAudioCaptureModule::SetPlayoutBuffer(const BufferType ,
                                                 uint16_t ) {
  RTC_NOTREACHED();
  return 0;
}

int32_t FakeAudioCaptureModule::PlayoutBuffer(BufferType* ,
                                              uint16_t* ) const {
  RTC_NOTREACHED();
  return 0;
}
...
int32_t FakeAudioCaptureModule::RecordingDelay(uint16_t* ) const {
  RTC_NOTREACHED();
  return 0;
}

int32_t FakeAudioCaptureModule::CPULoad(uint16_t* ) const {
  RTC_NOTREACHED();
  return 0;
}

int32_t FakeAudioCaptureModule::StartRawOutputFileRecording(
    const char [webrtc::kAdmMaxFileNameSize]) {
  RTC_NOTREACHED();
  return 0;
}
...
int32_t FakeAudioCaptureModule::SetLoudspeakerStatus(bool ) {
  RTC_NOTREACHED();
  return 0;
}

int32_t FakeAudioCaptureModule::GetLoudspeakerStatus(bool* ) const {
  RTC_NOTREACHED();
  return 0;
}
