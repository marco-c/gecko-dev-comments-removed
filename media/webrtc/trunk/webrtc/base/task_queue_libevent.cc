...
void TaskQueue::OnWakeup(int socket, short flags, void* context) {  
  QueueContext* ctx =
      static_cast<QueueContext*>(pthread_getspecific(GetQueuePtrTls()));
...
void TaskQueue::RunTask(int fd, short flags, void* context) {  
...
void TaskQueue::RunTimer(int fd, short flags, void* context) {  
