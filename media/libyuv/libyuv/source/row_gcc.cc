...
void RGB565ToARGBRow_SSE2(const uint8* src, uint8* dst, int width) {
  asm volatile (
    ...
    "punpcklbw %%xmm0,%%xmm1                   \n"
    "punpckhbw %%xmm0,%%xmm2                   \n"
    MEMOPMEM(movdqu,xmm1,0x00,1,0,2)           
    MEMOPMEM(movdqu,xmm2,0x10,1,0,2)           
    "lea       " MEMLEA(0x10,0) ",%0           \n"
    "sub       $0x8,%2                         \n"
    "jg        1b                              \n"
  : "+r"(src),  // %0
...
void ARGB4444ToARGBRow_SSE2(const uint8* src, uint8* dst, int width) {
  asm volatile (
    ...
    "punpcklbw %%xmm2,%%xmm0                   \n"
    "punpckhbw %%xmm2,%%xmm1                   \n"
    MEMOPMEM(movdqu,xmm0,0x00,1,0,2)           
    MEMOPMEM(movdqu,xmm1,0x10,1,0,2)           
    "lea       " MEMLEA(0x10,0) ",%0           \n"
    "sub       $0x8,%2                         \n"
    "jg        1b                              \n"
  : "+r"(src),  // %0
...
void ARGBToUVRow_AVX2(const uint8* src_argb0,
  ...
  asm volatile (
    ...
    "vmovdqu    " MEMACCESS2(0x40,0) ",%%ymm2  \n"
    "vmovdqu    " MEMACCESS2(0x60,0) ",%%ymm3  \n"
    VMEMOPREG(vpavgb,0x00,0,4,1,ymm0,ymm0)     
    ...
    VEXTOPMEM(vextractf128,1,ymm0,0x0,1,2,1) 
    "lea        " MEMLEA(0x10,1) ",%1          \n"
    "sub        $0x20,%3                       \n"
    "jg         1b                             \n"
    "vzeroupper                                \n"
...
void MirrorRow_SSSE3(const uint8* src, uint8* dst, int width) {
  ...
  asm volatile (
    ...
    LABELALIGN
    "1:                                        \n"
    MEMOPREG(movdqu,-0x10,0,2,1,xmm0)          
    "pshufb    %%xmm5,%%xmm0                   \n"
    "movdqu    %%xmm0," MEMACCESS(1) "         \n"
    "lea       " MEMLEA(0x10,1) ",%1           \n"
    "sub       $0x10,%2                        \n"
...
void MirrorRow_AVX2(const uint8* src, uint8* dst, int width) {
  ...
  asm volatile (
    ...
    LABELALIGN
    "1:                                        \n"
    MEMOPREG(vmovdqu,-0x20,0,2,1,ymm0)         
...
void ARGBMirrorRow_AVX2(const uint8* src, uint8* dst, int width) {
  ...
  asm volatile (
    ...
    LABELALIGN
    "1:                                        \n"
    VMEMOPREG(vpermd,-0x20,0,2,4,ymm5,ymm0) 
    "vmovdqu    %%ymm0," MEMACCESS(1) "        \n"
    "lea        " MEMLEA(0x20,1) ",%1          \n"
    "sub        $0x8,%2                        \n"
    "jg         1b                             \n"
...
void SplitUVRow_AVX2(const uint8* src_uv,
  ...
  asm volatile (
    ...
    "vpermq     $0xd8,%%ymm2,%%ymm2            \n"
    "vmovdqu    %%ymm0," MEMACCESS(1) "        \n"
    MEMOPMEM(vmovdqu,ymm2,0x00,1,2,1)           
    "lea        " MEMLEA(0x20,1) ",%1          \n"
    "sub        $0x20,%3                       \n"
    "jg         1b                             \n"
    "vzeroupper                                \n"
...
void MergeUVRow_AVX2(const uint8* src_u,
  ...
  asm volatile (
    ...
    "1:                                        \n"
    "vmovdqu   " MEMACCESS(0) ",%%ymm0         \n"
    MEMOPREG(vmovdqu,0x00,0,1,1,ymm1)           
    "lea       " MEMLEA(0x20,0) ",%0           \n"
...
void SetRow_X86(uint8* dst, uint8 v8, int width) {
  ...
  const uint32 v32 = v8 * 0x01010101u;  
...
void YUY2ToUVRow_AVX2(const uint8* src_yuy2,
  ...
  asm volatile (
    ...
    VEXTOPMEM(vextractf128,0,ymm0,0x00,1,2,1) 
    "lea      " MEMLEA(0x10,1) ",%1            \n"
    "sub       $0x20,%3                        \n"
    "jg        1b                              \n"
    "vzeroupper                                \n"
...
void ARGBUnattenuateRow_AVX2(const uint8* src_argb,
  ...
  asm volatile (
    ...
    "movzb     " MEMACCESS2(0x03,0) ",%3       \n"
    MEMOPREG(vmovd,0x00,4,3,4,xmm0)             
    "movzb     " MEMACCESS2(0x07,0) ",%3       \n"
    MEMOPREG(vmovd,0x00,4,3,4,xmm1)             
    "movzb     " MEMACCESS2(0x0b,0) ",%3       \n"
    "vpunpckldq %%xmm1,%%xmm0,%%xmm6           \n"
    MEMOPREG(vmovd,0x00,4,3,4,xmm2)             
    "movzb     " MEMACCESS2(0x0f,0) ",%3       \n"
    MEMOPREG(vmovd,0x00,4,3,4,xmm3)             
...
void InterpolateRow_AVX2(uint8* dst_ptr,
  ...
  "50:                                         \n"
    "vmovdqu    " MEMACCESS(1) ",%%ymm0        \n"
    VMEMOPREG(vpavgb,0x00,1,4,1,ymm0,ymm0)     
    MEMOPMEM(vmovdqu,ymm0,0x00,1,0,1)
    "lea       " MEMLEA(0x20,1) ",%1           \n"
    "sub       $0x20,%2                        \n"
    "jg        50b                             \n"
