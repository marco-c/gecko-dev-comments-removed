...
void ScaleRowDown34_NEON(const uint8_t* src_ptr,
  ...
  asm volatile(
      ...
      : [src_ptr] "+r"(src_ptr),      
        [dst_ptr] "+r"(dst_ptr),      
        [width] "+r"(dst_width)       
      : [kShuf34_0] "r"(&kShuf34_0),  
        [kShuf34_1] "r"(&kShuf34_1),  
        [kShuf34_2] "r"(&kShuf34_2)   
...
void ScaleRowDown38_3_Box_NEON(const uint8_t* src_ptr,
  ...
  asm volatile(
      ...
      : [src_ptr] "+r"(src_ptr),                         
        ...
        [src_ptr2] "+r"(src_ptr2),                       
        [width] "+r"(dst_width)                          
      : [div996] "r"(&kMult38_Div996),                   
        [tblArray1] "r"(kScaleRowDown38_3_BoxIndices1),  
        [tblArray2] "r"(kScaleRowDown38_3_BoxIndices2),  
        [tblArray3] "r"(kScaleRowDown38_3_BoxIndices3),  
        [tblArray4] "r"(kScaleRowDown38_NarrowIndices)   
...
void ScaleRowDown38_2_Box_NEON(const uint8_t* src_ptr,
  ...
  asm volatile(
      ...
      : [src_ptr] "+r"(src_ptr),                         
        ...
        [src_ptr1] "+r"(src_ptr1),                       
        [width] "+r"(dst_width)                          
      : [div664] "r"(&kMult38_Div664),                   
        [tblArray1] "r"(kScaleRowDown38_2_BoxIndices1),  
        [tblArray2] "r"(kScaleRowDown38_2_BoxIndices2),  
        [tblArray3] "r"(kScaleRowDown38_NarrowIndices)   
...
void ScaleARGBFilterCols_NEON(uint8_t* dst_argb,
  ...
  asm volatile(
      ...
      : "+r"(dst_argb),                                       // %0
        ...
        "=&r"(tmp),                                           // %5
        "+r"(src_tmp)                                         // %6
      : [kIndices] "r"(&kScaleARGBFilterColsShuffleIndices),  
        [kOffsets] "r"(dx_offset)                             
      : "memory", "cc", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v16",
        "v17", "v18", "v19");
}
