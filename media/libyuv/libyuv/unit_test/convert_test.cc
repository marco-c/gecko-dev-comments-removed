...
TEST_F(LibYUVConvertTest, TestRGB24ToJ420) {
  const int kSize = 256;
  align_buffer_page_end(orig_rgb24, kSize * 3 * 2);  
  ...
  for (int i = 0; i < iterations256; ++i) {
    RGB24ToJ420(orig_rgb24, kSize * 3, dest_j420, kSize,  
                dest_j420 + kSize * 2, kSize / 2,         
                dest_j420 + kSize * 5 / 2, kSize / 2,     
                kSize, 2);
  }
...
TEST_F(LibYUVConvertTest, TestRGB24ToI420) {
  ...
  for (int i = 0; i < iterations256; ++i) {
    RGB24ToI420(orig_rgb24, kSize * 3, dest_i420, kSize,  
                dest_i420 + kSize * 2, kSize / 2,         
                dest_i420 + kSize * 5 / 2, kSize / 2,     
                kSize, 2);
  }
