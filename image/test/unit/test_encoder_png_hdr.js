...
function makeU16TestPixels() {
  ...
  fillU16Row(pixels, 10, COLORS_ROW0, 21845, 65535); 
  fillU16Row(pixels, 15, COLORS_ROW1, 43690, 65535); 
...
function makeU10TestPixels() {
  ...
  fillU16Row(pixels, 10, COLORS_ROW0, 341, 1023); 
  fillU16Row(pixels, 15, COLORS_ROW1, 682, 1023); 
  return new Uint8Array(pixels.buffer);
}
...
function makeU12TestPixels() {
  ...
  fillU16Row(pixels, 10, COLORS_ROW0, 1365, 4095); 
  fillU16Row(pixels, 15, COLORS_ROW1, 2730, 4095); 
  return new Uint8Array(pixels.buffer);
}
...
function makeR10G10B10A2TestPixels() {
  ...
  fillR10G10B10A2Row(pixels, 10, COLORS_ROW0, 1); 
  fillR10G10B10A2Row(pixels, 15, COLORS_ROW1, 2); 
  return new Uint8Array(pixels.buffer);
}
...
function makeF16TestPixels() {
  var pixels = new Uint16Array(WIDTH * HEIGHT * 4);
  fillF16Row(pixels, 0, COLORS_ROW0, 0x3c00); 
  fillF16Row(pixels, 5, COLORS_ROW1, 0x3c00); 
  fillF16Row(pixels, 10, COLORS_ROW0, F16_ALPHA_THIRD); 
  fillF16Row(pixels, 15, COLORS_ROW1, F16_ALPHA_TWOTHIRDS); 
  return new Uint8Array(pixels.buffer);
}
