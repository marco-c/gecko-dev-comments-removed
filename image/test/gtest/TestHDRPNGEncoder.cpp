...
static void FillU16TestPixels(uint16_t* p) {
  ...
  FillU16Row(p + 2 * kWidth * 4, kRow0Colors, 21845, 65535);  
  FillU16Row(p + 3 * kWidth * 4, kRow1Colors, 43690, 65535);  
}
...
static const uint16_t kF16_Third = 0x3555;      
static const uint16_t kF16_TwoThirds = 0x3955;  
