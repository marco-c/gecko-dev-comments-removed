...
#  endif
  ...
  static size_t _S_rounded_up_size_aux(size_t __n, __true_type const& ) {
    
    return (__n + _S_alloc_granularity) & ~(_S_alloc_granularity - 1);
  }

  static size_t _S_rounded_up_size_aux(size_t __n, __false_type const& ) {
...
public:
  ...
  _RopeRep *_M_base;      
  size_t _M_start;
   void operator()(size_t __start_pos, size_t __req_len,
                                _CharT* __buffer) {
