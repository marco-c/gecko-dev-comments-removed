...
MAYBE_STATIC void raw(NonParam x) {} 
MAYBE_STATIC void raw(NonParamUnion x) {} 
MAYBE_STATIC void raw(NonParamClass x) {} 
MAYBE_STATIC void raw(NonParamEnum x) {} 
MAYBE_STATIC void raw(NonParamEnumClass x) {} 
MAYBE_STATIC void raw(HasNonParamStruct x) {} 
MAYBE_STATIC void raw(HasNonParamUnion x) {} 
MAYBE_STATIC void raw(HasNonParamStructUnion x) {} 

MAYBE_STATIC void const_(const NonParam x) {} 
MAYBE_STATIC void const_(const NonParamUnion x) {} 
MAYBE_STATIC void const_(const NonParamClass x) {} 
MAYBE_STATIC void const_(const NonParamEnum x) {} 
MAYBE_STATIC void const_(const NonParamEnumClass x) {} 
MAYBE_STATIC void const_(const HasNonParamStruct x) {} 
MAYBE_STATIC void const_(const HasNonParamUnion x) {} 
MAYBE_STATIC void const_(const HasNonParamStructUnion x) {} 
...
MAYBE_STATIC inline void inlineRaw(NonParam x) {} 
MAYBE_STATIC inline void inlineRaw(NonParamUnion x) {} 
MAYBE_STATIC inline void inlineRaw(NonParamClass x) {} 
MAYBE_STATIC inline void inlineRaw(NonParamEnum x) {} 
MAYBE_STATIC inline void inlineRaw(NonParamEnumClass x) {} 
