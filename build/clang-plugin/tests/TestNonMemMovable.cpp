...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate1 {T m;}; 

void bad1() {
  NeedyTemplate1<NonMovable> a1; 
  NeedyTemplate1<S_NonMovable> a2; 
  NeedyTemplate1<W_NonMovable> a3; 
  NeedyTemplate1<WS_NonMovable> a4; 
  NeedyTemplate1<SW_NonMovable> a5; 
  NeedyTemplate1<SWS_NonMovable> a6; 

  NeedyTemplate1<Template_Inline<NonMovable> > b1; 
  NeedyTemplate1<Template_Inline<S_NonMovable> > b2; 
  NeedyTemplate1<Template_Inline<W_NonMovable> > b3; 
  NeedyTemplate1<Template_Inline<WS_NonMovable> > b4; 
  NeedyTemplate1<Template_Inline<SW_NonMovable> > b5; 
  NeedyTemplate1<Template_Inline<SWS_NonMovable> > b6; 

  NeedyTemplate1<Template_NonMovable<NonMovable> > c1; 
  NeedyTemplate1<Template_NonMovable<S_NonMovable> > c2; 
  NeedyTemplate1<Template_NonMovable<W_NonMovable> > c3; 
  NeedyTemplate1<Template_NonMovable<WS_NonMovable> > c4; 
  NeedyTemplate1<Template_NonMovable<SW_NonMovable> > c5; 
  NeedyTemplate1<Template_NonMovable<SWS_NonMovable> > c6; 
  NeedyTemplate1<Template_NonMovable<Movable> > c7; 
  NeedyTemplate1<Template_NonMovable<S_Movable> > c8; 
  NeedyTemplate1<Template_NonMovable<W_Movable> > c9; 
  NeedyTemplate1<Template_NonMovable<WS_Movable> > c10; 
  NeedyTemplate1<Template_NonMovable<SW_Movable> > c11; 
  NeedyTemplate1<Template_NonMovable<SWS_Movable> > c12; 
}
...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate2 {T m;}; 
template <class T>
struct S_NeedyTemplate2 : NeedyTemplate2<T> {}; 
...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate3 {T m;}; 
template <class T>
...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate4 {T m;}; 
template <class T>
struct S_NeedyTemplate4 : NeedyTemplate4<T> {}; 
template <class T>
...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate5 {T m;}; 
template <class T>
...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate6 {T m;}; 
template <class T>
...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate7 {T m;}; 
template <class T, class Q = NeedyTemplate7<T> >
struct Defaulted_Templated_NeedyTemplate7 {Q m;}; 
void bad7() {
...
template <class T>
struct MOZ_NEEDS_MEMMOVABLE_TYPE NeedyTemplate8 {T m;}; 
template <class T, class Q = NeedyTemplate8<T> >
struct Defaulted_Templated_NeedyTemplate8 {Q m;}; 
template <class T>
...
void specialization() {
  ...
  NeedyTemplate1<Template_Inline<SpecializedNonMovable> > b1;  
  ...
  NeedyTemplate1<S_SpecializedNonMovable> c1; 
