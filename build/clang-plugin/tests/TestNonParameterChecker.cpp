...
class class_
{
    ...
    explicit class_(NonParam x) {} 
    explicit class_(HasNonParamStruct x) {} 
    explicit class_(HasNonParamUnion x) {} 
    explicit class_(HasNonParamStructUnion x) {} 
...
void testTemplateClass()
{
    ...
    tmplClassForNonParam<NonParam> nonParamClass; 
    NonParam nonParam;
    ...
    tmplClassForHasNonParamStruct<HasNonParamStruct> hasNonParamStructClass;
...
void testNestedTemplateClass()
{
    ...
    NonParam nonParam;
    outer.constRef(nonParam); 
}

template <typename T>
void tmplFuncForParam(T x) {}
template <typename T>
void tmplFuncForNonParam(T x) {} 
template <typename T>
void tmplFuncForNonParamImplicit(T x) {} 
template <typename T>
void tmplFuncForHasNonParamStruct(T x) {} 
template <typename T>
void tmplFuncForHasNonParamStructImplicit(T x) {} 
...
void testTemplateFunc()
{
    ...
    NonParam nonParam;
    tmplFuncForNonParam<NonParam>(nonParam); 
    tmplFuncForNonParamImplicit(nonParam); 

    HasNonParamStruct hasNonParamStruct;
    tmplFuncForHasNonParamStruct<HasNonParamStruct>(hasNonParamStruct); 
    tmplFuncForHasNonParamStructImplicit(hasNonParamStruct); 
}

void testLambda()
{
    auto paramLambda = [](Param x) -> void {};
    auto nonParamLambda = [](NonParam x) -> void {}; 
    auto nonParamStructLambda = [](HasNonParamStruct x) -> void {}; 
    auto nonParamUnionLambda = [](HasNonParamUnion x) -> void {}; 
    auto nonParamStructUnionLambda = [](HasNonParamStructUnion x) -> void {}; 

    (void)[](Param x) -> void {};
    (void)[](NonParam x) -> void {}; 
    (void)[](HasNonParamStruct x) -> void {}; 
    (void)[](HasNonParamUnion x) -> void {}; 
