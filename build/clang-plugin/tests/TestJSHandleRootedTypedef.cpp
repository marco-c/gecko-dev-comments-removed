...
class Foo {
  void HandleFunction(JS::HandleFunction){}; 
  void HandleId(JS::HandleId){}; 
  void HandleObject(JS::HandleObject){}; 
  void HandleScript(JS::HandleScript){}; 
  void HandleString(JS::HandleString){}; 
  void HandleSymbol(JS::HandleSymbol){}; 
  void HandleBigInt(JS::HandleBigInt){}; 
  void HandleValue(JS::HandleValue){}; 
  void HandleValueVector(JS::HandleValueVector){}; 
  void HandleObjectVector(JS::HandleObjectVector){}; 
  void HandleIdVector(JS::HandleIdVector){}; 

  void MutableHandleFunction(JS::MutableHandleFunction){}; 
  void MutableHandleId(JS::MutableHandleId){}; 
  void MutableHandleObject(JS::MutableHandleObject){}; 
  void MutableHandleScript(JS::MutableHandleScript){}; 
  void MutableHandleString(JS::MutableHandleString){}; 
  void MutableHandleSymbol(JS::MutableHandleSymbol){}; 
  void MutableHandleBigInt(JS::MutableHandleBigInt){}; 
  void MutableHandleValue(JS::MutableHandleValue){}; 
  void MutableHandleValueVector(JS::MutableHandleValueVector){}; 
  void MutableHandleObjectVector(JS::MutableHandleObjectVector){}; 
  void MutableHandleIdVector(JS::MutableHandleIdVector){}; 
...
static void Bar(JSContext *aCx) {
  JS::RootedObject RootedObject(aCx); 
  JS::RootedFunction RootedFunction(aCx); 
  JS::RootedScript RootedScript(aCx); 
  JS::RootedString RootedString(aCx); 
  JS::RootedSymbol RootedSymbol(aCx); 
  JS::RootedBigInt RootedBigInt(aCx); 
  JS::RootedId RootedId(aCx); 
  JS::RootedValue RootedValue(aCx); 

  JS::RootedValueVector RootedValueVector(aCx); 
  JS::RootedObjectVector RootedObjectVector(aCx); 
  JS::RootedIdVector RootedIdVector(aCx); 

  JS::PersistentRootedFunction PersistentRootedFunction(aCx); 
  JS::PersistentRootedId PersistentRootedId(aCx); 
  JS::PersistentRootedObject PersistentRootedObject(aCx); 
  JS::PersistentRootedScript PersistentRootedScript(aCx); 
  JS::PersistentRootedString PersistentRootedString(aCx); 
  JS::PersistentRootedSymbol PersistentRootedSymbol(aCx); 
  JS::PersistentRootedBigInt PersistentRootedBigInt(aCx); 
  JS::PersistentRootedValue PersistentRootedValue(aCx); 

  JS::PersistentRootedIdVector PersistentRootedIdVector(aCx); 
  JS::PersistentRootedObjectVector PersistentRootedObjectVector(aCx); 

  JS::HandleFunction HandleFunction(RootedFunction); 
  JS::HandleId HandleId(RootedId); 
  JS::HandleObject HandleObject(RootedObject); 
  JS::HandleScript HandleScript(RootedScript); 
  JS::HandleString HandleString(RootedString); 
  JS::HandleSymbol HandleSymbol(RootedSymbol); 
  JS::HandleBigInt HandleBigInt(RootedBigInt); 
  JS::HandleValue HandleValue(RootedValue); 
  JS::HandleValueVector HandleValueVector(RootedValueVector); 
  JS::HandleObjectVector HandleObjectVector(RootedObjectVector); 
  JS::HandleIdVector HandleIdVector(RootedIdVector); 

  JS::MutableHandleFunction MutableHandleFunction(&RootedFunction); 
  JS::MutableHandleId MutableHandleId(&RootedId); 
  JS::MutableHandleObject MutableHandleObject(&RootedObject); 
  JS::MutableHandleScript MutableHandleScript(&RootedScript); 
  JS::MutableHandleString MutableHandleString(&RootedString); 
  JS::MutableHandleSymbol MutableHandleSymbol(&RootedSymbol); 
  JS::MutableHandleBigInt MutableHandleBigInt(&RootedBigInt); 
  JS::MutableHandleValue MutableHandleValue(&RootedValue); 
  JS::MutableHandleValueVector MutableHandleValueVector(&RootedValueVector); 
  JS::MutableHandleObjectVector MutableHandleObjectVector(&RootedObjectVector); 
  JS::MutableHandleIdVector MutableHandleIdVector(&RootedIdVector); 
