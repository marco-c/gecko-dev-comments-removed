    ...
    switch (state) {
      ...
      case PREF_PARSE_UNTIL_NAME:
        if (c == '\"' || c == '\'') {
          ...
          mQuoteChar = c;
          mNextState = PREF_PARSE_UNTIL_COMMA; 
                         ...
                         void* aClosure)
{
  ...
  PREF_RegisterCallback(
    aPref, aCallback, aClosure, Preferences::ExactMatch,  true);
}
                              ...
                              MatchKind aMatchKind)
{
  ...
  PREF_RegisterCallback(
    aPref, aCallback, aClosure, aMatchKind,  false);
