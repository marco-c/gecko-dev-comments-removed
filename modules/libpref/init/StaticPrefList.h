...
VARCACHE_PREF("apz.axis_lock.breakout_angle",          APZAxisBreakoutAngle, AtomicFloat, float(M_PI / 8.0) );
VARCACHE_PREF("apz.axis_lock.breakout_threshold",      APZAxisBreakoutThreshold, AtomicFloat, 1.0f / 32.0f);
VARCACHE_PREF("apz.axis_lock.direct_pan_angle",        APZAllowedDirectPanAngle, AtomicFloat, float(M_PI / 3.0) );
VARCACHE_PREF("apz.axis_lock.lock_angle",              APZAxisLockAngle, AtomicFloat, float(M_PI / 6.0) );
...
#if defined(XP_MACOSX)
VARCACHE_PREF("gfx.font_rendering.coretext.enabled",   CoreTextEnabled, RelaxedAtomicBool, false);
#endif
