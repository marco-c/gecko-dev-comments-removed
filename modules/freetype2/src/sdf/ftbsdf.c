...
#undef CHECK_NEIGHBOR
  ...
  FT_DEFINE_RASTER_FUNCS(
    ...
    (FT_Raster_New_Func)     bsdf_raster_new,       
    (FT_Raster_Reset_Func)   bsdf_raster_reset,     
    (FT_Raster_Set_Mode_Func)bsdf_raster_set_mode,  
    (FT_Raster_Render_Func)  bsdf_raster_render,    
    (FT_Raster_Done_Func)    bsdf_raster_done       
  )
