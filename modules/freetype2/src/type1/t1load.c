...
#define ALIGN_SIZE( n ) \
  ...
  static void
  parse_blend_axis_types( FT_Face  face,     
                          void*    loader_ )
  {
    T1_Face      t1face = (T1_Face)face;
  ...
  static void
  parse_blend_design_positions( FT_Face  face,     
                                void*    loader_ )
  {
    T1_Face      t1face   = (T1_Face)face;
    T1_Loader    loader   = (T1_Loader)loader_;
  ...
  static void
  parse_blend_design_map( FT_Face  face,     
                          void*    loader_ )
  {
    T1_Face      t1face = (T1_Face)face;
    T1_Loader    loader = (T1_Loader)loader_;
  ...
  static void
  parse_weight_vector( FT_Face  face,     
                       void*    loader_ )
  {
    T1_Face      t1face = (T1_Face)face;
    T1_Loader    loader = (T1_Loader)loader_;
  ...
  static void
  t1_parse_font_matrix( FT_Face  face,     
                        void*    loader_ )
  {
    T1_Face     t1face = (T1_Face)face;
    T1_Loader   loader = (T1_Loader)loader_;
...
#define TABLE_EXTEND  5
  ...
  static void
  parse_charstrings( FT_Face  face,     
                     void*    loader_ )
  {
    T1_Face        t1face       = (T1_Face)face;
    T1_Loader      loader       = (T1_Loader)loader_;
