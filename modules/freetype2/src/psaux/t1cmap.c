...
#include "psauxerr.h"
  ...
  t1_cmap_std_done( FT_CMap  cmap_ )   
  {
  ...
  t1_cmap_std_char_index( FT_CMap    cmap,       
                          FT_UInt32  char_code )
  {
  ...
  t1_cmap_standard_init( FT_CMap     cmap,     
                         FT_Pointer  pointer )
  {
    T1_CMapStd  t1cmap = (T1_CMapStd)cmap;
    FT_UNUSED( pointer );
  ...
  FT_CALLBACK_DEF( FT_Error )
  t1_cmap_expert_init( FT_CMap     cmap,     
                       FT_Pointer  pointer )
  {
    T1_CMapStd  t1cmap = (T1_CMapStd)cmap;
    FT_UNUSED( pointer );
  ...
  FT_CALLBACK_DEF( FT_Error )
  t1_cmap_custom_init( FT_CMap     cmap,     
                       FT_Pointer  pointer )
  {
  ...
  FT_CALLBACK_DEF( void )
  t1_cmap_custom_done( FT_CMap  cmap )   
  {
    T1_CMapCustom  t1cmap = (T1_CMapCustom)cmap;
  ...
  FT_CALLBACK_DEF( FT_UInt )
  t1_cmap_custom_char_index( FT_CMap    cmap,       
                             FT_UInt32  char_code )
  {
    T1_CMapCustom  t1cmap = (T1_CMapCustom)cmap;
    FT_UInt        result = 0;
  ...
  FT_CALLBACK_DEF( FT_UInt )
  t1_cmap_custom_char_next( FT_CMap     cmap,        
                            FT_UInt32  *pchar_code )
  {
    T1_CMapCustom  t1cmap    = (T1_CMapCustom)cmap;
    FT_UInt        result    = 0;
  ...
  FT_CALLBACK_DEF( FT_Error )
  t1_cmap_unicode_init( FT_CMap     cmap,     
                        FT_Pointer  pointer )
  {
  ...
  FT_CALLBACK_DEF( void )
  t1_cmap_unicode_done( FT_CMap  cmap )   
  {
    PS_Unicodes  unicodes = (PS_Unicodes)cmap;
  ...
  FT_CALLBACK_DEF( FT_UInt )
  t1_cmap_unicode_char_index( FT_CMap    cmap,       
                              FT_UInt32  char_code )
  {
    PS_Unicodes         unicodes = (PS_Unicodes)cmap;
    T1_Face             face     = (T1_Face)FT_CMAP_FACE( cmap );
  ...
  FT_CALLBACK_DEF( FT_UInt )
  t1_cmap_unicode_char_next( FT_CMap     cmap,        
                             FT_UInt32  *pchar_code )
  {
    PS_Unicodes         unicodes = (PS_Unicodes)cmap;
    T1_Face             face     = (T1_Face)FT_CMAP_FACE( cmap );
