...
TEST(fpdf_text_int, CheckMailLink) {
  ...
  const wchar_t* valid_strs[][2] = {
      ...
      {L"abc_@gmail.com", L"abc_@gmail.com"},  
      {L"dummy-hi@gmail.com",
       L"dummy-hi@gmail.com"},                  
      {L"a..df@gmail.com", L"df@gmail.com"},    
      {L".john@yahoo.com", L"john@yahoo.com"},  
      {L"abc@xyz.org?/", L"abc@xyz.org"},       
      {L"fan{abc@xyz.org", L"abc@xyz.org"},     
      {L"fan@g.com..", L"fan@g.com"},           
      {L"CAP.cap@Gmail.Com", L"CAP.cap@Gmail.Com"},  
  };
