...
void ClipAngledGradient(const SkPoint pts[2],
  ...
  if (minPerpPtIndex < 0 && maxPerpPtIndex < 0)  
    return;
...
class SkiaState {
 ...
 private:
  SkTArray<SkPath> m_clips;        
  SkTDArray<Clip> m_commands;      
  SkTDArray<SkPoint> m_positions;  
  SkTDArray<uint16_t> m_glyphs;    
  SkPath m_skPath;                 
