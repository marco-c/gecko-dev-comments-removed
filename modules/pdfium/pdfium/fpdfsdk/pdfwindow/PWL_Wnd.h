...
struct PWL_CREATEPARAM {
 public:
  ...
  IPWL_Provider::ObservedPtr pProvider;  
  IPWL_FocusHandler* pFocusHandler;   
  uint32_t dwFlags;                   
  CPWL_Color sBackgroundColor;        
  CPDFSDK_Widget::ObservedPtr pAttachedWidget;  
  BorderStyle nBorderStyle;           
  int32_t dwBorderWidth;              
  CPWL_Color sBorderColor;            
