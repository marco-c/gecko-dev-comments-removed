...
nsresult TLSFilterTransaction::SetProxiedTransaction(
    nsAHttpTransaction* aTrans, nsAHttpTransaction* aHttp2ConnectTransaction) {
  LOG(
      ("TLSFilterTransaction::SetProxiedTransaction [this=%p] aTrans=%p, "
       "aHttp2ConnectTransaction=%p\n",
       this, aTrans, aHttp2ConnectTransaction));
...
Http2ConnectTransaction* TLSFilterTransaction::QueryHttp2ConnectTransaction() {
  if (!mTransaction) {
    return nullptr;
  }
  return mTransaction->QueryHttp2ConnectTransaction();
}
