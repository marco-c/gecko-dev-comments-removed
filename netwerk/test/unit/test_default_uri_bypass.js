...
function run_test() {
  ...
  Assert.equal(uri.spec, "https://example.com/"); 
  ...
  if (!inChildProcess()) {
    ...
    Assert.equal(uri4.spec, "simpleprotocol://https//example.com"); 
    ...
    Assert.equal(uri5.spec, "simpleprotocol://https://example.com"); 
    let uri6 = NetUtil.newURI("otherproto://https://example.com");
    Assert.equal(uri6.spec, "otherproto://https://example.com"); 
  }
}
