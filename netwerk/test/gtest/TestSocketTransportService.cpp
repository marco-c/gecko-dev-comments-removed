  ...
  sts->Dispatch(
      NS_NewRunnableFunction(
          ...
          [&]() {
            ...
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING(";")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING(" ;")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("; ")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("foo")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING(" foo")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING(" foo ")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("10=20;")));

            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1=")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1,=")));
            ...
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1=2,")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1=2-3")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1-2,=3")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1-2,3")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1-2,3-4")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1-2,3-4,")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1-2,3-4=")));
            ASSERT_FALSE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("10000000=10")));

            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1=2;3")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1-4=2;3")));
            ASSERT_FALSE(
                sts->UpdatePortRemapPreference(NS_LITERAL_CSTRING("1-4=2;3=")));
            ASSERT_FALSE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("1-foo=2;3=15")));
            ASSERT_FALSE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("1-4=foo;3=15")));
            ASSERT_FALSE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("1-4=2;foo=15")));
            ASSERT_FALSE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("1-4=2;3=foo")));
            ASSERT_FALSE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("1-4=2x3=15")));
            ASSERT_FALSE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("1+4=2;3=15")));
            ...
            ASSERT_TRUE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("100-200=1000")));
            ...
            ASSERT_TRUE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("100-200,500=1000")));
            ASSERT_TRUE(CheckPortRemap(10, 10));
            ASSERT_TRUE(CheckPortRemap(99, 99));
            ASSERT_TRUE(CheckPortRemap(100, 1000));
            ASSERT_TRUE(CheckPortRemap(101, 1000));
            ...
            ASSERT_TRUE(sts->UpdatePortRemapPreference(
                NS_LITERAL_CSTRING("1-3=10;5-8,12=20")));
