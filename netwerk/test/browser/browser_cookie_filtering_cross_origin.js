...
async function test_cross_origin_resource_com() {
  let comExpected = [];
  comExpected.push("test-cookie=comhtml"); 
  comExpected.push("test-cookie=png"); 
  comExpected.push("test-cookie=orghtml"); 
...
async function test_cross_origin_resource_org() {
  ...
  orgExpected.push("test-cookie=png"); 
  orgExpected.push("test-cookie=orghtml"); 
  orgExpected.push("test-cookie=png"); 
  orgExpected.push("test-cookie=comhtml"); 
...
add_task(test_cross_origin_resource_com); 
add_task(test_cross_origin_resource_org); 
