...
function oaSuite() {
  var suite = [];
  suite.push("test-cookie=orgwontsee"); 
  suite.push("test-cookie=firstparty"); 
  suite.push("test-cookie=usercontext"); 
  suite.push("test-cookie=privateonly"); 
  suite.push("test-cookie=sentinelcom"); 
  suite.push("test-cookie=sentineloa"); 
  suite.push("test-cookie=sentinelprivate"); 
  return suite;
}
...
add_task(test_origin_attributes); 
add_task(test_private); 
