...
UrlClassifierFeatureNoChannel::UrlClassifierFeatureNoChannel(
 ...
 void UrlClassifierFeatureNoChannel::GetFeatureNames(
 ...
 void UrlClassifierFeatureNoChannel::MaybeInitialize() {
 ...
 void UrlClassifierFeatureNoChannel::MaybeShutdown() {
  for (NoChannelFeature& feature : sNoChannelFeaturesMap) {
    if (feature.mFeature) {
 ...
 void UrlClassifierFeatureNoChannel::MaybeCreate(
