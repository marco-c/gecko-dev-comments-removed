...
static void RecordStackFrame(uint32_t , void* aPC,
                             void* , void* aClosure) {
...
static void WalkTheStackCached(FILE* aStream, const void* aFirstFramePC) {
  ...
  MozStackWalk(PrintStackFrameCached, aFirstFramePC,  0,
               aStream);
}
...
static void WalkTheStackSavingLocations(std::vector<void*>& aLocations,
  ...
  MozStackWalk(RecordStackFrame, aFirstFramePC,  0, &aLocations);
}
