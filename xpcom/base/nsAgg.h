  ...
  class NS_CYCLE_COLLECTION_INNERCLASS                                    \
   ...
   public:                                                                \
    ...
    NS_IMETHOD_(void) DeleteCycleCollectable(void* p) override {          \
      NS_CYCLE_COLLECTION_CLASSNAME(_class)::Downcast(                    \
          static_cast<nsISupports*>(p))                                   \
          ->DeleteCycleCollectable();                                     \
    }                                                                     \
    static _class* Downcast(nsISupports* s) {                             \
      return (_class*)((char*)(s)-offsetof(_class, fAggregated));         \
    }                                                                     \
    static nsISupports* Upcast(_class* p) { return p->InnerObject(); }    \
...
#define NS_IMPL_CYCLE_COLLECTING_AGGREGATED(_class)                      \
  ...
  NS_IMETHODIMP_(void)                                                   \
  _class::DeleteCycleCollectable(void) { delete this; }
...
#define NS_IMPL_AGGREGATED_HELPER(_class)                                    \
  ...
  _class::QueryInterface(const nsIID& aIID, void** aInstancePtr) {           \
    return fOuter->QueryInterface(aIID, aInstancePtr);                       \
                                                                             ...
                                                                             \
  NS_IMETHODIMP_(MozExternalRefCountType)                                    \
  _class::AddRef(void) { return fOuter->AddRef(); }                          \
                                                                             \
  NS_IMETHODIMP_(MozExternalRefCountType)                                    \
  _class::Release(void) { return fOuter->Release(); }                        \
                                                                             \
  NS_IMETHODIMP                                                              \
...
#define NS_IMPL_AGGREGATED_QUERY_HEAD(_class)                                 \
  nsresult _class::AggregatedQueryInterface(REFNSIID aIID,                    \
                                            void** aInstancePtr) {            \
