...
nsLocalFile::GetLastModifiedTime(PRTime* aLastModTime) {
  return GetLastModifiedTimeImpl(aLastModTime,  true);
}

NS_IMETHODIMP
nsLocalFile::SetLastModifiedTime(PRTime aLastModTime) {
  return SetLastModifiedTimeImpl(aLastModTime,  true);
}

NS_IMETHODIMP
nsLocalFile::GetLastModifiedTimeOfLink(PRTime* aLastModTimeOfLink) {
  return GetLastModifiedTimeImpl(aLastModTimeOfLink,  false);
}
