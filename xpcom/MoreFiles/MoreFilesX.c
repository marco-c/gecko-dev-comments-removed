	...
	Str31 hfsName)
{
	...
	else
	{
		...
		hfsName[0] = (unsigned char)actualPascalBytes;	
	...
	FSRef *newDestRef)
{
	...
	FSCatalogInfo			destCatalogInfo;	
	HFSUniStr255			sourceName;			
	HFSUniStr255			destName;			
	FSRef					sourceCurrentRef;	
	FSRef					destCurrentRef;		
	FSRef					sourceParentRef;	
	FSRef					destParentRef;		
	HFSUniStr255			sourceUniqueName;	
	HFSUniStr255			destUniqueName;		
	long					theSeed;			
	Boolean					sameParentDirs;		
