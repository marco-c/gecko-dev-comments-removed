...
public:
                            ...
                            DispatchReason aReason = NormalDispatch) override
  {
    ...
    RefPtr<nsIRunnable> runner(new Runner(this, std::move(aRunnable), false ));
...
private:
  ...
  CreateDirectTaskDrainer(already_AddRefed<nsIRunnable> aRunnable) override
  {
    RefPtr<Runner> runner =
      new Runner(this, std::move(aRunnable),  true);
...
AbstractThread::InitMainThread()
{
  ...
  sMainThread = new EventTargetWrapper(mainThread.get(),  true);
