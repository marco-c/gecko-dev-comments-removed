...
double nsTStringRepr<T>::ToDouble(nsresult* aErrorCode) const {
  return ParseFloatingPoint<double, T>(*this,  false,
                                       aErrorCode);
}
...
double nsTStringRepr<T>::ToDoubleAllowTrailingChars(
  ...
  return ParseFloatingPoint<double, T>(*this,  true,
                                       aErrorCode);
}

template <typename T>
float nsTStringRepr<T>::ToFloat(nsresult* aErrorCode) const {
  return ParseFloatingPoint<float, T>(*this,  false,
                                      aErrorCode);
}

template <typename T>
float nsTStringRepr<T>::ToFloatAllowTrailingChars(nsresult* aErrorCode) const {
  return ParseFloatingPoint<float, T>(*this,  true,
                                      aErrorCode);
}
