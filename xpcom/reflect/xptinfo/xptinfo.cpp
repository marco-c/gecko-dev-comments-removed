...
nsresult
nsXPTInterfaceInfo::GetTypeForParam(uint16_t ,
...
nsresult
nsXPTInterfaceInfo::GetSizeIsArgNumberForParam(uint16_t ,
                                               const nsXPTParamInfo* aParam,
                                               uint16_t aDimension,
...
nsresult
nsXPTInterfaceInfo::GetInterfaceIsArgNumberForParam(uint16_t ,
                                                    const nsXPTParamInfo* aParam,
                                                    uint8_t* aRetval) const
{
  const nsXPTType* type = &aParam->Type();
