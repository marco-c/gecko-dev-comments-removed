...
class nsWindow final : public nsWindowBase {
 ...
 private:
  ...
  nsIntPoint mLastPoint = nsIntPoint(0, 0);
  HWND mWnd = nullptr;
  ...
  HKL mLastKeyboardLayout = nullptr;
  ...
  nsCOMPtr<nsIUserIdleServiceInternal> mIdleService = nullptr;
  ...
  POINT mCachedHitTestPoint = POINT{0, 0};
