...
RENDER_AGAIN:
  ...
  if (aAppearance == StyleAppearance::Range ||
    ...
    theme->DrawThemeBackground(hdc, MENU_POPUPBORDERS,  0,
                               &widgetRect, &clipRect);
    SIZE borderSize;
    ...
    theme->DrawThemeBackground(hdc, MENU_POPUPBACKGROUND,  0,
                               &bgRect, &clipRect);
    ...
    theme->DrawThemeBackground(hdc, MENU_POPUPSEPARATOR,  0,
                               &sepRect, &clipRect);
...
bool nsNativeThemeWin::GetWidgetPadding(nsDeviceContext* aContext,
  ...
  if (aAppearance == StyleAppearance::Menupopup) {
    SIZE popupSize;
    theme->GetThemePartSize(nullptr, MENU_POPUPBORDERS,  0, nullptr,
                            TS_TRUE, &popupSize);
