...
WL_PRIVATE const struct wl_interface wp_color_manager_v1_interface = {
    "wp_color_manager_v1",        1, 7,
    wp_color_manager_v1_requests, 5, wp_color_manager_v1_events,
};
...
WL_PRIVATE const struct wl_interface wp_color_management_surface_v1_interface =
    {
        "wp_color_management_surface_v1",        1, 3,
        wp_color_management_surface_v1_requests, 0, NULL,
};
...
WL_PRIVATE const struct wl_interface
    wp_image_description_creator_icc_v1_interface = {
        "wp_image_description_creator_icc_v1",        1, 2,
        wp_image_description_creator_icc_v1_requests, 0, NULL,
};
...
WL_PRIVATE const struct wl_interface
    wp_image_description_creator_params_v1_interface = {
        "wp_image_description_creator_params_v1",        1, 10,
        wp_image_description_creator_params_v1_requests, 0, NULL,
};
...
WL_PRIVATE const struct wl_interface wp_image_description_v1_interface = {
    "wp_image_description_v1",        1, 2,
    wp_image_description_v1_requests, 2, wp_image_description_v1_events,
};
...
WL_PRIVATE const struct wl_interface wp_image_description_info_v1_interface = {
    "wp_image_description_info_v1",      1, 0, NULL, 11,
