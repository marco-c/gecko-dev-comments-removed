...
const GfxDeviceFamily* GfxDriverInfo::GetDeviceFamily(DeviceFamily id) {
  ...
  switch (id) {
    ...
    case DeviceFamily::IntelGen12:
      ...
      APPEND_DEVICE(0x4C8C);  
      APPEND_DEVICE(0x4C8A);  
      APPEND_DEVICE(0x4C8B);  
      APPEND_DEVICE(0x4C90);  
      APPEND_DEVICE(0x4C9A);  
      
      APPEND_DEVICE(0x4683);  
      APPEND_DEVICE(0x4693);  
      APPEND_DEVICE(0x4680);  
      APPEND_DEVICE(0x4681);  
      APPEND_DEVICE(0x4682);  
      APPEND_DEVICE(0x4688);  
      APPEND_DEVICE(0x4689);  
      APPEND_DEVICE(0x4690);  
      APPEND_DEVICE(0x4691);  
      APPEND_DEVICE(0x4692);  
      APPEND_DEVICE(0x4626);  
      APPEND_DEVICE(0x4628);  
      APPEND_DEVICE(0x462A);  
      APPEND_DEVICE(0x46A0);  
      APPEND_DEVICE(0x46A1);  
      APPEND_DEVICE(0x46A2);  
      APPEND_DEVICE(0x46A3);  
      APPEND_DEVICE(0x46A6);  
      APPEND_DEVICE(0x46A8);  
      APPEND_DEVICE(0x46AA);  
      APPEND_DEVICE(0x46B0);  
      APPEND_DEVICE(0x46B1);  
      APPEND_DEVICE(0x46B2);  
      APPEND_DEVICE(0x46B3);  
      APPEND_DEVICE(0x46C0);  
      APPEND_DEVICE(0x46C1);  
      APPEND_DEVICE(0x46C2);  
      APPEND_DEVICE(0x46C3);  
      APPEND_DEVICE(0x46D0);  
      APPEND_DEVICE(0x46D1);  
      APPEND_DEVICE(0x46D2);  
      ...
      APPEND_DEVICE(0xA780);  
      APPEND_DEVICE(0xA781);  
      APPEND_DEVICE(0xA782);  
      APPEND_DEVICE(0xA783);  
      APPEND_DEVICE(0xA788);  
      APPEND_DEVICE(0xA789);  
      APPEND_DEVICE(0xA720);  
      APPEND_DEVICE(0xA721);  
      APPEND_DEVICE(0xA7A0);  
      APPEND_DEVICE(0xA7A1);  
      APPEND_DEVICE(0xA7A8);  
      APPEND_DEVICE(0xA7A9);  
