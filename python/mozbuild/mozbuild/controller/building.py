...
class BuildDriver(MozbuildObject):
    ...
    def build(self, metrics, what=None, jobs=0, directory=None, verbose=False,
        ...
        if long_build:
            ...
            output.on_line('If you are building Firefox often, SCCache can save you a lot of time. You can learn more here: https://firefox-source-docs.mozilla.org/build/buildsystem/sccache-dist.html')  
        else:
