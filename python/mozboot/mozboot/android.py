...
NDK_VERSION = "r27c"
CMDLINE_TOOLS_VERSION_STRING = "16.0"
...
def ensure_android(
    ...
    sdk_url = "https://dl.google.com/android/repository/commandlinetools-{0}-{1}_latest.zip".format(  
        os_tag, CMDLINE_TOOLS_VERSION
    )
    ndk_url = android_ndk_url(os_name)
    bundletool_url = "https://github.com/google/bundletool/releases/download/{v}/bundletool-all-{v}.jar".format(  
