...
NS_IMPL_EDITTRANSACTIONBASE_GETASMETHODS(CompositionInTextNodeTransaction)
NS_IMPL_EDITTRANSACTIONBASE_GETASMETHODS(DeleteTextFromTextNodeTransaction)
NS_IMPL_EDITTRANSACTIONBASE_GETASMETHODS(InsertTextIntoTextNodeTransaction)
NS_IMPL_EDITTRANSACTIONBASE_GETASMETHODS(ReplaceTextInTextNodeTransaction)
