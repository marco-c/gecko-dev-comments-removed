...
add_task(function* init() {
  ...
  let [, , , s4, s5, ] = yield promiseAddonsByIDs(ADDON_IDS);
...
add_task(function* run_addon_change_2_test() {
  ...
  let [s1, s2, s3, , , h, r] = yield promiseAddonsByIDs(ADDON_IDS);
...
add_task(function* run_manual_update_2_test() {
  ...
  let [s1, s2, s3, s4, , h, r] = yield promiseAddonsByIDs(ADDON_IDS);
  ...
  [s1, s2, s3, s4, , h, r] = yield promiseAddonsByIDs(ADDON_IDS);
