...
`BackgroundTasksUtils.sys.mjs <https://searchfox.org/firefox-main/source/toolkit/components/backgroundtasks/BackgroundTasksUtils.sys.mjs>`__).
...
service <https://searchfox.org/firefox-main/source/toolkit/profile/nsIToolkitProfileService.idl>`__
...
`TaskScheduler.sys.mjs <https://searchfox.org/firefox-main/source/toolkit/components/taskscheduler/TaskScheduler.sys.mjs>`__
module.
...
into it, the regular
`UpdateService.sys.mjs <https://searchfox.org/firefox-main/source/toolkit/mozapps/update/UpdateService.sys.mjs>`__
