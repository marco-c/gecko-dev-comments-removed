...
const ExtFind = {
  ...
  get finder() {
    if (!this._finder) {
      ...
      this._finder = new Finder(this._docShell);
    }
    return this._finder;
  },
  ...
  findRanges(params) {
    ...
    iteratorPromise.then(() => {
      ...
      sendAsyncMessage("ext-Finder:CollectResultsFinished",
                       { count: this.iterator._previousRanges.length, rangeData, rectData });
    });
  },
