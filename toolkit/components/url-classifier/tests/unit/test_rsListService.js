...
add_task(async function test_empty_update() {
  ...
  const TEST_TABLES = [
    ["mozplugin-block-digest256", null], 
    ["content-fingerprinting-track-digest256", null], 
    ["fastblock2-trackwhite-digest256", null], 
  ];
...
add_task(async function test_update() {
  ...
  const TEST_TABLES = [
    ["mozplugin-block-digest256", 1575583456], 
    ["content-fingerprinting-track-digest256", null], 
    ["fastblock2-trackwhite-digest256", 1575583456 - 1], 
  ];
...
add_task(async function test_no_update() {
  ...
  const TEST_TABLES = [
    ["mozplugin-block-digest256", 1575583456], 
    ["content-fingerprinting-track-digest256", 1597417364], 
    ["fastblock2-trackwhite-digest256", 1575583456], 
  ];
