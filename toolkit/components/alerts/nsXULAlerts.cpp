                                  ...
                                  nsIURI* aIconURI)
{
  ...
  rv = argsArray->AppendElement(scriptableImageUrl,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableAlertTitle,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableAlertText,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableIsClickable,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableAlertCookie,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableBidi,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableLang,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableRequireInteraction,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(replacedWindow,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableAlertSource,  false);
  NS_ENSURE_SUCCESS(rv, rv);
  ...
  rv = argsArray->AppendElement(scriptableIconURL,  false);
  NS_ENSURE_SUCCESS(rv, rv);
