...
add_task(function test_isOriginMatching() {
  let testcases = [
    ...
    [false, "https://example.com", "http://example.com", { schemeUpgrades: true }], 
    [false, "http://example.com:8080", "https://example.com", { schemeUpgrades: true }], 
    [false, "http://example.com", "https://example.com:8443", { schemeUpgrades: true }], 
