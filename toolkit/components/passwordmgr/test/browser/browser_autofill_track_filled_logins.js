...
const BASIC_FORM_NO_USERNAME_PAGE_PATH = DIRECTORY_PATH + "form_basic_no_username.html";
...
add_task(async function test() {
  ...
  for (let usernameRequested of [true, false]) {
    info("Testing page with " + (usernameRequested ? "" : "no ") + "username requested");
    let url = usernameRequested ? TEST_HOSTNAME + BASIC_FORM_PAGE_PATH
