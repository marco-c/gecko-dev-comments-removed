...
export class RemoteSettingsClient extends RemoteSettingsClientInterface {
    ...
    async getLastModifiedTimestamp() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            71, // uniffi_remote_settings_fn_method_remotesettingsclient_get_last_modified_timestamp
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getRecords(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            72, // uniffi_remote_settings_fn_method_remotesettingsclient_get_records
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
    ...
    async getRecordsMap(
        ...
        FfiConverterBoolean.checkType(syncIfEmpty);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            73, // uniffi_remote_settings_fn_method_remotesettingsclient_get_records_map
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
            FfiConverterBoolean.lower(syncIfEmpty),
        )
        return handleRustResult(
    ...
    async resetStorage() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            74, // uniffi_remote_settings_fn_method_remotesettingsclient_reset_storage
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async shutdown() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            75, // uniffi_remote_settings_fn_method_remotesettingsclient_shutdown
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            76, // uniffi_remote_settings_fn_method_remotesettingsclient_sync
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class RemoteSettingsService extends RemoteSettingsServiceInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            77, // uniffi_remote_settings_fn_constructor_remotesettingsservice_new
    ...
    clientUrl() {
        ...
        const result = UniFFIScaffolding.callSync(
            78, // uniffi_remote_settings_fn_method_remotesettingsservice_client_url
    ...
    async makeClient(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            79, // uniffi_remote_settings_fn_method_remotesettingsservice_make_client
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            80, // uniffi_remote_settings_fn_method_remotesettingsservice_sync
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async updateConfig(
        ...
        FfiConverterTypeRemoteSettingsConfig.checkType(config);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            81, // uniffi_remote_settings_fn_method_remotesettingsservice_update_config
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
            FfiConverterTypeRemoteSettingsConfig.lower(config),
        )
        return handleRustResult(
