...
export class SearchEngineSelector extends SearchEngineSelectorInterface {
    ...
    static init() {
        ...
        const result = UniFFIScaffolding.callSync(
            91, // uniffi_search_fn_constructor_searchengineselector_new
        )
    ...
    clearSearchConfig() {
        ...
        const result = UniFFIScaffolding.callSync(
            92, // uniffi_search_fn_method_searchengineselector_clear_search_config
    ...
    filterEngineConfiguration(
        ...
        const result = UniFFIScaffolding.callSync(
            93, // uniffi_search_fn_method_searchengineselector_filter_engine_configuration
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
    ...
    setConfigOverrides(
        ...
        const result = UniFFIScaffolding.callSync(
            94, // uniffi_search_fn_method_searchengineselector_set_config_overrides
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
    ...
    setSearchConfig(
        ...
        const result = UniFFIScaffolding.callSync(
            95, // uniffi_search_fn_method_searchengineselector_set_search_config
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
    ...
    async useRemoteSettingsServer(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            96, // uniffi_search_fn_method_searchengineselector_use_remote_settings_server
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
