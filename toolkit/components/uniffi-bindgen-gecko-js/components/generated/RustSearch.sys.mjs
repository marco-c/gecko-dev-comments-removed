...
export class SearchEngineSelector extends SearchEngineSelectorInterface {
    ...
    static init() {
        ...
        const result = UniFFIScaffolding.callSync(
            82, // uniffi_search_fn_constructor_searchengineselector_new
        )
    ...
    clearSearchConfig() {
        ...
        const result = UniFFIScaffolding.callSync(
            83, // uniffi_search_fn_method_searchengineselector_clear_search_config
    ...
    filterEngineConfiguration(
        ...
        const result = UniFFIScaffolding.callSync(
            84, // uniffi_search_fn_method_searchengineselector_filter_engine_configuration
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
    ...
    setConfigOverrides(
        ...
        const result = UniFFIScaffolding.callSync(
            85, // uniffi_search_fn_method_searchengineselector_set_config_overrides
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
    ...
    setSearchConfig(
        ...
        const result = UniFFIScaffolding.callSync(
            86, // uniffi_search_fn_method_searchengineselector_set_search_config
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
    ...
    async useRemoteSettingsServer(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            87, // uniffi_search_fn_method_searchengineselector_use_remote_settings_server
            FfiConverterTypeSearchEngineSelector.lowerReceiver(this),
