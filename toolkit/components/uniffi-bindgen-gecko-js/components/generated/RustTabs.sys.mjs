...
export class RemoteCommandStore extends RemoteCommandStoreInterface {
    ...
    async addRemoteCommand(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            114, // uniffi_tabs_fn_method_remotecommandstore_add_remote_command
    ...
    async addRemoteCommandAt(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            115, // uniffi_tabs_fn_method_remotecommandstore_add_remote_command_at
            FfiConverterTypeRemoteCommandStore.lowerReceiver(this),
            FfiConverterString.lower(deviceId),
            FfiConverterTypeRemoteCommand.lower(command),
    ...
    async getUnsentCommands() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            116, // uniffi_tabs_fn_method_remotecommandstore_get_unsent_commands
            FfiConverterTypeRemoteCommandStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async removeRemoteCommand(
        ...
        FfiConverterTypeRemoteCommand.checkType(command);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            117, // uniffi_tabs_fn_method_remotecommandstore_remove_remote_command
            FfiConverterTypeRemoteCommandStore.lowerReceiver(this),
            FfiConverterString.lower(deviceId),
            FfiConverterTypeRemoteCommand.lower(command),
        )
    ...
    async setPendingCommandSent(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            118, // uniffi_tabs_fn_method_remotecommandstore_set_pending_command_sent
            FfiConverterTypeRemoteCommandStore.lowerReceiver(this),
...
export class TabsBridgedEngine extends TabsBridgedEngineInterface {
    ...
    async apply() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            119, // uniffi_tabs_fn_method_tabsbridgedengine_apply
    ...
    async ensureCurrentSyncId(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            120, // uniffi_tabs_fn_method_tabsbridgedengine_ensure_current_sync_id
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
    ...
    async lastSync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            121, // uniffi_tabs_fn_method_tabsbridgedengine_last_sync
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async prepareForSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            122, // uniffi_tabs_fn_method_tabsbridgedengine_prepare_for_sync
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
    ...
    async reset() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            123, // uniffi_tabs_fn_method_tabsbridgedengine_reset
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async resetSyncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            124, // uniffi_tabs_fn_method_tabsbridgedengine_reset_sync_id
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async setLastSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            125, // uniffi_tabs_fn_method_tabsbridgedengine_set_last_sync
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
    ...
    async setUploaded(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            126, // uniffi_tabs_fn_method_tabsbridgedengine_set_uploaded
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
    ...
    async storeIncoming(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            127, // uniffi_tabs_fn_method_tabsbridgedengine_store_incoming
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
    ...
    async syncFinished() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            128, // uniffi_tabs_fn_method_tabsbridgedengine_sync_finished
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            129, // uniffi_tabs_fn_method_tabsbridgedengine_sync_id
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncStarted() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            130, // uniffi_tabs_fn_method_tabsbridgedengine_sync_started
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async wipe() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            131, // uniffi_tabs_fn_method_tabsbridgedengine_wipe
            FfiConverterTypeTabsBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class TabsStore extends TabsStoreInterface {
    ...
    static async init(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            132, // uniffi_tabs_fn_constructor_tabsstore_new
    ...
    async bridgedEngine() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            133, // uniffi_tabs_fn_method_tabsstore_bridged_engine
    ...
    async closeConnection() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            134, // uniffi_tabs_fn_method_tabsstore_close_connection
            FfiConverterTypeTabsStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getAll() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            135, // uniffi_tabs_fn_method_tabsstore_get_all
            FfiConverterTypeTabsStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async newRemoteCommandStore() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            136, // uniffi_tabs_fn_method_tabsstore_new_remote_command_store
            FfiConverterTypeTabsStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async registerWithSyncManager() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            137, // uniffi_tabs_fn_method_tabsstore_register_with_sync_manager
            FfiConverterTypeTabsStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async setLocalTabs(
        ...
        FfiConverterSequenceTypeRemoteTabRecord.checkType(remoteTabs);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            138, // uniffi_tabs_fn_method_tabsstore_set_local_tabs
            FfiConverterTypeTabsStore.lowerReceiver(this),
    ...
    async setLocalTabsInfo(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            139, // uniffi_tabs_fn_method_tabsstore_set_local_tabs_info
            FfiConverterTypeTabsStore.lowerReceiver(this),
