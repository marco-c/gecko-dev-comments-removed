...
const result = UniFFIScaffolding.callSync(
    97, // uniffi_suggest_fn_func_raw_suggestion_url_matches
...
export class SuggestStore extends SuggestStoreInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            98, // uniffi_suggest_fn_constructor_suggeststore_new
    ...
    async anyDismissedSuggestions() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            99, // uniffi_suggest_fn_method_suggeststore_any_dismissed_suggestions
    ...
    async clear() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            100, // uniffi_suggest_fn_method_suggeststore_clear
            FfiConverterTypeSuggestStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async clearDismissedSuggestions() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            101, // uniffi_suggest_fn_method_suggeststore_clear_dismissed_suggestions
            FfiConverterTypeSuggestStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async dismissByKey(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            102, // uniffi_suggest_fn_method_suggeststore_dismiss_by_key
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async dismissBySuggestion(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            103, // uniffi_suggest_fn_method_suggeststore_dismiss_by_suggestion
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async dismissSuggestion(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            104, // uniffi_suggest_fn_method_suggeststore_dismiss_suggestion
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async fetchGeonameAlternates(
        ...
        FfiConverterTypeGeoname.checkType(geoname);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            105, // uniffi_suggest_fn_method_suggeststore_fetch_geoname_alternates
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async fetchGeonames(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            106, // uniffi_suggest_fn_method_suggeststore_fetch_geonames
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async fetchGlobalConfig() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            107, // uniffi_suggest_fn_method_suggeststore_fetch_global_config
            FfiConverterTypeSuggestStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async fetchProviderConfig(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            108, // uniffi_suggest_fn_method_suggeststore_fetch_provider_config
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async ingest(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            109, // uniffi_suggest_fn_method_suggeststore_ingest
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    interrupt(
        ...
        const result = UniFFIScaffolding.callSync(
            110, // uniffi_suggest_fn_method_suggeststore_interrupt
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async isDismissedByKey(
        ...
        FfiConverterString.checkType(key);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            111, // uniffi_suggest_fn_method_suggeststore_is_dismissed_by_key
            FfiConverterTypeSuggestStore.lowerReceiver(this),
            FfiConverterString.lower(key),
        )
        return handleRustResult(
    ...
    async isDismissedBySuggestion(
        ...
        FfiConverterTypeSuggestion.checkType(suggestion);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            112, // uniffi_suggest_fn_method_suggeststore_is_dismissed_by_suggestion
            FfiConverterTypeSuggestStore.lowerReceiver(this),
            FfiConverterTypeSuggestion.lower(suggestion),
        )
        return handleRustResult(
    ...
    async query(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            113, // uniffi_suggest_fn_method_suggeststore_query
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async queryWithMetrics(
        ...
        FfiConverterTypeSuggestionQuery.checkType(query);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            114, // uniffi_suggest_fn_method_suggeststore_query_with_metrics
            FfiConverterTypeSuggestStore.lowerReceiver(this),
            FfiConverterTypeSuggestionQuery.lower(query),
        )
        return handleRustResult(
...
export class SuggestStoreBuilder extends SuggestStoreBuilderInterface {
    ...
    static init() {
        ...
        const result = UniFFIScaffolding.callSync(
            115, // uniffi_suggest_fn_constructor_suggeststorebuilder_new
        )
        return handleRustResult(
            result,
    ...
    build() {
        ...
        const result = UniFFIScaffolding.callSync(
            116, // uniffi_suggest_fn_method_suggeststorebuilder_build
    ...
    async cachePath(
        ...
        FfiConverterString.checkType(path);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            117, // uniffi_suggest_fn_method_suggeststorebuilder_cache_path
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
            FfiConverterString.lower(path),
        )
        return handleRustResult(
    ...
    dataPath(
        ...
        FfiConverterString.checkType(path);
        const result = UniFFIScaffolding.callSync(
            118, // uniffi_suggest_fn_method_suggeststorebuilder_data_path
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
            FfiConverterString.lower(path),
        )
        return handleRustResult(
    ...
    loadExtension(
        ...
        const result = UniFFIScaffolding.callSync(
            119, // uniffi_suggest_fn_method_suggeststorebuilder_load_extension
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
    ...
    remoteSettingsBucketName(
        ...
        const result = UniFFIScaffolding.callSync(
            120, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_bucket_name
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
    ...
    remoteSettingsServer(
        ...
        const result = UniFFIScaffolding.callSync(
            121, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_server
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
    ...
    remoteSettingsService(
        ...
        const result = UniFFIScaffolding.callSync(
            122, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_service
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
