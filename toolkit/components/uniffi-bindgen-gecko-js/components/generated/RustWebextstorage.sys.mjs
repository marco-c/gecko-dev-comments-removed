...
export class WebExtStorageBridgedEngine extends WebExtStorageBridgedEngineInterface {
    ...
    async apply() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            146, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_apply
    ...
    async ensureCurrentSyncId(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            147, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_ensure_current_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
    ...
    async lastSync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            148, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_last_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async prepareForSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            149, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_prepare_for_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
    ...
    async reset() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            150, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_reset
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async resetSyncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            151, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_reset_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async setLastSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            152, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_set_last_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
    ...
    async setUploaded(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            153, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_set_uploaded
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
    ...
    async storeIncoming(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            154, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_store_incoming
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
    ...
    async syncFinished() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            155, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_finished
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            156, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncStarted() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            157, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_started
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async wipe() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            158, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_wipe
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class WebExtStorageStore extends WebExtStorageStoreInterface {
    ...
    static async init(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            159, // uniffi_webext_storage_fn_constructor_webextstoragestore_new
    ...
    async bridgedEngine() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            160, // uniffi_webext_storage_fn_method_webextstoragestore_bridged_engine
    ...
    async clear(
        ...
        FfiConverterString.checkType(extId);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            161, // uniffi_webext_storage_fn_method_webextstoragestore_clear
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
    ...
    async close() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            162, // uniffi_webext_storage_fn_method_webextstoragestore_close
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async get(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            163, // uniffi_webext_storage_fn_method_webextstoragestore_get
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
    ...
    async getBytesInUse(
        ...
        FfiConverterTypeJsonValue.checkType(keys);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            164, // uniffi_webext_storage_fn_method_webextstoragestore_get_bytes_in_use
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
            FfiConverterTypeJsonValue.lower(keys),
        )
    ...
    async getKeys(
        ...
        FfiConverterString.checkType(extId);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            165, // uniffi_webext_storage_fn_method_webextstoragestore_get_keys
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
        )
        return handleRustResult(
    ...
    async getSyncedChanges() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            166, // uniffi_webext_storage_fn_method_webextstoragestore_get_synced_changes
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async remove(
        ...
        FfiConverterTypeJsonValue.checkType(keys);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            167, // uniffi_webext_storage_fn_method_webextstoragestore_remove
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
            FfiConverterTypeJsonValue.lower(keys),
        )
    ...
    async set(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            168, // uniffi_webext_storage_fn_method_webextstoragestore_set
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
