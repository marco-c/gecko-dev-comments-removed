...
const result = UniFFIScaffolding.callSync(
    267, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_custom_type
...
const result = UniFFIScaffolding.callSync(
    268, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_enum
...
const result = UniFFIScaffolding.callSync(
    269, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_interface
...
const result = UniFFIScaffolding.callSync(
    270, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_record
