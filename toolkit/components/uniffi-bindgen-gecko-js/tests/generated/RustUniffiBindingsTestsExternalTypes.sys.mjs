...
const result = UniFFIScaffolding.callSync(
    258, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_custom_type
...
const result = UniFFIScaffolding.callSync(
    259, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_enum
...
const result = UniFFIScaffolding.callSync(
    260, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_interface
...
const result = UniFFIScaffolding.callSync(
    261, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_record
