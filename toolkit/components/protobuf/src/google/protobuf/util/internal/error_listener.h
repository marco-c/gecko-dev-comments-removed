...
class PROTOBUF_EXPORT NoopErrorListener : public ErrorListener {
 public:
  ...
  void InvalidName(const LocationTrackerInterface& ,
                   StringPiece ,
                   StringPiece ) override {}

  void InvalidValue(const LocationTrackerInterface& ,
                    StringPiece ,
                    StringPiece ) override {}

  void MissingField(const LocationTrackerInterface& ,
                    StringPiece ) override {}
