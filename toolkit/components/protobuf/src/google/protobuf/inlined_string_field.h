...
class PROTOBUF_EXPORT InlinedStringField {
 public:
  ...
  void ClearToEmptyNoArena(const std::string* )
  ...
  bool IsDefault(const std::string* ) { return false; }
...
inline void InlinedStringField::AssignWithDefault(
    const std::string* , const InlinedStringField& from) {
  value_ = from.value_;
}
...
inline void InlinedStringField::SetNoArena(const std::string* ,
                                           StringPiece value) {
...
inline std::string* InlinedStringField::UnsafeArenaRelease(
    const std::string* default_value, Arena* ) {
  return ReleaseNoArena(default_value);
}

inline void InlinedStringField::UnsafeArenaSetAllocated(
    const std::string* default_value, std::string* value, Arena* ) {
  if (value == NULL) {
    value_.assign(*default_value);
  } else {
    value_.assign(*value);
