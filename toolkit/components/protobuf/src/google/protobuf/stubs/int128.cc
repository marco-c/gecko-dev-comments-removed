...
std::ostream& operator<<(std::ostream& o, const uint128& b) {
  ...
  switch (flags & std::ios::basefield) {
    case std::ios::hex:
      div = static_cast<uint64>(GOOGLE_ULONGLONG(0x1000000000000000));  
      div_base_log = 15;
      break;
    case std::ios::oct:
      div = static_cast<uint64>(GOOGLE_ULONGLONG(01000000000000000000000));  
      div_base_log = 21;
      break;
    default:  
      div = static_cast<uint64>(GOOGLE_ULONGLONG(10000000000000000000));  
      div_base_log = 19;
      break;
  }
