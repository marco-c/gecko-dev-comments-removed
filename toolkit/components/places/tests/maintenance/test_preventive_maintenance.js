...
tests.push({
  ...
  async setup() {
    let folderWithInvalidGuid = addBookmark(
      ...
      PlacesUtils.bookmarks.bookmarksMenuFolder,  null,
       null, "NORMAL folder with invalid GUID",
    ...
    let bookmarkWithoutGuid = addBookmark(
      ...
      folderWithInvalidGuid,  null,
       null, "NEW bookmark without GUID",
       null);
    ...
    let bookmarkWithInvalidGuid = addBookmark(
      ...
      folderWithInvalidGuid,  null,
       null, "NORMAL bookmark with invalid GUID",
      "bookmarkAAAA\n", PlacesUtils.bookmarks.SYNC_STATUS.NORMAL);
    ...
    let bookmarkWithValidGuid = addBookmark(
      ...
      folderWithInvalidGuid,  null,
       null, "NORMAL bookmark with valid GUID",
