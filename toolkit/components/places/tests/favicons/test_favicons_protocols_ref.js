...
add_task(async function() {
  ...
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL, 16),
  ...
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL, 33),
                        PlacesUtils.favicons.getFaviconLinkForIcon(NetUtil.newURI(ICON32_URL)),
                        "Size=33 should return the 32px icon");
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL, 17),
                        PlacesUtils.favicons.getFaviconLinkForIcon(NetUtil.newURI(ICON32_URL)),
                        "Size=17 should return the 32px icon");
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL, 1),
                        PlacesUtils.favicons.getFaviconLinkForIcon(NetUtil.newURI(ICON16_URL)),
                        "Size=1 should return the 16px icon");
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL, 0),
                        PlacesUtils.favicons.getFaviconLinkForIcon(NetUtil.newURI(ICON32_URL)),
  ...
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL + "#other§=12", 16),
                        PlacesUtils.favicons.getFaviconLinkForIcon(NetUtil.newURI(ICON16_URL)),
                        "Pre-existing refs should be retained");
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL + "#other§=12", 32),
                        PlacesUtils.favicons.getFaviconLinkForIcon(NetUtil.newURI(ICON32_URL)),
                        "Pre-existing refs should be retained");

  
  await compareFavicons(PlacesUtils.urlWithSizeRef(win, PAGE_ICON_URL + "#randomstuff", 32),
                        PlacesUtils.favicons.getFaviconLinkForIcon(NetUtil.newURI(ICON32_URL)),
