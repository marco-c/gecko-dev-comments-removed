...
add_task(async function test_apply_then_revert() {
  ...
  deepEqual(await buf.fetchUnmergedGuids(), [],
  ...
  deepEqual(secondTimeRecords, firstTimeRecords,
    "Should stage identical records to upload, first and second time");

  let localItemIds = await PlacesUtils.promiseManyItemIds(["bookmarkFFFF",
    "bookmarkEEEE", "folderAAAAAA", "bookmarkCCCC", "bookmarkBBBB"]);

  observer.check([{
    name: "onItemRemoved",
    params: { itemId: localIdForD, parentId: PlacesUtils.bookmarksMenuFolderId,
              index: 1, type: PlacesUtils.bookmarks.TYPE_BOOKMARK,
              urlHref: "http://example.com/d", guid: "bookmarkDDDD",
              parentGuid: PlacesUtils.bookmarks.menuGuid,
    ...
    params: { itemId: localItemIds.get("bookmarkCCCC"),
              ...
              oldIndex: 1, newParentId: localItemIds.get("folderAAAAAA"),
              newIndex: 0, type: PlacesUtils.bookmarks.TYPE_BOOKMARK,
              guid: "bookmarkCCCC",
    ...
    params: { itemId: localItemIds.get("bookmarkBBBB"),
              oldParentId: localItemIds.get("folderAAAAAA"),
              oldIndex: 0, newParentId: localItemIds.get("folderAAAAAA"),
    ...
    name: "onItemChanged",
    params: { itemId: localItemIds.get("folderAAAAAA"), property: "title",
              isAnnoProperty: false, newValue: "A (remote)",
              type: PlacesUtils.bookmarks.TYPE_FOLDER,
              parentId: PlacesUtils.toolbarFolderId, guid: "folderAAAAAA",
              parentGuid: PlacesUtils.bookmarks.toolbarGuid,
              oldValue: "A",
              source: PlacesUtils.bookmarks.SOURCES.SYNC },
  }, {
    name: "onItemChanged",
    params: { itemId: localItemIds.get("bookmarkBBBB"), property: "uri",
              isAnnoProperty: false, newValue: "http://example.com/b-remote",
              type: PlacesUtils.bookmarks.TYPE_BOOKMARK,
              parentId: localItemIds.get("folderAAAAAA"), guid: "bookmarkBBBB",
