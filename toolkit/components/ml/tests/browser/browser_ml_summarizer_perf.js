...
const perfMetadata = {
  ...
  options: {
    default: {
      ...
      perfherder_metrics: [
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_TINY-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_TINY-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_TINY-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_TINY-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_TINY-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_TINY-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_SMALL-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_SMALL-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_SMALL-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_SMALL-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_SMALL-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_SMALL-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_MEDIUM-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_MEDIUM-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_MEDIUM-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_MEDIUM-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_MEDIUM-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_MEDIUM-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_BIG-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_BIG-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_BIG-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_BIG-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_BIG-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-XENOVA-DISTILBART-CNN-12-6_BIG-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_TINY-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_TINY-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_TINY-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_TINY-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_TINY-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_TINY-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_SMALL-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_SMALL-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_SMALL-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_SMALL-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_SMALL-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_SMALL-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_MEDIUM-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_MEDIUM-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_MEDIUM-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_MEDIUM-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_MEDIUM-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_MEDIUM-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_BIG-pipeline-ready-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_BIG-initialization-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_BIG-model-run-latency",
          unit: "ms",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_BIG-pipeline-ready-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_BIG-initialization-memory",
          unit: "MB",
          shouldAlert: true,
        },
        {
          name: "SUM-ONNX-COMMUNITY-QWEN2.5-0.5B-INSTRUCT_BIG-model-run-memory",
          unit: "MB",
          shouldAlert: true,
        },
      ],
