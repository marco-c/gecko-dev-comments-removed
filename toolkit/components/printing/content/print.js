  ...
  getSettingsToUpdate() {
    ...
    if (!matchedPaper) {
      ...
      if (settingsToUpdate.paperId) {
        ...
        paperSizeUnit = this.viewSettings.sizeUnit;
      }
    ...
    let paperHeightInInches = matchedPaper.paper.width * INCHES_PER_POINT;
...
var PrintSettingsViewProxy = {
  ...
  async fetchPaperMargins(paperId) {
    ...
    let margins = await paperWrapper.paper.unwriteableMargin;
