...
add_task(async function test() {
  ...
  await BrowserTestUtils.withNewTab(
    ...
    async function(browser) {
      ...
      await EventUtils.synthesizeKey("a", { ctrlKey: true }, content);
      await EventUtils.synthesizeKey("c", { ctrlKey: true }, content);
      await EventUtils.synthesizeKey("v", { ctrlKey: true }, content);
