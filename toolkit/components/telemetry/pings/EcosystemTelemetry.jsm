...
var EcosystemTelemetry = {
  ...
  _payload(reason, duration) {
    let payload = {
      ...
      scalars: Telemetry.getSnapshotForScalars(this.METRICS_STORE,  true,  true),
      keyedScalars: Telemetry.getSnapshotForKeyedScalars(this.METRICS_STORE,  true,  true),
      histograms: Telemetry.getSnapshotForHistograms(this.METRICS_STORE,  true,  true),
      keyedHistograms: Telemetry.getSnapshotForKeyedHistograms(this.METRICS_STORE,  true,  true),
    };
