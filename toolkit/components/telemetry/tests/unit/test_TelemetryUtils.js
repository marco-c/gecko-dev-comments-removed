...
add_task(async function testHistogramPacking() {
  ...
  const packedHistograms =
    TelemetryUtils.packHistograms(HISTOGRAM_SNAPSHOT, false );
  ...
  const packedHistogramsTest =
    TelemetryUtils.packHistograms(HISTOGRAM_SNAPSHOT, true );
...
add_task(async function testKeyedHistogramPacking() {
  ...
  const packedKeyedHistograms =
    TelemetryUtils.packKeyedHistograms(KEYED_HISTOGRAM_SNAPSHOT, false );
  ...
  const packedKeyedHistogramsTest =
    TelemetryUtils.packKeyedHistograms(KEYED_HISTOGRAM_SNAPSHOT, true );
