...
For any code that ships as part of Firefox that happens in `Events.yaml <https://searchfox.org/firefox-main/source/toolkit/components/telemetry/Events.yaml>`_.
