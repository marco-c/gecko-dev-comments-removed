...
For any code that ships as part of Firefox that happens in `UserInteractions.yaml <https://searchfox.org/firefox-main/source/toolkit/components/telemetry/UserInteractions.yaml>`_.
