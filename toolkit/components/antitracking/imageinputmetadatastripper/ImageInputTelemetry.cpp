...
static constexpr nsLiteralCString kKnownImageMIMETypes[] = {
 ...
 bool ImageInputTelemetry::IsKnownImageMIMEType(
 ...
 bool ImageInputTelemetry::IsContentPrincipal(
 ...
 void ImageInputTelemetry::RecordImageInputTelemetry(
 ...
 void ImageInputTelemetry::MaybeRecordImageInputTelemetry(
 ...
 void ImageInputTelemetry::MaybeRecordDropImageInputTelemetry(
 ...
 void ImageInputTelemetry::MaybeRecordPasteImageInputTelemetry(
 ...
 void ImageInputTelemetry::MaybeRecordFilePickerImageInputTelemetry(
