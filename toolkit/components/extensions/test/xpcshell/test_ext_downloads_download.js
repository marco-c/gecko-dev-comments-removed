...
async function testHttpErrors(allowHttpErrors) {
  ...
  await download(204, "SERVER_BAD_CONTENT"); 
  await download(205, "SERVER_BAD_CONTENT"); 
  await download(404, "SERVER_BAD_CONTENT"); 
  await download(403, "SERVER_FORBIDDEN"); 
  await download(402, "SERVER_UNAUTHORIZED"); 
  await download(407, "SERVER_UNAUTHORIZED"); 
  await download(504, "SERVER_FAILED"); 
