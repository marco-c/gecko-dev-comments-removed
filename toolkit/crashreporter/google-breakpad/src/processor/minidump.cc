...
uint32_t MinidumpMemoryRegion::max_bytes_ = 64 * 1024 * 1024;  
...
const MinidumpModule* MinidumpModuleList::GetModuleForAddress(
  ...
  if (!range_map_->RetrieveRange(address, &module_index, NULL ,
                                 NULL , NULL )) {
...
MinidumpMemoryRegion* MinidumpMemoryList::GetMemoryRegionForAddress(
  ...
  if (!range_map_->RetrieveRange(address, &region_index, NULL ,
                                 NULL , NULL )) {
...
const MinidumpMemoryInfo* MinidumpMemoryInfoList::GetMemoryInfoForAddress(
  ...
  if (!range_map_->RetrieveRange(address, &info_index, NULL ,
                                 NULL , NULL )) {
