...
TEST_F(MicrodumpProcessorTest, TestProcess_WithoutCrashReason) {
  ProcessState state;
  AnalyzeDump("microdump-arm64.dmp", true ,
              2 , &state);
...
TEST_F(MicrodumpProcessorTest, TestProcess_WithCrashReason) {
  ProcessState state;
  AnalyzeDump("microdump-withcrashreason.dmp", true ,
              8 , &state);
...
TEST_F(MicrodumpProcessorTest, TestProcessArm) {
  ProcessState state;
  AnalyzeDump("microdump-arm.dmp", false ,
              2 , &state);
...
TEST_F(MicrodumpProcessorTest, TestProcessArm64) {
  ProcessState state;
  AnalyzeDump("microdump-arm64.dmp", false ,
              2 , &state);
...
TEST_F(MicrodumpProcessorTest, TestProcessX86) {
  ProcessState state;
  AnalyzeDump("microdump-x86.dmp", false ,
              4 , &state);
...
TEST_F(MicrodumpProcessorTest, TestProcessMultiple) {
  ProcessState state;
  AnalyzeDump("microdump-multiple.dmp", false ,
              6 , &state);
...
TEST_F(MicrodumpProcessorTest, TestProcessMips) {
  ProcessState state;
  AnalyzeDump("microdump-mips32.dmp", false ,
              2 , &state);
...
TEST_F(MicrodumpProcessorTest, TestProcessMips64) {
  ProcessState state;
  AnalyzeDump("microdump-mips64.dmp", false ,
              1 , &state);
