...
const AddressRange Dt(Bt.end(), 20);  
const AddressRange Ft(Dt.end(), F.length);
const AddressRange Et(Ft.end(), E.length);
const AddressRange injected(Et.end(), 5);
const AddressRange H1t(injected.end(), 4);  
const AddressRange G1t(H1t.end(), G.length);  
const AddressRange G2t(G1t.end(), G.length);  
const AddressRange H2t(G2t.end(), 3);  
