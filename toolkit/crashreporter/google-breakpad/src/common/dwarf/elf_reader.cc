...
const char kElfPLTRelSectionName[] = ".rel.plt";      
const char kElfPLTRelaSectionName[] = ".rela.plt";    
const char kElfPLTSectionName[] = ".plt";
const char kElfDynSymSectionName[] = ".dynsym";

const int kX86PLTCodeSize = 0x10;  
const int kARMPLTCodeSize = 0xc;
const int kAARCH64PLTCodeSize = 0x10;

const int kX86PLT0Size = 0x10;  
