...
typedef enum {
  ...
  MD_EXCEPTION_CODE_MAC_ARM_DA_ALIGN = 0x0101,  
  MD_EXCEPTION_CODE_MAC_ARM_DA_DEBUG = 0x0102,  

  
  MD_EXCEPTION_CODE_MAC_ARM_UNDEFINED = 1,  

  
  MD_EXCEPTION_CODE_MAC_ARM_BREAKPOINT = 1, 
